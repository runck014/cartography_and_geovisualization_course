...
function b2(i2) {
  return i2 ? h(t2(i2.origin), t2(i2.direction)) : h(n2(), n2());
}
function h(i2, r4) {
...
function n4(n5, a3) {
  const c4 = r2(n5), i2 = l(n5[2] / c4), r4 = Math.atan2(n5[1] / c4, n5[0] / c4);
  return o(a3, c4, i2, r4), a3;
}
...
function I2(t3, r4, n5) {
  const s4 = S(r4, n5);
  if (!Y(t3, s4, X)) return [];
  const { origin: o2, direction: e3 } = s4, { t0: i2, t1: a3 } = X, c4 = (r5) => {
    const n6 = n2();
    return q(n6, o2, e3, r5), $(t3, n6, n6);
  };
  return Math.abs(i2 - a3) < e() ? [c4(i2)] : [c4(i2), c4(a3)];
}
var X = { t0: 0, t1: 0 };
function Y(t3, r4, n5) {
  ...
  const a3 = 2 * (o2[0] * e3[0] + o2[1] * e3[1] + o2[2] * e3[2]), c4 = a3 * a3 - 4 * i2 * (e3[0] * e3[0] + e3[1] * e3[1] + e3[2] * e3[2] - t3[3] * t3[3]);
  if (c4 < 0) return false;
  const u2 = Math.sqrt(c4);
  return n5.t0 = (-a3 - u2) / (2 * i2), n5.t1 = (-a3 + u2) / (2 * i2), true;
}
var G = n2();
function H(t3, r4) {
  return F(t3, r4, null);
...
function J(t3, r4, i2) {
  if (F(t3, r4, i2)) return i2;
  const a3 = K(t3, r4, c2.get());
  return u(i2, r4.origin, g(c2.get(), r4.direction, p2(r4.origin, a3) / r2(r4.direction))), i2;
}
function K(t3, n5, o2) {
  const c4 = c2.get(), u2 = f.get();
  _(c4, n5.origin, n5.direction);
  const f2 = N(t3);
  _(o2, c4, n5.origin), g(o2, o2, 1 / r2(o2) * f2);
  const m = rt(t3, n5.origin), l2 = a2(n5.origin, o2);
  return p(u2, l2 + m, c4), E(o2, o2, u2), o2;
}
function Q(t3, r4, n5, s4) {
  const o2 = N(t3), e3 = o2 * o2, i2 = r4 + 0.5 * Math.PI, a3 = n5 * n5 + e3 - 2 * Math.cos(i2) * n5 * o2, c4 = Math.sqrt(a3), u2 = a3 - e3;
  if (u2 <= 0) return 0.5;
  const f2 = Math.sqrt(u2), m = Math.acos(f2 / c4) - Math.asin(o2 / (c4 / Math.sin(i2)));
...
function $(t3, r4, o2) {
  const i2 = c(c2.get(), r4, U2(t3)), a3 = g(c2.get(), i2, t3[3] / r2(i2));
  return u(o2, a3, U2(t3));
}
function tt(t3, r4) {
...
function rt(r4, n5) {
  const s4 = c(c2.get(), n5, U2(r4)), o2 = r2(s4), i2 = N(r4), a3 = i2 + Math.abs(i2 - o2);
  return b(i2 / a3);
}
var nt = n2();
...
function et(t3, r4, o2, e3) {
  const i2 = ot(t3, r4), a3 = st(t3, r4, n.Z, ct), c4 = g(ct, a3, o2 - i2);
  return u(e3, r4, c4);
}
function it(t3, r4) {
  const n5 = v(U2(t3), r4), s4 = N(t3);
  return n5 <= s4 * s4;
}
function at(t3, r4, n5 = n3()) {
  const s4 = p2(U2(t3), U2(r4)), e3 = t3[3], i2 = r4[3];
  return s4 + i2 < e3 ? (a(n5, t3), n5) : s4 + e3 < i2 ? (a(n5, r4), n5) : (I(n5, U2(t3), U2(r4), (s4 + i2 - e3) / (2 * s4)), n5[3] = (s4 + e3 + i2) / 2, n5);
}
var ct = n2();
var ut = E2();
...
//# sourceMappingURL=chunk-XUTNI6FK.js.map
