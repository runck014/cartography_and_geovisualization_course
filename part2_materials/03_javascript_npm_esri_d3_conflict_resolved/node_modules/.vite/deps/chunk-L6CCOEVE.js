...
var l = class {
  constructor(h) {
    ...
    }, this._hint = new M(), h && (h.initialSize && (this.data = new Array(h.initialSize)), h.allocator && (this._allocator = h.allocator), void 0 !== h.deallocator && (this._deallocator = h.deallocator), h.shrink && (this._shrink = () => n(this)));
  }
  toArray() {
  ...
  remove(t2) {
    const i = x(this.data, t2, this.length, this._hint);
    if (-1 !== i) return this.data.splice(i, 1), this.length = this.length - 1, t2;
  }
  removeUnordered(t2) {
    return this.removeUnorderedIndex(x(this.data, t2, this.length, this._hint));
  }
  ...
  removeUnorderedMany(t2, h = t2.length, s) {
    this.length = S(this.data, t2, this.length, h, this._hint, s), this._shrink();
  }
  front() {
  ...
  find(t2, h) {
    ...
    for (let a2 = 0; a2 < s; ++a2) if (t2.call(h, i[a2])) return i[a2];
  }
  filterInPlace(t2, h) {
    let i = 0;
  ...
  forAll(t2, h) {
    const { data: i, length: s } = this;
    for (let a2 = 0; a2 < s; ++a2) t2.call(h, i[a2], a2, i);
  }
  forEach(t2, h) {
...
//# sourceMappingURL=chunk-L6CCOEVE.js.map
