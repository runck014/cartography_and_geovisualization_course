...
function S2(t19, e11, f6, l10) {
  ...
  if (!h7) return null;
  const m10 = K(new s3(), h7, false, false), p9 = m10.coords.filter((t20, o15) => !(o15 % 2)), g6 = m10.coords.filter((t20, o15) => o15 % 2), y9 = Math.min(...p9), d11 = Math.min(...g6), x4 = Math.max(...p9), M4 = Math.max(...g6), S5 = A(y9, d11, f6, g.WGS84), G2 = A(x4, M4, f6, g.WGS84);
...
var l2 = class _l extends t12 {
  ...
  getGeometry(t19, r14) {
    const a13 = this._getLngLatBounds(), [n19, l10, d11, c10] = a13, _5 = j({ rings: [[[n19, l10], [n19, c10], [d11, c10], [d11, l10], [n19, l10]]] }, g.WGS84, t19), u10 = K(new s3(), _5, false, false);
    if (null != r14) {
      return at(new s3(), u10, false, false, "esriGeometryPolygon", r14, false, false);
    }
    return u10;
  }
  getGeometricCentroid(t19, o15) {
    const a13 = this._getLngLatBounds(), [n19, l10, d11, c10] = a13, _5 = j({ x: (n19 + d11) / 2, y: (l10 + c10) / 2 }, g.WGS84, t19), u10 = O(new s3(), _5);
    if (null != o15) {
      return at(new s3(), u10, false, false, "esriGeometryPoint", o15, false, false);
    }
    return u10;
  }
  getAttributes() {
...
var l3 = class _l extends t12 {
  ...
  getGeometry(t19, e11) {
    const s20 = this.gridX * this._worldUnitsPerCell, o15 = this.gridY * this._worldUnitsPerCell, l10 = new s3([4], [s20, o15, s20 + this._worldUnitsPerCell, o15, s20 + this._worldUnitsPerCell, o15 + this._worldUnitsPerCell, s20, o15 + this._worldUnitsPerCell]);
    if (null != e11) {
      const t20 = new s3();
  ...
  getCentroid(t19) {
    const e11 = new s3([], [this.centroidXWorld, this.centroidYWorld]);
    if (null != t19) {
      const s20 = new s3();
  ...
  getGeometricCentroid(t19, e11) {
    const s20 = this.gridX * this._worldUnitsPerCell + 0.5 * this._worldUnitsPerCell, o15 = this.gridY * this._worldUnitsPerCell + 0.5 * this._worldUnitsPerCell, l10 = new s3([], [s20, o15]);
    if (null != e11) {
      const t20 = new s3();
  ...
  createAggregateFeatures(e11, i14) {
    ...
    for (const o15 of this._clusters.values()) {
      ...
      if (null != c10) if (1 === c10) {
        const n20 = new s3([], [e12, i15]), l11 = new e(n20, o15.inner.getAttributes(), null);
        l11.geometry.coords[0] -= a2, l11.objectId = u10, l11.displayId = h7, a13.push(l11);
        const d12 = new s3([], [e12, i15]), c11 = new e(d12, o15.inner.getAttributes(), null);
      ...
      if (e12 < a2 + y4 && e12 >= -y4 && i15 < a2 + y4 && i15 >= -y4) {
        const r14 = new s3([], [e12, i15]), n20 = new e(r14, o15.inner.getAttributes(), null);
...
var m5 = class {
  ...
  async update(e11, s20, r14, a13, n19) {
    ...
    has("esri-2d-update-debug") && console.debug(`Version[${this._version}] SymbolProcessor.update`, { changes: d4(this._schema, h7), schema: h7 }), this._schema = h7;
...
r([m2()], o10.prototype, "_strategy", void 0), o10 = r([a("esri.views.2d.layers.features.sources.StreamMessenger")], o10);
...
var m6 = class _m extends M2 {
  ...
  _readServerCentroid() {
    ...
    return e11 === u8 ? null : new s3([], [e11, t19]);
  }
  ...
  _parseGeometryForDisplay(e11) {
    ...
    return this._cache.area = f6, d11.length ? new s3(d11, l10) : null != l10 ? this._createQuantizedExtrudedGeometry(l10[0], l10[1]) : null;
  }
};
...
var d8 = class extends c8 {
  async executeQuery(t19, e11) {
    const { data: r14 } = await d3(this.service.source, t19, e11), a13 = !t19.quantizationParameters;
...
var f4 = class extends c8 {
  async executeQuery(t19, s20) {
    ...
    if (null != t19.quantizationParameters && !u10.supportsQuantization) {
      const u11 = t19.clone(), c11 = s5(u11.quantizationParameters);
...
var y6 = class extends c8 {
  async executeQuery(t19, r14) {
    if (t19.quantizationParameters && !this.service.queryMetadata.supportsQuantization) {
      const i15 = t19.clone(), o15 = s5(i15.quantizationParameters);
...
var l7 = class {
  constructor(e11, o15) {
    this.subscription = e11, this._tileIdToResult = /* @__PURE__ */ new Map(), this._controller = new AbortController(), this._handles = t2([m(e11.signal, () => this._controller.abort()), m(o15, () => this._controller.abort())]);
  }
  destroy() {
...
var n16 = class {
  constructor(e11, s20) {
    this.subscription = e11, this._pages = /* @__PURE__ */ new Set(), this._controller = new AbortController(), this._done = false, this._handles = t2([m(e11.signal, () => this._controller.abort()), m(s20, () => this._controller.abort())]);
  }
  destroy() {
    this._controller.abort(), this._handles.remove();
  }
...
r([m2()], s19.prototype, "connection", void 0), r([m2()], s19.prototype, "connectionStatus", null), r([m2()], s19.prototype, "errorString", null), s19 = r([a("esri.views.2d.layers.features.sources.StreamConnectionState")], s19);
...
var h6 = class extends r9 {
  ...
  connect() {
    ...
    this._connection = r4(this._service.source, s20, this._streamOptions.outSR, e11, a13, r14, n19, i14, c10), this._handlesGroup = t2([this._connection.on("data-received", (e12) => this._onFeature(e12)), this._connection.on("message-received", (e12) => this._onWebSocketMessage(e12))]), this._connectionState.connection = this._connection;
  }
  clear() {
...
var b6 = class {
  ...
  async update(t19, e11) {
    var _a, _b2, _c;
    const s20 = t19.source, o15 = d4((_a = this._schema) == null ? void 0 : _a.mutable, s20.mutable);
    if (!o15) return false;
...
//# sourceMappingURL=FeaturePipelineWorker-WUIEEEHY.js.map
