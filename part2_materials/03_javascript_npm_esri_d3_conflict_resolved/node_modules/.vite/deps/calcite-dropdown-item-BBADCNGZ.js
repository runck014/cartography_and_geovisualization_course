...
var DropdownItem = proxyCustomElement(class DropdownItem2 extends H {
  ...
  render() {
    ...
    const contentEl = !href ? slottedContent : h("a", { "aria-label": label, class: CSS.link, href, ref: (el) => this.childLink = el, rel: this.rel, tabIndex: -1, target: this.target }, slottedContent);
    ...
    const { disabled } = this;
    return h(Host, { key: "beec8e51bf18bdcab1928181828b372cc70bb7ee", "aria-checked": itemAria, "aria-label": !href ? label : "", role: itemRole, tabIndex: disabled ? -1 : 0 }, h(InteractiveContainer, { key: "5cbbd1074d6c571f4cac3a99e4a2c09bf113db55", disabled }, h("div", { key: "bff025aeb280c9d0d829e5cf4d94e9392604e607", class: {
      [CSS.container]: true,
...
@esri/calcite-components/dist/components/calcite-dropdown-item.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-dropdown-item-BBADCNGZ.js.map
