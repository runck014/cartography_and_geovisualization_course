...
function t(t2) {
  return new n3({ getCollections: () => [t2.tables, t2.layers], getChildrenFunction: (e) => {
    const t3 = [];
...
function a2(t2, e, r2) {
  if (t2) for (let s = 0, o = t2.length; s < o; s++) {
    ...
    if ("group" === (o2 == null ? void 0 : o2.type)) {
      const t3 = a2(o2.tables, e, r2);
      if (t3) return t3;
    }
  }
}
var n5 = (n6) => {
  let l2 = class extends n6 {
    constructor(...t2) {
      super(...t2), this.tables = new V(), this.addHandles([this.tables.on("after-add", (t3) => {
        const e = t3.item;
        e.parent && e.parent !== this && "tables" in e.parent && e.parent.tables.remove(e), e.parent = this, "feature" !== e.type && n.getLogger(this).error(`Layer 'title:${e.title}, id:${e.id}' of type '${e.type}' is not supported as a table and will therefore be ignored.`);
  ...
  return r([m()], l2.prototype, "tables", null), l2 = r([a("esri.support.TablesMixin")], l2), l2;
};
...
//# sourceMappingURL=chunk-EKHEOE6A.js.map
