...
var a3 = /* @__PURE__ */ ((a5) => a5)(["operational-layers", "basemap", "ground"]);
...
var f3 = { type: Number, json: { origins: { "web-document": w2, "portal-item": { write: true } } } };
var b3 = { ...f3, json: { ...f3.json, origins: { "web-document": { ...w2, write: { enabled: true, layerContainerTypes: a3, target: { opacity: { type: Number }, "layerDefinition.drawingInfo.transparency": { type: Number } } } } }, read: { source: ["layerDefinition.drawingInfo.transparency", "drawingInfo.transparency"], reader: (e, r4, n2) => {
  var _a;
...
var j3 = { type: Number, json: { origins: { service: { write: { enabled: false } }, "web-scene": { name: "layerDefinition.minScale", write: { enabled: true, layerContainerTypes: a3 } } }, name: "layerDefinition.minScale", write: true } };
var v = { type: Number, json: { origins: { service: { write: { enabled: false } }, "web-scene": { name: "layerDefinition.maxScale", write: { enabled: true, layerContainerTypes: a3 } } }, name: "layerDefinition.maxScale", write: true } };
var I = { json: { write: { ignoreOrigin: true, layerContainerTypes: a3 }, origins: { "web-map": { read: false, write: false } } } };
var T = { type: f2, json: { name: "attributeTableInfo", write: true, origins: { "web-scene": { read: false, write: false } } } };
...
//# sourceMappingURL=chunk-HKYICNT2.js.map
