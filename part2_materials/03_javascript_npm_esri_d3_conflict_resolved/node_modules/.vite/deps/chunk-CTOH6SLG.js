...
var D = class _D {
  ...
  static hydrateFieldsIndex(e) {
    return null === e ? null : K(e) ? e.getFieldsIndex() : e.fieldsIndex ? e.fieldsIndex : Z.fromLayerJSON({ datesInUnknownTimezone: e.datesInUnknownTimezone, fields: e.fields, timeInfo: e.timeInfo, editFieldsInfo: e.editFieldsInfo, dateFieldsTimeReference: e.dateFieldsTimeReference ?? { timeZone: "UTC", respectsDaylightSaving: false } });
  }
  ...
  castToText(t2 = false) {
    ...
    for (const s in this.attributes) {
      ...
      null == r2 ? i += JSON.stringify(s) + ":null" : L(r2) || z(r2) || P(r2) ? i += JSON.stringify(s) + ":" + JSON.stringify(r2) : r2 instanceof n ? i += JSON.stringify(s) + ":" + ye(r2) : r2 instanceof n3 || r2 instanceof n2 ? i += `${JSON.stringify(s)}:${JSON.stringify(r2.toString())}` : r2 instanceof t || Array.isArray(r2) ? i += JSON.stringify(s) + ":" + ye(r2, null, t2) : r2 instanceof m ? i += t2 ? JSON.stringify(s) + ":" + JSON.stringify(r2.getTime()) : JSON.stringify(s) + ":" + r2.stringify() : null !== r2 && "object" == typeof r2 && void 0 !== r2.castToText && (i += JSON.stringify(s) + ":" + r2.castToText(t2));
    }
    return '{"geometry":' + (null === this.geometry() ? "null" : ye(this.geometry())) + ',"attributes":{' + i + "}}";
  }
  _fixFieldTypes() {
    var _a;
      ...
      if (void 0 === o) {
        for (const t3 in this.attributes) if (t3.toLowerCase() === r2.toLowerCase()) {
          if (o = this.attributes[t3], null !== o) {
            if ("time-only" === n4) {
              ne(o) || (this.attributes[t3] = n3.fromReader(o.toString()));
              break;
            }
            if ("date-only" === n4) {
              te(o) || (this.attributes[t3] = n2.fromReader(o.toString()));
              break;
            }
            if ("timestamp-offset" === n4) {
              ee(o) || (this.attributes[t3] = m.fromReaderAsTimeStampOffset(o.toString()));
              break;
            }
            const s2 = this.isUnknownDateTimeField(t3);
            o instanceof Date ? this.attributes[t3] = s2 ? m.unknownDateJSToArcadeDate(o) : m.dateJSAndZoneToArcadeDate(o, i) : ee(o) || (this.attributes[t3] = s2 ? m.unknownEpochToArcadeDate(o) : m.epochToArcadeDate(o, i));
          }
          break;
        }
      } else if (null !== o) {
        if ("time-only" === n4) {
          ne(o) ? this.attributes[r2] = o : this.attributes[r2] = n3.fromReader(o.toString());
          continue;
        }
        if ("date-only" === n4) {
          te(o) ? this.attributes[r2] = o : this.attributes[r2] = n2.fromReader(o.toString());
          continue;
        }
        if ("timestamp-offset" === n4) {
          ee(o) ? this.attributes[r2] = o : this.attributes[r2] = m.fromReaderAsTimeStampOffset(o.toString());
          continue;
        }
        const t3 = this.isUnknownDateTimeField(r2);
        ee(o) ? this.attributes[r2] = o : o instanceof Date ? this.attributes[r2] = t3 ? m.unknownDateJSToArcadeDate(o) : m.dateJSAndZoneToArcadeDate(o, i) : this.attributes[r2] = t3 ? m.unknownEpochToArcadeDate(o) : m.epochToArcadeDate(o, i);
      }
    }
  }
  geometry() {
  ...
  setField(t2, i) {
    ...
    if (i instanceof Date && (i = this.isUnknownDateTimeField(t2) ? m.unknownDateJSToArcadeDate(i) : m.dateJSToArcadeDate(i)), false === I(i)) throw new a(null, r.TypeNotAllowedInFeature, null);
  ...
  static parseGeometryFromDictionary(e, t2) {
    ...
    return void 0 !== i.hasm && (i.hasM = i.hasm, delete i.hasm), void 0 !== i.hasz && (i.hasZ = i.hasz, delete i.hasz), void 0 !== i.spatialreference && (i.spatialReference = i.spatialreference, delete i.spatialreference), i.spatialReference || (i.spatialReference = t2), void 0 !== i.rings && (i.rings = this._fixPathArrays(i.rings, true === i.hasZ, true === i.hasZ)), void 0 !== i.paths && (i.paths = this._fixPathArrays(i.paths, true === i.hasZ, true === i.hasM)), void 0 !== i.points && (i.points = this._fixPointArrays(i.points, true === i.hasZ, true === i.hasM)), f(i);
  }
  ...
  static _fixPointArrays(e, t2, i) {
    ...
    if (Array.isArray(e)) for (let r2 = 0; r2 < e.length; r2++) {
      const o = e[r2];
      o instanceof j ? t2 && i ? s.push([o.x, o.y, o.z, o.m]) : t2 ? s.push([o.x, o.y, o.z]) : i ? s.push([o.x, o.y, o.m]) : s.push([o.x, o.y]) : o instanceof t ? s.push(o.toArray()) : s.push(o);
    }
  ...
  static parseAttributesFromDictionary(e) {
    ...
    for (const i in e.attributes) {
      ...
      if (!I(n4)) throw new a(null, r.InvalidParameter, null);
      t2[i] = n4;
    }
    return t2;
  }
  static fromJson(e, t2) {
    let i = null;
    null !== e.geometry && void 0 !== e.geometry && (i = f(e.geometry));
    const n4 = {};
    if (null !== e.attributes && void 0 !== e.attributes) for (const o in e.attributes) {
      const t3 = e.attributes[o];
      if (null === t3) n4[o] = t3;
      else {
        if (!(P(t3) || z(t3) || L(t3) || ee(t3) || ne(t3) || te(t3))) throw new a(null, r.InvalidParameter, null);
        n4[o] = t3;
      }
    }
  ...
  castAsJson(e) {
    ...
    for (const i in this.attributes) {
      ...
      void 0 !== s && (t2.attributes[i] = Ye(s, e));
    }
    return t2;
  }
...
//# sourceMappingURL=chunk-CTOH6SLG.js.map
