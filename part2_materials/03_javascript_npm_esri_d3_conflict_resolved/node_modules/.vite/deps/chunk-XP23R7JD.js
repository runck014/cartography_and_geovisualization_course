...
var E = H().vec3f(e.POSITION).u16(e.COMPONENTINDEX).freeze();
var I = H().vec2u8(e.SIDENESS).freeze();
var S = t2(I);
var T = H().vec3f(e.POSITION0).vec3f(e.POSITION1).vec2i16(e.NORMALCOMPRESSED).u16(e.COMPONENTINDEX).u8(e.VARIANTOFFSET, { glNormalized: true }).u8(e.VARIANTSTROKE).u8(e.VARIANTEXTENSION, { glNormalized: true }).freeze();
var A2 = H().vec3f(e.POSITION0).vec3f(e.POSITION1).vec2i16(e.NORMALCOMPRESSED).vec2i16(e.NORMAL2COMPRESSED).u16(e.COMPONENTINDEX).u8(e.VARIANTOFFSET, { glNormalized: true }).u8(e.VARIANTSTROKE).u8(e.VARIANTEXTENSION, { glNormalized: true }).freeze();
...
function u3(r3, i2, n2, o2) {
  ...
  const c3 = e2(r3.buffer, r3.stride / 4, { originalIndices: n2, originalIndicesLength: o2 }), f4 = t3(c3.indices, o2, c3.uniqueCount);
...
var g2 = new w2();
var a = new N3();
var d3 = H().vec3f(e.POSITION0).vec3f(e.POSITION1);
var m3 = H().vec3f(e.POSITION0).vec3f(e.POSITION1).u16(e.COMPONENTINDEX);
...
//# sourceMappingURL=chunk-XP23R7JD.js.map
