...
import {
  r as r7
} from "./chunk-FZ6E6NIW.js";
import {
  d as d5
} from "./chunk-FUV5SXAH.js";
import {
  h as h2
...
var M2 = class extends B {
  ...
  render() {
    ...
    return n3("div", { class: this.classes(F3.base, e3.widget) }, e11 ? this._renderProgressBar() : null, "loading" === s12 ? this._renderLoading() : this._renderAttachments(), this._renderErrorMessage());
  }
  _renderErrorMessage() {
    const { error: e11, visibleElements: t6 } = this;
    return e11 && t6.errorMessage ? n3("div", { class: F3.errorMessage, key: "error-message" }, e11.message) : null;
  }
  _renderAttachments() {
  ...
  _renderLoading() {
    return n3("div", { class: F3.loaderContainer, key: "loader" }, n3("div", { class: F3.loader }));
  }
  _renderProgressBar() {
    return this.visibleElements.progressBar ? n3("div", { class: F3.progressBar, key: "progress-bar" }) : null;
  }
  _renderAddForm() {
    const { submitting: e11, selectedFile: t6 } = this, s12 = e11 || !t6, i11 = this.visibleElements.cancelAddButton ? n3("button", { bind: this, class: this.classes(e3.button, e3.buttonTertiary, e3.buttonSmall, e3.buttonHalf, e11 && e3.buttonDisabled), disabled: e11, onclick: this._cancelForm, type: "button" }, this.messages.cancel) : null, a5 = this.visibleElements.addSubmitButton ? n3("button", { class: this.classes(e3.button, e3.buttonSecondary, e3.buttonSmall, e3.buttonHalf, { [e3.buttonDisabled]: s12 }), disabled: s12, type: "submit" }, this.messages.add) : null, n11 = t6 ? n3("span", { class: F3.fileName, key: "file-name" }, t6.name) : null, l9 = n3("form", { afterCreate: m2, afterRemoved: f, bind: this, "data-node-ref": "_addAttachmentForm", onsubmit: this._submitAddAttachment }, n3("fieldset", { class: F3.fileFieldset }, n11, n3("label", { class: this.classes(F3.fileLabel, e3.button, e3.buttonSecondary) }, t6 ? this.messages.changeFile : this.messages.selectFile, n3("input", { bind: this, class: F3.fileInput, name: "attachment", onchange: this._handleFileInputChange, type: "file" }))), a5, i11);
    return n3("div", { class: F3.formNode, key: "add-form-container" }, l9);
  }
  _renderDetailsForm(e11) {
    ...
    const h10 = l9.editing && ((_a = l9.operations) == null ? void 0 : _a.delete) && t6.deleteButton ? n3("button", { bind: this, class: this.classes(e3.button, e3.buttonSmall, e3.buttonTertiary, F3.deleteButton, { [e3.buttonDisabled]: a5 }), disabled: a5, key: "delete-button", onclick: (t7) => this._submitDeleteAttachment(t7, e11), type: "button" }, this.messages.delete) : void 0, u9 = l9.editing && ((_b = l9.operations) == null ? void 0 : _b.update) && t6.updateButton ? n3("button", { class: this.classes(e3.button, e3.buttonSmall, e3.buttonThird, { [e3.buttonDisabled]: r9 }), disabled: r9, key: "update-button", type: "submit" }, this.messages.update) : void 0, b11 = this.visibleElements.cancelUpdateButton ? n3("button", { bind: this, class: this.classes(e3.button, e3.buttonSmall, e3.buttonTertiary, e3.buttonThird, { [e3.buttonDisabled]: a5 }), disabled: a5, key: "cancel-button", onclick: this._cancelForm, type: "button" }, this.messages.cancel) : void 0, f8 = l9.editing && ((_c = l9.operations) == null ? void 0 : _c.update) ? n3("fieldset", { class: F3.fileFieldset, key: "file" }, n3("span", { class: F3.fileName, key: "file-name" }, d10), n3("label", { class: this.classes(F3.fileLabel, e3.button, e3.buttonSecondary) }, this.messages.changeFile, n3("input", { bind: this, class: F3.fileInput, name: "attachment", onchange: this._handleFileInputChange, type: "file" }))) : void 0, v9 = n3("fieldset", { class: F3.metadataFieldset, key: "size" }, n3("label", null, T(this.messagesUnits, c14 ?? 0))), A5 = n3("fieldset", { class: F3.metadataFieldset, key: "content-type" }, n3("label", null, o4)), w11 = null != m9 ? n3("a", { class: F3.itemLink, href: m9, rel: "noreferrer", target: "_blank" }, this._renderImageMask(e11, 400), n3("div", { class: F3.itemLinkOverlay }, n3("span", { class: F3.itemLinkOverlayIcon }, n3("calcite-icon", { icon: "launch" })))) : this._renderImageMask(e11, 400), k4 = n3("form", { afterCreate: m2, afterRemoved: f, bind: this, "data-node-ref": "_updateAttachmentForm", onsubmit: (t7) => this._submitUpdateAttachment(t7, e11) }, n3("div", { class: F3.metadata }, v9, A5), f8, n3("div", { class: F3.actions }, h10, b11, u9));
    return n3("div", { class: F3.formNode, key: "edit-form-container" }, w11, k4);
  }
  ...
  _renderGenericImageMask(e11, t6) {
    ...
    return n3("div", { class: this.classes(F3.itemMaskIcon, F3.itemMask), key: i11 }, n3("img", { alt: e11, class: this.classes(a5, F3.itemImage), src: i11, title: e11 }));
  }
  _renderImageMaskForAttachment(e11, t6) {
    ...
    return n3("div", { class: this.classes(F3.itemMask), key: o4 }, n3("img", { alt: a5, class: this.classes(d10, F3.itemImage), src: o4, styles: r9, title: a5 }));
  }
  _renderFile(e11) {
    const { file: t6 } = e11;
    return n3("li", { class: F3.item, key: t6 }, n3("button", { "aria-label": this.messages.attachmentDetails, bind: this, class: F3.itemButton, key: "details-button", onclick: () => this._startEditFile(e11), title: this.messages.attachmentDetails, type: "button" }, this._renderImageMask(e11), n3("label", { class: F3.itemLabel }, n3("span", { class: F3.itemFilename }, t6.name || this.messages.noTitle), n3("span", { "aria-hidden": "true", class: this.classes(F3.itemChevronIcon, u2(this.container) ? i9.left : i9.right) }))));
  }
  _renderAttachmentInfo({ attachmentInfo: e11, displayType: t6 }) {
    const { viewModel: s12, effectiveDisplayType: i11 } = this, { capabilities: a5, supportsResizeAttachments: n11 } = s12, { contentType: l9, name: r9, url: o4 } = e11, d10 = this._renderImageMask(e11, "list" === t6 ? 48 : 400), c14 = a5.editing ? n3("span", { "aria-hidden": "true", class: this.classes(F3.itemChevronIcon, u2(this.container) ? i9.left : i9.right) }) : null, m9 = [d10, "preview" === i11 && n11 && e4(l9) ? null : n3("label", { class: F3.itemLabel }, n3("span", { class: F3.itemFilename }, r9 || this.messages.noTitle), c14)], u9 = a5.editing ? n3("button", { "aria-label": this.messages.attachmentDetails, bind: this, class: F3.itemButton, "data-attachment-info-id": e11.id, key: "details-button", onclick: () => this._startEditAttachment(e11), title: this.messages.attachmentDetails, type: "button" }, m9) : n3("a", { class: F3.itemButton, href: o4 ?? void 0, key: "details-link", rel: "noreferrer", target: "_blank" }, m9);
    return n3("li", { class: F3.item, key: e11 }, u9);
  }
  _renderAttachmentContainer() {
    var _a;
    const { effectiveDisplayType: e11, viewModel: t6, visibleElements: s12 } = this, { attachmentInfos: i11, capabilities: a5, fileInfos: n11 } = t6, l9 = !!(i11 == null ? void 0 : i11.length), r9 = !!(n11 == null ? void 0 : n11.length), o4 = { [F3.containerList]: "preview" !== e11, [F3.containerPreview]: "preview" === e11 }, d10 = a5.editing && ((_a = a5.operations) == null ? void 0 : _a.add) && s12.addButton ? n3("button", { bind: this, class: this.classes(e3.button, e3.buttonTertiary, F3.addAttachmentButton), onclick: () => this._startAddAttachment(), type: "button" }, n3("span", { "aria-hidden": "true", class: this.classes(F3.itemAddIcon, i9.plus) }), this.messages.add) : void 0, c14 = l9 ? n3("ul", { class: F3.items, key: "attachments-list" }, i11.toArray().map((t7) => this._renderAttachmentInfo({ attachmentInfo: t7, displayType: e11 }))) : void 0, m9 = r9 ? n3("ul", { class: F3.items, key: "file-list" }, n11.toArray().map((e12) => this._renderFile(e12))) : void 0, h10 = r9 || l9 ? void 0 : n3("div", { class: e3.empty }, this.messages.noAttachments);
    return n3("div", { class: this.classes(F3.container, o4), key: "attachments-container" }, c14, m9, h10, d10);
  }
  _modeChanged() {
...
function e5({ level: r9, class: e11, ...n11 }, l9) {
  const a5 = s8(r9);
  return n3(`h${a5}`, { ...n11, "aria-level": String(a5), class: l2(e3.heading, e11), role: "heading" }, l9);
}
function s8(t6) {
...
var c6 = class extends B {
  ...
  render() {
    return n3("div", { class: p6.base }, this._renderTitle(), this._renderDescription());
  }
  _renderTitle() {
    const { title: e11 } = this;
    return e11 ? n3(e5, { class: p6.title, innerHTML: e11, level: this.headingLevel }) : null;
  }
  _renderDescription() {
    const { description: e11 } = this;
    return e11 ? n3("div", { class: p6.description, innerHTML: e11, key: "description" }) : null;
  }
};
...
var h4 = class extends B {
  ...
  render() {
    ...
    return n3("div", { class: d6.base }, (_a = this._featureElementInfo) == null ? void 0 : _a.render(), e11 == null ? void 0 : e11.render());
  }
...
var l5 = class extends B {
  ...
  render() {
    ...
    return n3("div", { class: c10.base }, "loading" === e11 ? this._renderLoading() : this._renderCreated());
  }
  _renderLoading() {
    return n3("div", { class: c10.loaderContainer, key: "loader" }, n3("div", { class: c10.loader }));
  }
  _renderCreated() {
    var _a;
    const e11 = (_a = this.viewModel) == null ? void 0 : _a.created;
    return e11 ? e11 instanceof HTMLElement ? n3("div", { afterCreate: this._attachToNode, bind: e11, key: e11 }) : e7(e11) ? n3("div", { key: e11 }, !e11.destroyed && e11.render()) : n3("div", { afterCreate: this._addTargetToAnchors, innerHTML: e11, key: e11 }) : null;
  }
  _attachToNode(e11) {
    const r9 = this;
    e11.appendChild(r9);
...
var c11 = class extends B {
  ...
  render() {
    var _a;
    return n3("div", { class: m5.base }, (_a = this._featureElementInfo) == null ? void 0 : _a.render(), this._renderFields());
  }
  _renderFieldInfo(e11, t6) {
    ...
    return n3("tr", { key: `fields-element-info-row-${i11}-${t6}` }, n3("th", { class: m5.fieldHeader, innerHTML: r9, key: `fields-element-info-row-header-${i11}-${t6}` }), n3("td", { class: this.classes(m5.fieldData, d10), innerHTML: n11, key: `fields-element-info-row-data-${i11}-${t6}` }));
  }
  _renderFields() {
    const { formattedFieldInfos: e11 } = this.viewModel;
    return (e11 == null ? void 0 : e11.length) ? n3("table", { class: e3.table, summary: this.messages.fieldsSummary }, n3("tbody", null, e11.map((e12, t6) => this._renderFieldInfo(e12, t6)))) : null;
  }
  _setupFeatureElementInfo() {
    var _a;
...
async function $3(e11, t6, r9, i11) {
  ...
  if ((g10 == null ? void 0 : g10.relationshipTableId) && g10.keyFieldInRelationshipTable) {
    ...
    if ((y10 == null ? void 0 : y10.length) && u9.supportsStatistics) {
      ...
      const r10 = { features: Promise.resolve(t7), statsFeatures: s6(p12, e12) };
      return y(r10);
    }
  }
  const S4 = g10 == null ? void 0 : g10.keyField;
  if (S4) {
    const t7 = pe(L2(u9.fields, S4)), o5 = F4(e11.attributes, c14.keyField), f9 = t7 ? `${S4}=${o5}` : `${S4}='${o5}'`, d11 = r9.historicMoment, I8 = r9.gdbVersion, g11 = s6(p12, new b3({ where: f9, outFields: h10, sourceSpatialReference: m9, historicMoment: d11, gdbVersion: I8 }), i11), b11 = !!(y10 == null ? void 0 : y10.length) && u9.supportsStatistics ? s6(p12, new b3({ where: f9, outFields: h10, outStatistics: y10, sourceSpatialReference: m9 }), i11) : null, w11 = { features: g11 };
...
var T4 = class extends B {
  constructor(e11, t6) {
    super(e11, t6), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new M3(), this.messages = null, this._disposeChart = (e12) => {
      ...
      const { createRoot: r9 } = await import("./chartUtilsAm5-7SRRI7RH.js"), a5 = await r9(e12);
  ...
  render() {
    var _a;
    return n3("div", { bind: this, class: v7.base, onkeyup: this._handleMediaKeyup }, (_a = this._featureElementInfo) == null ? void 0 : _a.render(), this._renderMedia());
  }
  _renderMedia() {
    const { formattedMediaInfoCount: e11, activeMediaInfoIndex: t6 } = this.viewModel, i11 = this._renderMediaText();
    return e11 ? n3("div", { class: v7.mediaContainer, key: "media-element-container" }, this._renderMediaInfo(), n3("div", { class: v7.mediaNavigation }, i11, e11 > 1 ? n3("div", { class: v7.mediaPagination }, this._renderMediaPageButton("previous"), n3("span", { class: v7.mediaPaginationText }, s2(this.messages.pageText, { index: t6 + 1, total: e11 })), this._renderMediaPageButton("next")) : null)) : null;
  }
  _renderMediaText() {
    const { activeMediaInfo: e11 } = this.viewModel;
    if (!e11) return null;
    const t6 = e11 && e11.title ? n3("div", { class: v7.mediaItemTitle, innerHTML: e11.title, key: "media-title" }) : null, i11 = e11 && e11.caption ? n3("div", { class: v7.mediaItemCaption, innerHTML: e11.caption, key: "media-caption" }) : null;
    return t6 || i11 ? n3("div", { class: v7.mediaItemText, key: "media-text" }, t6, i11) : null;
  }
  _renderImageMediaInfo(e11) {
    if (!e11.value) return null;
    const { _refreshIntervalInfo: t6 } = this, { activeMediaInfoIndex: i11, formattedMediaInfoCount: r9 } = this.viewModel, { value: a5, refreshInterval: o4, altText: s12, title: n11, type: l9 } = e11, { sourceURL: d10, linkURL: c14 } = a5, p12 = v2(c14 ?? void 0) ? "_blank" : "_self", h10 = "_blank" === p12 ? "noreferrer" : "", f8 = o4 ? t6 : null, _6 = f8 ? f8.timestamp : 0, g10 = f8 ? f8.sourceURL : d10, v9 = n3("img", { alt: s12 || n11, key: `media-${l9}-${i11}-${r9}-${_6}`, src: g10 ?? void 0 });
    return (c14 ? n3("a", { href: c14, rel: h10, target: p12, title: n11 }, v9) : null) ?? v9;
  }
  _renderChartMediaInfo(e11) {
    const { activeMediaInfoIndex: t6, formattedMediaInfoCount: i11 } = this.viewModel;
    return n3("div", { afterCreate: this._createChart, afterRemoved: this._disposeChart, bind: this, class: v7.mediaChart, key: `media-${e11.type}-${t6}-${i11}` });
  }
  ...
  _renderMediaInfo() {
    const { activeMediaInfo: e11 } = this.viewModel;
    return e11 ? n3("div", { class: v7.mediaItemContainer, key: "media-container" }, n3("div", { class: v7.mediaItem, key: "media-item-container" }, this._renderMediaInfoType())) : null;
  }
  _renderMediaPageButton(e11) {
    ...
    return n3("button", { "aria-label": i11, bind: this, class: v7.mediaPaginationButton, key: a5, onclick: o4, tabIndex: 0, title: i11, type: "button" }, n3("calcite-icon", { class: v7.mediaPaginationIcon, icon: r9, scale: "s" }));
  }
  _setupFeatureElementInfo() {
    var _a;
    const { description: e11, title: t6 } = this;
  ...
  async _getSeriesColors(e11) {
    const { colorAm5: t6 } = await import("./chartCommon-6R5RG3VB.js"), i11 = /* @__PURE__ */ new Map();
    return e11.forEach((e12) => {
      e12.color && i11.set(e12, t6(e12.color.toCss(true)));
    }), i11;
  }
  async _getRendererColors() {
    const { colorAm5: e11 } = await import("./chartCommon-6R5RG3VB.js"), t6 = /* @__PURE__ */ new Map(), i11 = this._getRenderer(), r9 = "default";
    if (!i11) return t6;
  ...
  async _renderChart(e11) {
    const { root: t6, mediaInfo: i11 } = e11, { value: r9, type: a5 } = i11, { ResponsiveThemeAm5: o4, DarkThemeAm5: s12, AnimatedThemeAm5: n11, ColorSetAm5: l9, ThemeAm5: d10, esriChartColorSet: m9 } = await import("./chartCommon-6R5RG3VB.js"), c14 = d10.new(t6);
  ...
  async _customizeChartTooltip(e11, t6 = "horizontal") {
    var _a;
    const { colorAm5: i11 } = await import("./chartCommon-6R5RG3VB.js");
  ...
  async _createPieChart(e11, t6) {
    const { TooltipAm5: i11 } = await import("./chartCommon-6R5RG3VB.js"), { PieChartAm5: r9, PieSeriesAm5: a5 } = await import("./pieChart-ITMTOGE3.js"), { mediaInfo: o4, root: s12 } = e11, { title: n11 } = o4, l9 = 5, d10 = (o4 == null ? void 0 : o4.altText) || (o4 == null ? void 0 : o4.title) || "", m9 = s12.container.children.push(r9.new(s12, { ariaLabel: d10, focusable: true, paddingBottom: l9, paddingTop: l9, paddingLeft: l9, paddingRight: l9 })), c14 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", p12 = i11.new(s12, { labelText: c14 }), h10 = m9.series.push(a5.new(s12, { name: n11, valueField: A4, categoryField: w7, tooltip: p12 }));
  ...
  async _createColumnChart(e11, t6, i11) {
    const { TooltipAm5: r9, ScrollbarAm5: a5 } = await import("./chartCommon-6R5RG3VB.js"), { CategoryAxisAm5: o4, AxisRendererXAm5: s12, ValueAxisAm5: n11, AxisRendererYAm5: l9, ColumnSeriesAm5: d10 } = await import("./xyChart-PTVEMLP7.js"), { mediaInfo: m9, root: c14 } = t6, { value: h10, title: u9 } = m9;
  ...
  async _createLineChart(e11, t6, i11) {
    var _a, _b, _c;
    const { TooltipAm5: r9, ScrollbarAm5: a5 } = await import("./chartCommon-6R5RG3VB.js"), { CategoryAxisAm5: o4, AxisRendererXAm5: s12, ValueAxisAm5: n11, AxisRendererYAm5: l9, LineSeriesAm5: d10 } = await import("./xyChart-PTVEMLP7.js"), { root: m9, mediaInfo: c14 } = t6, { value: h10, title: u9 } = c14;
    e11.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e11, t6) {
    const { XYChartAm5: i11, XYCursorAm5: r9 } = await import("./xyChart-PTVEMLP7.js"), { root: a5, mediaInfo: o4 } = e11, { type: s12 } = o4, n11 = (o4 == null ? void 0 : o4.altText) || (o4 == null ? void 0 : o4.title) || "", l9 = a5.container.children.push(i11.new(a5, { ariaLabel: n11, focusable: true, panX: true, panY: true }));
...
function l7(e11) {
  ...
  return `<table class="${e3.table}">${r9}</table>`;
}
function d9() {
  return import("./arcade-E5OVUKYF.js");
}
function f3(e11) {
...
var g5 = class extends B {
  ...
  render() {
    ...
    return n3("div", { class: u8.base }, "loading" === e11 ? this._renderLoading() : "disabled" === e11 ? null : (_a = this._contentWidget) == null ? void 0 : _a.render());
  }
  _renderLoading() {
    return n3("div", { class: u8.loadingSpinnerContainer, key: "loading-container" }, n3("calcite-loader", { inline: true, label: "" }));
  }
...
var I7 = f4 = class extends B {
  ...
  render() {
    var _a;
    const { state: e11 } = this.viewModel;
    return n3("div", { class: this.classes(y8.base, e3.widget) }, (_a = this._featureElementInfo) == null ? void 0 : _a.render(), "loading" === e11 ? this._renderLoading() : "disabled" === e11 ? this._renderRelationshipNotFound() : this._renderRelatedFeatures());
  }
  async _selectRecord(e11) {
    const { flowItems: t6, featureVisibleElements: s12 } = this;
    if (!t6) return;
    e11.abilities = { relationshipContent: true };
    const { default: i11 } = await import("./Feature-YAACAB2J.js");
  ...
  _renderStickyLoading() {
    return "querying" === this.viewModel.state ? n3("div", { class: y8.stickySpinnerContainer, key: "sticky-loader" }, this._renderLoadingIcon()) : null;
  }
  _renderLoadingIcon() {
    return n3("calcite-loader", { inline: true, label: "" });
  }
  _renderLoading() {
    return n3("div", { class: y8.loadingSpinnerContainer, key: "loading-container" }, this._renderLoadingIcon());
  }
  _renderShowAllIconNode() {
    return n3("calcite-icon", { icon: "list", scale: "s", slot: "content-end" });
  }
  _renderChevronIconNode() {
    const e11 = u2(this.container) ? "chevron-left" : "chevron-right";
    return n3("calcite-icon", { icon: e11, scale: "s", slot: "content-end" });
  }
  _renderRelatedFeature(e11) {
    ...
    return n3("calcite-list-item", { class: this.classes(y8.listItem, { [y8.listItemHidden]: i11 }), description: e11.description ?? "", key: e11.uid, label: s12, onCalciteListItemSelect: () => this._selectRecord(e11) }, this._renderChevronIconNode());
  }
  _renderShowAllListItem() {
    var _a;
    return this.displayShowAllButton ? n3("calcite-list-item", { description: this.featureCountDescription, key: "show-all-item", label: (_a = this.messages) == null ? void 0 : _a.showAll, onCalciteListItemSelect: () => this._showAllRecords() }, this._renderShowAllIconNode()) : null;
  }
  _renderNoRelatedFeaturesMessage() {
    var _a;
    return n3("calcite-notice", { icon: "information", key: "no-related-features-message", kind: "brand", open: true, scale: "s", width: "full" }, n3("div", { slot: "message" }, (_a = this.messages) == null ? void 0 : _a.noRelatedFeatures));
  }
  _renderFeatureObserver() {
    return n3("div", { afterCreate: this._relatedFeatureIntersectionObserverCreated, bind: this, class: y8.featureObserver, key: "feature-observer" });
  }
  _renderList() {
    const { relatedFeatureViewModels: e11 } = this.viewModel;
    return n3("calcite-list", null, e11.toArray().map((e12) => this._renderRelatedFeature(e12)), this._renderShowAllListItem());
  }
  _renderRelatedFeatures() {
    const { displayListItems: e11 } = this, { state: t6 } = this.viewModel;
    return n3("div", { class: this.classes(y8.listContainer, { [y8.listContainerQuerying]: "querying" === t6 }), key: "list-container" }, e11 ? this._renderList() : "ready" === t6 ? this._renderNoRelatedFeaturesMessage() : null, this._renderStickyLoading(), this._renderFeatureObserver());
  }
  _renderRelationshipNotFound() {
    var _a;
    return n3("calcite-notice", { icon: "exclamation-mark-triangle", key: "relationship-not-found", kind: "danger", open: true, scale: "s", width: "full" }, n3("div", { slot: "message" }, (_a = this.messages) == null ? void 0 : _a.relationshipNotFound));
  }
...
var _3 = class extends i5(s4(b2)) {
  ...
  get associationFeatures() {
    return this._get("associationFeatures") || new s5();
  }
  ...
  _generateWhereClause(t6, e11) {
    const o4 = e11.fieldsIndex.get(o3.status), r9 = `(${e2.join(",")})`, s12 = `${o4.name} IN ${r9}`;
...
var F9 = _4 = class extends B {
  constructor(e11, t6) {
    super(e11, t6), this.flowType = "feature-utility-network-association-type", this.description = null, this.headingLevel = 2, this.title = null, this.viewModel = new F8(), this.parentFeatureViewModel = null, this.listType = null, this.selectedLayer = null, this.flowItems = null, this.messages = null, this.messagesCommon = null, this.visibleElements = new i10(), this._featuresPerPage = 50, this._maxNumFeatures = 1e3, this._currentFeaturePage = 1, this._previewDisplayCount = 3, this._associatedFeatureIntersectionObserverNode = null, this._associatedFeatureIntersectionObserver = new IntersectionObserver(([e12]) => {
      (e12 == null ? void 0 : e12.isIntersecting) && this._increaseFeaturePage();
    }, { root: window.document }), this._tooltipReferenceMap = new s5(), this._filterText = "";
  }
  initialize() {
  ...
  render() {
    ...
    return n3("div", { class: this.classes(w10.base, e3.widget) }, "loading" === t6 || "querying" === t6 || "loading" === s12 ? this._renderLoading() : n3("calcite-list", null, i11 && this.selectedLayer ? n3(i4, null, this._renderFilter(), this._renderAssociatedFeatureListPage(), this._renderFeatureObserver()) : Array.from(e11.keys(), (t7) => this._renderTypeList(t7, e11.get(t7)))));
  }
  _renderFilter() {
    return n3("div", { class: w10.filterContainer, key: "filter" }, n3("calcite-input", { icon: "search", placeholder: this.messages.associationFilterPlaceholder, type: "search", onCalciteInputInput: (e11) => {
  ...
  _renderFeatureObserver() {
    return n3("div", { afterCreate: this._associatedFeatureIntersectionObserverCreated, bind: this, class: w10.featureObserver, key: "feature-observer" });
  }
  _increaseFeaturePage() {
    this.currentFeaturePage++;
  }
  _renderLoading() {
    return n3("div", { class: w10.loadingSpinnerContainer, key: "loading-container" }, this._renderLoadingIcon());
  }
  _renderLoadingIcon() {
    return n3("calcite-loader", { inline: true, label: "" });
  }
  ...
  _renderItemTooltip(e11) {
    ...
    return this.isConnectivity(e11) ? n3("calcite-tooltip", { key: `tooltip-${e11.featureViewModel.uid}`, referenceElement: t6.get(e11.featureViewModel.uid) }, this._getConnectivityTooltip(e11.association.associationType)) : null;
  }
  _renderConnectivityIcon(e11, t6) {
    ...
    return n3("calcite-icon", { afterCreate: (e12) => this._tooltipReferenceMap.set(t6, e12), afterRemoved: () => this._tooltipReferenceMap.delete(t6), icon: i11, scale: "s", slot: "content-start" });
  }
  ...
  _renderAssociatedFeature(e11) {
    ...
    return n3("calcite-list-item", { class: this.classes(w10.listItem, { [w10.listItemHidden]: s12 }), description: e11.terminalName ?? "", key: `associated-feature-type-${t6.uid}`, label: i11, onCalciteListItemSelect: () => this._handleFeatureClick(r9, o4, t6) }, l9 ? this._renderConnectivityIcon(e11.association.associationType, e11.featureViewModel.uid) : null, c14 ? n3("calcite-chip", { scale: "s", slot: "content-end", value: e11.association.percentAlong }, this._formatPercentAlong(e11)) : null, this._renderChevronIconNode(n11));
  }
  async _selectAssociation(e11) {
    ...
    const { default: s12 } = await import("./Feature-YAACAB2J.js");
  ...
  _renderChevronIconNode(e11) {
    return n3("calcite-icon", { flipRtl: true, icon: e11 ? "move-up" : "chevron-right", scale: "s", slot: "content-end" });
  }
  _renderTypeList(e11, t6) {
    const { messages: i11 } = this, s12 = t6.slice(0, this._previewDisplayCount), o4 = s12.length < t6.length;
    return n3("calcite-list-item", { key: "show-all", label: e11.title, open: true, value: e11.id }, n3("calcite-chip", { scale: "s", slot: "actions-end", value: e11.id }, t6.length), n3("calcite-list", { group: e11.id }, [this._renderTooltips(s12), this._renderAssociatedFeatureList(s12)], o4 ? n3("calcite-list-item", { description: s2(i11 == null ? void 0 : i11.numberRecords, { number: t6.length.toString() }), key: "show-all-item", label: i11.showAll, onCalciteListItemSelect: () => this._showAllAssociations(e11) }, n3("calcite-icon", { icon: "list", scale: "s", slot: "content-end" })) : null));
  }
};
...
var f7 = class extends B {
  ...
  render() {
    var _a;
    const { state: e11 } = this.viewModel;
    return n3("div", { class: this.classes(g9.base, e3.widget) }, (_a = this._featureElementInfo) == null ? void 0 : _a.render(), "loading" === e11 ? this._renderLoading() : "disabled" === e11 ? this._renderAssociationNotFound() : this._renderContent());
  }
  _renderStickyLoading() {
    return "querying" === this.viewModel.state ? n3("div", { class: g9.stickySpinnerContainer, key: "sticky-loader" }, this._renderLoadingIcon()) : null;
  }
  _renderLoadingIcon() {
    return n3("calcite-loader", { inline: true, label: "" });
  }
  _renderLoading() {
    return n3("div", { class: g9.loadingSpinnerContainer, key: "loading-container" }, this._renderLoadingIcon());
  }
  _renderAssociationNotFound() {
    var _a;
    return n3("calcite-notice", { icon: "exclamation-mark-triangle", key: "association-not-found", kind: "danger", open: true, scale: "s", width: "full" }, n3("div", { slot: "message" }, (_a = this.messages) == null ? void 0 : _a.noAssociations));
  }
  _setupFeatureElementInfo() {
    var _a;
  ...
  _renderAssociationType(e11) {
    ...
    return n3("calcite-list-item", { description: e11.description, key: `association-type-${e11.type}`, label: t6, value: e11.type, onCalciteListItemSelect: () => this._selectAssociationType(e11) }, n3("calcite-chip", { scale: "s", slot: "content-end", value: e11.type }, this._getFeatureCount(e11.type)), n3("calcite-icon", { flipRtl: true, icon: "chevron-right", scale: "s", slot: "content-end" }));
  }
  ...
  _renderAssociations(e11) {
    return n3("div", null, this._getFeatureCount(e11.type) > 0 ? this._renderAssociationType(e11) : null);
  }
  _renderContent() {
    const { state: e11, associationTypes: t6 } = this.viewModel;
    return n3("div", { class: this.classes(g9.listContainer, { [g9.listContainerQuerying]: "querying" === e11 }), key: "list-container" }, "ready" === e11 ? n3("calcite-list", null, t6.map((e12) => this._renderAssociations(e12))) : null, this._renderStickyLoading());
  }
};
...
var n10 = (n11) => {
  let i11 = class extends n11 {
    constructor() {
      super(...arguments), this.renderNodeContent = (e11) => e7(e11) && !e11.destroyed ? n3("div", { class: t5.contentNode, key: e11 }, e11.render()) : e11 instanceof HTMLElement ? n3("div", { afterCreate: this._attachToNode, bind: e11, class: t5.contentNode, key: e11 }) : t3(e11) ? n3("div", { afterCreate: this._attachToNode, bind: e11.domNode, class: t5.contentNode, key: e11 }) : null;
    }
    _attachToNode(e11) {
      const o4 = this;
      e11.appendChild(o4);
...
var j8 = class extends n10(B) {
  ...
  render() {
    const { state: e11 } = this.viewModel, t6 = n3("div", { class: t5.container, key: "container" }, this._renderTitle(), "error" === e11 ? this._renderError() : "loading" === e11 ? this._renderLoading() : this._renderContentContainer());
    return n3("div", { class: this.classes(t5.base, e3.widget) }, t6);
  }
  _renderError() {
    const { messagesCommon: e11, messages: t6, visibleElements: s12 } = this;
    return n3("calcite-notice", { icon: "exclamation-mark-circle", kind: "danger", open: true, scale: "s" }, s12.title ? n3("div", { key: "error-title", slot: "title" }, e11.errorMessage) : null, n3("div", { key: "error-message", slot: "message" }, t6.loadingError));
  }
  _renderLoading() {
    return n3("div", { class: t5.loadingSpinnerContainer, key: "loading-container" }, n3("calcite-loader", { inline: true, label: "" }));
  }
  _renderContentContainer() {
    const { visibleElements: e11 } = this;
    return e11.content ? n3("div", { class: t5.main }, [this._renderContent(), this._renderLastEditInfo()]) : null;
  }
  _renderTitle() {
    const { visibleElements: e11, title: t6 } = this;
    return e11.title ? n3(e5, { class: t5.title, innerHTML: t6, level: this.headingLevel }) : null;
  }
  _renderContent() {
    const e11 = this.viewModel.content, t6 = "content";
    if (!e11) return null;
    if (Array.isArray(e11)) return e11.length ? n3("div", { class: t5.contentNode, key: `${t6}-content-elements` }, e11.map(this._renderContentElement, this)) : null;
    if ("string" == typeof e11) {
      const e12 = this._contentWidgets[0];
      return !e12 || e12.destroyed ? null : n3("div", { class: this.classes(t5.contentNode, t5.contentNodeText), key: `${t6}-content` }, e12.render());
    }
  ...
  _renderAttachments(e11) {
    ...
    return "loading" === s12 || i11.length > 0 ? n3("div", { class: this.classes(t5.contentElement), key: this._buildKey("attachments-element", e11) }, t6.render()) : null;
  }
  _renderRelationship(e11) {
    const t6 = this._contentWidgets[e11];
    return t6 && !t6.destroyed && this.flowItems ? n3("div", { class: t5.contentElement, key: this._buildKey("relationship-element", e11) }, t6.render()) : null;
  }
  _renderAssociation(e11) {
    const t6 = this._contentWidgets[e11];
    return t6 && !t6.destroyed && this.flowItems ? n3("div", { class: t5.contentElement, key: this._buildKey("utility-network-association-element", e11) }, t6.render()) : null;
  }
  _renderExpression(e11) {
    const t6 = this._contentWidgets[e11];
    return t6 && !t6.destroyed && t6.viewModel.contentElement ? n3("div", { class: t5.contentElement, key: this._buildKey("expression-element", e11) }, t6.render()) : null;
  }
  _renderCustom(e11, t6) {
    const { creator: s12 } = e11, i11 = this._contentWidgets[t6];
    return !i11 || i11.destroyed ? null : s12 ? n3("div", { class: t5.contentElement, key: this._buildKey("custom-element", t6) }, i11.render()) : null;
  }
  _renderFields(e11) {
    const t6 = this._contentWidgets[e11];
    return !t6 || t6.destroyed ? null : n3("div", { class: t5.contentElement, key: this._buildKey("fields-element", e11) }, t6.render());
  }
  _renderMedia(e11) {
    const t6 = this._contentWidgets[e11];
    return !t6 || t6.destroyed ? null : n3("div", { class: t5.contentElement, key: this._buildKey("media-element", e11) }, t6.render());
  }
  _renderLastEditInfo() {
    ...
    return n3("div", { class: this.classes(t5.lastEditedInfo, t5.contentElement), key: "edit-info-element" }, r9);
  }
  _renderText(e11, t6) {
    const s12 = e11.text, i11 = this._contentWidgets[t6];
    return !i11 || i11.destroyed ? null : s12 ? n3("div", { class: this.classes(t5.contentElement, t5.text), key: this._buildKey("text-element", t6) }, i11.render()) : null;
  }
  _buildKey(e11, ...t6) {
    var _a, _b;
...
//# sourceMappingURL=chunk-6K2T25C2.js.map
