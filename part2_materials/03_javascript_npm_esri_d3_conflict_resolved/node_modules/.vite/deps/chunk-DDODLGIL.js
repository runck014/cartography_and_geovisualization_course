...
var f2 = (f4) => {
  let b2 = class extends f4 {
    ...
    async fetchSublayerInfo(e2, t3) {
      var _a;
      const { source: s6 } = e2;
      if ((this == null ? void 0 : this.portalItem) && "tile" === this.type && "map-layer" === (s6 == null ? void 0 : s6.type) && c3(this.portalItem) && e2.originIdOf("url") < e.SERVICE) {
...
var re = G = class extends S(s5(m2)) {
  ...
  async load(e2) {
    return this.addResolvingPromise((async () => {
      ...
      if (!r5 && !t3) throw new s("sublayer:missing-layer", "Sublayer can't be loaded without being part of a layer", { sublayer: this });
  ...
  async createFeatureLayer() {
    ...
    const e2 = (await import("./FeatureLayer-Q542PX3E.js")).default, { layer: r5, url: t3 } = this;
    let i2;
    if (t3 && this.originIdOf("url") > e.SERVICE) i2 = new e2({ url: t3 });
    else {
      if (!(r5 == null ? void 0 : r5.parsedUrl)) throw new s("createFeatureLayer:missing-information", "Cannot create a FeatureLayer without a url or a parent layer");
      {
  ...
  async queryAttachments(e2, r5) {
    var _a, _b;
    await this.load(), e2 = c2.from(e2);
    const t3 = this.capabilities;
    if (!((_a = t3 == null ? void 0 : t3.data) == null ? void 0 : _a.supportsAttachment)) throw new s("queryAttachments:not-supported", "this layer doesn't support attachments");
    ...
    if (!((_b = t3 == null ? void 0 : t3.operations) == null ? void 0 : _b.supportsQueryAttachments)) {
      if ((i2 == null ? void 0 : i2.length) > 0 || (s6 == null ? void 0 : s6.length) > 0 || (n6 == null ? void 0 : n6.length) > 0 || a4 || p5 || u3) throw new s("queryAttachments:option-not-supported", "when 'capabilities.operations.supportsQueryAttachments' is false, only objectIds is supported", e2);
    }
    if (!((o4 == null ? void 0 : o4.length) || (s6 == null ? void 0 : s6.length) || u3)) throw new s("queryAttachments:invalid-query", "'objectIds', 'globalIds', or 'where' are required to perform attachment query", e2);
  ...
  toExportImageJSON(e2) {
    var _a, _b;
    const r5 = { id: this.id, source: ((_a = this.source) == null ? void 0 : _a.toJSON()) || { mapLayerId: this.id, type: "mapLayer" } }, t3 = n3(e2, this.definitionExpression);
  ...
  _handleSublayersChange(e2, r5) {
    r5 && (r5.forEach((e3) => {
      ...
      var _a, _b, _c;
      (((_c = (_b = (_a = this.layer) == null ? void 0 : _a.capabilities) == null ? void 0 : _b.exportMap) == null ? void 0 : _c.supportsSublayersChanges) ?? 1) || (n.getLogger(this).error(new s("sublayer:sublayers-non-modifiable", "Sublayer can't be added, moved, or removed from the layer's sublayers", { sublayer: this, layer: this.layer })), e3.preventDefault());
    })]));
  }
  _logLockedError(e2, r5) {
    const { layer: t3, declaredClass: i2 } = this;
    n.getLogger(i2).error(new s("sublayer:locked", `Property '${String(e2)}' can't be changed on Sublayer from the layer '${t3 == null ? void 0 : t3.id}'`, { reason: r5, sublayer: this, layer: t3 }));
  }
  _getLayerDomain(e2) {
    var _a;
...
//# sourceMappingURL=chunk-DDODLGIL.js.map
