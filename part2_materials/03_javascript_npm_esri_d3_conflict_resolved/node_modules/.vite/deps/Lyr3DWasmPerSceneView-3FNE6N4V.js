...
var f = class extends b2 {
  ...
  _debugLog(e2, t, i, s2 = true) {
    if (this._debugFlags.has(e2) && this._debugLevel >= t) {
      const e3 = s2 ? `[js] ${i}` : `${i}`;
      t === b3.Critical || t === b3.Error ? n.getLogger(this).error(e3) : t === b3.Warning && n.getLogger(this).warn(e3), n.getLogger(this).info(e3);
    }
  }
  initialize() {
    this._debugLevel > b3.Warning && (n.getLogger(this).level = "info"), this._debugLog(c.Lifetime, b3.Info, "Lyr3DWasmPerSceneView.initialize()"), this.addHandles([d(() => {
      var _a;
      return (_a = this.view.state) == null ? void 0 : _a.contentCamera;
    }, () => this._updateWasmCamera())]), this._pulseTaskHandle = A({ preRender: () => this._pulseTask() });
  }
  destroy() {
    var _a;
  ...
  add3DTilesLayerView(e2) {
    return this._lyr3DMain ? this._add3DTilesLayerView(e2) : (this._debugLog(c.Lifetime, b3.Error, "Lyr3DWasmPerSceneView.add3DTilesLayerView() called when WASM wasn't initialized"), d2);
  }
  ...
  initializeWasm(e2) {
    return this._lyr3DMain ? Promise.resolve() : (this._debugLog(c.Lifetime, b3.Info, "Lyr3DWasmPerSceneView.initializeWasm()"), this._lyr3DMainPromise || (this._lyr3DMainPromise = n2().then((t) => {
      var _a, _b, _c;
      this._lyr3DMain = t, this._lyr3DMainPromise = null;
      const i = this._lyr3DMain.addFunction(this._onNewJob.bind(this), "v"), r2 = this._lyr3DMain.addFunction(this._onNewRenderable.bind(this), "v"), s2 = this._lyr3DMain.addFunction(this._freeRenderables.bind(this), "viii"), n3 = this._lyr3DMain.addFunction(this._setRenderableVisibility.bind(this), "viiii"), a2 = this._lyr3DMain.addFunction(this._onWasmError.bind(this), "viiii"), o = "global" === this.view.viewingMode, l = ((_a = this.view.renderSpatialReference) == null ? void 0 : _a.isWebMercator) ? 3857 : ((_b = this.view.renderSpatialReference) == null ? void 0 : _b.wkid) ?? -1, d3 = (_c = this.view.heightModelInfo) == null ? void 0 : _c.heightModel, h2 = !d3 || "gravity-related-height" === d3;
      return this._lyr3DMain.initialize_lyr3d_wasm(a2, i, r2, s2, n3, e2, o, h2, l, this._debugLevel) ? (this._worker = new s(e(this.view.resourceController)), this._worker.promise ? this._worker.promise : void 0) : (this._lyr3DMain = null, void this._debugLog(c.Lifetime, b3.Critical, "Lyr3d Main WASM failed to initialize", false));
    }).catch((e3) => {
  ...
  _onJobFailed(e2, t, i) {
    t.error.length && this._debugLog(c.Jobs, b3.Error, t.error, false), this._lyr3DMain && this._lyr3DMain.on_job_failed(i.jobId, i.desc), this._decrementJobCount(e2);
  }
  ...
  _getRequestPromises(e2, i, r2) {
    ...
    for (const n3 of e2) {
      ...
      a2 ? this._session = a2 : !this._session || e3.origin === r2.origin && e3.pathname === r2.pathname || e3.searchParams.append("session", this._session), s2.push(U(e3.toString(), i).then((e4) => e4.data));
    }
    return s2;
  }
  _onNewJob() {
    ...
    Promise.all(o).then((e3) => (n3.inputs = e3, this._worker.invoke(n3, i))).then((e3) => e3).catch((t2) => (b(t2) ? this._debugLog(c.Jobs, b3.Warning, `job ${e2.jobId} was cancelled.`) : this._debugLog(c.Jobs, b3.Error, `job ${e2.jobId} failed with error ${t2}.`), { status: u.Failed, error: "", jobDescJson: "", data: new Uint8Array(0), missingInputUrls: [], inputs: [] })).then((o2) => {
      if (o2.status === u.Failed) this._onJobFailed(t, o2, e2);
        ...
        Promise.all(l).then((e3) => {
          ...
          this._decrementJobCount(t), b(i2) ? this._debugLog(c.Jobs, b3.Warning, `job ${e2.jobId} was cancelled.`) : this._debugLog(c.Jobs, b3.Error, `job ${e2.jobId} failed with error2 ${i2}.`), this._lyr3DMain && this._lyr3DMain.on_job_failed(e2.jobId, e2.desc);
        });
      }
    });
  }
  _onNewRenderable() {
    ...
    i && (this._incrementRenderableCount(i), i.layerView.createRenderable(e2).then((t2) => {
      ...
      b(t2) || this._debugLog(c.Renderables, b3.Error, `createRenderable failed with error ${t2}.`), this._lyr3DMain && this._lyr3DMain.on_renderable_created(false, e2.layerId, e2.handle, 0), this._decrementRenderableCount(i);
    }));
  }
...
//# sourceMappingURL=Lyr3DWasmPerSceneView-3FNE6N4V.js.map
