...
function R(R2) {
  const z2 = new o7(), { vertex: k, fragment: G, varyings: U } = z2, { output: W, offsetBackfaces: H, instancedColor: q, pbrMode: J, snowCover: K, spherical: Q } = R2, X = J === n3.Normal || J === n3.Schematic;
  if (d(k, R2), z2.include(o4), U.add("vpos", "vec3"), z2.include(l, R2), z2.include(M, R2), z2.include(a, R2), W === n.Color && (f(z2.vertex, R2), z2.include(t, R2), z2.include(o5, R2), H && z2.include(e3), q && z2.attributes.add(e.INSTANCECOLOR, "vec4"), U.add("vNormalWorld", "vec3"), U.add("localvpos", "vec3"), R2.terrainDepthTest && U.add("depth", "float"), z2.include(o6, R2), z2.include(n2, R2), z2.include(i, R2), z2.include(e4, R2), k.uniforms.add(new e5("externalColor", (e6) => e6.externalColor)), U.add("vcolorExt", "vec4"), k.main.add(o2`
...
//# sourceMappingURL=chunk-ZDN6M7KF.js.map
