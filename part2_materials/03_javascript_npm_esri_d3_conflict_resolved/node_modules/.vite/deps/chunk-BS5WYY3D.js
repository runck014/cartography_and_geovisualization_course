import {
  a as a2
} from "./chunk-Y5F7W3CJ.js";
import {
  d as d3
} from "./chunk-BN2GQIOE.js";
import {
  i as i3
} from "./chunk-QAX25DP3.js";
import {
  c as c3,
  t as t2
...
async function i4(t3, e2) {
  if ("Utility Network Layer" === t3) {
    const { default: t4 } = await import("./UtilityNetwork-ZR36FNEN.js");
...
var U2 = class extends S2(m2) {
  ...
  async queryNamedTraceConfigurations(e2, t3) {
    var _a;
    const [{ queryNamedTraceConfigurations: r4 }, { default: o }] = await Promise.all([import("./queryNamedTraceConfigurations-MEP7QDQB.js"), import("./QueryNamedTraceConfigurationsParameters-Q64KBC2S.js")]), s3 = this.networkServiceUrl, i5 = o.from(e2);
  ...
  async validateTopology(e2, t3) {
    ...
    const [{ validateNetworkTopology: r4 }, { default: s3 }] = await Promise.all([import("./validateNetworkTopology-TAKP5LJA.js"), import("./ValidateNetworkTopologyParameters-ZOKRKTQJ.js")]), i5 = s3.from(e2);
  ...
  async submitTopologyValidationJob(e2, t3) {
    ...
    const [{ submitValidateNetworkTopologyJob: i5 }, { default: a5 }] = await Promise.all([import("./validateNetworkTopology-TAKP5LJA.js"), import("./ValidateNetworkTopologyParameters-ZOKRKTQJ.js")]), n6 = a5.from(e2);
...
var f3 = class extends N {
  ...
  async queryAssociations(e2) {
    const [{ queryAssociations: t3 }, { default: r4 }] = await Promise.all([import("./queryAssociations-NL3FKKHA.js"), import("./QueryAssociationsParameters-5CTOL77N.js")]), o = r4.from(e2);
  ...
  async synthesizeAssociationGeometries(e2) {
    const [{ synthesizeAssociationGeometries: t3 }, { default: r4 }] = await Promise.all([import("./synthesizeAssociationGeometries-WFBETNX7.js"), import("./SynthesizeAssociationGeometriesParameters-R2ZPTIAW.js")]), o = r4.from(e2);
    return o.gdbVersion = this.gdbVersion, o.moment = this.historicMoment, t3(this.networkServiceUrl, o);
  }
  async trace(e2) {
    const [{ trace: t3 }, { default: r4 }] = await Promise.all([import("./trace-D2MUC2G5.js"), import("./TraceParameters-OG7FWEML.js")]), o = r4.from(e2);
    return o.gdbVersion = this.gdbVersion, o.moment = this.historicMoment, t3(this.networkServiceUrl, o);
  }
  async submitTraceJob(e2) {
    const [{ submitTraceJob: t3 }, { default: r4 }] = await Promise.all([import("./trace-D2MUC2G5.js"), import("./TraceParameters-OG7FWEML.js")]), o = r4.from(e2);
    o.gdbVersion = this.gdbVersion, o.moment = this.historicMoment;
...
//# sourceMappingURL=chunk-BS5WYY3D.js.map
