...
r([m({ types: n2, json: { read: { reader: i }, write: true } })], l3.prototype, "domain", void 0), r([m({ type: Boolean, json: { write: true } })], l3.prototype, "editable", void 0), r([m({ type: String, json: { write: true } })], l3.prototype, "editableExpression", void 0), r([m({ type: String, json: { write: true } })], l3.prototype, "fieldName", void 0), r([m({ type: String, json: { write: true } })], l3.prototype, "hint", void 0), r([m({ types: c7, json: { read: { source: "inputType" }, write: { target: "inputType" } } })], l3.prototype, "input", void 0), r([m({ type: String, json: { write: true } })], l3.prototype, "requiredExpression", void 0), r([m({ type: String, json: { read: false, write: true } })], l3.prototype, "type", void 0), r([m({ type: String, json: { write: true } })], l3.prototype, "valueExpression", void 0), l3 = n5 = r([a2("esri.form.elements.FieldElement")], l3);
var a9 = l3;
...
var c9 = class extends i2(f) {
  ...
  readDomains(o2) {
    if (!o2) return null;
    const r5 = {};
    for (const t3 of Object.keys(o2)) r5[t3] = i(o2[t3]);
    return r5;
  }
  writeDomains(o2, r5) {
    var _a;
...
//# sourceMappingURL=chunk-UK4PA5E2.js.map
