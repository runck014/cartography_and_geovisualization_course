import {
  re
} from "./chunk-EXBCV6ZO.js";
import "./chunk-GBAJR7JF.js";
import "./chunk-SGZGPX6H.js";
import "./chunk-SK5QCHZZ.js";
import "./chunk-TQ54TTVN.js";
import "./chunk-EVT35YP5.js";
...
var s = (s2) => {
  let t2 = class extends s2 {
    constructor(...r2) {
      super(...r2);
    }
    get updateSuspended() {
      var _a;
      const r2 = (_a = this.parent) == null ? void 0 : _a.dynamicGroupLayerView;
      return this.suspended && (!r2 || true === r2.suspended);
    }
  };
  return r([m()], t2.prototype, "layer", void 0), r([m()], t2.prototype, "parent", void 0), r([m()], t2.prototype, "updateSuspended", null), t2 = r([a("esri.views.layers.CatalogFootprintLayerView")], t2), t2;
};

// node_modules/@arcgis/core/views/2d/layers/CatalogFootprintLayerView2D.js
var t = class extends s(re) {
};
t = r([a("esri.views.2d.layers.CatalogFootprintLayerView2D")], t);
var a2 = t;
export {
  a2 as default
};
//# sourceMappingURL=CatalogFootprintLayerView2D-7UH7F3TJ.js.map
