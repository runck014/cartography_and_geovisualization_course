...
async function o3(r2, t2, s2) {
  ...
  if (!o4) {
    ...
    o4 = (await U(t3, { responseType: "json", query: { f: "json" } })).data.defaultVersionName;
  }
  return o4 === t2;
}
async function i(e, r2, n2 = false) {
  var _a, _b, _c;
  if (!e || !r2) return true;
  const a4 = e.replace(/\/FeatureServer/i, "/VersionManagementServer").replace(/\/\d*$/, ""), o4 = (_a = s.get(a4)) == null ? void 0 : _a.entries();
  if (o4) {
    for (const [s2, i2] of o4) if (i2.name === r2) {
      const e2 = !((_b = i2.stack) == null ? void 0 : _b.hasForwardEdits());
      if (!e2 && n2) {
        const [{ deleteForwardEdits: e3 }, { default: r3 }] = await Promise.all([import("./deleteForwardEdits-KZA4G2JI.js"), import("./DeleteForwardEditsParameters-UIILQD52.js")]), n3 = await e3(a4, s2, new r3({ sessionId: t, moment: i2.moment }));
...
var F = (e) => {
  var s2;
  let o4 = class extends e {
    constructor(...t2) {
      super(...t2), this[s2] = true, this._applyEditsHandler = (t3) => {
        const { serviceUrl: e2, layerId: s3, gdbVersion: r2, mayReceiveServiceEdits: d, result: o5 } = t3, n2 = e2 === this.url, a4 = null != s3 && null != this.layerId && s3 === this.layerId, l2 = b(this), h2 = b(this) && g(e2, r2, this.gdbVersion);
        ...
        const { serviceUrl: e2, gdbVersion: i2, moment: s3 } = t3, r2 = e2 === this.url, d = b(this), o5 = b(this) && g(e2, i2, this.gdbVersion), n2 = b(this) && !g(e2, this.gdbVersion, null);
        r2 && d && o5 && n2 && "historicMoment" in this && this.historicMoment !== s3 && (this.historicMoment = s3);
      }, this.when().then(() => {
  ...
  return s2 = m2, r([m()], o4.prototype, "lastEditsEventDate", void 0), o4 = r([a2("esri.layers.mixins.EditBusLayer")], o4), o4;
};
...
//# sourceMappingURL=chunk-U3JQIAF6.js.map
