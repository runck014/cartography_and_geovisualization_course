...
function u2(n4, o3, e4) {
  A(m, n4), A(h, o3);
  const i = P(m, h), f3 = b(i), a3 = _(m, m, h);
...
function p(t3, n4, r4, o3 = M()) {
  const c3 = r4[0] - n4[0], e4 = r4[1] - n4[1], u3 = r4[2] - n4[2], I2 = t3[0] - n4[0], i = t3[1] - n4[1], f3 = t3[2] - n4[2], s2 = e4 * f3 - u3 * i, N = u3 * I2 - c3 * f3, E2 = c3 * i - e4 * I2, a3 = s2 * s2 + N * N + E2 * E2, T = Math.abs(a3 - 1) > 1e-5 && a3 > 1e-12 ? 1 / Math.sqrt(a3) : 1;
  return o3[0] = s2 * T, o3[1] = N * T, o3[2] = E2 * T, o3[3] = -(o3[0] * t3[0] + o3[1] * t3[1] + o3[2] * t3[2]), o3;
}
function v(t3, n4, u3, I2 = 0, i = Math.floor(u3 * (1 / 3)), f3 = Math.floor(u3 * (2 / 3))) {
  ...
  return N ? (p(R, j, b2, t3), true) : (0 !== I2 || 1 !== i || 2 !== f3) && v(t3, n4, u3, 0, 1, 2);
}
var F = 0.99619469809;
var R = n();
var j = n();
...
function J(t3, n4, r4, c3) {
  const e4 = O(t3), I2 = c2.get(), i = c2.get();
  q(e4, I2, i);
  const f3 = c(c2.get(), r4, n4), s2 = f(I2, f3), N = f(i, f3), E2 = f(e4, f3);
  return o(c3, s2, N, E2);
}
function K(t3, n4, r4) {
...
//# sourceMappingURL=chunk-7Z4L4IHM.js.map
