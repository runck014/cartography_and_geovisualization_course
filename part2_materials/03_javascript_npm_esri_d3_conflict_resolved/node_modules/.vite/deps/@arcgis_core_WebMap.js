import {
  T
} from "./chunk-BS5WYY3D.js";
import "./chunk-Y5F7W3CJ.js";
import "./chunk-F5EWBV6B.js";
import "./chunk-BN2GQIOE.js";
import "./chunk-LNP4UEHL.js";
import "./chunk-QAX25DP3.js";
...
r([m({ type: p, json: { type: [[x, _]], read: { source: "properties.currentTimeExtent" }, write: { target: "properties.currentTimeExtent" } } })], T2.prototype, "currentTimeExtent", void 0), r([o2("currentTimeExtent")], T2.prototype, "readCurrentTimeExtent", null), r([r2("currentTimeExtent")], T2.prototype, "writeCurrentTimeExtent", null), r([m({ type: p, json: { read: { source: ["properties.endTime", "properties.startTime"] }, write: { target: { "properties.endTime": { type: Number }, "properties.startTime": { type: Number } } } } })], T2.prototype, "fullTimeExtent", void 0), r([o2("fullTimeExtent")], T2.prototype, "readFullTimeExtent", null), r([r2("fullTimeExtent")], T2.prototype, "writeFullTimeExtent", null), r([m({ type: Boolean, nonNullable: true, json: { default: false, read: { source: "properties.loop" }, write: { target: "properties.loop" } } })], T2.prototype, "loop", void 0), r([m({ type: x, json: { read: { source: "properties.numberOfStops" }, write: { target: "properties.numberOfStops", overridePolicy() {
  var _a;
...
} } } })], T2.prototype, "stopInterval", void 0), r([o2("stopInterval")], T2.prototype, "readStopInterval", null), r([r2("stopInterval")], T2.prototype, "writeStopInterval", null), r([m({ type: [Date], json: { type: [x], read: { source: "properties.stops" }, write: { target: "properties.stops", overridePolicy() {
  return { isRequired: null == this.numStops && !this.stopInterval };
} } } })], T2.prototype, "stops", void 0), r([o2("stops")], T2.prototype, "readStops", null), r([r2("stops")], T2.prototype, "writeStops", null), T2 = d2 = r([a2("esri.webdoc.widgets.TimeSlider")], T2);
var y = T2;
...
function l4(e5, t4, r4) {
  ...
  return e5.portalItem && (o5.context.portal = e5.portalItem.portal || b2.getDefault()), import("./layersCreator-OQ2G4CDH.js").then(({ populateOperationalLayers: r5 }) => {
...
async function y2(e5, t4, r4) {
  ...
  const { getGeometryServiceURL: p15 } = await import("./geometryServiceUtils-6L6FBVHH.js");
  try {
...
r([m({ type: Boolean, json: { write: true } })], a6.prototype, "exactMatch", void 0), r([m({ type: String, json: { write: true } })], a6.prototype, "name", void 0), r([r3(i)], a6.prototype, "type", void 0), a6 = c4 = r([a2("esri.webdoc.applicationProperties.SearchLayerField")], a6);
var i7 = a6;
...
r([m({ type: Boolean, json: { write: true } })], a8.prototype, "exactMatch", void 0), r([m({ type: String, json: { write: true } })], a8.prototype, "name", void 0), r([r3(i)], a8.prototype, "type", void 0), a8 = c6 = r([a2("esri.webdoc.applicationProperties.SearchTableField")], a8);
var i8 = a8;
...
r([m({ type: String, nonNullable: true, json: { write: { isRequired: true } } })], y4.prototype, "name", void 0), r([m({ type: u5, json: { write: { overridePolicy: (t4) => ({ enabled: !(!t4 || !t4.url) }) } } })], y4.prototype, "thumbnail", void 0), r([s3("thumbnail")], y4.prototype, "castThumbnail", null), r([m(m8)], y4.prototype, "timeExtent", void 0), r([m({ type: m3, nonNullable: true, json: { write: true } })], y4.prototype, "viewpoint", null), r([o2("viewpoint", ["extent", "viewpoint"])], y4.prototype, "readViewpoint", null), r([r2("viewpoint")], y4.prototype, "writeViewpoint", null), y4 = d3 = r([a2("esri.webmap.Bookmark")], y4);
var f6 = y4;

// node_modules/@arcgis/core/webmap/InitialViewProperties.js
var l6 = class extends i2(b) {
  constructor(o5) {
    super(o5), this.background = null, this.rangeInfo = null, this.spatialReference = null, this.timeExtent = null, this.timeZone = o, this.viewpoint = null;
  }
};
r([m({ type: m4 })], l6.prototype, "background", void 0), r([m({ type: c })], l6.prototype, "rangeInfo", void 0), r([m({ type: g })], l6.prototype, "spatialReference", void 0), r([m({ type: p })], l6.prototype, "timeExtent", void 0), r([m({ nonNullable: true })], l6.prototype, "timeZone", void 0), r([m({ type: m3 })], l6.prototype, "viewpoint", void 0), l6 = r([a2("esri.webmap.InitialViewProperties")], l6);
var f7 = l6;
...
var Z = "ArcGIS Pro";
var W = f3.JSAPI;
var $ = class extends S2(m2.LoadableMixin(n3(L))) {
  constructor(e5) {
    super(e5), this._isAuthoringAppSetByUser = false, this._isAuthoringAppVersionSetByUser = false, this._thumbnailFilename = null, this._updateFromPromise = null, this.resourceReferences = { portalItem: null, paths: [] }, this.applicationProperties = null, this.bookmarks = new J(), this.floorInfo = null, this.initialViewProperties = new f7(), this.portalItem = null, this.sourceVersion = null, this.widgets = null, this._debouncedSaveOperations = k(async (e6, t4, r4) => {
      const { save: i12, saveAs: o5 } = await import("./webdocSaveUtils-7COFEXL7.js");
      switch (e6) {
        case A.SAVE:
  ...
  _writeLayers(e5, t4, r4) {
    ...
    return e5.map((e6) => f4(e6, "tables" === r4 ? null : this.getLayerJSONFromResourceInfo(e6), t4)).filter(F).toArray();
  }
  _validateJSON(e5) {
  ...
  _updateInitialViewProperties(e5, t4) {
    var _a, _b;
    if (t4.backgroundExcluded || (this.initialViewProperties.background = (_a = e5.background) == null ? void 0 : _a.clone()), this.initialViewProperties.spatialReference = (_b = e5.spatialReference) == null ? void 0 : _b.clone(), this.initialViewProperties.timeZone = e5.timeZone, t4.viewpointExcluded || (this.initialViewProperties.viewpoint = new m3({ rotation: e5.rotation, scale: t4.scalePreserved ? e5.scale : null, targetGeometry: this._getViewExtent(e5) })), !t4.widgetsExcluded) for (const r4 of e5.persistableViewModels) r4.updateWebDocument(this);
  }
  _getViewExtent(e5) {
...
r([m({ type: S, json: { write: { isRequired: true } } })], a13.prototype, "portalItem", void 0), r([o2("portalItem", ["itemId"])], a13.prototype, "readPortalItem", null), r([r2("portalItem", { itemId: { type: String } })], a13.prototype, "writePortalItem", null), a13 = r([a2("esri.webdoc.ips.PositioningService")], a13);
var c14 = a13;

// node_modules/@arcgis/core/webdoc/IPSInfo.js
var p14 = class extends i2(f) {
  constructor(o5) {
