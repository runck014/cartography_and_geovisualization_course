...
function U2(t, r, e) {
  if ("resource" === (t == null ? void 0 : t.type)) return w(t, r, e);
  switch ((t == null ? void 0 : t.type) ?? "other") {
    case "other":
      return { read: true, write: true };
    case "url": {
      const { read: t2, write: r2 } = P;
...
function w(t, r, n3) {
  ...
  }, write: { writer(r2, p2, c, u) {
    if (!(u == null ? void 0 : u.resources)) return "string" == typeof r2 ? void (p2[c] = m(r2, u)) : void (p2[c] = r2.write({}, u));
    const l = x2(r2), m2 = m(l, { ...u, verifyItemRelativeUrls: (u == null ? void 0 : u.verifyItemRelativeUrls) ? { writtenUrls: u.verifyItemRelativeUrls.writtenUrls, rootPath: void 0 } : void 0 }, y.NO), d = i2.type !== String && (!i(this) || (u == null ? void 0 : u.origin) && this.originIdOf(n3) > n(u.origin)), h = { object: this, propertyName: n3, value: r2, targetUrl: m2, dest: p2, targetPropertyName: c, context: u, params: t };
    (u == null ? void 0 : u.portalItem) && m2 && !Y(m2) ? d && (t == null ? void 0 : t.contentAddressed) ? I(h) : d ? N(h) : P2(h) : (u == null ? void 0 : u.portalItem) && (null == m2 || null != U(m2) || Z(m2) || d) ? I(h) : p2[c] = m2;
  } } };
}
function I(e) {
  var _a;
  ...
  const g2 = (p2 == null ? void 0 : p2.contentAddressed) && "json" === y2.type ? x(y2.jsonString) : (f2 == null ? void 0 : f2.filename) ?? n2(), v = V((p2 == null ? void 0 : p2.prefix) ?? (f2 == null ? void 0 : f2.prefix), g2), j3 = `${v}.${p(y2)}`;
  if ((p2 == null ? void 0 : p2.contentAddressed) && a.resources && "json" === y2.type) {
    const t = a.resources.toKeep.find(({ resource: t2 }) => t2.path === j3) ?? a.resources.toAdd.find(({ resource: t2 }) => t2.path === j3);
    if (t) return void (l[d] = t.resource.itemRelativeUrl);
  }
  const U3 = a.portalItem.resourceFromPath(j3);
  Z(o2) && a.resources && a.resources.pendingOperations.push(st(o2).then((t) => {
    U3.path = `${v}.${p({ type: "blob", blob: t })}`, l[d] = U3.itemRelativeUrl;
  }).catch(() => {
  }));
...
function N(t) {
  ...
  const c = r.portalItem.resourceFromPath(e), u = S(s2, e, r), a = p(u), l = Ht(c.path), d = (o2 == null ? void 0 : o2.compress) ?? false;
  a === l ? (r.resources && b({ ...t, resource: c, content: u, compress: d, updates: r.resources.toUpdate }), n3[i2] = e) : I(t);
}
function P2({ context: t, targetUrl: r, dest: e, targetPropertyName: o2 }) {
...
//# sourceMappingURL=chunk-CSMPF4LP.js.map
