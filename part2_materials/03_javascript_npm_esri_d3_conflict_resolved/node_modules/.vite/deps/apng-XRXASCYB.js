  ...
  return n2 || (n2 = 1, e = function() {
    return function(e2) {
      ...
      function c(e3) {
        ...
        var n4 = [], s4 = [], u3 = null, h3 = null, c2 = 0, f2 = new i2.APNG();
        if (p(t2, function(e4, t3, r3, a3) {
          ...
          switch (e4) {
            ...
            case "acTL":
              ...
              break;
            case "fcTL":
              h3 && (f2.frames.push(h3), c2++), (h3 = new i2.Frame()).width = o4.getUint32(r3 + 8 + 4), h3.height = o4.getUint32(r3 + 8 + 8), h3.left = o4.getUint32(r3 + 8 + 12), h3.top = o4.getUint32(r3 + 8 + 16);
              var l3 = o4.getUint16(r3 + 8 + 20), p2 = o4.getUint16(r3 + 8 + 22);
              0 === p2 && (p2 = 100), h3.delay = 1e3 * l3 / p2, h3.delay <= 10 && (h3.delay = 100), f2.playTime += h3.delay, h3.disposeOp = o4.getUint8(r3 + 8 + 24), h3.blendOp = o4.getUint8(r3 + 8 + 25), h3.dataParts = [], 0 === c2 && 2 === h3.disposeOp && (h3.disposeOp = 1);
              break;
            case "fdAT":
        ...
        }), h3 && f2.frames.push(h3), 0 == f2.frames.length) return o3;
      ...
      function p(e3, t2) {
        ...
        do {
          s4 = r2.getUint32(n4), a3 = t2(i3 = f(e3, n4 + 4, 4), e3, n4, s4), n4 += 12 + s4;
      ...
      var u2 = function(e3) {
        function t2(e4, r2, n4) {
          ...
          return i3.playbackRate = 1, i3._currentFrameNumber = 0, i3._ended = false, i3._paused = true, i3._numPlays = 0, i3._apng = e4, i3.context = r2, i3.stop(), n4 && i3.play(), i3;
        }
...
async function o2(e, n3) {
  ...
  const l2 = h2.getContext("2d", { willReadFrequently: true }), c = [], p = [];
  let f = 0;
  for (const t of s3) {
  ...
  return { frameCount: s3.length, duration: f, frameDurations: p, getFrame: (e2) => c[e2], width: o3, height: u2 };
}
...
//# sourceMappingURL=apng-XRXASCYB.js.map
