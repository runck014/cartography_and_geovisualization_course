...
import {
  ...
  x as x4,
  y as y6
} from "./chunk-KG6AZHOW.js";
import {
  h as h5
} from "./chunk-QJUE5NJJ.js";
import {
  I as I5
...
import {
  x as x2
} from "./chunk-P6J6V7QN.js";
import {
  v as v5
} from "./chunk-AZPOFFL5.js";
import {
  K as K3,
  W as W2,
  Z as Z2
...
import {
  a as a8,
  i as i6
} from "./chunk-DAAZ64TZ.js";
import "./chunk-MJE45HWA.js";
...
function h8(n38, o19, { z: i25, m: l23 }, f18, c18) {
  ...
  if (null == i25 && null == l23) d28 = void 0;
    ...
    d28 = x3(o19, n38, a28, j7, s26) ?? 0;
  }
  const [v15, p22] = n38;
  return c18 ? n9(c18, v15, p22, d28, a28) : c18 = e10(v15, p22, d28, a28), null != l23 && (c18.m = l23, c18.hasM = true), c18;
}
!function(n38) {
...
var n13 = class _n extends s13 {
  ...
  get length() {
    return p4(this.lineStart, this.lineEnd);
  }
};
...
var d14 = class extends r15 {
  ...
  visualizeRightAngleQuad(e27, t21) {
    const r26 = n7(), s26 = n7(), m15 = n5();
    e6(r26, s12(e27.centerVertex), s12(e27.previousVertex)), e6(s26, s12(e27.nextVertex), s12(e27.previousVertex)), y2(m15, r26, s26);
  ...
  _visualizeSnappingIndicator(r26, i25) {
    const o19 = new d10({ geometry: r26, symbol: i25 });
    return this._graphicsLayer.add(o19), e2(() => {
...
var W3 = class extends R7 {
  constructor(t21, a28, o19 = null) {
    super(a28), this._defaultZ = o19, this.transform = e11(), this.transformInv = e11(), this.transform = r13(t21), u9(this.transformInv, this.transform);
  }
...
var v8 = class extends R7 {
  constructor(t21, r26) {
    super(t21.spatialReference), this.view = t21, this.defaultZ = null, this.pWS = n5(), this.tangentFrameUpWS = n5(), this.tangentFrameRightWS = n5(), this.tangentFrameForwardWS = n5(), this.localFrameRightWS = n5(), this.localFrameUpWS = n5(), this.worldToLocalTransform = e9(), this.localToWorldTransform = e9(), this.scale = 1, this.scale = t21.resolution, this.referenceMapPoint = r26, this.defaultZ = r26.hasZ ? r26.z : null;
    ...
    const s26 = n5();
    g5(s26, this.tangentFrameForwardWS, P3(e27, this.tangentFrameForwardWS)), c3(this.localFrameRightWS, e27, s26), A5(this.localFrameRightWS, this.localFrameRightWS), _5(this.localFrameUpWS, this.tangentFrameForwardWS, this.localFrameRightWS), R4(this.worldToLocalTransform, this.localFrameRightWS, this.tangentFrameRightWS), L5(this.localToWorldTransform, this.worldToLocalTransform);
  }
  get doUnnormalization() {
...
function P4(t21, e27, o19) {
  w9[0] = t21.x, w9[1] = t21.y, w9[2] = 0, I6[0] = e27.x, I6[1] = e27.y, I6[2] = 0, I3(w9, w9, I6, 0.5), z4.x = w9[0], z4.y = I6[1], z4.z = I6[2];
...
function L6(t21, e27, o19, r26) {
  ...
  let d28 = 0;
  if (g(e27.spatialReference)) d28 = M15 * a10(x15, h18, null);
  else {
...
function b9(t21, n38) {
  const r26 = t21.start, e27 = t21.end, s26 = n38.start, c18 = n38.end, i25 = e6(x5, e27, r26), f18 = e6(M7, c18, s26), a28 = m8(i25, f18);
  if (Math.abs(a28) <= v10) return [];
  const p22 = e6(g12, r26, s26), h18 = m8(f18, p22) / a28, E15 = m8(i25, p22) / a28;
  if (h18 >= 0) {
    if (E15 >= 0 || n38.type === j12.LINE) return [d6(A6, r26, i25, h18)];
  } else if (t21.type === j12.LINE && (E15 >= 0 || n38.type === j12.LINE)) return [d6(A6, r26, i25, h18)];
  return [];
}
function d17(t21, n38, s26) {
  const c18 = [], i25 = e6(x5, t21.end, t21.start), f18 = e6(M7, t21.start, n38), a28 = p3(i25), p22 = 2 * j5(i25, f18), m15 = p22 * p22 - 4 * a28 * (p3(f18) - s26 * s26);
  if (0 === m15) {
    const n39 = -p22 / (2 * a28);
    (t21.type === j12.LINE || n39 >= 0) && c18.push(d6(A6, t21.start, i25, n39));
  } else if (m15 > 0) {
    const n39 = Math.sqrt(m15), r26 = (-p22 + n39) / (2 * a28);
    (t21.type === j12.LINE || r26 >= 0) && c18.push(d6(A6, t21.start, i25, r26));
    const e27 = (-p22 - n39) / (2 * a28);
    (t21.type === j12.LINE || e27 >= 0) && c18.push(d6(g12, t21.start, i25, e27));
  }
  return c18;
}
var j12;
...
function U5({ start: t21, end: o19, type: c18 }, i25, u18) {
  const a28 = [], f18 = e6(et, o19, t21), m15 = e6(ot, t21, i25), L13 = p3(f18), h18 = 2 * j5(f18, m15), A16 = h18 * h18 - 4 * L13 * (p3(m15) - u18 * u18);
  if (0 === A16) {
    const n38 = -h18 / (2 * L13);
    (c18 === rt.PLANE || n38 >= 0) && a28.push(d6(n7(), t21, f18, n38));
  } else if (A16 > 0) {
    const n38 = Math.sqrt(A16), r26 = (-h18 + n38) / (2 * L13);
    (c18 === rt.PLANE || r26 >= 0) && a28.push(d6(n7(), t21, f18, r26));
    const s26 = (-h18 - n38) / (2 * L13);
    (c18 === rt.PLANE || s26 >= 0) && a28.push(d6(n7(), t21, f18, s26));
  }
  return a28;
}
function k4(t21, r26) {
  const e27 = t21.start, c18 = t21.end, i25 = e6(et, c18, e27), u18 = o6(it, -i25[1], i25[0], 0), a28 = r26.start, f18 = r26.end, p22 = R2(ut, f18, a28), m15 = P3(p22, u18), L13 = o6(at, e27[0], e27[1], 0), E15 = R2(ft, L13, a28), N11 = P3(E15, u18), y21 = e5();
  if (Math.abs(m15) < y21) return Math.abs(N11), [];
  const P13 = q2(pt, a28, p22, N11 / m15);
  if (r26.type === j12.RAY) {
    const t22 = R2(mt, P13, a28);
    if (P3(t22, p22) < -y21) return [];
  }
  if (t21.type === rt.HALF_PLANE) {
    const t22 = B2(ot, P13, e27);
    if (j5(t22, i25) < -y21) return [];
  }
  return [t2(P13)];
}
...
function z5(t21, n38) {
  const r26 = 0;
  return S3(X(ht, r26, t21), X(At, r26, n38)).map(([t22, n39]) => r12(t22, n39));
}
function C5(t21, n38, r26) {
  return J5(t21, X(ht, t21[2], n38), r26);
}
function B4(t21, r26, s26, o19 = n5()) {
  const i25 = e6(et, t21, r26), u18 = q(i25);
  return d6(o19, r26, i25, 0 === u18 ? 1 : s26 / u18), o19[2] = t21[2], o19;
}
function J5(t21, { start: n38, end: r26, type: s26 }, e27 = n5()) {
  const o19 = R2(ct, t21, n38), c18 = R2(it, r26, n38), i25 = P3(o19, c18) / P3(c18, c18);
  return q2(e27, n38, c18, s26 === j12.RAY ? Math.max(i25, 0) : i25);
}
var O4 = (() => {
  const t21 = n5(), n38 = n5(), r26 = n5();
  return ({ start: s26, end: e27 }, { center: o19, radius: c18, normal: i25, slicePlane: u18 }) => {
    const a28 = l7(o19, i25, Lt);
    if ($3(Q3(a28, s26), 0) && $3(Q3(a28, e27), 0)) {
      q3(i25, t21, n38);
      const a29 = (s27, e28) => (c3(r26, e28, o19), o5(s27, P3(r26, t21), P3(r26, n38)), s27), p23 = d17({ start: a29(et, s26), end: a29(ot, e27), type: j12.LINE }, a5, c18), m15 = [];
      for (const [r27, s27] of p23) {
        const e28 = s8(n5(), o19);
        q2(e28, e28, t21, r27), q2(e28, e28, n38, s27), u18 && !nt(u18, e28) || m15.push(e28);
      }
      return m15;
    }
    const p22 = n5();
    return k3(a28, s26, e27, p22) ? !$3(p4(p22, o19), c18) || u18 && !nt(u18, p22) ? [] : [p22] : [];
  };
})();
function Q4({ start: t21, end: e27, type: o19 }, c18, i25) {
  const u18 = [], a28 = c3(ct, e27, t21), f18 = e6(ot, t21, c18), p22 = p3(a28), m15 = 2 * j5(a28, f18), L13 = m15 * m15 - 4 * p22 * (p3(f18) - i25 * i25);
  if (0 === L13) {
    const n38 = -m15 / (2 * p22);
    (o19 === j12.LINE || n38 >= 0) && u18.push(q2(n5(), t21, a28, n38));
  } else if (L13 > 0) {
    const n38 = Math.sqrt(L13), r26 = (-m15 + n38) / (2 * p22);
    (o19 === j12.LINE || r26 >= 0) && u18.push(q2(n5(), t21, a28, r26));
    const s26 = (-m15 - n38) / (2 * p22);
    (o19 === j12.LINE || s26 >= 0) && u18.push(q2(n5(), t21, a28, s26));
  }
  return u18;
}
function S3(t21, n38) {
  const r26 = t21.start, s26 = t21.end, e27 = n38.start, o19 = n38.end, c18 = R2(ct, s26, r26), i25 = R2(it, o19, e27), u18 = R2(ut, e27, r26), a28 = _5(at, c18, i25);
  if (!$3(P3(u18, a28), 0)) return [];
  const f18 = Z(a28);
  if ($3(f18, 0)) return [];
  const p22 = _5(ft, u18, i25), m15 = P3(p22, a28) / f18, L13 = q2(pt, r26, c18, m15);
  if (t21.type === j12.RAY) {
    const t22 = R2(mt, L13, r26);
    if (P3(c18, t22) < -e5()) return [];
  }
  if (n38.type === j12.RAY) {
    const t22 = R2(mt, L13, e27);
    if (P3(i25, t22) < -e5()) return [];
  }
  return [t2(L13)];
}
function T3({ start: t21, end: n38, type: r26 }, s26) {
  const e27 = R2(ct, s26, t21), o19 = R2(it, n38, t21), c18 = _5(ut, o19, e27), i25 = Z(c18) / Z(o19), u18 = e5();
...
function W4(t21, n38, r26, s26) {
  ...
  const h18 = (n38 * n38 - s26 * s26 + p22) / (2 * L13), A16 = Math.sqrt(n38 * n38 - h18 * h18), d28 = A16 * f18 / L13, l23 = A16 * u18 / L13, [E15, N11] = _4(et, t21, r26, h18 / L13);
  return $3(d28, l23) ? [r12(E15, N11)] : [r12(E15 + d28, N11 - l23), r12(E15 - d28, N11 + l23)];
}
function X(t21, n38, { start: r26, end: s26, type: e27 }) {
  return o6(t21.start, r26[0], r26[1], n38), o6(t21.end, s26[0], s26[1], n38), t21.type = st[e27], t21;
}
function Z3(t21, n38) {
...
var mt = n5();
var Lt = M4();
var ht = { start: n5(), end: n5(), type: j12.LINE };
var At = { start: n5(), end: n5(), type: j12.LINE };
...
var xt = class extends mt2 {
  ...
  closestTo(t21) {
    ...
    for (const r26 of this.constraints) {
      const n38 = r26.closestTo(t21), i25 = v4(t21, n38);
...
var zt = class extends mt2 {
  ...
  closestTo(t21) {
    ...
    const r26 = R2(Mt, Mt, e27), n38 = j6(r26);
  ...
  getPlane(t21 = M4()) {
    return l7(this.center, this.normal, t21);
  }
};
var Mt = n5();
var Tt = M4();
var qt = class extends mt2 {
  ...
  getPlane(t21 = M4()) {
    return o6(wt, 0, 0, this.z), l7(wt, N2, t21);
  }
};
var wt = n5();
var jt = class extends mt2 {
  ...
  closestEndTo(t21) {
    ...
    return Math.sign(j5(e6(vt, s26, e27), e6(At2, s12(t21), e27))) > 0 ? this.end : this.start;
  }
  getPlane(t21 = M4()) {
    const e27 = s8(Dt, this.end);
    return e27[2] += 1, p5(this.start, this.end, e27, t21);
  }
  getSlicePlane(t21 = M4()) {
    const { start: e27, end: s26, type: r26 } = this.planeLike;
    if (r26 === rt.PLANE) return;
    const n38 = o6(Dt, e27[0], e27[1], 0), i25 = o6(bt, s26[0], s26[1], 0), o19 = c3(bt, i25, n38);
    return l7(n38, o19, t21), t21;
  }
};
var vt = n7();
var At2 = n7();
...
var It = class extends mt2 {
  ...
  closestTo([t21, e27, s26]) {
    return o5(St, t21, e27), E(St, this._origin) || this._applyDirectionAndDistance(St), f8(St[0], St[1], this._z ?? s26);
  }
...
var Vt = (() => {
  ...
  return (e27, s26) => {
    ...
    const i25 = c5();
    return k3(s26.getPlane(t21), r26, n38, i25) ? new gt(i25) : void 0;
  };
})();
...
var Jt = (() => {
  ...
  return (n38, i25, o19) => {
    ...
    if ($3(Q3(n38, u18), 0)) {
      ...
      _5(e27, f18, c18), A5(e27, e27);
      const t22 = new Array(), s26 = t2(u18);
      q2(s26, s26, e27, h18), o19 && !nt(o19, s26) || t22.push(s26);
      const r27 = t2(u18);
      return q2(r27, r27, e27, -h18), o19 && !nt(o19, r27) || t22.push(r27), pe(t22);
    }
    if (g22) return;
    const _13 = -p22 / m15;
    if (Math.abs(_13) > 1 || $3(_13, 1)) return;
    const z14 = Math.atan(l23 / d28), M15 = l4(_13) - z14, w19 = Math.PI - M15, j24 = new Array(), v15 = n5();
    q2(v15, u18, e27, h18 * Math.cos(M15)), q2(v15, v15, r26, h18 * Math.sin(M15)), j24.push(v15);
    const A16 = n5();
    return q2(A16, u18, e27, h18 * Math.cos(w19)), q2(A16, A16, r26, h18 * Math.sin(w19)), j24.push(A16), pe(o19 ? tt(o19, j24) : j24);
  };
})();
function Kt(t21, e27) {
...
var re2 = (() => {
  ...
  return (e27, { center: s26, radius: r26 }) => {
    ...
    return q2(u18, s26, h18, i25), new zt(u18, c18, h18, e27.getSlicePlane());
  };
})();
function ne(t21, e27) {
}
...
var b10 = (() => {
  const e27 = n5(), t21 = n5();
  return (r26, i25) => (o6(e27, r26.x, r26.y, r26.z ?? 0), o6(t21, i25.x, i25.y, i25.z ?? 0), y9(e27, t21, r26.spatialReference, i25.spatialReference));
})();
var y9 = (() => {
  const e27 = n7(), t21 = n5(), r26 = n5();
  return (i25, s26, c18, u18) => {
    if (H(i25, s26)) return;
    const f18 = N4(c18), v15 = N4(u18);
    if (f18 && v15 && s4(f18, v15) && n10(i25, c18, t21, f18) && n10(s26, u18, r26, v15)) {
...
var M8 = (() => {
  ...
  return (t21, r26, n38, a28, s26, l23 = "geodesic") => {
    ...
    if ("geodesic" === l23) {
      const i25 = N4(n38);
      if (i25 && n10(e27, n38, e27, i25)) return j10(t21, e27, f18, a28, i25), t21[2] = r26[2], !!n10(t21, i25, t21, n38);
    }
    ...
    return o6(t21, h18, j24, R19), true;
  };
})();
function T4(e27) {
...
function Z4(e27, n38, t21, r26, o19, i25) {
  ...
  const a28 = c5();
  return E3(e27, n38, r26, a28), a28[2] = 0, u18 && n10(a28, t21, a28, u18) || (l23 = "euclidean", u18 = t21), { mode: l23, view: n38, elevationInfo: r26, hasZ: o19, directionMode: i25, spatialReference: e27.spatialReference, measurementSR: u18, origin: a28 };
}
...
function T5(n38, t21, { context: r26, direction: o19, distance: i25, elevation: l23 }) {
  ...
  if (!a28 || !n10(f18, t21.spatialReference, E6, a28)) return;
...
function G(e27, n38, t21 = c5()) {
  ...
  if (E3(e27, r26, o19, t21), n10(t21, e27.spatialReference, t21, l23)) return "geodesic" !== c18 && c3(t21, t21, u18), t21;
}
function W5(e27, n38, t21, r26) {
  const { view: o19, measurementSR: i25, spatialReference: c18, origin: a28, mode: f18 } = t21;
  if ("geodesic" === f18 ? s8(H3, e27) : u8(H3, e27, a28), n10(H3, i25, H3, c18)) return h8(H3, o19, n38, t21, r26);
}
function C7(e27, n38) {
  var _a;
...
var h9 = class {
  ...
  addToggle(i25, r26) {
    const n38 = m9.fromDefinition(i25, r26), s26 = r3(this._bindings, n38.key, () => []);
    return s26.push(n38), e2(() => C(s26, n38));
  }
...
function U6(r26, e27, a28, n38 = a12, i25 = true) {
...
var N5 = new n11(-180, 180);
var O5 = new n11(-90, 90);
...
function P7(t21, e27) {
  const o19 = a7(e27.vertexSpace), { scale: n38, orientation: a28 } = t21, { transform: l23 } = e27, s26 = q9(l23);
...
function B7(t21) {
  return J2(t21, N2) ? 1 : J2(t21, O8) ? -1 : null;
}
var O8 = y3(n5(), N2);
function C11(t21) {
...
function l17(l23) {
  return A3(l23) ? C3(l23) || O(l23) || w2(l23) || A4(l23) ? w4 : l23 : a6(l23);
}
...
function h13(r26, g22, j24 = r26.hasZ) {
  ...
  const b20 = (t21, o19) => !(o19.length < 2) && (o6(t21, o19[0], o19[1], j24 && o19[2] || 0), true);
  let v15 = 0;
  for (const t21 of r26.rings) {
    const o19 = t21.length;
    if (o19 < 3) continue;
    const { positionsWorldCoords: a28 } = g22;
    for (; a28.length < o19; ) a28.push(n5());
    const j25 = y15, k15 = o6(d22, 0, 0, 0), x15 = 1 / o19;
    for (let n38 = 0; n38 < o19; n38++) {
      if (!b20(j25, t21[n38])) return null;
      if (!n10(j25, r26.spatialReference, a28[n38], h18)) return null;
      q2(k15, k15, a28[n38], x15);
    }
    const C14 = p5(a28[0], a28[1], k15, D());
    if (0 === j6(O2(C14))) continue;
...
function V6(t21, r26, l23, c18) {
  ...
  if (!n10(t21, l23, U11, s26) || !n10(r26, l23, b15, s26)) return null;
  if (c18 === a23.Direct) {
    return { direct: p4(b15, U11), unit: f18 };
  }
  if (o6(S7, t21[0], t21[1], r26[2]), !n10(S7, l23, S7, s26)) return null;
  const h18 = p4(S7, b15);
  if (c18 === a23.Horizontal) return { horizontal: h18, unit: f18 };
  return { direct: p4(b15, U11), horizontal: h18, vertical: Math.abs(p22), unit: f18 };
}
!function(t21) {
...
var I11 = class extends o3.EventedMixin(n32) {
  ...
  initialize() {
    const { view: t21 } = this;
    this.internalGraphicsLayer = new h5({ listMode: "hide", internal: true }), this.view.map.layers.add(this.internalGraphicsLayer);
  ...
  _createOrUpdateGraphic(t21) {
    ...
    const o19 = new d10({ ...this.graphicProperties, symbol: this.graphicSymbol });
    return this._graphic = o19, this.updateGraphicGeometry(t21), this.internalGraphicsLayer.add(o19), this.addHandles(this.initializeGraphic(o19)), this.notifyChange("graphic"), this.addHandles(e2(() => {
  ...
  _getCreateOperationGeometry(t21 = { operationComplete: false }) {
    ...
    switch (x15) {
      ...
      case "polyline":
      case "polygon":
        l23 > 0 && (u18.full = "polygon" === x15 ? j11([p22], h18, d28, true) : R8([p22], h18, d28), u18.cursorEdge = null != c18 && i25 && !a8(r26, i25) ? R8([[c18, e27.pointToArray(i25)]], h18, d28) : null, u18.outline = l23 > 1 ? u18.full : null);
        break;
      case "circle":
      case "rectangle": {
...
var R16 = class {
  ...
  pointToVector(e27) {
    return this._tag(r12(e27.x, e27.y));
  }
  arrayToVector(e27) {
    return this._tag(r12(e27[0], e27[1]));
  }
  vectorToArray(e27) {
    return [e27[0], e27[1]];
  }
  ...
  toXYZ(e27, r26 = n5()) {
    return o6(r26, e27[0], e27[1], 0);
  }
  pointToXYZ(e27, r26 = n5()) {
    return o6(r26, e27.x, e27.y, 0);
  }
  equals(e27, r26) {
    return T(e27, r26);
  }
...
var M14 = class {
  ...
  lerp(e27, r26, t21, a28) {
    return I3(a28, e27, r26, t21);
  }
  addDelta(e27, r26, t21, a28) {
    e27[0] += r26, e27[1] += t21, this._valueType === x12.Z && (e27[2] += a28);
  }
  distance(e27, t21) {
    return this._valueType === x12.Z ? p4(e27, t21) : m3(w16(e27), w16(t21));
  }
  getZ(e27, r26 = void 0) {
  ...
  toXYZ(e27, r26 = n5()) {
    return o6(r26, e27[0], e27[1], this._valueType === x12.Z ? e27[2] : 0);
  }
  pointToXYZ(e27, r26 = n5()) {
    return o6(r26, e27.x, e27.y, this._valueType === x12.Z ? e27.z ?? 0 : 0);
  }
  equals(e27, r26) {
    return J2(e27, r26);
  }
...
var z11 = class {
  ...
  toXYZ(e27, r26 = n5()) {
    return o6(r26, e27[0], e27[1], e27[2]);
  }
  pointToXYZ(e27, r26 = n5()) {
    return o6(r26, e27.x, e27.y, e27.z ?? 0);
  }
  equals(e27, r26) {
    return L3(e27, r26);
  }
...
var P10 = class _P {
  ...
  constructor(t21, i25, e27, s26 = 0, n38 = j21.IMMEDIATE) {
    this._helper = t21, this._planeType = i25, this._edge = e27, this.distance = s26, this._plane = M4(), this._offsetPlane = M4(), this._minDistance = -1 / 0, this._maxDistance = 1 / 0, this._selectedArrow = 1, n38 === j21.IMMEDIATE && this._initialize();
  }
  _initialize() {
  ...
  _computeNeighbor(t21, i25, e27, s26) {
    ...
    return this._helper.hasZ() ? s26 && (_5(n38, e27, s26.direction), _5(n38, n38, e27), A5(n38, n38), Math.sign(n38[1]) !== Math.sign(e27[0]) && g5(n38, n38, -1)) : o6(n38, -e27[1], e27[0], 0), { start: t21, end: i25, direction: n38, isOriginalDirection: true };
  }
  _passesBisectingAngleThreshold(t21, i25) {
    const e27 = Math.abs(a9(i25, t21));
    return e27 >= y17 && e27 <= Math.PI - y17;
  }
  _bisectVectorsPerpendicular(t21, i25) {
    const e27 = P3(t21, i25) < 0 ? t21 : y3(n5(), t21), s26 = Math.abs(P3(e27, i25));
    if (!(s26 < A14 || s26 > 1 - A14)) return this._bisectDirection(e27, i25);
    const n38 = _5(n5(), e27, [0, 0, 1]);
    return A5(n38, n38);
  }
  _bisectDirection(t21, i25) {
    const e27 = u8(n5(), t21, i25);
    return A5(e27, e27);
  }
  _initializePlane() {
    const t21 = this._computeNormalDirection(this._left), i25 = this._computeNormalDirection(this._right);
    P3(t21, i25) < 0 && y3(i25, i25), l7(this._left.start, this._bisectDirection(t21, i25), this._plane);
  }
  _computeNormalDirection(t21) {
    const i25 = _5(n5(), t21.direction, this._edgeDirection);
    A5(i25, i25);
    const e27 = _5(n5(), this._edgeDirection, i25);
  ...
  _updateIntersectDistanceConstraint(t21) {
    const i25 = O2(t21), h18 = this._edgeDirection, o19 = u8(n5(), this._left.start, this._left.direction), a28 = u8(n5(), this._right.start, this._right.direction), _13 = this._pointInBasis2D(n7(), i25, h18, this._left.start), l23 = this._pointInBasis2D(n7(), i25, h18, o19), p22 = this._pointInBasis2D(n7(), i25, h18, this._right.start), d28 = this._pointInBasis2D(n7(), i25, h18, a28), [u18] = b9({ start: l23, end: _13, type: j12.LINE }, { start: d28, end: p22, type: j12.LINE });
    if (!u18) return;
    const m15 = e6(n7(), _13, l23);
    v3(m15, m15);
    const D10 = e6(n7(), u18, l23), x15 = j5(m15, D10), b20 = u8(n5(), o19, g5(n5(), this._left.direction, -x15)), I12 = V2(t21, b20);
    this._updateDistanceConstraint(I12);
  }
  _pointInBasis2D(t21, i25, e27, s26) {
    return t21[0] = f6(i25, s26), t21[1] = f6(e27, s26), t21;
  }
  _offset(t21, i25) {
    ...
    const e27 = (t22, i26, e28) => null != i26 && k3(this._offsetPlane, t22, u8(n5(), t22, i26), e28), s26 = n5();
  ...
  clampedStartAndEnd(i25) {
    const e27 = this._helper.toXYZ(this._helper.pointToVector(i25)), s26 = H2(this._plane, e27, n5()), n38 = V2(this._plane, e27), r26 = r7(n38, this._minDistance, this._maxDistance);
    return I3(e27, s26, e27, r26 / n38), { start: s26, end: e27 };
  }
  apply(t21) {
  ...
  clone() {
    ...
    return h3(t21._plane, this._plane), h3(t21._offsetPlane, this._offsetPlane), t21._maxDistance = this._maxDistance, t21._minDistance = this._minDistance, t21._left = this._cloneNeighbor(this._left), t21._right = this._cloneNeighbor(this._right), t21._edgeDirection = s8(n5(), this._edgeDirection), t21;
  }
  _maybeEqualsVec3(t21, i25) {
    return null == t21 && null == i25 || null != t21 && null != i25 && J2(t21, i25);
  }
  _cloneNeighbor({ start: t21, end: i25, direction: e27, isOriginalDirection: s26 }) {
    return { start: s8(n5(), t21), end: null != i25 ? s8(n5(), i25) : null, direction: s8(n5(), e27), isOriginalDirection: s26 };
  }
};
var y17 = s6(15);
var A14 = 1e-3;
...
var e23 = class _e2 {
  ...
  _rotate(t21, i25) {
    I2(t21.pos, t21.pos, this.origin, i25);
  }
  apply(t21) {
...
var c17 = class _c {
  constructor(t21, s26, c18, o19, r26 = e22.CUMULATIVE) {
    this.origin = t21, this.axis1 = s26, this.factor1 = c18, this.factor2 = o19, this._accumulationType = r26, this.axis2 = r12(s26[1], -s26[0]);
  }
  _scale(t21, i25, a28) {
    k2(t21.pos, t21.pos, this.origin, this.axis1, i25), k2(t21.pos, t21.pos, this.origin, this.axis2, a28);
  }
  apply(t21) {
...
var E11 = class _E extends o3 {
  ...
  createResetState() {
    ...
    return e2(() => this.trySetGeometry(t21));
  }
  closeComponent(t21) {
  ...
  createUndoGroup() {
    const t21 = new s22();
    return this._apply(t21), e2(() => t21.close());
  }
  undo() {
...
function f17({ predicate: o19 = () => true, snappingManager: i25, snappingContext: l23, updatingHandles: u18, useZ: c18 = true }) {
  ...
  const T10 = () => {
    Z11 = e(Z11), i25.doneSnapping(), j24 == null ? void 0 : j24.frameTask.remove(), j24 = null, f18 = l(f18), z14 = null;
  }, k14 = d25(i25, c18, p22);
...
function d25(n38, e27, t21) {
  return k(async ({ frameTask: o19, point: r26, scenePoint: l23, context: a28, event: s26, delta: u18, getLastState: c18 }, p22) => {
    ...
    if (f18.valid) {
      ...
      const d28 = c18();
      null != d28.point && r26 !== d28.point && (l24 = n38.update({ point: d28.point, scenePoint: d28.scenePoint, context: a28 })), null != d28.updatePoint && a8(l24, d28.updatePoint) || (h15(s26.mapEnd, l24, u18, e27), t21.execute(s26));
    }
  });
}
function m12(n38) {
  return "3d" === n38.type ? n38.resourceController.scheduler.registerTask(g4.SNAPPING) : F2;
}
...
var p21 = class extends b {
  ...
  initialize() {
    ...
    this._frameTask = null != t21 ? t21.registerTask(g4.SNAPPING) : F2;
  }
  destroy() {
...
var F11 = class extends o3.EventedMixin(b) {
  constructor(t21) {
    super(t21), this._createOperationCompleted = false, this._hideDefaultCursor = false, this._pointerDownStates = new s11(), this._stagedScreenPoint = null, this._stagedPointerType = null, this._updatingHandles = new h2(), this._stagedPointerId = null, this.constraintsEnabled = false, this.constraints = void 0, this._getPointConstraint = t10(V4), this._getPolylineOrPolygonConstraint = t10(k6), this.constraintZ = null, this.defaultZ = null, this.isDraped = true, this.labelOptions = new c14(), this.cursor = null, this.loading = false, this.snapToSceneEnabled = null, this.firstVertex = null, this.lastVertex = null, this.secondToLastVertex = null, null == t21.elevationInfo && (this.elevationInfo = u10(!!t21.hasZ));
  }
  initialize() {
    ...
    this.coordinateHelper = P9(this.hasZ, this.hasM, i25), this._editGeometryOperations = new E11(new p19(o19, this.coordinateHelper), n38), this._snappingOperation = new p21({ view: e27 }), this.addHandles([d3(() => ({ stagedPoint: this._snappingOperation.stagedPoint, constraint: this._constraint }), ({ stagedPoint: t22, constraint: e28 }, i26) => {
      ...
      t22 && e28 && d7(t22, e28) && this._onKeyboardBasedChange();
    ...
    null != s26 && (s26.context = { view: e27, editGeometryOperations: this._editGeometryOperations, elevationInfo: this.elevationInfo, labelOptions: this.labelOptions }, this.addHandles(d3(() => this.labelOptions.enabled, (t22) => {
      ...
      switch (a8(r26, this.secondToLastVertex) || (this.secondToLastVertex = r26), this._processCursor(this.cursorVertex), t22.type) {
        case "vertex-add":
...
var h16 = class {
  ...
  constrainZ(e27) {
    ...
    return this.hasZ && e27.z !== t21 && ((e27 = x2(e27)).z = t21), e27;
  }
};
var u15 = class _u {
  screenToMap(e27) {
...
var E13 = class extends I11 {
  ...
  initializeGraphic(e27) {
    return null != this._visualElementSymbols.fill && (e27.symbol = this._visualElementSymbols.fill), this.internalGraphicsLayer.graphics.sort(G5), e2();
  }
  makeDrawOperation() {
  ...
  onActiveVertexChanged(e27) {
    if ("point" === this.geometryType) return e2();
    const [s26, a28] = e27, l23 = new j2({ x: s26, y: a28, spatialReference: this.view.spatialReference });
    return null != this._visualElementGraphics.activeVertex ? (this._visualElementGraphics.activeVertex.geometry = l23, e2()) : (this._visualElementGraphics.activeVertex = new d10({ geometry: l23, symbol: this._visualElementSymbols.activeVertex, attributes: { displayOrder: 2 } }), this.internalGraphicsLayer.add(this._visualElementGraphics.activeVertex), this.internalGraphicsLayer.graphics.sort(G5), e2(() => {
  ...
  onCursorEdgeChanged(e27) {
    return null != this._visualElementGraphics.activeEdge ? (this._visualElementGraphics.activeEdge.geometry = e27, e2()) : (this._visualElementGraphics.activeEdge = new d10({ geometry: e27, symbol: this._visualElementSymbols.outline, attributes: { displayOrder: 0 } }), this.internalGraphicsLayer.add(this._visualElementGraphics.activeEdge), this.internalGraphicsLayer.graphics.sort(G5), e2(() => {
  ...
  onRegularVerticesChanged(e27) {
    ...
    return null != this._visualElementGraphics.regularVertices ? (this._visualElementGraphics.regularVertices.geometry = s26, e2()) : (this._visualElementGraphics.regularVertices = new d10({ geometry: s26, symbol: this._visualElementSymbols.regularVertices, attributes: { displayOrder: 1 } }), this.internalGraphicsLayer.add(this._visualElementGraphics.regularVertices), this.internalGraphicsLayer.graphics.sort(G5), e2(() => {
...
var S10 = class extends b {
  ...
  get elevationInfo() {
    ...
    return new h4({ mode: o19, offset: i25 });
  }
  ...
  _intersectDistance2D(t21, e27, o19, i25) {
    var _a, _b;
    if (null == (i25 = i25 || J3(o19))) return null;
    const s26 = 1;
  ...
  _intersectDistance3D(t21, e27, o19) {
    ...
    return i25 && c4(i25, C13, t21.renderSpatialReference) ? p4(C13, t21.state.camera.eye) : null;
  }
};
...
var v13 = 1;
var S11 = 10;
var k13 = new l6("#009af2");
var b19 = class extends n32 {
  constructor(t21) {
    super(t21), this._isOpacityToggled = false, this._isModifierActive = false, this._factor = 1, this._initialControlPoints = null, this._graphicsLayer = new h5({ internal: true, listMode: "hide", visible: false, effect: "drop-shadow(0px, 0px, 3px)" }), this._undoStack = [], this._redoStack = [], this._sharedUndoStack = [], this._sharedRedoStack = [], this._highlightHandle = null, this.activeHandle = 0, this.type = "reshape";
  }
  initialize() {
    this._initialize();
  }
...
function V9(o19, i25, r26 = false) {
  ...
  u8(i25.origin, i25.origin, s26), K3(i25);
}
function h17(o19, i25, r26 = false) {
  const t21 = r26 ? -o19.angle : o19.angle;
  w3(i25.basis1, i25.basis1, _2, t21), w3(i25.basis2, i25.basis2, _2, t21), K3(i25);
}
function v14(i25, r26, t21 = false) {
  const s26 = t21 ? 1 / i25.factor1 : i25.factor1, n38 = t21 ? 1 / i25.factor2 : i25.factor2;
  g5(r26.basis1, r26.basis1, s26), g5(r26.basis2, r26.basis2, n38), k2(r26.origin, r26.origin, i25.origin, i25.axis1, s26), k2(r26.origin, r26.origin, i25.origin, i25.axis2, n38), K3(r26);
}
function F12(o19, c18, f18, m15) {
  m15 || (m15 = W2());
  const p22 = o5(t3.get(), o19[1], -o19[0]), g22 = o5(t3.get(), Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY), N11 = o5(t3.get(), Number.NEGATIVE_INFINITY, Number.NEGATIVE_INFINITY), j24 = t3.get();
  c18.components.forEach((n38) => n38.vertices.forEach(({ pos: n39 }) => {
    o5(j24, j5(o19, n39), j5(p22, n39)), f5(g22, g22, j24), M3(N11, N11, j24);
  }));
  const l23 = 1e-6, x15 = o5(t3.get(), N11[0] - g22[0] < l23 ? f18 / 2 : 0, N11[1] - g22[1] < l23 ? f18 / 2 : 0);
  return e6(g22, g22, x15), u7(N11, N11, x15), l5(m15.basis1, o19, (N11[0] - g22[0]) / 2), l5(m15.basis2, p22, (N11[1] - g22[1]) / 2), o5(m15.origin, g22[0] * o19[0] + g22[1] * p22[0], g22[0] * o19[1] + g22[1] * p22[1]), u7(m15.origin, m15.origin, m15.basis1), u7(m15.origin, m15.origin, m15.basis2), K3(m15), m15;
}

// node_modules/@arcgis/core/views/2d/interactive/editingTools/manipulations/RotateManipulation.js
var u17 = class extends r23 {
  constructor(i25) {
    super(), this._handles = new r2(), this._originCache = n5(), this._view = i25.view, this._tool = i25.tool, this._graphic = i25.graphic, this._snapRotation = i25.snapRotation, this._manipulator = this._createManipulator(), this._handles.add([this._manipulator.events.on("grab-changed", (t21) => n36(t21, this._manipulator))]), this.forEachManipulator((t21) => this._tool.manipulators.add(t21));
  }
  destroy() {
...
var y20 = 0.3;
function j23(t21) {
  const i25 = r11(t21.basis1), e27 = r11(t21.basis2);
  return y20 * Math.min(i25, e27);
}
var w18 = class extends r23 {
  constructor(i25) {
    super(), this._handles = new r2(), this._planeStart = W2(), this._displayPlaneStart = W2(), this._originCache = n5(), this._axisCache = n7(), this._renderStartCache = n5(), this._renderEndCache = n5(), this._resizeOriginCache = n5(), this._view = i25.view, this._tool = i25.tool, this._graphic = i25.graphic, this._direction = i25.direction, this._preserveAspectRatio = i25.preserveAspectRatio, this._manipulator = this._createManipulator(), this._handles.add([this._manipulator.events.on("grab-changed", (t21) => n36(t21, this._manipulator))]), this.forEachManipulator((t21) => this._tool.manipulators.add(t21));
  }
  destroy() {
    this._handles.destroy(), this.forEachManipulator((t21) => {
      this._tool.manipulators.remove(t21), t21.destroy();
  ...
  createDragPipeline(t21, r26) {
    ...
    return p20(this._manipulator, (f18, M15) => {
      M15.next((i25) => {
        ...
        q2(r27, r27, w19.basis1, -P13[0]), q2(r27, r27, w19.basis2, -P13[1]), c3(e27, e27, r27), c3(i25, i25, r27);
        const c19 = 0 !== P13[0] && 0 !== P13[1], p22 = j23(w19), u18 = j23(h18) / p22, _14 = (t23, r28) => {
          if (0 === t23) return 1;
          let s26 = r11(r28), n38 = 0.5 * t23 * P3(r28, e27) / s26;
          const o19 = n38 < 0 ? -1 : 1;
          if (c19) {
        ...
        q2(a28, a28, y21.basis1, -P13[0]), q2(a28, a28, y21.basis2, -P13[1]);
        const o19 = o5(this._axisCache, y21.basis1[0], y21.basis1[1]);
        v3(o19, o19);
...
var $6 = class extends n32 {
  constructor(e27) {
    super(e27), this._initialControlPoints = null, this._initialGeometry = null, this._graphic = null, this._planeCache = W2(), this._displayPlaneCache = W2(), this._mainAxisCache = n7(), this._rotationHandleCache = n5(), this._cornerA = n5(), this._cornerB = n5(), this._cornerC = n5(), this._cornerD = n5(), this._avgAB = n5(), this._avgBC = n5(), this._avgCD = n5(), this._avgDA = n5(), this._preserveAspectRatio = new s25(), this._snapRotation = new r24(), this._graphicsLayer = new h5({ internal: true, listMode: "hide", visible: false }), this._sharedUndoStack = [], this._sharedRedoStack = [], this._isOpacityToggled = false, this._factor = Y3, this.preserveAspectRatio = null, this.snapRotation = null, this.type = "transform";
  }
  initialize() {
    this._initialize();
  }
  ...
  get _plane() {
    ...
    if (null == e27) return null;
    const t21 = this._editGeometryOperations.data, i25 = t21.components[0].edges[0], s26 = e6(this._mainAxisCache, i25.leftVertex.pos, i25.rightVertex.pos);
    v3(s26, s26);
  ...
  get _displayPlane() {
    ...
    return g5(t21.basis1, t21.basis1, 1 + i25 / r11(t21.basis1)), g5(t21.basis2, t21.basis2, 1 + i25 / r11(t21.basis2)), t21;
  }
  ...
  get _rotateGraphicGeometry() {
    ...
    return A5(t21, e27.basis1), g5(t21, t21, Q8 * this.view.resolution), u8(t21, t21, e27.origin), u8(t21, t21, e27.basis1), new j2({ x: t21[0], y: t21[1], spatialReference: this.view.spatialReference });
  }
  get _scaleGraphicGeometries() {
    ...
    const { _cornerA: i25, _cornerB: s26, _cornerC: o19, _cornerD: r26 } = this, a28 = I3(this._avgAB, i25, s26, 0.5), n38 = I3(this._avgBC, s26, o19, 0.5), c18 = I3(this._avgCD, o19, r26, 0.5), h18 = I3(this._avgDA, r26, i25, 0.5);
...
//# sourceMappingURL=editingTools-7SRXMTK6.js.map
