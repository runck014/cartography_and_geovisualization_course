...
var b2 = class {
  getIconPlacement(n5, s6, o6) {
    ...
    l6 && (r6 += n5.angle);
    const m2 = new u2([]);
    return o6.allowOverlap && o6.ignorePlacement || !o2 || (m2.iconColliders = []), this._addIconPlacement(m2, a6, s6, o6, r6), l6 && h5 && this._addIconPlacement(m2, a6, s6, o6, r6 + o), m2;
  }
  ...
  getTextPlacement(s6, o6, a6, c5) {
    ...
    for (const t5 of o6) {
      ...
      } else m2.push(new f2(x2, _2, _2, g2, false)), y2 && b4 && m2.push(new f2(x2, _2 + o, _2 + o, g2, false));
  ...
  _placeGlyph(t5, s6, l6, h5, r6, c5, g2, m2, x2) {
    let d2 = c5;
    const p4 = d2 < 0 ? a(t5.angle + o, e2) : t5.angle;
    let w2 = 0;
    l6 < 0 && (d2 *= -1, l6 *= -1, w2 = o), d2 > 0 && ++r6;
    let T2 = new h(t5.x, t5.y), y2 = h5[r6], I4 = r;
    if (h5.length <= r6) return I4;
    for (; ; ) {
      const e6 = y2.x - T2.x, t6 = y2.y - T2.y, i5 = Math.sqrt(e6 * e6 + t6 * t6), n5 = Math.max(l6 / i5, s6), c6 = e6 / i5, u4 = t6 / i5, b4 = a(Math.atan2(u4, c6) + w2, e2);
...
var o4 = class extends t3 {
  ...
  add(t5, o6, r6, u4, h5, a6, n5, d2, e6, p4, i5, c5) {
    ...
    M.push(l6);
    const m2 = 31;
    l6 = t3.i8888to32(Math.round(m2 * r6), Math.round(m2 * u4), Math.round(m2 * h5), Math.round(m2 * a6)), M.push(l6), l6 = t3.i8888to32(Math.round(m2 * n5), Math.round(m2 * d2), Math.round(m2 * e6), Math.round(m2 * p4)), M.push(l6), l6 = t3.i1616to32(i5, 0), M.push(l6), c5 && M.push(...c5);
  }
};
...
var u3 = class extends t3 {
  ...
  add(t5, o6, r6, u4, h5, a6, n5) {
    ...
    d2.push(p4);
    const i5 = 15;
    return p4 = t3.i8888to32(Math.round(i5 * r6), Math.round(i5 * u4), h5, a6), d2.push(p4), n5 && d2.push(...n5), e6;
  }
};
var h4 = class extends t3 {
  ...
  add(o6, r6, u4, h5, a6, n5, d2, e6, p4, i5, c5, M) {
    ...
    l6.push(m2), m2 = t3.i1616to32(Math.round(8 * u4), Math.round(8 * h5)), l6.push(m2), m2 = t3.i8888to32(a6 / 4, n5 / 4, e6, p4), l6.push(m2), m2 = t3.i8888to32(0, f(d2), 10 * i5, Math.min(10 * c5, 255)), l6.push(m2), M && l6.push(...M);
  }
};
...
var s4 = class _s extends t4 {
  ...
  _processFill(r6, l6, n5, s6, o6) {
    ...
    const h5 = e3(d2, a6, 2);
    if (s6 && e3.deviation(d2, a6, 2, h5) > 0) {
      const t5 = l6.map((t6) => r6[t6].length), { buffer: e6, vertexCount: s7 } = a2(d2, t5);
      if (s7 > 0) {
...
var L = class _L extends t4 {
  ...
  static _pushAnchors(e6, t5, n5, i5) {
    ...
    for (let s6 = 0; s6 < f3; s6++) {
      ...
      for (; d2 + n5 < c5 + f4; ) {
        d2 += n5;
        const t6 = (d2 - c5) / f4, y2 = p(i6.x, a7.x, t6), m2 = p(i6.y, a7.y, t6);
  ...
  static _pushCenterAnchor(e6, t5) {
    ...
    for (let s6 = 0; s6 < r6; s6++) {
      ...
      if (a6 < o6 + c5) {
        const t6 = (a6 - o6) / c5, d2 = p(n6.x, i6.x, t6), f3 = p(n6.y, i6.y, t6), g2 = Math.atan2(h5, r7);
...
var g = class {
  ...
  _processLayers(e6) {
    ...
    for (let f3 = s6.length - 1; f3 >= 0; f3--) {
      ...
      if (e7.type === a3.BACKGROUND || !this._canParseStyleLayer(e7.uid) || !t5[e7.source] || !i5[e7.source]) continue;
...
//# sourceMappingURL=WorkerTileHandler-DGIX2SRC.js.map
