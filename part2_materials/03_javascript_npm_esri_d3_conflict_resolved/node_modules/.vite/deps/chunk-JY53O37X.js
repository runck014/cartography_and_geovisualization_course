...
function t4(t5) {
  t5.vertex.uniforms.add(new o5("renderTransparentlyOccludedHUD", (e6, o10) => o10.hudRenderStyle === c.Occluded ? 1 : o10.hudRenderStyle === c.NotOccluded ? 0 : 0.75), new e3("viewport", (e6, r5) => r5.camera.fullViewport), new s3("hudVisibilityTexture", (e6, r5) => {
    var _a;
...
posProj = alignToPixelOrigin(posProj, viewport.zw);
  ...
  M2.main.add(o3`
    ...
    bool alphaDiscard = vcolor.a < ${o3.float(o2)};
    ${r3(T2, `alphaDiscard = alphaDiscard && outlineColor.a < ${o3.float(o2)};`)}
    if (alphaDiscard) {
    ...
    vsize = inputSize;
  `), H2.uniforms.add(new s3("tex", (e6) => e6.texture)), o10.occludedFragmentFade && (H2.uniforms.add(new s3("depthMap", (e6, o11) => o11.mainDepth)), H2.uniforms.add(new o5("fadeFactor", () => L.occludedFadeFactor)));
  const _ = o10.debugDrawLabelBorder ? o3`(isBorder > 0.0 ? 0.0 : ${o3.float(o2)})` : o3.float(o2), I = o10.output === n2.Highlight, q = o3`
    ...
    ${T2 ? o3`
      ...
      if (outlineSize > 0.25) {
        ...
        if (
          ...
          fillPixelColor.a + outlinePixelColor.a < ${o3.float(o2)}
        ) {
          discard;
        }
...
function M(o10, r5, i) {
  null != r5 ? o(i, o10[0] * (r5[2] - r5[0]) + r5[0], o10[1] * (r5[3] - r5[1]) + r5[1]) : o(i, 0, 0);
}
var R = n();
...
//# sourceMappingURL=chunk-JY53O37X.js.map
