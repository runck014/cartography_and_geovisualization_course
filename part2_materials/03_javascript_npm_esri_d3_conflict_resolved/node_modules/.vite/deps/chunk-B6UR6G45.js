...
function s(t, r) {
  const { width: i, height: a, getFrame: n3 } = t, o2 = r / t.duration, s2 = t.frameDurations.map((t2) => n(t2 * o2));
  return { frameCount: t.frameCount, duration: t.duration, frameDurations: s2, getFrame: n3, width: i, height: a };
}
function m2(t, r) {
  const { width: i, height: a, getFrame: n3 } = t, o2 = t.frameDurations.slice(), s2 = o2.shift();
  return o2.unshift(n(s2 + r)), { frameCount: t.frameCount, duration: t.duration + r, frameDurations: o2, getFrame: n3, width: i, height: a };
}
function u(t, r) {
  const { width: i, height: a, getFrame: n3 } = t, o2 = t.frameDurations.slice(), s2 = o2.pop();
  return o2.push(n(s2 + r)), { frameCount: t.frameCount, duration: t.duration + r, frameDurations: o2, getFrame: n3, width: i, height: a };
}
var h = class {
...
//# sourceMappingURL=chunk-B6UR6G45.js.map
