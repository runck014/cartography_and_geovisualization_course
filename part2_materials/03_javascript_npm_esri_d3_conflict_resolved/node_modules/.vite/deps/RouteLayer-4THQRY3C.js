...
async function d6(t4, o6, s4) {
  ...
  const n6 = i2({ f: "json", token: o6 }, s4), { data: l7 } = await U(t4, n6), u7 = l7.currentVersion >= 10.4 ? p3(t4, o6, s4) : v2(t4, s4), { defaultTravelMode: f7, supportedTravelModes: c15 } = await u7;
  return l7.defaultTravelMode = f7, l7.supportedTravelModes = c15, m4.fromJSON(l7);
}
async function v2(r5, t4) {
  var _a, _b, _c;
  const i8 = i2({ f: "json" }, t4), { data: l7 } = await U(r5.replace(/\/rest\/.*$/i, "/info"), i8);
  ...
  const v3 = f3(u7), p8 = /\/solve$/i.test(v3.path) ? "Route" : /\/solveclosestfacility$/i.test(v3.path) ? "ClosestFacility" : "ServiceAreas", m9 = i2({ f: "json", serviceName: p8 }, t4), h2 = jt(d7) + "/GetTravelModes/execute", g2 = await U(h2, m9), w4 = [];
  let T2 = null;
...
async function p3(t4, o6, n6) {
  try {
    const r5 = i2({ f: "json", token: o6 }, n6), i8 = jt(t4) + "/retrieveTravelModes", { data: { supportedTravelModes: l7, defaultTravelMode: u7 } } = await U(i8, r5);
...
async function l5(f7, p8, l7) {
  const y6 = [], d7 = [], g2 = {}, h2 = {}, R4 = f3(f7), { path: v3 } = R4;
...
var pe = class extends l(t2(b2(j2(S2(f5))))) {
  constructor(e2) {
  ...
  async saveAs(e2, t4 = {}) {
    ...
    r5.extent ?? (r5.extent = await $(this.fullExtent)), r5.id = null, r5.portal ?? (r5.portal = b4.getDefault()), r5.title ?? (r5.title = this.title), r5.type = "Feature Collection", r5.typeKeywords = ["Data", "Feature Collection", f4.MULTI_LAYER, "Route Layer"];
    ...
    return await o6.user.addItem({ item: r5, folder: s4, data: n6 }), this.portalItem = r5, i3(i8), i8.portalItem = r5, r5;
  }
  async solve(e2, t4) {
...
//# sourceMappingURL=RouteLayer-4THQRY3C.js.map
