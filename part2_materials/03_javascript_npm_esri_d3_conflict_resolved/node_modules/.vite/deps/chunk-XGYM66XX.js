...
function t(r2, t3, f, c, i, m) {
  return e[0] = r2, e[1] = t3, e[2] = f, n2(e, c, 0, i, m, 0);
}
var e = n();
...
var s6 = class _s {
  ...
  constructor(s7) {
    if (this.steps = [], this._cachedProjection = {}, this._chain = "", this._gtlistentry = null, s7 == null ? void 0 : s7.steps) for (const e2 of s7.steps) e2 instanceof t2 ? this.steps.push(e2) : this.steps.push(new t2({ wkid: e2.wkid, wkt: e2.wkt, isInverse: e2.isInverse }));
  }
  getInverse() {
    const t3 = new _s();
    t3.steps = [];
...
function k() {
  return !!_2() || (a(T), W(), false);
}
function B(n3, e2) {
  return !n3 || !e2 || (J(n3, e2) || k());
}
function U(n3, e2) {
  return !J(n3, e2) && !_2();
}
function W(n3) {
  return null == b && (b = Promise.all([_(), import("./geometryEngineBase-KWFKUUKH.js").then((n4) => n4.g), import("./hydrated-3A7WMC5J.js")])), b.then(([, r2, { hydratedAdapter: t3 }]) => {
    s2(n3), P = t3, G3 = r2.default, G3._enableProjection(G), T.notify();
  });
}
function K(n3, e2, r2 = null, t3 = null) {
  return Array.isArray(n3) ? 0 === n3.length ? [] : O3(P, n3, n3[0].spatialReference, e2, r2, t3) : O3(P, [n3], n3.spatialReference, e2, r2, t3)[0];
}
function O3(n3, e2, r2, t3, l = null, o2 = null) {
  if (null == r2 || null == t3) return e2;
  if (J(r2, t3, l)) return e2.map((n4) => Q(n4, r2, t3));
  if (null == l && A(r2)) {
    return e2.map((n4) => Q(n4, r2, g2.WGS84)).map((n4) => H(n4, t3));
  }
  if (null == l && A(t3)) {
    return e2.map((n4) => H(n4, g2.WGS84)).map((n4) => Q(n4, g2.WGS84, t3));
  }
  if (null == l) {
...
function X(n3, e2) {
  if (!_2()) {
    for (const r2 of n3) if (null != r2 && !s4(r2.spatialReference, e2) && g(r2.spatialReference) && g(e2) && !J(r2.spatialReference, e2)) return a(T), { pending: W(), geometries: null };
  }
  return { pending: null, geometries: n3.map((n4) => null == n4 ? null : s4(n4.spatialReference, e2) ? n4 : g(n4.spatialReference) && g(e2) ? H(n4, e2) : null) };
}
function Y(n3, e2, r2 = null) {
  if (null == n3 || null == e2) return null;
  if (null == G3 || null == P) throw new C2();
  const t3 = G3._getTransformation(P, n3, e2, r2, r2 == null ? void 0 : r2.spatialReference);
  return null !== t3 ? s6.fromGE(t3) : null;
}
function q(n3, e2, r2 = null) {
  if (null == G3 || null == P) throw new C2();
  const t3 = G3._getTransformationBySuitability(P, n3, e2, r2, r2 == null ? void 0 : r2.spatialReference);
  if (null !== t3) {
    const n4 = [];
...
async function I(n3, e2, r2) {
  const t3 = n3.spatialReference;
  return null != t3 && null != e2 && await N(t3, e2, null, r2), H(n3, e2);
}
function J(n3, e2, r2) {
  return !r2 && (!!s4(n3, e2) || g(n3) && g(e2) && !!G2(n3, e2, En));
}
function L(n3, e2) {
  if (s4(n3, e2)) return true;
  if (!g(n3) || !g(e2)) return false;
  const r2 = C(n3) || O(n3) || w(n3), t3 = C(e2) || O(e2) || w(e2);
  return r2 && t3;
}
async function N(n3, e2, t3, l) {
  if (_2()) return D(l);
  if (Array.isArray(n3)) {
    for (const { source: r2, dest: o2, geographicTransformation: i } of n3) if (r2 && o2 && !J(r2, o2, i)) return W(l);
  } else if (n3 && e2 && !J(n3, e2, t3)) return W(l);
  return D(l);
}
function Q(n3, e2, r2) {
  return n3 ? "x" in n3 ? nn(n3, e2, new j(), r2, 0) : "xmin" in n3 ? an(n3, e2, new w2(), r2, 0) : "rings" in n3 ? un(n3, e2, new v(), r2, 0) : "paths" in n3 ? ln(n3, e2, new d(), r2, 0) : "points" in n3 ? rn(n3, e2, new u(), r2, 0) : null : null;
}
...
function nn(n3, e2, r2, t3, l) {
  fn[0] = n3.x, fn[1] = n3.y;
  const o2 = n3.z;
  return fn[2] = void 0 !== o2 ? o2 : l, n2(fn, e2, 0, fn, t3, 0) ? (r2.x = fn[0], r2.y = fn[1], r2.spatialReference = t3, void 0 !== o2 || O2(t3) ? (r2.z = fn[2], r2.hasZ = true) : (r2.z = void 0, r2.hasZ = false), void 0 === n3.m ? (r2.m = void 0, r2.hasM = false) : (r2.m = n3.m, r2.hasM = true), r2) : null;
}
...
function rn(n3, e2, r2, t3, l) {
  const { points: o2, hasZ: i, hasM: s7 } = n3, a2 = [], c = o2.length, f = [];
  for (const u2 of o2) f.push(u2[0], u2[1], i ? u2[2] : l);
  if (!n2(f, e2, 0, f, t3, 0, c)) return null;
  const p = i || O2(t3);
  for (let u2 = 0; u2 < c; ++u2) {
    const n4 = 3 * u2, e3 = f[n4], r3 = f[n4 + 1];
    p && s7 ? a2.push([e3, r3, f[n4 + 2], o2[u2][3]]) : p ? a2.push([e3, r3, f[n4 + 2]]) : s7 ? a2.push([e3, r3, o2[u2][2]]) : a2.push([e3, r3]);
  }
  return r2.points = a2, r2.spatialReference = t3, r2.hasZ = i, r2.hasM = s7, r2;
}
...
function ln(n3, e2, r2, t3, l) {
  const { paths: o2, hasZ: i, hasM: s7 } = n3, a2 = [];
  if (!cn(o2, i ?? false, s7 ?? false, e2, a2, t3, l)) return null;
  const c = i || O2(t3);
  return r2.paths = a2, r2.spatialReference = t3, r2.hasZ = c, r2.hasM = s7, r2;
}
...
function un(n3, e2, r2, t3, l) {
  const { rings: o2, hasZ: i, hasM: s7 } = n3, a2 = [];
  if (!cn(o2, i ?? false, s7 ?? false, e2, a2, t3, l)) return null;
  const c = i || O2(t3);
  return r2.rings = a2, r2.spatialReference = t3, r2.hasZ = c, r2.hasM = s7, r2;
}
...
function an(n3, e2, r2, t3, l) {
  const { xmin: o2, ymin: i, xmax: s7, ymax: a2, hasZ: c, hasM: f } = n3, p = c ? n3.zmin : l;
  if (!t(o2, i, p, e2, fn, t3)) return null;
  const m = c || O2(t3);
  r2.xmin = fn[0], r2.ymin = fn[1], m && (r2.zmin = fn[2]);
  const h = c ? n3.zmax : l;
  return t(s7, a2, h, e2, fn, t3) ? (r2.xmax = fn[0], r2.ymax = fn[1], m && (r2.zmax = fn[2]), f && (r2.mmin = n3.mmin, r2.mmax = n3.mmax), r2.spatialReference = t3, r2) : null;
}
function cn(n3, e2, r2, t3, l, o2, i = 0) {
  const s7 = new Array();
  for (const u2 of n3) for (const n4 of u2) s7.push(n4[0], n4[1], e2 ? n4[2] : i);
  if (!n2(s7, t3, 0, s7, o2, 0)) return false;
  let a2 = 0;
  l.length = 0;
  const c = e2 || O2(o2);
  for (const u2 of n3) {
    const n4 = new Array();
    for (const e3 of u2) c && r2 ? n4.push([s7[a2++], s7[a2++], s7[a2++], e3[3]]) : c ? n4.push([s7[a2++], s7[a2++], s7[a2++]]) : r2 ? (n4.push([s7[a2++], s7[a2++], e3[2]]), a2++) : (n4.push([s7[a2++], s7[a2++]]), a2++);
    l.push(n4);
  }
  return true;
}
...
//# sourceMappingURL=chunk-XGYM66XX.js.map
