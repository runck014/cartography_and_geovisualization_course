...
var Loader = proxyCustomElement(class Loader2 extends H {
  ...
  render() {
    ...
    return h(Host, { key: "8272bdfae9fff51b19ed8fa66197eb93b53feb4c", "aria-label": label, "aria-valuemax": isDeterminate ? "100" : void 0, "aria-valuemin": isDeterminate ? "0" : void 0, "aria-valuenow": isDeterminate ? valueNow.toString() : void 0, id, role: "progressbar" }, h("div", { key: "3d410c178af39bb57cc478bdd06c0392f6ba71a3", class: CSS.loaderParts }, [1, 2, 3].map((index) => h("svg", { "aria-hidden": "true", class: {
      [CSS.loaderPart]: true,
      [CSS.loaderPartId(index)]: true
    }, key: index, style: isDeterminate && index === 3 ? determinateStyle : void 0, viewBox: viewbox }, h("circle", { cx: size / 2, cy: size / 2, r: radius }))), isDeterminate && h("div", { key: "4ccc633930dee031bf769908d712df39e0677bbb", class: CSS.loaderPercentage }, this.formatValue())), text && h("div", { key: "6d0d51988bdfafee2a19faed9e14d3bda06d79b5", class: CSS.loaderText }, text));
  }
  ...
  updateFormatter() {
    var _a;
    if (this.type !== "determinate-value" || ((_a = this.formatter) == null ? void 0 : _a.resolvedOptions().locale) === this.effectiveLocale) {
      return;
    }
...
@esri/calcite-components/dist/components/loader.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KS2WBYQ7.js.map
