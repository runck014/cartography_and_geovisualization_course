...
async function p(e4) {
  ...
  let l3;
  const [{ projectBuffer: u2 }, { initializeProjection: m2 }] = await Promise.all([import("./projectBuffer-SPETTATZ.js"), import("./projection-SCQVF3DC.js")]);
  await m2(f2, c3);
  const y2 = [0, 0, 0];
  ...
  if ("georeferenced" === a4.type && null == a4.origin) {
    ...
    const e5 = "georeferenced" === a4.type ? a.fromJSON(a4) : a2.fromJSON(a4), { projectMeshVertexPositions: t } = await import("./projectMeshVertexPositions-5R5H734Q.js"), s2 = t({ vertexAttributes: { position: i2 }, transform: n4 ? { localMatrix: n4 } : void 0, vertexSpace: e5, spatialReference: f2 }, c3);
...
//# sourceMappingURL=SceneLayerWorker-WCIKSV6B.js.map
