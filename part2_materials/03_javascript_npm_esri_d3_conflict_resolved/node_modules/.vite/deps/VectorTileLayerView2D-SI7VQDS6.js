...
var p5 = class {
  ...
  _requestSprite(t8) {
    ...
    this._spriteSourcePromise = this._layer.loadSpriteSource(this.devicePixelRatio, o6), this._spriteSourcePromise.then((t9) => {
      a2(i8), this._spriteMosaic = new o3(1024, 1024, 250), this._spriteMosaic.setSpriteSource(t9);
    });
  }
...
var l5 = class extends h5 {
  constructor(t8, e9) {
    super(t8, e9), this.type = E3.LINE, this.lineIndexStart = 0, this.lineIndexCount = 0;
  ...
  doPrepareForRendering(t8, e9, r13) {
    const n9 = new Uint32Array(e9), s6 = new Int32Array(n9.buffer), h8 = n9[r13++], l7 = E2.createVertex(t8, F.STATIC_DRAW, new Int32Array(s6.buffer, 4 * r13, h8));
    r13 += h8;
    const f4 = n9[r13++], u5 = E2.createIndex(t8, F.STATIC_DRAW, new Uint32Array(n9.buffer, 4 * r13, f4));
    r13 += f4;
...
var f3 = class extends h5 {
  constructor(t8, e9) {
    super(t8, e9), this.type = E3.FILL, this.fillIndexStart = 0, this.fillIndexCount = 0, this.outlineIndexStart = 0, this.outlineIndexCount = 0;
    const r13 = new Uint32Array(t8);
    let s6 = this.bufferDataOffset;
  ...
  doPrepareForRendering(t8, e9, r13) {
    ...
    const f4 = n9[r13++], u5 = E2.createIndex(t8, F.STATIC_DRAW, new Uint32Array(n9.buffer, 4 * r13, f4));
    r13 += f4;
    const c7 = n9[r13++], y6 = E2.createVertex(t8, F.STATIC_DRAW, new Int32Array(s6.buffer, 4 * r13, c7));
    r13 += c7;
    const d6 = n9[r13++], A3 = E2.createIndex(t8, F.STATIC_DRAW, new Uint32Array(n9.buffer, 4 * r13, d6));
    r13 += d6;
...
var u3 = class extends h5 {
  constructor(t8, e9, i8) {
    super(t8, e9), this.type = E3.SYMBOL, this.iconPerPageElementsMap = /* @__PURE__ */ new Map(), this.glyphPerPageElementsMap = /* @__PURE__ */ new Map(), this.symbolInstances = [], this.isIconSDF = false, this.opacityChanged = false, this.lastOpacityUpdate = 0, this.symbols = [];
  ...
  doPrepareForRendering(t8, e9, r13) {
    ...
    const d6 = n9[r13++], A3 = E2.createIndex(t8, F.STATIC_DRAW, new Uint32Array(n9.buffer, 4 * r13, d6));
    r13 += d6;
    const p7 = E2.createVertex(t8, F.STATIC_DRAW, this.iconOpacity.buffer), I3 = E2.createVertex(t8, F.STATIC_DRAW, this.textOpacity.buffer), g2 = this.layer, x = g2.iconMaterial, b2 = g2.textMaterial;
...
var c4 = class extends h5 {
  constructor(t8, e9) {
    super(t8, e9), this.type = E3.CIRCLE, this.circleIndexStart = 0, this.circleIndexCount = 0;
    const r13 = new Uint32Array(t8);
    let s6 = this.bufferDataOffset;
...
var y3 = class _y extends r7 {
  ...
  deleteLayerData(e9) {
    ...
    for (const s6 of e9) {
      ...
      e10 && (this._usedMemory -= e10.usedMemory, e10.type === E3.SYMBOL && this.symbols.delete(s6) && (t8 = true), e10.destroy(), this.layerData.delete(s6));
    }
  ...
  changeDataImpl(e9) {
    ...
    if (e9) {
      ...
      for (const [e10, o6] of a8) this._deleteLayerData(e10), o6.type === E3.SYMBOL && (this.symbols.set(e10, o6.symbols), t8 = true), this._usedMemory += o6.usedMemory, this.layerData.set(e10, o6);
      (_b = this._memCache) == null ? void 0 : _b.updateSize(this.key.id, this, this.usedMemory);
    }
    this._hasSymbolBuckets = false;
    for (const s6 of this.layerData.values()) s6.type === E3.SYMBOL && (this._hasSymbolBuckets = true);
  ...
  setTransform(a8) {
    ...
    o(l7), M(l7, l7, n9), h2(l7, l7, Math.PI * a8.rotation / 180), f2(l7, l7, [o6, h8, 1]);
  }
  _createTransforms() {
...
var d5 = class _d {
  ...
  _indexLayer(e9, t8, r13, i8, y6, h8) {
    const d6 = e9.sourceLayer, m5 = e9.getFeatureFilter(), f4 = r13, _3 = r13 + 1, p7 = d2(f4), g2 = new n2(new Uint8Array(t8), new DataView(t8));
  ...
  _addSymbolsAttributes(t8, s6, r13, i8) {
    ...
    this._getSymbolAttributes(i8.protobuff, s6, r13, a8, y6, c7).forEach((s7) => {
      ...
      t8.push({ layerId: o6[r13].id, layerIndex: r13, graphic: new d3({ attributes: i9, origin: { type: "vector-tile", layerId: o6[r13].id, layerIndex: r13, layer: this._parentLayer } }), tilePoint: l8 });
    });
  }
  ...
  _queryIndex(t8, s6, r13, i8, o6, l7) {
    ...
    return (_a = this._index) == null ? void 0 : _a.search({ minX: s6 - n9, minY: r13 - n9, maxX: s6 + n9, maxY: r13 + n9 }, (n10) => {
      ...
      a8.isIntersectingFeature(s6, r13, i8, y6, o6, l7, n10) && t8.push({ layerId: a8.id, layerIndex: a8.uid, tilePoint: null, graphic: new d3({ attributes: y6.values, origin: { type: "vector-tile", layerId: n10.layer.id, layerIndex: n10.layer.uid, layer: this._parentLayer } }) });
    }), t8;
  }
  async _getTilePayload(e9) {
    return r3(this._tileKeyToPBF, e9.id, () => this._tileHandler.fetchTilePBFs(e9)).then((e10) => e10);
  }
};
...
var Q = class extends i3(j2(y2)) {
  ...
  attach() {
    ...
    this._styleRepository = new l2(e9), this._tileInfoView = new t7(this.layer.tileInfo, this.layer.fullExtent), this._vectorTileContainer = new m3(this._tileInfoView), this._tileHandler = new p5(this.layer, this._styleRepository, window.devicePixelRatio || 1, this.layer.tileInfo.lods.length - 1), this.container.addChild(this._vectorTileContainer), this._start(), this.addAttachHandles([this.layer.on("paint-change", (e10) => {
      ...
      const s6 = d(i8.layout, e10.layout);
      if (null != s6) {
        if (p2(s6, "visibility") && 1 === E5(s6)) return t8.setLayoutProperties(e10.layer, e10.layout), i8.type === a5.SYMBOL && ((_a = this._vectorTileContainer) == null ? void 0 : _a.restartDeclutter()), void ((_b = this._vectorTileContainer) == null ? void 0 : _b.requestRender());
  ...
  _start() {
    ...
    const e9 = new AbortController(), t8 = this._tileHandler.start({ signal: e9.signal }).then(() => {
      this._fetchQueue = new p({ tileInfoView: this._tileInfoView, process: (e10, t9) => this._getTileData(e10, t9), concurrency: 15, scheduler: this.scheduler, priority: g.MAPVIEW_FETCH_QUEUE }), this._parseQueue = new p({ tileInfoView: this._tileInfoView, process: (e10, t9) => this._parseTileData(e10, t9), concurrency: 8, scheduler: this.scheduler, priority: g.MAPVIEW_VECTOR_TILE_PARSING_QUEUE }), this.requestUpdate(), this._isTileHandlerReady = true;
    });
...
//# sourceMappingURL=VectorTileLayerView2D-SI7VQDS6.js.map
