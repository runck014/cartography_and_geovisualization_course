...
var I2 = class _I {
  ...
  transform(t3, a2, e6, s3 = 0, i = a(e6), r4 = a(a2), n5 = G(a2, r4)) {
    if (e6 === i) a2.isGeographic ? st2(this, t3, a2, s3, r4) : et2(this, t3, a2, s3, r4, n5);
      ...
      i2[2] += s3, n3(i2, a2, 0, i2, e6, 0), t3.center = i2, this !== t3 && (t3.quaternion = this.getQuaternion(T2), t3.halfSize = this.getHalfSize(ct2));
    }
  }
};
var O4 = e5();
...
function $2(t3, a2, e6, s3, i) {
  ...
  const r4 = a(e6);
  n3(ot2, t3, 0, ot2, r4, 0), at2(r4, a2, ot2, e6, s3);
}
...
function at2(a2, e6, s3, i, r4) {
  ...
  n3(it2, a2, 0, it2, i, 0, 8), J2(rt2, r4);
}
...
function st2(t3, a2, e6, s3, i = a(e6)) {
  ...
  t3.getCenter(nt2), nt2[2] += s3, n3(nt2, e6, 0, nt2, i, 0), a2.center = nt2;
...
//# sourceMappingURL=chunk-NQRBRDNC.js.map
