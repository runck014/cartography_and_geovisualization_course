...
var t2 = class {
  ...
  registerIncoming(t3, i3, s4) {
    let o3;
    "function" == typeof i3 ? (s4 = i3, o3 = []) : o3 = i3 || [];
    ...
    }, g2 = new n2(a2, s4, { onPause: r4, onRemove: r4, onResume: (e2) => {
      const t4 = this._incoming[e2.match.eventType];
...
var s3 = class extends t2 {
  ...
  _update(t3) {
    const s4 = "touch" === t3.native.pointerType ? "touch" : "mouse", { x: e2, y: i3 } = t3;
    s4 === this._value && this._x === e2 && this._y === i3 || (this._value = s4, this._x = e2, this._y = i3, this._onChange(s4, e2, i3));
  }
};
...
var o2 = class {
  constructor(r4, o3) {
    ...
    for (const t3 in r4) {
      const o4 = r4[t3], s4 = new s(o4, void 0, void 0, 2, 2);
  ...
  destroy() {
    ...
    for (const e2 in this._properties) {
      const t3 = this._properties[e2];
      for (const e3 of t3.acquired) O(e3) || t3.pool.release(e3);
      t3.pool.destroy(), t3.pool = null, t3.acquired = null;
    }
    this._properties = null, this._owner = null;
  }
  get(e2) {
    const t3 = this._owner._get(e2), r4 = this._properties[e2];
    let o3 = r4.pool.acquire();
    for (r4.acquired.push(o3); o3 === t3; ) r4.acquired.push(o3), o3 = r4.pool.acquire();
    return o3;
  }
  _release() {
    for (const e2 in this._properties) {
      const t3 = this._properties[e2];
      let o3 = 0;
      for (const e3 of t3.acquired) O(e3) ? t3.acquired[o3++] = e3 : t3.pool.release(e3);
...
var d = class extends b {
  constructor(e2) {
    super(e2), this._pointerCaptures = /* @__PURE__ */ new Map(), this._nameToGroup = {}, this._handlers = [], this._handlersPriority = [], this._currentPropagation = null, this._updateDependenciesAfterPropagation = false, this._sourceEvents = /* @__PURE__ */ new Set(), this._keyModifiers = /* @__PURE__ */ new Set(), this._activeKeyModifiers = /* @__PURE__ */ new Set(), this._stoppedPropagationEventIds = /* @__PURE__ */ new Set(), this.primaryKey = t, this._latestPointerType = "mouse", this._propertiesPool = new o2({ latestPointerLocation: P }, this), this.latestPointerLocation = null, this._paused = false, this.test = { timestamp: void 0, hasCurrentPropagation: () => !!this._currentPropagation };
  }
  initialize() {
  ...
  installHandlers(e2, t3, i3 = _.INTERNAL) {
    ...
    for (let n3 = r4.handlers.length - 1; n3 >= 0; n3--) {
      ...
      this._handlers.push(e3), e3.handler.onInstall({ updateDependencies: () => {
        ...
        this._emitInputEvent(e3.priorityIndex + 1, t4, i4, r5, s4, n4);
  ...
  _updateKeyModifiers(e2, t3) {
    ...
    const s4 = t3.native;
    n3("Alt", !!(s4 == null ? void 0 : s4.altKey)), n3("Control", !!(s4 == null ? void 0 : s4.ctrlKey)), n3("Ctrl", !!(s4 == null ? void 0 : s4.ctrlKey)), n3("Shift", !!(s4 == null ? void 0 : s4.shiftKey)), n3("Meta", !!(s4 == null ? void 0 : s4.metaKey)), n3("Primary", this._activeKeyModifiers.has(this.primaryKey));
  }
  _installRecognizers() {
    this._latestPointerHandler = new s3((e2, t3, i3) => this._setLatestPointer(e2, t3, i3)), this._multiTouchHandler = new i2(), this.installHandlers("input-manager-logic", [this._latestPointerHandler, this._multiTouchHandler], _.ALWAYS), this.recognizers.length > 0 && this.installHandlers("default", this.recognizers, _.INTERNAL);
  }
  _setPointerCapture(e2, t3, i3, r4) {
    const n3 = e2.name + "-" + t3.priorityIndex, s4 = this._pointerCaptures.get(i3.pointerId) || /* @__PURE__ */ new Set();
    this._pointerCaptures.set(i3.pointerId, s4), r4 ? (s4.add(n3), 1 === s4.size && this.eventSource && this.eventSource.setPointerCapture(i3, true)) : s4.has(n3) && (s4.delete(n3), 0 === s4.size && (this._pointerCaptures.delete(i3.pointerId), this.eventSource && this.eventSource.setPointerCapture(i3, false)));
  }
  ...
  _emitInputEvent(e2, t3, i3, r4, n3, s4) {
    const o3 = void 0 !== r4 ? r4 : this._currentPropagation ? this._currentPropagation.timestamp : performance.now(), a2 = void 0 !== n3 && n3, l = { event: new u(t3, i3, o3, s4 || this._activeKeyModifiers, a2), priorityIndex: e2 };
    this._currentPropagation ? this._currentPropagation.events.push(l) : this._doNewPropagation(l);
  }
  _doNewPropagation(e2) {
    this._currentPropagation = { events: new s2(), currentHandler: null, needsHandlerGarbageCollect: false, timestamp: e2.event.timestamp }, this._currentPropagation.events.push(e2), this._continuePropagation();
  }
...
//# sourceMappingURL=chunk-BZVFVFOB.js.map
