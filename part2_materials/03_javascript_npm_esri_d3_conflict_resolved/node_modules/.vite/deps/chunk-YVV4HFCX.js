...
var B = class _B extends I2 {
  ...
  rewriteSql(e3, t5) {
    const r2 = this.evaluateNodeToWhereClause(e3.parseTree, l.Standardised, this.field.name, this.codefield instanceof Z ? f3(this.codefield, l.Standardised) : this.codefield, e3.parameters);
...
var L2 = class extends I2 {
  ...
  rewriteSql(e3, t5) {
    return { rewritten: true, where: p(e3, this.field.name, f3(this._sql, l.Standardised), t5.getFieldsIndex()) };
  }
  extractValue(e3) {
...
var O2 = class _O extends C {
  ...
  _initialiseFeatureSet() {
    ...
    for (const s4 of this._decodedGroupbyfield) {
      ...
      if (s4.name = this._nextUniqueName(e3), t6.name = s4.tofieldname, t6.alias = t6.name, O(s4.expression)) {
        const e4 = this._parent.getField(f3(s4.expression, l.Standardised));
    ...
    for (let i2 = 0; i2 < this._decodedStatsfield.length; i2++) {
      ...
      const r3 = null !== n10.workingexpr && O(n10.workingexpr) ? f3(n10.workingexpr, l.Standardised) : "";
  ...
  _reformulateWhereClauseWithoutStatsFields(e3) {
    for (const t5 of this._decodedStatsfield) e3 = p(e3, t5.tofieldname, f3(t5.workingexpr, l.Standardised), this._parent.getFieldsIndex());
    return e3;
  }
  _reformulateWhereClauseWithoutGroupByFields(e3) {
    for (const t5 of this._decodedGroupbyfield) t5.tofieldname !== t5.name && (e3 = p(e3, t5.tofieldname, f3(t5.expression, l.Standardised), this._parent.getFieldsIndex()));
    return e3;
  }
...
var P = class _P extends C {
  ...
  async _getFilteredSet(e3, t5, r2, i2, s4) {
    ...
    u2.where = n6(u2.where, null === r2 ? null === t5 ? "1=1" : "" : f3(r2, a6)), u2.spatialRelationship = this._makeRelationshipEnum(e3), u2.outSpatialReference = this.spatialReference, u2.orderByFields = "" !== n9 ? n9.split(",") : null, u2.geometry = null === t5 ? null : t5, u2.relationParameter = this._makeRelationshipParam(e3);
  ...
  async _getFilteredSetUsingPaging(e3, t5, r2, i2, s4) {
    ...
    const l2 = await this.databaseType(), u2 = null === r2 ? null === t5 ? "1=1" : "" : f3(r2, l2);
  ...
  async _getDistinctPages(e3, t5, r2, i2, s4, l2, o, u2, d5) {
    ...
    f7.where = n6(f7.where, null === l2 ? null === s4 ? "1=1" : "" : f3(l2, c5)), f7.spatialRelationship = this._makeRelationshipEnum(i2), f7.relationParameter = this._makeRelationshipParam(i2), f7.geometry = null === s4 ? null : s4, f7.returnDistinctValues = true, f7.returnGeometry = false, f7.outFields = [h2];
  ...
  async _countstat(e3, t5, r2, i2) {
    ...
    a6.where = n6(a6.where, null === i2 ? null === r2 ? "1=1" : "" : f3(i2, s4)), a6.spatialRelationship = this._makeRelationshipEnum(t5), a6.relationParameter = this._makeRelationshipParam(t5), a6.geometry = null === r2 ? null : r2, a6.returnGeometry = false;
  ...
  async _stats(e3, t5, r2, i2, s4, l2, o) {
    ...
    p2.where = n6(p2.where, null === s4 ? null === i2 ? "1=1" : "" : f3(s4, h2)), p2.spatialRelationship = this._makeRelationshipEnum(r2), p2.relationParameter = this._makeRelationshipParam(r2), p2.geometry = null === i2 ? null : i2;
    const g5 = new m2();
    g5.statisticType = w2(e3), g5.onStatisticField = f3(t5, h2), g5.outStatisticFieldName = "ARCADE_STAT_RESULT", p2.returnGeometry = false;
  ...
  async _getAggregatePagesDataSourceDefinition(e3, t5, r2, i2, s4, a6, n9) {
    ...
    for (let o = 0; o < t5.length; o++) {
      const e4 = new m2();
      e4.onStatisticField = null !== t5[o].workingexpr ? f3(t5[o].workingexpr, l2) : "", e4.outStatisticFieldName = t5[o].field, e4.statisticType = t5[o].toStatisticsName(), h2.push(e4);
    }
    "" === u2 && (u2 = e3.join(","));
    let p2 = this._maxQueryRate();
    const f7 = (_a = this._layer.capabilities) == null ? void 0 : _a.query.maxRecordCount;
    null != f7 && f7 < p2 && (p2 = f7);
    const _ = null === s4 ? null === i2 ? "1=1" : "" : f3(s4, l2);
...
c4.registerAction(), O2.registerAction(), a3.registerAction(), f4.registerAction(), a5.registerAction();
var j2 = class extends e {
  ...
  async featureSetByName(e3, t5 = true, a6 = null) {
    if (m.isLoadable(this._map) && !this._map.loaded) return await this._map.load(), this.featureSetByName(e3, t5, a6);
  ...
  async featureSetById(e3, t5 = true, a6 = ["*"]) {
    if (m.isLoadable(this._map) && !this._map.loaded) return await this._map.load(), this.featureSetById(e3, t5, a6);
    null === a6 && (a6 = ["*"]), a6 = (a6 = a6.slice()).sort();
    const r2 = JSON.stringify(a6);
    for (let i2 = 0; i2 < this._instantLayers.length; i2++) {
      const a7 = this._instantLayers[i2];
...
async function G2(e3, t5, a6, r2, n9, i2, l2) {
  ...
  if ("Feature Service" === e3.type || "Map Service" === e3.type) s4 = await F3(k(e3.url ?? "") + "/" + t5, ["*"], i2);
    ...
    } else s4 = await f5.fromPortalItem(e3);
  }
...
//# sourceMappingURL=chunk-YVV4HFCX.js.map
