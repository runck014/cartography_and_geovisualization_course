...
var Notice = proxyCustomElement(class Notice2 extends H {
  ...
  render() {
    const { el } = this;
    const closeButton = h("button", { key: "52f9306ebe945398929f68fe66615359836ba2d8", "aria-label": this.messages.close, class: CSS.close, onClick: this.close, ref: (el2) => this.closeButton = el2 }, h("calcite-icon", { key: "f3601ac9547c73219661eebc7e7470db5dee7b52", icon: "x", scale: getIconScale(this.scale) }));
...
@esri/calcite-components/dist/components/calcite-notice.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-notice-QIIO24YX.js.map
