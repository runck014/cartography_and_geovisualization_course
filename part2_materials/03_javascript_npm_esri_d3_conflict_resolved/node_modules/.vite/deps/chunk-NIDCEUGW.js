...
import {
  f as f3
} from "./chunk-AFW7JFZH.js";
import {
  p as p2
} from "./chunk-LY6SU3A2.js";
import {
  b
...
function c6(t6, o3, s7) {
  const a11 = e9(f4, t6, o3, s7) ? O3(f4) : [0, 0, 1];
...
function f5(t6) {
  ...
  for (const r4 of e10.polygons) {
    const t7 = r4.count, c9 = r4.index, h8 = a4(e10.position, 3 * c9, 3 * t7), a11 = r4.holeIndices.map((n9) => n9 - c9), g10 = t3(e6(h8, a11, 3));
    s7.push({ position: h8, faces: g10 }), l3 += h8.length, f8 += g10.length;
  }
  const g9 = h4(s7, l3, f8), u10 = Array.isArray(g9.position) ? e2(g9.position, 3, { originalIndices: g9.faces }) : e2(g9.position.buffer, 6, { originalIndices: g9.faces });
...
function t5(o3, t6, i3, a11) {
  if (void 0 !== a11) {
    a(o3(), "option: geographic", { replacement: "Use mesh `vertexSpace` and spatial reference to control how operations are performed instead.", version: "4.30", warnOnce: true });
    const c9 = "local" === t6.type;
    if (!a8(t6) || a11 === c9) return i3.isGeographic || i3.isWebMercator && a11;
...
function u6(e10, t6, r4) {
  ...
  a8(i3) ? x(e10, t6, o3) : n9 ? v4(e10, t6, o3) : R2(e10, t6, o3);
}
function x(e10, o3, s7) {
  const { vertexSpace: c9 } = e10;
  if (!a8(c9)) return;
  const f8 = h5, m7 = b2;
  if (!c5(o3, m7, e10.spatialReference)) return void F(g6(), o3.spatialReference, e10.spatialReference, O2);
  if (!c5(s7, f8, e10.spatialReference)) {
    const t6 = e10.origin;
    return f8[0] = t6.x, f8[1] = t6.y, f8[2] = t6.z, void F(g6(), s7.spatialReference, e10.spatialReference, O2);
  }
  const u10 = c4(A2, m7, f8);
  c9.origin = u3(n5(), c9.origin, u10);
}
function v4(e10, t6, r4) {
  const i3 = r2(r4.x, r4.y, r4.z ?? 0), n9 = B(e10, new a7({ origin: i3 }));
  if (!n9) return;
  const a11 = r2(t6.x, t6.y, t6.z ?? 0), f8 = B({ vertexAttributes: n9, spatialReference: e10.spatialReference, vertexSpace: new a7({ origin: a11 }) }, a5.absolute);
  if (!f8) return;
...
function R2(e10, t6, r4) {
  ...
  if (c5(t6, o3, e10.spatialReference)) {
    if (!c5(r4, i3, e10.spatialReference)) {
      const t7 = e10.origin;
      return i3[0] = t7.x, i3[1] = t7.y, i3[2] = t7.z, void F(g6(), r4.spatialReference, e10.spatialReference, O2);
    }
    j3(e10.vertexAttributes.position, o3, i3), e10.vertexAttributesChanged();
  } else F(g6(), t6.spatialReference, e10.spatialReference, O2);
}
...
function l2(r4) {
  const { spatialReference: f8, vertexSpace: l3, untransformedBounds: d5 } = r4, g9 = f2(d5, u7);
  if (a8(l3) && r4.transform && e5(g9, g9, r4.transform.localMatrix), "georeferenced" === l3.type) {
    const r5 = l3.origin;
    return r5 && i(g9, g9, r5), c3(m3(g9), f8);
  }
  const y3 = a6(f8), B3 = l3.origin;
  if (!J(y3, f8)) {
    const [r5, t6, e10] = B3;
    return new w({ xmin: r5, ymin: t6, zmin: e10, xmax: r5, ymax: t6, zmax: e10, spatialReference: f8 });
  }
  return C(f8, B3, x2, y3), e5(g9, g9, x2), n6(g9, y3, 0, g9, f8, 0), c3(m3(g9), f8);
}
var x2 = e4();
var u7 = t2(24);
...
async function c7(e10, n9, r4) {
  const { source: o3 } = n9, { loadGLTFMesh: i3 } = await h(import("./loadGLTFMesh-QX5M7LYI.js"), r4), l3 = await f6(o3, r4);
  s2(r4);
...
var a10 = class extends l {
  ...
  set displaySource(e10) {
    ...
    this._explicitDisplaySource = e10, e10 && this.externalSources.every((r4) => !h3(r4, e10)) && this.externalSources.add(e10);
  }
  clearSources() {
...
r([m()], a10.prototype, "externalSources", void 0), r([m()], a10.prototype, "displaySource", null), r([m()], a10.prototype, "_implicitDisplaySource", null), r([m()], a10.prototype, "_explicitDisplaySource", void 0), r([m()], a10.prototype, "georeferenced", void 0), a10 = r([a2("esri.geometry.support.meshUtils.Metadata")], a10);
...
function G3(t6, e10, r4) {
  ...
  else if (!k(d5, r4, t6)) return void F(O5(), r4.spatialReference, f8, O2);
  b(Z, w3(e10), z3(e10));
  const y3 = D(N3, Z, _, s4, d5), { localMatrix: T3 } = c9, U = c2(N3, y3, T3);
  c9.scale = O(n5(), U), f(U, U, z2(K, c9.scale));
  const z5 = c9.rotationAxis;
  c9.rotation = k2(U), 0 === c9.rotationAngle && (c9.rotationAxis = z5), c9.translation = I(n5(), U);
}
function H(t6, r4, o3) {
  const i3 = t6.spatialReference, n9 = a6(i3), s7 = Y;
  ...
  const u10 = Q;
  N(w3(Q), w3(r4), X), u10[3] = r4[3], g4(a11, i3, m7, n9) && (null == l3 || null == f8 || E2(l3, a11, i3, m7, n9, f8)) && (null == c9 || null == p6 || w2(c9, a11, i3, m7, n9, p6)) ? (J2(m7, u10, 3, s7), h2(m7, n9, a11, i3) && (null == l3 || null == f8 || (J2(f8, u10, 3), R(f8, a11, i3, m7, n9, l3))) && (null == c9 || null == p6 || (J2(p6, u10, 4), G2(p6, a11, i3, m7, n9, c9))) ? t6.vertexAttributesChanged() : F(O5(), n9, i3)) : F(O5(), i3, n9);
}
function I2(t6, e10, r4) {
  const o3 = Y;
  if (!c5(r4, o3, t6.spatialReference)) {
    const e11 = t6.origin;
    return o3[0] = e11.x, o3[1] = e11.y, o3[2] = e11.z, void F(O5(), r4.spatialReference, t6.spatialReference, O2);
  }
...
function z4(e10, s7, f8) {
  ...
  else if (!k(F3, f8, e10)) return void F(k3(), f8.spatialReference, h8, O2);
  const S2 = o(V2, s7, s7, s7), U = D(D2, r3, _, S2, F3), { localMatrix: q2 } = x5, z5 = c2(D2, U, q2);
  x5.scale = O(n5(), z5), f(z5, z5, z2(T2, x5.scale));
  const L3 = x5.rotationAxis;
  x5.rotation = k2(z5), 0 === x5.rotationAngle && (x5.rotationAxis = L3), x5.translation = I(n5(), z5);
}
function L2(e10, t6, r4) {
  const o3 = e10.spatialReference, i3 = a6(o3), n9 = E3;
  ...
  g4(s7, o3, c9, i3) && (null == a11 || null == f8 || E2(a11, s7, o3, c9, i3, f8)) && (null == l3 || null == m7 || w2(l3, s7, o3, c9, i3, m7)) ? (P(c9, t6, n9), h2(c9, i3, s7, o3) && (null == a11 || null == f8 || R(f8, s7, o3, c9, i3, a11)) && (null == l3 || null == m7 || G2(m7, s7, o3, c9, i3, l3)) ? e10.vertexAttributesChanged() : F(k3(), i3, o3)) : F(k3(), o3, i3);
}
function M3(e10, t6, r4) {
  const o3 = E3;
  if (!c5(r4, o3, e10.spatialReference)) {
    const t7 = e10.origin;
    return o3[0] = t7.x, o3[1] = t7.y, o3[2] = t7.z, void F(k3(), r4.spatialReference, e10.spatialReference, O2);
  }
...
var Q2 = { base: null, key: "type", defaultKeyValue: "georeferenced", typeMap: { georeferenced: a5, local: a7 } };
var X2 = H2 = class extends m2.LoadableMixin(n2(n3)) {
  constructor(e10) {
  ...
  get _untransformedBounds() {
    ...
    return 0 === e10.length || 0 === (t6 == null ? void 0 : t6.length) ? u2(L) : m3(e10);
  }
  get origin() {
  ...
  async toBinaryGLTF(e10) {
    const [{ toBinaryGLTF: t6 }] = await Promise.all([import("./gltfexport-RZ3X5E5D.js"), this.load(e10)]);
  ...
  static async createFromGLTF(e10, t6, r4) {
    ...
    const { loadGLTFMesh: o3 } = await h(import("./loadGLTFMesh-QX5M7LYI.js"), r4);
...
r([m({ type: [f3], json: { write: true } })], X2.prototype, "components", void 0), r([m({ nonNullable: true, types: Q2, constructOnly: true, json: { write: true } })], X2.prototype, "vertexSpace", void 0), r([m({ type: N2, json: { write: true } })], X2.prototype, "transform", void 0), r([m({ constructOnly: true })], X2.prototype, "metadata", void 0), r([m()], X2.prototype, "hasExtent", null), r([m()], X2.prototype, "_transformedExtent", null), r([m()], X2.prototype, "_untransformedBounds", null), r([m()], X2.prototype, "origin", null), r([m({ readOnly: true, json: { read: false } })], X2.prototype, "extent", null), r([m({ readOnly: true, json: { read: false, write: true, default: true } })], X2.prototype, "hasZ", void 0), r([m({ readOnly: true, json: { read: false, write: true, default: false } })], X2.prototype, "hasM", void 0), r([m({ type: p2, nonNullable: true, json: { write: true } })], X2.prototype, "vertexAttributes", void 0), X2 = H2 = r([a2(K2)], X2);
var Y2 = j2();
var $ = X2;
...
//# sourceMappingURL=chunk-NIDCEUGW.js.map
