...
import {
  K,
  i as i6
} from "./chunk-X5DEX4NK.js";
import {
  z
} from "./chunk-ZDN6M7KF.js";
import {
  d,
  d2,
  f as f2,
...
var o7 = null;
async function g3() {
  return null == o7 && (o7 = i7(), l5 = await o7), o7;
}
function u10(e10, t11) {
  if (null == l5) return e10.byteLength;
  const n11 = new l5.BasisFile(new Uint8Array(e10)), s10 = E3(n11) ? m3(n11.getNumLevels(0), n11.getHasAlpha(), n11.getImageWidth(0, 0), n11.getImageHeight(0, 0), t11) : 0;
  return n11.close(), n11.delete(), s10;
}
function c6(e10, t11) {
  if (null == l5) return e10.byteLength;
  const n11 = new l5.KTX2File(new Uint8Array(e10)), s10 = T(n11) ? m3(n11.getLevels(), n11.getHasAlpha(), n11.getWidth(), n11.getHeight(), t11) : 0;
  return n11.close(), n11.delete(), s10;
}
function m3(e10, t11, s10, r13, i15) {
  const l9 = u6(t11 ? c4.COMPRESSED_RGBA8_ETC2_EAC : c4.COMPRESSED_RGB8_ETC2), o13 = i15 && e10 > 1 ? (4 ** e10 - 1) / (3 * 4 ** (e10 - 1)) : 1;
...
async function h(e10, t11, n11) {
  null == l5 && (l5 = await g3());
  const s10 = new l5.BasisFile(new Uint8Array(n11));
  if (!E3(s10)) return null;
  s10.startTranscoding();
  const r13 = p4(e10, t11, s10.getNumLevels(0), s10.getHasAlpha(), s10.getImageWidth(0, 0), s10.getImageHeight(0, 0), (e11, t12) => s10.getImageTranscodedSizeInBytes(0, e11, t12), (e11, t12, n12) => s10.transcodeImage(n12, 0, e11, t12, 0, 0));
  return s10.close(), s10.delete(), r13;
}
async function _4(e10, t11, n11) {
  null == l5 && (l5 = await g3());
  const s10 = new l5.KTX2File(new Uint8Array(n11));
  if (!T(s10)) return null;
  s10.startTranscoding();
  const r13 = p4(e10, t11, s10.getLevels(), s10.getHasAlpha(), s10.getWidth(), s10.getHeight(), (e11, t12) => s10.getImageTranscodedSizeInBytes(e11, 0, 0, t12), (e11, t12, n12) => s10.transcodeImage(n12, e11, 0, 0, t12, 0, -1, -1));
  return s10.close(), s10.delete(), r13;
}
function p4(e10, a11, l9, o13, g5, u14, c12, m8) {
...
var o8 = () => n.getLogger("esri.views.3d.webgl-engine.lib.DDSUtil");
var a3 = 542327876;
var i8 = 131072;
var s6 = 4;
function l6(e10) {
...
function S4(e10, t11) {
  const n11 = new Int32Array(e10.buffer, e10.byteOffset, f4);
  if (n11[d3] !== a3) return o8().error("Invalid magic number in DDS header"), null;
  if (!(n11[T2] & s6)) return o8().error("Unsupported format, must contain a FourCC code"), null;
  const l9 = n11[_5];
  let E6, S7;
  switch (l9) {
    case c7:
    ...
    case m4:
      ...
      break;
    default:
      return o8().error("Unsupported FourCC code:", u11(l9)), null;
  }
  let b3 = 1, A6 = n11[C], M3 = n11[D2];
  (3 & A6 || 3 & M3) && (o8().warn("Rounding up compressed texture size to nearest multiple of 4."), A6 = A6 + 3 & -4, M3 = M3 + 3 & -4);
  const x3 = A6, R7 = M3;
  let X2, I5;
  n11[g4] & i8 && false !== t11 && (b3 = Math.max(1, n11[w]));
  let v3 = e10.byteOffset + n11[p5] + 4;
  const y5 = [];
...
function r10(t11, e10) {
  const n11 = 1048576, i15 = 4096, r13 = 2;
  let h7 = t11.width * t11.height;
  if (h7 < i15) return t11 instanceof ImageData ? a4(t11) : t11;
  ...
  return o9(t11, c12, u14);
}
function h3(t11, e10) {
  const n11 = Math.max(t11.width, t11.height);
  if (n11 <= e10) return t11;
  const i15 = e10 / n11;
  return o9(t11, Math.round(t11.width * i15), Math.round(t11.height * i15));
}
function o9(t11, e10, n11) {
  if (t11 instanceof ImageData) return o9(a4(t11), e10, n11);
...
var C2 = class extends r8 {
  ...
  _loadFromURL(e10, t11) {
    return this._loadAsync(async (r13) => {
      const s10 = await t9(t11, { signal: r13 });
  ...
  _loadFromImage(e10, t11) {
    ...
    if (!(r13 instanceof HTMLVideoElement)) {
      ...
      r13 = this._parameters.downsampleUncompressed ? r10(r13, t12) : h3(r13, t12);
    }
    const s10 = R3(r13);
...
function H4(e10, t11) {
  ...
  if (t(e10) || u(e10)) return t11.encoding === u7.KTX2_ENCODING ? c6(e10, !!t11.mipmap) : t11.encoding === u7.BASIS_ENCODING ? u10(e10, !!t11.mipmap) : e10.byteLength;
...
function V2(i15, e10, s10, c12, r13, a11, f9, u14, l9, m8) {
  ...
  for (let j3 = s10; j3 < c12; ++j3) {
    ...
    o2(p9[0], a11[s11 + 0], a11[s11 + 1], a11[s11 + 2]);
    const c13 = f9 * r13[e11 + 1];
    o2(p9[1], a11[c13 + 0], a11[c13 + 1], a11[c13 + 2]);
    const l10 = f9 * r13[e11 + 2];
    o2(p9[2], a11[l10 + 0], a11[l10 + 1], a11[l10 + 2]), u14 && (s3(p9[0], u14.applyToVertex(p9[0][0], p9[0][1], p9[0][2], j3)), s3(p9[1], u14.applyToVertex(p9[1][0], p9[1][1], p9[1][2], j3)), s3(p9[2], u14.applyToVertex(p9[2][0], p9[2][1], p9[2][2], j3))), R(B6, p9[0], i15), R(C5, p9[1], i15), R(k4, p9[2], i15);
...
function I4(t11, o13, s10, c12, r13, a11, f9) {
  return o2(O3, t11, o13, s10), o2(A3, c12, r13, a11), _2(f9, O3, A3), A(f9, f9), f9;
}
function R4(n11) {
...
var A3 = n3();
function C4(t11, o13) {
  return o2(o13, 1 / t11[0], 1 / t11[1], 1 / t11[2]);
}
...
var T5 = class {
  ...
  applyToVertex(t11, s10, r13) {
    const e10 = o2(q4, t11, s10, r13), i15 = u4(z2, e10, this.localOrigin), o13 = this.offset / r5(i15);
...
var x2 = class {
  ...
  applyToVertex(t11, s10, r13) {
    const e10 = o2(q4, t11, s10, r13), i15 = o2(z2, t11, s10, r13 + this.componentLocalOriginLength), o13 = this._totalOffset / r5(i15);
...
var O4 = class {
  ...
  applyToVertex(t11, s10, r13) {
    const e10 = this.objectTransform.transform, i15 = o2(q4, t11, s10, r13), o13 = E(i15, i15, e10), a11 = this.offset / r5(o13);
    q(o13, o13, o13, a11);
...
function b2(t11, f9, o13, r13, i15 = 1) {
  if (!f9) return void a6(t11, o13, r13, i15);
...
function O5(f9, o13, r13, i15, s10 = 1) {
  if (!o13) return void a6(f9, r13, i15, s10);
...
function h6(e10, f9, o13, r13, i15 = 1) {
  if (!f9) return void p7(e10, o13, r13, i15);
...
function E5(e10, t11, o13, r13, i15, s10, n11) {
  ...
  for (const c12 of o13.fields.keys()) {
    ...
    else if (c12 === e3.OBJECTANDLAYERIDCOLOR && null != t11) {
      const o15 = (_a = e10.get(e3.POSITION)) == null ? void 0 : _a.indices;
      if (o15) {
...
function F(e10, t11, d7, a11, B6, y5) {
  switch (e10) {
    case e3.POSITION: {
      ...
      s4(!!f9, `No buffer view for ${e10}`), f9 && b2(t11, d7, f9, y5);
      break;
    }
    case e3.NORMAL: {
      s4(3 === t11.size);
      const f9 = B6.getField(e10, i3);
      s4(!!f9, `No buffer view for ${e10}`), f9 && O5(t11, a11, f9, y5);
      break;
    }
    case e3.NORMALCOMPRESSED: {
      s4(2 === t11.size);
      const f9 = B6.getField(e10, q2);
      s4(!!f9, `No buffer view for ${e10}`), f9 && u12(t11, f9, y5);
      break;
    }
    case e3.UV0: {
      s4(2 === t11.size);
    ...
    case e3.SYMBOLCOLOR: {
      ...
      s4(!!o13, `No buffer view for ${e10}`), s4(3 === t11.size || 4 === t11.size), !o13 || 3 !== t11.size && 4 !== t11.size || S6(t11, t11.size, o13, y5);
      break;
    }
    case e3.COLORFEATUREATTRIBUTE: {
      const f9 = B6.getField(e10, y2);
      s4(!!f9, `No buffer view for ${e10}`), s4(1 === t11.size), f9 && 1 === t11.size && N4(t11, f9, y5);
      break;
    }
    case e3.TANGENT: {
      s4(4 === t11.size);
      const f9 = B6.getField(e10, c3);
      s4(!!f9, `No buffer view for ${e10}`), f9 && h6(t11, d7, f9, y5);
      break;
    }
    case e3.PROFILERIGHT:
    case e3.PROFILEUP:
    case e3.PROFILEVERTEXANDNORMAL:
    case e3.FEATUREVALUE: {
      s4(4 === t11.size);
      const f9 = B6.getField(e10, c3);
      s4(!!f9, `No buffer view for ${e10}`), f9 && p7(t11, f9, y5);
    }
  }
}
...
var e9 = { mask: 255 };
var f6 = { function: { func: O.ALWAYS, ref: s5.OutlineVisualElementMask, mask: s5.OutlineVisualElementMask }, operation: { fail: I2.KEEP, zFail: I2.KEEP, zPass: I2.ZERO } };
var o10 = { function: { func: O.ALWAYS, ref: s5.OutlineVisualElementMask, mask: s5.OutlineVisualElementMask }, operation: { fail: I2.KEEP, zFail: I2.KEEP, zPass: I2.REPLACE } };
var P3 = { function: { func: O.EQUAL, ref: s5.OutlineVisualElementMask, mask: s5.OutlineVisualElementMask }, operation: { fail: I2.KEEP, zFail: I2.KEEP, zPass: I2.KEEP } };
var m6 = { function: { func: O.NOTEQUAL, ref: s5.OutlineVisualElementMask, mask: s5.OutlineVisualElementMask }, operation: { fail: I2.KEEP, zFail: I2.KEEP, zPass: I2.KEEP } };

// node_modules/@arcgis/core/views/3d/webgl-engine/shaders/DefaultMaterialTechnique.js
var F2 = class extends f2 {
  constructor() {
    super(...arguments), this.isSchematic = false, this.usePBR = false, this.mrrFactors = t8, this.hasVertexColors = false, this.hasSymbolColors = false, this.doubleSided = false, this.doubleSidedType = "normal", this.cullFace = e4.Back, this.isInstanced = false, this.hasInstancedColor = false, this.emissiveFactor = _, this.instancedDoublePrecision = false, this.normalType = a2.Attribute, this.receiveShadows = true, this.receiveAmbientOcclusion = true, this.castShadows = true, this.ambient = e2(0.2, 0.2, 0.2), this.diffuse = e2(0.8, 0.8, 0.8), this.externalColor = r4(1, 1, 1, 1), this.colorMixMode = "multiply", this.opacity = 1, this.layerOpacity = 1, this.origin = n3(), this.hasSlicePlane = false, this.hasSliceHighlight = true, this.offsetTransparentBackfaces = false, this.vvSize = null, this.vvColor = null, this.vvOpacity = null, this.vvSymbolAnchor = null, this.vvSymbolRotationMatrix = null, this.modelTransformation = null, this.transparent = false, this.writeDepth = true, this.customDepthTest = n4.Less, this.textureAlphaMode = i4.Blend, this.textureAlphaCutoff = o4, this.textureAlphaPremultiplied = false, this.renderOccluded = p3.Occlude, this.isDecoration = false;
  }
};
var N5 = class extends n6 {
  constructor() {
    super(...arguments), this.origin = n3(), this.slicePlaneLocalOrigin = this.origin;
  }
};
var k2 = class extends n7 {
  constructor(e10, t11, i15, s10 = new t7(K, () => import("./DefaultMaterial.glsl-HJWE53P7.js"))) {
  ...
  _makePipeline(e10, t11) {
    ...
    return B({ blending: u8(s10) && o13 ? a5(i15) : null, culling: B4(e10) ? f3(a11) : null, depthTest: { func: f5(i15, q5(n11)) }, depthWrite: l7(e10), drawBuffers: s10 === n5.Depth ? { buffers: [f.NONE] } : i9(i15, s10), colorWrite: g2, stencilWrite: h7 ? e9 : null, stencilTest: h7 ? t11 ? o10 : f6 : null, polygonOffset: u14 || m8 ? null : N2(c12) });
  }
...
function B4(e10) {
  return e10.cullFace !== e4.None || !e10.hasSlicePlane && (!e10.transparent && !e10.doubleSidedMode);
}
...
r([i11({ count: i4.COUNT })], c9.prototype, "alphaDiscardMode", void 0), r([i11({ count: i6.COUNT })], c9.prototype, "doubleSidedMode", void 0), r([i11({ count: n9.COUNT })], c9.prototype, "pbrMode", void 0), r([i11({ count: e4.COUNT })], c9.prototype, "cullFace", void 0), r([i11({ count: a2.COUNT })], c9.prototype, "normalType", void 0), r([i11({ count: n4.COUNT })], c9.prototype, "customDepthTest", void 0), r([i11({ count: d2.COUNT })], c9.prototype, "emissionSource", void 0), r([i11()], c9.prototype, "hasVertexColors", void 0), r([i11()], c9.prototype, "hasSymbolColors", void 0), r([i11()], c9.prototype, "hasVerticalOffset", void 0), r([i11()], c9.prototype, "hasSlicePlane", void 0), r([i11()], c9.prototype, "hasSliceHighlight", void 0), r([i11()], c9.prototype, "hasColorTexture", void 0), r([i11()], c9.prototype, "hasMetallicRoughnessTexture", void 0), r([i11()], c9.prototype, "hasOcclusionTexture", void 0), r([i11()], c9.prototype, "hasNormalTexture", void 0), r([i11()], c9.prototype, "hasScreenSizePerspective", void 0), r([i11()], c9.prototype, "hasVertexTangents", void 0), r([i11()], c9.prototype, "hasOccludees", void 0), r([i11()], c9.prototype, "hasModelTransformation", void 0), r([i11()], c9.prototype, "offsetBackfaces", void 0), r([i11()], c9.prototype, "vvSize", void 0), r([i11()], c9.prototype, "vvColor", void 0), r([i11()], c9.prototype, "receiveShadows", void 0), r([i11()], c9.prototype, "receiveAmbientOcclusion", void 0), r([i11()], c9.prototype, "textureAlphaPremultiplied", void 0), r([i11()], c9.prototype, "instanced", void 0), r([i11()], c9.prototype, "instancedColor", void 0), r([i11()], c9.prototype, "writeDepth", void 0), r([i11()], c9.prototype, "transparent", void 0), r([i11()], c9.prototype, "enableOffset", void 0), r([i11()], c9.prototype, "terrainDepthTest", void 0), r([i11()], c9.prototype, "cullAboveTerrain", void 0), r([i11()], c9.prototype, "snowCover", void 0), r([i11()], c9.prototype, "hasColorTextureTransform", void 0), r([i11()], c9.prototype, "hasEmissionTextureTransform", void 0), r([i11()], c9.prototype, "hasNormalTextureTransform", void 0), r([i11()], c9.prototype, "hasOcclusionTextureTransform", void 0), r([i11()], c9.prototype, "hasMetallicRoughnessTextureTransform", void 0);

// node_modules/@arcgis/core/views/3d/webgl-engine/shaders/RealisticTreeTechnique.js
var i13 = class extends k2 {
  constructor(r13, i15, t11) {
    super(r13, i15, t11, new t7(z, () => import("./RealisticTree.glsl-D5ULBALV.js"))), this.type = "RealisticTreeTechnique";
  }
};

// node_modules/@arcgis/core/views/3d/webgl-engine/materials/DefaultMaterial.js
var B5 = class extends n8 {
  constructor(e10, r13) {
    super(e10, z3), this.materialType = "default", this.supportsEdges = true, this.produces = /* @__PURE__ */ new Map([[A4.OPAQUE_MATERIAL, (e11) => (t6(e11) || o5(e11)) && !this.parameters.transparent], [A4.TRANSPARENT_MATERIAL, (e11) => (t6(e11) || o5(e11)) && this.parameters.transparent && this.parameters.writeDepth], [A4.TRANSPARENT_MATERIAL_WITHOUT_DEPTH, (e11) => (r7(e11) || o5(e11)) && this.parameters.transparent && !this.parameters.writeDepth]]), this._vertexBufferLayout = U4(this.parameters), this._configuration = new c9(r13.spherical, r13.doublePrecisionRequiresObfuscation);
  }
  ...
  get visible() {
    ...
    if (e10.layerOpacity < o4) return false;
    const { hasInstancedColor: r13, hasVertexColors: t11, hasSymbolColors: i15, vvColor: s10 } = e10, a11 = r13 || s10 || i15, o13 = "replace" === e10.colorMixMode, n11 = e10.opacity >= o4;
    if (t11 && a11) return o13 || n11;
    const c12 = e10.externalColor && e10.externalColor[3] >= o4;
  ...
  intersect(e10, l9, u14, h7, m8, p9) {
    if (null != this.parameters.verticalOffset) {
      ...
      let v3 = null;
      this.parameters.screenSizePerspective && (v3 = P(p10, x3)), d7 += i5(e11, T6, this.parameters.verticalOffset, v3 ?? 0, this.parameters.screenSizePerspective), g(p10, p10, d7), N(Y, p10, u14.transform.inverseRotation), h7 = c2(W2, h7, Y), m8 = c2(k3, m8, Y);
    }
    p6(e10, u14, h7, m8, d5(u14.verticalOffset), p9);
  }
  createGLMaterial(e10) {
    return new q6(e10);
  }
  createBufferWriter() {
    return new r11(this._vertexBufferLayout);
  }
};
var q6 = class extends u9 {
  ...
  beginSlot(e10) {
    ...
    return o2(t11.origin, i15[3], i15[7], i15[11]), this._material.setParameters(this.textureBindParameters), this.acquireTechnique(t11.treeRendering ? i13 : k2, e10);
  }
};
...
function U4(e10) {
  const r13 = H3().vec3f(e3.POSITION);
  e10.normalType === a2.Compressed ? r13.vec2i16(e3.NORMALCOMPRESSED, { glNormalized: true }) : r13.vec3f(e3.NORMAL), e10.hasVertexTangents && r13.vec4f(e3.TANGENT);
  return (e10.textureId || e10.normalTextureId || e10.metallicRoughnessTextureId || e10.emissiveTextureId || e10.occlusionTextureId) && r13.vec2f(e3.UV0), e10.hasVertexColors && r13.vec4u8(e3.COLOR), e10.hasSymbolColors && r13.vec4u8(e3.SYMBOLCOLOR), e5() && r13.vec4u8(e3.OBJECTANDLAYERIDCOLOR), r13;
}
var W2 = n3();
var k3 = n3();
var F3 = r3(0, 0, 1);
...
var o12 = class _o {
  constructor(i15, e10, o13) {
    this.primitiveIndices = i15, this._numIndexPerPrimitive = e10, this.position = o13, this._children = void 0, s4(i15.length >= 1), s4(3 === o13.size || 4 === o13.size);
    const { data: c12, size: l9, indices: m8 } = o13;
    s4(m8.length % this._numIndexPerPrimitive == 0), s4(m8.length >= i15.length * this._numIndexPerPrimitive);
    const d7 = i15.length;
    let u14 = l9 * m8[this._numIndexPerPrimitive * i15[0]];
    a9.clear(), a9.push(u14);
    ...
    for (let t11 = 0; t11 < a9.length; ++t11) {
      u14 = a9.at(t11);
...
function i14(r13, o13) {
  if (!r13) return false;
  const { size: i15, data: c12, indices: f9 } = r13;
  o2(o13, 0, 0, 0), o2(m7, 0, 0, 0);
  let g5 = 0, d7 = 0;
  for (let p9 = 0; p9 < f9.length - 2; p9 += 3) {
    const r14 = f9[p9] * i15, h7 = f9[p9 + 1] * i15, j3 = f9[p9 + 2] * i15;
    o2(a10, c12[r14], c12[r14 + 1], c12[r14 + 2]), o2(l8, c12[h7], c12[h7 + 1], c12[h7 + 2]), o2(u13, c12[j3], c12[j3 + 1], c12[j3 + 2]);
    const z4 = S3(a10, l8, u13);
    z4 ? (u4(a10, a10, l8), u4(a10, a10, u13), g(a10, a10, 1 / 3 * z4), u4(o13, o13, a10), g5 += z4) : (u4(m7, m7, a10), u4(m7, m7, l8), u4(m7, m7, u13), d7 += 3);
  }
  return (0 !== d7 || 0 !== g5) && (0 !== g5 ? (g(o13, o13, 1 / g5), true) : 0 !== d7 && (g(o13, m7, 1 / d7), true));
}
function c10(e10, r13) {
  if (!e10) return false;
...
function f7(o13, s10, i15) {
  if (!o13) return false;
  o2(i15, 0, 0, 0), o2(m7, 0, 0, 0);
  let c12 = 0, f9 = 0;
  ...
  for (let t11 = 0; t11 < h7; t11 += 2) {
    ...
    a10[0] = g5[s11], a10[1] = g5[s11 + 1], a10[2] = g5[s11 + 2], l8[0] = g5[h8], l8[1] = g5[h8 + 1], l8[2] = g5[h8 + 2], g(a10, u4(a10, a10, l8), 0.5);
    const j3 = W(a10, l8);
    j3 > 0 ? (u4(i15, i15, g(a10, a10, j3)), c12 += j3) : 0 === c12 && (u4(m7, m7, a10), f9++);
  }
  return 0 !== c12 ? (g(i15, i15, 1 / c12), true) : 0 !== f9 && (g(i15, m7, 1 / f9), true);
}
var a10 = n3();
var l8 = n3();
var u13 = n3();
...
var p8 = class _p extends r8 {
  constructor(t11, i15, e10 = null, n11 = e6.Mesh, r13 = null, h7 = -1) {
    ...
    for (const [o13, u14] of i15) this._attributes.set(o13, { ...u14, indices: t3(u14.indices) }), o13 === e3.POSITION && (this.edgeIndicesLength = this.edgeIndicesLength < 0 ? this._attributes.get(o13).indices.length : this.edgeIndicesLength);
  }
  instantiate(t11 = {}) {
  ...
  getMutableAttribute(t11) {
    ...
    return i15 && !i15.exclusive && (i15 = { ...i15, exclusive: true, data: o11(i15.data) }, this._attributes.set(t11, i15)), i15;
  }
  ...
  _computeAttachmentOriginTriangles(t11) {
    const i15 = this.attributes.get(e3.POSITION);
    return i14(i15, t11);
  }
  _computeAttachmentOriginLines(t11) {
    const i15 = this.attributes.get(e3.POSITION);
    return f7(i15, f8(this.material.parameters, i15), t11);
  }
  ...
  _calculateBoundingInfo() {
    const t11 = this.attributes.get(e3.POSITION);
    if (!t11 || 0 === t11.indices.length) return null;
    const i15 = this.type === e6.Mesh ? 3 : 1;
    s4(t11.indices.length % i15 == 0, "Indexing error: " + t11.indices.length + " not divisible by " + i15);
    const e10 = l3(t11.indices.length / i15);
    return new o12(e10, i15, t11);
  }
  get transformation() {
    return this._transformation ?? o3;
  }
  set transformation(e10) {
    this._transformation = e10 && e10 !== o3 ? r6(e10) : null;
  }
  get highlightGroups() {
...
//# sourceMappingURL=chunk-SHP52NEA.js.map
