...
var b3 = class {
  constructor(e4, t2, i6) {
    this.config = null, this.fieldMap = null, this.url = null, this._ongoingRequests = /* @__PURE__ */ new Map(), this._symbolCache = new e2(100), this._dictionaryVersion = null, this._fieldIndex = null, this._dictionaryPromise = null, this.url = e4, this.config = t2, this.fieldMap = i6;
  }
  getSymbolFields() {
  ...
  async _cimPartsToCIMSymbol(e4, t2, i6, r5, o3) {
    ...
    return new d2({ data: j2(l3, i6, r5) });
  }
...
var m2 = h2 = class extends v(p) {
  constructor(t2) {
    super(t2), this.attributes = null, this.backgroundColor = new l([0, 0, 0, 0]), this.dotBlendingEnabled = true, this.dotShape = "square", this.dotSize = 1, this.legendOptions = null, this.outline = new d(), this.dotValue = null, this.referenceScale = null, this.seed = 1, this.type = "dot-density";
  }
...
r([m({ type: [c4], json: { write: true } })], m2.prototype, "attributes", void 0), r([m({ type: l, json: { write: true } })], m2.prototype, "backgroundColor", void 0), r([m({ type: Boolean, json: { write: true } })], m2.prototype, "dotBlendingEnabled", void 0), r([m({ type: String, json: { write: false } })], m2.prototype, "dotShape", void 0), r([m({ type: Number, json: { write: true } })], m2.prototype, "dotSize", void 0), r([m({ type: i3, json: { write: true } })], m2.prototype, "legendOptions", void 0), r([m({ type: d, json: { default: null, write: true } })], m2.prototype, "outline", void 0), r([m({ type: Number, json: { write: true } })], m2.prototype, "dotValue", void 0), r([m({ type: Number, json: { write: true } })], m2.prototype, "referenceScale", void 0), r([m({ type: Number, json: { write: true } })], m2.prototype, "seed", void 0), r([r3({ dotDensity: "dot-density" })], m2.prototype, "type", void 0), m2 = h2 = r([a2("esri.renderers.DotDensityRenderer")], m2);
var y4 = m2;
...
var b4 = g2 = class extends p {
  ...
  set blurRadius(t2) {
    ...
    this._set("radius", e(t2)), this._set("maxDensity", e4 * this._pixelIntensityToDensity), this._set("minDensity", i6 * this._pixelIntensityToDensity);
  }
...
//# sourceMappingURL=chunk-5GQ62KHN.js.map
