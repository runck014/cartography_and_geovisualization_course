...
var T = 180 / Math.PI;
function B2(t) {
  return t.wkid ? t : t.spatialReference || g2.WGS84;
}
function D(t, e3) {
...
function H(t, e3, n3 = 0) {
  ...
  if (0 !== n3) {
    const e4 = s2(n3), i3 = Math.abs(Math.cos(e4)), c3 = Math.abs(Math.sin(e4));
...
async function J2(t, r3, n3, o2) {
  ...
  if (V.isCollection(t) && (t = t.toArray()), Array.isArray(t) && t.length && "object" == typeof t[0]) {
    ...
    for (const t2 of i3) o2 = await J2(t2, r3, n3, o2);
    return o2;
  }
  if (Array.isArray(t) && 2 === t.length && "number" == typeof t[0] && "number" == typeof t[1]) a = new j(t);
  ...
  if (!i2) return null;
  _() || J(i2.spatialReference, n3) || await W();
  const c2 = K(i2, n3);
  if (!c2) return null;
  if (o2) {
...
function X(t, e3) {
  const r3 = B2(t);
  return s(r3, e3) || r3.imageCoordinateSystem || e3.imageCoordinateSystem ? t : K(t, e3);
}
async function Y(e3, r3) {
  var _a;
  if (!e3 || !r3) return new m({ targetGeometry: new j(), scale: 0, rotation: 0 });
  let n3 = r3.spatialReference;
  const { constraints: o2, padding: a, viewpoint: i2, size: c2 } = r3, s4 = [a ? c2[0] - a.left - a.right : c2[0], a ? c2[1] - a.top - a.bottom : c2[1]];
  let u4 = null;
  e3 instanceof m ? u4 = e3 : e3.viewpoint ? u4 = e3.viewpoint : e3.target && "esri.Viewpoint" === e3.target.declaredClass && (u4 = e3.target);
  let l2 = null;
  (u4 == null ? void 0 : u4.targetGeometry) ? l2 = u4.targetGeometry : e3 instanceof w ? l2 = e3 : e3 instanceof n ? l2 = await J2(e3, r3, n3) : e3 && (l2 = await J2(e3.center, r3, n3) || await J2(e3.target, r3, n3) || await J2(e3, r3, n3)), !l2 && (i2 == null ? void 0 : i2.targetGeometry) ? l2 = i2.targetGeometry : !l2 && r3.extent && (l2 = r3.extent), n3 || (n3 = B2(r3.spatialReference || r3.extent || l2)), _() || s(l2.spatialReference, n3) || J(l2.spatialReference, n3) || await W();
  const f2 = X(l2, n3), m2 = "center" in f2 ? f2.center : f2;
  false !== r3.pickClosestTarget && "point" === m2.type && "point" === ((_a = i2.targetGeometry) == null ? void 0 : _a.type) && (m2.x = P(m2.x, i2.targetGeometry.x, m2.spatialReference));
  let y2 = 0;
  ...
  const g3 = K2(e3.target ?? e3);
  g3 && (g3.min && g3.min < p ? p = g3.min : g3.max && g3.max > p && (p = g3.max));
...
var nt = function() {
  const t = e2(), e3 = n2();
  return function(r3, n3, o2, s4) {
    const u4 = ot(n3), l2 = it(n3);
    return o(e3, u4, u4), h(t, e3), s3(t, t, l2), i(t, t, rt(e3, o2, s4)), i(t, t, [0, s4.top - s4.bottom]), o(r3, t[4], t[5]);
  };
}();
function ot(t) {
  var _a;
...
function at(t) {
  return null != t && g(t) ? 1 / (W2(t) * Q * O) : 1;
}
function it(t) {
  return u(t.rotation) || 0;
}
function ct(t) {
  return g(t) ? W2(t) * Q * O : 1;
}
function st(t, e3) {
  return l(t, e3, 0.5);
}
var ut = function() {
  ...
  return function(n3, o2, a, l2, f2, m2) {
    return x(t, o2), l(e3, a, 0.5 * m2), o(r3, 1 / l2 * m2, -1 / l2 * m2), f(n3, e3), f2 && s3(n3, n3, f2), c(n3, n3, r3), i(n3, n3, t), n3;
  };
}();
var lt = function() {
  const t = n2();
...
var pt = function() {
  ...
  return function(n3, o2, a) {
    ...
    let i2 = Math.acos(j2(t, e3) / (q(t) * q(e3))) * T;
...
var Rt = function() {
  const t = n2(), e3 = n2();
  return function(r3, n3, o2, a, i2, c2, s4) {
    return rt(e3, c2, s4), u2(t, i2, e3), a ? Gt(r3, n3, o2, a, t, c2) : dt(r3, n3, o2, t, c2);
  };
}();
var At = function() {
  const t = e2();
...
var kt = function() {
  ...
  return function(r3, n3, o2) {
    ...
    return M(e3, it(n3)), c(e3, e3, r2(a, a)), S(t, o2, e3), i2.x += t[0], i2.y += t[1], r3;
  };
}();
...
//# sourceMappingURL=chunk-7RAZQP6S.js.map
