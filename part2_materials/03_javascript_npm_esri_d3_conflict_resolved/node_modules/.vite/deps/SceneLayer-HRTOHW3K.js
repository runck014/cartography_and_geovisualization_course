...
import {
  V as V3
} from "./chunk-FY2YDIDK.js";
import "./chunk-HB2JTNV2.js";
import "./chunk-LVKQ4JXF.js";
...
var a6 = (t8) => {
  let a7 = class extends t8 {
    ...
    async loadTimeInfoFromService(e5) {
      ...
      const c4 = new p2({ start: m4, end: a8 });
      this.setAtOrigin("timeInfo", new d2({ endField: i5, startField: r4, fullTimeExtent: c4 }), "service");
    }
  };
  return r([m({ type: d2, json: { read: false, write: false } })], a7.prototype, "timeInfo", null), r([m({ type: p2, json: { read: false, write: false } })], a7.prototype, "timeExtent", null), r([m({ type: l2, json: { read: false, write: false } })], a7.prototype, "timeOffset", null), r([m({ type: Boolean, nonNullable: true, json: { read: false, write: false } })], a7.prototype, "datesInUnknownTimezone", null), r([m({ type: c2, readOnly: true, json: { read: { source: "timeInfo" } } })], a7.prototype, "serviceTimeInfo", void 0), a7 = r([a3("esri.layers.mixins.TemporalSceneLayer")], a7), a7;
};
...
p10 = c3 = r([a3("esri.layers.support.PolygonCollection")], p10);
var l4 = p10;
...
var je = s4();
var Fe = class extends a6(F(R(l(b3(j2(t2(S(e2(i2(i(f3))))))))))) {
  constructor(...e5) {
  ...
  readNodePages(e5, t8, r4) {
    return "Point" === t8.layerType && (e5 = t8.pointNodePages), null == e5 || "object" != typeof e5 ? null : p8.fromJSON(e5, r4);
  }
  ...
  async queryCachedAttributes(e5, t8) {
    var _a;
    const r4 = x(this.fieldsIndex, await n4(this, p9(this)));
  ...
  async applyEdits(e5, t8) {
    const { applyEdits: r4 } = await import("./editingSupport-GGK2DXYS.js");
    let i5 = t8;
    await this.load();
...
//# sourceMappingURL=SceneLayer-HRTOHW3K.js.map
