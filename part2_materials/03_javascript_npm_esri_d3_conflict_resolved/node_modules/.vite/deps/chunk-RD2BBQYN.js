...
var c = class extends b {
  ...
  async update(t, r2) {
    const { addOrUpdateResources: e2 } = await import("./resourceUtils-XEA5RLNQ.js");
...
r([m()], e.prototype, "created", void 0), r([m()], e.prototype, "rating", void 0), e = r([a2("esri.portal.PortalRating")], e);
var c2 = e;
...
var b3 = /* @__PURE__ */ new Set(["KML", "GeoJson", "CSV"]);
var k = v = class extends u(m2) {
  static from(e2) {
    return h(v, e2);
  }
  constructor(e2) {
  ...
  load(e2) {
    const t = this.portal ?? (this.portal = b2.getDefault()), i = t.load(e2).then(() => this.sourceJSON ? this.sourceJSON : this.id && this.itemUrl ? t.request(this.itemUrl, { signal: null != e2 ? e2.signal : null, query: { token: this.apiKey } }) : {}).then((e3) => {
  ...
  async addRating(e2) {
    ...
    return e2 instanceof c2 && (e2 = e2.rating), null == e2 || isNaN(e2) || "number" != typeof e2 || (t.query.rating = e2), this.portal ? (await this.portal.request(this.itemUrl + "/addRating", t), new c2({ rating: e2, created: /* @__PURE__ */ new Date() })) : null;
  }
  clone() {
  ...
  async fetchResources(e2 = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-XEA5RLNQ.js");
    return i(this, e2, t);
  }
  async addResource(e2, t, i) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-XEA5RLNQ.js");
  ...
  async removeResource(e2, t) {
    const { removeResource: r2 } = await import("./resourceUtils-XEA5RLNQ.js");
  ...
  async removeAllResources(e2) {
    const { removeAllResources: t } = await import("./resourceUtils-XEA5RLNQ.js");
    return t(this, e2);
  }
  resourceFromPath(e2) {
    return new u2({ portalItem: this, path: e2 });
  }
  toJSON() {
    var _a, _b;
...
//# sourceMappingURL=chunk-RD2BBQYN.js.map
