...
var K = class extends l(l2(f(t(b2(j(S2(f2))))))) {
  constructor(...e) {
  ...
  _defaultFetchFeatureInfoFunction(e) {
    ...
    const s6 = new q({ title: this.title, content: t3 }), i2 = new d2({ sourceLayer: this, popupTemplate: s6 });
