...
import {
  ...
  g,
  k as k2
} from "./chunk-THYALLAY.js";
import {
  l
} from "./chunk-CLIR7IOF.js";
import {
  s
} from "./chunk-A5G2HMUT.js";
import {
  Bt,
  Ee,
  Fe,
...
function se2(e2, t) {
  var i2 = k2(true), s2 = null, a = ee, o4 = null, n3 = V(r2);
  function r2(r3) {
    var l2, h, d, c = (r3 = J2(r3)).length, u = false;
    for (null == s2 && (o4 = a(d = n3())), l2 = 0; l2 <= c; ++l2) !(l2 < c && i2(h = r3[l2], l2, r3)) === u && ((u = !u) ? o4.lineStart() : o4.lineEnd()), u && o4.point(+e2(h, l2, r3), +t(h, l2, r3));
    if (d) return o4 = null, d + "" || null;
  }
  return e2 = "function" == typeof e2 ? e2 : void 0 === e2 ? te : k2(e2), t = "function" == typeof t ? t : void 0 === t ? ie : k2(t), r2.x = function(t2) {
    ...
    return arguments.length ? (a = e3, null != s2 && (o4 = a(s2)), r2) : a;
  }, r2.context = function(e3) {
    return arguments.length ? (null == e3 ? s2 = o4 = null : o4 = a(s2 = e3), r2) : s2;
  }, r2;
}
function ae(e2, t, i2) {
  var s2 = null, a = k2(true), o4 = null, n3 = ee, r2 = null, l2 = V(h);
  function h(h2) {
    var d2, c, u, g2, p, m = (h2 = J2(h2)).length, _4 = false, b = new Array(m), x2 = new Array(m);
    for (null == o4 && (r2 = n3(p = l2())), d2 = 0; d2 <= m; ++d2) {
      if (!(d2 < m && a(g2 = h2[d2], d2, h2)) === _4) if (_4 = !_4) c = d2, r2.areaStart(), r2.lineStart();
      else {
  ...
  function d() {
    return se2().defined(a).curve(n3).context(o4);
  }
  return e2 = "function" == typeof e2 ? e2 : void 0 === e2 ? te : k2(+e2), t = "function" == typeof t ? t : k2(void 0 === t ? 0 : +t), i2 = "function" == typeof i2 ? i2 : void 0 === i2 ? ie : k2(+i2), h.x = function(t2) {
    ...
    return arguments.length ? (a = "function" == typeof e3 ? e3 : k2(!!e3), h) : a;
  }, h.curve = function(e3) {
    return arguments.length ? (n3 = e3, null != o4 && (r2 = n3(o4)), h) : n3;
  }, h.context = function(e3) {
    return arguments.length ? (null == e3 ? o4 = r2 = null : r2 = n3(o4 = e3), h) : o4;
  }, h;
}
...
var oe = class extends hi {
  setupDefaultRules() {
    ...
    d("CategoryDateAxis").setAll({ markUnitChange: true, gridIntervals: j(c), dateFormats: W(u), periodChangeDateFormats: W(g2) }), d("DateAxis").setAll({ maxZoomFactor: null, strictMinMax: true, startLocation: 0, endLocation: 1, markUnitChange: true, groupData: false, groupCount: 500, gridIntervals: j(c), dateFormats: W(u), periodChangeDateFormats: W(g2), tooltipDateFormats: p, groupIntervals: [{ timeUnit: "millisecond", count: 1 }, { timeUnit: "millisecond", count: 10 }, { timeUnit: "millisecond", count: 100 }, { timeUnit: "second", count: 1 }, { timeUnit: "second", count: 10 }, { timeUnit: "minute", count: 1 }, { timeUnit: "minute", count: 10 }, { timeUnit: "hour", count: 1 }, { timeUnit: "day", count: 1 }, { timeUnit: "week", count: 1 }, { timeUnit: "month", count: 1 }, { timeUnit: "year", count: 1 }], fillRule: (e3) => {
      ...
      if (t) {
        const i2 = e3.component, s2 = e3.get("value"), a = e3.get("endValue"), o4 = i2.intervalDuration(), n3 = i2.getPrivate("baseInterval"), r2 = i2.getPrivate("gridInterval", n3);
        let l2 = i2.getPrivate("min", 0);
        if (l2 = I(new Date(l2), r2.timeUnit, r2.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime(), null != s2 && null != a) {
    ...
    d("Button", ["rangegrip"]).setAll({ draggable: true, paddingTop: 0, paddingBottom: 0 }), d("Button", ["rangegrip", "vertical"]).setAll({ rotation: 90, cursorOverStyle: "ns-resize", centerX: n }), d("Button", ["rangegrip", "horizontal"]).setAll({ cursorOverStyle: "ew-resize", centerX: n }), d("Button", ["rangegrip", "vertical", "left"]).setAll({ centerY: r }), d("Button", ["rangegrip", "vertical", "right"]).setAll({ centerY: 0 }), d("Button", ["rangegrip", "horizontal", "top"]).setAll({ centerY: 0 }), d("Button", ["rangegrip", "horizontal", "bottom"]).setAll({ centerY: r });
  }
};
var ne2 = class extends R2 {
  constructor() {
    super(...arguments), Object.defineProperty(this, "xAxes", { enumerable: true, configurable: true, writable: true, value: new re() }), Object.defineProperty(this, "yAxes", { enumerable: true, configurable: true, writable: true, value: new re() }), Object.defineProperty(this, "topAxesContainer", { enumerable: true, configurable: true, writable: true, value: this.chartContainer.children.push(ni.new(this._root, { width: r, layout: this._root.verticalLayout })) }), Object.defineProperty(this, "yAxesAndPlotContainer", { enumerable: true, configurable: true, writable: true, value: this.chartContainer.children.push(ni.new(this._root, { width: r, height: r, layout: this._root.horizontalLayout })) }), Object.defineProperty(this, "bottomAxesContainer", { enumerable: true, configurable: true, writable: true, value: this.chartContainer.children.push(ni.new(this._root, { width: r, layout: this._root.verticalLayout })) }), Object.defineProperty(this, "leftAxesContainer", { enumerable: true, configurable: true, writable: true, value: this.yAxesAndPlotContainer.children.push(ni.new(this._root, { height: r, layout: this._root.horizontalLayout })) }), Object.defineProperty(this, "plotsContainer", { enumerable: true, configurable: true, writable: true, value: this.yAxesAndPlotContainer.children.push(ni.new(this._root, { width: r, height: r, maskContent: false })) }), Object.defineProperty(this, "plotContainer", { enumerable: true, configurable: true, writable: true, value: this.plotsContainer.children.push(ni.new(this._root, { width: r, height: r })) }), Object.defineProperty(this, "topPlotContainer", { enumerable: true, configurable: true, writable: true, value: this.plotsContainer.children.push(ni.new(this._root, { width: r, height: r })) }), Object.defineProperty(this, "gridContainer", { enumerable: true, configurable: true, writable: true, value: this.plotContainer.children.push(ni.new(this._root, { width: r, height: r, isMeasured: false })) }), Object.defineProperty(this, "topGridContainer", { enumerable: true, configurable: true, writable: true, value: ni.new(this._root, { width: r, height: r, isMeasured: false }) }), Object.defineProperty(this, "rightAxesContainer", { enumerable: true, configurable: true, writable: true, value: this.yAxesAndPlotContainer.children.push(ni.new(this._root, { height: r, layout: this._root.horizontalLayout })) }), Object.defineProperty(this, "axisHeadersContainer", { enumerable: true, configurable: true, writable: true, value: this.plotContainer.children.push(ni.new(this._root, {})) }), Object.defineProperty(this, "zoomOutButton", { enumerable: true, configurable: true, writable: true, value: this.topPlotContainer.children.push(o3.new(this._root, { themeTags: ["zoom"], icon: Ye.new(this._root, { themeTags: ["button", "icon"] }) })) }), Object.defineProperty(this, "_movePoint", { enumerable: true, configurable: true, writable: true, value: { x: 0, y: 0 } }), Object.defineProperty(this, "_wheelDp", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_otherCharts", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_movePoints", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_downStartX", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downEndX", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downStartY", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downEndY", { enumerable: true, configurable: true, writable: true, value: void 0 });
  }
  _afterNew() {
  ...
  handleWheel(e2) {
    const t = this.get("wheelX"), i2 = this.get("wheelY"), s2 = this.plotContainer, a = e2.originalEvent;
    if (!lt(a, this)) return;
    a.preventDefault();
    const o4 = s2.toLocal(e2.point), n3 = this.get("wheelStep", 0.2), r2 = a.deltaY / 100, l2 = a.deltaX / 100, h = this.get("wheelZoomPositionX"), d = this.get("wheelZoomPositionY");
    "zoomX" !== t && "zoomXY" !== t || 0 == l2 || this.xAxes.each((e3) => {
      if (e3.get("zoomX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), a2 = e3.fixPosition(o4.x / s2.width());
        null != h && (a2 = h);
        let r3 = e3.get("maxDeviation", 0), d2 = Math.min(1 + r3, Math.max(-r3, t2 - n3 * (i3 - t2) * l2 * a2)), c = Math.max(-r3, Math.min(1 + r3, i3 + n3 * (i3 - t2) * l2 * (1 - a2)));
        1 / (c - d2) < e3.getPrivate("maxZoomFactor", 1 / 0) / e3.get("minZoomCount", 1) && this._handleWheelAnimation(e3.zoom(d2, c));
      }
    }), "zoomX" !== i2 && "zoomXY" !== i2 || 0 == r2 || this.xAxes.each((e3) => {
      if (e3.get("zoomX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), a2 = e3.fixPosition(o4.x / s2.width());
        null != h && (a2 = h);
        let l3 = e3.get("maxDeviation", 0), d2 = Math.min(1 + l3, Math.max(-l3, t2 - n3 * (i3 - t2) * r2 * a2)), c = Math.max(-l3, Math.min(1 + l3, i3 + n3 * (i3 - t2) * r2 * (1 - a2)));
        1 / (c - d2) < e3.getPrivate("maxZoomFactor", 1 / 0) / e3.get("minZoomCount", 1) && this._handleWheelAnimation(e3.zoom(d2, c));
      }
    }), "zoomY" !== t && "zoomXY" !== t || 0 == l2 || this.yAxes.each((e3) => {
      if (e3.get("zoomY")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), a2 = e3.fixPosition(o4.y / s2.height());
        null != d && (a2 = d);
        let r3 = e3.get("maxDeviation", 0), h2 = Math.min(1 + r3, Math.max(-r3, t2 - n3 * (i3 - t2) * l2 * a2)), c = Math.max(-r3, Math.min(1 + r3, i3 + n3 * (i3 - t2) * l2 * (1 - a2)));
        1 / (c - h2) < e3.getPrivate("maxZoomFactor", 1 / 0) / e3.get("minZoomCount", 1) && this._handleWheelAnimation(e3.zoom(h2, c));
      }
    }), "zoomY" !== i2 && "zoomXY" !== i2 || 0 == r2 || this.yAxes.each((e3) => {
      if (e3.get("zoomY")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), a2 = e3.fixPosition(o4.y / s2.height());
        null != d && (a2 = d);
        let l3 = e3.get("maxDeviation", 0), h2 = Math.min(1 + l3, Math.max(-l3, t2 - n3 * (i3 - t2) * r2 * a2)), c = Math.max(-l3, Math.min(1 + l3, i3 + n3 * (i3 - t2) * r2 * (1 - a2)));
        1 / (c - h2) < e3.getPrivate("maxZoomFactor", 1 / 0) / e3.get("minZoomCount", 1) && this._handleWheelAnimation(e3.zoom(h2, c));
      }
    }), "panX" !== t && "panXY" !== t || 0 == l2 || this.xAxes.each((e3) => {
      if (e3.get("panX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), s3 = this._getWheelSign(e3) * n3 * (i3 - t2) * l2, a2 = t2 + s3, o5 = i3 + s3, r3 = this._fixWheel(a2, o5);
        a2 = r3[0], o5 = r3[1], this._handleWheelAnimation(e3.zoom(a2, o5));
      }
    }), "panX" !== i2 && "panXY" !== i2 || 0 == r2 || this.xAxes.each((e3) => {
      if (e3.get("panX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), s3 = this._getWheelSign(e3) * n3 * (i3 - t2) * r2, a2 = t2 + s3, o5 = i3 + s3, l3 = this._fixWheel(a2, o5);
        a2 = l3[0], o5 = l3[1], this._handleWheelAnimation(e3.zoom(a2, o5));
      }
  ...
  _handlePlotMove(e2) {
    ...
    if (i2) {
      ...
      const a = this.get("panX"), o4 = this.get("panY");
      if (a) {
        let e3 = this.get("scrollbarX");
        e3 && e3.events.disableType("rangechanged"), this.xAxes.each((e4) => {
          if (e4.get("panX")) {
            e4._isPanning = true;
            let a2 = e4._panStart, o5 = e4._panEnd, n3 = (o5 - a2) * (i2.x - s2.x) / t.width();
            e4.get("renderer").get("inversed") && (n3 *= -1);
            let r2 = a2 + n3, l2 = o5 + n3;
      ...
      if (o4) {
        ...
        e3 && e3.events.disableType("rangechanged"), this.yAxes.each((e4) => {
          if (e4.get("panY")) {
            e4._isPanning = true;
            let a2 = e4._panStart, o5 = e4._panEnd, n3 = (o5 - a2) * (i2.y - s2.y) / t.height();
            e4.get("renderer").get("inversed") && (n3 *= -1);
            let r2 = a2 - n3, l2 = o5 - n3;
            l2 - r2 < 1 + 2 * e4.get("maxDeviation", 1) && (e4.set("start", r2), e4.set("end", l2));
          }
  ...
  _handlePinch() {
    ...
    let t = 0, i2 = [], s2 = [];
    if (U(e2._downPoints, (e3, a) => {
      i2[t] = a;
      let o4 = this._movePoints[e3];
      o4 && (s2[t] = o4), t++;
    }), i2.length > 1 && s2.length > 1) {
      const t2 = e2.width(), a = e2.height();
      let o4 = i2[0], n3 = i2[1], r2 = s2[0], l2 = s2[1];
      if (o4 && n3 && r2 && l2) {
        if (r2 = e2.toLocal(r2), l2 = e2.toLocal(l2), o4 = e2.toLocal(o4), n3 = e2.toLocal(n3), this.get("pinchZoomX")) {
          const e3 = this._downStartX, i3 = this._downEndX;
          if (null != e3 && null != i3) {
            o4.x > n3.x && ([o4, n3] = [n3, o4], [r2, l2] = [l2, r2]);
            let s3 = e3 + o4.x / t2 * (i3 - e3), a2 = e3 + n3.x / t2 * (i3 - e3), h = e3 + r2.x / t2 * (i3 - e3), d = e3 + l2.x / t2 * (i3 - e3), c = Math.max(1e-3, a2 - s3) / Math.max(1e-3, d - h), u = e3 * c + s3 - h * c, g2 = i3 * c + a2 - d * c;
            this.xAxes.each((e4) => {
        ...
        if (this.get("pinchZoomY")) {
          ...
          if (null != e3 && null != t3) {
            o4.y < n3.y && ([o4, n3] = [n3, o4], [r2, l2] = [l2, r2]);
            let i3 = e3 + (1 - o4.y / a) * (t3 - e3), s3 = e3 + (1 - n3.y / a) * (t3 - e3), h = e3 + (1 - r2.y / a) * (t3 - e3), d = e3 + (1 - l2.y / a) * (t3 - e3), c = Math.max(1e-3, s3 - i3) / Math.max(1e-3, d - h), u = e3 * c + i3 - h * c, g2 = t3 * c + s3 - d * c;
            this.yAxes.each((e4) => {
    ...
    if (e2) {
      ...
      if (e2._downPoint && (i2 = void 0), i2 && t) {
        ...
        if (P(a, (e3) => {
          ...
          if (i3) {
            let a2 = 0;
            a2 = "x" == s2 || "x!" == s2 ? Math.abs(t.x - i3.x) : "y" == s2 || "y!" == s2 ? Math.abs(t.y - i3.y) : Math.hypot(t.x - i3.x, t.y - i3.y), a2 < n3 && (n3 = a2, o4 = e3);
          }
        }), P(i2, (e3) => {
  ...
  _processSeries(e2) {
    ...
    T(t.series, e2), T(i2.series, e2), e2._posXDp = e2.addDisposer(t.events.on("positionchanged", () => {
      e2._fixPosition();
  ...
  _handleCursorSelectEnd() {
    const e2 = this.get("cursor"), t = e2.get("behavior"), i2 = e2.getPrivate("downPositionX", 0), s2 = e2.getPrivate("downPositionY", 0), a = Math.min(1, Math.max(0, e2.getPrivate("positionX", 0.5))), o4 = Math.min(1, Math.max(0, e2.getPrivate("positionY", 0.5)));
    this.xAxes.each((e3) => {
      if ("zoomX" === t || "zoomXY" === t) {
        let t2 = e3.toAxisPosition(i2), s3 = e3.toAxisPosition(a);
        e3.zoom(t2, s3);
      }
  ...
  _handleScrollbar(e2, t, i2, s2) {
    e2.each((e3) => {
      let a = e3.fixPosition(t), o4 = e3.fixPosition(i2), n3 = e3.zoom(a, o4, void 0, s2);
  ...
  _removeAxis(e2) {
    if (!e2.isDisposed()) {
      ...
      const a = e2.topGridContainer, o4 = a.parent;
      o4 && o4.children.removeValue(a);
    }
  }
  _updateChartLayout() {
  ...
  inPlot(e2) {
    ...
    if (i2) for (let a = i2.length - 1; a >= 0; a--) {
      const e3 = i2[a];
      if (e3 != this) {
        const t2 = e3.plotContainer, i3 = this._root.rootPointToDocument(s2), a2 = e3._root.documentPointToRoot(i3), o4 = t2.toLocal(a2);
  ...
  arrangeTooltips() {
    ...
    let o4 = e2._display.toGlobal({ x: 0, y: 0 }), n3 = e2._display.toGlobal({ x: t, y: i2 });
    const r2 = [];
    let l2, h, d = 0, c = 1 / 0, u = this._movePoint, g2 = this.get("maxTooltipDistance"), p = this.get("maxTooltipDistanceBy", "xy");
    _(g2) && this.series.each((e3) => {
      if (!e3.isHidden()) {
        const t2 = e3.get("tooltip");
        if (t2) {
    ...
    if (this.series.each((e3) => {
        ...
        if (s3) {
          if (g2 >= 0) {
            ...
            if (s4 && h && e3 != l2) {
              ...
              "x" == p ? e4 = Math.abs(h.x - s4.x) : "y" == p && (e4 = Math.abs(h.y - s4.y)), e4 > g2 && (i3 = true);
            }
          } else -1 == g2 && e3 != l2 && (i3 = true);
      ...
      if (d / t2 > i2 / 2 + o4.y) {
        r2.sort((e4, t4) => Ee(t4.get("pointTo").y, e4.get("pointTo").y));
        let t3 = n3.y;
        if (P(r2, (i3) => {
          let s3 = i3.height(), a = i3.get("centerY");
          a instanceof e && (s3 *= a.value), s3 += i3.get("marginBottom", 0), i3.set("bounds", { left: o4.x, top: o4.y, right: n3.x, bottom: t3 }), i3.setPrivate("customData", { left: o4.x, top: o4.y, right: n3.x, bottom: t3 }), t3 = Math.min(t3 - s3, i3._fy - s3), i3.parent == e3 && e3.children.moveValue(i3, 0);
        }), t3 < 0) {
          r2.reverse();
          let e4 = t3;
          P(r2, (i3) => {
            ...
            if (s3) {
              let a = s3.top - t3, o5 = s3.bottom - t3;
              a < e4 && (a = e4, o5 = a + i3.height()), i3.set("bounds", { left: s3.left, top: a, right: s3.right, bottom: o5 }), e4 = s3.bottom - t3 + i3.get("marginBottom", 0);
            }
          });
        }
      } else {
        r2.reverse(), r2.sort((e4, t4) => Ee(e4.get("pointTo").y, t4.get("pointTo").y));
        let t3 = 0;
        if (P(r2, (i3) => {
          let a = i3.height(), r3 = i3.get("centerY");
          r3 instanceof e && (a *= r3.value), a += i3.get("marginBottom", 0), i3.set("bounds", { left: o4.x, top: t3, right: n3.x, bottom: Math.max(o4.y + s2, t3 + a) }), i3.parent == e3 && e3.children.moveValue(i3, 0), t3 = Math.max(t3 + a, i3._fy + a);
        }), t3 > s2) {
          r2.reverse();
          let e4 = s2;
          P(r2, (i3) => {
            let a = i3.get("bounds");
            if (a) {
              let o5 = a.top - (s2 - t3), n4 = a.bottom - (s2 - t3);
              n4 > e4 && (n4 = e4, o5 = n4 - i3.height()), i3.set("bounds", { left: a.left, top: o5, right: a.right, bottom: n4 }), e4 = n4 - i3.height() - i3.get("marginBottom", 0);
            }
          });
        }
      }
...
Object.defineProperty(ne2, "className", { enumerable: true, configurable: true, writable: true, value: "XYChart" }), Object.defineProperty(ne2, "classNames", { enumerable: true, configurable: true, writable: true, value: R2.classNames.concat([ne2.className]) });
...
var le = class extends ni {
  ...
  _handleLineMove(e2, t) {
    ...
    if (s2 && s2.xAxes.length) {
      this._root.focused(this.lineX) ? (i2 = "positionX", a = s2.xAxes.getIndex(0)) : this._root.focused(this.lineY) && (a = s2.yAxes.getIndex(0), i2 = "positionY");
      let o4 = 1;
      if (t && (o4 = 5), a) {
        let t2, s3 = a.get("renderer").get("inversed", false);
        "ArrowRight" == e2 || "ArrowDown" == e2 ? t2 = 1 : "ArrowLeft" == e2 || "ArrowUp" == e2 ? t2 = -1 : "Tab" == e2 && (t2 = 0), null != t2 && (s3 && (t2 *= -1), this.set(i2, a.nextPosition(t2 * o4)));
      }
    }
  }
  _handleLineFocus() {
  ...
  _handleCursorUp(e2) {
    if (this._downPoint) {
      ...
      if ("none" != t) {
        ...
        const a = this._downPoint, o4 = this.get("moveThreshold", 1);
        if (s2 && a) {
          let i3 = false;
          if ("zoomX" !== t && "zoomXY" !== t && "selectX" !== t && "selectXY" !== t || Math.abs(s2.x - a.x) > o4 && (i3 = true), "zoomY" !== t && "zoomXY" !== t && "selectY" !== t && "selectXY" !== t || Math.abs(s2.y - a.y) > o4 && (i3 = true), i3) {
  ...
  handleMove(e2, t, i2) {
    ...
    this._movePoint = e2;
    let o4 = this._display.toLocal(e2), n3 = this.chart;
    if (n3 && (this._inPlot(o4) || this._downPoint)) {
  ...
  _updateSelection(e2) {
    const t = this.selection, i2 = this.get("behavior"), s2 = this.width(), a = this.height();
    e2.x < 0 && (e2.x = 0), e2.x > s2 && (e2.x = s2), e2.y < 0 && (e2.y = 0), e2.y > a && (e2.y = a), t.set("draw", (t2) => {
      const o4 = this._downPoint;
      o4 && ("zoomXY" === i2 || "selectXY" === i2 ? (t2.moveTo(o4.x, o4.y), t2.lineTo(o4.x, e2.y), t2.lineTo(e2.x, e2.y), t2.lineTo(e2.x, o4.y), t2.lineTo(o4.x, o4.y)) : "zoomX" === i2 || "selectX" === i2 ? (t2.moveTo(o4.x, 0), t2.lineTo(o4.x, a), t2.lineTo(e2.x, a), t2.lineTo(e2.x, 0), t2.lineTo(o4.x, 0)) : "zoomY" !== i2 && "selectY" !== i2 || (t2.moveTo(0, o4.y), t2.lineTo(s2, o4.y), t2.lineTo(s2, e2.y), t2.lineTo(0, e2.y), t2.lineTo(0, o4.y)));
    });
  }
  _onHide() {
    if (this.isHidden()) {
...
var ce = class extends D {
  ...
  _processAxisRange(e2) {
    ...
    if (s2) {
      ...
      const a = i2.get("axisFill");
      a && t.set("mask", a), s2._seriesAxisRanges.push(i2);
    }
  }
  _removeAxisRange(e2) {
    const t = e2.axisDataItem, i2 = t.component;
    i2.disposeDataItem(t), k(i2._seriesAxisRanges, t);
  ...
  _dispose() {
    ...
    const e2 = this.chart;
    e2 && e2.series.removeValue(this), O(this.get("xAxis").series, this), O(this.get("yAxis").series, this);
  }
  _min(e2, t) {
  ...
  _shouldMakeBullet(e2) {
    ...
    if (a > 0) {
      ...
      if (t == s2) {
        if (t.get("renderer").axisLength() / o4 < a / 5) return false;
      } else if (i2 == s2 && i2.get("renderer").axisLength() / o4 < a / 5) return false;
    }
    return null != e2.get(this._xField) && null != e2.get(this._yField);
  }
  _makeFieldNames() {
    const e2 = this.get("xAxis"), t = this.get("yAxis"), i2 = e2.getPrivate("name"), s2 = Bt(i2), a = t.getPrivate("name"), o4 = Bt(a), n3 = e2.get("renderer").getPrivate("letter"), r2 = t.get("renderer").getPrivate("letter"), l2 = "open", h = "low", d = "high", c = "Show";
    "ValueAxis" === e2.className ? (this._xField = this.get(i2 + n3 + c), this._xOpenField = this.get(l2 + s2 + n3 + c), this._xLowField = this.get(h + s2 + n3 + c), this._xHighField = this.get(d + s2 + n3 + c)) : (this._xField = i2 + n3, this._xOpenField = l2 + s2 + n3, this._xLowField = h + s2 + n3, this._xHighField = d + s2 + n3), "ValueAxis" === t.className ? (this._yField = this.get(a + r2 + c), this._yOpenField = this.get(l2 + o4 + r2 + c), this._yLowField = this.get(h + o4 + r2 + c), this._yHighField = this.get(d + o4 + r2 + c)) : (this._yField = a + r2, this._yOpenField = l2 + o4 + r2, this._yLowField = h + o4 + r2, this._yHighField = d + o4 + r2);
  }
  _fixVC() {
    const e2 = this.get("xAxis"), t = this.get("yAxis"), i2 = this.get("baseAxis"), s2 = this.states.lookup("hidden"), a = this.get("sequencedInterpolation");
    if (s2) {
      let o4 = 0;
      a && (o4 = 0.999999999999), e2 === i2 ? s2.set("vcy", o4) : (t === i2 || s2.set("vcy", o4), s2.set("vcx", o4));
    }
  }
  _handleMaskBullets() {
  ...
  _prepareChildren() {
    ...
    if (this.isDirty("stacked") && (o4 ? this._valuesDirty && !this._dataProcessed || this._stack() : this._unstack()), this._valuesDirty && !this._dataProcessed && (this._dataProcessed = true, o4 && this._stack(), P(this.dataItems, (i3) => {
      ...
      let s3 = this.startIndex(), a2 = this.endIndex(), o5 = this.get("minBulletDistance", 0);
      if (o5 > 0 && i2 && (i2.get("renderer").axisLength() / (a2 - s3) > o5 ? this._showBullets = true : this._showBullets = false), (this._psi != s3 || this._pei != a2 || this.isDirty("vcx") || this.isDirty("vcy") || this.isPrivateDirty("adjustedStartIndex") || this._stackDirty || this._valuesDirty) && !this._selectionProcessed) {
        this._selectionProcessed = true;
        const o6 = this.get("vcx", 1), n3 = this.get("vcy", 1), r2 = this.get("stacked", false), l2 = this.getPrivate("outOfSelection");
        ...
        else for (let e3 = s3; e3 < a2; e3++) this.processYSelectionDataItem(this.dataItems[e3], n3, r2);
        ...
        else for (let e3 = s3; e3 < a2; e3++) this.processXSelectionDataItem(this.dataItems[e3], o6, r2);
    ...
    if (this.axisRanges.length > 0) {
      ...
      null == e2 && (e2 = this.children.push(Ye.new(this._root, {})), this._mainContainerMask = e2, e2.set("draw", (t, i2) => {
        ...
        if (s2) {
          ...
          t.moveTo(-e3, -a), t.lineTo(-e3, 2 * a), t.lineTo(2 * e3, 2 * a), t.lineTo(2 * e3, -a), t.lineTo(-e3, -a), this.axisRanges.each((e4) => {
      ...
      for (let t2 = 0; t2 < n3; t2++) {
        ...
        if (n4) {
          ...
          if (l2) {
            ...
            if (_(t3)) {
              if (h >= 0 && t3 >= 0) {
                e3.setRaw(o4, n4), this._reallyStackedTo[i3.uid] = i3, i3._stackedSeries[this.uid] = this;
                break;
              }
              if (h < 0 && t3 < 0) {
                e3.setRaw(o4, n4), this._reallyStackedTo[i3.uid] = i3, i3._stackedSeries[this.uid] = this;
  ...
  processXSelectionDataItem(e2, t, i2) {
    P(this.__valueXShowFields, (s2) => {
      let a = e2.get(s2);
      null != a && (i2 && (a += this.getStackedXValueWorking(e2, s2)), this._min("selectionMinX", a), this._max("selectionMaxX", a * t));
    });
  }
  processYSelectionDataItem(e2, t, i2) {
    P(this.__valueYShowFields, (s2) => {
      let a = e2.get(s2);
      null != a && (i2 && (a += this.getStackedYValueWorking(e2, s2)), this._min("selectionMinY", a), this._max("selectionMaxY", a * t));
    });
  }
  ...
  _positionBullet(e2) {
    let t = e2.get("sprite");
    if (t) {
      let i2 = t.dataItem, s2 = e2.get("locationX", i2.get("locationX", 0.5)), a = e2.get("locationY", i2.get("locationY", 0.5)), o4 = this.get("xAxis"), n3 = this.get("yAxis"), r2 = o4.getDataItemPositionX(i2, this._xField, s2, this.get("vcx", 1)), l2 = n3.getDataItemPositionY(i2, this._yField, a, this.get("vcy", 1)), h = this.getPoint(r2, l2), d = i2.get("left", h.x), c = i2.get("right", h.x), u = i2.get("top", h.y), g2 = i2.get("bottom", h.y), p = 0, m = 0, _4 = c - d, b = g2 - u;
      if (this._shouldShowBullet(r2, l2)) {
        ...
        if (null != o5) {
          let e3;
          n4 == c2 ? ("value" == o5 ? e3 = this._yField : "open" == o5 ? e3 = this._yOpenField : "high" == o5 ? e3 = this._yHighField : "low" == o5 && (e3 = this._yLowField), e3 && (l2 = u2.getDataItemPositionY(i2, e3, 0, this.get("vcy", 1)), h = u2.get("renderer").positionToPoint(l2), m = h.y, p = d + _4 * s2)) : ("value" == o5 ? e3 = this._xField : "open" == o5 ? e3 = this._xOpenField : "high" == o5 ? e3 = this._xHighField : "low" == o5 && (e3 = this._xLowField), e3 && (r2 = c2.getDataItemPositionX(i2, e3, 0, this.get("vcx", 1)), h = c2.get("renderer").positionToPoint(r2), p = h.x, m = g2 - b * a));
        } else p = d + _4 * s2, m = g2 - b * a;
        ...
        if (x2) {
          ...
          if (n4 == c2) {
            ...
            if (i3) {
              let s3 = i3.bounds(), a2 = t.localBounds(), o6 = m;
              m = s3.top, "down" == x2 ? m = s3.bottom - a2.top : "auto" == x2 ? e3 && (o6 < e3.plotContainer.height() / 2 ? m = s3.bottom - a2.top : m += a2.bottom) : m += a2.bottom;
            }
            this._bullets[r2 + "_" + l2] = t;
          } else {
            let i3 = this._bullets[r2 + "_" + l2];
            if (i3) {
              let s3 = i3.bounds(), a2 = t.localBounds(), o6 = p;
              p = s3.right, "down" == x2 ? p = s3.left - a2.right : "auto" == x2 ? e3 && (o6 < e3.plotContainer.width() / 2 ? p = s3.left - a2.right : p -= a2.left) : p -= a2.left;
            }
            this._bullets[r2 + "_" + l2] = t;
          }
        }
  ...
  hideDataItem(e2, t) {
    ...
    return o(this, void 0, void 0, function* () {
      ...
      const n3 = o4.get("stateAnimationEasing", this.get("stateAnimationEasing")), r2 = this.get("xAxis"), l2 = this.get("yAxis"), h = this.get("baseAxis"), d = this.get("stacked");
      if (h !== r2 && h || P(this._valueYFields, (i3) => {
        let o5 = l2.getPrivate("min"), r3 = l2.baseValue();
        _(o5) && o5 > r3 && (r3 = o5), d && (r3 = 0), null != e2.get(i3) && s2.push(e2.animate({ key: i3 + "Working", to: r3, duration: t, easing: n3 }).waitForStop());
      }), h === l2 || !h) {
        let i3 = r2.getPrivate("min"), o5 = r2.baseValue();
        _(i3) && i3 > o5 && (o5 = i3), d && (o5 = 0), P(this._valueXFields, (i4) => {
          null != e2.get(i4) && s2.push(e2.animate({ key: i4 + "Working", to: o5, duration: t, easing: n3 }).waitForStop());
        });
      }
      yield Promise.all(s2);
    });
  ...
  showDataItemTooltip(e2) {
    ...
    if (t) if (!this.isHidden() && this.get("visible")) {
      if (t._setDataItem(e2), e2) {
        let i2 = this.get("locationX", 0), s2 = this.get("locationY", 1), a = e2.get("locationX", i2), o4 = e2.get("locationY", s2);
        const n3 = this.get("xAxis"), r2 = this.get("yAxis"), l2 = this.get("vcx", 1), h = this.get("vcy", 1), d = n3.getDataItemPositionX(e2, this._tooltipFieldX, this._aLocationX0 + (this._aLocationX1 - this._aLocationX0) * a, l2), c = r2.getDataItemPositionY(e2, this._tooltipFieldY, this._aLocationY0 + (this._aLocationY1 - this._aLocationY0) * o4, h), u = this.getPoint(d, c);
        let g2 = true;
  ...
  getPoint(e2, t) {
    let i2 = this.get("xAxis").get("renderer").positionToCoordinate(e2), s2 = this.get("yAxis").get("renderer").positionToCoordinate(t), a = 999999999;
    return s2 < -a && (s2 = -a), s2 > a && (s2 = a), i2 < -a && (i2 = -a), i2 > a && (i2 = a), { x: i2, y: s2 };
  }
  _shouldInclude(e2) {
    return true;
  }
  ...
  _adjustStartIndex(e2) {
    ...
    if (this.get("baseAxis") == t && t.isType("DateAxis")) {
      const i2 = t.baseDuration(), s2 = t.getPrivate("selectionMin", t.getPrivate("min", 0)), a = i2 * this.get("locationX", 0.5);
      let o4 = -1 / 0;
      for (; o4 < s2; ) {
        ...
        {
          const i3 = t2.open;
          if (o4 = i3 ? i3.valueX : t2.get("valueX", 0), o4 += a, !(o4 < s2)) break;
          e2++;
        }
      }
    }
...
Object.defineProperty(ce, "className", { enumerable: true, configurable: true, writable: true, value: "XYSeries" }), Object.defineProperty(ce, "classNames", { enumerable: true, configurable: true, writable: true, value: D.classNames.concat([ce.className]) });
var ue2 = class extends _2 {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_series", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "_isPanning", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "minorDataItems", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "labelsContainer", { enumerable: true, configurable: true, writable: true, value: this.children.push(ni.new(this._root, {})) }), Object.defineProperty(this, "gridContainer", { enumerable: true, configurable: true, writable: true, value: ni.new(this._root, { width: r, height: r }) }), Object.defineProperty(this, "topGridContainer", { enumerable: true, configurable: true, writable: true, value: ni.new(this._root, { width: r, height: r }) }), Object.defineProperty(this, "bulletsContainer", { enumerable: true, configurable: true, writable: true, value: this.children.push(ni.new(this._root, { isMeasured: false, width: r, height: r, position: "absolute" })) }), Object.defineProperty(this, "chart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_rangesDirty", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_panStart", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_panEnd", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_sAnimation", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_eAnimation", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_skipSync", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "axisRanges", { enumerable: true, configurable: true, writable: true, value: new se() }), Object.defineProperty(this, "_seriesAxisRanges", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "ghostLabel", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_cursorPosition", { enumerable: true, configurable: true, writable: true, value: -1 }), Object.defineProperty(this, "_snapToSeries", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_seriesValuesDirty", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_seriesAdded", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "axisHeader", { enumerable: true, configurable: true, writable: true, value: this.children.push(ni.new(this._root, { themeTags: ["axis", "header"], position: "absolute", background: Xe.new(this._root, { themeTags: ["header", "background"], fill: this._root.interfaceColors.get("background") }) })) }), Object.defineProperty(this, "_bullets", { enumerable: true, configurable: true, writable: true, value: {} });
  }
  _dispose() {
  ...
  zoom(e2, t, i2, s2) {
    if (this.get("zoomable", true)) if (this._updateFinals(e2, t), this.get("start") !== e2 || this.get("end") != t) {
      let o4 = this._sAnimation, n3 = this._eAnimation, r2 = this.get("maxDeviation", 0.5) * Math.min(1, t - e2);
      ...
      if ((o4 && o4.playing && o4.to == e2 || this.get("start") == e2) && (n3 && n3.playing && n3.to == t || this.get("end") == t)) return;
      if (i2 > 0) {
        let s3, a, o5 = this.get("interpolationEasing");
        if (this.get("start") != e2 && (s3 = this.animate({ key: "start", to: e2, duration: i2, easing: o5 })), this.get("end") != t && (a = this.animate({ key: "end", to: t, duration: i2, easing: o5 })), this._sAnimation = s3, this._eAnimation = a, s3) return s3;
        if (a) return a;
  ...
  _processAxisRange(e2, t) {
    ...
    const i2 = e2.get("above"), s2 = this.topGridContainer, a = e2.get("grid");
    i2 && a && s2.children.moveValue(a);
  ...
  _createAssets(e2, t, i2) {
    ...
    if (l2) {
      let a2 = l2.get("themeTags"), o5 = false;
      i2 ? -1 == (null == a2 ? void 0 : a2.indexOf(r2)) && (o5 = true) : -1 != (null == a2 ? void 0 : a2.indexOf(r2)) && (o5 = true), o5 && (null === (s2 = l2.parent) || void 0 === s2 || s2.children.removeValue(l2), n3.makeLabel(e2, t), l2.dispose(), n3.labels.removeValue(l2));
    } else n3.makeLabel(e2, t);
    const h = e2.get("grid");
    if (h) {
      let s3 = h.get("themeTags"), o5 = false;
      i2 ? -1 == (null == s3 ? void 0 : s3.indexOf(r2)) && (o5 = true) : -1 != (null == s3 ? void 0 : s3.indexOf(r2)) && (o5 = true), o5 && (null === (a = h.parent) || void 0 === a || a.children.removeValue(h), n3.makeGrid(e2, t), h.dispose(), n3.grid.removeValue(h));
    } else n3.makeGrid(e2, t);
    const d = e2.get("tick");
    if (d) {
      let s3 = false, a2 = d.get("themeTags");
      i2 ? -1 == (null == a2 ? void 0 : a2.indexOf(r2)) && (s3 = true) : -1 != (null == a2 ? void 0 : a2.indexOf(r2)) && (s3 = true), s3 && (null === (o4 = d.parent) || void 0 === o4 || o4.children.removeValue(d), n3.makeTick(e2, t), d.dispose(), n3.ticks.removeValue(d));
...
Object.defineProperty(ue2, "className", { enumerable: true, configurable: true, writable: true, value: "Axis" }), Object.defineProperty(ue2, "classNames", { enumerable: true, configurable: true, writable: true, value: _2.classNames.concat([ue2.className]) });
var ge = class extends ue2 {
  ...
  _handleSizeDirty() {
    this._sizeDirty && !this._dseHandled && (this._dirtySelectionExtremes = true, this._dseHandled = true);
  }
  _clearDirty() {
  ...
  _prepareAxisItems() {
    ...
    if (_(e2) && _(t)) {
      ...
      if (t2) {
        ...
        h = n3, h <= 0 && (h = 1, i2 < 1 && (h = _(this._minRealLog) ? this._minRealLog : Math.pow(10, -50))), l2 = Math.log(o4 - i2) * Math.LOG10E - Math.log(h) * Math.LOG10E, l2 > 2 && (n3 = Math.pow(10, Math.log(h) * Math.LOG10E - 50));
      }
      ...
      for (; n3 < o4; ) {
        let e3;
        this.dataItems.length < x2 + 1 ? (e3 = new g(this, void 0, {}), this._dataItems.push(e3), this.processDataItem(e3)) : e3 = this.dataItems[x2], this._createAssets(e3, []), this._toggleDataItem(e3, true), e3.setRaw("value", n3);
        const s3 = e3.get("label");
        s3 && s3.set("text", this._formatText(n3)), this._prepareDataItem(e3);
        let a = n3;
        if (t2 && l2 > 2 ? a = Math.pow(10, Math.log(h) * Math.LOG10E + x2 - 50) : a += i2, u) {
          let e4 = n3 + _4;
          if (t2) {
            if (l2 > 2) {
              _4 = this._adjustMinMax(n3, a, 10).step;
            }
            e4 = n3 + _4;
          }
          for (; e4 < a - 1e-11 * i2; ) {
            let t3;
            this.minorDataItems.length < f + 1 ? (t3 = new g(this, void 0, {}), this.minorDataItems.push(t3), this.processDataItem(t3)) : t3 = this.minorDataItems[f], this._createAssets(t3, ["minor"], true), this._toggleDataItem(t3, true), t3.setRaw("value", e4);
  ...
  _prepareDataItem(e2, t) {
    let i2 = this.get("renderer"), s2 = e2.get("value"), o4 = e2.get("endValue"), n3 = this.valueToPosition(s2), r2 = n3, l2 = this.valueToPosition(s2 + this.getPrivate("step"));
    _(o4) && (r2 = this.valueToPosition(o4), l2 = r2), e2.get("isRange") && null == o4 && (l2 = n3);
  ...
  _handleRangeChange() {
    ...
    let s2 = this._adjustMinMax(e2, t, i2, true), a = _t(s2.step);
    this.setPrivateRaw("stepDecimalPlaces", a), e2 = de(e2, a), t = de(t, a), s2 = this._adjustMinMax(e2, t, i2, true);
    let o4 = s2.step;
  ...
  getDataItemPositionX(e2, t, i2, s2) {
    ...
    if (e2.get("stackToItemX")) {
      a = a * s2 + e2.component.getStackedXValueWorking(e2, t);
    } else a = this._baseValue + (a - this._baseValue) * s2;
  ...
  getDataItemPositionY(e2, t, i2, s2) {
    ...
    if (e2.get("stackToItemY")) {
      a = a * s2 + e2.component.getStackedYValueWorking(e2, t);
    } else a = this._baseValue + (a - this._baseValue) * s2;
    return this.valueToPosition(a);
  }
  basePosition() {
    ...
    if (this.get("calculateTotals")) {
      ...
      if (e2) {
        ...
        if (e2.dataItems.length > 0) {
          t > 0 && t--;
          let i2, s2, a = e2.endIndex();
          a < e2.dataItems.length && a++, e2.get("yAxis") == this ? (i2 = "valueY", s2 = "vcy") : e2.get("xAxis") == this && (i2 = "valueX", s2 = "vcx");
          let o4 = i2 + "Working";
          if (i2) for (let e3 = t; e3 < a; e3++) {
            let t2 = 0, a2 = 0;
            P(this.series, (i3) => {
              if (!i3.get("excludeFromTotal")) {
                let n3 = i3.dataItems[e3];
                if (n3) {
                  let e4 = n3.get(o4) * i3.get(s2);
                  o2(e4) || (t2 += e4, a2 += Math.abs(e4));
                }
              }
            }), P(this.series, (n3) => {
              if (!n3.get("excludeFromTotal")) {
                ...
                if (r2) {
                  let e4 = r2.get(o4) * n3.get(s2);
                  o2(e4) || (r2.set(i2 + "Total", a2), r2.set(i2 + "Sum", t2), r2.set(i2 + "TotalPercent", e4 / a2 * 100));
                }
              }
            });
          }
  ...
  _getSelectionMinMax() {
    ...
    let o4 = this.get("extraMin", 0), n3 = this.get("extraMax", 0);
    this.get("logarithmic") && (null == this.get("extraMin") && (o4 = 0.1), null == this.get("extraMax") && (n3 = 0.2));
    ...
    if (_(e2) && _(t)) {
      ...
      if (P(this.series, (e3) => {
        if (!e3.get("ignoreMinMax")) {
          ...
          if (e3.get("xAxis") === this) {
            if (!s3) {
              let s4 = e3.getPrivate("minX"), a = e3.getPrivate("maxX");
              0 == e3.startIndex() && e3.endIndex() == e3.dataItems.length || (s4 = void 0, a = void 0), t2 = e3.getPrivate("selectionMinX", s4), i3 = e3.getPrivate("selectionMaxX", a);
            }
          } else if (e3.get("yAxis") === this && !s3) {
            let s4 = e3.getPrivate("minY"), a = e3.getPrivate("maxY");
            0 == e3.startIndex() && e3.endIndex() == e3.dataItems.length || (s4 = void 0, a = void 0), t2 = e3.getPrivate("selectionMinY", s4), i3 = e3.getPrivate("selectionMaxY", a);
          }
      ...
      if (x2 && (_4 = this._syncAxes(c, u, _4.step, x2.getPrivate("selectionMinFinal", x2.getPrivate("minFinal", 0)), x2.getPrivate("selectionMaxFinal", x2.getPrivate("maxFinal", 1)), x2.getPrivate("selectionStepFinal", x2.getPrivate("step", 1))), _4.min < e2 && (_4.min = e2), _4.max > t && (_4.max = t), c = _4.min, u = _4.max), d && (_(i2) && (c = Math.max(c, i2)), _(s2) && (u = Math.min(u, s2))), h && (c = g2 - (p - g2) * o4, u = p + (p - g2) * n3), d) {
      ...
      let f = Math.min(20, Math.ceil(Math.log(this.getPrivate("maxZoomFactor", 100) + 1) / Math.LN10) + 2), v = de(this.valueToFinalPosition(c), f), y = de(this.valueToFinalPosition(u), f);
      this.setPrivateRaw("selectionMinFinal", c), this.setPrivateRaw("selectionMaxFinal", u), this.setPrivateRaw("selectionStepFinal", _4.step), this.zoom(v, y);
    }
  }
  _getMinMax() {
    let e2 = this.get("min"), t = this.get("max"), i2 = 1 / 0, s2 = -1 / 0, o4 = this.get("extraMin", 0), n3 = this.get("extraMax", 0);
    this.get("logarithmic") && (null == this.get("extraMin") && (o4 = 0.1), null == this.get("extraMax") && (n3 = 0.2));
    let l2 = 1 / 0;
    if (P(this.series, (e3) => {
      if (!e3.get("ignoreMinMax")) {
    ...
    this._minRealLog = i2, _(c) && (i2 = c), _(u) && (s2 = u), i2 = this._fixMin(i2), s2 = this._fixMax(s2), s2 - i2 <= 1 / Math.pow(10, 15) && (s2 - i2 != 0 ? this._deltaMinMax = (s2 - i2) / 2 : this._getDelta(s2), i2 -= this._deltaMinMax, s2 += this._deltaMinMax), i2 -= (s2 - i2) * o4, s2 += (s2 - i2) * n3, this.get("logarithmic") && (i2 < 0 && h >= 0 && (i2 = 0), s2 > 0 && d <= 0 && (s2 = 0)), this._minReal = i2, this._maxReal = s2;
  ...
  _adjustMinMax(e2, t, i2, s2) {
    ...
    let o4 = e2, n3 = t, l2 = t - e2;
    0 === l2 && (l2 = Math.abs(t));
    let h = Math.log(Math.abs(l2)) * Math.LOG10E, d = Math.pow(10, Math.floor(h));
    d /= 10;
    let c = d;
    s2 && (c = 0), s2 ? (e2 = Math.floor(e2 / d) * d, t = Math.ceil(t / d) * d) : (e2 = Math.ceil(e2 / d) * d - c, t = Math.floor(t / d) * d + c), e2 < 0 && o4 >= 0 && (e2 = 0), t > 0 && n3 <= 0 && (t = 0), h = Math.log(Math.abs(l2)) * Math.LOG10E, d = Math.pow(10, Math.floor(h)), d /= 100;
    ...
    return e2 = de(u * x2, _4), b = s2 ? Math.floor(t / u) : Math.ceil(t / u), b === x2 && b++, (t = de(u * b, _4)) < n3 && (t += u), e2 > o4 && (e2 -= u), u = this.fixSmallStep(u), { min: e2, max: t, step: u };
  }
  getTooltipText(e2, t) {
    const i2 = this.get("tooltipNumberFormat", this.get("numberFormat")), s2 = this.getNumberFormatter(), a = this.get("extraTooltipPrecision", 0), o4 = this.getPrivate("stepDecimalPlaces", 0) + a, n3 = de(this.positionToValue(e2), o4);
    return i2 ? s2.format(n3, i2) : s2.format(n3, void 0, o4);
  }
  getSeriesItem(e2, t) {
    let i2, s2, a = this.getPrivate("name") + this.get("renderer").getPrivate("letter"), o4 = this.positionToValue(t);
    if (P(e2.dataItems, (e3, t2) => {
      const n3 = Math.abs(e3.get(a) - o4);
  ...
  zoomToValues(e2, t, i2) {
    ...
    null != this.getPrivate("min") && null != this.getPrivate("max") && this.zoom((e2 - s2) / (a - s2), (t - s2) / (a - s2), i2);
  }
  _syncAxes(e2, t, i2, s2, o4, n3) {
    if (this.get("syncWithAxis")) {
      let r2 = Math.round(o4 - s2) / n3, l2 = Math.round((t - e2) / i2), h = this.get("renderer").gridCount();
      if (_(r2) && _(l2)) {
        let s3 = false, a = 0, o5 = 0.01 * (t - e2), n4 = e2, l3 = t, d = i2;
        for (; 1 != s3; ) if (s3 = this._checkSync(n4, l3, d, r2), a++, a > 500 && (s3 = true), s3) e2 = n4, t = l3, i2 = d;
        else {
          a / 3 == Math.round(a / 3) ? (n4 = e2 - o5 * a, e2 >= 0 && n4 < 0 && (n4 = 0)) : (l3 = t + o5 * a, l3 <= 0 && l3 > 0 && (l3 = 0));
  ...
  _checkSync(e2, t, i2, s2) {
    let a = (t - e2) / i2;
    for (let o4 = 1; o4 < s2; o4++) if (de(a / o4, 1) == s2 || a * o4 == s2) return true;
    return false;
  }
  getCellWidthPosition() {
...
var me = class extends U2 {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_tickPoints", { enumerable: true, configurable: true, writable: true, value: [] });
  }
};
Object.defineProperty(me, "className", { enumerable: true, configurable: true, writable: true, value: "AxisTick" }), Object.defineProperty(me, "classNames", { enumerable: true, configurable: true, writable: true, value: U2.classNames.concat([me.className]) });
var _e = class extends Ye {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_axisLength", { enumerable: true, configurable: true, writable: true, value: 100 }), Object.defineProperty(this, "_start", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_end", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_inversed", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_minSize", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "chart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_lc", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_ls", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_thumbDownPoint", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downStart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downEnd", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "ticks", { enumerable: true, configurable: true, writable: true, value: this.addDisposer(new ne(Fe.new({}), () => me._new(this._root, { themeTags: Ut(this.ticks.template.get("themeTags", []), this.get("themeTags", [])) }, [this.ticks.template]))) }), Object.defineProperty(this, "grid", { enumerable: true, configurable: true, writable: true, value: this.addDisposer(new ne(Fe.new({}), () => re2._new(this._root, { themeTags: Ut(this.grid.template.get("themeTags", []), this.get("themeTags", [])) }, [this.grid.template]))) }), Object.defineProperty(this, "axisFills", { enumerable: true, configurable: true, writable: true, value: this.addDisposer(new ne(Fe.new({}), () => Ye._new(this._root, { themeTags: Ut(this.axisFills.template.get("themeTags", ["axis", "fill"]), this.get("themeTags", [])) }, [this.axisFills.template]))) }), Object.defineProperty(this, "labels", { enumerable: true, configurable: true, writable: true, value: this.addDisposer(new ne(Fe.new({}), () => pe2._new(this._root, { themeTags: Ut(this.labels.template.get("themeTags", []), this.get("themeTags", [])) }, [this.labels.template]))) }), Object.defineProperty(this, "axis", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "thumb", { enumerable: true, configurable: true, writable: true, value: void 0 });
  }
  makeTick(e2, t) {
  ...
  _handleThumbMove(e2) {
    ...
    if (t) {
      const i2 = this.toLocal(e2.point), s2 = this._downStart, a = this._downEnd, o4 = this._getPan(i2, t) * Math.min(1, a - s2) / 2 * this.get("panSensitivity", 1);
      this.axis.zoom(s2 - o4, a + o4, 0);
    }
  }
  _getPan(e2, t) {
    return 0;
  ...
  toggleVisibility(e2, t, i2, s2) {
    let a = this.axis;
    const o4 = a.get("start", 0), n3 = a.get("end", 1);
    t < o4 + (n3 - o4) * (i2 - 1e-4) || t > o4 + (n3 - o4) * (s2 + 1e-4) ? e2.setPrivate("visible", false) : e2.setPrivate("visible", true);
  }
...
var be = class extends _e {
    ...
    if (this.isDirty(t) || this.isDirty(i2)) {
      ...
      if (this.get(i2) ? e2.addTag(i2) : e2.removeTag(i2), s2) {
        if (this.get(t)) {
          ...
          -1 == i3.indexOf(e2) && i3.insertIndex(0, e2), e2.addTag(t), a.moveValue(this);
        } else {
          const i3 = s2.bottomAxesContainer.children;
          -1 == i3.indexOf(e2) && i3.moveValue(e2), e2.removeTag(t), a.moveValue(this, 0);
        }
  ...
  _updatePositions() {
    ...
    if (i2) {
      ...
      let a = e2.get("marginLeft", 0), o4 = e2.x() - a;
      const n3 = e2.parent;
      n3 && (o4 -= n3.get("paddingLeft", 0)), s2.children.length > 0 ? (a = e2.axisHeader.width(), e2.set("marginLeft", a + 1)) : s2.set("width", a), s2.setAll({ x: o4, y: -1, height: t2.height() + 2 });
    }
  }
  processAxis() {
    super.processAxis();
  ...
  updateTick(e2, t, s2, o4) {
    if (e2) {
      _(t) || (t = 0);
      let n3 = 0.5;
      n3 = _(o4) && o4 > 1 ? e2.get("multiLocation", n3) : e2.get("location", n3), _(s2) && s2 != t && (t += (s2 - t) * n3), e2.set("x", this.positionToCoordinate(t));
  ...
  updateLabel(e2, t, s2, o4) {
    if (e2) {
      let n3 = 0.5;
      n3 = _(o4) && o4 > 1 ? e2.get("multiLocation", n3) : e2.get("location", n3), _(t) || (t = 0);
      const r2 = e2.get("inside", this.get("inside", false));
      this.get("opposite") ? r2 ? (e2.set("position", "absolute"), e2.set("y", 0)) : (e2.set("position", "relative"), e2.set("y", r)) : r2 ? (e2.set("y", 0), e2.set("position", "absolute")) : (e2.set("y", void 0), e2.set("position", "relative")), _(s2) && s2 != t && (t += (s2 - t) * n3), e2.set("x", this.positionToCoordinate(t)), this.toggleVisibility(e2, t, e2.get("minPosition", 0), e2.get("maxPosition", 1));
    }
  }
  updateGrid(e2, t, i2) {
    if (e2) {
  ...
  updateBullet(e2, t, i2) {
    if (e2) {
      ...
      if (s2) {
        ...
        _(i2) && i2 != t && (t += (i2 - t) * o4);
        let n3 = this.axis.roundAxisPosition(t, o4), r2 = this.axis._bullets[n3], l2 = -1;
  ...
  fillDrawMethod(e2, t, i2) {
    e2.set("draw", (e3) => {
      ...
      i2 < t && ([i2, t] = [t, i2]), t > a || i2 < 0 || (e3.moveTo(t, 0), e3.lineTo(i2, 0), e3.lineTo(i2, s2), e3.lineTo(t, s2), e3.lineTo(t, 0));
    });
  }
  ...
  updateTooltipBounds(e2) {
    ...
    let s2 = this._display.toGlobal({ x: 0, y: 0 }), a = s2.x, o4 = 0, n3 = this.axisLength(), r2 = i2, l2 = "up";
    this.get("opposite") ? t ? (l2 = "up", o4 = s2.y, r2 = i2) : (l2 = "down", o4 = s2.y - i2, r2 = i2) : t ? (l2 = "down", o4 = s2.y - i2, r2 = i2) : (l2 = "up", o4 = s2.y, r2 = i2);
    const h = { left: a, right: a + n3, top: o4, bottom: o4 + r2 }, d = e2.get("bounds");
...
var xe = class extends _e {
  ...
  _changed() {
    ...
    const t = this.thumb, i2 = "opposite", s2 = "inside", a = this.chart;
    ...
    a && (this.get(i2) ? t.set("centerX", 0) : t.set("centerX", o4)), t.setPrivate("width", o4);
  }
  processAxis() {
    super.processAxis();
    const e2 = this.axis;
  ...
  _updatePositions() {
    ...
    if (i2) {
      ...
      s2.children.length > 0 ? (a = e2.axisHeader.height(), e2.set("marginTop", a + 1)) : s2.set("height", a), s2.setAll({ y: e2.y() - a, x: -1, width: t2.width() + 2 });
    }
  }
  axisLength() {
  ...
  updateLabel(e2, t, i2, s2) {
    if (e2) {
      ...
      n3 ? (e2.set("x", 0), r2 ? e2.set("position", "absolute") : e2.set("position", "relative")) : r2 ? (e2.set("x", 0), e2.set("position", "absolute")) : (e2.set("x", void 0), e2.set("position", "relative")), _(i2) && i2 != t && (t += (i2 - t) * o4), e2.set("y", this.positionToCoordinate(t)), this.toggleVisibility(e2, t, e2.get("minPosition", 0), e2.get("maxPosition", 1));
    }
  }
  updateGrid(e2, t, i2) {
    if (e2) {
  ...
  fillDrawMethod(e2, t, i2) {
    e2.set("draw", (e3) => {
      ...
      i2 < t && ([i2, t] = [t, i2]), t > a || i2 < 0 || (e3.moveTo(0, t), e3.lineTo(s2, t), e3.lineTo(s2, i2), e3.lineTo(0, i2), e3.lineTo(0, t));
    });
  }
  positionToCoordinate(e2) {
  ...
  updateTooltipBounds(e2) {
    const t = this.get("inside"), i2 = 1e5;
    let s2 = this._display.toGlobal({ x: 0, y: 0 }), a = s2.y, o4 = 0, n3 = this.axisLength(), r2 = i2, l2 = "right";
    this.get("opposite") ? t ? (l2 = "right", o4 = s2.x - i2, r2 = i2) : (l2 = "left", o4 = s2.x, r2 = i2) : t ? (l2 = "left", o4 = s2.x, r2 = i2) : (l2 = "right", o4 = s2.x - i2, r2 = i2);
    const h = { left: o4, right: o4 + r2, top: a, bottom: a + n3 }, d = e2.get("bounds");
    Vt(h, d) || (e2.set("bounds", h), e2.set("pointerOrientation", l2));
  }
  _updateLC() {
    const e2 = this.axis, t = e2.parent;
...
var fe = class extends ce {
  ...
  _startSegment(e2) {
    ...
    const s2 = this.get("autoGapCount"), a = this.get("connect"), o4 = this.makeFill(this.fills), n3 = this._fillTemplate, r2 = this.fills.template;
    n3 && n3 != r2 && (o4.template = n3), o4.setPrivate("visible", true);
    ...
    const y = this.get("stacked"), w = d.basePosition(), P2 = c.basePosition();
    let A;
    ...
    let S = this.get("locationX", 0.5), O2 = this.get("locationY", 0.5), C = this.get("openLocationX", S), X2 = this.get("openLocationY", O2);
    const Y = this.get("minDistance", 0);
    let L, F = this.fills.template.get("visible");
    this.axisRanges.length > 0 && (F = true);
    let I3 = false;
    (y || f || v) && (I3 = true);
    const j2 = { points: k3, segments: D2, stacked: y, getOpen: I3, basePosX: w, basePosY: P2, fillVisible: F, xField: m, yField: _4, xOpenField: b, yOpenField: x2, vcx: g2, vcy: p, baseAxis: u, xAxis: d, yAxis: c, locationX: S, locationY: O2, openLocationX: C, openLocationY: X2, minDistance: Y };
    let V2 = this._strokeTemplate, E = this._fillTemplate;
    for (L = e2; L < i2; L++) {
      this._dindex = L;
      const t2 = this._dataItems[L];
      let n4 = t2.get(m), r3 = t2.get(_4);
      if (null == n4 || null == r3 ? a || (k3 = [], D2.push(k3), j2.points = k3) : this._getPoints(t2, j2), T2) {
      ...
      if (!a) {
        ...
        e3 && u.shouldGap(t2, e3, s2, A) && (k3 = [], D2.push(k3), j2.points = k3);
      }
    }
    o4.setRaw("userData", [e2, L]), l2.setRaw("userData", [e2, L]), L === t && this._endLine(k3, D2[0][0]), l2 && this._drawStroke(l2, D2), o4 && this._drawFill(o4, D2), this.axisRanges.each((t2) => {
      const i3 = t2.container, s3 = t2.fills, a2 = this.makeFill(s3);
      i3 && i3.children.push(a2), a2.setPrivate("visible", true), this._drawFill(a2, D2);
      const o5 = t2.strokes, n4 = this.makeStroke(o5);
      i3 && i3.children.push(n4), V2 && V2 != this.strokes.template && (n4.template = V2), E && E != this.fills.template && (a2.template = E), n4.setPrivate("visible", true), this._drawStroke(n4, D2), a2.setRaw("userData", [e2, L]), n4.setRaw("userData", [e2, L]);
    });
  }
  _getPoints(e2, t) {
    let i2 = t.points, s2 = e2.get("locationX", t.locationX), a = e2.get("locationY", t.locationY), o4 = t.xAxis.getDataItemPositionX(e2, t.xField, s2, t.vcx), n3 = t.yAxis.getDataItemPositionY(e2, t.yField, a, t.vcy);
    if (this._shouldInclude(o4)) {
      const s3 = this.getPoint(o4, n3), a2 = [s3.x, s3.y];
      if (s3.x += this._x, s3.y += this._y, e2.set("point", s3), t.fillVisible) {
        ...
        if (t.baseAxis === t.xAxis ? s4 = t.basePosY : t.baseAxis === t.yAxis && (i3 = t.basePosX), t.getOpen) {
          let a3 = e2.get(t.xOpenField), o5 = e2.get(t.yOpenField);
          if (null != a3 && null != o5) {
            let a4 = e2.get("openLocationX", t.openLocationX), o6 = e2.get("openLocationY", t.openLocationY);
            if (t.stacked) {
              let n4 = e2.get("stackToItemX"), r3 = e2.get("stackToItemY");
              n4 ? (i3 = t.xAxis.getDataItemPositionX(n4, t.xField, a4, n4.component.get("vcx")), o2(i3) && (i3 = t.basePosX)) : i3 = t.yAxis === t.baseAxis ? t.basePosX : t.xAxis.getDataItemPositionX(e2, t.xOpenField, a4, t.vcx), r3 ? (s4 = t.yAxis.getDataItemPositionY(r3, t.yField, o6, r3.component.get("vcy")), o2(s4) && (s4 = t.basePosY)) : s4 = t.xAxis === t.baseAxis ? t.basePosY : t.yAxis.getDataItemPositionY(e2, t.yOpenField, o6, t.vcy);
            } else i3 = t.xAxis.getDataItemPositionX(e2, t.xOpenField, a4, t.vcx), s4 = t.yAxis.getDataItemPositionY(e2, t.yOpenField, o6, t.vcy);
          }
        }
      ...
      if (t.minDistance > 0) {
        const e3 = a2[0], s4 = a2[1], o5 = a2[2], n4 = a2[3], r2 = this._previousPoint, l2 = r2[0], h = r2[1], d = r2[2], c = r2[3];
        (Math.hypot(e3 - l2, s4 - h) > t.minDistance || o5 && n4 && Math.hypot(o5 - d, n4 - c) > t.minDistance) && (i2.push(a2), this._previousPoint = a2);
      } else i2.push(a2);
    }
  }
  _endLine(e2, t) {
  ...
  _processAxisRange(e2) {
    super._processAxisRange(e2), e2.fills = new ne(Fe.new({}), () => Ye._new(this._root, { themeTags: Ut(e2.fills.template.get("themeTags", []), ["line", "series", "fill"]) }, [this.fills.template, e2.fills.template])), e2.strokes = new ne(Fe.new({}), () => Ye._new(this._root, { themeTags: Ut(e2.strokes.template.get("themeTags", []), ["line", "series", "stroke"]) }, [this.strokes.template, e2.strokes.template]));
  }
  createLegendMarker(e2) {
    const t = this.get("legendDataItem");
    if (t) {
      ...
      const a = e3.children.push(Ye._new(e3._root, { themeTags: ["line", "series", "legend", "marker", "fill"] }, [this.fills.template]));
      this._legendFill = a;
      const o4 = this._root.interfaceColors.get("disabled");
      if (s2.states.create("disabled", { fill: o4, stroke: o4 }), a.states.create("disabled", { fill: o4, stroke: o4 }), this.bullets.length > 0) {
        const t2 = this.bullets.getIndex(0);
        if (t2) {
          const i3 = t2(e3._root, this, new g(this, { legend: true }, {}));
          if (i3) {
...
var x = class _x extends ce {
  ...
  _prepareChildren() {
    ...
    const t = this.get("xAxis"), e2 = this.get("yAxis"), i2 = this.dataItems.length, s2 = Math.max(0, this.startIndex() - 2), a = Math.min(this.endIndex() + 2, i2 - 1);
    if (t.inited && e2.inited) for (let o4 = s2; o4 <= a; o4++) {
  ...
  _updateChildren() {
    ...
    const e2 = this.get("xAxis"), i2 = this.get("yAxis"), a = this.get("baseAxis"), o4 = this.columns.template;
    ...
    P(a.series, (t2) => {
      ...
      t2 === this && (n3 = r2 - 1), l2++;
    }), this.get("clustered") || (n3 = 0, r2 = 1), 0 === r2 && (r2 = 1, n3 = 0);
    ...
    if (this._aLocationX0 = m + n3 / r2 * (p - m), this._aLocationX1 = m + (n3 + 1) / r2 * (p - m), this._aLocationY0 = u + n3 / r2 * (_4 - u), this._aLocationY1 = u + (n3 + 1) / r2 * (_4 - u), e2.inited && i2.inited) {
      if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty) {
        ...
        for (let a2 = i3 + 1; a2 < t2; a2++) this._toggleColumn(this.dataItems[a2], false);
      }
    } else this._skipped = true;
    ...
    if (!e2) {
      ...
      if (i2) {
        ...
        if (t2) {
          ...
          P(ze, (s2) => {
            const a2 = e2.get(s2, this.get(s2));
            t2.set(s2, a2), i3.set(s2, a2);
          });
        }
      }
      let a = t.get("rangeGraphics");
      a && P(a, (t2) => {
        t2.dispose();
      }), a = [], t.setRaw("rangeGraphics", a), this.axisRanges.each((e3) => {
        const i3 = e3.container, s2 = this._makeGraphics(e3.columns, t);
        a && a.push(s2), s2.setPrivate("list", e3.columns), i3.children.push(s2);
      });
    }
  }
  createAxisRange(t) {
  ...
  _updateGraphics(t, e2) {
    ...
    const a = this._xField, o4 = this._yField, l2 = t.get(a), h = t.get(o4);
    if (null != l2 && null != h) {
      const l3 = this._xOpenField, h2 = this._yOpenField, g2 = this.get("locationX", t.get("locationX", 0.5)), d = this.get("locationY", t.get("locationY", 0.5)), c = this.get("openLocationX", t.get("openLocationX", g2)), m = this.get("openLocationY", t.get("openLocationY", d)), p = i2.get("width"), u = i2.get("height"), x2 = this.get("stacked"), _4 = this.get("xAxis"), I3 = this.get("yAxis"), f = this.get("baseAxis"), y = _4.get("start"), P2 = _4.get("end"), b = I3.get("start"), v = I3.get("end");
      let D2, T2, C, w, A = this.get("vcy", 1), k3 = this.get("vcx", 1), F = false, M = false;
      if (I3.isType("CategoryAxis") && _4.isType("CategoryAxis")) {
        let e3 = this._aLocationX0 + c - 0.5, i3 = this._aLocationX1 + g2 - 0.5;
        if (p instanceof e) {
          let t2 = (i3 - e3) * (1 - p.value) / 2;
          e3 += t2, i3 -= t2;
        }
        if (D2 = _4.getDataItemPositionX(t, l3, e3, k3), T2 = _4.getDataItemPositionX(t, a, i3, k3), e3 = this._aLocationY0 + m - 0.5, i3 = this._aLocationY1 + d - 0.5, u instanceof e) {
          let t2 = (i3 - e3) * (1 - u.value) / 2;
          e3 += t2, i3 -= t2;
        }
        C = I3.getDataItemPositionY(t, h2, e3, A), w = I3.getDataItemPositionY(t, o4, i3, A), t.setRaw("point", { x: D2 + (T2 - D2) / 2, y: C + (w - C) / 2 });
      } else if (_4 === f) {
        let e3 = this._aLocationX0 + c - 0.5, i3 = this._aLocationX1 + g2 - 0.5;
        if (p instanceof e) {
          let t2 = (i3 - e3) * (1 - p.value) / 2;
        ...
        if (D2 = _4.getDataItemPositionX(t, l3, e3, k3), T2 = _4.getDataItemPositionX(t, a, i3, k3), C = I3.getDataItemPositionY(t, o4, d, A), this._yOpenField !== this._yField) w = I3.getDataItemPositionY(t, h2, m, A);
        else if (x2) {
          let e4 = t.get("stackToItemY");
          w = e4 ? I3.getDataItemPositionY(e4, o4, m, e4.component.get("vcy")) : I3.basePosition();
        } else w = I3.basePosition();
        t.setRaw("point", { x: D2 + (T2 - D2) / 2, y: C }), M = true;
      } else if (I3 === f) {
        ...
        if (C = I3.getDataItemPositionY(t, h2, e3, A), w = I3.getDataItemPositionY(t, o4, i3, A), T2 = _4.getDataItemPositionX(t, a, g2, k3), this._xOpenField !== this._xField) D2 = _4.getDataItemPositionX(t, l3, c, k3);
        else if (x2) {
          let e4 = t.get("stackToItemX");
          D2 = e4 ? _4.getDataItemPositionX(e4, a, c, e4.component.get("vcx")) : _4.basePosition();
        } else D2 = _4.basePosition();
        F = true, t.setRaw("point", { x: T2, y: C + (w - C) / 2 });
      }
      this._updateSeriesGraphics(t, i2, D2, T2, C, w, F, M), D2 < y && T2 < y || D2 > P2 && T2 > P2 || C < b && w <= b || C >= v && w > v || o2(D2) || o2(C) ? this._toggleColumn(t, false) : this._toggleColumn(t, true);
      let X2 = t.get("rangeGraphics");
      X2 && P(X2, (e3) => {
        this._updateSeriesGraphics(t, e3, D2, T2, C, w, F, M);
      }), this._applyGraphicsStates(t, e2);
    }
  }
  _updateSeriesGraphics(t, e2, i2, s2, a, o4, n3, r2) {
    const h = e2.get("width"), g2 = e2.get("height"), d = e2.get("maxWidth"), c = e2.get("maxHeight"), m = this.getPoint(i2, a), p = this.getPoint(s2, o4), u = t.get("point");
    if (u) {
      const t2 = this.getPoint(u.x, u.y);
      u.x = t2.x + this._x, u.y = t2.y + this._y;
    }
    if (i2 = m.x, s2 = p.x, a = m.y, o4 = p.y, _(h)) {
      const t2 = (s2 - i2 - h) / 2;
      i2 += t2, s2 -= t2;
    }
    ...
    if (_(c) && c < Math.abs(o4 - a)) {
      const t2 = (o4 - a - c) / 2;
      a += t2, o4 -= t2;
    }
    this.get("adjustBulletPosition") && (n3 && (s2 = Math.min(Math.max(0, s2), this._pw), i2 = Math.min(Math.max(0, i2), this._pw)), r2 && (a = Math.min(Math.max(0, a), this._ph), o4 = Math.min(Math.max(0, o4), this._ph))), t.setRaw("left", i2), t.setRaw("right", s2), t.setRaw("top", a), t.setRaw("bottom", o4), e2.setPrivate("width", s2 - i2), e2.setPrivate("height", o4 - a), e2.set("x", i2), e2.set("y", o4 - (o4 - a));
  }
  _handleDataSetChange() {
  ...
  _applyGraphicsStates(t, e2) {
    const i2 = t.get("graphics"), s2 = i2.states.lookup("dropFromOpen"), a = i2.states.lookup("riseFromOpen"), o4 = i2.states.lookup("dropFromPrevious"), n3 = i2.states.lookup("riseFromPrevious");
    if (s2 || o4 || a || n3) {
      const i3 = this.get("xAxis"), r2 = this.get("yAxis"), h = this.get("baseAxis");
      let g2, d, c;
      h === i3 && r2.isType("ValueAxis") ? (g2 = t.get(this._yOpenField), d = t.get(this._yField), c = e2.get(this._yField)) : h === r2 && i3.isType("ValueAxis") && (g2 = t.get(this._xOpenField), d = t.get(this._xField), c = e2.get(this._xField)), _(g2) && _(d) && (d < g2 ? s2 && s2.apply() : a && a.apply(), _(c) && (d < c ? o4 && o4.apply() : n3 && n3.apply()));
    }
  }
  disposeDataItem(t) {
  ...
  hideDataItem(t, e2) {
    const i2 = Object.create(null, { hideDataItem: { get: () => super.hideDataItem } });
    return o(this, void 0, void 0, function* () {
      const a = [i2.hideDataItem.call(this, t, e2)], o4 = t.get("graphics");
      o4 && a.push(o4.hide(e2));
      const n3 = t.get("rangeGraphics");
      n3 && P(n3, (t2) => {
        a.push(t2.hide(e2));
      }), yield Promise.all(a);
    });
  ...
  showDataItem(t, e2) {
    const i2 = Object.create(null, { showDataItem: { get: () => super.showDataItem } });
    return o(this, void 0, void 0, function* () {
      const a = [i2.showDataItem.call(this, t, e2)], o4 = t.get("graphics");
      o4 && a.push(o4.show(e2));
      const n3 = t.get("rangeGraphics");
      n3 && P(n3, (t2) => {
        a.push(t2.show(e2));
      }), yield Promise.all(a);
  ...
  updateLegendMarker(t) {
    ...
    if (e2) {
      ...
      if (a && !e2.get("itemContainer").get("disabled")) {
        const t2 = a.states.lookup("default");
        P(ze, (e3) => {
          const s2 = i2.get(e3, this.get(e3));
          a.set(e3, s2), t2.set(e3, s2);
        });
      }
    }
  }
...
var _3 = class __ extends ue2 {
  ...
  _handleRangeChange() {
    P(this.series, (t) => {
      let e2 = this.dataItems[this.startIndex()].get("category"), a = this.dataItems[this.endIndex() - 1].get("category"), o4 = t.get("baseAxis"), n3 = t.get("xAxis"), r2 = t.get("yAxis");
      if (n3 instanceof __ && r2 instanceof __) t._markDirtyAxes();
      else if (o4 === this) {
        let l2, h, g2 = r2;
        if (n3 === o4 ? (t.get("categoryXField") && (l2 = "categoryX"), t.get("openCategoryXField") && (h = "openCategoryX")) : r2 === o4 && (t.get("categoryYField") && (l2 = "categoryY"), t.get("openCategoryYField") && (h = "openCategoryY"), g2 = n3), g2 instanceof ge && (l2 || h)) {
          let i2, o5;
          for (let s2 = 0, a2 = t.dataItems.length; s2 < a2; s2++) {
            let a3 = t.dataItems[s2];
            if (l2 && a3.get(l2) === e2) {
              i2 = a3;
              break;
            }
          ...
          let n4 = 0, r3 = t.dataItems.length;
          i2 && (n4 = t.dataItems.indexOf(i2)), o5 && (r3 = t.dataItems.indexOf(o5) + 1), t.setPrivate("startIndex", n4), t.setPrivate("endIndex", r3);
          let g3 = false;
          for (let e3 = n4; e3 < r3; e3++) {
  ...
  _prepareAxisItems() {
    ...
    let a = this.endIndex();
    a < i2 && a++;
    const o4 = e2.get("minorLabelsEnabled"), n3 = e2.get("minorGridEnabled", o4);
    let r2 = e2.axisLength() / Math.max(e2.get("minGridDistance"), 1), l2 = Math.max(1, Math.min(i2, Math.ceil((a - s2) / r2)));
    ...
    for (let g2 = s2; g2 < a; g2 += l2) {
      let t2 = this.dataItems[g2];
      this._createAssets(t2, []), this._toggleDataItem(t2, true);
      let e3 = l2;
      n3 && (e3 = 1), this._prepareDataItem(t2, h, e3), h++;
    }
    if (e2.get("minorGridEnabled")) for (let g2 = s2; g2 < a; g2++) {
  ...
  _prepareDataItem(t, e2, i2) {
    let s2 = this.get("renderer"), a = t.get("categoryLocation", 0), o4 = t.get("endCategoryLocation", 1), n3 = t.get("index");
    _(n3) || (n3 = this.categoryToIndex(t.get("category")));
    let r2, h = this.indexToPosition(n3, a), g2 = t.get("endCategory");
    g2 ? (r2 = this.categoryToIndex(g2), _(r2) || (r2 = n3)) : r2 = n3;
    let d, c, m = this.indexToPosition(r2, o4);
    d = t.get("isRange") ? r2 : n3 + this._frequency - 1, c = this.indexToPosition(d, o4), s2.updateLabel(t.get("label"), h, m, i2), s2.updateGrid(t.get("grid"), h, m), s2.updateTick(t.get("tick"), h, m, i2), s2.updateFill(t.get("axisFill"), h, c), this._processBullet(t), s2.updateBullet(t.get("bullet"), h, m);
  ...
  getDataItemPositionX(t, e2, i2, s2) {
    const a = t.get(e2), o4 = this._itemMap[a];
  ...
  indexToPosition(t, e2) {
    ...
    let a = (t + e2 - s2) / i2, o4 = this.dataItems[t];
    return o4 && (a += o4.get("deltaPosition", 0)), a;
  }
  categoryToIndex(t) {
    let e2 = this._itemMap[t];
  ...
  getSeriesItem(t, e2) {
    if (this.dataItems.length > 0) {
      let i2 = this.getPrivate("name") + this.get("renderer").getPrivate("letter"), s2 = this.axisPositionToIndex(e2), a = t.dataItems[s2], o4 = this.dataItems[s2], n3 = o4.get("category");
      if (a && o4 && a.get(i2) === n3) return a;
      for (let e3 = 0, r2 = t.dataItems.length; e3 < r2; e3++) {
        let s3 = t.dataItems[e3];
        if (s3.get(i2) === n3) return s3;
      }
    }
  }
...
var I2 = class extends x {
  constructor() {
    super(...arguments), Object.defineProperty(this, "columns", { enumerable: true, configurable: true, writable: true, value: this.addDisposer(new ne(Fe.new({}), () => n2._new(this._root, { position: "absolute", themeTags: Ut(this.columns.template.get("themeTags", []), ["series", "column"]) }, [this.columns.template]))) });
  }
  makeColumn(t, e2) {
  ...
  _processAxisRange(t) {
    super._processAxisRange(t), t.columns = new ne(Fe.new({}), () => n2._new(this._root, { position: "absolute", themeTags: Ut(t.columns.template.get("themeTags", []), ["series", "column"]) }, [this.columns.template, t.columns.template]));
  }
};
Object.defineProperty(I2, "className", { enumerable: true, configurable: true, writable: true, value: "ColumnSeries" }), Object.defineProperty(I2, "classNames", { enumerable: true, configurable: true, writable: true, value: x.classNames.concat([I2.className]) });
export {
  be as AxisRendererXAm5,
  xe as AxisRendererYAm5,
  _3 as CategoryAxisAm5,
  I2 as ColumnSeriesAm5,
  fe as LineSeriesAm5,
  ge as ValueAxisAm5,
  ne2 as XYChartAm5,
  le as XYCursorAm5
};
//# sourceMappingURL=xyChart-PTVEMLP7.js.map
