...
}`), u4.textureCoordinateType !== d2.None && (T2.include(u2, u4), x2.uniforms.add(u4.bindType === a.Pass ? new s2("normalTexture", (e9) => e9.textureNormal) : new s("normalTexture", (e9) => e9.textureNormal)), u4.hasNormalTextureTransform && (x2.uniforms.add(new e4("scale", (e9) => e9.scale ?? l)), x2.uniforms.add(new e3("normalTextureTransformMatrix", (t5) => t5.normalTextureTransformMatrix ?? o))), x2.code.add(o3`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
function s3(e9, s4) {
  s4.hasColorTextureTransform ? (e9.varyings.add("colorUV", "vec2"), e9.vertex.uniforms.add(new e3("colorTextureTransformMatrix", (e10) => e10.colorTextureTransformMatrix ?? o)).code.add(o3`void forwardColorUV(){
colorUV = (colorTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)) : e9.vertex.code.add(o3`void forwardColorUV(){}`);
}
function i4(s4, i5) {
  i5.hasNormalTextureTransform && i5.textureCoordinateType !== d2.None ? (s4.varyings.add("normalUV", "vec2"), s4.vertex.uniforms.add(new e3("normalTextureTransformMatrix", (e9) => e9.normalTextureTransformMatrix ?? o)).code.add(o3`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)) : s4.vertex.code.add(o3`void forwardNormalUV(){}`);
}
function t4(s4, i5) {
  i5.hasEmissionTextureTransform && i5.textureCoordinateType !== d2.None ? (s4.varyings.add("emissiveUV", "vec2"), s4.vertex.uniforms.add(new e3("emissiveTextureTransformMatrix", (e9) => e9.emissiveTextureTransformMatrix ?? o)).code.add(o3`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)) : s4.vertex.code.add(o3`void forwardEmissiveUV(){}`);
}
function d4(s4, i5) {
  i5.hasOcclusionTextureTransform && i5.textureCoordinateType !== d2.None ? (s4.varyings.add("occlusionUV", "vec2"), s4.vertex.uniforms.add(new e3("occlusionTextureTransformMatrix", (e9) => e9.occlusionTextureTransformMatrix ?? o)).code.add(o3`void forwardOcclusionUV(){
occlusionUV = (occlusionTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)) : s4.vertex.code.add(o3`void forwardOcclusionUV(){}`);
}
function n5(s4, i5) {
  i5.hasMetallicRoughnessTextureTransform && i5.textureCoordinateType !== d2.None ? (s4.varyings.add("metallicRoughnessUV", "vec2"), s4.vertex.uniforms.add(new e3("metallicRoughnessTextureTransformMatrix", (e9) => e9.metallicRoughnessTextureTransformMatrix ?? o)).code.add(o3`void forwardMetallicRoughnessUV(){
...
function J(J2) {
  ...
  if (d(Q, J2), K2.include(o5), Y.add("vpos", "vec3"), K2.include(l2, J2), K2.include(M, J2), K2.include(a3, J2), K2.include(s3, J2), !u(Z)) return K2.include(h, J2), K2;
  K2.include(i4, J2), K2.include(t4, J2), K2.include(d4, J2), K2.include(n5, J2), f(Q, J2), K2.include(t, J2), K2.include(o6, J2);
  const be = ee === a2.Attribute || ee === a2.Compressed;
  return be && re && K2.include(e5), K2.include(T, J2), K2.include(c, J2), oe && K2.attributes.add(e.INSTANCECOLOR, "vec4"), Y.add("vPositionLocal", "vec3"), K2.include(o7, J2), K2.include(n2, J2), K2.include(i, J2), K2.include(e6, J2), Q.uniforms.add(new e7("externalColor", (e9) => e9.externalColor)), Y.add("vcolorExt", "vec4"), J2.terrainDepthTest && Y.add("depth", "float"), Q.main.add(o3`
  ...
  `), K2.include(p, J2), K2.include(t3, J2), K2.include(t2, J2), K2.include(ne ? m2 : x, J2), K2.include(a5, J2), K2.include(P, J2), K2.include(d3, J2), f(X, J2), X.uniforms.add(Q.uniforms.get("localOrigin"), new e2("ambient", (e9) => e9.ambient), new e2("diffuse", (e9) => e9.diffuse), new o4("opacity", (e9) => e9.opacity), new o4("layerOpacity", (e9) => e9.layerOpacity)), me && X.uniforms.add(new s2("tex", (e9) => e9.texture)), K2.include(m, J2), K2.include(n4, J2), X.include(i2), K2.include(e8, J2), h2(X), u3(X), a4(X), X.main.add(o3`
      ...
      ${se === n3.Normal || se === n3.Schematic ? o3`
...
//# sourceMappingURL=chunk-X5DEX4NK.js.map
