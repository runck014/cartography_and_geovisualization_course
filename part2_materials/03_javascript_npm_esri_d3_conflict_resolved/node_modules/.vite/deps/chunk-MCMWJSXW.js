...
function u(t) {
  ...
  let e2 = t < 0;
  t = Math.abs(t);
  let i2, s2 = /^([0-9]+)(?:\.([0-9]+))?(?:e[\+\-]([0-9]+))?$/.exec("" + t), r2 = s2[1], n2 = s2[2] || "";
  if (void 0 === s2[3]) i2 = "" === n2 ? r2 : r2 + "." + n2;
  else {
    let e3 = +s2[3];
    if (t < 1) {
      i2 = "0." + p("0", e3 - 1) + r2 + n2;
      ...
      let t2 = e3 - n2.length;
      i2 = 0 === t2 ? r2 + n2 : t2 < 0 ? r2 + n2.slice(0, t2) + "." + n2.slice(t2) : r2 + n2 + p("0", t2);
    }
  }
  return e2 ? "-" + i2 : i2;
}
...
function Ct(t, e2 = false, i2 = false, s2 = false, r2) {
  ...
  let n2 = t.toLocaleString("UTC"), a2 = t.toLocaleString("UTC", { timeZoneName: e2 ? "long" : "short" }).substr(n2.length);
  return false === i2 && (a2 = a2.replace(/ (standard|daylight|summer|winter) /i, " ")), vt(a2);
}
function Mt(t) {
...
function At(t) {
  let e2, i2, s2, r2 = t.h, n2 = t.s, a2 = t.l;
  if (0 == n2) e2 = i2 = s2 = a2;
  else {
    let t2 = function(t3, e3, i3) {
      return i3 < 0 && (i3 += 1), i3 > 1 && (i3 -= 1), i3 < 1 / 6 ? t3 + 6 * (e3 - t3) * i3 : i3 < 0.5 ? e3 : i3 < 2 / 3 ? t3 + (e3 - t3) * (2 / 3 - i3) * 6 : t3;
    }, o3 = a2 < 0.5 ? a2 * (1 + n2) : a2 + n2 - a2 * n2, h2 = 2 * a2 - o3;
    e2 = t2(h2, o3, r2 + 1 / 3), i2 = t2(h2, o3, r2), s2 = t2(h2, o3, r2 - 1 / 3);
  }
  return { r: Math.round(255 * e2), g: Math.round(255 * i2), b: Math.round(255 * s2) };
}
function Ht(t) {
  let e2 = t.r / 255, i2 = t.g / 255, s2 = t.b / 255, r2 = Math.max(e2, i2, s2), n2 = Math.min(e2, i2, s2), a2 = 0, o3 = 0, h2 = (r2 + n2) / 2;
  if (r2 === n2) a2 = o3 = 0;
  else {
    let t2 = r2 - n2;
    switch (o3 = h2 > 0.5 ? t2 / (2 - r2 - n2) : t2 / (r2 + n2), r2) {
      case e2:
        a2 = (i2 - s2) / t2 + (i2 < s2 ? 6 : 0);
        break;
      case i2:
        a2 = (s2 - e2) / t2 + 2;
        break;
...
var Xt = class {
  ...
  _on(t, e2, i2, s2, r2, n2) {
    if (this._disposed) throw new Error("EventDispatcher is disposed");
    this._removeExistingListener(t, e2, i2, s2);
    const a2 = { type: e2, callback: i2, context: s2, shouldClone: r2, dispatch: n2, killed: false, once: t, disposer: new z(() => {
...
function me(t, e2, i2, s2, r2) {
  let n2 = Number.MAX_VALUE, a2 = Number.MAX_VALUE, o3 = -Number.MAX_VALUE, h2 = -Number.MAX_VALUE, l2 = [];
  ...
  for (let p2 = 0; p2 < l2.length; p2++) {
    let t2 = l2[p2];
    t2.x < n2 && (n2 = t2.x), t2.y < a2 && (a2 = t2.y), t2.x > o3 && (o3 = t2.x), t2.y > h2 && (h2 = t2.y);
  }
  return { left: t + n2, top: e2 + a2, right: t + o3, bottom: e2 + h2 };
}
function fe(t, e2) {
...
function be(t) {
  const e2 = t.length;
  if (e2 > 0) {
    let i2 = t[0], s2 = i2.left, r2 = i2.top, n2 = i2.right, a2 = i2.bottom;
    if (e2 > 1) for (let o3 = 1; o3 < e2; o3++) i2 = t[o3], s2 = Math.min(i2.left, s2), n2 = Math.max(i2.right, n2), r2 = Math.min(i2.top, r2), a2 = Math.max(i2.bottom, a2);
  ...
  applyAnimate(t) {
    ...
    return this._eachSetting((n2, a2) => {
      if (!s2[n2]) {
        ...
        const o3 = this._entity.animate({ key: n2, to: a2, duration: t, easing: e2 });
        o3 && (r2[n2] = o3);
      }
    }), r2;
  }
...
function je(t, e2, i2) {
  const s2 = t.length, r2 = e2.length, n2 = Math.min(s2, r2);
  for (let a2 = 0; a2 < n2; ++a2) {
    const s3 = i2(t[a2], e2[a2]);
    if (0 !== s3) return s3;
  }
  return Se(s2, r2);
}
...
var Me = class {
  constructor(t, e2, i2, s2, r2, n2, a2) {
    Object.defineProperty(this, "_animation", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_from", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_to", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_duration", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_easing", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_loops", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_interpolate", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_oldTime", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_time", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_stopped", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_playing", { enumerable: true, configurable: true, writable: true, value: true }), Object.defineProperty(this, "events", { enumerable: true, configurable: true, writable: true, value: new Xt() }), this._animation = t, this._from = e2, this._to = i2, this._duration = s2, this._easing = r2, this._loops = n2, this._interpolate = te(e2, i2), this._oldTime = a2;
  }
  get to() {
    return this._to;
  }
...
var Ae = class {
  ...
  animate(t) {
    const e2 = t.key, i2 = t.to, s2 = t.duration || 0, r2 = t.loops || 1, n2 = void 0 === t.from ? this.get(e2) : t.from, a2 = void 0 === t.easing ? ye : t.easing;
    if (0 === s2) this.set(e2, i2);
    else {
      if (void 0 !== n2 && n2 !== i2) {
        this.set(e2, n2);
        const t2 = this._animatingSettings[e2] = new Me(this, n2, i2, s2, a2, r2, this._animationTime());
        return this._startAnimation(), t2;
      }
      this.set(e2, i2);
    }
    const o3 = new Me(this, n2, i2, s2, a2, r2, null);
    return o3.stop(), o3;
  }
  animatePrivate(t) {
    const e2 = t.key, i2 = t.to, s2 = t.duration || 0, r2 = t.loops || 1, n2 = void 0 === t.from ? this.getPrivate(e2) : t.from, a2 = void 0 === t.easing ? ye : t.easing;
    if (0 === s2) this.setPrivate(e2, i2);
    else {
      if (void 0 !== n2 && n2 !== i2) {
        this.setPrivate(e2, n2);
        const t2 = this._animatingPrivateSettings[e2] = new Me(this, n2, i2, s2, a2, r2, this._animationTime());
        return this._startAnimation(), t2;
      }
...
var We = class _We extends Xt {
  ...
  _on(t, e2, i2, s2, r2, n2) {
    const a2 = super._on(t, e2, i2, s2, r2, n2), o3 = _We.RENDERER_EVENTS[e2];
    return void 0 !== o3 && (a2.disposer = new X([a2.disposer, this._onRenderer(e2, o3)])), a2;
  }
  stopParentDispatch() {
...
var Ue = class extends He {
  ...
  dragMove(t) {
    ...
    if (e2) {
      ...
      let n2 = (t.point.x - e2.point.x) / r2, a2 = (t.point.y - e2.point.y) / r2;
  ...
  showTooltip(t) {
    if (!this.isDisposed()) {
      ...
      if ((i2 || s2) && e2) {
        ...
        "fixed" != r2 && t || (this._display._setMatrix(), t = this.toGlobal(n2._getTooltipPoint())), e2.set("pointTo", t), e2.set("tooltipTarget", n2), e2.get("x") || e2.set("x", t.x), e2.get("y") || e2.set("y", t.y), i2 && e2.label.set("text", i2), s2 && e2.label.set("html", s2);
        const a2 = this.dataItem;
        if (a2 && e2.label._setDataItem(a2), "always" == this.get("showTooltipOn") && (t.x < 0 || t.x > this._root.width() || t.y < 0 || t.y > this._root.height())) return void this.hideTooltip();
  ...
  _updatePosition() {
    const t = this.parent;
    let i2 = this.get("dx", 0), s2 = this.get("dy", 0), r2 = this.get("x"), n2 = this.getPrivate("x"), a2 = 0, o3 = 0;
    const h2 = this.get("position");
    r2 instanceof e && (r2 = t ? t.innerWidth() * r2.value + t.get("paddingLeft", 0) : 0), _(r2) ? a2 = r2 + i2 : null != n2 ? a2 = n2 : t && "relative" == h2 && (a2 = t.get("paddingLeft", 0) + i2);
    ...
    if (u2.x != a2 || u2.y != o3) {
      u2.invalidateBounds(), u2.x = a2, u2.y = o3;
  ...
  width() {
    let t = this.get("width"), i2 = this.get("maxWidth", this.getPrivate("maxWidth")), s2 = this.get("minWidth", this.getPrivate("minWidth")), r2 = this.getPrivate("width"), n2 = 0;
    if (_(r2)) n2 = r2;
    else if (null == t) this._adjustedLocalBounds && (n2 = this._adjustedLocalBounds.right - this._adjustedLocalBounds.left);
    else if (t instanceof e) {
      const e2 = this.parent;
      n2 = e2 ? e2.innerWidth() * t.value : this._root.width() * t.value;
    } else _(t) && (n2 = t);
    return _(s2) && (n2 = Math.max(s2, n2)), _(i2) && (n2 = Math.min(i2, n2)), n2;
  }
  maxWidth() {
  ...
  height() {
    let t = this.get("height"), i2 = this.get("maxHeight", this.getPrivate("maxHeight")), s2 = this.get("minHeight", this.getPrivate("minHeight")), r2 = this.getPrivate("height"), n2 = 0;
    if (_(r2)) n2 = r2;
    else if (null == t) this._adjustedLocalBounds && (n2 = this._adjustedLocalBounds.bottom - this._adjustedLocalBounds.top);
    else if (t instanceof e) {
      const e2 = this.parent;
      n2 = e2 ? e2.innerHeight() * t.value : this._root.height() * t.value;
    } else _(t) && (n2 = t);
    return _(s2) && (n2 = Math.max(s2, n2)), _(i2) && (n2 = Math.min(i2, n2)), n2;
  }
  _findStaticTemplate(t) {
...
var Ve = class extends He {
  ...
  _changed() {
    if (super._changed(), this._clear) {
      const t = this.get("repetition", ""), e2 = this.get("width", 100), i2 = this.get("height", 100), s2 = this.get("fill"), r2 = this.get("fillOpacity", 1), n2 = this._backgroundDisplay, a2 = this._display;
      a2.clear(), n2.clear(), s2 && r2 > 0 && (n2.beginFill(s2, r2), n2.drawRect(0, 0, e2, i2), n2.endFill()), a2.angle = this.get("rotation", 0), this._draw(), this._pattern = this._root._renderer.createPattern(a2, n2, t, e2, i2);
    }
    this._clear = false;
  }
};
...
var Ke = class extends Ve {
  ...
  _draw() {
    ...
    if (t) {
      ...
      let r2 = 0, n2 = 0;
      "pattern" == s2 ? (r2 = e3, n2 = i2) : (r2 = t.width, n2 = t.height, "image" == s2 && (this.set("width", r2), this.set("height", n2)));
      let a2 = 0, o3 = 0;
      this.get("centered", true) && (a2 = e3 / 2 - r2 / 2, o3 = i2 / 2 - n2 / 2), this._display.image(t, r2, n2, a2, o3);
    }
...
var Ye = class extends Ue {
  ...
  _afterChanged() {
    if (super._afterChanged(), this._clear) {
      const t = this.get("fill"), e2 = this.get("fillGradient"), i2 = this.get("fillPattern"), s2 = this.get("fillOpacity"), r2 = this.get("stroke"), n2 = this.get("strokeGradient"), a2 = this.get("strokePattern"), o3 = this.get("shadowColor"), h2 = this.get("shadowBlur"), l2 = this.get("shadowOffsetX"), d2 = this.get("shadowOffsetY"), u2 = this.get("shadowOpacity");
      ...
      if (r2 || n2 || a2) {
        ...
        if (r2 && !n2 && (this._display.lineStyle(e3, r2, t2, i3), this._display.endStroke()), n2) {
          ...
          a3 && (this._display.lineStyle(e3, a3, t2, i3), this._display.endStroke());
        }
        if (a2) {
          let s3 = a2.pattern;
          s3 && (this._display.lineStyle(e3, s3, t2, i3), this._display.endStroke(), a2 instanceof Ke && a2.events.once("loaded", () => {
            this._clear = true, this.markDirty();
          }));
        }
      }
  ...
  updateContainer(t) {
    ...
    $e(t, (t2) => {
      if (t2.isVisible() && "relative" == t2.get("position")) {
        ...
        if (i3 instanceof e) {
          r2 += i3.value;
          let e2 = s2 * i3.value, n3 = t2.get("minWidth", t2.getPrivate("minWidth", -1 / 0));
          n3 > e2 && (s2 -= n3, r2 -= i3.value);
          let a2 = t2.get("maxWidth", t2.getPrivate("maxWidth", 1 / 0));
          e2 > a2 && (s2 -= a2, r2 -= i3.value);
      ...
      if (t2.isVisible() && "relative" == t2.get("position")) {
        let i3 = t2.get("width");
        if (i3 instanceof e) {
          let e2 = s2 * i3.value / r2 - t2.get("marginLeft", 0) - t2.get("marginRight", 0), n3 = t2.get("minWidth", t2.getPrivate("minWidth", -1 / 0)), a2 = t2.get("maxWidth", t2.getPrivate("maxWidth", 1 / 0));
          e2 = Math.min(Math.max(n3, e2), a2), t2.setPrivate("width", e2);
    ...
    $e(t, (t2) => {
      if ("relative" == t2.get("position")) if (t2.isVisible()) {
        let e2 = t2.adjustedLocalBounds(), i3 = t2.get("marginLeft", 0), s3 = t2.get("marginRight", 0), r3 = t2.get("maxWidth"), a2 = e2.left, o3 = e2.right;
        r3 && o3 - a2 > r3 && (o3 = a2 + r3);
        let h2 = n2 + i3 - a2;
        t2.setPrivate("x", h2), n2 = h2 + o3 + s3;
  ...
  updateContainer(t) {
    ...
    $e(t, (t2) => {
      if (t2.isVisible() && "relative" == t2.get("position")) {
        ...
        if (i3 instanceof e) {
          r2 += i3.value;
          let e2 = s2 * i3.value, n3 = t2.get("minHeight", t2.getPrivate("minHeight", -1 / 0));
          n3 > e2 && (s2 -= n3, r2 -= i3.value);
          let a2 = t2.get("maxHeight", t2.getPrivate("maxHeight", 1 / 0));
          e2 > a2 && (s2 -= a2, r2 -= i3.value);
      ...
      if (t2.isVisible() && "relative" == t2.get("position")) {
        let i3 = t2.get("height");
        if (i3 instanceof e) {
          let e2 = s2 * i3.value / r2 - t2.get("marginTop", 0) - t2.get("marginBottom", 0), n3 = t2.get("minHeight", t2.getPrivate("minHeight", -1 / 0)), a2 = t2.get("maxHeight", t2.getPrivate("maxHeight", 1 / 0));
          e2 = Math.min(Math.max(n3, e2), a2), t2.setPrivate("height", e2);
    ...
    $e(t, (t2) => {
      if ("relative" == t2.get("position")) if (t2.isVisible()) {
        let e2 = t2.adjustedLocalBounds(), i3 = t2.get("marginTop", 0), s3 = e2.top, r3 = e2.bottom, a2 = t2.get("maxHeight");
        a2 && r3 - s3 > a2 && (r3 = s3 + a2);
        let o3 = t2.get("marginBottom", 0), h2 = n2 + i3 - s3;
        t2.setPrivate("y", h2), n2 = h2 + r3 + o3;
...
var Qe = class extends Ze {
  ...
  updateContainer(t) {
    let e2 = t.get("paddingLeft", 0), i2 = t.get("paddingRight", 0), s2 = t.get("paddingTop", 0), r2 = t.maxWidth() - e2 - i2, n2 = r2, a2 = 1;
    $e(t, (t2) => {
      if (t2.get("visible") && t2.getPrivate("visible") && !t2.get("forceHidden") && "absolute" != t2.get("position")) {
        let e3 = t2.width();
        e3 < n2 && (n2 = e3), e3 > a2 && (a2 = e3);
      }
    }), n2 = pe(n2, 1, r2), a2 = pe(a2, 1, r2);
    let o3 = 1;
    o3 = this.get("fixedWidthGrid") ? r2 / a2 : r2 / n2, o3 = Math.max(1, Math.floor(o3)), o3 = Math.min(this.get("maxColumns", Number.MAX_VALUE), o3);
    let h2 = this.getColumnWidths(t, o3, a2, r2), l2 = s2, d2 = 0, u2 = 0;
    o3 = h2.length;
    let p2 = e2;
    $e(t, (t2) => {
      if ("relative" == t2.get("position") && t2.isVisible()) {
        const i3 = t2.get("marginTop", 0), s3 = t2.get("marginBottom", 0);
        let r3 = t2.adjustedLocalBounds(), n3 = t2.get("marginLeft", 0), a3 = t2.get("marginRight", 0), c2 = p2 + n3 - r3.left, g2 = l2 + i3 - r3.top;
        t2.setPrivate("x", c2), t2.setPrivate("y", g2), p2 += h2[d2] + a3, u2 = Math.max(u2, t2.height() + i3 + s3), d2++, d2 >= o3 && (d2 = 0, p2 = e2, l2 += u2);
      }
    });
  }
  getColumnWidths(t, e2, i2, s2) {
    ...
    return $e(t, (s3) => {
      ...
      "absolute" != s3.get("position") && s3.isVisible() && (this.get("fixedWidthGrid") ? n2[a2] = i2 : n2[a2] = Math.max(0 | n2[a2], r3.right - r3.left + s3.get("marginLeft", 0) + s3.get("marginRight", 0)), a2 < t.children.length - 1 && (a2++, a2 == e2 && (a2 = 0)));
    }), P(n2, (t2) => {
      r2 += t2;
    }), r2 > s2 ? e2 > 2 ? (e2 -= 1, this.getColumnWidths(t, e2, i2, s2)) : [s2] : n2;
  }
};
...
function ii(t, e2, i2) {
  let s2;
  const r2 = t.dataItem;
  let n2, a2 = [], o3 = /(format[a-zA-Z]*)\((.*)\)|([^.]+)/g;
  for (; n2 = o3.exec(e2), null !== n2; ) if (n2[3]) {
    a2.push({ prop: n2[3] });
    ...
    if ("" != vt(n2[2])) {
      let e3, i3 = /'([^']*)'|"([^"]*)"|([0-9\-]+)/g;
      for (; e3 = i3.exec(n2[2]), null !== e3; ) t2.push(e3[1] || e3[2] || e3[3]);
    }
    a2.push({ method: n2[1], params: t2 });
  }
  if (r2) {
    s2 = ri(t, a2, r2._settings), (null == s2 || m(s2)) && (s2 = ri(t, a2, r2));
    let i3 = r2.dataContext;
    null == s2 && i3 && (s2 = ri(t, a2, i3), null == s2 && (s2 = ri(t, [{ prop: e2 }], i3)), null == s2 && i3.dataContext && (s2 = ri(t, a2, i3.dataContext))), null == s2 && r2.component && r2.component.dataItem !== r2 && (s2 = ii(r2.component, e2));
  }
  return null == s2 && (s2 = ri(t, a2, t)), null == s2 && t.parent && (s2 = ii(t.parent, e2)), s2;
}
function si(t, e2) {
...
function ri(t, e2, i2, s2) {
  let r2 = i2, n2 = false;
  for (let a2 = 0, h2 = e2.length; a2 < h2; a2++) {
    let s3 = e2[a2];
    if (s3.prop) {
      if (r2 instanceof Ue) {
      ...
      case "formatNumber":
        let e3 = l(r2);
        null != e3 && (r2 = t.getNumberFormatter().format(e3, s3.params[0] || void 0), n2 = true);
        break;
      case "formatDate":
        let a3 = d(r2);
        if (!c(a3) || o2(a3.getTime())) return;
        null != a3 && (r2 = t.getDateFormatter().format(a3, s3.params[0] || void 0), n2 = true);
        break;
      case "formatDuration":
        let h3 = l(r2);
        null != h3 && (r2 = t.getDurationFormatter().format(h3, s3.params[0] || void 0, s3.params[1] || void 0), n2 = true);
        break;
      case "urlEncode":
...
var ni = class _ni extends Ue {
  ...
  updateBackground() {
    ...
    if (e2 && !this.isHidden()) {
      let i2 = e2.left, s2 = e2.top, r2 = e2.right - i2, n2 = e2.bottom - s2, a2 = this.get("maxWidth"), o3 = this.get("maxHeight");
      o3 && n2 > o3 && (n2 = o3), a2 && r2 > a2 && (r2 = a2);
      let h2 = this.width(), l2 = this.height();
      t && (t.setAll({ width: r2, height: n2, x: i2, y: s2 }), this._display.interactive && (t._display.interactive = true));
  ...
  _getBounds() {
    if (this.get("html")) {
      ...
      let t = this.get("width"), e2 = this.get("height"), i2 = this.getPrivate("width"), s2 = this.getPrivate("height"), r2 = { left: 0, top: 0, right: this.width(), bottom: this.height() }, n2 = this.get("layout"), a2 = false, o3 = false;
      if ((n2 instanceof Je || n2 instanceof Qe) && (a2 = true), n2 instanceof qe && (o3 = true), null == t && null == i2 || null == e2 && null == s2 || this.get("verticalScrollbar")) {
        let t2 = Number.MAX_VALUE, e3 = t2, i3 = -t2, s3 = t2, n3 = -t2;
        ...
        this.children.each((t3) => {
          if ("absolute" != t3.get("position") && t3.get("isMeasured")) {
            ...
            a2 && (d3 -= t3.get("marginLeft", 0), u3 += t3.get("marginRight", 0)), o3 && (p3 -= t3.get("marginTop", 0), c3 += t3.get("marginBottom", 0)), d3 < e3 && (e3 = d3), u3 > i3 && (i3 = u3), p3 < s3 && (s3 = p3), c3 > n3 && (n3 = c3);
          }
        }), e3 == t2 && (e3 = 0), i3 == -t2 && (i3 = 0), s3 == t2 && (s3 = 0), n3 == -t2 && (n3 = 0), r2.left = e3 - h2, r2.top = s3 - l2, r2.right = i3 + d2, r2.bottom = n3 + u2;
  ...
  _prepareChildren() {
    ...
    if (t != this._prevWidth || i2 != this._prevHeight) {
      let s2 = this.get("layout"), r2 = false, n2 = false;
      s2 && ((s2 instanceof Je || s2 instanceof Qe) && (r2 = true), s2 instanceof qe && (n2 = true)), P(this._percentageSizeChildren, (s3) => {
        if (!r2) {
          let i3 = s3.get("width");
  ...
  _updateHTMLContent() {
    ...
    t && "" !== t ? this._root._setHTMLContent(this, ei(this, this.get("html", ""))) : this._root._removeHTMLContent(this), this._root._positionHTMLElement(this);
  }
  scrollToChild(t) {
    const e2 = this.get("verticalScrollbar");
    if (e2) {
      let i2 = t.y(), s2 = this.innerHeight(), r2 = t.height(), n2 = this._contentHeight, a2 = 1 - (s2 - r2 / 2) / n2;
      if (i2 + 0.7 * r2 + this._childrenDisplay.y > s2 || i2 - 0.3 * r2 + this._childrenDisplay.y < 0) {
        let t2 = Math.max(0, Math.min(a2, (i2 - r2 / 2) / n2));
    ...
    if (this.isDirty("html") && this._updateHTMLContent(), this.isDirty("verticalScrollbar")) {
      ...
      if (t) {
        ...
        e2 || (e2 = this.set("background", Xe.new(this._root, { themeTags: ["background"], fillOpacity: 0, fill: this._root.interfaceColors.get("alternativeBackground") }))), this._vsbd0 = this.events.on("wheel", (e3) => {
          ...
          const r2 = t.get("start", 0), n2 = t.get("end", 1);
          r2 + s2 <= 0 && (s2 = -r2), n2 + s2 >= 1 && (s2 = 1 - n2), r2 + s2 >= 0 && n2 + s2 <= 1 && (t.set("start", r2 + s2), t.set("end", n2 + s2));
  ...
  walkChildren(t) {
    this.children.each((e2) => {
      e2 instanceof _ni && e2.walkChildren(t), t(e2);
    });
  }
  eachChildren(t) {
    const e2 = this.get("background");
...
Object.defineProperty(ni, "className", { enumerable: true, configurable: true, writable: true, value: "Container" }), Object.defineProperty(ni, "classNames", { enumerable: true, configurable: true, writable: true, value: Ue.classNames.concat([ni.className]) });
var ai = class extends Ue {
  constructor() {
...
Object.defineProperty(ai, "className", { enumerable: true, configurable: true, writable: true, value: "Text" }), Object.defineProperty(ai, "classNames", { enumerable: true, configurable: true, writable: true, value: Ue.classNames.concat([ai.className]) });
var oi = class extends ni {
  ...
  _makeText() {
    this._text = this.children.push(ai.new(this._root, {}));
  }
  _updateChildren() {
    ...
    if (P(this._textKeys, (t2) => {
      ...
      let i2;
      null != this.get("width") ? i2 = "right" == e3 ? r : "center" == e3 ? n : 0 : "left" == e3 || "start" == e3 ? i2 = this.get("paddingLeft", 0) : "right" != e3 && "end" != e3 || (i2 = -this.get("paddingRight", 0)), t.set("x", i2);
    }
    const e2 = this.get("background");
  ...
  _setMaxDimentions() {
    ...
    _(s2) ? i2.set(e2 ? "maxHeight" : "maxWidth", s2 - this.get("paddingLeft", 0) - this.get("paddingRight", 0)) : i2.set(e2 ? "maxHeight" : "maxWidth", void 0);
    const r2 = this.get("maxHeight", this.getPrivate("maxHeight", 1 / 0));
    _(r2) ? i2.set(e2 ? "maxWidth" : "maxHeight", r2 - this.get("paddingTop", 0) - this.get("paddingBottom", 0)) : i2.set(e2 ? "maxWidth" : "maxHeight", void 0), this.root.events.once("frameended", () => {
      i2.markDirtyBounds();
    });
  }
  _setDataItem(t) {
...
Object.defineProperty(oi, "className", { enumerable: true, configurable: true, writable: true, value: "Label" }), Object.defineProperty(oi, "classNames", { enumerable: true, configurable: true, writable: true, value: ni.classNames.concat([oi.className]) });
var hi = class {
  constructor(t, e2) {
...
//# sourceMappingURL=chunk-MCMWJSXW.js.map
