...
var b = y = class extends i(f) {
  constructor(t) {
    super(t), this.isAggregate = false, this.layer = null, this.origin = null, this.popupTemplate = null, this.sourceLayer = null, this._version = 0, Object.defineProperty(this, "uid", { value: e(), configurable: true }), Object.defineProperty(this, "_lastMeshTransform", { value: {}, configurable: true, writable: true, enumerable: false }), arguments.length > 1 && o(n.getLogger(this), "Graphic", { version: "4.30" });
  }
  initialize() {
  ...
  cloneShallow() {
    return new y({ aggregateGeometries: this.aggregateGeometries, attributes: this.attributes, geometry: this.geometry, isAggregate: this.isAggregate, layer: this.layer, popupTemplate: this.popupTemplate, sourceLayer: this.sourceLayer, symbol: this.symbol, visible: this.visible, origin: this.origin });
  }
  ...
  toJSON() {
    var _a;
    return { aggregateGeometries: f3(this.aggregateGeometries), geometry: null != this.geometry ? this.geometry.toJSON() : null, symbol: null != this.symbol ? this.symbol.toJSON() : null, attributes: a2(this.attributes) ? this.attributes.toJSON() : { ...this.attributes }, popupTemplate: ((_a = this.popupTemplate) == null ? void 0 : _a.toJSON()) ?? null };
  }
  ...
  _notifyLayer(t, e2, r2, s) {
    if (this._version++, !this.layer || !("graphicChanged" in this.layer)) return;
    const i2 = { graphic: this, property: t, oldValue: e2, newValue: r2 };
...
r([m({ value: null, json: { read: c } })], b.prototype, "aggregateGeometries", null), r([m({ value: null })], b.prototype, "attributes", null), r([m({ value: null, types: n2, json: { read: f2 } })], b.prototype, "geometry", null), r([m({ type: Boolean })], b.prototype, "isAggregate", void 0), r([m({ clonable: "reference" })], b.prototype, "layer", void 0), r([m({ clonable: "reference" })], b.prototype, "origin", void 0), r([m({ type: q })], b.prototype, "popupTemplate", void 0), r([m({ clonable: "reference" })], b.prototype, "sourceLayer", void 0), r([m({ value: null, types: j })], b.prototype, "symbol", null), r([m({ clonable: false, json: { read: false, write: false } })], b.prototype, "_version", void 0), r([m({ type: Boolean, value: true })], b.prototype, "visible", null), b = y = r([a("esri.Graphic")], b);
var d = b;

export {
  d
};
//# sourceMappingURL=chunk-6Q7GN2CW.js.map
