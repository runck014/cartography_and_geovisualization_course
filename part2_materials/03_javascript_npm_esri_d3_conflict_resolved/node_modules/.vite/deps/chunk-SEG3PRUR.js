...
var u4;
var m3 = new n2({ avgRating: "avg-rating", numRatings: "num-ratings", numComments: "num-comments", numViews: "num-views" });
...
r([m()], p.prototype, "categories", void 0), r([m()], p.prototype, "disableExtraQuery", void 0), r([m({ type: w2 })], p.prototype, "extent", void 0), r([m()], p.prototype, "filter", void 0), r([m()], p.prototype, "num", void 0), r([m()], p.prototype, "query", void 0), r([m()], p.prototype, "sortField", void 0), r([m()], p.prototype, "sortOrder", null), r([m()], p.prototype, "start", void 0), p = u4 = r([a3("esri.portal.PortalQueryParams")], p);
var c3 = p;
...
r([m()], u5.prototype, "access", void 0), r([m({ type: Date })], u5.prototype, "created", void 0), r([m()], u5.prototype, "description", void 0), r([m()], u5.prototype, "id", void 0), r([m()], u5.prototype, "isInvitationOnly", void 0), r([m({ type: Date })], u5.prototype, "modified", void 0), r([m()], u5.prototype, "owner", void 0), r([m()], u5.prototype, "portal", void 0), r([m()], u5.prototype, "snippet", void 0), r([m()], u5.prototype, "sortField", void 0), r([m()], u5.prototype, "sortOrder", void 0), r([m()], u5.prototype, "sourceJSON", void 0), r([m()], u5.prototype, "tags", void 0), r([m()], u5.prototype, "thumbnail", void 0), r([m({ readOnly: true })], u5.prototype, "thumbnailUrl", null), r([m()], u5.prototype, "title", void 0), r([m({ readOnly: true })], u5.prototype, "url", null), u5 = l2 = r([a3("esri.portal.PortalGroup")], u5);
var p2 = u5;
...
var u6 = n4 = class extends f {
  ...
  async fetchItems(t2) {
    ...
    const { default: r2 } = await import("./PortalItem-4R2QKFXQ.js"), o2 = { folders: false, inRecycleBin: !!t2.inRecycleBin || null, foldersContent: !(t2.folder || !t2.includeSubfolderItems) || null, num: t2.num || 10, start: t2.start || 1, sortField: t2.sortField || "created", sortOrder: t2.sortOrder || "asc" }, s4 = await this.portal.request(e2, { query: o2 });
    let l4;
...
var U2 = _ = class extends u3(m2) {
  ...
  load(e2) {
    const t2 = import("./Basemap-RQ3KP63D.js").then(({ default: t3 }) => {
      s3(e2), M2 = t3;
  ...
  async createElevationLayers() {
    await this.load();
    const e2 = this._getHelperService("defaultElevationLayers"), t2 = (await import("./ElevationLayer-SCCHGQ2F.js")).default;
...
//# sourceMappingURL=chunk-SEG3PRUR.js.map
