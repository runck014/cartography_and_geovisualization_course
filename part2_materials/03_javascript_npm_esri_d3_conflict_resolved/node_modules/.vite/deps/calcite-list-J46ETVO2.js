...
} from "./chunk-YHSC5ZUW.js";
import {
  MAX_COLUMNS
} from "./chunk-6EIBJKOP.js";
import {
...
import {
  ...
  defineCustomElement3 as defineCustomElement6
} from "./chunk-VOHNEOVL.js";
import "./chunk-4ZPTG6ER.js";
import "./chunk-6X32HROJ.js";
import {
...
var Stack = proxyCustomElement(class Stack2 extends H {
  ...
  render() {
    return h(Host, { key: "97f052828720d715fd3b11a4b0e77fa085127796" }, h("div", { key: "5351cc20a8a437763894fef35ecc7a7240cb7c46", class: CSS2.container }, this.renderActionsStart(), this.renderContentStart(), this.renderDefaultContent(), this.renderContentEnd(), this.renderActionsEnd()));
  }
  static get style() {
    return CalciteStackStyle0;
  }
}, [1, "calcite-stack", {
  "disabled": [516],
  "hasActionsStart": [32],
...
var Filter = proxyCustomElement(class Filter2 extends H {
  ...
  async setFocus() {
    ...
    return (_a = this.textInput) == null ? void 0 : _a.setFocus();
  }
  ...
  render() {
    ...
    return h(InteractiveContainer, { key: "c4a624e52409ed90839b506f5d99ab623767260e", disabled }, h("div", { key: "1f2ef99156489719dd2f938bc5ce8a05185866bf", class: CSS3.container }, h("label", { key: "6fe8c6cf73f554908be38299263d23380a4ed089" }, h("calcite-input", { key: "6765e00d208d6898221540769865d84aa1c64974", clearable: true, disabled, icon: ICONS.search, label: this.messages.label, messageOverrides: { clear: this.messages.clear }, onCalciteInputInput: this.inputHandler, onKeyDown: this.keyDownHandler, placeholder: this.placeholder, ref: (el) => {
      this.textInput = el;
...
var List = proxyCustomElement(class List2 extends H {
  constructor() {
    ...
    this.updateListItems = debounce((options) => {
      const emitFilterChange = (options == null ? void 0 : options.emitFilterChange) ?? false;
      const performFilter = (options == null ? void 0 : options.performFilter) ?? false;
  ...
  render() {
    ...
    return h(InteractiveContainer, { key: "c3139afe4fe7c7462578a51a4578971c97473167", disabled: this.disabled }, h("div", { key: "5e99dc8b479c35609c5f0318723b3da84ec23ef4", class: CSS4.container }, this.dragEnabled ? h("span", { "aria-live": "assertive", class: CSS4.assistiveText }, this.assistiveText) : null, this.renderItemAriaLive(), loading ? h("calcite-scrim", { class: CSS4.scrim, loading }) : null, h("table", { key: "a31ba050d3141351e491141365e8244ed3ca5303", "aria-busy": toAriaBoolean(loading), "aria-label": label || "", class: CSS4.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? h("thead", { class: CSS4.sticky }, h("tr", null, h("th", { colSpan: MAX_COLUMNS }, h("calcite-stack", { class: CSS4.stack }, h("slot", { name: SLOTS2.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: SLOTS.actionsStart }), h("calcite-filter", { "aria-label": filterPlaceholder, disabled, filterProps, items: dataForFilter, onCalciteFilterChange: this.handleFilterChange, placeholder: filterPlaceholder, ref: this.setFilterEl, value: filterText }), h("slot", { name: SLOTS2.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: SLOTS.actionsEnd }))))) : null, h("tbody", { key: "3ed1b8d9a4387c3ea0f4ff38e5388be35b32d89b", class: CSS4.tableContainer }, h("slot", { key: "712562533b4609749cbff0968bd0a9e77d99758e", onSlotchange: this.handleDefaultSlotChange }))), h("div", { key: "3ff977013e0ca0d58229e1305dca702000d91a99", "aria-live": "polite", "data-test-id": "no-results-container", hidden: !(hasFilterNoResults && filterEnabled && filterText && !filteredItems.length) }, h("slot", { key: "7c2bf6389c8b5f4b6f617950e4068baf6b1dc358", name: SLOTS2.filterNoResults, onSlotchange: this.handleFilterNoResultsSlotChange }))));
  }
  // --------------------------------------------------------------------------
  //
  //  Private Methods
...
@esri/calcite-components/dist/components/calcite-list.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-J46ETVO2.js.map
