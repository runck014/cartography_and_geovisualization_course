...
var S3 = h3.fromSimpleFillSymbol(c);
var b4 = new c2({ symbolLayers: new V([new h({ material: { color: e2 }, edges: new i2({ size: e(1), color: new l(i) }) })]) });
...
function u3(u4, d2 = g) {
  ...
  else if (u4 instanceof S) k2 = d2.geometryType && "mesh" === d2.geometryType ? c2.fromSimpleFillSymbol(u4) : h3.fromSimpleFillSymbol(u4);
  else {
...
//# sourceMappingURL=chunk-NVFQGMP6.js.map
