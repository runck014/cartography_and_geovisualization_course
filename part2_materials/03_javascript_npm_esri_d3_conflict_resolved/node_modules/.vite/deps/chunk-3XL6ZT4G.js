...
var u = p = class extends f {
  ...
  get transparent() {
    ...
    return t instanceof HTMLCanvasElement ? f2(t.getContext("2d").getImageData(0, 0, t.width, t.height)) : t instanceof ImageData ? f2(t) : !(!(e == null ? void 0 : e.toLowerCase().endsWith(".png")) && !(e == null ? void 0 : e.toLocaleLowerCase().startsWith("data:image/png;")));
  }
  set transparent(t) {
...
r([m({ type: l, json: { write: true } })], u2.prototype, "color", void 0), r([m({ type: w, json: { write: true } })], u2.prototype, "colorTexture", void 0), r([m({ type: c2, json: { write: true } })], u2.prototype, "colorTextureTransform", void 0), r([m({ type: w, json: { write: true } })], u2.prototype, "normalTexture", void 0), r([m({ type: c2, json: { write: true } })], u2.prototype, "normalTextureTransform", void 0), r([m({ nonNullable: true, json: { write: true } })], u2.prototype, "alphaMode", void 0), r([m({ nonNullable: true, json: { write: true } })], u2.prototype, "alphaCutoff", void 0), r([m({ nonNullable: true, json: { write: true } })], u2.prototype, "doubleSided", void 0), u2 = n = r([a("esri.geometry.support.MeshMaterial")], u2);
var a2 = u2;
...
//# sourceMappingURL=chunk-3XL6ZT4G.js.map
