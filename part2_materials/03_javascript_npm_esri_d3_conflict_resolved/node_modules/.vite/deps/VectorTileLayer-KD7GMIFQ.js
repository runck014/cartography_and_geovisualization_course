...
var l4 = class {
  ...
  _getIndexedDataKey(e5, t4) {
    ...
    let i2 = t4;
    for (; 0 !== i2.level; ) i2 = new e2(i2.level - 1, i2.row >> 1, i2.col >> 1, i2.world), l7.push(i2);
...
var l5 = class {
  ...
  dataKey(e5, t4) {
    const { level: l7, row: s5, col: o4 } = e5, n3 = new e2(e5);
...
var B = class extends l(t2(f(p2(l2(b2(j3(e3(i(S(f2)))))))))) {
  constructor(...e5) {
  ...
  load(e5) {
    const r5 = this.loadFromPortal({ supportedTypes: ["Vector Tile Service"], supportsData: false }, e5).catch(a2).then(async () => {
      var _a;
      if (!((_a = this.portalItem) == null ? void 0 : _a.id)) return;
      const r6 = `${this.portalItem.itemCdnUrl}/resources/styles/root.json`;
      (await U(r6, { ...e5, query: { f: "json", ...this.customParameters, token: this.apiKey } })).data && this.read({ url: r6 }, e4(this.portalItem, "portal-item"));
...
r([m2({ readOnly: true })], B.prototype, "attributionDataUrl", null), r([m2({ type: ["show", "hide"] })], B.prototype, "listMode", void 0), r([m2({ json: { read: true, write: true } })], B.prototype, "blendMode", void 0), r([m2({ readOnly: true, json: { read: false } })], B.prototype, "capabilities", null), r([m2({ readOnly: true })], B.prototype, "currentStyleInfo", void 0), r([m2({ json: { read: false }, readOnly: true, type: w })], B.prototype, "fullExtent", null), r([m2({ json: { read: false }, readOnly: true, type: w })], B.prototype, "initialExtent", null), r([m2({ type: Boolean, json: { read: false, write: { enabled: true, overridePolicy: () => ({ enabled: false }) } } })], B.prototype, "isReference", void 0), r([m2({ type: ["VectorTileLayer"] })], B.prototype, "operationalLayerType", void 0), r([m2({ readOnly: true })], B.prototype, "parsedUrl", null), r([m2({ type: String, json: { origins: { "web-scene": { read: true, write: true } }, read: false } })], B.prototype, "path", void 0), r([m2({ type: Number, json: { write: false, origins: { "web-map": { write: false }, "web-scene": { write: false }, "portal-item": { write: false } } } })], B.prototype, "refreshInterval", void 0), r([m2()], B.prototype, "style", void 0), r([m2({ readOnly: true })], B.prototype, "serviceUrl", null), r([m2({ type: g, readOnly: true })], B.prototype, "spatialReference", null), r([m2({ readOnly: true })], B.prototype, "styleRepository", void 0), r([m2({ readOnly: true })], B.prototype, "sourceNameToSource", void 0), r([m2({ readOnly: true })], B.prototype, "primarySource", void 0), r([m2({ type: String, readOnly: true, json: { write: { ignoreOrigin: true }, origins: { "web-document": { write: { ignoreOrigin: true, isRequired: true } } } } })], B.prototype, "styleUrl", null), r([r3(["portal-item", "web-document"], "styleUrl")], B.prototype, "writeStyleUrl", null), r([m2({ json: { read: false, origins: { service: { read: false } } }, readOnly: true, type: z })], B.prototype, "tileInfo", null), r([m2()], B.prototype, "tilemapCache", void 0), r([o("service", "tilemapCache", ["capabilities", "tileInfo"])], B.prototype, "readTilemapCache", null), r([m2({ json: { read: false }, readOnly: true, value: "vector-tile" })], B.prototype, "type", void 0), r([m2({ json: { origins: { "web-document": { read: { source: "styleUrl" } }, "portal-item": { read: { source: "url" } } }, write: false, read: false } })], B.prototype, "url", void 0), r([m2({ readOnly: true })], B.prototype, "version", void 0), r([o("version", ["version", "currentVersion"])], B.prototype, "readVersion", null), B = r([a3("esri.layers.VectorTileLayer")], B);
var A2 = B;
export {
  A2 as default
};
//# sourceMappingURL=VectorTileLayer-KD7GMIFQ.js.map
