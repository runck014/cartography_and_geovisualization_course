...
var r = class _r {
  ...
  encodeAttributes(t6, n2, o2, s) {
    ...
    for (const _3 of Object.keys(i6)) {
      const l6 = i6[_3], { type: f3, precisionFactor: h2, isLayout: d4 } = r3[_3], y2 = d4 ? o2.getLayoutProperty(_3) : o2.getPaintProperty(_3), m = (_a = y2.interpolator) == null ? void 0 : _a.getInterpolationRange(n2);
      let E2 = 0;
      for (const o3 of l6) {
        ...
        switch (f3) {
          case N2.R8_SIGNED:
          case N2.R8_UNSIGNED:
            a6[c3] |= this._encodeByte(_4 * (h2 || 1), 8 * r4);
            break;
          case N2.R16_SIGNED:
          case N2.R16_UNSIGNED:
            a6[c3] |= this._encodeShort(_4 * (h2 || 1), 8 * r4);
            break;
          case N2.R8G8_SIGNED:
          case N2.R8G8_UNSIGNED:
            a6[c3] |= this._encodeByte(_4 * (h2 || 1), 8 * r4), a6[c3] |= this._encodeByte(_4 * (h2 || 1), 8 * r4 + 8);
            break;
          case N2.R16G16_SIGNED:
          case N2.R16G16_UNSIGNED:
            a6[c3] |= this._encodeShort(_4 * (h2 || 1), 8 * r4), a6[c3] |= this._encodeShort(_4 * (h2 || 1), 8 * r4 + 16);
            break;
          case N2.R8G8B8A8_SIGNED:
          case N2.R8G8B8A8_UNSIGNED:
            a6[c3] |= this._encodeByte(_4 * (h2 || 1), 8 * r4), a6[c3] |= this._encodeByte(_4 * (h2 || 1), 8 * r4 + 8), a6[c3] |= this._encodeByte(_4 * (h2 || 1), 8 * r4 + 16), a6[c3] |= this._encodeByte(_4 * (h2 || 1), 8 * r4 + 24);
            break;
  ...
  _buildAttributesInfo() {
    ...
    for (const o2 of c3) {
      ...
      for (let e4 = 0; e4 < c4; e4++) {
        ...
        let _5 = s[u3], h2 = 0;
        if (!_5 || _5.count + o3 > 4) i6++, _5 = { dataIndex: i6, count: 0, offset: 0 }, 4 !== o3 && (s[u3] = _5), t6.push({ location: -1, name: "a_data_" + i6, count: o3, type: e5, normalized: a7 }), h2 = Math.ceil(Math.max(c5 / 4, 1));
        else {
          const e6 = t6[_5.dataIndex];
          e6.count += o3;
          h2 = Math.ceil(Math.max(e6.count * n2 / 4, 1)) - Math.ceil(Math.max(_5.offset / 4, 1));
        }
        l7.push({ dataIndex: _5.dataIndex, offset: _5.offset, bufferElementsToAdd: h2 }), _5.offset += c5, _5.count += o3;
      }
    }
    ...
    let _3 = 0;
    const l6 = this._layout.get("geometry");
    for (const n2 of l6) this._locations.set(n2.name, _3++);
...
`;
    ...
    for (const f3 of u2) {
      l6++;
      const { name: t7, type: u3, precisionFactor: h2, isLayout: d4 } = _3[f3], y2 = h2 && 1 !== h2 ? " * " + 1 / h2 : "", { bytesPerElement: m, count: E2 } = _r._encodingInfo[u3], I4 = (t8) => `a_data_${t8.dataIndex}${a3(E2, t8.offset, m)}`;
      switch (this.getAtributeState(l6)) {
        case R2.UNIFORM:
          {
...
l3.ATTRIBUTES = ["fill-color", "fill-opacity", "fill-pattern"], l3.GEOMETRY_LAYOUT = [new t("a_pos", 2, C.SHORT, 0, 4)], l3.ATTRIBUTES_INFO = { "fill-color": { name: "color", type: N2.R8G8B8A8_COLOR }, "fill-opacity": { name: "opacity", type: N2.R8_UNSIGNED, precisionFactor: 100 }, "fill-pattern": { name: "tlbr", type: N2.R16G16B16A16_PATTERN, isOptional: true } };
...
function d(r3) {
  if (null === r3) return "";
  const e3 = typeof r3;
  return "string" === e3 ? r3 : "number" === e3 || "boolean" === e3 ? String(r3) : r3 instanceof l ? r3.toString() : JSON.stringify(r3);
}
...
var U = class _U {
  ...
  static parse(t6, e3) {
    ...
    for (let i6 = 2; i6 < t6.length - 1; i6 += 2) {
      ...
      const l6 = pt(t6[i6 + 1], e3);
      r3 || (r3 = l6.type), n2.push(l6);
    }
...
var P2 = class _P {
  ...
  static parse(t6, e3, r3) {
    ...
    const i6 = [];
    for (let l6 = 3; l6 < t6.length; l6 += 2) {
      const r4 = t6[l6];
  ...
  evaluate(n2, a6) {
    ...
    const l6 = this.input.evaluate(n2, a6);
    if (l6 <= i6[0][0]) return i6[0][1].evaluate(n2, a6);
    if (l6 >= i6[i6.length - 1][0]) return i6[i6.length - 1][1].evaluate(n2, a6);
    let u2 = 0;
    for (; ++u2 < i6.length && !(l6 < i6[u2][0]); ) ;
    const c3 = i6[u2 - 1][0], h2 = i6[u2][0], p2 = _P.interpolationRatio(this.interpolation, l6, c3, h2), f3 = i6[u2 - 1][1].evaluate(n2, a6), w = i6[u2][1].evaluate(n2, a6);
    if ("interpolate" === this._operator) {
      ...
      if ("color" === this.type.kind && f3 instanceof l && w instanceof l) {
        const e3 = new l(f3), r3 = new l(w);
        return new l([p(e3.r, r3.r, p2), p(e3.g, r3.g, p2), p(e3.b, r3.b, p2), p(e3.a, r3.a, p2)]);
      }
    ...
    if ("interpolate-hcl" === this._operator) {
      const s = H(f3), n3 = H(w), a7 = n3.h - s.h, i7 = A({ h: s.h + p2 * (a7 > 180 || a7 < -180 ? a7 - 360 * Math.round(a7 / 360) : a7), c: p(s.c, n3.c, p2), l: p(s.l, n3.l, p2) });
      return new l({ a: p(f3.a, w.a, p2), ...i7 });
    }
    if ("interpolate-lab" === this._operator) {
      const e3 = C2(f3), n3 = C2(w), a7 = A({ l: p(e3.l, n3.l, p2), a: p(e3.a, n3.a, p2), b: p(e3.b, n3.b, p2) });
      return new l({ a: p(f3.a, w.a, p2), ...a7 });
    }
...
var ot = class _ot {
  ...
  evaluate(e3, r3) {
    ...
    return new l({ r: s, g: n2, b: a6, a: o2 });
  }
  _validate(t6) {
    if ("number" != typeof t6 || t6 < 0 || t6 > 255) throw new Error(`${t6}: invalid color component`);
    return Math.round(t6);
...
var it = class _it {
  ...
  evaluate(e3, r3) {
    return new l(this._color.evaluate(e3, r3)).toRgba();
  }
};
var lt = class _lt {
  constructor(t6, e3) {
  ...
  evaluate(t6, e3) {
    ...
    for (const s of this._args) {
      ...
      if (r3 = l4(n2), c2(r3, this.type)) return n2;
    }
...
var ut = class _ut {
  ...
  static toColor(e3) {
    ...
    if ("string" == typeof e3) {
      const r3 = l.fromString(e3);
      if (r3) return r3;
      throw new Error(`"${e3}" is not a color`);
    }
    if (Array.isArray(e3)) return l.fromArray(e3);
    throw new Error(`"${e3}" is not a color`);
  }
};
...
var ht = class _ht {
  ...
  evaluate(t6, e3) {
    return k(l4(this._arg.evaluate(t6, e3)));
  }
};
...
var h = class _h {
  constructor(t6, e3) {
    ...
    if (h2) for (const r3 of e3.stops) r3[1] = this._validate(r3[1], t6);
    if (this.isDataDriven = !!e3 && !!e3.property, this.isDataDriven) if (void 0 !== e3.default && (e3.default = this._validate(e3.default, t6)), h2) switch (e3.type) {
      case "identity":
    ...
    else h2 ? this.getValue = o2 ? this._buildZoomInterpolate(e3) : this._buildZoomInterval(e3) : (e3 = this._validate(e3, t6), this.getValue = this._buildSimple(e3));
  }
  _validate(t6, e3) {
    if ("number" === e3.type) {
  ...
  _buildIdentity(t6, e3) {
    return (r3, i6) => {
      let l6;
      return i6 && (l6 = i6.values[t6.property]), void 0 !== l6 && (l6 = this._validate(l6, e3)), null != l6 ? l6 : void 0 !== t6.default ? t6.default : e3.default;
    };
  }
  _buildCategorical(t6, e3) {
    return (r3, i6) => {
      let l6;
      return i6 && (l6 = i6.values[t6.property]), l6 = this._categorical(l6, t6.stops), void 0 !== l6 ? l6 : void 0 !== t6.default ? t6.default : e3.default;
    };
  }
  _buildInterval(t6, e3) {
    return (r3, i6) => {
      let l6;
      return i6 && (l6 = i6.values[t6.property]), "number" == typeof l6 ? this._interval(l6, t6.stops) : void 0 !== t6.default ? t6.default : e3.default;
    };
  }
  _buildInterpolate(t6, e3) {
    return (r3, i6) => {
      let l6;
      return i6 && (l6 = i6.values[t6.property]), "number" == typeof l6 ? this._interpolate(l6, t6.stops, t6.base || 1) : void 0 !== t6.default ? t6.default : e3.default;
    };
  }
  ...
  _interval(t6, e3) {
    const r3 = e3.length;
    let i6 = 0;
    for (let l6 = 0; l6 < r3 && e3[l6][0] <= t6; l6++) i6 = l6;
    return e3[i6][1];
  }
  _interpolate(t6, r3, i6) {
    ...
    if (l6 && a6) {
      const r4 = a6[0] - l6[0], s2 = t6 - l6[0], n2 = 1 === i6 ? s2 / r4 : (i6 ** s2 - 1) / (i6 ** r4 - 1);
      if (Array.isArray(l6[1])) {
        const t7 = l6[1], r5 = a6[1], i7 = [];
        for (let l7 = 0; l7 < t7.length; l7++) i7.push(p(t7[l7], r5[l7], n2));
        return i7;
      }
      return p(l6[1], a6[1], n2);
    }
    return l6 ? l6[1] : a6 ? a6[1] : void 0;
  }
  static _isEmpty(t6) {
...
var v2 = class extends T4 {
  ...
  isIntersectingFeature(t6, i6, r3, n2, s, l6, h2) {
    ...
    const g = b(this.getPaintValue("fill-translate", s, n2), this.getPaintValue("fill-translate-anchor", s, n2), l6, d3);
    t6 -= p2 * g.x, i6 -= p2 * g.y;
...
var x2 = class extends T4 {
  ...
  getFeatureInflatedBounds(t6, i6, e3, a6) {
    ...
    const s = a6 * Math.abs(this.getPaintValue("line-offset", i6, t6) || 0), l6 = a6 * (this.getPaintValue("line-width", i6, t6) / 2);
    return o2[0] -= s + l6, o2[1] -= s + l6, o2[2] += s + l6, o2[3] += s + l6, o2;
  }
  isIntersectingFeature(t6, i6, a6, n2, s, l6, h2) {
    let u2 = n2.getGeometry();
    if (!u2) return false;
    const p2 = d3 / h2.normalizationRatio;
    t6 = t6 / h2.normalizationRatio + h2.normalizationOffsetX, i6 = i6 / h2.normalizationRatio + h2.normalizationOffsetY;
    const g = b(this.getPaintValue("line-translate", s, n2), this.getPaintValue("line-translate-anchor", s, n2), l6, d3);
    t6 -= p2 * g.x, i6 -= p2 * g.y;
...
var A3 = class extends T4 {
  ...
  isIntersectingFeature(t6, i6, a6, o2, r3, n2, s) {
    ...
    const u2 = b(this.getPaintValue("circle-translate", r3, o2), this.getPaintValue("circle-translate-anchor", r3, o2), n2, h2), p2 = h2 * (this.getPaintValue("circle-radius", r3, o2) + this.getPaintValue("circle-stroke-width", r3, o2));
    let g, c3;
    for (const e3 of l6) if (e3) for (const o3 of e3) {
...
var l5 = class _l {
  ...
  _identifyRefLayers() {
    ...
    for (const i6 of this.layers) {
      ...
      if (i6.type === a2.FILL) {
        ...
        const e3 = i6, t7 = i6.paint, l6 = null != t7 && (null != t7["line-pattern"] || null != t7["line-dasharray"]);
        let y2 = i6.source + "|" + i6.sourceLayer;
        y2 += "|" + ((a6 == null ? void 0 : a6.visibility) ?? ""), y2 += "|" + i6.minzoom, y2 += "|" + i6.maxzoom, y2 += "|" + JSON.stringify(i6.filter), y2 += "|" + (void 0 !== a6 ? a6["line-cap"] : ""), y2 += "|" + (void 0 !== a6 ? a6["line-join"] : ""), (e3.hasDataDrivenLine || l6) && (y2 += "|" + s), r3.push({ key: y2, layer: i6 });
      }
      ++s;
    }
  ...
  _assignRefLayers(t6) {
    ...
    for (let a6 = 0; a6 < i6; a6++) {
      const l6 = t6[a6];
      if (l6.key === r3) l6.layer.refLayerId = s;
      else if (r3 = l6.key, s = l6.layer.id, l6.layer.type === a2.FILL) {
        if (!l6.layer.getPaintProperty("fill-outline-color")) for (let e3 = a6 + 1; e3 < i6; e3++) {
          const i7 = t6[e3];
          if (i7.key !== r3) break;
          if (i7.layer.getPaintProperty("fill-outline-color")) {
            t6[a6] = i7, t6[e3] = l6, s = i7.layer.id;
            break;
          }
        }
      } else if (l6.layer.type === a2.LINE) {
        let e3 = l6.layer;
        for (let y2 = a6 + 1; y2 < i6; y2++) {
          const i7 = t6[y2];
          if (i7.key !== r3) break;
          const n2 = i7.layer;
          (e3.canUseThinTessellation && !n2.canUseThinTessellation || !e3.canUseThinTessellation && (n2.getPaintProperty("line-pattern") || n2.getPaintProperty("line-dasharray"))) && (e3 = n2, t6[a6] = i7, t6[y2] = l6, s = i7.layer.id);
        }
      }
    }
  }
  _create(l6, y2, n2) {
    ...
    switch (l6.type) {
      case "background":
        return new V2(a2.BACKGROUND, l6, o2, u2);
      case "fill":
        return new v2(a2.FILL, l6, o2, u2);
      case "line":
        return new x2(a2.LINE, l6, o2, u2);
      case "symbol":
        return new I3(a2.SYMBOL, l6, o2, u2);
      case "raster":
        return console.warn(`Unsupported vector tile raster layer ${l6.id}`), null;
      case "circle":
        return new A3(a2.CIRCLE, l6, o2, u2);
    }
    return null;
  }
  static _recreateLayer(l6, y2) {
    switch (l6.type) {
      case "background":
        return new V2(a2.BACKGROUND, l6, y2.z, y2.uid);
      case "fill":
        return new v2(a2.FILL, l6, y2.z, y2.uid);
      case "line":
        return new x2(a2.LINE, l6, y2.z, y2.uid);
      case "symbol":
        return new I3(a2.SYMBOL, l6, y2.z, y2.uid);
      case "raster":
        return console.warn(`Unsupported vector tile raster layer ${l6.id}`), null;
      case "circle":
        return new A3(a2.CIRCLE, l6, y2.z, y2.uid);
    }
    return null;
  }
};
...
//# sourceMappingURL=chunk-CPYCBRIJ.js.map
