...
import {
  i
} from "./chunk-VRW5WHAY.js";
import {
  t
} from "./chunk-2DF6UTWB.js";
import {
  a
...
async function a2(e2, r, a3) {
  ...
  if (null == (e2 == null ? void 0 : e2.layers) || null == (e2 == null ? void 0 : e2.tables)) {
    const s5 = await a3.fetchServiceMetadata(r, { customParameters: (_a = l(e2)) == null ? void 0 : _a.customParameters });
    (e2 = e2 || {}).layers = e2.layers || ((_b = s5 == null ? void 0 : s5.layers) == null ? void 0 : _b.map(t2)), e2.tables = e2.tables || ((_c = s5 == null ? void 0 : s5.tables) == null ? void 0 : _c.map(t2));
  }
  return e2;
}
function l(e2) {
...
function n(e2, r) {
  return [...e2.layers || [], ...e2.tables || []].filter(({ layerType: e3 }) => e3 ? e3 === r : "ArcGISFeatureLayer" === r);
}
function u(e2) {
  var _a, _b;
...
async function o(r, a3, s5) {
  var _a, _b, _c, _d;
  if (!(r == null ? void 0 : r.url)) return a3 ?? {};
  if (a3 ?? (a3 = {}), !a3.layers) {
    const e2 = await s5.fetchServiceMetadata(r.url);
    a3.layers = (_a = e2.layers) == null ? void 0 : _a.map(t2);
  }
  const { serverUrl: n2, portalItem: u2 } = await s2(r.url, { sceneLayerItem: r, customParameters: (_b = l(a3)) == null ? void 0 : _b.customParameters }).catch(() => ({ serverUrl: null, portalItem: null }));
  if (null == n2) return a3.tables = [], a3;
  if (!a3.tables && u2) {
    const e2 = await u2.fetchData().catch(() => null);
    if (e2 == null ? void 0 : e2.tables) a3.tables = e2.tables.map(t2);
    else {
      const r2 = await s5.fetchServiceMetadata(n2, { customParameters: (_c = l(e2)) == null ? void 0 : _c.customParameters }).catch(() => null);
...
async function I(e2, a3) {
  ...
  const c2 = await a3.fetchServiceMetadata(e2.url, { customParameters: await a3.fetchCustomParameters(e2) }), n2 = (_b = c2.cacheType) == null ? void 0 : _b.toLowerCase(), o2 = (_c = c2.capabilities) == null ? void 0 : _c.toLowerCase().includes("tilesonly"), i3 = ((_e = (_d = c2.tileInfo) == null ? void 0 : _d.format) == null ? void 0 : _e.toLowerCase()) ?? "", u2 = null == n2 && ["jpg", "jpeg", "png", "png8", "png24", "png32", "mixed"].includes(i3);
  return "map" === n2 || u2 || o2 ? { className: "ImageryTileLayer" } : { className: "ImageryLayer" };
}
function M() {
...
async function D(e2, a3, t3) {
  ...
  if (n2) {
    const e3 = await a2(f, s5, a3), r = J(e3);
    if ("object" == typeof r) {
      const a4 = s4(e3, r.id);
  ...
  return t3 && (p2.tables = await t3()), J(p2);
}
function J(e2) {
  var _a;
...
//# sourceMappingURL=chunk-RP6LW6HL.js.map
