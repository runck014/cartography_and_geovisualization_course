...
function s4(s6) {
  ...
  const a4 = null != s6.offset ? s6.offset : i4, n9 = null != s6.rotation ? s6.rotation : 0, e7 = null != s6.scale ? s6.scale : f2, f3 = t2(1, 0, 0, 0, 1, 0, a4[0], a4[1], 1), c3 = t2(Math.cos(n9), -Math.sin(n9), 0, Math.sin(n9), Math.cos(n9), 0, 0, 0, 1), m = t2(e7[0], 0, 0, 0, e7[1], 0, 0, 0, 1), u2 = e3();
  return i3(u2, c3, m), i3(u2, f3, u2), u2;
}
...
function T(e7, t10) {
  var _a, _b;
  const r4 = new Array(), n9 = new Array(), s6 = new Array(), o5 = new t6(), u2 = e7.resource, c3 = r2.parse(u2.version || "1.0", "wosr");
  q2.validate(c3);
  ...
  for (let a4 = 0; a4 < g.length; a4++) {
    ...
    const i6 = k(e8), u3 = e8.params.vertexAttributes, c4 = [], p3 = (t11) => {
      ...
      return null;
    }, I3 = u3[e2.POSITION], P2 = I3.values.length / I3.valuesPerElement;
    for (const t11 in u3) {
      const e9 = u3[t11], r5 = e9.values, n10 = p3(t11) ?? l3(P2);
      c4.push([t11, new t5(r5, n10, e9.valuesPerElement, true)]);
    }
    ...
    if (null == B2) {
      ...
      const r5 = U3 && U3.alphaChannelUsage, n10 = e9.transparency > 0 || "transparency" === r5 || "maskAndTransparency" === r5, s7 = U3 ? O2(U3.alphaChannelUsage) : void 0, a5 = { ambient: u(e9.diffuse), diffuse: u(e9.diffuse), opacity: 1 - (e9.transparency || 0), transparent: n10, textureAlphaMode: s7, textureAlphaCutoff: 0.33, textureId: q3, initTextureTransparent: true, doubleSided: true, cullFace: e6.None, colorMixMode: e9.externalColorMixMode || "tint", textureAlphaPremultiplied: (U3 == null ? void 0 : U3.parameters.preMultiplyAlpha) ?? false };
    ...
    A4 += ((_b = (_a = c4.find((e9) => e9[0] === e2.POSITION)) == null ? void 0 : _a[1]) == null ? void 0 : _b.indices.length) ?? 0, r4.push(C2);
  }
...
async function E3(e7, t10) {
  ...
  for (const a4 in e7) {
    ...
    const o5 = n10.encoding + ";base64," + s7, i6 = "/textureDefinitions/" + a4, l5 = "rgba" === n10.channels ? n10.alphaChannelUsage || "transparency" : "none", u2 = { noUnpackFlip: true, wrap: { s: D.REPEAT, t: D.REPEAT }, preMultiplyAlpha: O2(l5) !== i5.Opaque }, c3 = (t10 == null ? void 0 : t10.disableTextures) ? Promise.resolve(null) : t8(o5, t10);
...
async function ee(t10, r4) {
  ...
  if (r4.cache) s6 = await r4.cache.loadGLTF(o5.url, r4, !!r4.usePBR);
    ...
    const { loadGLTF: e7 } = await import("./loader-E4ZW4LCS.js");
  ...
  const a4 = !!r4.usePBR, l5 = s6.meta.isEsriSymbolResource ? { usePBR: a4, isSchematic: false, treeRendering: n9, mrrFactors: s3 } : { usePBR: a4, isSchematic: false, treeRendering: false, mrrFactors: t7 }, u2 = { ...r4.materialParameters, treeRendering: n9 }, { engineResources: c3, referenceBoundingBox: m } = re(s6, l5, u2, r4, o5.specifiedLodIndex);
...
function se(e7, s6) {
  const i6 = e7.attributes.position.count, n9 = o2(e7.indices || i6, e7.primitiveType), a4 = t(3 * i6), { typedBuffer: l5, typedBufferStride: u2 } = e7.attributes.position;
  e5(a4, l5, e7.transform, 3, u2);
  const c3 = [[e2.POSITION, new t5(a4, n9, 3, true)]];
  if (null != e7.attributes.normal) {
    const o5 = t(3 * i6), { typedBuffer: s7, typedBufferStride: a5 } = e7.attributes.normal;
    j(ie, e7.transform), f(o5, s7, ie, 3, a5), A(ie) && l4(o5, o5), c3.push([e2.NORMAL, new t5(o5, n9, 3, true)]);
  }
  if (null != e7.attributes.tangent) {
    const r4 = t(4 * i6), { typedBuffer: s7, typedBufferStride: a5 } = e7.attributes.tangent;
    n3(ie, e7.transform), n4(r4, s7, ie, 4, a5), A(ie) && l4(r4, r4, 4), c3.push([e2.TANGENT, new t5(r4, n9, 4, true)]);
  }
  if (null != e7.attributes.texCoord0) {
    const t10 = t(2 * i6), { typedBuffer: r4, typedBufferStride: o5 } = e7.attributes.texCoord0;
    n5(t10, r4, 2, o5), c3.push([e2.UV0, new t5(t10, n9, 2, true)]);
  }
  const m = e7.attributes.color;
  if (null != m) {
    const t10 = new Uint8Array(4 * i6);
    4 === m.elementCount ? m instanceof c2 ? s2(t10, m, 255) : m instanceof x ? t4(t10, m) : m instanceof L && s2(t10, m, 1 / 256) : (t10.fill(255), m instanceof i2 ? o(t10, m.typedBuffer, 255, 4, m.typedBufferStride) : e7.attributes.color instanceof O ? t3(t10, m.typedBuffer, 4, e7.attributes.color.typedBufferStride) : e7.attributes.color instanceof E2 && o(t10, m.typedBuffer, 1 / 256, 4, m.typedBufferStride)), c3.push([e2.COLOR, new t5(t10, n9, 4, true)]);
  }
...
function ae(e7, t10) {
  for (let r4 = 0; r4 < e7.model.lods.length; ++r4) {
    ...
    for (const s6 of o5.parts) {
      ...
      if (null == o6) return;
      const a4 = s6.attributes.position, g = a4.count, x2 = n2(), b = n2(), h2 = n2(), y = new Uint8Array(4 * g), v2 = new Float64Array(3 * g), R = h(e4(), s6.transform);
      let j3 = 0, B2 = 0;
      for (let i6 = 0; i6 < g; i6++) {
        a4.getVec(i6, b), o6.getVec(i6, x2), E(b, b, s6.transform), c(h2, b, t10.center), i(h2, h2, t10.radius);
        const n9 = h2[2], p2 = r(h2), g2 = Math.min(0.45 + 0.55 * p2 * p2, 1);
      ...
      s6.attributes.normal = new i2(v2), s6.attributes.color = new x(y);
    }
  }
}
export {
...
//# sourceMappingURL=objectResourceUtils-DRZVC3Q3.js.map
