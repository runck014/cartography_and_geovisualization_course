...
var positionFloatingUI = (
  ...
  async (component, { referenceEl, floatingEl, overlayPositioning = "absolute", placement, flipDisabled, flipPlacements: flipPlacements2, offsetDistance, offsetSkidding, arrowEl, type }) => {
    var _a;
...
function filterValidFlipPlacements(placements2, el) {
  ...
  if (filteredPlacements.length !== placements2.length) {
    console.warn(`${el.tagName}: Invalid value found in: flipPlacements. Try any of these: ${flipPlacements.map((placement) => `"${placement}"`).join(", ").trim()}`, { el });
  }
...
@esri/calcite-components/dist/components/floating-ui.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5ZFEXP26.js.map
