...
function d(r) {
  ...
  const t = I(r), s = (t == null ? void 0 : t.path.match(c)) || (t == null ? void 0 : t.path.match(v));
  if (!s) return null;
  const [, n, l, i, u] = s, a2 = l.indexOf("/");
  return { title: m(-1 !== a2 ? l.slice(a2 + 1) : l), serverType: o[i.toLowerCase()], sublayer: null != u && "" !== u ? parseInt(u, 10) : null, url: { path: n } };
}
function h2(r) {
...
//# sourceMappingURL=chunk-P3GRQ2CH.js.map
