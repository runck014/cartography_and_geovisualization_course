...
function g(r, t2, o2, e4) {
  return n4(r, t2, 0, o2, e4, 0) ? o2 : null;
}
...
function B3(t2, n7, r) {
  const { vertexSpace: e4, transform: o2, vertexAttributes: i3 } = t2, l2 = a2(e4) ? o2 : null, s2 = X(t2.spatialReference, r, at.SOURCE_AND_TARGET);
...
function L({ vertexAttributes: t2, transform: n7, spatialReference: r }, { origin: e4 }, o2, i3) {
  const l2 = X(r, i3, at.SOURCE_AND_TARGET), a3 = e4 || !Y2(l2) ? n3(rt, (n7 == null ? void 0 : n7.localMatrix) ?? o) : null;
...
function V3(t2, n7) {
  return (n7 == null ? void 0 : n7.useEllipsoid) && A(t2) ? w2 : a(t2);
}
...
//# sourceMappingURL=chunk-SGDQIAAB.js.map
