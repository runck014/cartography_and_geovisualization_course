import {
  ...
  submitForm
} from "./chunk-4ZPTG6ER.js";
import {
  connectLabel,
  disconnectLabel,
  getLabelText
} from "./chunk-6X32HROJ.js";
import {
  InteractiveContainer,
  updateHostInteraction
} from "./chunk-I4OPFZO2.js";
import {
  connectMessages,
  disconnectMessages,
  setUpMessages,
...
var Validation = ({ scale, status, id, icon, message }) => h(
  "div",
  { class: CSS.validationContainer },
  h("calcite-input-message", { "aria-live": "polite", icon, id, scale, status }, message)
);
...
var Input = proxyCustomElement(class Input2 extends H {
  ...
  render() {
    const dir = getElementDir(this.el);
    const loader = h("div", { key: "ed9acea9dbc18f4cfc5e7095c1e2de0b1adfdf35", class: CSS2.loader }, h("calcite-progress", { key: "58321a27c25dd848a648d2e3d5ca6dfc3f5fd649", label: this.messages.loading, type: "indeterminate" }));
    const inputClearButton = h("button", { key: "348d8dee0c032afe986b1e253c9d667256f3d9f0", "aria-label": this.messages.clear, class: CSS2.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, h("calcite-icon", { key: "334b68a283b767c0e9bea09ccfd83d09c8c17711", icon: "x", scale: getIconScale(this.scale) }));
    const iconEl = h("calcite-icon", { key: "4ab83aa9268277a38449ebe4a6e3db4dc9badcae", class: CSS2.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) });
    ...
    const numberButtonsVertical = h("div", { key: "247efdce33568f219b1bf3bf252b8b19a74d03ea", class: CSS2.numberButtonWrapper }, numberButtonsHorizontalUp, numberButtonsHorizontalDown);
    const prefixText = h("div", { key: "01819a850399fb20a29471861e011695bf80af97", class: CSS2.prefix }, this.prefixText);
    const suffixText = h("div", { key: "dcc073305f3824a0eb72ef230bd217dabdb72104", class: CSS2.suffix }, this.suffixText);
    ...
    const localeNumberInput = this.type === "number" ? h("input", { accept: this.accept, "aria-errormessage": IDS.validationMessage, "aria-invalid": toAriaBoolean(this.status === "invalid"), "aria-label": getLabelText(this), autocomplete: this.autocomplete, autofocus, defaultValue: this.defaultValue, disabled: this.disabled ? true : null, enterKeyHint, inputMode, key: "localized-input", maxLength: this.maxLength, minLength: this.minLength, multiple: this.multiple, name: void 0, onBlur: this.inputBlurHandler, onFocus: this.inputFocusHandler, onInput: this.inputNumberInputHandler, onKeyDown: this.inputNumberKeyDownHandler, onKeyUp: this.inputKeyUpHandler, pattern: this.pattern, placeholder: this.placeholder || "", readOnly: this.readOnly, ref: this.setChildNumberElRef, type: "text", value: this.displayedValue }) : null;
    const childEl = this.type !== "number" ? [
      h(this.childElType, { accept: this.accept, "aria-errormessage": IDS.validationMessage, "aria-invalid": toAriaBoolean(this.status === "invalid"), "aria-label": getLabelText(this), autocomplete: this.autocomplete, autofocus, class: {
        [CSS2.editingEnabled]: this.editingEnabled,
        [CSS2.inlineChild]: !!this.inlineEditableEl
      }, defaultValue: this.defaultValue, disabled: this.disabled ? true : null, enterKeyHint, inputMode, max: this.maxString, maxLength: this.maxLength, min: this.minString, minLength: this.minLength, multiple: this.multiple, name: this.name, onBlur: this.inputBlurHandler, onChange: this.inputChangeHandler, onFocus: this.inputFocusHandler, onInput: this.inputInputHandler, onKeyDown: this.inputKeyDownHandler, onKeyUp: this.inputKeyUpHandler, pattern: this.pattern, placeholder: this.placeholder || "", readOnly: this.readOnly, ref: this.setChildElRef, required: this.required ? true : null, step: this.step, tabIndex: this.disabled || this.inlineEditableEl && !this.editingEnabled ? -1 : null, type: this.type, value: this.value }),
      this.isTextarea ? h("div", { class: CSS2.resizeIconWrapper }, h("calcite-icon", { icon: "chevron-down", scale: getIconScale(this.scale) })) : null
    ] : null;
    return h(Host, { key: "23d6092960315f172a56105b9af75ddc6497874c", onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { key: "1bb063f39c14a829a376465fa8c2bbc288046ac7", disabled: this.disabled }, h("div", { key: "7f3644f002b7cb75d93d9c0218508b502ddcfd0b", class: { [CSS2.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" }, ref: (el) => this.inputWrapperEl = el }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? numberButtonsHorizontalDown : null, this.prefixText ? prefixText : null, h("div", { key: "0d01898e4949a60e0853c1a72669f5c9d6c91ba5", class: CSS2.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { key: "42e7adec440e417128feb9845c36d0444e6c1ae4", class: CSS2.actionWrapper, ref: (el) => this.actionWrapperEl = el }, h("slot", { key: "f391b035ad9fc108d1f99c4cedf539425c20a36d", name: SLOTS.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly ? numberButtonsVertical : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? numberButtonsHorizontalUp : null, h(HiddenFormInputSlot, { key: "df415df551b4a9a16565c8f554454d01aa89327e", component: this })), this.validationMessage && this.status === "invalid" ? h(Validation, { icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status }) : null));
  }
...
export {
  ...
  defineCustomElement3 as defineCustomElement2,
  Input,
  defineCustomElement4 as defineCustomElement3
};
...
@esri/calcite-components/dist/components/input2.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VOHNEOVL.js.map
