...
function r(e, i, r2) {
  var _a;
  const h = (_a = e.thumbnail) == null ? void 0 : _a.url;
  return h ? U(h, { responseType: "image" }).then((t2) => {
    const e2 = s(t2.data, r2);
    return (r2 == null ? void 0 : r2.node) ? (r2.node.appendChild(e2), r2.node) : e2;
  }) : N(e).then((t2) => t2 ? i(t2, r2) : null);
}
function s(t2, n) {
  const r2 = !/\\.svg$/i.test(t2.src) && (n == null ? void 0 : n.disableUpsampling), s2 = Math.max(t2.width, t2.height);
  let h = null != (n == null ? void 0 : n.maxSize) ? u(n.maxSize) : t.maxSize;
  r2 && (h = Math.min(s2, h));
  const o = "number" == typeof (n == null ? void 0 : n.size) ? n == null ? void 0 : n.size : null, m = Math.min(h, null != o ? u(o) : s2);
  if (m !== s2) {
...
//# sourceMappingURL=previewWebStyleSymbol-B274IPI6.js.map
