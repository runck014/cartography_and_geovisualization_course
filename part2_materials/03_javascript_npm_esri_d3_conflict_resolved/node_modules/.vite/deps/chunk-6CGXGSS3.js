...
async function v(t, r) {
  const n3 = U3((await U(t, { responseType: "text", query: { SERVICE: "WFS", REQUEST: "GetCapabilities", VERSION: F2, ...r == null ? void 0 : r.customParameters }, signal: r == null ? void 0 : r.signal })).data);
  return L(t, n3), n3;
}
function U3(e) {
  const t = te(e);
...
function $(e) {
  ...
  return { xmin: t, ymin: r, xmax: n3, ymax: a, spatialReference: U2 };
}
function Y(e, t, r) {
  return o(e, (e2) => r ? e2.name === t && e2.namespaceUri === r : e2.typeName === t || e2.name === t);
}
async function W(e, t, r, n3 = {}) {
  const { featureType: a, extent: o4 } = await X(e, t, r, n3), { spatialReference: i } = oe(e.operations.GetFeature.url, a, n3.spatialReference), { fields: s3, geometryType: p2, swapXY: u2, objectIdField: l, geometryField: c } = await q(e, a, i, n3);
  return { url: e.operations.GetCapabilities.url, name: a.name, namespaceUri: a.namespaceUri, fields: s3, geometryField: c, geometryType: p2, objectIdField: l, spatialReference: n3.spatialReference ?? new g({ wkid: a.defaultSpatialReference }), extent: o4, swapXY: u2, wfsCapabilities: e, customParameters: n3.customParameters };
}
async function X(e, r, n3, a = {}) {
  const o4 = e.readFeatureTypes(), i = r ? Y(o4, r, n3) : o4.next().value, { spatialReference: u2 = new g({ wkid: i == null ? void 0 : i.defaultSpatialReference }) } = a;
  if (null == i) throw r ? new s(C, `The type '${r}' could not be found in the service`) : new s(E, "The service is empty");
  let c = i.extent;
  if (c && !s2(c.spatialReference, u2)) try {
    await N(c.spatialReference, u2, void 0, a), c = K(c, u2);
  } catch {
...
async function q(e, r, n3, a = {}) {
  var _a, _b, _c;
  const { typeName: o4 } = r, [i, s3] = await Promise.allSettled([J(e.operations.DescribeFeatureType.url, o4, a), _(e, o4, n3, a)]), p2 = (e2) => new s(x, `An error occurred while getting info about the feature type '${o4}'`, { error: e2 });
  if ("rejected" === i.status) throw p2(i.reason);
  if ("rejected" === s3.status) throw p2(s3.reason);
  const { fields: u2, errors: l } = i.value ?? {}, c = ((_a = i.value) == null ? void 0 : _a.geometryType) || ((_b = s3.value) == null ? void 0 : _b.geometryType), m = ((_c = s3.value) == null ? void 0 : _c.swapXY) ?? false;
  if (null == c) throw new s(j, `The geometry type could not be determined for type '${o4}`, { typeName: o4, geometryType: c, fields: u2, errors: l });
...
async function _(t, r, n3, a = {}) {
  var _a;
  let o4, i = false;
  const [s3, p2] = await Promise.all([K3(t.operations.GetFeature.url, r, n3, t.operations.GetFeature.outputFormat, { ...a, count: 1 }), U(t.operations.GetFeature.url, { responseType: "text", query: Z(r, n3, void 0, { ...a, count: 1 }), signal: a == null ? void 0 : a.signal })]), u2 = "FeatureCollection" === s3.type && ((_a = s3.features[0]) == null ? void 0 : _a.geometry);
  if (u2) {
    let e;
...
async function J(t, r, n3) {
  return Q(r, (await U(t, { responseType: "text", query: { SERVICE: "WFS", REQUEST: "DescribeFeatureType", VERSION: F2, TYPENAME: r, TYPENAMES: r, ...n3 == null ? void 0 : n3.customParameters }, signal: n3 == null ? void 0 : n3.signal })).data);
}
function Q(e, r) {
...
function B(e) {
  ...
  for (const i of o4) {
    ...
    if (!o5) continue;
    let s3, p2;
    if (i.hasAttribute("type") ? s3 = re(i.getAttribute("type")).name : o3(i, { simpleType: { restriction: (e2) => (s3 = re(e2.getAttribute("base")).name, { maxLength: (e3) => {
    ...
    switch (s3.toLowerCase()) {
      ...
      case "positiveinteger":
        n3.push(new y({ name: o5, alias: o5, type: "integer", nullable: u2, length: K2("integer") }));
        break;
      case "float":
      case "double":
      case "decimal":
        n3.push(new y({ name: o5, alias: o5, type: "double", nullable: u2, length: K2("double") }));
        break;
      case "boolean":
      case "string":
      case "gyearmonth":
      ...
      case "duration":
      case "time":
        n3.push(new y({ name: o5, alias: o5, type: "string", nullable: u2, length: p2 ?? K2("string") }));
        break;
      case "datetime":
      case "date":
        n3.push(new y({ name: o5, alias: o5, type: "date", nullable: u2, length: p2 ?? K2("date") }));
        break;
...
async function K3(r, n3, a, o4, i) {
  let { data: s3 } = await U(r, { responseType: "text", query: Z(n3, a, o4, i), signal: i == null ? void 0 : i.signal });
  s3 = s3.replaceAll(/": +(-?\d+),(\d+)(,)?/g, '": $1.$2$3');
  try {
    return JSON.parse(s3);
  } catch (p2) {
    throw new s(P, "Error while parsing the response", { response: s3, error: p2 });
  }
}
function Z(e, t, r, n3) {
...
async function ee(t, r, n3) {
  ...
  if (o4 == null ? void 0 : o4.groups) return +o4.groups.numberMatched;
}
function te(e) {
...
//# sourceMappingURL=chunk-6CGXGSS3.js.map
