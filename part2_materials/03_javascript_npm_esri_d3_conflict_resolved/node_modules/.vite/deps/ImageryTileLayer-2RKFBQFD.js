...
var $ = class extends f {
  constructor() {
    super(...arguments), this._tileFetchQueue = new _({ concurrency: 32, process: (e3, t5) => this._fetchRawTile(e3.pyramidLevel, e3.row, e3.col, { ...e3.options, signal: t5 }) }), this.datasetName = null, this.datasetFormat = null, this.hasUniqueSourceStorageInfo = true, this.rasterInfo = null, this.ioConfig = { sampling: "closest" };
  }
  ...
  set url(e3) {
    this._set("url", y2(e3, n.getLogger(this)));
  }
  async open(e3) {
  ...
  async identify(e3, t5 = {}) {
    ...
    const c7 = null != s4 && n7 && (null != o6 || h4(i7));
    if (c7 && !a6) {
  ...
  async fetchPixels(e3, t5, i7, o6 = {}) {
    ...
    const n7 = V(e3.spatialReference), s4 = ee(e3);
    ...
    } else d10 = U3(p7, x4, { blockWidths: h9 });
  ...
  async fetchRawPixels(e3, t5, i7, o6 = {}) {
    ...
    } else y7 = U3(u9, h9, { clipOffset: x4, clipSize: i7 });
  ...
  getSliceIndex(e3) {
    ...
    return null == t5 || null == e3 || 0 === e3.length ? null : w3(e3, t5);
  }
  ...
  createRemoteDatasetStorageInfo(e3, t5 = 512, i7 = 512, o6) {
    ...
    e3.storageInfo = new n4({ blockWidth: t5, blockHeight: i7, pyramidBlockWidth: t5, pyramidBlockHeight: i7, origin: c7, firstPyramidLevel: 1, maximumPyramidLevel: o6, blockBoundary: f10 });
  }
  ...
  async _fetchPixels(e3, t5, i7, o6 = {}) {
    ...
    if (this.rasterJobHandler) {
      ...
      const e4 = U3(N4, V3, { alignmentInfo: J2 });
      O = A2 ? D2(e4, { width: t5, height: i7 }, D5.coefficients, q3, o6.interpolation) : e4, E3 && D5.gcsGrid && ($2 = R2({ width: t5, height: i7 }, D5.gcsGrid), O = u3(O, this.rasterInfo.dataType, $2));
    }
  ...
  _fetchRawTile(e3, t5, i7, o6) {
    ...
    if (null == u9) {
      ...
      u9 = this.fetchRawTile(e3, t5, i7, { ...o6, signal: r8.signal }), x2(f10, o6.registryId, m10, u9, r8), u9.catch(() => h5(f10, o6.registryId, m10));
    }
    return o6.signal && m(o6, () => {
...
r([m2()], $.prototype, "_rasterTileAlignmentInfo", void 0), r([m2()], $.prototype, "_tileFetchQueue", void 0), r([m2({ readOnly: true })], $.prototype, "_isGlobalWrappableSource", null), r([m2({ readOnly: true })], $.prototype, "_hasNoneOrGCSShiftTransform", null), r([m2()], $.prototype, "_openPromise", void 0), r([m2()], $.prototype, "rasterJobHandler", null), r([m2({ readOnly: true })], $.prototype, "rasterId", null), r([m2(y5)], $.prototype, "url", null), r([m2({ type: String, json: { write: true } })], $.prototype, "datasetName", void 0), r([m2({ type: String, json: { write: true } })], $.prototype, "datasetFormat", void 0), r([m2()], $.prototype, "hasUniqueSourceStorageInfo", void 0), r([m2()], $.prototype, "rasterInfo", void 0), r([m2()], $.prototype, "ioConfig", void 0), r([m2()], $.prototype, "sourceJSON", void 0), $ = r([a2("esri.layers.support.rasterDatasets.BaseRaster")], $);
var X = $;
...
var m6 = class extends X {
  ...
  async fetchPixels(t5, e3, r7, s4 = {}) {
    ...
    if (!l10 || null == y7 || null == g8) {
      ...
      return s4.noClip || s4.requestRawData || null == y7 || !t6 || (y7 = await h2(y7, d10, t6)), { ...u9[0], pixelBlock: y7 };
    }
    ...
    } else R3 = D2(y7, { width: e3, height: r7 }, g8.coefficients, x4, c7);
    const w5 = s4.noClip ? null : this.getClippingGeometry(t5.spatialReference);
    return s4.noClip || s4.requestRawData || null == R3 || null == w5 || (R3 = await h2(R3, t5, w5)), { extent: t5, srcExtent: u9[0].srcExtent, pixelBlock: R3 };
  }
  ...
  async _open(t5) {
    ...
    "Table" === (l10 == null ? void 0 : l10.functionName) && (r7.rasterInfo.attributeTable = d3.fromJSON(l10.functionArguments.attributeTableAsRecordSet)), await this.syncJobHandler();
    const p7 = n7[0];
  ...
  async _updateClipGeometry() {
    ...
    if (e3 && "inside" === t5.clippingType) {
      const { extent: t6 } = this.rasterInfo, { difference: r7, densify: s4 } = await import("./geometryEngine-5ALHOU3E.js");
...
r([m2({ type: String, json: { write: true } })], m6.prototype, "datasetFormat", void 0), r([m2()], m6.prototype, "tileType", void 0), r([m2()], m6.prototype, "rasterFunction", void 0), r([m2()], m6.prototype, "primaryRasters", void 0), m6 = r([a2("esri.layers.support.rasterDatasets.FunctionRaster")], m6);
var u4 = m6;
function h6(t5, e3) {
...
var K2 = (K3) => {
  let Q2 = class extends K3 {
    ...
    async convertVectorFieldData(e3, t5) {
      ...
      return i7 ? i7.convertVectorFieldData({ pixelBlock: e3, dataType: n7 }, t5) : f3(e3, n7);
    }
    async computeStatisticsHistograms(e3, t5) {
      ...
      const a6 = e3.pixelSize ?? new j({ x: r7.pixelSize.x, y: r7.pixelSize.y, spatialReference: s4 }), { extent: l10, width: u9, height: d10 } = l6(r7, n7, a6), m10 = await this.fetchPixels(l10, u9, d10, { ...t5, interpolation: "nearest" });
      if (null == m10.pixelBlock) throw new s("imagery-tile-mixin:compute-statistics-histograms", "failed to fetch pixels");
      const h9 = await h2(m10.pixelBlock, l10, n7), p7 = this._rasterJobHandler.instance;
    ...
    async updateRasterFunction() {
      ...
      if (i7) {
        ...
        const n8 = T2(((_b = i7.functionDefinition) == null ? void 0 : _b.toJSON()) ?? i7.toJSON(), r8), s5 = new u4({ rasterFunction: n8 });
    ...
    async updateRenderer() {
      ...
      const { rasterInfo: r7 } = this.raster, i7 = f4(r7, { multidimensionalDefinition: this.multidimensionalDefinition, multidimensionalSubset: this.multidimensionalSubset }), n7 = i7 == null ? void 0 : i7.name, s4 = ee2({ ...this.renderer.toJSON(), variableName: n7 });
    ...
    async identify(e3, t5 = {}) {
      ...
      if (null != (i7 == null ? void 0 : i7.multidimensionalInfo)) {
        if (!(i7.hasMultidimensionalTranspose && !!(h4(t5.multidimensionalDefinition) || t5.transposedVariableName || t5.timeExtent)) && null == (t5 = this.normalizeRasterFetchOptions(t5)).multidimensionalDefinition) return { location: e3, value: null };
      }
    ...
    _configDefaultRenderer(e3 = "no") {
      ...
      const s4 = ee2({ ...this.renderer.toJSON(), variableName: i7 }), o6 = W2(t5, i7);
      this.symbolizer ? (this.symbolizer.rendererJSON = s4, this.symbolizer.rasterInfo = o6) : this.symbolizer = new _2({ rendererJSON: s4, rasterInfo: o6 });
  ...
  return r([m2({ clonable: false })], Q2.prototype, "_cachedRendererJson", void 0), r([m2({ clonable: false })], Q2.prototype, "_cachedRasterFunctionJson", void 0), r([m2({ clonable: false })], Q2.prototype, "_compatibleFullExtent", void 0), r([m2({ clonable: false })], Q2.prototype, "_isConstructedFromFunctionRaster", void 0), r([m2({ clonable: false })], Q2.prototype, "_rasterJobHandler", void 0), r([m2({ type: [x], json: { write: { overridePolicy() {
    var _a;
  ...
  } } } }), r2(a4)], Q2.prototype, "interpolation", void 0), r([m2()], Q2.prototype, "ioConfig", void 0), r([m2({ type: [p3], json: { write: true } })], Q2.prototype, "multidimensionalDefinition", null), r([m2({ type: c3, json: { write: true } })], Q2.prototype, "multidimensionalSubset", void 0), r([m2()], Q2.prototype, "raster", void 0), r([m2({ type: N2, json: { name: "renderingRule", write: true } })], Q2.prototype, "rasterFunction", null), r([m2({ readOnly: true })], Q2.prototype, "rasterInfo", null), r([m2()], Q2.prototype, "serviceRasterInfo", void 0), r([m2()], Q2.prototype, "sourceJSON", void 0), r([m2({ readOnly: true, type: g, json: { read: false } })], Q2.prototype, "spatialReference", void 0), r([m2({ type: z })], Q2.prototype, "tileInfo", void 0), r([m2(y5)], Q2.prototype, "url", null), r([m2()], Q2.prototype, "renderer", null), r([m2({ types: l8, json: { name: "layerDefinition.drawingInfo.renderer", write: { overridePolicy() {
    var _a;
...
var f9 = class extends X {
  ...
  async _buildMDimStats(t5, e3, s4) {
    for (let i7 = 0; i7 < e3.variables.length; i7++) {
      ...
      }), l10 = w3(a6, e3), m10 = null == l10 ? null : t5[l10];
...
r([m2({ type: String, json: { write: true } })], f9.prototype, "datasetFormat", void 0), r([m2()], f9.prototype, "source", void 0), r([m2()], f9.prototype, "url", null), f9 = r([a2("esri.layers.support.rasterDatasets.InMemoryRaster")], f9);
var g6 = f9;
...
var m8 = class extends X {
  ...
  async _open(e3) {
    const { extent: t5, pixelBlocks: r7, multidimensionalInfo: s4, attributeTable: a6, bandNames: o6 } = await this._fetchData(e3), { statistics: i7, histograms: n7 } = m4(r7[0]), m10 = o6 == null ? void 0 : o6.map((e4) => ({ BandName: e4 })), h9 = { DataType: a6 ? "Thematic" : s4 ? "Scientific" : "Generic", BandProperties: m10 }, d10 = new g6({ source: { extent: t5, pixelBlocks: r7, attributeTable: a6 ? d3.fromJSON(a6) : null, multidimensionalInfo: s4, statistics: i7, histograms: n7, keyProperties: h9, isPseudoSpatialReference: false } });
...
function c6(e3) {
  ...
  return { spatialReference: n7, transform: S4 && C2 && S4.length && C2.length ? new y4({ spatialReference: n7, polynomialOrder: s4, forwardCoefficients: S4, inverseCoefficients: C2 }) : null };
}
function m9(e3) {
  var _a;
...
var h8 = class extends X {
  ...
  async _open(t5) {
    ...
    const i7 = !e3;
    i7 && (e3 = new g({ wkid: 3857 })), (o6 == null ? void 0 : o6.length) && null == r7 && (r7 = g3(o6));
  ...
  async _fetchAuxiliaryData(t5) {
    ...
    if (!u9.transform) {
      ...
      u9.transform = 6 === (t6 == null ? void 0 : t6.length) ? new y4({ forwardCoefficients: [t6[4], t6[5], t6[0], -t6[1], t6[2], -t6[3]] }) : null;
    }
    return u9;
  }
};
r([m2({ type: String, json: { write: true } })], h8.prototype, "datasetFormat", void 0), h8 = r([a2("esri.layers.support.rasterDatasets.ImageAuxRaster")], h8);
var d9 = h8;
...
var g7 = class extends X {
  ...
  async fetchRawTile(e3, t5, i7, s4 = {}) {
    ...
    return T(p7, { x: b3, y: T4 }, { width: _4 - b3, height: O - T4 }), p7;
  }
  getSliceIndex(e3) {
  ...
  async _fetchRasterInfo(e3) {
    ...
    const { signal: i7 } = e3, s4 = f5(this.url, this.sourceJSON, { signal: i7, query: this.ioConfig.customFetchParameters }), r7 = t5.hasMultidimensions ? this.request(`${this.url}/slices`, { query: { f: "json" }, signal: i7 }).then((e4) => {
      var _a;
...
function S3(e3) {
  ...
  t5.xmin > -1 && t5.xmax > 181 && (i7 == null ? void 0 : i7.wkid) && i7.isGeographic && (e3.nativeExtent = e3.extent, e3.transform = new c(), e3.extent = e3.transform.forwardTransform(t5));
}
r([m2({ type: String, json: { write: true } })], g7.prototype, "datasetFormat", void 0), r([m2()], g7.prototype, "tileType", void 0), g7 = r([a2("esri.layers.support.rasterDatasets.ImageServerRaster")], g7);
var I3 = g7;
...
var w4 = class extends X {
  ...
  async _open(t5) {
    ...
    if (!a6.includes("aux.xml") && !i7) {
      ...
      null != e4 && (s4.statistics = e4.statistics ?? s4.statistics, s4.histograms = e4.histograms, e4.histograms && null == s4.statistics && (s4.statistics = g3(e4.histograms)));
    }
...
r([m2()], w4.prototype, "_files", void 0), r([m2()], w4.prototype, "_storageIndex", void 0), r([m2({ type: String, json: { write: true } })], w4.prototype, "datasetFormat", void 0), w4 = r([a2("esri.layers.support.rasterDatasets.MRFRaster")], w4);
var b2 = w4;
...
var v4 = class extends X {
  ...
  async _open(e3) {
    ...
    const { imageInfo: l10, rasterInfo: u9 } = k3(f10), p7 = U2(f10), d10 = N(f10);
  ...
  async _readIFDs(e3, t5, r7, i7, s4, a6 = 4, n7) {
    ...
    const o6 = await this._readIFD(t5, r7, i7, s4, n3.tiffTags, a6, n7);
    if (e3.push(o6.ifd), !o6.nextIFD) return null;
    await this._readIFDs(e3, t5, r7, o6.nextIFD - s4, s4, a6, n7);
  }
  async _readIFD(e3, r7, i7, s4, a6 = n3.tiffTags, n7 = 4, o6) {
    var _a, _b;
    if (!e3) return null;
    ...
    if (f10.success) {
      ...
      if ((_b = f10.ifd) == null ? void 0 : _b.has("GEOKEYDIRECTORY")) {
        ...
        if (i9 && i9.length > 4) {
          const a7 = i9[0] + "." + i9[1] + "." + i9[2], n8 = await this._readIFD(e3, r7, t5.valueOffset + 6 - s4, s4, n3.geoKeys, 2, o6);
    ...
    if (f10.requiredBufferSize && f10.requiredBufferSize !== e3.byteLength) {
      ...
      return (e3 = t5.data).byteLength < f10.requiredBufferSize ? null : this._readIFD(e3, r7, 0, s4, n3.tiffTags, 4, o6);
    }
  }
  ...
  _getTileLocation(e3, t5, r7, i7 = false) {
    ...
    if (!f10) return null;
    const l10 = D(f10, o6), u9 = _3(f10, "TILEOFFSETS");
  ...
  async _fetchAuxiliaryTable(e3) {
    try {
      ...
      return (r7 == null ? void 0 : r7.recordSet) ? d3.fromJSON(r7.recordSet) : null;
    } catch {
      return null;
    }
  }
...
function P2(e3, t5) {
  if (t5.statistics = e3.statistics ?? t5.statistics, t5.histograms = e3.histograms, e3.histograms && null == t5.statistics && (t5.statistics = g3(e3.histograms)), e3.transform && null == t5.transform) {
...
r([m2()], v4.prototype, "_files", void 0), r([m2()], v4.prototype, "_headerInfo", void 0), r([m2()], v4.prototype, "_bufferSize", void 0), r([m2({ type: String, json: { write: true } })], v4.prototype, "datasetFormat", void 0), v4 = r([a2("esri.layers.support.rasterDatasets.TIFFRaster")], v4);
var D4 = v4;
...
var L3 = class extends l2(t(b(j2(o3(e(K2(l5(l4(f2(S(i2(f6)))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.fields = null, this.source = void 0, this._debouncedSaveOperations = k(async (e4, t5, r7) => {
      const { save: s4, saveAs: i7 } = await import("./imageryUtils-OKAHYXKJ.js");
      switch (e4) {
        case A.SAVE:
          return s4(this, t5);
        case A.SAVE_AS:
  ...
  get rasterFields() {
    var _a, _b;
    const e3 = [new y3({ name: "Raster.ServicePixelValue", alias: "Pixel Value", domain: null, editable: false, length: 50, type: "string" }), new y3({ name: "Raster.ServicePixelValue.Raw", alias: "Raw Pixel Value", domain: null, editable: false, length: 50, type: "string" })], t5 = ((_a = this.raster) == null ? void 0 : _a.rasterInfo) ?? this.serviceRasterInfo, r7 = t5 == null ? void 0 : t5.attributeTable, s4 = null != r7 ? r7.fields : null, i7 = "Raster.";
    if (s4) {
    ...
    if (("vector-magdir" === o6 || "vector-uv" === o6) && null != a6) {
      ...
      e3.push(new y3({ name: "Raster.Magnitude", alias: r8, domain: null, editable: false, type: "double" })), e3.push(new y3({ name: "Raster.Direction", alias: "Direction (°)", domain: null, editable: false, type: "double" }));
    }
    return e3;
  }
  ...
  async generateRasterInfo(e3, t5) {
    var _a;
    if (e3 = h(N2, e3), await this.load(), !e3 || "none" === ((_a = e3.functionName) == null ? void 0 : _a.toLowerCase())) return this.serviceRasterInfo;
    try {
  ...
  async _openFunctionRaster(e3, t5) {
    ...
    const s4 = T2(((_a = e3.functionDefinition) == null ? void 0 : _a.toJSON()) ?? e3.toJSON(), r7), i7 = new u4({ rasterFunction: s4 });
...
r([m2({ clonable: false })], L3.prototype, "_primaryRasters", void 0), r([m2(d4)], L3.prototype, "legendEnabled", void 0), r([m2({ type: Boolean, json: { read: false, write: { enabled: true, overridePolicy: () => ({ enabled: false }) } } })], L3.prototype, "isReference", void 0), r([m2({ type: ["show", "hide"] })], L3.prototype, "listMode", void 0), r([m2({ json: { read: true, write: true } })], L3.prototype, "blendMode", void 0), r([m2()], L3.prototype, "sourceJSON", void 0), r([m2({ readOnly: true, json: { origins: { service: { read: { source: "currentVersion" } } } } })], L3.prototype, "version", void 0), r([m2({ readOnly: true, json: { read: false } })], L3.prototype, "type", void 0), r([m2({ type: ["ArcGISTiledImageServiceLayer"] })], L3.prototype, "operationalLayerType", void 0), r([m2({ type: Boolean, value: true, json: { read: { source: "disablePopup", reader: (e3, t5) => !t5.disablePopup }, write: { target: "disablePopup", overridePolicy() {
  return { enabled: !this.loaded || "Raster" === this.raster.tileType };
}, writer(e3, t5, r7) {
  t5[r7] = !e3;
} } } })], L3.prototype, "popupEnabled", void 0), r([m2({ type: q, json: { read: { source: "popupInfo" }, write: { target: "popupInfo", overridePolicy() {
  return { enabled: !this.loaded || "Raster" === this.raster.tileType };
} } } })], L3.prototype, "popupTemplate", void 0), r([m2({ readOnly: true })], L3.prototype, "defaultPopupTemplate", null), r([m2({ readOnly: true, type: [y3] })], L3.prototype, "fields", void 0), r([m2({ readOnly: true, type: [y3] })], L3.prototype, "rasterFields", null), r([m2({ constructOnly: true })], L3.prototype, "source", void 0), L3 = r([a2("esri.layers.ImageryTileLayer")], L3);
var J = L3;
export {
  J as default
};
//# sourceMappingURL=ImageryTileLayer-2RKFBQFD.js.map
