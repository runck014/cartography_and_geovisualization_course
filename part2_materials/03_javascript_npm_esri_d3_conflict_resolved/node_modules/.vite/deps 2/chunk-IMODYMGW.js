...
l3.ATTRIBUTES = ["fill-color", "fill-opacity", "fill-pattern"], l3.GEOMETRY_LAYOUT = [new t("a_pos", 2, C2.SHORT, 0, 4)], l3.ATTRIBUTES_INFO = { "fill-color": { name: "color", type: N2.R8G8B8A8_COLOR }, "fill-opacity": { name: "opacity", type: N2.R8_UNSIGNED, precisionFactor: 100 }, "fill-pattern": { name: "tlbr", type: N2.R16G16B16A16_PATTERN, isOptional: true } };
...
var P2 = class _P {
  ...
  evaluate(n2, a6) {
    ...
    if ("interpolate-lab" === this._operator) {
      const e3 = C(f3), n3 = C(w), a7 = A({ l: p(e3.l, n3.l, p2), a: p(e3.a, n3.a, p2), b: p(e3.b, n3.b, p2) });
...
//# sourceMappingURL=chunk-IMODYMGW.js.map
