...
async function o2(o3) {
  var _a;
  const a2 = "portalItem" in o3 ? o3 : { portalItem: o3 }, { fromItem: e } = await import("./portalLayers-6XQKSZXV.js");
  try {
    return await e(a2);
  } catch (p2) {
...
var b2 = 0;
var h = class extends o.EventedMixin(s3(m2)) {
  constructor() {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-JEDUUFPC.js")).fromUrl(e);
  }
  ...
  initialize() {
    this.when().catch((t) => {
      b(t) || n.getLogger(this).error("#load()", `Failed to load layer (title: '${this.title ?? "no title"}', id: '${this.id ?? "no id"}')`, { error: t });
    });
  }
  destroy() {
    const t = this.parent;
  ...
  get effectiveVisible() {
    let t = this.visible;
    const e = this.parent;
    return t && e && "effectiveVisible" in e && (t && (t = e.effectiveVisible)), t;
  }
...
//# sourceMappingURL=chunk-2HEBE37N.js.map
