...
r([K], D2.prototype, "blendMode", void 0), r([g2(B)], D2.prototype, "config", void 0), r([e(0, m3(z2))], D2.prototype, "vertex", null), r([e(0, m3(A))], D2.prototype, "fragment", null);
...
r([g2(f2)], v2.prototype, "config", void 0), r([e(0, m3(m4))], v2.prototype, "vertex", null), r([e(0, m3(x))], v2.prototype, "fragment", null);
    ...
    (_a = this.navigation.animationManager) == null ? void 0 : _a.animateContinuous(t7.viewpoint, (o5, i2) => {
      ...
      if (this._momentumFinished = e4 && n6, !this._momentumFinished) {
        ...
        if (this._previousCenter) {
          o3(e5, this._previousCenter.x, this._previousCenter.y), rt(n7, t7.size, t7.padding), u2(e5, e5, n7);
...
var j4 = class extends b {
  ...
  begin(t7, e4) {
    this.navigation.begin(), o3(this._previousCenter, e4.center.x, e4.center.y);
  }
  update(t7, e4) {
    const { state: { size: o5, padding: r13 } } = t7;
    o3(d5, e4.center.x, e4.center.y), $(g3, o5, r13), t7.viewpoint = bt(this.viewpoint, t7.state.paddedViewState.viewpoint, pt(g3, this._previousCenter, d5)), r5(this._previousCenter, d5);
  }
  end() {
    this.navigation.end();
  }
...
r([g2(j5)], E3.prototype, "config", void 0), r([e(0, m3(T2))], E3.prototype, "vertex", null), r([e(0, m3(C2))], E3.prototype, "fragment", null);
...
r([g2(G3)], S2.prototype, "transform", void 0), r([g2(M2)], S2.prototype, "config", void 0), r([e(0, m3(k))], S2.prototype, "vertex", null), r([e(0, m3(F))], S2.prototype, "fragment", null);
...
//# sourceMappingURL=chunk-C55OFUQT.js.map
