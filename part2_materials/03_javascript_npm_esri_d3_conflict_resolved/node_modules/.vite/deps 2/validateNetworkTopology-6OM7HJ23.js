...
async function o(t, o2, d2) {
  ...
  const c = { ...u, returnEdits: true, f: "json" }, p = s2({ ...l.query, ...c }), f2 = i(p, { ...d2, method: "post" }), k = `${l.path}/validateNetworkTopology`, { data: v } = await U(k, f2);
...
async function d(r, o2, d2) {
  ...
  const u = i(n2.query, { query: s2({ ...l, returnEdits: true, async: true, f: "json" }), ...d2, method: "post" }), c = `${n2.path}/validateNetworkTopology`, { data: p } = await U(c, u);
...
//# sourceMappingURL=validateNetworkTopology-6OM7HJ23.js.map
