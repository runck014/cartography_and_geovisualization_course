...
var FloatingArrow = ({ floatingLayout, key, ref }) => {
  ...
  return h(
    "svg",
    { "aria-hidden": "true", class: CSS.arrow, height: width, key, ref, viewBox: `0 0 ${width} ${width + (!isVertical ? strokeWidth : 0)}`, width: width + (isVertical ? strokeWidth : 0) },
...
@esri/calcite-components/dist/components/FloatingArrow.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-43ER5AHW.js.map
