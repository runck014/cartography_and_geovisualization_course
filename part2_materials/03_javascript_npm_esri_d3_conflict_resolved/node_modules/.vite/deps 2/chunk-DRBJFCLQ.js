...
var i2 = class {
  constructor(i4, t3, e2, s5, h3, n3) {
    this.semiMajorAxis = i4, this.flattening = t3, this.outerAtmosphereRimWidth = e2, this.atmosphereHeight = s5, this.scaleHeight = h3;
    const r4 = 1 - this.flattening;
    this.semiMinorAxis = this.semiMajorAxis * r4, this.halfSemiMajorAxis = this.semiMajorAxis / 2, this.halfCircumference = Math.PI * this.semiMajorAxis, this.metersPerDegree = this.halfCircumference / 180, this.inverseFlattening = 1 / (1 - this.flattening) - 1, this.eccentricitySquared = n3 || 2 * this.flattening - this.flattening * this.flattening, this.meanRadiusSemiAxes = (2 * this.semiMajorAxis + this.semiMinorAxis) / 3;
  }
  get radius() {
    return this.semiMajorAxis;
  }
};
var t = new i2(6378137, 1 / 298.257223563, 3e5, 1e5, 0.085, 0.006694379990137799);
var e = new i2(3396190, 1 / 169.8944472236118, 23e4, 6e4, 0.111);
var s = new i2(1737400, 0, 0, 0, 0);
...
function _() {
  return t2 || (t2 = import("./pe-wasm-PCGRRIGP.js").then((e2) => e2.p).then(({ default: t3 }) => t3({ locateFile: (t4) => n(`esri/geometry/support/${t4}`) })).then((e2) => {
    d(e2);
  }), t2);
}
var P;
...
!function(e2) {
  function t3(e3, t4, r5) {
    ...
    const n4 = D(r5), _4 = r5 === n4, P3 = o.ensureFloat64(n4), s5 = o._pe_geog_to_proj(o.getPointer(e3), t4, P3);
    return s5 && R(r5, t4, P3, _4), s5;
  }
  function r4(e3, o5, r5, _4) {
    switch (_4) {
  ...
  function n3(e3, t4, o5) {
    return _3(e3, t4, o5, 0);
  }
  function _3(e3, t4, r5, n4) {
    o.ensureCache.prepare();
    const _4 = D(r5), P3 = r5 === _4, s5 = o.ensureFloat64(_4), i4 = o._pe_proj_to_geog_center(o.getPointer(e3), t4, s5, n4);
    return i4 && R(r5, t4, s5, P3), i4;
  }
...
!function(e2) {
  ...
  function P3(e3) {
    return i4(s2.PE_TYPE_COORDSYS, e3);
  }
  function i4(e3, r5) {
    let _4 = null, P4 = t3[e3];
    if (P4 || (P4 = {}, t3[e3] = P4), P4.hasOwnProperty(String(r5)) && (_4 = P4[r5], o.compare(_4, o.NULL) && (_4 = null)), !_4) {
      const t4 = o.PeFactory.prototype.factoryByType(e3, r5);
      o.compare(t4, o.NULL) || (_4 = n3(t4), P4[r5] = _4);
    }
    return _4;
  }
  function p5(e3, t4) {
    let _4 = null, P4 = r4[e3];
    if (P4 || (P4 = {}, r4[e3] = P4), P4.hasOwnProperty(t4) && (_4 = P4[t4], o.compare(_4, o.NULL) && (_4 = null)), !_4) {
      const r5 = o.PeFactory.prototype.fromString(e3, t4);
      o.compare(r5, o.NULL) || (_4 = n3(r5), P4[t4] = _4);
    }
    return _4;
  }
  function u4(e3) {
    return i4(s2.PE_TYPE_GEOGCS, e3);
  }
  function E5(e3) {
    return i4(s2.PE_TYPE_GEOGTRAN, e3);
  }
  function c3(e3) {
    return o.PeFactory.prototype.getCode(e3);
  }
  function a2(e3) {
    return i4(s2.PE_TYPE_PROJCS, e3);
  }
  function g4(e3) {
    return i4(s2.PE_TYPE_UNIT, e3);
  }
  e2.initialize = _3, e2.coordsys = P3, e2.factoryByType = i4, e2.fromString = p5, e2.geogcs = u4, e2.geogtran = E5, e2.getCode = c3, e2.projcs = a2, e2.unit = g4;
}(p || (p = {}));
var u = null;
var E;
var c;
...
function d(e2) {
  ...
  o = e2, s2.init(), E.init(), l.init(), S.init(), O.init(), i3 = class extends o.PeDouble {
    constructor(e3 = NaN) {
      super(e3);
    }
    destroy() {
  ...
  for (const o5 of r4) t3(o5.prototype, "getName", (e3) => function() {
    return e3.call(this, new Array(s2.PE_NAME_MAX));
  });
  for (const P3 of [o.PeGeogtran, o.PeProjcs]) t3(P3.prototype, "getParameters", (e3) => function() {
  ...
  t3(o.PeHorizon.prototype, "getCoord", (e3) => function(t4 = false) {
    const o5 = this.getSize();
    if (!o5) return null;
    const r5 = [];
    return R(r5, o5, e3.call(this), t4), r5;
...
!function(e2) {
  ...
  function n3(e3, r5, n4, _3, P3, s5) {
    let i4 = null;
    const p5 = new o.PeInteger(s5);
    try {
      const u4 = o.PeGTlistExtended.prototype.getGTlist(e3, r5, n4, _3, P3, p5);
      if ((s5 = p5.val) && (i4 = [u4], s5 > 1)) {
        const e4 = o.getPointer(u4);
        for (let r6 = 1; r6 < s5; r6++) i4.push(o.wrapPointer(e4 + t3 * r6, o.PeGTlistExtendedEntry));
      }
    } finally {
      o.destroy(p5);
    }
  ...
  function t3(e3, t4, r4, n3, _3) {
    o.ensureCache.prepare();
    const P3 = D(r4), s5 = r4 === P3, i4 = o.ensureFloat64(P3);
    let p5 = 0;
    n3 && (p5 = o.ensureFloat64(n3));
    const u4 = o._pe_geog_to_geog(o.getPointer(e3), t4, i4, p5, _3);
    return u4 && R(r4, t4, i4, s5), u4;
  }
  e2.geogToGeog = t3;
}(a || (a = {})), function(e2) {
  function t3(e3, t4, r5, n4, _4, P3, s5, i4) {
    o.PeLineType.prototype.geodesic_coordinate(e3, t4, r5, n4, _4, P3, s5, i4);
  }
  function r4(e3, t4, r5, n4, _4, P3, s5, i4, p5) {
    o.PeLineType.prototype.geodetic_coordinate(e3, t4, r5, n4, _4, P3, s5, i4, p5);
  }
  function n3(e3, t4, r5, n4, _4, P3, s5, i4, p5, u4) {
    o.PeLineType.prototype.geodetic_distance(e3, t4, r5, n4, _4, P3, s5, i4, p5, u4);
  }
  function _3(e3, t4, r5, n4, _4, P3, s5, i4, p5) {
    o.PeLineType.prototype.great_elliptic_distance(e3, t4, r5, n4, _4, P3, s5, i4, p5);
  }
  ...
  e2.phiToEta = t3, e2.etaToPhi = r4, e2.phiToPhig = n3, e2.q = _3, e2.q90 = P3;
}(T || (T = {})), function(e2) {
  const t3 = (e3, t4, r5, n4, _4, P4) => {
    let i5, p6;
    switch (o.ensureCache.prepare(), e3) {
      case "dd":
        i5 = o._pe_geog_to_dd, p6 = s2.PE_DD_MAX;
        break;
      case "ddm":
        i5 = o._pe_geog_to_ddm, p6 = s2.PE_DDM_MAX;
        break;
      case "dms":
        i5 = o._pe_geog_to_dms, p6 = s2.PE_DMS_MAX;
    }
    let u5 = 0;
    t4 && (u5 = o.getPointer(t4));
    const E5 = D(n4), c3 = o.ensureFloat64(E5), a2 = A(r5, p6), g4 = i5(u5, r5, c3, _4, o.ensureInt32(a2));
    if (g4) for (let s5 = 0; s5 < r5; s5++) P4[s5] = o.UTF8ToString(a2[s5]);
    return g4;
  }, r4 = (e3, t4, r5, n4, _4) => {
    let P4;
    switch (o.ensureCache.prepare(), e3) {
      case "dd":
        ...
        break;
      case "ddm":
        P4 = o._pe_ddm_to_geog;
        break;
      case "dms":
        P4 = o._pe_dms_to_geog;
    }
    let s5 = 0;
    t4 && (s5 = o.getPointer(t4));
    const i5 = n4.map((e4) => o.ensureString(e4)), p6 = o.ensureInt32(i5), u5 = o.ensureFloat64(new Array(2 * r5)), E5 = P4(s5, r5, p6, u5);
    return E5 && R(_4, r5, u5), E5;
  };
  function n3(e3, o5, r5, n4, _4) {
    return t3("dms", e3, o5, r5, n4, _4);
  }
  function _3(e3, t4, o5, n4) {
    return r4("dms", e3, t4, o5, n4);
  }
  function P3(e3, o5, r5, n4, _4) {
    return t3("ddm", e3, o5, r5, n4, _4);
  }
  function i4(e3, t4, o5, n4) {
    return r4("ddm", e3, t4, o5, n4);
  }
  function p5(e3, o5, r5, n4, _4) {
    return t3("dd", e3, o5, r5, n4, _4);
  }
  function u4(e3, t4, o5, n4) {
    return r4("dd", e3, t4, o5, n4);
  }
  e2.geogToDms = n3, e2.dmsToGeog = _3, e2.geogToDdm = P3, e2.ddmToGeog = i4, e2.geogToDd = p5, e2.ddToGeog = u4;
}(f || (f = {})), function(e2) {
  function t3() {
  ...
  function r4(e3, t4, r5, n4, _3, P3, i4) {
    o.ensureCache.prepare();
    let p5 = 0;
    e3 && (p5 = o.getPointer(e3));
    const u4 = D(r5), E5 = o.ensureFloat64(u4), c3 = A(t4, s2.PE_MGRS_MAX), a2 = o.ensureInt32(c3), g4 = o._pe_geog_to_mgrs_extended(p5, t4, E5, n4, _3, P3, a2);
    if (g4) for (let s5 = 0; s5 < t4; s5++) i4[s5] = o.UTF8ToString(c3[s5]);
    return g4;
  }
  function n3(e3, t4, r5, n4, _3) {
    o.ensureCache.prepare();
    let P3 = 0;
    e3 && (P3 = o.getPointer(e3));
    const s5 = r5.map((e4) => o.ensureString(e4)), i4 = o.ensureInt32(s5), p5 = o.ensureFloat64(new Array(2 * t4)), u4 = o._pe_mgrs_to_geog_extended(P3, t4, i4, n4, p5);
    return u4 && R(_3, t4, p5), u4;
  }
  e2.init = t3, e2.geogToMgrsExtended = r4, e2.mgrsToGeogExtended = n3;
}(l || (l = {})), function(e2) {
  function t3(e3, t4, r5, n3, _3, P3, i4) {
    o.ensureCache.prepare();
    let p5 = 0;
    e3 && (p5 = o.getPointer(e3));
    const u4 = D(r5), E5 = o.ensureFloat64(u4), c3 = A(t4, s2.PE_MGRS_MAX), a2 = o.ensureInt32(c3), g4 = o._pe_geog_to_usng(p5, t4, E5, n3, _3, P3, a2);
    if (g4) for (let s5 = 0; s5 < t4; s5++) i4[s5] = o.UTF8ToString(c3[s5]);
    return g4;
  }
  function r4(e3, t4, r5, n3) {
    ...
    const P3 = r5.map((e4) => o.ensureString(e4)), s5 = o.ensureInt32(P3), i4 = o.ensureFloat64(new Array(2 * t4)), p5 = o._pe_usng_to_geog(_3, t4, s5, i4);
    return p5 && R(n3, t4, i4), p5;
  }
  ...
  function r4(e3, t4, r5, n4, _3) {
    ...
    let P3 = 0;
    e3 && (P3 = o.getPointer(e3));
    const i4 = D(r5), p5 = o.ensureFloat64(i4), u4 = A(t4, s2.PE_UTM_MAX), E5 = o.ensureInt32(u4), c3 = o._pe_geog_to_utm(P3, t4, p5, n4, E5);
  ...
  function n3(e3, t4, r5, n4, _3) {
    ...
    let P3 = 0;
    e3 && (P3 = o.getPointer(e3));
    const s5 = r5.map((e4) => o.ensureString(e4)), i4 = o.ensureInt32(s5), p5 = o.ensureFloat64(new Array(2 * t4)), u4 = o._pe_utm_to_geog(P3, t4, i4, n4, p5);
    return u4 && R(_3, t4, p5), u4;
  }
  ...
  function n3(r5, n4 = e2.PE_PCSINFO_OPTION_DOMAIN) {
    let _3 = null, P3 = null;
    return t3.has(r5) && (P3 = t3.get(r5), P3[n4] && (_3 = P3[n4])), _3 || (_3 = o.PePCSInfo.prototype.generate(r5, n4), P3 || (P3 = [], t3.set(r5, P3)), P3[n4] = _3), _3;
  }
...
var u2 = [4326, ...l2, ...E2];
var o3 = [-20037508342788905e-9, 20037508342788905e-9];
var S3 = [-20037508342787e-6, 20037508342787e-6];
var M2 = { wkTemplate: 'PROJCS["WGS_1984_Web_Mercator_Auxiliary_Sphere",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Mercator_Auxiliary_Sphere"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",{Central_Meridian}],PARAMETER["Standard_Parallel_1",0.0],PARAMETER["Auxiliary_Sphere_Type",0.0],UNIT["Meter",1.0]]', valid: o3, origin: S3, dx: 1e-5 };
var R2 = { 102113: { wkTemplate: 'PROJCS["WGS_1984_Web_Mercator",GEOGCS["GCS_WGS_1984_Major_Auxiliary_Sphere",DATUM["D_WGS_1984_Major_Auxiliary_Sphere",SPHEROID["WGS_1984_Major_Auxiliary_Sphere",6378137.0,0.0]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Mercator"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",{Central_Meridian}],PARAMETER["Standard_Parallel_1",0.0],UNIT["Meter",1.0]]', valid: o3, origin: S3, dx: 1e-5 }, 102100: M2, 3785: { wkTemplate: 'PROJCS["WGS_1984_Web_Mercator",GEOGCS["GCS_WGS_1984_Major_Auxiliary_Sphere",DATUM["D_WGS_1984_Major_Auxiliary_Sphere",SPHEROID["WGS_1984_Major_Auxiliary_Sphere",6378137.0,0.0]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Mercator"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",{Central_Meridian}],PARAMETER["Standard_Parallel_1",0.0],UNIT["Meter",1.0]]', valid: o3, origin: S3, dx: 1e-5 }, 3857: M2, 4326: { wkTemplate: 'GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",{Central_Meridian}],UNIT["Degree",0.0174532925199433]]', altTemplate: 'PROJCS["WGS_1984_Plate_Carree",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Plate_Carree"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",{Central_Meridian}],UNIT["Degrees",111319.491]]', valid: [-180, 180], origin: [-180, 90], dx: 1e-5 }, 104971: { wkTemplate: 'GEOGCS["Mars_2000_(Sphere)",DATUM["Mars_2000_(Sphere)",SPHEROID["Mars_2000_(Sphere)",3396190.0,0.0]],PRIMEM["Reference_Meridian",0.0],UNIT["Degree",0.0174532925199433]]', valid: [-180, 180], origin: [-180, 90], dx: 1e-5 }, 104905: { wkTemplate: 'GEOGCS["GCS_Mars_2000",DATUM["D_Mars_2000",SPHEROID["Mars_2000_IAU_IAG",3396190.0,169.8944472236118]],PRIMEM["Reference_Meridian",0.0],UNIT["Degree",0.0174532925199433]]', valid: [-180, 180], origin: [-180, 90], dx: 1e-5 }, 900913: M2 };
function s3(e2, r4) {
  ...
  if (null != n3 || null != t3) {
    ...
    const i5 = e2.latestWkid;
    if (null != i5 && t3 === i5) return true;
    const _4 = r4.latestWkid;
    return null != _4 && n3 === _4;
  }
  let i4, _3;
  return e2.wkt2 && r4.wkt2 ? (i4 = e2.wkt2, _3 = r4.wkt2) : e2.wkt && r4.wkt && (i4 = e2.wkt, _3 = r4.wkt), !(!i4 || !_3) && i4.toUpperCase() === _3.toUpperCase();
}
function d2(e2) {
...
function s4(o5) {
  if (null != o5 && g2(o5)) {
    const n3 = o5.wkid, t3 = o5.wkt2 ?? o5.wkt;
    if (I(n3)) return e;
...
var U2 = r3;
var d3 = /UNIT\[([^\]]+)]/i;
var h2 = /* @__PURE__ */ new Set([4305, 4807, 4810, 4811, 4812, 4816, 4819, 4821, 4901, 4902, 37225, 104025, 104026, 104139, 104140]);
var B = i()({ meter: "meters", foot: "feet", foot_us: "us-feet", foot_clarke: "clarke-feet", yard_clarke: "clarke-yards", link_clarke: "clarke-links", yard_sears: "sears-yards", foot_sears: "sears-feet", chain_sears: "sears-chains", chain_benoit_1895_b: "benoit-1895-b-chains", yard_indian: "indian-yards", yard_indian_1937: "indian-1937-yards", foot_gold_coast: "gold-coast-feet", chain: "chains", chain_sears_1922_truncated: "sears-1922-truncated-chains", "50_kilometers": "50-kilometers", "150_kilometers": "150-kilometers" });
var q = (e2) => e2 * e2;
var k2 = (e2) => e2 * e2 * e2;
var b = { length: { baseUnit: "meters", units: { millimeters: { inBaseUnits: 1e-3 }, centimeters: { inBaseUnits: 0.01 }, decimeters: { inBaseUnits: 0.1 }, meters: { inBaseUnits: 1 }, kilometers: { inBaseUnits: 1e3 }, inches: { inBaseUnits: 0.0254 }, feet: { inBaseUnits: 0.3048 }, yards: { inBaseUnits: 0.9144 }, miles: { inBaseUnits: 1609.344 }, "nautical-miles": { inBaseUnits: 1852 }, "us-feet": { inBaseUnits: 1200 / 3937 }, "clarke-feet": { inBaseUnits: 0.3047972654 }, "clarke-yards": { inBaseUnits: 0.9143917962 }, "clarke-links": { inBaseUnits: 0.201166195164 }, "sears-yards": { inBaseUnits: 0.9143984146160287 }, "sears-feet": { inBaseUnits: 0.3047994715386762 }, "sears-chains": { inBaseUnits: 20.11676512155263 }, "benoit-1895-b-chains": { inBaseUnits: 20.11678249437587 }, "indian-yards": { inBaseUnits: 0.9143985307444408 }, "indian-1937-yards": { inBaseUnits: 0.91439523 }, "gold-coast-feet": { inBaseUnits: 0.3047997101815088 }, chains: { inBaseUnits: 20.1168 }, "sears-1922-truncated-chains": { inBaseUnits: 20.116756 }, "50-kilometers": { inBaseUnits: 5e4 }, "150-kilometers": { inBaseUnits: 15e4 } } }, area: { baseUnit: "square-meters", units: { "square-millimeters": { inBaseUnits: q(1e-3) }, "square-centimeters": { inBaseUnits: q(0.01) }, "square-decimeters": { inBaseUnits: q(0.1) }, "square-meters": { inBaseUnits: 1 }, "square-kilometers": { inBaseUnits: q(1e3) }, "square-inches": { inBaseUnits: q(0.0254) }, "square-feet": { inBaseUnits: q(0.3048) }, "square-yards": { inBaseUnits: q(0.9144) }, "square-miles": { inBaseUnits: q(1609.344) }, "square-us-feet": { inBaseUnits: q(1200 / 3937) }, acres: { inBaseUnits: 15625e-7 * q(1609.344) }, ares: { inBaseUnits: 100 }, hectares: { inBaseUnits: 1e4 } } }, volume: { baseUnit: "liters", units: { liters: { inBaseUnits: 1 }, "cubic-millimeters": { inBaseUnits: 1e3 * k2(1e-3) }, "cubic-centimeters": { inBaseUnits: 1e3 * k2(0.01) }, "cubic-decimeters": { inBaseUnits: 1e3 * k2(0.1) }, "cubic-meters": { inBaseUnits: 1e3 }, "cubic-kilometers": { inBaseUnits: 1e3 * k2(1e3) }, "cubic-inches": { inBaseUnits: 1e3 * k2(0.0254) }, "cubic-feet": { inBaseUnits: 1e3 * k2(0.3048) }, "cubic-yards": { inBaseUnits: 1e3 * k2(0.9144) }, "cubic-miles": { inBaseUnits: 1e3 * k2(1609.344) } } }, angle: { baseUnit: "radians", units: { radians: { inBaseUnits: 1 }, degrees: { inBaseUnits: Math.PI / 180 } } } };
var p4 = (() => {
  const e2 = {};
  for (const s5 in b) for (const t3 in b[s5].units) e2[t3] = s5;
  return e2;
})();
function y2(e2, s5, t3) {
  return e2 * b[t3].units[s5].inBaseUnits;
}
function g3(e2, s5, t3) {
  return e2 / b[t3].units[s5].inBaseUnits;
}
var _2 = ["metric", "imperial", "inches", "feet", "yards", "miles", "nautical-miles", "us-feet", "meters", "kilometers"];
...
function E4(e2, s5 = null) {
  return s5 = s5 || D3(e2), b[s5].baseUnit === e2;
}
function I3(e2, s5, t3) {
  if (s5 === t3) return e2;
  const r4 = D3(s5);
  if (r4 !== D3(t3)) throw new Error("incompatible units");
  const n3 = E4(s5, r4) ? e2 : y2(e2, s5, r4);
  return E4(t3, r4) ? n3 : g3(n3, t3, r4);
}
function v(e2) {
  switch (e2) {
    case "metric":
...
function $(e2) {
  return z(e2) >= s4(e2).metersPerDegree ? "meters" : ee(e2);
}
function z(e2, s5 = t.metersPerDegree) {
  return Q(e2, true) ?? s5;
}
function Q(e2, s5 = false) {
  const t3 = (e2 == null ? void 0 : e2.wkid) ?? null, i4 = (e2 == null ? void 0 : e2.wkt2) ?? (e2 == null ? void 0 : e2.wkt) ?? null;
  let c3 = null;
  if (t3) {
    if (I(t3)) return e.metersPerDegree;
    if (p2(t3)) return s.metersPerDegree;
    c3 = U2.values[U2[t3]], !c3 && s5 && h2.has(t3) && (c3 = m2);
  } else i4 && (ie(i4) ? c3 = X(f3.exec(i4), c3) : ne(i4) && (c3 = X(d3.exec(i4), c3)));
  return c3;
}
function V(e2) {
  return P2(e2) ? 1 : z(e2);
...
function X(e2, s5) {
  return (e2 == null ? void 0 : e2[1]) ? Z(e2[1]) : s5;
}
function Z(e2) {
  return parseFloat(e2.split(",")[1]);
}
function ee(e2) {
  const s5 = (e2 == null ? void 0 : e2.wkid) ?? null, t3 = (e2 == null ? void 0 : e2.wkt2) ?? (e2 == null ? void 0 : e2.wkt) ?? null;
  let r4 = null;
  if (s5) r4 = U2.units[U2[s5]];
  else if (t3) {
    const e3 = ie(t3) ? f3 : ne(t3) ? d3 : null;
    if (e3) {
      const s6 = e3.exec(t3);
      (s6 == null ? void 0 : s6[1]) && (r4 = ue(s6[1]));
    }
  }
  return null != r4 ? Y(r4) : null;
}
function se(e2) {
  const s5 = ee(e2);
  return null != s5 && _2.includes(s5) ? s5 : null;
}
function te(e2) {
  const s5 = $(e2);
  return null != s5 && _2.includes(s5) ? s5 : null;
...
function ue(e2) {
  const s5 = /[\\"']{1}([^\\"']+)/.exec(e2);
  let t3 = s5 == null ? void 0 : s5[1];
  if (!t3 || !U2.units.includes(t3)) {
    const s6 = Z(e2);
    t3 = null;
    const r4 = U2.values;
    for (let e3 = 0; e3 < r4.length; ++e3) if (Math.abs(s6 - r4[e3]) < ae) {
      t3 = U2.units[e3];
      break;
    }
  }
...
//# sourceMappingURL=chunk-DRBJFCLQ.js.map
