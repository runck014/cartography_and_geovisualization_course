...
function f(r2, o3, u6, l, a6, p2) {
  ...
  if (!a6 && l.write.overridePolicy) {
    const e3 = l.write.overridePolicy.call(r2, f4, u6, p2 ?? void 0);
    void 0 !== e3 && (a6 = e3);
  }
  ...
  if (!a6.alwaysWriteDefaults && (!o3.store.multipleOriginsSupported || o3.store.originOf(u6) === e.DEFAULTS) && c2(r2, u6, p2, l, f4)) return false;
...
function g(r2, e3, t3, i2) {
  const o3 = t(r2), n4 = o3.metadata, s6 = a2(n4[e3], i2);
  return !!s6 && f(r2, o3, e3, s6, t3, i2);
}
function d(r2, e3, t3) {
  var _a, _b;
  if (r2 && "function" == typeof r2.toJSON && (!r2.toJSON.isDefaultToJSON || !r2.write)) return u(e3, r2.toJSON(t3));
  const n4 = t(r2), s6 = n4.metadata;
  for (const u6 in s6) {
    const c4 = a2(s6[u6], t3);
    if (!f(r2, n4, u6, c4, void 0, t3)) continue;
    const g2 = o(r2, u6), d3 = p(r2, c4, c4.write && "string" == typeof c4.write.target ? c4.write.target : u6, g2, t3);
...
var s4 = class _s {
  ...
  clone(e3) {
    const t3 = new _s();
    return this._values.forEach((s6, r2) => {
      e3 && e3.has(r2) || t3.set(r2, a(s6.value), s6.origin);
    }), t3;
  }
  get(i2, e3) {
    e3 = this._normalizeOrigin(e3);
    const s6 = this._values.get(i2);
    return null == e3 || (s6 == null ? void 0 : s6.origin) === e3 ? s6 == null ? void 0 : s6.value : void 0;
  }
  originOf(i2) {
    var _a;
  ...
  set(i2, s6, r2) {
    ...
    this._values.set(i2, new t2(s6, r2));
  }
  delete(i2, e3) {
    var _a;
  ...
  forEach(i2) {
    this._values.forEach(({ value: e3 }, s6) => i2(e3, s6));
  }
  _normalizeOrigin(i2) {
...
function f2(e3, t3, r2, n4, f4) {
  let a6 = s3(t3[r2], f4);
  i(a6) && (e3[r2] = true);
  for (const i2 of Object.getOwnPropertyNames(t3)) a6 = s3(t3[i2], f4), s5(a6, r2, n4) && (e3[i2] = true);
}
function a4(e3, t3, r2, o3) {
  const s6 = r2.metadata, i2 = o2(s6[t3], o3), f4 = i2 == null ? void 0 : i2.default;
  if (void 0 === f4) return;
  const a6 = "function" == typeof f4 ? f4.call(e3, t3, o3) : f4;
  void 0 !== a6 && r2.set(t3, a6);
}
var c3 = { origin: "service" };
function u4(t3, n4, s6 = c3) {
  ...
  for (const r2 of Object.getOwnPropertyNames(d3)) {
    const f4 = s3(u6[r2], s6).read, a6 = f4 == null ? void 0 : f4.source;
    let c4;
    c4 = a6 && "string" == typeof a6 ? u2(n4, a6) : n4[r2], (f4 == null ? void 0 : f4.reader) && (c4 = f4.reader.call(t3, c4, n4, s6)), void 0 !== c4 && i2.set(r2, c4);
  }
  if (!s6 || !s6.ignoreDefaults) {
    i2.setDefaultOrigin("defaults");
    for (const e3 of Object.getOwnPropertyNames(u6)) d3[e3] || a4(t3, e3, i2, s6);
  }
  i2.setDefaultOrigin("user");
}
function d2(e3, t3, r2, o3 = c3) {
  var _a;
...
var u5 = (t3) => {
  let u6 = class extends t3 {
    constructor(...r2) {
      super(...r2);
      const t4 = t(this), e3 = t4.store, i2 = new s4();
      t4.store = i2, e2(t4, e3, i2);
    }
    read(r2, t4) {
      u4(this, r2, t4);
    }
...
function a5(r2) {
  return r2 && "object" == typeof r2 && "toJSON" in r2 && "function" == typeof r2.toJSON;
}
var f3 = class extends u5(b) {
};
f3 = r([a3("esri.core.JSONSupport")], f3);
...
//# sourceMappingURL=chunk-VU6O6TFT.js.map
