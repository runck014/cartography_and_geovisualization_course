...
var Action = proxyCustomElement(class Action2 extends H {
  ...
  render() {
    ...
    const ariaLabel = labelFallback ? `${labelFallback}${indicator ? ` (${messages.indicator})` : ""}` : "";
    const buttonClasses = {
      [CSS.button]: true,
      [CSS.buttonTextVisible]: textEnabled,
      [CSS.buttonCompact]: compact
    };
    return h(Host, { key: "3b459307dcb6f8d373e70cd5c7a45d122565a70e" }, h(InteractiveContainer, { key: "3a81f1fb62a66f1dbd608f095ed90f2d47a9daf6", disabled }, h("button", { key: "bb5249babc116d462becd6b9a056ca0d368c6e09", "aria-busy": toAriaBoolean(loading), "aria-controls": indicator ? indicatorId : null, "aria-label": ariaLabel, "aria-pressed": toAriaBoolean(active), class: buttonClasses, disabled, id: buttonId, ref: (buttonEl) => this.buttonEl = buttonEl }, this.renderIconContainer(), this.renderTextContainer(), !icon && indicator && h("div", { class: CSS.indicatorWithoutIcon, key: "indicator-no-icon" })), h("slot", { key: "983989711d64076eca866c1928f9c777331fcba4", name: SLOTS.tooltip, onSlotchange: this.handleTooltipSlotChange }), this.renderIndicatorText()));
  }
...
@esri/calcite-components/dist/components/action.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ICHPE26O.js.map
