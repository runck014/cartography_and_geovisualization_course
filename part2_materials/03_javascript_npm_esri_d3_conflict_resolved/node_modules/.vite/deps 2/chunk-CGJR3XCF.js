...
var n11 = class {
  constructor(i5, n20) {
    this._rctx = i5, this._attributes = [{ name: "position", offset: 0, type: C.SHORT, count: 2 }], this.layout = { hash: r4(this._attributes), attributes: this._attributes, stride: 4 }, this._vertexBuffer = E2.createVertex(i5, F.STATIC_DRAW, new Uint16Array(n20)), this._vao = new o3(i5, /* @__PURE__ */ new Map([["a_position", 0]]), /* @__PURE__ */ new Map([["geometry", [new t2("a_position", 2, C.SHORT, 0, 4)]]]), /* @__PURE__ */ new Map([["geometry", this._vertexBuffer]])), this._count = n20.length / 2;
  }
  bind() {
...
var r8 = /* @__PURE__ */ new Map([["geometry", [new t2("a_pos", 2, C.BYTE, 0, 2)]]]);
var t6 = /* @__PURE__ */ new Map([["geometry", [new t2("a_pos", 2, C.BYTE, 0, 4), new t2("a_tex", 2, C.BYTE, 2, 4)]]]);
var n14 = /* @__PURE__ */ new Map([["geometry", [new t2("a_pos", 2, C.UNSIGNED_SHORT, 0, 4)]]]);
...
var r9 = class extends e8 {
  constructor(t12, e13, i5, r14, n20, o8, h3 = n20, l5 = o8) {
    super(), this.tileDebugInfoTexture = null, this.debugInfo = { display: { length: 0, minOrderedLength: 0, minUnorderedLength: 0, triangleCount: 0 }, memory: { bytesUsed: 0, bytesReserved: 0 } }, this._destroyed = false, this.key = new e2(t12), this.resolution = e13, this.x = i5, this.y = r14, this.width = n20, this.height = o8, this.rangeX = h3, this.rangeY = l5;
  }
  destroy() {
...
var d3 = class extends r9 {
  ...
  setTransform(o8) {
    ...
    const f6 = r3(n7(), c4, 0, 0, h3, n20, l5);
    e3(this.transforms.labelMat2d, o8.viewMat2d, f6);
  }
  _createTransforms() {
    return { labelMat2d: n7(), tileMat3: e5(), displayViewScreenMat3: e5() };
  }
...
function o7(e13) {
  if (!e13) return null;
  return { entities: n6(new t9(e13.entities), s4), vertexData: e13.data.map(a7) };
}
function a7(t12) {
...
var b2 = class extends d3 {
  constructor(e13, s11, i5, r14, o8 = false) {
    super(e13, s11, i5, r14), this._meshes = /* @__PURE__ */ new Map(), this._entities = [], this._invalidated = false, this._nextUploadAllowed = false, this.tileAge = g++, this._metrics = [], this._entityIds = /* @__PURE__ */ new Set(), this._entityIdsFromBuffer = /* @__PURE__ */ new Set(), this._attributeEpoch = 0, this._encounteredEnd = false, this._objectIdMap = null, this.visible = true, this.transforms.labelMat2d = n7(), this.enableDeferredUploads = o8;
  }
  destroy() {
  ...
  _onAppendMessage(e13) {
    ...
    const t12 = n6(new t9(e13.append.entities), s4);
  ...
  _onUpdateMessage(e13) {
    ...
    const t12 = n6(new t9(e13.modify.entities), s4), s11 = t12.map((e14) => e14.id), i5 = e13.isPixelBuffer ?? false, r14 = [...e13.remove, ...s11];
  ...
  _insertVertexData(e13) {
    ...
    for (const s11 of e13) {
      ...
      if (s11.metrics) {
        const e15 = n6(new t9(s11.metrics), r5) ?? [];
...
var f5 = class extends t3 {
  ...
  _drawFill(n20, f6, u6, c4, d7, p6, m3, y5, g4) {
    ...
    h3.setUniformMatrix3fv("u_displayMat3", p6 === r2.VIEWPORT ? E4.displayMat3 : E4.displayViewMat3), h3.setUniform2fv("u_fillTranslation", d7), h3.setUniform1f("u_depth", u6.z + s9);
    let w3 = -1;
    for (const t12 of c4) {
  ...
  _drawOutline(e13, i5, n20, a8, f6, u6) {
    ...
    c4.useProgram(I2), I2.setUniformMatrix3fv("u_displayMat3", u6 === r2.VIEWPORT ? p6.displayMat3 : p6.displayViewMat3), I2.setUniform2fv("u_fillTranslation", f6), I2.setUniform1f("u_depth", n20.z + s9), I2.setUniform1f("u_outline_width", P);
    let x2 = -1;
    for (const t12 of a8) {
...
var d6 = class extends t3 {
  ...
  _drawIcons(e13, t12, o8) {
    ...
    T3 === l.AUTO && (T3 = t12.getLayoutValue("symbol-placement", c4) === n5.POINT ? l.VIEWPORT : l.MAP);
  ...
  _drawText(e13, s11, f6) {
    ...
    w3 === l.AUTO && (w3 = s11.getLayoutValue("symbol-placement", u6) === n5.POINT ? l.VIEWPORT : l.MAP);
...
var g3 = ({ coords: e13, lengths: r14 }, n20) => {
  ...
  for (let s11 = 0, i5 = 0; s11 < r14.length; i5 += r14[s11], s11 += 1) {
    ...
    const f6 = e13.slice(2 * c4, 2 * (i5 + r14[s11])), m3 = e(f6, a8, 2);
...
var p5 = class _p {
  ...
  static fromPolygon(e13, r14) {
    ...
    for (let o8 = 0; o8 < h3.length; o8++) o2(u6, s11[2 * o8], s11[2 * o8 + 1]), e13.toScreen(l5, u6), h3[o8] = s5(Math.floor(l5[0]), Math.floor(l5[1]));
...
//# sourceMappingURL=chunk-CGJR3XCF.js.map
