...
function p(t2) {
  ...
  if (!b(t2)) {
    ...
    for (const e5 of Object.getOwnPropertyNames(t2)) {
      const r3 = t2[e5], o4 = p(r3);
      if (null != r3 && null == o4) return null;
      n5[e5] = o4;
    }
    return n5;
  }
...
function O(t2) {
  if (o(t2) || u(t2) || e(t2) || c2(t2) || i(t2) || a(t2) || f(t2) || s(t2) || m(t2)) return t2.slice();
...
function j(t2, n4) {
  return t2 === n4 || "number" == typeof t2 && isNaN(t2) && "number" == typeof n4 && isNaN(n4) || "function" == typeof (t2 == null ? void 0 : t2.getTime) && "function" == typeof (n4 == null ? void 0 : n4.getTime) && t2.getTime() === n4.getTime() || false;
}
function h(n4, e5) {
  return n4 === e5 || (null == n4 || "string" == typeof n4 ? n4 === e5 : "number" == typeof n4 ? n4 === e5 || "number" == typeof e5 && isNaN(n4) && isNaN(e5) : n4 instanceof Date ? e5 instanceof Date && n4.getTime() === e5.getTime() : Array.isArray(n4) ? Array.isArray(e5) && c(n4, e5) : n4 instanceof Set ? e5 instanceof Set && N(n4, e5) : n4 instanceof Map ? e5 instanceof Map && T(n4, e5) : !!g(n4) && (g(e5) && w(n4, e5)));
}
function w(t2, n4) {
...
function t(r3, n4) {
  if (null != n4) return n4[r3] || u2(r3.split("."), false, n4);
}
function e2(r3, n4, t2) {
  const e5 = r3.split("."), i5 = e5.pop(), f3 = u2(e5, true, t2);
  f3 && i5 && (f3[i5] = n4);
}
function i2(r3, n4) {
  ...
  if ("object" == typeof r3) {
    if (Array.isArray(r3)) {
      ...
      for (let n5 = 0; n5 < r3.length; n5++) if (i2(r3[n5], t2[n5])) return true;
      return false;
    }
    if (Object.keys(r3).length !== Object.keys(n4).length) return true;
    for (const t2 in r3) {
      if (i2(r3[t2], n4[t2])) return true;
    }
    return false;
  }
  return r3 !== n4;
}
function u2(r3, n4, t2) {
  let e5 = t2;
  for (const i5 of r3) {
    if (null == e5) return;
    if (!(i5 in e5)) {
...
function f2(n4, t2, e5) {
  return t2 ? Object.keys(t2).reduce((n5, i5) => {
    let u4 = n5[i5], l3 = t2[i5];
    return u4 === l3 ? n5 : void 0 === u4 ? (n5[i5] = a2(l3), n5) : (Array.isArray(l3) || Array.isArray(n5) ? (u4 = u4 ? Array.isArray(u4) ? n5[i5] = u4.slice() : n5[i5] = [u4] : n5[i5] = [], l3 && (Array.isArray(l3) || (l3 = [l3]), e5 ? l3.forEach((r3) => {
      u4.includes(r3) || u4.push(r3);
    }) : n5[i5] = l3.slice())) : l3 && "object" == typeof l3 ? n5[i5] = f2(u4, l3, e5) : n5.hasOwnProperty(i5) && !t2.hasOwnProperty(i5) || (n5[i5] = l3), n5);
  }, n4 || {}) : n4;
}

// node_modules/@arcgis/core/config.js
var _a;
var s2 = { apiKey: void 0, applicationName: "", applicationUrl: (_a = globalThis.location) == null ? void 0 : _a.href, assetsPath: "", fontsUrl: "https://static.arcgis.com/fonts", geometryServiceUrl: "https://utility.arcgisonline.com/arcgis/rest/services/Geometry/GeometryServer", geoRSSServiceUrl: "https://utility.arcgis.com/sharing/rss", kmlServiceUrl: "https://utility.arcgis.com/sharing/kml", userPrivilegesApplied: true, portalUrl: "https://www.arcgis.com", respectPrefersReducedMotion: true, routeServiceUrl: "https://route-api.arcgis.com/arcgis/rest/services/World/Route/NAServer/Route_World", workers: { loaderConfig: { has: {}, paths: {}, map: {}, packages: [] } }, request: { crossOriginNoCorsDomains: null, httpsDomains: ["arcgis.com", "arcgisonline.com", "esrikr.com", "premiumservices.blackbridge.com", "esripremium.accuweather.com", "gbm.digitalglobe.com", "firstlook.digitalglobe.com", "msi.digitalglobe.com"], interceptors: [], internalInterceptors: [], maxUrlLength: 2e3, priority: "high", proxyRules: [], proxyUrl: null, timeout: 62e3, trustedServers: [], useIdentity: true }, log: { interceptors: [], level: null } };
...
function r(r3, o4) {
  return o4 ? r3.replaceAll(e3, "object" == typeof o4 ? (e5, r4) => n2(t(r4, o4)) : (t2, e5) => n2(o4(e5))) : r3;
}
function o2(t2, e5) {
  return t2.replaceAll(/([.$?*|{}()[\]\\/+\-^])/g, (t3) => (e5 == null ? void 0 : e5.includes(t3)) ? t3 : `\\${t3}`);
}
function l2(t2) {
  let e5 = 0;
...
var n3 = class _n {
  constructor(e5) {
    this.level = null, this._module = "", this._parent = null, this.writer = null, this._loggedMessages = { error: /* @__PURE__ */ new Map(), warn: /* @__PURE__ */ new Map(), info: /* @__PURE__ */ new Map() }, null != e5.level && (this.level = e5.level), null != e5.writer && (this.writer = e5.writer), this._module = e5.module, _n._loggers.set(this.module, this);
  ...
  static getLogger(e5) {
    return e5 = "string" != typeof e5 ? e5.declaredClass : e5, _n._loggers.get(e5) || new _n({ module: e5 });
  }
  _log(t2, r3, ...i5) {
    if (!this._matchLevel(t2)) return;
    if ("always" !== r3 && !_n._throttlingDisabled) {
      const e5 = o3(i5), s5 = this._loggedMessages[t2].get(e5);
...
//# sourceMappingURL=chunk-PKLD5YJF.js.map
