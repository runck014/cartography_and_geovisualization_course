...
function r2(t2, r3, i2, a2 = new w()) {
  ...
  if ("2d" === i2.type) o2 = r3 * (i2.resolution ?? 0);
    ...
    o2 = null == a3 || a3.equals(i2.spatialReference) ? r3 * n2 : z(a3) / z(i2.spatialReference);
  }
  const s = t2.x - o2, l = t2.y - o2, m = t2.x + o2, p = t2.y + o2, { spatialReference: c } = i2;
...
//# sourceMappingURL=chunk-BURNMHZB.js.map
