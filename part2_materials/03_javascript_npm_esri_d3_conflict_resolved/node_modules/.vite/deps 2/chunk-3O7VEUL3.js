...
async function whenTransitionOrAnimationDone(targetEl, transitionPropOrAnimationName, type, onStart, onEnd) {
  ...
  const duration = allDurationsArray[propIndex] ?? /* Safari will have a single duration value for the shorthand prop when multiple, separate names/props are defined,
          so we fall back to it if there's no matching prop duration */
  allDurationsArray[0];
  function triggerFallbackStartEnd() {
    requestAnimationFrame(() => {
      onStart == null ? void 0 : onStart();
      requestAnimationFrame(() => onEnd == null ? void 0 : onEnd());
    });
  }
  if (duration === "0s") {
...
@esri/calcite-components/dist/components/dom.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-3O7VEUL3.js.map
