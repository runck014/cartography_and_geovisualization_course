...
function l(e2) {
  var _a, _b;
  const { mapExtent: t, floors: i5, width: o5, sublayers: l2, layerIds: m4, layerOption: p5, gdbVersion: f5 } = e2, y2 = (_b = (_a = l2 == null ? void 0 : l2.find((e3) => null != e3.layer)) == null ? void 0 : _a.layer) == null ? void 0 : _b.serviceSublayers, u3 = "popup" === p5, c2 = {}, d3 = i3({ extent: t, width: o5, spatialReference: t == null ? void 0 : t.spatialReference }), g2 = [], x = (e3) => {
  ...
  async _updateHighlightedFeaturesSymbols(e2) {
    ...
    if (r4 && s5) for (const i5 of e2) {
      ...
      i5.sourceLayer && "geometryType" in i5.sourceLayer && "point" === i5.sourceLayer.geometryType && e3 && "getSymbolAsync" in e3 && e3.getSymbolAsync(i5).then(async (o5) => {
        ...
        n6 && (G || (G = (await import("./visualVariableUtils-ERGCQWIK.js")).getSize), a5 = G(n6, i5, { view: t.type, scale: t.scale, shape: "simple-marker" === o5.type ? o5.style : null })), a5 || (a5 = "width" in o5 && "height" in o5 && null != o5.width && null != o5.height ? Math.max(o5.width, o5.height) : "size" in o5 ? o5.size : 16), r4.includes(i5) && (i5.symbol = new y({ style: "square", size: a5, xoffset: "xoffset" in o5 ? o5.xoffset : 0, yoffset: "yoffset" in o5 ? o5.yoffset : 0 }), s5(i5, "symbol"), i5.visible = true);
      });
    }
  }
...
function T(e2) {
  var _a;
  return ((_a = e2.expressionInfos) == null ? void 0 : _a.length) || Array.isArray(e2.content) && e2.content.some((e3) => "expression" === e3.type) ? i4() : Promise.resolve();
}
...
//# sourceMappingURL=chunk-27FUTNYZ.js.map
