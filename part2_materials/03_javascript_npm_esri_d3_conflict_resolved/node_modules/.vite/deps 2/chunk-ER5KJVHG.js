...
var T3 = class extends m2.LoadableMixin(n2(V2)) {
  ...
  async queryFeatures(e4, t5 = {}) {
    ...
    t3(e4, this.layer.spatialReference, r3);
    const s6 = d4.fromJSON(r3);
  ...
  async queryFeaturesJSON(e4, t5 = {}) {
    ...
    await this.load(t5);
    const r3 = await this._connection.invoke("queryFeatures", e4 ? e4.toJSON() : null, t5);
    return t3(e4, this.layer.spatialReference, r3), r3;
  }
...
r([n3({ Type: d3, ensureType: w(d3) })], T3.prototype, "itemType", void 0), r([m()], T3.prototype, "type", void 0), r([m({ constructOnly: true })], T3.prototype, "layer", void 0), r([m({ readOnly: true })], T3.prototype, "_workerGeometryType", null), r([m()], T3.prototype, "sourceJSON", void 0), T3 = r([a2("esri.layers.graphics.sources.MemorySource")], T3);
...
r([m()], e3.prototype, "updating", void 0), r([m()], e3.prototype, "status", void 0), e3 = r([a2("esri.layers.support.PublishingInfo")], e3);
var p7 = e3;
...
var n8 = (i6) => {
  ...
  return n9 = o4, r([m({ readOnly: true, clonable: false })], u3.prototype, "publishingInfo", null), u3 = r([a2("esri.layers.mixins.PublishableLayer")], u3), u3;
};
...
var Ke = class extends B(c2(c(n8(F(l(p2(l4(t2(f2(l3(b4(j(S(e2(i4(i2(f))))))))))))))))) {
  constructor(...e4) {
    super(...e4), this.attributeTableTemplate = null, this.charts = null, this.copyright = null, this.displayField = null, this.dynamicDataSource = null, this.fields = null, this.fieldsIndex = null, this.formTemplate = null, this.fullExtent = null, this.geometryType = null, this.hasM = void 0, this.hasZ = void 0, this.infoFor3D = null, this.isTable = false, this.labelsVisible = true, this.labelingInfo = null, this.legendEnabled = true, this.objectIdField = null, this.outFields = null, this.path = null, this.popupEnabled = true, this.popupTemplate = null, this.resourceInfo = null, this.screenSizePerspectiveEnabled = true, this.spatialReference = g.WGS84, this.subtypeCode = null, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Oriented Imagery Layer", "Table", "Catalog Layer"]), this.templates = null, this.timeInfo = null, this.title = null, this.sublayerTitleMode = "item-title", this.type = "feature", this.typeIdField = null, this.types = null, this.visible = true, this._debouncedSaveOperations = k(async (e5, t5, r3) => {
      const { save: i6, saveAs: o5 } = await import("./featureLayerUtils-3XKBGZCI.js");
      switch (e5) {
        case A.SAVE:
          return i6(this, t5);
        case A.SAVE_AS:
  ...
  load(e4) {
    ...
    const r3 = this.loadFromPortal({ supportedTypes: ["Feature Service", "Feature Collection", "Scene Service"] }, e4).catch(a3).then(async () => {
  ...
  readSource(e4, t5) {
    const r3 = d4.fromJSON(t5.featureSet);
  ...
  readTemplates(e4, t5) {
    ...
    return e4 = e4 == null ? void 0 : e4.map((e5) => p3.fromJSON(e5)), this._fixTemplates(e4, i6), this._fixTemplates(e4, o5), e4;
  }
  readTitle(e4, t5) {
    var _a, _b, _c;
  ...
  async addAttachment(e4, t5) {
    const r3 = await I3(this, e4, t5, We);
  ...
  async createGraphicsSource(e4) {
    ...
    const { default: t5 } = await h(import("./FeatureLayerSource-KTEMQICL.js"), e4);
  ...
  async deleteAttachments(e4, t5) {
    const r3 = await A2(this, e4, t5, We);
    return this.lastEditsEventDate = /* @__PURE__ */ new Date(), r3;
  }
  ...
  async queryTopFeatures(e4, t5) {
    ...
    const o5 = await import("./TopFeaturesQuery-HGNIMCY5.js"), s6 = await r3.queryTopFeatures(o5.default.from(e4), t5);
  ...
  async queryBins(e4, t5) {
    ...
    _(e4, i6, We);
    const o5 = await import("./BinsQuery-S44TLM7F.js"), s6 = await r3.queryBins(o5.default.from(e4), t5);
  ...
  async queryTopObjectIds(e4, t5) {
    ...
    const o5 = await import("./TopFeaturesQuery-HGNIMCY5.js");
...
r([m(T)], Ke.prototype, "attributeTableTemplate", void 0), r([o("service", "capabilities")], Ke.prototype, "readCapabilities", null), r([m({ json: { origins: { "web-scene": { write: false } }, write: true } })], Ke.prototype, "charts", void 0), r([m({ readOnly: true })], Ke.prototype, "createQueryVersion", null), r([m({ json: { read: { source: "layerDefinition.copyrightText" } } })], Ke.prototype, "copyright", void 0), r([m({ json: { read: { source: "layerDefinition.displayField" } } })], Ke.prototype, "displayField", void 0), r([m({ types: j2, readOnly: true })], Ke.prototype, "defaultSymbol", void 0), r([m({ type: K })], Ke.prototype, "dynamicDataSource", void 0), r([m({ type: Boolean })], Ke.prototype, "editingEnabled", null), r([o(["portal-item", "web-scene"], "editingEnabled", ["layerDefinition.capabilities"])], Ke.prototype, "readEditingEnabled", null), r([o("web-map", "editingEnabled", ["capabilities", "layerDefinition.capabilities"])], Ke.prototype, "readEditingEnabledFromWebMap", null), r([r2(["portal-item", "web-scene"], "editingEnabled", { "layerDefinition.capabilities": { type: String } })], Ke.prototype, "writeEditingEnabled", null), r([r2("web-map", "editingEnabled", { capabilities: { type: String }, "layerDefinition.capabilities": { type: String } })], Ke.prototype, "writeEditingEnabledToWebMap", null), r([m({ readOnly: true })], Ke.prototype, "effectiveEditingEnabled", null), r([m({ ...ke.fields, json: { read: { source: "layerDefinition.fields" }, origins: { service: { name: "fields" }, "web-map": { write: { target: "layerDefinition.fields", overridePolicy: ze } } } } })], Ke.prototype, "fields", void 0), r([m(ke.fieldsIndex)], Ke.prototype, "fieldsIndex", void 0), r([m({ type: V3, json: { name: "formInfo", write: true, origins: { "web-scene": { read: false, write: false } } } })], Ke.prototype, "formTemplate", void 0), r([m({ json: { read: { source: "layerDefinition.extent" } } })], Ke.prototype, "fullExtent", void 0), r([m({ json: { origins: { "web-map": { write: { target: "layerDefinition.geometryType", overridePolicy: ze, writer(e4, t5, r3) {
  const i6 = e4 ? g2.toJSON(e4) : null;
  i6 && e(r3, i6, t5);
} } } }, read: { source: "layerDefinition.geometryType", reader: g2.read } } })], Ke.prototype, "geometryType", void 0), r([m({ json: { read: { source: "layerDefinition.hasM" } } })], Ke.prototype, "hasM", void 0), r([m({ json: { read: { source: "layerDefinition.hasZ" } } })], Ke.prototype, "hasZ", void 0), r([m(u)], Ke.prototype, "id", void 0), r([m({ readOnly: true, json: { origins: { service: { read: true } }, read: false } })], Ke.prototype, "infoFor3D", void 0), r([m({ json: { origins: { "web-map": { write: { target: "layerDefinition.type" } } } } })], Ke.prototype, "isTable", void 0), r([o("service", "isTable", ["type", "geometryType"]), o("isTable", ["layerDefinition.type", "layerDefinition.geometryType"])], Ke.prototype, "readIsTable", null), r([r2("web-map", "isTable")], Ke.prototype, "writeIsTable", null), r([m(p)], Ke.prototype, "labelsVisible", void 0), r([m({ type: [C2], json: { origins: { service: { name: "drawingInfo.labelingInfo", read: n7, write: false }, "web-scene": { name: "layerDefinition.drawingInfo.labelingInfo", read: n7, write: { enabled: true, layerContainerTypes: a4 } } }, name: "layerDefinition.drawingInfo.labelingInfo", read: n7, write: true } })], Ke.prototype, "labelingInfo", void 0), r([m((() => {
  const e4 = a(b3);
  return e4.json.origins["portal-item"] = { write: { target: "layerDefinition.drawingInfo.transparency", writer(e5, t5, r3) {
    e(r3, n5(e5), t5);
  } } }, e4;
})())], Ke.prototype, "opacity", void 0), r([m(d2)], Ke.prototype, "legendEnabled", void 0), r([m({ type: ["show", "hide"], json: (() => {
  const e4 = a(I2.json);
  return e4.origins["portal-item"] = { read: false, write: false }, e4;
})() })], Ke.prototype, "listMode", void 0), r([o("globalIdField", ["layerDefinition.globalIdField", "layerDefinition.fields"])], Ke.prototype, "readGlobalIdField", null), r([m({ json: { origins: { "web-map": { write: { target: "layerDefinition.objectIdField", overridePolicy: ze } } } } })], Ke.prototype, "objectIdField", void 0), r([o("objectIdField", ["layerDefinition.objectIdField", "layerDefinition.fields"])], Ke.prototype, "readObjectIdField", null), r([m({ value: "ArcGISFeatureLayer", type: ["ArcGISFeatureLayer"] })], Ke.prototype, "operationalLayerType", void 0), r([m(ke.outFields)], Ke.prototype, "outFields", void 0), r([m({ readOnly: true })], Ke.prototype, "parsedUrl", null), r([m({ type: String, json: { origins: { "web-scene": { read: true, write: true } }, read: false } })], Ke.prototype, "path", void 0), r([m(l2)], Ke.prototype, "popupEnabled", void 0), r([m({ type: q, json: { name: "popupInfo", write: true } })], Ke.prototype, "popupTemplate", void 0), r([m({ readOnly: true })], Ke.prototype, "defaultPopupTemplate", null), r([m({ types: m4, json: { origins: { service: { write: { target: "drawingInfo.renderer", enabled: false } }, "web-scene": { types: u2, name: "layerDefinition.drawingInfo.renderer", write: { layerContainerTypes: a4, overridePolicy: (e4, t5, r3) => ({ ignoreOrigin: r3 == null ? void 0 : r3.writeLayerSchema }) } } }, write: { target: "layerDefinition.drawingInfo.renderer", overridePolicy: (e4, t5, r3) => ({ ignoreOrigin: r3 == null ? void 0 : r3.writeLayerSchema }) } } })], Ke.prototype, "renderer", null), r([o("service", "renderer", ["drawingInfo.renderer", "defaultSymbol"]), o("renderer", ["layerDefinition.drawingInfo.renderer", "layerDefinition.defaultSymbol"])], Ke.prototype, "readRenderer", null), r([m()], Ke.prototype, "resourceInfo", void 0), r([m((() => {
  const e4 = a(s4);
  return e4.json.origins["portal-item"] = { read: false, write: false }, e4;
})())], Ke.prototype, "screenSizePerspectiveEnabled", void 0), r([m({ clonable: false })], Ke.prototype, "source", null), r([s3("source")], Ke.prototype, "castSource", null), r([o("portal-item", "source", ["featureSet"]), o("web-map", "source", ["featureSet"])], Ke.prototype, "readSource", null), r([m({ json: { read: { source: "layerDefinition.extent.spatialReference" } } })], Ke.prototype, "spatialReference", void 0), r([m({ type: Number })], Ke.prototype, "subtypeCode", void 0), r([m({ type: [p3] })], Ke.prototype, "templates", void 0), r([o("templates", ["editFieldsInfo", "creatorField", "editorField", "templates"])], Ke.prototype, "readTemplates", null), r([m({ type: d5 })], Ke.prototype, "timeInfo", void 0), r([m()], Ke.prototype, "title", void 0), r([o("service", "title", ["name"]), o("portal-item", "title", ["layerDefinition.title", "layerDefinition.name", "title"])], Ke.prototype, "readTitle", null), r([o("web-map", "title", ["layerDefinition.name", "title"])], Ke.prototype, "readTitleFromWebMap", null), r([m({ type: String })], Ke.prototype, "sublayerTitleMode", void 0), r([m({ json: { read: false } })], Ke.prototype, "type", void 0), r([m({ type: String })], Ke.prototype, "typeIdField", void 0), r([o("service", "typeIdField"), o("typeIdField", ["layerDefinition.typeIdField"])], Ke.prototype, "readTypeIdField", null), r([m({ type: [n6] })], Ke.prototype, "types", void 0), r([o("service", "types", ["types"]), o("types", ["layerDefinition.types"])], Ke.prototype, "readTypes", null), r([m({ type: Boolean, json: { origins: { "portal-item": { write: { target: "layerDefinition.defaultVisibility" } } } } })], Ke.prototype, "visible", void 0), r([o("portal-item", "visible", ["visibility", "layerDefinition.defaultVisibility"])], Ke.prototype, "readVisible", null), Ke = r([a2("esri.layers.FeatureLayer")], Ke);
var Xe = Ke;

export {
  Xe
};
//# sourceMappingURL=chunk-ER5KJVHG.js.map
