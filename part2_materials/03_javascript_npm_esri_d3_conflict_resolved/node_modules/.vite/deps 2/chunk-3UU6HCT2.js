...
async function h4(t7, e9, i28) {
  ...
  const { width: a35, height: h7 } = t7, m17 = new Uint8Array(a35 * h7), { contains: l23, intersects: s12 } = await import("./geometryEngine-AJ7UTRKV.js");
...
var c9 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    if ("outside" === s12) try {
      const { spatialReference: e10 } = t7, s13 = "extent" === r12.type ? K(r12, e10) : D2(r12, e10).extent;
      s13 && m8(t7, s13);
    } catch {
    }
...
var u9 = i7 = class extends p4 {
  ...
  readColorRampName(o10, r12) {
    if (!o10) return null;
    const e9 = a3.jsonValues.find((r13) => r13.toLowerCase() === o10.toLowerCase());
...
r([m({ type: [[Number]], json: { write: true } })], u9.prototype, "colormap", void 0), r([m({ type: String, json: { write: true } })], u9.prototype, "colormapName", void 0), r([s2("colormapName")], u9.prototype, "castColormapName", null), r([m({ types: m2, json: { write: true } })], u9.prototype, "colorRamp", void 0), r([o("colorRamp")], u9.prototype, "readColorRamp", null), r([m({ type: a3.apiValues, json: { type: a3.jsonValues, write: a3.write } })], u9.prototype, "colorRampName", void 0), r([o("colorRampName")], u9.prototype, "readColorRampName", null), u9 = i7 = r([a2("esri.layers.support.rasterFunctions.ColormapFunctionArguments")], u9);
var d7 = u9;
...
function e5(t7, o10) {
  ...
  return w2({ type: "multipart", colorRamps: e9 }, { numColors: s12, weights: o10 = o10 ?? n21 });
}
function n8() {
...
var a17 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    const r12 = [...t7.colormap].sort((t8, o11) => t8[0] - o11[0]), { indexedColormap: e9, offset: s12 } = a4({ colormap: r12 });
...
var c22 = class extends p5 {
  ...
  _processPixels(t7) {
    ...
    const s12 = (_a = t7.pixelBlocks) == null ? void 0 : _a[0];
    if (!s12) return null;
    const { extent: e9, primaryPixelSizes: r12 } = t7, o10 = r12 == null ? void 0 : r12[0], i28 = o10 ?? (e9 ? { x: e9.width / s12.width, y: e9.height / s12.height } : { x: 1, y: 1 }), p21 = d3(this.functionArguments, i28, this.isGCS), a35 = r5(s12, p21);
    return a35.pixelType = this.outputPixelType, a35;
  }
  _getWebGLParameters() {
    const t7 = d3(this.functionArguments, { x: 1, y: 1 }, this.isGCS), s12 = a7(t7), { slopeType: e9, zFactor: o10, pixelSizeFactor: i28, pixelSizePower: u21 } = this.functionArguments, c36 = "scaled" === e9, l23 = o2(this.outputPixelType);
...
var c24 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    for (let a35 = 0; a35 < t7.bandCount; a35++) {
      const t8 = w3(e9, s12 == null ? void 0 : s12.slice(2 * a35, 2 * a35 + 2), o10 == null ? void 0 : o10[a35]);
      if (null == t8) {
        r12 = null;
        break;
      }
...
var c25 = a28 = class extends m12 {
  readColorRamp(o10) {
    if ("string" == typeof o10) {
      const r12 = a3.jsonValues.find((r13) => r13.toLowerCase() === o10.toLowerCase());
      return r12 ? d2(a3.fromJSON(r12)) : null;
    }
...
var h6 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    const { indexedColormap: o10, offset: n21 } = a4({ colormap: s12 });
    ...
    const p21 = D(o10);
    return this.lookup = { indexedColormap: o10, offset: n21, hsvMap: p21 }, { success: true, supportsGPU: a5(o10) };
  }
  _processPixels(e9) {
    var _a, _b, _c;
    const t7 = (_a = e9.pixelBlocks) == null ? void 0 : _a[0];
    ...
    const r12 = d3(this.functionArguments, s12, this.isGCS), o10 = r5(t7, r12), i28 = ((_c = this.sourceRasterInfos[0].statistics) == null ? void 0 : _c[0]) ?? { min: 0, max: 8e3 };
    return c2(o10, t7, this.lookup.hsvMap, i28), o10.pixelType = this.outputPixelType, o10;
  }
  _getWebGLParameters() {
    var _a;
    const e9 = d3(this.functionArguments, { x: 1, y: 1 }, this.isGCS), t7 = a7(e9), { slopeType: s12, zFactor: o10, pixelSizeFactor: i28, pixelSizePower: n21 } = this.functionArguments, a35 = "scaled" === s12, { indexedColormap: u21, offset: m17 } = this.lookup, d10 = (_a = this.sourceRasterInfos[0].statistics) == null ? void 0 : _a[0], f7 = o2(this.outputPixelType);
...
var c32 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    if (!r12 && ["u8", "u16", "s8", "s16"].includes(s12)) {
      ...
      this.lookup = a6({ pixelType: s12, ...r13, gamma: i28 ? u21 : null, rounding: p22 }), this.cutOffs = r13;
...
function c34(e9, r12, o10) {
  ...
  l23 = l23.map((r13) => a33(e9, r13, o10));
...
var u20 = l22 = class extends a32 {
  ...
  forwardTransform(e9) {
    if ("point" === e9.type) {
      const r12 = a33(this.forwardCoefficients, e9, this.polynomialOrder);
      return new j({ x: r12.x, y: r12.y, spatialReference: e9.spatialReference });
    }
    return c34(this.forwardCoefficients, e9, this.polynomialOrder);
  }
  inverseTransform(e9) {
    if ("point" === e9.type) {
      const r12 = a33(this.inverseCoefficients, e9, this.polynomialOrder);
      return new j({ x: r12.x, y: r12.y, spatialReference: e9.spatialReference });
    }
    return c34(this.inverseCoefficients, e9, this.polynomialOrder);
  }
  clone() {
...
var n20 = a34 = class extends a32 {
  ...
  clone() {
    return new a34({ tolerance: this.tolerance });
  }
};
r([r3({ GCSShiftXform: "gcs-shift" })], n20.prototype, "type", void 0), r([m()], n20.prototype, "tolerance", void 0), n20 = a34 = r([a2("esri.layers.support.rasterTransforms.GCSShiftTransform")], n20);
var c35 = n20;
...
//# sourceMappingURL=chunk-3UU6HCT2.js.map
