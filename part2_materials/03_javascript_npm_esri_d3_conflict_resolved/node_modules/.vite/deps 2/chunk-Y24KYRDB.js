...
var p6 = { types: { key: "type", base: t, typeMap: { selection: p3, cluster: v2, binning: w } }, json: { name: "layerDefinition.featureReduction", write: { allowNull: true }, origins: { "web-map": { types: o4 }, "portal-item": { types: o4 }, "web-scene": { types: { key: "type", base: t, typeMap: { selection: p3 } }, name: "layerDefinition.featureReduction", write: { layerContainerTypes: a4 } } } } };
...
function d2(r4, s2) {
  let i3 = s2.clone();
  if (!f2(i3)) return i3;
  if (s2.getSymbols().some((e2) => p7.has(e2.type)) && (i3 = new p2({ symbol: new y() })), i3.authoringInfo || (i3.authoringInfo = new j()), i3.authoringInfo.isAutoGenerated = true, "visualVariables" in i3) {
  ...
  let p8 = class extends c2 {
    ...
    _normalizeFeatureReduction(e2) {
      ...
      if (e2.symbol) {
        ...
        const n4 = d2(t2, this.renderer), o5 = this._withClusterVariable(n4, a7, u2), l4 = "visualVariables" in o5 && o5.visualVariables ? o5.visualVariables : [], c4 = new p2({ symbol: e2.symbol, visualVariables: l4 });
...
//# sourceMappingURL=chunk-Y24KYRDB.js.map
