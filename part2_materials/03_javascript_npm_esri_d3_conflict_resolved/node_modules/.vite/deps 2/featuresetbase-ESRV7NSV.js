import {
  ...
  k,
  q
} from "./chunk-7SEW7HZS.js";
import {
  O,
  u
} from "./chunk-QPKZXDIJ.js";
import "./chunk-IYIF3BRH.js";
import {
  D
} from "./chunk-MXN43UDR.js";
import {
  l
} from "./chunk-MTIXXCDD.js";
import {
  l as l2
  ...
  "async" === q2.mode && (q2.functions.timezone = function(t3, r2) {
    ...
    return q2.standardFunctionAsync(e2, n, (r2, s, l3) => {
      ...
      if (l3[0] instanceof t2) {
        ...
        let d2;
        return d2 = ((_a = e2.services) == null ? void 0 : _a.portal) ? e2.services.portal : b.getDefault(), d2 = l2(l3[0], d2), q(t3, r3, e2.spatialReference ?? null, s2, f3, d2, e2.lrucache, e2.interceptor);
      }
      ...
      return q(f2, d, e2.spatialReference ?? null, u2, c2, ((_b = e2.services) == null ? void 0 : _b.portal) ?? b.getDefault(), e2.lrucache, e2.interceptor);
    });
    ...
    return q2.standardFunctionAsync(e2, t3, async (n, r2, s) => {
      ...
      switch (f2) {
        ...
        case "container":
          B2 = `${b3}='${g}' AND ${$} = 2`, null !== F && (B2 += ` AND ${N3} = ` + F.toString()), q3.codefield = S2, B2 = "( " + B2 + " )", O3 = new b2(R.findField(y3.associations.fields, E3), H, H);
          break;
        case "content":
          B2 = `(${E3}='${g}' AND ${$} = 2)`, null !== F && (B2 += ` AND ${L2} = ` + F.toString()), q3.codefield = C, B2 = "( " + B2 + " )", O3 = new b2(R.findField(y3.associations.fields, b3), H, H);
          break;
        case "structure":
          B2 = `(${b3}='${g}' AND ${$} = 3)`, null !== F && (B2 += ` AND ${N3} = ` + F.toString()), q3.codefield = S2, B2 = "( " + B2 + " )", O3 = new b2(R.findField(y3.associations.fields, E3), H, G);
          break;
        case "attached":
          B2 = `(${E3}='${g}' AND ${$} = 3)`, null !== F && (B2 += ` AND ${L2} = ` + F.toString()), q3.codefield = C, B2 = "( " + B2 + " )", O3 = new b2(R.findField(y3.associations.fields, b3), H, G);
          break;
        default:
          throw new a(e2, r.InvalidParameter, t3);
      }
...
//# sourceMappingURL=featuresetbase-ESRV7NSV.js.map
