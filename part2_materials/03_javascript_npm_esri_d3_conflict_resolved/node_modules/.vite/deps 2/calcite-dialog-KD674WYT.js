...
(function(module, exports) {
  !function(t, e) {
    ...
    function y(t2) {
      return h2(t2) ? t2 : (t2.ownerDocument || t2).defaultView || g.window;
    }
        ...
        for (var e3, n3, r3, i3 = [], o3 = 0; o3 < t3.length; o3++) {
          ...
          if (a3 && o3 !== e3) if (s3) {
            ...
            if (c3 !== a3.ownerDocument) if (l3 !== a3.ownerDocument) if (c3 !== l3) {
              ...
              if (d3[0]) for (var h4 = d3[0].lastChild; h4; ) {
                if (h4 === d3[1]) {
                  e3 = o3, i3 = p3;
                  break;
                }
    ...
    var Ot = { id: "actions/drop", install: function(t2) {
      ...
      t2.usePlugin(_), r2.prototype.dropzone = function(t3) {
        ...
        return function(t4, e4, n4, r4, i4, o3, a2) {
          ...
          if (d2 && "center" === c2) {
            var h3 = d2.left + d2.width / 2, v2 = d2.top + d2.height / 2;
            s2 = h3 >= a2.left && h3 <= a2.right && v2 >= a2.top && v2 <= a2.bottom;
          }
          if (d2 && w.number(c2)) {
    ...
    function ee(t2, e2, n2, r2) {
      ...
      for (var p2 = 0, f2 = r2.interactions.list; p2 < f2.length; p2++) {
        var d2 = f2[p2], h3 = d2.prepared.name;
        if (d2.interacting()) {
          if (++c2 >= s2) return false;
          if (d2.interactable === t2) {
            if ((l2 += h3 === n2.name ? 1 : 0) >= o2) return false;
            if (d2.element === e2 && (u2++, h3 === n2.name && u2 >= a2)) return false;
          }
        }
      }
      return s2 > 0;
    ...
    var me = function() {
      ...
      return o(t2, [{ key: "start", value: function(t3, e2) {
        ...
        for (var a2 = r2 ? this.states.slice(r2) : this.states, s2 = ye(t3.coords, t3.rect), c2 = 0; c2 < a2.length; c2++) {
          ...
          null != (l2 = u2.methods) && l2.set && this.shouldDo(p2, n2, e2) && (t3.state = u2, d2 = u2.methods.set(t3), H2(t3.edges, t3.rect, { x: t3.coords.x - f2.x, y: t3.coords.y - f2.y })), s2.eventProps.push(d2);
        }
        ...
        var d2 = this.result.rectDelta, h3 = t3.rect || e2.rect;
        h3.left += d2.left, h3.right += d2.right, h3.top += d2.top, h3.bottom += d2.bottom, h3.width = h3.right - h3.left, h3.height = h3.bottom - h3.top;
    ...
    var we = { id: "modifiers/base", before: ["actions"], install: function(t2) {
      ...
      function n2(t3, i2, o2, a2, s2, c2, l2) {
        ...
        var f2 = t3.interactable, d2 = (f2 && f2.options || Te).deltaSource, h3 = K(f2, s2, o2), v2 = "start" === a2, g2 = "end" === a2, m2 = v2 ? u(p2) : t3.prevEvent, y2 = v2 ? t3.coords.start : g2 ? { page: m2.page, client: m2.client, timeStamp: t3.coords.cur.timeStamp } : t3.coords.cur;
        return p2.page = V({}, y2.page), p2.client = V({}, y2.client), p2.rect = V({}, t3.rect), p2.timeStamp = y2.timeStamp, g2 || (p2.page.x -= h3.x, p2.page.y -= h3.y, p2.client.x -= h3.x, p2.client.y -= h3.y), p2.ctrlKey = i2.ctrlKey, p2.altKey = i2.altKey, p2.shiftKey = i2.shiftKey, p2.metaKey = i2.metaKey, p2.button = i2.button, p2.buttons = i2.buttons, p2.target = s2, p2.currentTarget = s2, p2.preEnd = c2, p2.type = l2 || o2 + (a2 || ""), p2.interactable = f2, p2.t0 = v2 ? t3.pointers[t3.pointers.length - 1].downTime : m2.t0, p2.x0 = t3.coords.start.page.x - h3.x, p2.y0 = t3.coords.start.page.y - h3.y, p2.clientX0 = t3.coords.start.client.x - h3.x, p2.clientY0 = t3.coords.start.client.y - h3.y, p2.delta = v2 || g2 ? { x: 0, y: 0 } : { x: p2[d2].x - m2[d2].x, y: p2[d2].y - m2[d2].y }, p2.dt = t3.coords.delta.timeStamp, p2.duration = p2.timeStamp - p2.t0, p2.velocity = V({}, t3.coords.velocity[d2]), p2.speed = Q(p2.velocity.x, p2.velocity.y), p2.swipe = g2 || "inertiastart" === a2 ? p2.getSwipe() : null, p2;
      }
    ...
    var _e = o(function t2(e2, n2, i2, o2, a2) {
      ...
      return o(t2, [{ key: "pointerMoveTolerance", get: function() {
        ...
        if (o2 && "move" === n2 && (H2(this.edges, o2, this.coords.delta[this.interactable.options.deltaSource]), o2.width = o2.right - o2.left, o2.height = o2.bottom - o2.top), false === this._scopeFire("interactions:before-action-".concat(n2), t3)) return false;
    ...
    function Me(t2) {
      ...
      return Ae(t2.coords.cur, e2), Ae(t2.coords.delta, e2), H2(t2.edges, t2.rect, e2), e2.x = 0, e2.y = 0, true;
    }
    function ze(t2) {
      var e2 = t2.x, n2 = t2.y;
    ...
    var Ue = { id: "events", install: function(t2) {
      var e2, n2 = [], r2 = {}, i2 = [], o2 = { add: a2, remove: s2, addDelegate: function(t3, e3, n3, o3, s3) {
        ...
        var d2 = r2[n3], h3 = bt(d2, function(n4) {
          return n4.selector === t3 && n4.context === e3;
        });
        h3 || (h3 = { selector: t3, context: e3, listeners: [] }, d2.push(h3));
        ...
        for (a3 = p2.length - 1; a3 >= 0; a3--) {
          ...
          if (d2.selector === t3 && d2.context === e3) {
            for (var h3 = d2.listeners, v2 = h3.length - 1; v2 >= 0; v2--) {
              var g2 = h3[v2];
              if (g2.func === i3 && Ne(g2.options, u2)) {
                h3.splice(v2, 1), h3.length || (p2.splice(a3, 1), s2(e3, n3, c2), s2(e3, n3, l2, true)), f2 = true;
                break;
              }
            }
            if (f2) break;
        ...
        if (t3.addEventListener && t3.removeEventListener) {
          ...
          if (c3 && c3.events) if ("all" !== e3) {
            ...
            if (u2) {
              ...
              for (var d2 = Ge(i3), h3 = 0; h3 < u2.length; h3++) {
                var v2 = u2[h3];
                if (v2.func === r3 && Ne(v2.options, d2)) {
                  t3.removeEventListener(e3, r3, o2.supportsOptions ? d2 : d2.capture), u2.splice(h3, 1), 0 === u2.length && (delete c3.events[e3], l3 = true);
                  break;
                }
              }
            }
      ...
      return function(n2) {
        ...
        if (/^touch/.test(n2.type)) {
          ...
          if (!I.supportsPointerEvent && /mouse/.test(n2.type)) {
            for (var v2 = 0; v2 < r2.length && !h3; v2++) h3 = "mouse" !== r2[v2].pointerType && r2[v2].pointerIsDown;
            h3 = h3 || e2.now() - e2.prevTouchTime < 500 || 0 === n2.timeStamp;
          }
          if (!h3) {
    ...
    var fn = Object.freeze({ __proto__: null, edgeTarget: function() {
      ...
      var e2 = [["x", "y"], ["left", "top"], ["right", "bottom"], ["width", "height"]].filter(function(e3) {
        ...
        for (var i2 = t2.range, o2 = t2.limits, a2 = void 0 === o2 ? { left: -1 / 0, right: 1 / 0, top: -1 / 0, bottom: 1 / 0 } : o2, s2 = t2.offset, c2 = void 0 === s2 ? { x: 0, y: 0 } : s2, l2 = { range: i2, grid: t2, x: null, y: null }, u2 = 0; u2 < e2.length; u2++) {
          var p2 = e2[u2], f2 = p2[0], d2 = p2[1], h3 = Math.round((n3 - c2.x) / t2[f2]), v2 = Math.round((r2 - c2.y) / t2[d2]);
          l2[f2] = Math.max(a2.left, Math.min(a2.right, h3 * t2[f2] + c2.x)), l2[d2] = Math.max(a2.top, Math.min(a2.bottom, v2 * t2[d2] + c2.y));
        }
        return l2;
      };
      ...
      if (false !== c2 && V(i2, f2), null != p2 && p2.length) {
        var h3 = new me(t2.interaction);
        h3.copyFrom(t2.interaction.modification), h3.prepareStates(p2), n2.subModification = h3, h3.startAll(e({}, t2));
      }
    }, set: function(t2) {
      ...
      var c2 = V({}, r2);
      H2(o2, c2, { x: i2.x - a2.x, y: i2.y - a2.y });
    ...
    var Rn = { start: function(t2) {
      ...
      for (var l2 = 0, u2 = o2; l2 < u2.length; l2++) for (var p2 = u2[l2], f2 = s2.x - p2.x, d2 = s2.y - p2.y, h3 = 0, v2 = i2.targets.length; h3 < v2; h3++) {
        var g2 = i2.targets[h3], m2 = void 0;
        (m2 = w.func(g2) ? g2(f2, d2, e2._proxy, p2, h3) : g2) && c2.push({ x: (w.number(m2.x) ? m2.x : f2) + p2.x, y: (w.number(m2.y) ? m2.y : d2) + p2.y, range: w.number(m2.range) ? m2.range : i2.range, source: g2, index: h3, offset: p2 });
      }
      ...
      for (var s2 = 0, c2 = i2.targets || []; s2 < c2.length; s2++) {
        ...
        if (u2 = w.func(l2) ? l2(a2.x, a2.y, e2) : l2) {
          for (var p2 = 0, f2 = n2.targetFields; p2 < f2.length; p2++) {
            var d2 = f2[p2], h3 = d2[0], v2 = d2[1];
            if (h3 in u2 || v2 in u2) {
              u2.x = u2[h3], u2.y = u2[v2];
              break;
            }
          }
    ...
    var Xn = { aspectRatio: yn, restrictEdges: kn, restrict: Tn, restrictRect: In, restrictSize: An, snapEdges: be({ start: function(t2) {
      ...
      !function(t3, e3) {
        ...
        for (var f2 = 1 / 0, d2 = 0, h3 = l2.targets; d2 < h3.length; d2++) {
          var v2 = h3[d2].eventable.options.holdDuration;
          v2 < f2 && (f2 = v2);
        }
    ...
    function Vn(t2, e2) {
      ...
      for (var u2 = { interaction: n2, pointer: r2, event: i2, eventTarget: o2, targets: c2, type: a2, pointerEvent: l2 }, p2 = 0; p2 < c2.length; p2++) {
        ...
        var h3 = K(f2.eventable, f2.node);
        if (l2._subtractOrigin(h3), l2.eventable = f2.eventable, l2.currentTarget = f2.node, f2.eventable.fire(l2), l2._addOrigin(h3), l2.immediatePropagationStopped || l2.propagationStopped && p2 + 1 < c2.length && c2[p2 + 1].node !== l2.currentTarget) break;
      }
...
var Dialog = proxyCustomElement(class Dialog2 extends H {
  ...
  render() {
    ...
    } }, this.modal ? h("calcite-scrim", { class: CSS.scrim, onClick: this.handleOutsideClose }) : null, h("div", { key: "be47093e3a955ce45a71c555700143a4a1c7a166", "aria-description": description, "aria-label": heading, "aria-modal": toAriaBoolean(this.modal), class: CSS.dialog, onKeyDown: this.handleKeyDown, ref: this.setTransitionEl, role: "dialog" }, assistiveText ? h("div", { "aria-live": "polite", class: CSS.assistiveText, key: "assistive-text" }, assistiveText) : null, h("slot", { key: "6ed9f10ae7d5ecc1ec9062d6aba559001d5194e6", name: SLOTS2.content }, h("calcite-panel", { key: "cd6ebaa7d7362cbeb70e9ae623f38298d1e831e3", beforeClose: this.beforeClose, class: CSS.panel, closable: !this.closeDisabled, closed: !opened, description, heading, headingLevel: this.headingLevel, loading: this.loading, menuOpen: this.menuOpen, messageOverrides: this.messageOverrides, onCalcitePanelClose: this.handleInternalPanelCloseClick, onCalcitePanelScroll: this.handleInternalPanelScroll, onKeyDown: this.handlePanelKeyDown, overlayPositioning: this.overlayPositioning, ref: (el) => this.panelEl = el, scale: this.scale }, h("slot", { key: "2ce955775c33b09fc849a083d0bcc1c8ce523dd8", name: SLOTS2.actionBar, slot: SLOTS.actionBar }), h("slot", { key: "dd44184de251320af6225baa2e59571b881a23cd", name: SLOTS2.alerts, slot: SLOTS.alerts }), h("slot", { key: "da343a1a10e015b04b37463c10592e612a576e9b", name: SLOTS2.headerActionsStart, slot: SLOTS.headerActionsStart }), h("slot", { key: "6680fde2bd7ad6dc5803c78ea7250d11d4920b7c", name: SLOTS2.headerActionsEnd, slot: SLOTS.headerActionsEnd }), h("slot", { key: "a17ca64188ffe6000792e67eafc838df575ebbc3", name: SLOTS2.headerContent, slot: SLOTS.headerContent }), h("slot", { key: "7e048c4a9104053ca0a61ab2514b018efb4fc872", name: SLOTS2.headerMenuActions, slot: SLOTS.headerMenuActions }), h("slot", { key: "6760c8a6c105a511fcb859cfd222f8c1355a82c4", name: SLOTS2.fab, slot: SLOTS.fab }), h("slot", { key: "e0f2e7644281d408d8c21ce5bf16b08af0a59c3b", name: SLOTS2.contentTop, slot: SLOTS.contentTop }), h("slot", { key: "01889c3b7fc13bc49521c27feb2ab35346552504", name: SLOTS2.contentBottom, slot: SLOTS.contentBottom }), h("slot", { key: "593bad35110b5d7e7b44d598b397e4b87cc28e28", name: SLOTS2.footerStart, slot: SLOTS.footerStart }), h("slot", { key: "5e84099e096a6afb678cce9731b189f4011dc067", name: SLOTS2.footer, slot: SLOTS.footer }), h("slot", { key: "69a805bd0c1f43a6d165939e62db562428f39f11", name: SLOTS2.footerEnd, slot: SLOTS.footerEnd }), h("slot", { key: "b49e14ff6d2c63caaa8fd296920618e7673eb71b" }))))));
  }
  ...
  async setFocus() {
    ...
    return ((_a = this.panelEl) == null ? void 0 : _a.setFocus()) ?? focusFirstTabbable(this.el);
  }
  /**
  ...
  async scrollContentTo(options) {
    var _a;
    await ((_a = this.panelEl) == null ? void 0 : _a.scrollContentTo(options));
  }
  //--------------------------------------------------------------------------
  //
  //  Private Methods
      ...
      this.interaction.resizable({
        ...
        modifiers: [
          interact.modifiers.restrictSize({
            ...
            max: {
              width: this.isPixelValue(maxInlineSize) ? parseInt(maxInlineSize, 10) : window.innerWidth,
              height: this.isPixelValue(maxBlockSize) ? parseInt(maxBlockSize, 10) : window.innerHeight
            }
          }),
...
@esri/calcite-components/dist/components/calcite-dialog.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-dialog-KD674WYT.js.map
