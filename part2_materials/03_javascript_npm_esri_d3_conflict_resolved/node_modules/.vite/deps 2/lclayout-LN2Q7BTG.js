...
function n() {
  ...
  return e || (e = 1, r = t, n2 = "undefined" != typeof document ? (_a = document.currentScript) == null ? void 0 : _a.src : void 0, a2 = function(r2 = {}) {
    ...
    function q() {
      var r3 = N();
      function e3(r4, e4) {
        return st = r4.exports, d = st.M, T(), kr = st.P, $(st.N), x(), st;
      }
      function n3(r4) {
        e3(r4.instance);
      }
    ...
    function xr(r3, e3, t3, n3, a4, o4) {
      var i2 = e3.length;
      i2 < 2 && fr("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var u2 = null !== e3[1] && null !== t3, s2 = Rr(e3), l2 = "void" !== e3[0].name, c2 = i2 - 2, f2 = new Array(c2), d2 = [], h2 = [];
      return Sr(r3, function(...t4) {
        var o5;
        t4.length !== c2 && fr(`function ${r3} called with ${t4.length} arguments, expected ${c2}`), h2.length = 0, d2.length = u2 ? 2 : 1, d2[0] = a4, u2 && (o5 = e3[1].toWireType(h2, this), d2[1] = o5);
        for (var i3 = 0; i3 < c2; ++i3) f2[i3] = e3[i3 + 2].toWireType(h2, t4[i3]), d2.push(f2[i3]);
        function m2(r4) {
          if (s2) K(h2);
          else for (var t5 = u2 ? 1 : 2; t5 < e3.length; t5++) {
            var n4 = 1 === t5 ? o5 : f2[t5 - 2];
            null !== e3[t5].destructorFunction && e3[t5].destructorFunction(n4);
          }
          if (l2) return e3[0].fromWireType(r4);
        }
        return m2(n3(...d2));
      });
    }
    var kr, Hr, Ir, Vr = (r3, e3) => {
      ...
      hr(r3, { name: e3, fromWireType(r4) {
        ...
        var o4 = ct(4 + n3 + 1), i2 = o4 + 4;
        if (w[o4 >> 2] = n3, t3 && a4) ne(e4, i2, n3 + 1);
        else if (a4) for (var u2 = 0; u2 < n3; ++u2) {
          var s2 = e4.charCodeAt(u2);
          s2 > 255 && (ft(i2), fr("String has UTF-16 code units that do not fit in 8 bits")), v[i2 + u2] = s2;
        }
        else for (u2 = 0; u2 < n3; ++u2) v[i2 + u2] = e4[u2];
        return null !== r4 && r4.push(ft, o4), o4;
      ...
      t3 = cr(t3), 2 === e3 ? (n3 = ce, a4 = fe, i2 = de, o4 = (r4) => y[r4 >> 1]) : 4 === e3 && (n3 = he, a4 = me, i2 = ve, o4 = (r4) => w[r4 >> 2]), hr(r3, { name: t3, fromWireType: (r4) => {
        ...
        var o5 = i2(n4), u2 = ct(4 + o5 + e3);
        return w[u2 >> 2] = o5 / e3, a4(n4, u2 + 4, o5 + e3), null !== r4 && r4.push(ft, u2), u2;
      }, argPackAdvance: mr, readValueFromPointer: Q, destructorFunction(r4) {
        ft(r4);
      } });
    ...
    }, Ce = (r3, e3, t3) => (r3 = Ar.toValue(r3), e3 = $r(e3, "emval::as"), Te(e3, t3, r3)), Fe = {}, Pe = (r3) => {
      var e3 = Fe[r3];
      return void 0 === e3 ? cr(r3) : e3;
    }, We = [], Ee = (r3, e3, t3, n3, a4) => (r3 = We[r3])(e3 = Ar.toValue(e3), e3[t3 = Pe(t3)], n3, a4), Se = (r3) => {
      var e3 = We.length;
      return We.push(r3), e3;
    }, Oe = (r3, e3) => {
      for (var t3 = new Array(r3), n3 = 0; n3 < r3; ++n3) t3[n3] = $r(w[e3 + 4 * n3 >> 2], "parameter " + n3);
      return t3;
    }, $e = Reflect.construct, je = (r3, e3, t3) => {
      var n3 = Oe(r3, e3), a4 = n3.shift();
      r3--;
      var o4 = new Array(r3), i2 = (e4, i3, u3, s2) => {
        ...
        var f2 = 1 === t3 ? $e(i3, o4) : i3.apply(e4, o4);
        return Te(a4, u3, f2);
      }, u2 = `methodCaller<(${n3.map((r4) => r4.name).join(", ")}) => ${a4.name}>`;
      return Se(Sr(u2, i2));
    }, Me = (r3, e3) => (r3 = Ar.toValue(r3), e3 = Ar.toValue(e3), Ar.toHandle(r3[e3])), De = () => Ar.toHandle([]), Re = (r3) => {
      r3 = Ar.toValue(r3);
      for (var e3 = new Array(r3.length), t3 = 0; t3 < r3.length; t3++) e3[t3] = r3[t3];
      return Ar.toHandle(e3);
    }, xe = (r3) => Ar.toHandle(Pe(r3)), ke = (r3) => {
      var e3 = Ar.toValue(r3);
      K(e3), wr(r3);
    }, He = (r3, e3) => {
    ...
    var Be = (r3) => {
      ...
      for (var n3 = (r4, e4) => r4 + (e4 - r4 % e4) % e4, a4 = 1; a4 <= 4; a4 *= 2) {
        ...
        if (Be(i2)) return true;
      }
      return false;
    }, Ne = {}, qe = () => s || "./this.program", Ge = () => {
      if (!Ge.strings) {
        var r3 = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: ("object" == typeof navigator && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: qe() };
        for (var e3 in Ne) void 0 === Ne[e3] ? delete r3[e3] : r3[e3] = Ne[e3];
        var t3 = [];
      ...
      var t3 = 0;
      return Ge().forEach((n3, a4) => {
        var o4 = e3 + t3;
        w[r3 + 4 * a4 >> 2] = o4, Je(n3, o4), t3 += n3.length + 1;
      }), 0;
    }, Xe = (r3, e3) => {
      var t3 = Ge();
      w[r3 >> 2] = t3.length;
    ...
    }, Ke = (r3) => r3 % 4 == 0 && (r3 % 100 != 0 || r3 % 400 == 0), Qe = (r3, e3) => {
      for (var t3 = 0, n3 = 0; n3 <= e3; t3 += r3[n3++]) ;
      return t3;
    }, Ze = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], rt = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], et = (r3, e3) => {
      for (var t3 = new Date(r3.getTime()); e3 > 0; ) {
        var n3 = Ke(t3.getFullYear()), a4 = t3.getMonth(), o4 = (n3 ? Ze : rt)[a4];
    ...
    var nt = (r3, e3) => {
      ...
      function v2(r4) {
        var e4 = et(new Date(r4.tm_year + 1900, 0, 1), r4.tm_yday), t4 = new Date(e4.getFullYear(), 0, 4), n4 = new Date(e4.getFullYear() + 1, 0, 4), a5 = m2(t4), o5 = m2(n4);
      ...
      var p2 = { "%a": (r4) => l2[r4.tm_wday].substring(0, 3), "%A": (r4) => l2[r4.tm_wday], "%b": (r4) => c2[r4.tm_mon].substring(0, 3), "%B": (r4) => c2[r4.tm_mon], "%C": (r4) => d2((r4.tm_year + 1900) / 100 | 0, 2), "%d": (r4) => d2(r4.tm_mday, 2), "%e": (r4) => f2(r4.tm_mday, 2, " "), "%g": (r4) => v2(r4).toString().substring(2), "%G": v2, "%H": (r4) => d2(r4.tm_hour, 2), "%I": (r4) => {
      ...
      }, "%j": (r4) => d2(r4.tm_mday + Qe(Ke(r4.tm_year + 1900) ? Ze : rt, r4.tm_mon - 1), 3), "%m": (r4) => d2(r4.tm_mon + 1, 2), "%M": (r4) => d2(r4.tm_min, 2), "%n": () => "\n", "%p": (r4) => r4.tm_hour >= 0 && r4.tm_hour < 12 ? "AM" : "PM", "%S": (r4) => d2(r4.tm_sec, 2), "%t": () => "	", "%u": (r4) => r4.tm_wday || 7, "%U": (r4) => {
        ...
        if ((r4.tm_wday + 371 - r4.tm_yday - 2) % 7 <= 2 && e4++, e4) {
          if (53 == e4) {
            ...
            4 == t4 || 3 == t4 && Ke(r4.tm_year) || (e4 = 1);
          }
        } else {
          e4 = 52;
          var n4 = (r4.tm_wday + 7 - r4.tm_yday - 1) % 7;
          (4 == n4 || 5 == n4 && Ke(r4.tm_year % 400 - 1)) && e4++;
        }
        return d2(e4, 2);
      ...
      var y2 = tt(i2 = i2.replace(/\0\0/g, "%"));
      return y2.length > e3 ? 0 : (nt(y2, r3), y2.length - 1);
    }, ot = (r3, e3, t3, n3, a4) => at(r3, e3, t3, n3);
    ...
    var it, ut = { a: L, j: ur, x: sr, F: vr, u: pr, w: Cr, v: Er, q: jr, t: Dr, e: Kr, l: Zr, f: re, L: ee, s: se, r: pe, k: ye, b: ge, K: we, D: be, I: Ae, g: Ce, n: Ee, c: wr, o: je, h: Me, p: De, J: Re, m: xe, d: ke, i: He, C: Ie, E: Ve, y: Ye, H: Ir, G: ze, A: Le, B: Xe, z: ot }, st = q(), lt = (r3) => (lt = st.O)(r3), ct = a3._malloc = (r3) => (ct = a3._malloc = st.Q)(r3), ft = a3._free = (r3) => (ft = a3._free = st.R)(r3), dt = (r3) => (dt = st.S)(r3);
    function ht() {
      function r3() {
        it || (it = true, a3.calledRun = true, A || (E(), e2(a3), a3.onRuntimeInitialized && a3.onRuntimeInitialized(), S()));
      }
    ...
    if (a3.dynCall_viijii = (r3, e3, t3, n3, o4, i2, u2) => (a3.dynCall_viijii = st.T)(r3, e3, t3, n3, o4, i2, u2), a3.dynCall_iiiiij = (r3, e3, t3, n3, o4, i2, u2) => (a3.dynCall_iiiiij = st.U)(r3, e3, t3, n3, o4, i2, u2), a3.dynCall_iiiiijj = (r3, e3, t3, n3, o4, i2, u2, s2, l2) => (a3.dynCall_iiiiijj = st.V)(r3, e3, t3, n3, o4, i2, u2, s2, l2), a3.dynCall_iiiiiijj = (r3, e3, t3, n3, o4, i2, u2, s2, l2, c2) => (a3.dynCall_iiiiiijj = st.W)(r3, e3, t3, n3, o4, i2, u2, s2, l2, c2), D = function r3() {
      it || ht(), it || (D = r3);
...
//# sourceMappingURL=lclayout-LN2Q7BTG.js.map
