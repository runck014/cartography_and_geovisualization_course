import {
  ...
  m as m3,
  y
} from "./chunk-6GD5IU2W.js";
import {
  F
} from "./chunk-XQ3CVA7I.js";
import {
  o as o2
...
var C = S = class extends u2(m2) {
  ...
  async queryElevation(r6, e3) {
    ...
    const { ElevationQuery: o3 } = await import("./ElevationQuery-GZW4IQBS.js");
    s2(e3);
  ...
  async _loadLayersFromJSON(r6, e3, o3) {
    const t4 = (e3 == null ? void 0 : e3.origin) || "web-scene", s5 = (e3 == null ? void 0 : e3.portal) || null, a5 = (e3 == null ? void 0 : e3.url) || null, { populateOperationalLayers: i2 } = await import("./layersCreator-4QWZWPER.js");
    s2(o3);
    const n7 = [];
...
r([m({ json: { read: false } })], C.prototype, "layers", null), r([r2("layers")], C.prototype, "writeLayers", null), r([m({ readOnly: true })], C.prototype, "resourceInfo", void 0), r([m({ type: Number, nonNullable: true, range: { min: 0, max: 1 }, json: { type: x, read: { reader: r4, source: "transparency" }, write: { writer: (r6, e3) => {
  e3.transparency = n4(r6);
}, target: "transparency" } } })], C.prototype, "opacity", void 0), r([m({ type: l2, json: { type: [x], write: (r6, e3) => {
...
var j = class extends n5(l(o.EventedMixin(b2))) {
  constructor(e3) {
    ...
    }, getChildrenFunction: (e4) => "layers" in e4 ? e4.layers : null }), this.allTables = t2(this), this.basemap = null, this.editableLayers = new n2({ getCollections: () => [this.allLayers], itemFilterFunction: e2 }), this.ground = new b4(), this._basemapCache = y();
  }
  destroy() {
...
r([m({ type: l2, json: { write: true } })], a4.prototype, "color", void 0), a4 = p2 = r([a2("esri.webmap.background.ColorBackground")], a4);
var m4 = a4;
...
//# sourceMappingURL=chunk-GKIKLM2L.js.map
