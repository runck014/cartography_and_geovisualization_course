...
var j = (j2) => {
  let _2 = class extends j2 {
    ...
    async loadFromPortal(t, e) {
      ...
      if ((_a = this.portalItem) == null ? void 0 : _a.id) try {
        const { load: r3 } = await import("./layersLoader-HVDBOWSJ.js");
  ...
  return r([m({ type: S })], _2.prototype, "portalItem", null), r([o("web-document", "portalItem", ["itemId"])], _2.prototype, "readPortalItem", null), r([r2("web-document", "portalItem", { itemId: { type: String } })], _2.prototype, "writePortalItem", null), r([m({ clonable: false })], _2.prototype, "resourceReferences", void 0), r([m({ type: Boolean, readOnly: true })], _2.prototype, "userHasEditingPrivileges", void 0), r([m({ type: Boolean, readOnly: true })], _2.prototype, "userHasFullEditingPrivileges", void 0), r([m({ type: Boolean, readOnly: true })], _2.prototype, "userHasUpdateItemPrivileges", void 0), _2 = r([a("esri.layers.mixins.PortalLayer")], _2), _2;
};
...
//# sourceMappingURL=chunk-F3W2DG3D.js.map
