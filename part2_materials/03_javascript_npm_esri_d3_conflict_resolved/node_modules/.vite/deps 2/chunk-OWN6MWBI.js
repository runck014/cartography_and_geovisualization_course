...
function q(e2, a = 1) {
  const s3 = e2.a, n4 = B(e2), r = n4.h, o2 = n4.s / a, i = 100 - (100 - n4.v) / a, { r: c2, g: p3, b: u3 } = A({ h: r, s: o2, v: i });
  return [c2, p3, u3, s3];
}
function I(e2) {
  var _a;
...
function N(e2) {
  return e2.outline ? C(e2) : { color: "rgba(0, 0, 0, 1)", width: 1.5 };
}
function T(e2, t2) {
  const l3 = I(e2);
  if (!l3) return null;
  ...
  switch (e2.type) {
    case "icon": {
      ...
      switch (((_a = e2.resource) == null ? void 0 : _a.primitive) ?? j) {
        case "circle":
          a.push({ shape: { type: "circle", cx: 0, cy: 0, r: 0.5 * t2 }, fill: Z(e2, 0), stroke: C(e2) });
          break;
        case "square":
          a.push({ shape: { type: "path", path: [{ command: "M", values: [l4, r] }, { command: "L", values: [l4, s3] }, { command: "L", values: [n4, s3] }, { command: "L", values: [n4, r] }, { command: "Z", values: [] }] }, fill: Z(e2, 0), stroke: C(e2) });
          break;
        case "triangle":
          a.push({ shape: { type: "path", path: [{ command: "M", values: [l4, r] }, { command: "L", values: [0.5 * n4, s3] }, { command: "L", values: [n4, r] }, { command: "Z", values: [] }] }, fill: Z(e2, 0), stroke: C(e2) });
          break;
        case "cross":
        ...
        case "x":
          ...
          break;
        case "kite":
          a.push({ shape: { type: "path", path: [{ command: "M", values: [l4, 0.5 * r] }, { command: "L", values: [0.5 * n4, s3] }, { command: "L", values: [n4, 0.5 * r] }, { command: "L", values: [0.5 * n4, r] }, { command: "Z", values: [] }] }, fill: Z(e2, 0), stroke: C(e2) });
      }
      break;
    }
    case "object":
      switch (((_b = e2.resource) == null ? void 0 : _b.primitive) ?? d) {
        case "cone": {
          const s3 = F(Z(e2, 0), Z(e2, -0.6), l3 ? R : t2), n4 = l(t2, l3);
        ...
        case "cylinder": {
          const s3 = F(Z(e2, 0), Z(e2, -0.6), l3 ? R : t2), n4 = n3(t2, l3);
...
async function J(e2, t2) {
  ...
  o2.forEach((s3) => {
    ...
    if (null != (t2 == null ? void 0 : t2.rotation) && (y3 = (y3 ?? 0) + t2.rotation), c2.push(y3), (_a = s3 == null ? void 0 : s3.resource) == null ? void 0 : _a.href) {
      const t3 = E(e2, s3).then((e3) => {
        ...
        return u3 = Math.max(u3, t4), h2 = Math.max(h2, l4), y3 && (p3 = true), [{ shape: { type: "image", x: 0, y: 0, width: t4, height: l4, src: e3.url }, fill: null, stroke: null }];
      });
      i.push(t3);
    } else {
      let e3 = f3;
      ...
      u3 = Math.max(u3, a2 ? R : e3), h2 = Math.max(h2, e3), y3 && ((_c = s3.resource) == null ? void 0 : _c.primitive) && ["square", "triangle", "x"].includes((_d = s3.resource) == null ? void 0 : _d.primitive) && (p3 = true), i.push(Promise.resolve(A2(s3, e3, a2)));
    }
  });
  ...
  }), l2(y2, [u3, h2], { node: t2 == null ? void 0 : t2.node, scale: false, opacity: t2 == null ? void 0 : t2.opacity, ariaLabel: t2 == null ? void 0 : t2.ariaLabel, rotations: c2, useRotationSize: p3 });
}
function K(e2, t2) {
  const l3 = e2.symbolLayers, a = [], s3 = y(e2), r = B2(t2), o2 = ((t2 == null ? void 0 : t2.maxSize) ? u(t2.maxSize) : null) || U;
  let i, c2 = 0, p3 = 0;
      ...
      switch (e3.type) {
        case "fill": {
          ...
          if (c2 = Math.max(c2, a2), p3 = Math.max(p3, a2), u3 = true, l3) {
            ...
            let l4 = Z(e3, 0);
            const a3 = "pattern" in e3 ? e3.pattern : null, s4 = C(e3), n5 = I(e3);
...
//# sourceMappingURL=chunk-OWN6MWBI.js.map
