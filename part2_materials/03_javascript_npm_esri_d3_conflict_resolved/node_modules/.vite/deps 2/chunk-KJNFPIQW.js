...
function i7(s13, i16) {
  ...
  const y6 = "esriGeometryPolygon" === s13.geometryType, m7 = y6 ? i3.Polygon : i3.LineString, l12 = y6 ? 3 : 2;
  let c5, p7;
...
var r11 = class extends r3 {
  ...
  processPath(t15) {
    ...
    if (this.iteratePath) s13 = this._pattern.nextValue();
      ...
      this._originalEndings === Y.WithFullGap && this.isClosed ? this._endings = Y.WithMarkers : this._endings = this._originalEndings, this._pattern.extPtGap = 0;
      let i17, n18 = true;
      switch (this._endings) {
        case Y.NoConstraint:
...
var L2 = class {
  ...
  get bounds() {
    if (!this._bounds) {
      ...
      const a12 = e4(n4(), this._rotationT, this._transform);
      a5(r18, r18, a12);
  ...
  _setOffsets() {
    ...
    const t15 = e4(n4(), this._rotationT, this._transform);
...
function R2(t15, s13) {
  return t15.forEach((t16) => S2(t16, t16, s13)), { topLeft: t15[0], topRight: t15[1], bottomLeft: t15[2], bottomRight: t15[3] };
}
var B3 = class {
  constructor(t15, s13, i16) {
  ...
  setRotation(i16) {
    ...
    this._rotation = i16;
    const e13 = this._transform, h8 = M(n4(), i16);
    e4(e13, h8, e13);
  ...
  get boundsT() {
    const t15 = this.bounds, s13 = o(n3(), t15.x, t15.y);
  ...
  _createGlyphTransform(t15, s13) {
    const h8 = b3 * s13.angle, n18 = n4(), f7 = n3();
...
var tt = class {
  ...
  drawPictureMarker(t15, e13) {
    if (!t15) return;
    const r18 = this._resourceManager.getResource(t15.url), s13 = p(t15.size, i2.CIMPictureMarker.size);
  ...
  drawVectorMarker(t15, e13) {
    ...
    if (!r18) return;
    const s13 = p(t15.size, i2.CIMVectorMarker.size), i16 = t15.frame, o8 = i16 ? i16.ymax - i16.ymin : 0, n18 = s13 && o8 ? s13 / o8 : 1, a12 = $.createIdentity();
  ...
  drawTextSymbol(t15, e13, r18) {
    if (!t15) return;
    if (!u2(e13)) return;
    if (p(t15.height, i2.CIMTextSymbol.height) <= 0) return;
...
var et = class extends tt {
  ...
  drawSolidStroke(t15, e13, r18) {
    ...
    const s13 = Math.max(0.5 * this.transformSize(p(r18, i2.CIMSolidStroke.width)), 0.5 * Q2);
...
var rt = class extends tt {
  ...
  hitTest(t15, e13, r18, s13, n18, a12) {
    ...
    if (this._mapRotation = h8 ? n18 : 0, !has("esri-mobile")) {
      const t16 = e2(X * window.devicePixelRatio), r19 = e2(Y2);
  ...
  drawText(t15, e13) {
    ...
    const i16 = p6(p(t15.height, i2.CIMTextSymbol.height)), { lineGapType: o8, lineGap: n18 } = t15, a12 = o8 ? ht(o8, p(n18), i16) : 0, l12 = "CIMBackgroundCallout" === ((_a = t15.callout) == null ? void 0 : _a.type), h8 = O(s13.glyphMosaicItems, { scale: i16 / A2, angle: 0, xOffset: 0, yOffset: 0, horizontalAlignment: t15.horizontalAlignment, verticalAlignment: t15.verticalAlignment, maxLineWidth: g4(t15.lineWidth), lineHeight: G3 * Math.max(0.25, Math.min(a12 || 1, 4)), decoration: t15.font.decoration || "none", useCIMAngleBehavior: true, hasBackground: l12 }), c5 = this.reverseTransformPt(this._searchPoint), m7 = c5[0], f7 = c5[1];
  ...
  _hitTestStroke(t15, e13) {
    ...
    nt(this.reverseTransformPt(this._searchPoint), r18, p(e13, i2.CIMSolidStroke.width) * this.geomUnitsPerPoint() / 2 + this.reverseTransformScalar(this._searchDistPoint) * this.prevGeomUnitsPerPoint()) && (this._earlyReturn = true);
  }
};
var st = class extends tt {
  ...
  drawImage(t15, e13) {
    ...
    const h8 = G2(s13) || "src" in n18 && G2(n18.src);
  ...
  drawPictureFill(t15, e13) {
    ...
    const m7 = this._ctx, _6 = G2(h8) || "src" in c5 && G2(c5.src);
  ...
  drawPictureStroke(t15, r18) {
    ...
    c5 || (c5 = m7.width);
    const g5 = G2(h8) || "src" in m7 && G2(m7.src);
...
function it(t15, e13, r18) {
  let s13 = p(t15.separation, i2.CIMHatchFill.separation) * r18, i16 = p(t15.rotation);
...
var Z3 = class {
  ...
  static _getTextInflatedSize(e13, t15, r18) {
    var _a;
    const o8 = p6(t15.height ?? i2.CIMTextSymbol.height);
    ...
    const { lineGapType: s13, lineGap: i16 } = t15, n18 = s13 ? ht(s13, i16 ?? 0, o8) : 0, l12 = "CIMBackgroundCallout" === ((_a = t15.callout) == null ? void 0 : _a.type), c5 = O(a12.glyphMosaicItems, { scale: o8 / A2, angle: p(t15.angle), xOffset: p(t15.offsetX), yOffset: p(t15.offsetY), horizontalAlignment: t15.horizontalAlignment, verticalAlignment: t15.verticalAlignment, maxLineWidth: g4(t15.lineWidth), lineHeight: G3 * Math.max(0.25, Math.min(n18 || 1, 4)), decoration: t15.font.decoration || "none", useCIMAngleBehavior: true, hasBackground: l12 }).boundsT, m7 = Math.sqrt(c5.width * c5.width + c5.height * c5.height);
...
var ee = class _ee {
  ...
  static fromCIMHatchFill(e13, r18) {
    var _a;
    const o8 = r18 * (e13.separation ?? i2.CIMHatchFill.separation), a12 = o8 / 2, s13 = a(e13.lineSymbol);
  ...
  static fetchFonts(e13, t15, r18) {
    if (e13 && t15) {
      if ("symbolLayers" in e13 && e13.symbolLayers) {
        ...
        const { style: s13, weight: i16 } = w2(a12), n18 = L(e13), c5 = new m2({ family: o8, style: s13, weight: i16, decoration: n18 });
...
function ue(e13, t15, r18) {
  ...
  k(e13.effects) && (t15.geometryEnginePromise = S(), r18.push(t15.geometryEnginePromise), t15.geometryEnginePromise.then((e14) => t15.geometryEngine = e14));
}
function pe(e13) {
  if (!e13) return null;
  let t15 = null;
...
//# sourceMappingURL=chunk-KJNFPIQW.js.map
