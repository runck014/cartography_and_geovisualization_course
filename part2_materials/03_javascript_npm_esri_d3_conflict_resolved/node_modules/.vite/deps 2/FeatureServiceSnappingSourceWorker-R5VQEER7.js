...
var C2 = class extends b {
  ...
  constructor(e5) {
    super(e5), this.suspended = true, this._historicMoment = null, this.tilesOfInterest = [], this.availability = 0, this._pendingTiles = /* @__PURE__ */ new Map(), this._updatingHandles = new h2();
  }
  initialize() {
  ...
  async handleEdits(e5) {
    ...
    const t5 = { ...e5, deletedFeatures: e5.deletedFeatures.map(({ objectId: e6, globalId: t6 }) => e6 && -1 !== e6 ? e6 : this._lookupObjectIdByGlobalId(t6)) }, i6 = d(async (e6) => {
      try {
        ...
        a3(i7), n.getLogger(this).warn("Failed to apply edits", i7);
      }
    });
  ...
  _initializeFetchExtent() {
    ...
    const e5 = d(async (e6) => {
      ...
      try {
        ...
        a3(t5), n.getLogger(this).warn("Failed to fetch data extent", t5);
      }
    });
...
r([m({ constructOnly: true })], y.prototype, "featureStore", void 0), r([m()], y.prototype, "tileInfo", void 0), r([m()], y.prototype, "extent", void 0), r([m()], y.prototype, "maximumByteSize", void 0), y = r([a2("esri.views.interactive.snapping.featureSources.featureServiceSource.FeatureServiceTileStore")], y);
var w4 = class {
...
var w5 = class extends o2.EventedAccessor {
  constructor() {
    super(...arguments), this._isInitializing = true, this.remoteClient = null, this._whenSetup = L(), this._elevationAligner = i2(), this._elevationFilter = r4(), this._symbologyCandidatesFetcher = n4(), this._updatingHandles = new h2(), this._alignPointsInFeatures = async (e5, t5) => {
...
r([m({ readOnly: true })], w5.prototype, "updating", null), r([m()], w5.prototype, "_isInitializing", void 0), w5 = r([a2("esri.views.interactive.snapping.featureSources.featureServiceSource.FeatureServiceSnappingSourceWorker")], w5);
var I2 = w5;
function j2(e5) {
...
//# sourceMappingURL=FeatureServiceSnappingSourceWorker-R5VQEER7.js.map
