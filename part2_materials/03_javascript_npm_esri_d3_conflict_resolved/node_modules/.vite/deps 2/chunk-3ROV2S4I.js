...
function a(r5) {
  return r5 ? { ray: b(r5.ray), c0: r5.c0, c1: r5.c1 } : { ray: b(), c0: 0, c1: Number.MAX_VALUE };
}
var A = new s2(() => a());
...
function L(T2, t, A3, E3 = y2) {
  ...
  h(F2, F2);
  for (let _ = 0; _ < h3; ++_) {
    const T3 = z(r3.get(), k2[_], F2);
    o(E3[_], T3[0] / T3[3], T3[1] / T3[3], T3[2] / T3[3]);
  }
  P(A3, E3);
}
function P(T2, _) {
  p(_[g2.FAR_BOTTOM_LEFT], _[g2.NEAR_BOTTOM_LEFT], _[g2.NEAR_TOP_LEFT], T2[j.LEFT]), p(_[g2.NEAR_BOTTOM_RIGHT], _[g2.FAR_BOTTOM_RIGHT], _[g2.FAR_TOP_RIGHT], T2[j.RIGHT]), p(_[g2.FAR_BOTTOM_LEFT], _[g2.FAR_BOTTOM_RIGHT], _[g2.NEAR_BOTTOM_RIGHT], T2[j.BOTTOM]), p(_[g2.NEAR_TOP_LEFT], _[g2.NEAR_TOP_RIGHT], _[g2.FAR_TOP_RIGHT], T2[j.TOP]), p(_[g2.NEAR_BOTTOM_LEFT], _[g2.NEAR_BOTTOM_RIGHT], _[g2.NEAR_TOP_RIGHT], T2[j.NEAR]), p(_[g2.FAR_BOTTOM_RIGHT], _[g2.FAR_BOTTOM_LEFT], _[g2.FAR_TOP_LEFT], T2[j.FAR]);
}
function s3(T2, _) {
...
var b2 = 6;
var h3 = 8;
var k2 = [r2(-1, -1, -1, 1), r2(1, -1, -1, 1), r2(1, 1, -1, 1), r2(-1, 1, -1, 1), r2(-1, -1, 1, 1), r2(1, -1, 1, 1), r2(1, 1, 1, 1), r2(-1, 1, 1, 1)];
var x = new s2(a);
var y2 = I2();
...
var b3 = class _b {
  ...
  constructor(t, e2) {
    this.objectToBoundingSphere = t, this._maximumObjectsPerNode = 10, this._maximumDepth = 20, this._degenerateObjects = /* @__PURE__ */ new Set(), this._root = new g3(), this._objectCount = 0, e2 && (void 0 !== e2.maximumObjectsPerNode && (this._maximumObjectsPerNode = e2.maximumObjectsPerNode), void 0 !== e2.maximumDepth && (this._maximumDepth = e2.maximumDepth));
  }
  destroy() {
    this._degenerateObjects.clear(), g3.clearPool(), k3[0] = null, K.prune(), Q.prune();
  }
  add(t, e2 = t.length) {
  ...
  findClosest(t, e2, n2, o2 = () => true, s4 = 1 / 0) {
    let h4 = 1 / 0, a2 = 1 / 0, d = null;
    const u2 = F(t, e2), c2 = (i2) => {
      if (--s4, !o2(i2)) return;
      const r5 = this.objectToBoundingSphere(i2);
      if (!s3(n2, r5)) return;
      const u3 = v4(t, e2, U(r5)), c3 = u3 - r5[3], f2 = u3 + r5[3];
      c3 < h4 && (h4 = c3, a2 = f2, d = i2);
    };
    return j2(this._root, (o3) => {
      if (s4 <= 0 || !s3(n2, o3.bounds)) return false;
  ...
  forEachInDepthRange(t, e2, n2, o2, s4, h4, a2) {
    let d = -1 / 0, u2 = 1 / 0;
    ...
    c2.setRange(o2);
    const f2 = v4(e2, n2, t), _ = F(e2, n2), p2 = F(e2, -n2), g4 = (t2) => {
      if (!a2(t2)) return;
      const o3 = this.objectToBoundingSphere(t2), i2 = U(o3), r5 = v4(e2, n2, i2) - f2, _2 = r5 - o3[3], p3 = r5 + o3[3];
      _2 > u2 || p3 < d || !s3(h4, o3) || s4(t2, c2);
    };
    j2(this._root, (t2) => {
      if (!s3(h4, t2.bounds)) return false;
      g(I3, _, t2.halfSize), u(I3, I3, U(t2.bounds));
      if (v4(e2, n2, I3) - f2 > u2) return false;
      g(I3, p2, t2.halfSize), u(I3, I3, U(t2.bounds));
      if (v4(e2, n2, I3) - f2 < d) return false;
      const o3 = t2.node;
      return o3.terminals.forAll((t3) => g4(t3)), null !== o3.residents && o3.residents.forAll((t3) => g4(t3)), true;
    }, e2, n2);
  }
  forEachNode(t) {
  ...
  forEachNeighbor(t, e2) {
    const n2 = N(e2), o2 = U(e2), i2 = (e3) => {
      const i3 = this.objectToBoundingSphere(e3), r6 = N(i3), h5 = n2 + r6;
      return !(v(U(i3), o2) - h5 * h5 <= 0) || t(e3);
    };
    let r5 = true;
    const h4 = (t2) => {
      r5 && (r5 = i2(t2));
    ...
    S(this._root, (t2) => {
      ...
      if (v(U(t2.bounds), o2) - i3 * i3 > 0) return false;
      const a2 = t2.node;
      return a2.terminals.forAll(h4), r5 && null !== a2.residents && a2.residents.forAll(h4), r5;
  ...
  _split(t) {
    ...
    for (let n2 = 0; n2 < e2.length; n2++) {
      const o2 = g3.acquire().init(t);
      this._add(e2.at(n2), o2), g3.release(o2);
    }
  }
  _grow(t, e2) {
    if (0 !== e2 && (D(t, e2, (t2) => this.objectToBoundingSphere(t2), W), C(W[3]) && !this._fitsInsideTree(W))) if (N3(this._root.node)) w(W, this._root.bounds), this._root.halfSize = 1.25 * this._root.bounds[3], this._root.updateBoundsRadiusFromHalfSize();
    else {
      const t2 = this._rootBoundsForRootAsSubNode(W);
      this._placingRootViolatesMaxDepth(t2) ? this._rebuildTree(W, t2) : this._growRootAsSubNode(t2), g3.release(t2);
    }
  }
  _rebuildTree(t, e2) {
    s(U(V2), U(e2.bounds)), V2[3] = e2.halfSize, D([t, V2], 2, (t2) => t2, G2);
    const o2 = g3.acquire().init(this._root);
    this._root.initFrom(null, G2, G2[3]), this._root.increaseHalfSize(1.25), S(o2, (t2) => (this.add(t2.node.terminals.data, t2.node.terminals.length), null !== t2.node.residents && this.add(t2.node.residents.data, t2.node.residents.length), true)), g3.release(o2);
  }
  ...
  _rootBoundsForRootAsSubNode(t) {
    ...
    for (let h4 = 0; h4 < 3; h4++) {
      const t2 = i2[h4] - r5 - (n2[h4] - e2), s5 = n2[h4] + e2 - (i2[h4] + r5), a2 = Math.max(0, Math.ceil(t2 / (2 * r5))), l2 = Math.max(0, Math.ceil(s5 / (2 * r5))) + 1, d = 2 ** Math.ceil(Math.log(a2 + l2) * Math.LOG2E);
      o2 = Math.max(o2, d), U2[h4].min = a2, U2[h4].max = l2;
    }
    for (let h4 = 0; h4 < 3; h4++) {
      let t2 = U2[h4].min, e3 = U2[h4].max;
      const n3 = (o2 - (t2 + e3)) / 2;
      t2 += Math.ceil(n3), e3 += Math.floor(n3);
      const s5 = i2[h4] - r5 - t2 * r5 * 2;
      y3[h4] = s5 + (e3 + t2) * r5;
    }
    const s4 = o2 * r5;
    return y3[3] = s4 * w2, g3.acquire().initFrom(null, y3, s4, 0);
  }
  ...
  _nodeToJSON(t) {
    var _a, _b2;
    const e2 = t.children.map((t2) => t2 ? this._nodeToJSON(t2) : null), n2 = (_a = t.residents) == null ? void 0 : _a.map((t2) => this.objectToBoundingSphere(t2)), o2 = (_b2 = t.terminals) == null ? void 0 : _b2.map((t2) => this.objectToBoundingSphere(t2));
...
function S(t, e2) {
  let n2 = g3.acquire().init(t);
  const o2 = [n2];
  for (; 0 !== o2.length; ) {
    if (n2 = o2.pop(), e2(n2) && !n2.isLeaf()) for (let t2 = 0; t2 < n2.node.children.length; t2++) {
      n2.node.children[t2] && o2.push(g3.acquire().init(n2).advance(t2));
    }
    g3.release(n2);
  }
}
function j2(t, e2, n2, o2 = b3.DepthOrder.FRONT_TO_BACK) {
  let i2 = g3.acquire().init(t);
  const r5 = [i2];
  for (R(n2, o2, X); 0 !== r5.length; ) {
    if (i2 = r5.pop(), e2(i2) && !i2.isLeaf()) for (let t2 = 7; t2 >= 0; --t2) {
      const e3 = X[t2];
      i2.node.children[e3] && r5.push(g3.acquire().init(i2).advance(e3));
    }
    g3.release(i2);
  }
}
...
function x2(t, n2) {
  return n2 >= 0 && (t.children[n2] = null), !!N3(t) && (null === t.residents && (t.residents = new l({ shrink: true })), true);
}
function T(t, e2) {
...
function D(t, e2, n2, i2) {
  if (1 === e2) {
    ...
    for (let o2 = 0; o2 < e2; o2++) {
      const e3 = n2(t[o2]);
      C(e3[3]) && (M2(L2, e3), A2(H3, e3));
    }
    I(U(i2), L2, H3, 0.5), i2[3] = Math.max(H3[0] - L2[0], H3[1] - L2[1], H3[2] - L2[2]) / 2;
  }
}
function R(t, e2, n2) {
...
function F(t, e2) {
  ...
  for (let i2 = 0; i2 < 8; ++i2) {
    const r5 = v4(t, e2, P2[i2]);
    r5 < o2 && (o2 = r5, n2 = P2[i2]);
  }
  return n2;
}
function v4(t, e2, n2) {
...
var P2 = [r(-1, -1, -1), r(-1, -1, 1), r(-1, 1, -1), r(-1, 1, 1), r(1, -1, -1), r(1, -1, 1), r(1, 1, -1), r(1, 1, 1)];
var w2 = Math.sqrt(3);
var k3 = [null];
function q2(t) {
  return k3[0] = t, k3;
...
//# sourceMappingURL=chunk-3ROV2S4I.js.map
