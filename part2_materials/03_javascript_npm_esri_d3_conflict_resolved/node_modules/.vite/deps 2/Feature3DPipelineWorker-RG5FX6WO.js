...
var a7 = class extends b2 {
  constructor(e15) {
    super(e15), this._removing = 0, this._tiles = new s10();
  }
  destroy() {
...
var o17 = class extends n19 {
  ...
  getCentroid(e15) {
    return n17(new s5(), this._geometryOverride, e15.hasZ, e15.hasM);
  }
};
var d9 = class {
  constructor() {
  ...
  _addPage(e15) {
    ...
    if (0 === i16) return;
    const r24 = new h5(9, (t28) => e15.getBounds(t28)), s27 = new Array();
...
var u12 = class {
  constructor(e15) {
    const r24 = new n9(new Uint8Array(e15), new DataView(e15));
  ...
  getOptimizedGeometry(e15) {
    const t28 = n5();
    return this.getCoordinates(e15, t28), new s5([], t28);
  }
  getCentroid(e15, { hasZ: t28, hasM: r24 }) {
    this.getCoordinates(e15, h7);
    const [s27, n30, o28] = h7, a21 = [s27, n30];
    return t28 && (a21[3] = o28), r24 && (a21[t28 ? 4 : 3] = 0), new s5([], a21);
  }
  getBounds(e15) {
    this.getCoordinates(e15, h7);
    const [t28, r24] = h7, n30 = new E7();
...
function l6(e15) {
  ...
  for (; e15.next(); ) switch (e15.tag()) {
    ...
    case t28:
      ...
      break;
    case r24:
      m9 = u3(e15.processMessage(h2));
      break;
    case s27: {
      const t29 = e15.processMessage(b5);
...
var c9 = class {
  ...
  async _fetchPage(t28, o28, i16) {
    ...
    const n30 = (await d3(this.url, a21, { signal: i16 })).data;
...
var s15 = Object.freeze({ "bottom-left": r10(0, 0), bottom: r10(0.5, 0), "bottom-right": r10(1, 0), left: r10(0, 0.5), center: r10(0.5, 0.5), right: r10(1, 0.5), "top-left": r10(0, 1), top: r10(0.5, 1), "top-right": r10(1, 1) });

// node_modules/@arcgis/core/views/3d/webgl-engine/effects/RenderPlugin.js
var t12 = { required: [] };
var s16 = { required: [n13.Depth] };
...
var x4 = class extends u13 {
  ...
  initialize() {
    this.material.produces.forEach((e15, t28) => {
      this._produces.set(t28, (t29) => !(0 === this._dataByOrigin.size || !(t29 !== n13.Highlight && t29 !== n13.ShadowHighlight || this._hasAnyHighlight)) && e15(t29));
    });
  }
  initializeRenderContext(e15, t28) {
    this._glMaterials = new t13(this.material, t28 ?? e15.materials), this._bufferWriter = this.material.createBufferWriter(), this._vaoCache = e15.renderContext.rctx.getVaoCache(this.material.vertexAttributeLocations, t11(this._bufferWriter.vertexBufferLayout));
  }
  ...
  _addAndRemoveGeometries(e15, r24) {
    ...
    a21.forEach((e16, r25) => {
      ...
      if (e16.forEach((e17, n31) => {
        if (a21.delete(r25, n31), null == n31) return void s11(false, "No VAO for removed geometries");
  ...
  _applyAndRebuild(e15, t28, r24) {
    ...
    for (; t28.length > 0; ) {
      ...
      s11(null == e15.instances.get(r25.id)), e15.addInstance(r25.id, o29);
    }
  ...
  _applyAdds(e15, t28) {
    ...
    t28.forEach((t29, r24) => {
      ...
      s11(null == e15.instances.get(t29.id)), e15.addInstance(t29.id, n31), e15.drawCommandsDirty = true;
    });
    const p14 = m9 - c18;
    p14 > 0 && h15.setSubData(d14, c18 * s27, 0, p14 * s27), v(t28, (e16, t29) => null == u19[t29]);
  }
  _writeGeometry(e15, t28, r24) {
    null != this._bufferWriter && (n7(j, e15.transformation), j[12] -= e15.localOrigin.vec3[0], j[13] -= e15.localOrigin.vec3[1], j[14] -= e15.localOrigin.vec3[2], h(M2, j), s7(M2, M2), this._bufferWriter.write(j, M2, e15.geometry.attributes, e15.geometry.objectAndLayerIdColor, t28, r24));
  }
  updateAnimation(e15) {
  ...
  acquireTechniques(e15) {
    ...
    const { highlightGroupName: s27, slot: o28 } = r24, a21 = t28 === n13.ShadowHighlight, n30 = t28 === n13.Highlight, l12 = n30 || a21, u19 = (e16) => l12 && (0 === this._highlightGroups.size || n30 && !!s27 && !e16.has(s27));
    if (u19(this._highlightGroups)) return null;
    const h15 = t28 === n13.ShadowExcludeHighlight, f10 = !(l12 || h15);
  ...
  render(e15, t28) {
    const { output: r24, bind: i16 } = e15, { slot: s27, highlightGroupName: o28 } = i16, a21 = r24 === n13.Highlight;
    if (a21 && !o28) return;
    const n30 = r24 === n13.ShadowHighlight, l12 = a21 || n30, u19 = r24 === n13.ShadowExcludeHighlight, h15 = !(l12 || u19), f10 = s27 === A3.OCCLUDER_MATERIAL || s27 === A3.TRANSPARENT_OCCLUDER_MATERIAL ? s27 : null, { rctx: c18 } = e15;
...
var m6 = class extends u13 {
  ...
  initialize() {
    this._bufferWriter = this.material.createBufferWriter(), this.material.produces.forEach((e15, r24) => {
      this._produces.set(r24, (r25) => !!(r25 !== n13.Highlight && r25 !== n13.ShadowHighlight || this._hasHighlights) && e15(r25));
    });
  }
  destroy() {
  ...
  acquireTechniques(e15) {
    ...
    if ((t28 === n13.Highlight || t28 === n13.ShadowHighlight) && !this._hasHighlights) return null;
  ...
  initializeRenderContext(e15, r24) {
    ...
    const t28 = e15.renderContext.rctx.getVaoCache(this.material.vertexAttributeLocations, t11(this._bufferWriter.vertexBufferLayout));
    this._vaoCache = t28;
  }
  uninitializeRenderContext() {
  }
...
var tt = $ = class extends b2 {
  constructor(t28) {
    super(t28), this._ray = b7(), this._viewport = r8(0, 0, 1, 1), this._padding = r8(0, 0, 0, 0), this._fov = 55 / 180 * Math.PI, this._nearFar = r10(1, 1e3), this._viewDirty = true, this._viewMatrix = e4(), this._viewProjectionDirty = true, this._viewProjectionMatrix = e4(), this._viewInverseTransposeMatrixDirty = true, this._viewInverseTransposeMatrix = e4(), this._frustumDirty = true, this._frustum = H3(), this._fullViewport = n8(), this._pixelRatio = 1, this.row = 0, this.column = 0, this._rows = 1, this._columns = 1, this._center = n5(), this._up = n5(), this.relativeElevation = 0;
  }
  get pixelRatio() {
  ...
  get ray() {
    return c5(this._ray.direction, this.center, this.eye), this._ray;
  }
  get up() {
    return this._up;
  }
  ...
  set viewMatrix(t28) {
    n7(this._viewMatrix, t28), this.notifyChange("_viewMatrix"), this._viewDirty = false, this._viewInverseTransposeMatrixDirty = true, this._viewProjectionDirty = true, this._frustumDirty = true;
  }
  get viewForward() {
  ...
  get screenViewport() {
    ...
    const t28 = m2(n8(), this._viewport, 1 / this.pixelRatio), i16 = this._get("screenViewport");
    return i16 && L(t28, i16) ? i16 : t28;
  }
  get screenPadding() {
    if (1 === this.pixelRatio) return this._padding;
    const t28 = m2(n8(), this._padding, 1 / this.pixelRatio), i16 = this._get("screenPadding");
    return i16 && L(t28, i16) ? i16 : t28;
  }
  get x() {
  ...
  get viewInverseTransposeMatrix() {
    return (this._viewInverseTransposeMatrixDirty || this._viewDirty) && (h(this._viewInverseTransposeMatrix, this.viewMatrix), s7(this._viewInverseTransposeMatrix, this._viewInverseTransposeMatrix), this._viewInverseTransposeMatrixDirty = false), this._viewInverseTransposeMatrix;
  }
  depthNDCToWorld(t28) {
    const i16 = 2 * t28 - 1;
  ...
  get _projectionMatrixInternal() {
    const t28 = this.width, i16 = this.height, e15 = this.near * Math.tan(this.fovY / 2) * 2, r24 = e15 * this._aspect, s27 = e15 / this.rows, o28 = r24 / this.columns, n30 = -r24 / 2 + this.column * o28, h15 = n30 + o28, a21 = -e15 / 2 + this.row * s27, p14 = a21 + s27, u19 = A(e4(), n30 * (1 + 2 * this._padding[t18.LEFT] / t28), h15 * (1 + 2 * this._padding[t18.RIGHT] / t28), a21 * (1 + 2 * this._padding[t18.BOTTOM] / i16), p14 * (1 + 2 * this._padding[t18.TOP] / i16), this.near, this.far), l12 = this._get("projectionMatrix");
    return l12 && C(l12, u19) ? l12 : u19;
  }
  copyFrom(t28) {
    s8(this._ray.origin, t28.eye), this.center = t28.center, this.up = t28.up, a3(this._viewport, t28.viewport), this.notifyChange("_viewport"), a3(this._padding, t28.padding), this.notifyChange("_padding"), r11(this._nearFar, t28.nearFar), this.notifyChange("_nearFar"), this._fov = t28.fov, this.row = t28.row, this.column = t28.column, this.rows = t28.rows, this.columns = t28.columns, this.relativeElevation = t28.relativeElevation;
    const i16 = t28;
    return this._viewDirty = i16._viewDirty, this._viewDirty || (n7(this._viewMatrix, t28.viewMatrix), this.notifyChange("_viewMatrix")), this._viewProjectionDirty = true, this._frustumDirty = i16._frustumDirty, this._frustumDirty || (N5(this._frustum, t28.frustum), this._frustumDirty = false), i16._viewInverseTransposeMatrixDirty ? this._viewInverseTransposeMatrixDirty = true : (n7(this._viewInverseTransposeMatrix, t28.viewInverseTransposeMatrix), this._viewInverseTransposeMatrixDirty = false), a3(this._fullViewport, t28.fullViewport), this.pixelRatio = t28.pixelRatio, this;
  }
  copyViewFrom(t28) {
  ...
  _viewDirectionDistance(t28) {
    return Math.abs(f3(this.viewForward, c5(st, t28, this.eye)));
  }
  ...
  _computeUpGlobal() {
    c5(st, this.center, this.eye);
    const t28 = r9(this.center);
    t28 < 1 ? (o5(this._up, 0, 0, 1), this._markViewDirty(), this.notifyChange("_up")) : Math.abs(P2(st, this.center)) > 0.9999 * r9(st) * t28 || (_(this._up, st, this.center), _(this._up, this._up, st), A2(this._up, this._up), this.notifyChange("_up"), this._markViewDirty());
  }
  _computeUpLocal() {
    K(st, this.eye, this.center), Math.abs(st[2]) <= 0.9999 && (g2(st, st, st[2]), o5(this._up, -st[0], -st[1], 1 - st[2]), A2(this._up, this._up), this.notifyChange("_up"), this._markViewDirty());
  }
...
var r18 = class {
  constructor(r24, i16, s27) {
    this._elementSize = i16, this._buffer = E8.createVertex(r24, F3.STATIC_DRAW), this.resize(s27);
  }
  destroy() {
...
var c11 = class {
  constructor(t28) {
    this.modelOriginHi = t28.getField(e7.INSTANCEMODELORIGINHI, i2), this.modelOriginLo = t28.getField(e7.INSTANCEMODELORIGINLO, i2), this.model = t28.getField(e7.INSTANCEMODEL, l4), this.modelNormal = t28.getField(e7.INSTANCEMODELNORMAL, l4), this.featureAttribute = t28.getField(e7.INSTANCEFEATUREATTRIBUTE, c8), this.color = t28.getField(e7.INSTANCECOLOR, x3), this.objectAndLayerIdColor = t28.getField(e7.INSTANCEOBJECTANDLAYERIDCOLOR, x3);
  }
};
var f5 = class {
  constructor(t28, i16) {
  ...
  endUpdate() {
    s11(this._updating, "not updating"), this.size < r2 * this.capacity && this._shrink(), this._resized ? (this._buffer.transferAll(), this._resized = false) : this._transferRange(this._prevHeadIndex, this._headIndex), this._updating = false;
  }
  allocateHead() {
    s11(this._updating, "not updating"), this.isFull && this._grow();
    const t28 = this.headIndex;
    return this._captureFirstIndex && (this._firstIndex = t28, this._captureFirstIndex = false), this._incrementHead(), s11(this._headIndex !== this._tailIndex, "invalid pointers"), t28;
  }
  freeTail() {
  ...
  _resize(t28) {
    if (s11(this._updating, "not updating"), t28 === this._capacity) return;
    ...
    if (this._buffer) {
      ...
      s11(e15 === t29, "invalid compaction"), this._buffer.destroy(), this._tailIndex = 0, this._headIndex = e15, this._prevHeadIndex = 0;
    }
...
var F4;
function C5(t28) {
  let e15 = H2().mat4f64(e7.LOCALTRANSFORM).mat4f64(e7.GLOBALTRANSFORM).vec4f64(e7.BOUNDINGSPHERE).vec3f64(e7.MODELORIGIN).mat3f(e7.INSTANCEMODEL).mat3f(e7.INSTANCEMODELNORMAL).vec2f(e7.MODELSCALEFACTORS);
  return t28.includes(e7.FEATUREATTRIBUTE) && (e15 = e15.vec4f(e7.FEATUREATTRIBUTE)), t28.includes(e7.COLOR) && (e15 = e15.vec4u8(e7.COLOR)), t28.includes(e7.OBJECTANDLAYERIDCOLOR) && (e15 = e15.vec4u8(e7.OBJECTANDLAYERIDCOLOR)), e15 = e15.u8(e7.STATE).u8(e7.LODLEVEL), e15;
}
!function(t28) {
...
var R4 = class {
  constructor(t28) {
    this.localTransform = t28.getField(e7.LOCALTRANSFORM, b6), this.globalTransform = t28.getField(e7.GLOBALTRANSFORM, b6), this.modelOrigin = t28.getField(e7.MODELORIGIN, T), this.model = t28.getField(e7.INSTANCEMODEL, l4), this.modelNormal = t28.getField(e7.INSTANCEMODELNORMAL, l4), this.modelScaleFactors = t28.getField(e7.MODELSCALEFACTORS, u10), this.boundingSphere = t28.getField(e7.BOUNDINGSPHERE, h3), this.featureAttribute = t28.getField(e7.FEATUREATTRIBUTE, c8), this.color = t28.getField(e7.COLOR, x3), this.objectAndLayerIdColor = t28.getField(e7.OBJECTANDLAYERIDCOLOR, x3), this.state = t28.getField(e7.STATE, d4), this.lodLevel = t28.getField(e7.LODLEVEL, d4);
  }
};
var b9 = class extends b2 {
  ...
  removeInstance(t28) {
    ...
    s11(t28 >= 0 && t28 < this._capacity && !!(e15.get(t28) & F4.ALLOCATED), "invalid instance handle"), this._getStateFlag(t28, F4.ACTIVE) ? this._setStateFlags(t28, F4.REMOVE) : this.freeInstance(t28), this.events.emit("instances-changed");
  }
  freeInstance(t28) {
    const e15 = this._view.state;
    s11(t28 >= 0 && t28 < this._capacity && !!(e15.get(t28) & F4.ALLOCATED), "invalid instance handle"), e15.set(t28, 0), this._size--;
  }
  ...
  updateModelTransform(t28) {
    ...
    const r24 = g3(G2, a21);
    r24.sort(), e15.modelScaleFactors.set(t28, 0, r24[1]), e15.modelScaleFactors.set(t28, 1, r24[2]), s9(i16, i16), u9(i16, i16), e15.modelNormal.setMat(t28, i16), this._setStateFlags(t28, F4.TRANSFORM_CHANGED), this.events.emit("instance-transform-changed", { index: t28 });
  }
...
var n24 = class extends Y {
  constructor(e15, r24) {
    super((t28) => T2(this._instanceData.view.boundingSphere.getVec(t28, this._tmpSphere)), { maximumDepth: 25 }), this._instanceData = e15, this._boundingSphere = r24, this._tmpSphere = E5(), this._tmpMat4 = e4();
  }
  addInstance(t28) {
    const s27 = this._instanceData.view.boundingSphere, i16 = this._instanceData.getCombinedModelTransform(t28, this._tmpMat4);
    E2(U(this._tmpSphere), this._boundingSphere.center, i16), this._tmpSphere[3] = this._boundingSphere.radius * m3(i16), s27.setVec(t28, this._tmpSphere), this.add([t28]);
  }
  removeInstance(t28) {
    this.remove([t28]);
  }
...
var B4 = class {
  ...
  get distanceInRenderSpace() {
    return null != this.dist ? (g2(M3, this.ray.direction, this.dist), r9(M3)) : null;
  }
  getIntersectionPoint(t28) {
    return !!o15(this) && (g2(M3, this.ray.direction, this.dist), u7(t28, this.ray.origin, M3), true);
  }
  getTransformedNormal(t28) {
    return s8(R5, this.normal), R5[3] = 0, z2(R5, R5, this.transformation), s8(t28, R5), A2(t28, t28);
  }
  constructor(t28) {
    this.intersector = i6.OBJECT, this.normal = n5(), this.transformation = e4(), this._ray = b7(), this.init(t28);
  }
  init(t28) {
    this.dist = null, this.target = null, this.drapedLayerOrder = null, this.drapedLayerGraphicOrder = null, this.intersector = i6.OBJECT, v2(t28, this._ray);
  }
  set(r24, s27, e15, a21, n30, h15, l12) {
    this.intersector = r24, this.dist = e15, s8(this.normal, a21 ?? N), n7(this.transformation, n30 ?? o6), this.target = s27, this.drapedLayerOrder = h15, this.drapedLayerGraphicOrder = l12;
  }
  copy(r24) {
    v2(r24.ray, this._ray), this.intersector = r24.intersector, this.dist = r24.dist, this.target = r24.target, this.drapedLayerOrder = r24.drapedLayerOrder, this.drapedLayerGraphicOrder = r24.drapedLayerGraphicOrder, s8(this.normal, r24.normal), n7(this.transformation, r24.transformation);
  }
};
function G3(t28) {
  return new B4(t28);
...
var d11 = class {
  constructor(o28, n30) {
    ...
    let d14 = null;
    d14 = u19 instanceof r12 ? f6(u19.material, u19.attributes, u19.boundingInfo) : u19;
    const c18 = d14.material;
    this._materials = o28.materials, c18.setParameters({ instancedDoublePrecision: true }), this.geometry = u19, this.material = c18, this.glMaterials = new t13(c18, this._materials), this.vertexBufferLayout = d14.vertexBufferLayout, this.vbo = E8.createVertex(i16, F3.STATIC_DRAW, d14.buffer), this.vao = new r20(i16, O3, /* @__PURE__ */ new Map([["geometry", t11(d14.vertexBufferLayout)]]), /* @__PURE__ */ new Map([["geometry", this.vbo]])), this.vertexCount = d14.elementCount;
  }
  destroy() {
  ...
  intersect(t28, r24, s27, a21, m9, l12, f10, d14) {
    if (!(this.geometry instanceof r12)) return;
...
function l7(t28, n30, r24, l12, i16) {
  o22[0] = t28.get(n30, 0), o22[1] = t28.get(n30, 1), o22[2] = t28.get(n30, 2), t9(o22, s19, 3), r24.set(i16, 0, s19[0]), l12.set(i16, 0, s19[1]), r24.set(i16, 1, s19[2]), l12.set(i16, 1, s19[3]), r24.set(i16, 2, s19[4]), l12.set(i16, 2, s19[5]);
}
var o22 = n5();
...
var q2 = class extends o19 {
  constructor(e15, t28) {
    super(e15), this.type = i6.LOD, this.isGround = false, this._levels = [], this._defaultRenderInstanceData = new Array(), this._highlightRenderInstanceDataMap = /* @__PURE__ */ new Map(), this._instanceIndex = 0, this._cycleStartIndex = 0, this._slicePlane = false, this._camera = new it(), this._updateCyclesWithStaticCamera = -1, this._needFullCycle = false, this.produces = /* @__PURE__ */ new Map([[A3.OPAQUE_MATERIAL, (e16) => this._produces(e16)], [A3.TRANSPARENT_MATERIAL, (e16) => !!this._hasTransparentLevels() && this._produces(e16)]]), this._instanceData = new b9({ shaderTransformation: e15.shaderTransformation }, e15.optionalFields), this.addHandles(t28.registerTask(g5.LOD_RENDERER, this));
  }
  initialize() {
    this._instanceBufferLayout = k(this.optionalFields), this._glInstanceBufferLayout = t11(this._instanceBufferLayout, 1), this.addHandles([this._instanceData.events.on("instances-changed", () => this._requestUpdateCycle()), this._instanceData.events.on("instance-transform-changed", ({ index: e15 }) => {
  ...
  _hasTransparentLevels() {
    return this._levels.some((e15) => e15.components.some((e16) => {
      ...
      return t28 == null ? void 0 : t28(n13.Color);
    }));
  }
  hasHighlights() {
  ...
  _produces(e15) {
    return e15 !== n13.Highlight && e15 !== n13.ShadowHighlight || this.hasHighlights();
  }
  prepareRender(e15) {
    if (!t10.LOD_INSTANCE_RENDERER_DISABLE_UPDATES) {
      ...
      this._needFullCycle && (this.runTask(C4), this._needFullCycle = false);
    }
  }
  acquireTechniques(e15) {
  ...
  _getInstanceDatas(e15) {
    const { output: t28, bind: r24 } = e15, n30 = t28 === n13.Highlight, a21 = !n30 && t28 !== n13.ShadowHighlight, s27 = t28 !== n13.ShadowExcludeHighlight;
  ...
  intersect(e15, t28, r24, n30) {
    ...
    c5(a21, n30, r24);
    const s27 = (a22) => {
      this._instanceData.getCombinedModelTransform(a22, Y2), e15.transform.set(Y2), E2(J2, r24, e15.transform.inverse), E2(Q, n30, e15.transform.inverse);
      const s28 = this._instanceData.getState(a22), i16 = this._instanceData.getLodLevel(a22), o28 = this._levels.length;
      s11(!!(s28 & F4.ACTIVE), "invalid instance state"), s11(i16 >= 0 && i16 < o28, "invaid lod level"), this._levels[i16].intersect(e15, t28, J2, Q, a22, this.metadata, o28);
    };
  ...
  queryDepthRange(e15) {
    ...
    s27.boundingSphere.getVec(r24, K2), c5(K2, K2, a21);
    const i16 = P2(K2, t28) - K2[3];
    s27.boundingSphere.getVec(n30, K2), c5(K2, K2, a21);
  ...
  _renderComponent(e15, t28, r24, n30, a21) {
    ...
    i16.bindVAO(n30.vao), t28.ensureAttributeLocations(n30.vao), t10.LOD_INSTANCE_RENDERER_COLORIZE_BY_LEVEL && e15.output === n13.Color && (o28.setUniform4fv("externalColor", Z3[Math.min(a21, Z3.length - 1)]), o28.setUniform1i("colorMixMode", o12.replace));
    const l12 = r24.capacity, c18 = r24.headIndex, h15 = r24.tailIndex, d14 = r24.firstIndex, u19 = this._glInstanceBufferLayout, f10 = (e16, a22) => {
      E6(i16, O3, r24.buffer, u19, e16), i16.drawArraysInstanced(t28.primitiveType, 0, n30.vertexCount, a22 - e16), _2(i16, O3, r24.buffer, u19);
    };
    n30.material.parameters.transparent && null != d14 ? c18 > h15 ? (s11(d14 >= h15 && d14 <= c18, "invalid firstIndex"), f10(d14, c18), f10(h15, d14)) : c18 < h15 && (d14 <= c18 ? (s11(d14 >= 0 && d14 <= c18, "invalid firstIndex"), f10(d14, c18), f10(h15, l12), f10(0, d14)) : (s11(d14 >= h15 && d14 <= l12, "invalid firstIndex"), f10(d14, l12), f10(0, c18), f10(h15, d14))) : c18 > h15 ? f10(h15, c18) : c18 < h15 && (f10(0, c18), f10(h15, l12)), i16.bindVAO(null);
  }
};
...
function k(e15) {
  let t28 = H2().vec3f(e7.INSTANCEMODELORIGINHI).vec3f(e7.INSTANCEMODELORIGINLO).mat3f(e7.INSTANCEMODEL).mat3f(e7.INSTANCEMODELNORMAL);
  return null != e15 && e15.includes("featureAttribute") && (t28 = t28.vec4f(e7.INSTANCEFEATUREATTRIBUTE)), null != e15 && e15.includes("color") && (t28 = t28.vec4u8(e7.INSTANCECOLOR)), null != e15 && e15.includes("objectAndLayerIdColor") && (t28 = t28.vec4u8(e7.INSTANCEOBJECTANDLAYERIDCOLOR)), t28;
}
...
var n25 = class {
  ...
  get numTriangles() {
    return this.geometry instanceof r12 ? this.geometry.indexCount / 3 : this.geometry.elementCount / 3;
  }
};
function s20(e15) {
  return e15 instanceof r12 ? e15.attributes.get(e7.POSITION).indices.length : e15.elementCount;
}
var o23 = class {
...
var c13 = class {
  ...
  async doLoad(e15, s27, t28) {
    has("enable-feature:objectAndLayerId-rendering") && this._optionalFields.push(e7.OBJECTANDLAYERIDCOLOR);
...
function u17(t28, a21 = e12, u19 = a21 * o24, s27 = 0) {
  ...
  return new C3(i16, { mipmap: false, wrap: { s: D.CLAMP_TO_EDGE, t: D.CLAMP_TO_EDGE }, width: a21, height: a21, components: 4, noUnpackFlip: true, reloadable: true });
}
...
var c16 = class extends n16 {
  constructor(e15, o28, t28) {
    super(e15, o28, new t8(H4, () => import("./HUDMaterial.glsl-CDBMPUDY.js")), t28), this.primitiveType = o28.occlusionPass ? E4.POINTS : E4.TRIANGLES;
  }
  initializePipeline(r24) {
    const { oitPass: o28, hasPolygonOffset: l12, draped: n30, output: c18, depthTestEnabled: f10 } = r24, T7 = o28 === o13.NONE, g9 = l12 ? h12 : null, j4 = o28 === o13.ColorAlpha, b15 = n30 || !f10 || j4 || c18 === n13.Highlight ? null : p6;
    return B({ blending: c18 === n13.Color ? T7 ? o14 : T3(o28) : null, depthTest: f10 && !n30 ? { func: O.LEQUAL } : null, depthWrite: b15, drawBuffers: i4(o28, c18), colorWrite: g4, polygonOffset: g9 });
  }
};
...
var r22 = class extends a6 {
  constructor(e15) {
    super(), this.spherical = e15, this.screenCenterOffsetUnitsEnabled = false, this.occlusionTestEnabled = true, this.signedDistanceFieldEnabled = false, this.sampleSignedDistanceFieldTexelCenter = false, this.vvSize = false, this.vvColor = false, this.hasVerticalOffset = false, this.hasScreenSizePerspective = false, this.hasRotation = false, this.debugDrawLabelBorder = false, this.hasSlicePlane = false, this.hasPolygonOffset = false, this.depthTestEnabled = true, this.pixelSnappingEnabled = true, this.draped = false, this.terrainDepthTest = false, this.cullAboveTerrain = false, this.occlusionPass = false, this.occludedFragmentFade = false, this.objectAndLayerIdColorInstanced = false, this.horizonCullingEnabled = true, this.textureCoordinateType = d5.None, this.emissionSource = d6.None, this.discardInvisibleFragments = true, this.hasSliceInVertexProgram = true, this.hasVvInstancing = false;
  }
};
r([i5()], r22.prototype, "screenCenterOffsetUnitsEnabled", void 0), r([i5()], r22.prototype, "occlusionTestEnabled", void 0), r([i5()], r22.prototype, "signedDistanceFieldEnabled", void 0), r([i5()], r22.prototype, "sampleSignedDistanceFieldTexelCenter", void 0), r([i5()], r22.prototype, "vvSize", void 0), r([i5()], r22.prototype, "vvColor", void 0), r([i5()], r22.prototype, "hasVerticalOffset", void 0), r([i5()], r22.prototype, "hasScreenSizePerspective", void 0), r([i5()], r22.prototype, "hasRotation", void 0), r([i5()], r22.prototype, "debugDrawLabelBorder", void 0), r([i5()], r22.prototype, "hasSlicePlane", void 0), r([i5()], r22.prototype, "hasPolygonOffset", void 0), r([i5()], r22.prototype, "depthTestEnabled", void 0), r([i5()], r22.prototype, "pixelSnappingEnabled", void 0), r([i5()], r22.prototype, "draped", void 0), r([i5()], r22.prototype, "terrainDepthTest", void 0), r([i5()], r22.prototype, "cullAboveTerrain", void 0), r([i5()], r22.prototype, "occlusionPass", void 0), r([i5()], r22.prototype, "occludedFragmentFade", void 0), r([i5()], r22.prototype, "objectAndLayerIdColorInstanced", void 0), r([i5()], r22.prototype, "horizonCullingEnabled", void 0);

// node_modules/@arcgis/core/views/3d/webgl-engine/materials/HUDMaterial.js
var ae = class extends n14 {
  constructor(e15, t28) {
  ...
  intersect(e15, t28, i16, a21, o28, n30) {
    ...
    n11(Te, t28), e15.attributes.has(e7.FEATUREATTRIBUTE) && le(Te);
    const _7 = e15.attributes.get(e7.POSITION), R8 = e15.attributes.get(e7.SIZE), C6 = e15.attributes.get(e7.NORMAL), x9 = e15.attributes.get(e7.ROTATION), P6 = e15.attributes.get(e7.CENTEROFFSETANDDISTANCE);
    s11(_7.size >= 3);
    ...
    for (let s27 = 0; s27 < _7.data.length / _7.size; s27++) {
      ...
      o5(pe, _7.data[e16], _7.data[e16 + 1], _7.data[e16 + 2]), E2(pe, pe, t28), E2(pe, pe, b15.viewMatrix);
      const a22 = s27 * P6.size;
      if (o5(Ae, P6.data[a22], P6.data[a22 + 1], P6.data[a22 + 2]), !D6 && (pe[0] += Ae[0], pe[1] += Ae[1], 0 !== Ae[2])) {
        const e17 = Ae[2];
        A2(Ae, pe), c5(pe, pe, g2(Ae, Ae, e17));
      }
      ...
      if (o5(me, C6.data[o29], C6.data[o29 + 1], C6.data[o29 + 2]), ce(me, Te, b15, _e), this._applyVerticalOffsetTransformationView(pe, _e, b15, he), b15.applyProjection(pe, ue), ue[0] > -1) {
        ...
        if (fe(T7, ue[0], ue[1], xe, t29, a23, c19, A6, y6)) {
          const e18 = i16.ray;
          if (E2(ge, pe, h(ve, b15.viewMatrix)), ue[0] = T7[0], ue[1] = T7[1], b15.unprojectFromRenderScreen(ue, pe)) {
            const t30 = n5();
  ...
  intersectDraped(e15, t28, s27, i16, r24, a21) {
    const o28 = e15.attributes.get(e7.POSITION), n30 = e15.attributes.get(e7.SIZE), c18 = e15.attributes.get(e7.ROTATION), l12 = this.parameters, f10 = E9(l12), { scaleX: h15, scaleY: p14 } = this._getScreenScale(e15, e15.screenToWorldRatio), m9 = Ce * e15.screenToWorldRatio;
  ...
  _updateScaleInfo(e15, t28, s27) {
    ...
    null != i16.screenSizePerspective ? d7(s27, t28, i16.screenSizePerspective, e15.factor) : (e15.factor.scale = 1, e15.factor.factor = 0, e15.factor.minScaleFactor = 0), null != i16.screenSizePerspectiveAlignment ? d7(s27, t28, i16.screenSizePerspectiveAlignment, e15.factorAlignment) : (e15.factorAlignment.factor = e15.factor.factor, e15.factorAlignment.scale = e15.factor.scale, e15.factorAlignment.minScaleFactor = e15.factor.minScaleFactor);
  }
  ...
  _applyPolygonOffsetView(t28, s27, i16, r24, a21) {
    ...
    return g2(a21, t28, c18 > 0 ? f10 : 1 / f10), a21;
  }
  _applyVerticalGroundOffsetView(e15, t28, s27, i16) {
    const r24 = r9(e15), a21 = s27.aboveGround ? 1 : -1, o28 = s27.computeRenderPixelSizeAtDist(r24) * p8, n30 = g2(pe, t28.normal, a21 * o28);
  ...
  _applyVerticalOffsetTransformationView(e15, t28, s27, i16) {
    ...
    const a21 = r9(e15), o28 = r24.screenSizePerspectiveAlignment ?? r24.screenSizePerspective, n30 = i3(s27, a21, r24.verticalOffset, t28.cosAngle, o28);
    return this._updateScaleInfo(i16, a21, t28.cosAngle), g2(t28.normal, t28.normal, n30), u7(e15, e15, t28.normal);
  }
  _applyCenterOffsetView(e15, t28, s27) {
    const i16 = "screen" !== this.parameters.centerOffsetUnits;
    return s27 !== e15 && s8(s27, e15), i16 && (s27[0] += t28[0], s27[1] += t28[1], t28[2] && (A2(me, s27), u7(s27, s27, g2(me, me, t28[2])))), s27;
  }
  ...
  get visible() {
    const { color: e15, outlineSize: t28, outlineColor: s27 } = this.parameters, i16 = e15[3] >= o4 || t28 >= o4 && s27[3] >= o4;
  ...
  _getScreenScale(e15, t28) {
    const s27 = e15.attributes.get(e7.FEATUREATTRIBUTE);
...
function ce(e15, t28, i16, r24) {
  return t19(t28) && (t28 = n11(be, t28)), N3(r24.normal, e15, t28), E2(r24.normal, r24.normal, i16.viewInverseTransposeMatrix), r24.cosAngle = P2(de, Pe), r24;
}
function le(e15) {
...
function fe(e15, s27, i16, r24, a21, c18, l12, f10, h15) {
  ...
  return f10.textureIsSignedDistanceField && null != g9 && (p14 += r24[0] * g9[0], u19 += r24[1] * g9[1], m9 -= r24[0] * (1 - g9[2]), d14 -= r24[1] * (1 - g9[3]), p14 -= c18, m9 += c18, u19 -= c18, d14 += c18), o7(Oe, s27, i16), I(Se, e15, Oe, s4(l12)), Se[0] > p14 && Se[0] < m9 && Se[1] > u19 && Se[1] < d14;
}
var he = new t20();
var pe = n5();
var me = n5();
...
var xe = [0, 0];
var Pe = r6(0, 0, 1);
var ye = class extends h4 {
  constructor() {
    super(...arguments), this.renderOccluded = p5.Occlude, this.isDecoration = false, this.color = e3(1, 1, 1, 1), this.polygonOffset = false, this.anchorPosition = r10(0.5, 0.5), this.screenOffset = [0, 0], this.shaderPolygonOffset = 1e-5, this.textureIsSignedDistanceField = false, this.sampleSignedDistanceFieldTexelCenter = false, this.outlineColor = e3(1, 1, 1, 1), this.outlineSize = 0, this.rotation = 0, this.hasRotation = false, this.vvSizeEnabled = false, this.vvSize = null, this.vvColor = null, this.vvOpacity = null, this.vvSymbolAnchor = null, this.vvSymbolRotationMatrix = null, this.hasSlicePlane = false, this.pixelSnappingEnabled = true, this.occlusionTest = true, this.occludedFragmentFade = false, this.horizonCullingEnabled = false, this.centerOffsetUnits = "world", this.drawInSecondSlot = false, this.depthEnabled = true, this.draped = false, this.isLabel = false;
  }
};
var De = H2().vec3f(e7.POSITION).vec3f(e7.NORMAL).vec2f(e7.UV0).vec4u8(e7.COLOR).vec2f(e7.SIZE).f32(e7.ROTATION).vec4f(e7.CENTEROFFSETANDDISTANCE).vec4f(e7.FEATUREATTRIBUTE);
var je = De.clone().vec4u8(e7.OBJECTANDLAYERIDCOLOR);
var Fe = class {
  constructor() {
    this.vertexBufferLayout = e8() ? je : De;
  }
  elementCount(e15) {
    return 6 * e15.get(e7.POSITION).indices.length;
  }
  write(e15, t28, s27, i16, r24, a21) {
    var _a, _b;
    b8(s27.get(e7.POSITION), e15, r24.position, a21, 6), O4(s27.get(e7.NORMAL), t28, r24.normal, a21, 6);
    const o28 = (_a = s27.get(e7.UV0)) == null ? void 0 : _a.data;
    ...
    let h15 = s27.get(e7.POSITION).indices.length, p14 = a21;
    const m9 = r24.uv0;
    ...
    S(s27.get(e7.COLOR), 4, r24.color, a21, 6);
    const { data: u19, indices: d14 } = s27.get(e7.SIZE);
    h15 = d14.length;
    const g9 = r24.size;
    p14 = a21;
    ...
    if (d8(s27.get(e7.ROTATION), r24.rotation, a21, 6), s27.get(e7.CENTEROFFSETANDDISTANCE) ? p7(s27.get(e7.CENTEROFFSETANDDISTANCE), r24.centerOffsetAndDistance, a21, 6) : B2(r24.centerOffsetAndDistance, a21, 6 * h15), s27.get(e7.FEATUREATTRIBUTE) ? p7(s27.get(e7.FEATUREATTRIBUTE), r24.featureAttribute, a21, 6) : B2(r24.featureAttribute, a21, 6 * h15), null != i16) {
      const e16 = (_b = s27.get(e7.POSITION)) == null ? void 0 : _b.indices;
      if (e16) {
        const t29 = e16.length, s28 = r24.getField(e7.OBJECTANDLAYERIDCOLOR, x3);
...
function _3(e15, r24, t28) {
  const i16 = { usePBR: r24.physicalBasedRenderingEnabled, isSchematic: true, mrrFactors: o11, ambient: s6, diffuse: s6, hasSlicePlane: r24.slicePlaneEnabled, hasSliceHighlight: false, castShadows: r24.castShadows, offsetTransparentBackfaces: !r24.isPrimitive };
...
function R6(e15) {
  ...
  return e15.transparent = t28, e15.opacity = r24, e15.cullFace = t28 ? e6.None : e6.Back, e15;
}
...
var n27 = class {
  ...
  createBuffer(o28, n30) {
    ...
    let l12 = null;
    if (o28.transformation && n30) n7(f8, o28.transformation), f8[12] -= n30[0], f8[13] -= n30[1], f8[14] -= n30[2], l12 = f8;
    else {
      if (n30) throw new Error("not implemented");
      o28.transformation && (l12 = o28.transformation);
    }
    let u19 = null;
    l12 && (h(a16, f8), s7(a16, a16), u19 = a16);
...
var d12 = class {
  ...
  createLodRenderer(r24) {
    const t28 = this._context.generateId("lod-renderer"), s27 = { levels: r24.levels.map((r25) => ({ components: r25.components.map((r26) => {
      const t29 = r26.attributes.get(e7.POSITION);
      if (!t29 || 0 === t29.indices.length) throw new Error("positions attribute expected");
      const s28 = 3, d14 = l3(t29.indices.length / s28), i16 = new o10(d14, s28, t29), o28 = this._context.getRenderGeometryBufferWriter(r26.materialId);
...
async function c17(e15, r24) {
  ...
  if (!n6(i16, s27, 0, l12, f10, 0, o28)) throw new Error("Failed to project coordinates");
  return l12;
}
async function s22(t28, n30) {
  ...
  return n12([s27[0], s27[1], 0], a21, f10, i16), f10;
}
...
function D4(t28 = s6, e15, r24, n30 = 1) {
...
var z5 = r13(-0.5, 0, -0.5);
var Z4 = r13(0.5, 0, -0.5);
var H6 = r13(0, 0, 0.5);
var J3 = r13(0, 0.5, 0);
var K3 = n18();
var Q2 = n18();
...
var X3 = n18();
var Y3 = n18();
c5(K3, z5, J3), c5(Q2, z5, Z4), _(W4, K3, Q2), A2(W4, W4), c5(K3, Z4, J3), c5(Q2, Z4, H6), _(X3, K3, Q2), A2(X3, X3), c5(K3, H6, J3), c5(Q2, H6, z5), _(Y3, K3, Q2), A2(Y3, Y3);
...
function ct(t28, n30, e15, o28, s27 = true, r24 = true) {
  ...
  let a21 = r13(0, l12, 0), f10 = r13(0, l12 + u19, 0), p14 = r13(0, -1, 0), i16 = r13(0, 1, 0);
  o28 && (l12 = u19, f10 = r13(0, 0, 0), a21 = r13(0, l12, 0), p14 = r13(0, 1, 0), i16 = r13(0, -1, 0));
  const w3 = [f10, a21], g9 = [p14, i16], m9 = e15 + 2, M6 = Math.sqrt(u19 * u19 + h15 * h15);
  if (o28) for (let O6 = e15 - 1; O6 >= 0; O6--) {
    const t29 = O6 * (2 * Math.PI / e15), n31 = r13(Math.cos(t29) * h15, l12, Math.sin(t29) * h15);
    w3.push(n31);
    const o29 = r13(u19 * Math.cos(t29) / M6, -h15 / M6, u19 * Math.sin(t29) / M6);
    g9.push(o29);
  }
  ...
  return [[e7.POSITION, new t5(y6, A6, 3, true)], [e7.NORMAL, new t5(N9, I4, 3, true)]];
}
var yt = n5();
...
function a19(e15) {
  const t28 = e15, n30 = t28.get(e7.POSITION).data, r24 = t28.get(e7.NORMAL).data;
  if (r24) {
    const t29 = o27(e15, e7.NORMAL).data;
  ...
  if (n30) {
    const t29 = o27(e15, e7.POSITION).data;
...
function o27(e15, n30) {
  let i16 = e15.get(n30);
  return i16 && !i16.exclusive && (i16 = { ...i16, exclusive: true, data: o9(i16.data) }, e15.set(n30, i16)), i16;
}
...
var j2 = class extends b2 {
  ...
  async add(e15, r24) {
    ...
    const t28 = e15.numFeatures, o28 = true, s27 = u4(c4("cone")), i16 = u5(b4(s27)), n30 = u5(t3(i16, { isPrimitive: o28, width: 100, depth: null, height: null })), c18 = new Float64Array(16 * t28), f10 = new Float64Array(16 * t28), u19 = e15.mapCoordinates;
  ...
  _computeGlobalTransform(e15, r24, t28, o28, s27) {
    return _5[0] = e15, _5[1] = r24, _5[2] = t28, C2(o28, _5, s27, this._context.renderSpatialReference), s27;
  }
...
var l11 = class extends b2 {
  ...
  async add(e15, r24) {
    ...
    const I4 = new t5(l12, A6, 3, true), R8 = new t5(d14, E14, 3, true), f10 = new t5(y6, E14, 2, true), h15 = new t5(c18, E14, 4, true), b15 = new t5(u19, E14, 1, true), j4 = new t5(p14, E14, 2, true), O6 = new t5(w3, E14, 4, true), _7 = [[e7.POSITION, I4], [e7.NORMAL, R8], [e7.UV0, f10], [e7.COLOR, h15], [e7.ROTATION, b15], [e7.SIZE, j4], [e7.CENTEROFFSETANDDISTANCE, O6]], D6 = { attributes: n28(_7), objectAndLayerIdColor: void 0, transformation: e4(), materialId: this.materialId };
...
function t26(r24, e15, t28) {
  return !!n12(r24, e15, i15, t28.spatialReference) && (t28.x = i15[0], t28.y = i15[1], t28.z = i15[2], true);
}
var i15 = n5();
...
function b14(t28) {
  return A5(ft, V2(0, 0, 0, s3(t28).radius));
}
var g8 = 2 ** 50;
function P5() {
...
function T6(n30, o28, r24, i16) {
  return o28 !== i16 && n7(i16, o28), o5(q3, i16[12], i16[13], i16[14]), O5(n30, q3, r24, q3), i16[12] = q3[0], i16[13] = q3[1], i16[14] = q3[2], i16;
}
...
var B5 = class _B {
  ...
  basisMatrixAtPosition(t28, e15) {
    const o28 = this.worldBasisAtPosition(t28, n3.X, c6.get()), i16 = this.worldBasisAtPosition(t28, n3.Y, c6.get()), s27 = this.worldBasisAtPosition(t28, n3.Z, c6.get());
    return r7(e15, o28[0], o28[1], o28[2], 0, i16[0], i16[1], i16[2], 0, s27[0], s27[1], s27[2], 0, 0, 0, 0, 1), e15;
  }
  headingAtPosition(e15, o28) {
    const r24 = this.worldUpAtPosition(e15, c6.get()), i16 = this.worldBasisAtPosition(e15, n3.Y, c6.get()), s27 = u8(o28, i16, r24);
    return M(s27);
  }
  ...
  intersectInfiniteManifold(t28, e15, o28) {
    ...
    Z5(this._coordinateSystem, e15, this._tmpCoordinateSystem);
    const r24 = this._tmpCoordinateSystem.value, s27 = c6.get();
    return x2(r24.plane, t28, s27) ? s8(o28, s27) : null;
  }
  toRenderCoords(t28, e15, o28) {
    return t27(t28) ? c7(t28, e15, this.spatialReference) : n12(t28, e15, o28, this.spatialReference);
  }
  fromRenderCoords(t28, e15, o28 = null) {
    return t27(e15) ? (null != o28 && (e15.spatialReference = o28), t26(t28, this.spatialReference, e15) ? e15 : null) : n12(t28, this.spatialReference, e15, o28) ? e15 : null;
  }
...
var p13 = class extends o.EventedAccessor {
  ...
  async setup({ viewSpatialReference: e15, renderSpatialReference: t28, viewingMode: r24, baseQuery: n30, url: o28, objectIdField: c18, capabilities: d14, fieldsIndex: p14, timeInfo: f10 }) {
    ...
    return this._fetcher = new c9(g9, b3.fromJSON(n30), o28, c18, d14), this._symbolizer = new a20({ viewSpatialReference: g9, renderSpatialReference: S4, viewingMode: r24 }), this._queryEngine = new V3({ hasZ: true, hasM: false, geometryType: "esriGeometryPoint", objectIdField: c18, fieldsIndex: p14, availableFields: [c18], spatialReference: e15, featureStore: this._featureStore, timeInfo: f10 }), this._defaultQueryJSON = new b3({ outSpatialReference: g9 }).toJSON(), this.addHandles(d2(() => this.updating, async (e16) => {
...
//# sourceMappingURL=Feature3DPipelineWorker-RG5FX6WO.js.map
