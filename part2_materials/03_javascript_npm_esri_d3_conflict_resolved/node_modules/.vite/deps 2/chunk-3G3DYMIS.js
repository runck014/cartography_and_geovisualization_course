...
var _2 = class extends t4 {
  ...
  _runProgram(n7) {
    ...
    const A4 = new x(d2, _4), b2 = E2.createVertex(d2, F.STATIC_DRAW, new Uint16Array([0, 0, 1, 0, 0, 1, 1, 1])), g = new o3(d2, /* @__PURE__ */ new Map([["position", 0]]), /* @__PURE__ */ new Map([["geometry", [new t2("position", 2, C.UNSIGNED_SHORT, 0, 4)]]]), /* @__PURE__ */ new Map([["geometry", b2]])), B2 = r2(5633261287538229e-9, 2626832878767164e-9, 1.4349880495278358e6), w = r2(563327146742708e-8, 2.6268736381334523e6, 1434963231608387e-9), F2 = new Float32Array(6);
    t(B2, F2, 3);
    const O2 = new Float32Array(6);
    t(w, O2, 3), d2.useProgram(n7), n7.setUniform3f("u_highA", F2[0], F2[2], F2[4]), n7.setUniform3f("u_lowA", F2[1], F2[3], F2[5]), n7.setUniform3f("u_highB", O2[0], O2[2], O2[4]), n7.setUniform3f("u_lowB", O2[1], O2[3], O2[5]), d2.bindFramebuffer(A4), d2.setViewport(0, 0, 1, 1), d2.bindVAO(g), d2.drawArrays(E.TRIANGLE_STRIP, 0, 4);
...
var b = class extends t4 {
  ...
  _test(g) {
    ...
    const _4 = new x(b2, d2), w = E2.createVertex(b2, F.STATIC_DRAW, new Uint16Array([0, 0, 1, 0, 0, 1, 1, 1])), A4 = new o3(b2, /* @__PURE__ */ new Map([["a_pos", 0]]), /* @__PURE__ */ new Map([["geometry", [new t2("a_pos", 2, C.UNSIGNED_SHORT, 0, 4)]]]), /* @__PURE__ */ new Map([["geometry", w]]));
...
//# sourceMappingURL=chunk-3G3DYMIS.js.map
