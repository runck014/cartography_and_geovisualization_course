...
var h = class _h {
  ...
  static fromRgb(r3, s2) {
    ...
    if (e) {
      const r4 = e[2].split(/\s*,\s*/), i2 = e[1];
      if ("rgb" === i2 && 3 === r4.length || "rgba" === i2 && 4 === r4.length) {
        const t = r4[0];
      ...
      if ("hsl" === i2 && 3 === r4.length || "hsla" === i2 && 4 === r4.length) return _h.fromArray(i(parseFloat(r4[0]), parseFloat(r4[1]) / 100, parseFloat(r4[2]) / 100, parseFloat(r4[3])), s2);
    }
    return null;
  }
  static fromHex(t, r3 = new _h()) {
    ...
    switch (t.length) {
      case 4:
      case 5: {
        const s2 = parseInt(t.slice(1, 2), 16), e = parseInt(t.slice(2, 3), 16), i2 = parseInt(t.slice(3, 4), 16), a2 = 5 === t.length ? 15 : parseInt(t.slice(4), 16);
        return _h.fromArray([s2 + 16 * s2, e + 16 * e, i2 + 16 * i2, (a2 + 16 * a2) / 255], r3);
      }
      case 7:
      case 9: {
        const s2 = parseInt(t.slice(1, 3), 16), e = parseInt(t.slice(3, 5), 16), i2 = parseInt(t.slice(5, 7), 16), a2 = 7 === t.length ? 255 : parseInt(t.slice(7), 16);
        return _h.fromArray([s2, e, i2, a2 / 255], r3);
      }
      default:
        return null;
    }
  ...
  static fromString(t, e) {
    const i2 = r2(t) ? l(t) : null;
    return i2 && _h.fromArray(i2, e) || _h.fromRgb(t, e) || _h.fromHex(t, e);
  }
  static fromJSON(t) {
  ...
  toHex(t) {
    const r3 = (t == null ? void 0 : t.capitalize) ?? false, s2 = (t == null ? void 0 : t.digits) ?? 6, e = 3 === s2 || 4 === s2, i2 = 4 === s2 || 8 === s2, a2 = `#${o(this.r, e)}${o(this.g, e)}${o(this.b, e)}${i2 ? o(Math.round(255 * this.a), e) : ""}`;
...
//# sourceMappingURL=chunk-VFTH6C2E.js.map
