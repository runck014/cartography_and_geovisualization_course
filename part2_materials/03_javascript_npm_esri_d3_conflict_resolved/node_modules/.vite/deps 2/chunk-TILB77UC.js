...
var a = class {
  ...
  finishFeatureResult(o2) {
    if (!(o2 == null ? void 0 : o2.features) || !o2.hasZ || !this._options.sourceSpatialReference || !o2.spatialReference || s2(o2.spatialReference, this._options.sourceSpatialReference) || o2.spatialReference.vcsWkid) return;
...
function p(e3, t2, s5) {
  const r = 3, a3 = e3.asUnsafe(), n4 = t2.createPointGeometry(s5);
  for (; a3.next(); ) switch (a3.tag()) {
    case r: {
      const e4 = a3.getUInt32(), s6 = a3.pos() + e4;
      let r2 = 0;
      for (; a3.pos() < s6; ) t2.addCoordinatePoint(n4, a3.getSInt64(), r2++);
      break;
    }
    default:
      a3.skip();
...
function u(e3, t2, s5) {
  const r = 2, a3 = 3, n4 = e3.asUnsafe(), i2 = t2.createGeometry(s5), o2 = 2 + (s5.hasZ ? 1 : 0) + (s5.hasM ? 1 : 0);
  for (; n4.next(); ) switch (n4.tag()) {
    case r: {
      const e4 = n4.getUInt32(), s6 = n4.pos() + e4;
      let r2 = 0;
      for (; n4.pos() < s6; ) t2.addLength(i2, n4.getUInt32(), r2++);
      break;
    }
    case a3: {
      const e4 = n4.getUInt32(), s6 = n4.pos() + e4;
      let r2 = 0;
      for (t2.allocateCoordinates(i2); n4.pos() < s6; ) t2.addCoordinate(i2, n4.getSInt64(), r2), r2++, r2 === o2 && (r2 = 0);
      break;
    }
    default:
      n4.skip();
...
function f(e3) {
  const t2 = 1, a3 = 2, n4 = 3, i2 = e3.asUnsafe(), o2 = new s3();
...
function y(e3) {
  const t2 = 1, s5 = 2, r = 3, a3 = 4, n4 = 5, i2 = 6, o2 = 7, c2 = 8, l2 = 9, g2 = e3.asUnsafe();
...
function b(e3) {
  const t2 = 1, s5 = 2, r = 3, a3 = 4, n4 = 5, i2 = 6, l2 = e3.asUnsafe(), g2 = { type: o(0) };
...
function k(e3) {
  const t2 = 1, s5 = 2, r = {}, a3 = e3.asUnsafe();
  for (; a3.next(); ) switch (a3.tag()) {
    case t2:
      r.name = a3.getString();
      break;
...
function d(e3, t2, s5, r) {
  const a3 = 1, n4 = 2, i2 = 4, o2 = t2.createFeature(s5);
  let c2 = 0;
  for (; e3.next(); ) switch (e3.tag()) {
    case a3: {
      const t3 = r[c2++].name;
      o2.attributes[t3] = e3.processMessage(y);
      break;
    }
    case n4:
      o2.geometry = e3.processMessageWithArgs(u, t2, s5);
      break;
    case i2:
      o2.centroid = e3.processMessageWithArgs(p, t2, s5);
      break;
    default:
      e3.skip();
  }
...
function T(e3) {
  const t2 = 1, s5 = 2, r = 3, a3 = 4, n4 = [1, 1, 1, 1], i2 = e3.asUnsafe();
  for (; i2.next(); ) switch (i2.tag()) {
    case t2:
      n4[0] = i2.getDouble();
      break;
...
function m(e3) {
  const t2 = 1, s5 = 2, r = 3, a3 = 4, n4 = [0, 0, 0, 0], i2 = e3.asUnsafe();
  for (; i2.next(); ) switch (i2.tag()) {
    case t2:
      n4[0] = i2.getDouble();
      break;
...
function h(e3) {
  const t2 = 1, s5 = 2, r = 3, a3 = { originPosition: l(0) }, n4 = e3.asUnsafe();
  for (; n4.next(); ) switch (n4.tag()) {
    case t2:
...
function F(e3) {
  const t2 = 1, s5 = 2, r = 3, a3 = {}, n4 = e3.asUnsafe();
  for (; n4.next(); ) switch (n4.tag()) {
    case t2:
...
function q(e3, t2) {
  const s5 = 1, r = 2, a3 = 3, n4 = 4, i2 = 5, o2 = t2.createSpatialReference();
  for (; e3.next(); ) switch (e3.tag()) {
    case s5:
...
function I(e3, t2) {
  const s5 = 1, r = 2, a3 = 3, n4 = 4, i2 = 5, o2 = 7, c2 = 8, l2 = 9, p2 = 10, u2 = 11, f2 = 12, y2 = 13, T2 = 15, m2 = t2.createFeatureResult(), I2 = e3.asUnsafe();
...
function S(s5, r) {
  try {
    const e3 = 2, a3 = new n(new Uint8Array(s5), new DataView(s5)), n4 = {};
...
function t(t2, r) {
  const u2 = S(t2, r), o2 = u2.queryResult.featureResult, s5 = u2.queryResult.queryGeometry, y2 = u2.queryResult.queryGeometryType;
  if (o2 && o2.features && o2.features.length && o2.objectIdFieldName) {
    const e3 = o2.objectIdFieldName;
    for (const t3 of o2.features) t3.attributes && (t3.objectId = t3.attributes[e3]);
  }
  return o2 && (o2.queryGeometry = s5, o2.queryGeometryType = y2), o2;
}
...
//# sourceMappingURL=chunk-TILB77UC.js.map
