...
import {
  m as m8
} from "./chunk-TRMW5XQP.js";
import {
  g as g5,
  i as i8,
  m as m9,
  r as r14
} from "./chunk-HBU7EMDX.js";
import {
  a as a3,
  e as e10,
  l as l6
...
var o13 = (o32) => {
  ...
  return r([m()], g13.prototype, "breakpoints", null), r([m()], g13.prototype, "orientation", void 0), r([m()], g13.prototype, "widthBreakpoint", void 0), r([m()], g13.prototype, "heightBreakpoint", void 0), g13 = r([a("esri.views.BreakpointsOwner")], g13), g13;
};
...
r([m({ readOnly: true })], a4.prototype, "surface", void 0), r([m({ readOnly: true })], a4.prototype, "items", void 0), r([m({ readOnly: true })], a4.prototype, "needsRender", null), r([m({ readOnly: true })], a4.prototype, "_watchUpdatingTracking", void 0), r([m({ readOnly: true })], a4.prototype, "updating", null), a4 = r([a("esri.views.overlay.ViewOverlay")], a4);
var c8 = a4;
...
var w4 = (p27) => {
  ...
  return r([m()], w11.prototype, "container", null), r([m({ readOnly: true })], w11.prototype, "focused", null), r([m({ readOnly: true })], w11.prototype, "height", void 0), r([m()], w11.prototype, "messagesCommon", void 0), r([m({ type: c8 })], w11.prototype, "overlay", void 0), r([m({ readOnly: true })], w11.prototype, "position", void 0), r([m({ readOnly: true })], w11.prototype, "resizing", void 0), r([m({ readOnly: true })], w11.prototype, "root", void 0), r([m({ value: null, readOnly: true })], w11.prototype, "size", null), r([m({ readOnly: true })], w11.prototype, "surface", void 0), r([m({ readOnly: true })], w11.prototype, "suspended", void 0), r([m()], w11.prototype, "ui", void 0), r([m({ readOnly: true })], w11.prototype, "userContent", void 0), r([m({ readOnly: true })], w11.prototype, "width", void 0), r([m()], w11.prototype, "widthBreakpoint", void 0), w11 = r([a("esri.views.DOMContainer")], w11), w11;
};
...
var w5 = (a22) => {
  let w11 = class extends a22 {
    ...
    async setupPopup() {
      ...
      if ((_a = this._popupSetupTask) == null ? void 0 : _a.abort(), this.popup && !m13(this.popup)) return this._popupSetupTask = d2(async (p27) => {
        const { default: e25 } = await import("./Popup-7ZP724DX.js");
        if (s3(p27), !this.popup || m13(this.popup)) return;
  ...
  return r([m()], w11.prototype, "popup", void 0), r([m()], w11.prototype, "popupEnabled", void 0), w11 = r([a("esri.views.PopupView")], w11), w11;
};
var y2 = class {
  constructor(p27) {
...
r([m({ constructOnly: true })], n17.prototype, "view", void 0), r([m({ readOnly: true })], n17.prototype, "baseLayerViews", void 0), r([m({ readOnly: true })], n17.prototype, "referenceLayerViews", void 0), r([m({ readOnly: true })], n17.prototype, "suspended", null), r([m({ type: Boolean, readOnly: true })], n17.prototype, "updating", null), n17 = r([a("esri.views.BasemapView")], n17);
var p5 = n17;
...
var L3 = class {
  constructor(e25, r30, t29) {
    this.layer = e25, this.view = r30, this.layerViewImporter = t29, this._controller = new AbortController(), this._deferred = L(), this._started = false, this.done = false, this.promise = this._deferred.promise, m2(this._controller.signal, () => {
  ...
  async start() {
    ...
    try {
      ...
      if (await r30.load({ signal: e25 }), r30.prefetchResources && await r30.prefetchResources({ signal: e25 }), C3(r30)) o32 = await r30.createLayerView(t29, { signal: e25 });
        ...
        s3(e25), o32 = "default" in s28 ? new s28.default({ layer: r30, view: t29 }) : new s28({ layer: r30, view: t29 });
      }
      const n33 = () => {
        l21 = l(l21), o32.destroyed || o32.destroy(), o32.layer = null, o32.parent = null, o32.view = null, this.done = true;
      };
      l21 = m2(e25, n33), s3(e25);
      try {
        await o32.when();
      } catch (s28) {
        throw n33(), s28;
...
var M5 = class extends b2 {
  constructor(e25) {
    super(e25), this._layerLayerViewInfoMap = /* @__PURE__ */ new Map(), this._recyclingInfoMap = /* @__PURE__ */ new Map(), this._watchUpdatingTracking = new h6(), this.supportsGround = true, this._preloadLayerViewModules = () => {
      ...
      for (const o32 of this._rootCollectionNames) s28(o(this, o32));
  ...
  get updating() {
    return null != this._workPromise || this._watchUpdatingTracking.updating || n2(this._layerLayerViewInfoMap, (e25) => !e25.done) || this._recyclingInfoMap.size > 0;
  }
  ...
  _refreshCollections() {
    for (const [e25, r30] of this._layersToLayerViews) this._populateLayerViewsOwners(o(this, e25), o(this, r30), this.view);
...
r([m()], M5.prototype, "_workPromise", void 0), r([m({ readOnly: true })], M5.prototype, "_watchUpdatingTracking", void 0), r([m({ readOnly: true })], M5.prototype, "_layersToLayerViews", null), r([m({ readOnly: true })], M5.prototype, "_rootCollectionNames", null), r([m()], M5.prototype, "layerViewImporter", void 0), r([m()], M5.prototype, "supportsGround", void 0), r([m({ readOnly: true })], M5.prototype, "updating", null), r([m({ readOnly: true })], M5.prototype, "updatingRemaining", null), r([m({ constructOnly: true })], M5.prototype, "view", void 0), M5 = r([a("esri.views.LayerViewManager")], M5);
var I3 = M5;
function C3(e25) {
...
var i9 = class extends b2 {
  constructor(o32) {
    super(o32), this.factor = 1.5, this.offset = c4(0, 0), this.position = null, this.size = 120, this.maskUrl = null, this.maskEnabled = true, this.overlayUrl = null, this.overlayEnabled = true, this.visible = true;
  }
  get version() {
...
r([m({ type: Number })], i9.prototype, "factor", void 0), r([m({ nonNullable: true })], i9.prototype, "offset", void 0), r([m()], i9.prototype, "position", void 0), r([m({ type: Number, range: { min: 0 } })], i9.prototype, "size", void 0), r([m()], i9.prototype, "maskUrl", void 0), r([m()], i9.prototype, "maskEnabled", void 0), r([m()], i9.prototype, "overlayUrl", void 0), r([m()], i9.prototype, "overlayEnabled", void 0), r([m({ readOnly: true })], i9.prototype, "version", null), r([m({ type: Boolean })], i9.prototype, "visible", void 0), i9 = r([a("esri.views.Magnifier")], i9);
var p6 = i9;
...
var y3 = class extends o5.EventedAccessor {
  constructor(e25) {
    super(e25), this._selectionMap = new s9(), this._sources = new V(), this._trashCan = [], this._layerEditHandles = new V(), this._vizTaskId = 0, this.showHighlight = true;
  }
  initialize() {
    ...
    this.view.when().then(() => {
      this.view.map && (this.view.map.allLayers.flatten((e26) => "sublayers" in e26 && e26.sublayers ? e26.sublayers : null).forEach((t29) => {
        (e12(t29) && !c5(t29) || l2(t29)) && e25.add(t29);
      }), this.sources = e25);
    });
  }
  destroy() {
...
r([m({ readOnly: true, nonNullable: true })], y3.prototype, "selections", null), r([m({ readOnly: true, nonNullable: true })], y3.prototype, "count", null), r([m({ constructOnly: true, nonNullable: true })], y3.prototype, "view", void 0), r([m({ readOnly: true, nonNullable: true })], y3.prototype, "hasSelection", null), r([m()], y3.prototype, "showHighlight", void 0), r([m()], y3.prototype, "sources", null), y3 = r([a("esri.views.SelectionManager")], y3);
var v7 = (e25) => {
  var _a;
...
var p7 = class extends i2(b2) {
  constructor(o32) {
    super(o32), this.accentColor = new l3([255, 127, 0]), this.textColor = new l3([255, 255, 255]);
  }
};
r([m({ type: l3, nonNullable: true })], p7.prototype, "accentColor", void 0), r([m({ type: l3, nonNullable: true })], p7.prototype, "textColor", void 0), p7 = r([a("esri.views.Theme")], p7);
var l8 = p7;
...
var c9 = class {
  ...
  on(e25, n33, a22, r30) {
    ...
    return this.inputManager && this.inputManager.installHandlers(m26, [d21], r30), e(() => this._removeHandler(m26, o32));
  }
  hasHandler(t29) {
...
function d8(t29, e25) {
  ...
  return { type: "click", pointerType: a22, button: i22, buttons: r30, x: o32, y: s28, native: p27, timestamp: u17, screenPoint: c4(o32, s28), mapPoint: b5(t29, o32, s28), eventId: c26, cancelable: l21, stopPropagation: () => e25.stopPropagation(), async: (t30) => e25.async(t30), preventDefault: () => e25.preventDefault() };
}
function g7(t29, e25) {
...
function b5(t29, e25, a22) {
  return t29.toMap(c4(e25, a22), { exclude: [] });
}
function f6(t29) {
...
var i11 = class {
  ...
  _updateFocusedManipulatorTools(t29) {
    ...
    this._grabbedManipulators.forEach(({ tool: e25 }) => {
      ...
      const r30 = this._grabbedManipulators.values(), i22 = o2(r30, ({ tool: e25 }) => e25 === t30);
  ...
  updateHoveredStateFromKnownPointers(e25) {
    this._pointerLocations.forEach((t29, a22) => {
      this._updateHoveredStateForPointerAtScreenPosition(c4(t29.x, t29.y), a22, t29.pointerType, e25);
    });
  }
...
r([m({ nonNullable: true, readOnly: true })], n19.prototype, "nativeIndex", void 0), r([m({ type: String, readOnly: true })], n19.prototype, "deviceType", null), r([m({ type: Number, readOnly: true })], n19.prototype, "axisThreshold", null), n19 = r([a("esri.views.input.gamepad.GamepadInputDevice")], n19);
var o16 = n19;
...
r([m({ type: V.ofType(o16), readOnly: true })], p10.prototype, "devices", void 0), r([m({ type: ["document", "view", "none"] })], p10.prototype, "enabledFocusMode", void 0), p10 = r([a("esri.views.input.gamepad.GamepadSettings")], p10);
var i13 = p10;
...
r([m({ readOnly: true })], p11.prototype, "gamepad", void 0), p11 = r([a("esri.views.input.Input")], p11);
var a6 = p11;
...
r([m({ type: Boolean, nonNullable: true })], s15.prototype, "enabled", void 0), r([m({ type: o16 })], s15.prototype, "device", void 0), r([m({ type: ["pan", "zoom"], nonNullable: true })], s15.prototype, "mode", void 0), r([m({ type: ["forward-down", "forward-up"], nonNullable: true })], s15.prototype, "tiltDirection", void 0), r([m({ type: Number, nonNullable: true })], s15.prototype, "velocityFactor", void 0), s15 = r([a("esri.views.navigation.gamepad.GamepadSettings")], s15);
var i14 = s15;
...
r([m({ type: Boolean })], m15.prototype, "browserTouchPanEnabled", void 0), r([m({ type: i14, nonNullable: true })], m15.prototype, "gamepad", void 0), r([m({ type: Boolean })], m15.prototype, "momentumEnabled", void 0), r([m({ type: Boolean })], m15.prototype, "mouseWheelZoomEnabled", void 0), m15 = r([a("esri.views.navigation.Navigation")], m15);
var p12 = m15;
...
function l11(e25) {
  ...
  return !(null == a22 && null != i22 && "ImageServer" === i22.serverType) && h10(e25) && e25.heightModelInfo ? e25.heightModelInfo : d9(e25) ? v4.deriveUnitFromSR(p13, e25.spatialReference) : null;
}
function h10(e25) {
...
var p13 = new v4({ heightModel: "gravity-related-height" });

// node_modules/@arcgis/core/views/support/projectionUtils.js
var n20;
var s16 = null;
async function c11(r30) {
  s16 || (s16 = import("./geometryServiceUtils-MNTFMAGI.js").then((e25) => n20 = e25)), await s16, s3(r30);
}
...
var d10 = class extends b2 {
  ...
  get _extentTask() {
    ...
    return i22.extent.equals(this._projectExtentTask.input) && r30.equals(this._projectExtentTask.spatialReference) ? { extent: this._projectExtentTask.output, updating: null != this._projectExtentTask.task && !this._projectExtentTask.task.finished } : (null != this._projectExtentTask.task && (this._projectExtentTask.task = e2(this._projectExtentTask.task)), this._projectExtentTask = { input: i22.extent.clone(), output: null, spatialReference: r30.clone(), task: d2(async (e26) => {
      try {
...
r([m()], d10.prototype, "required", void 0), r([m({ constructOnly: true })], d10.prototype, "map", void 0), r([m({ constructOnly: true })], d10.prototype, "getSpatialReferenceSupport", void 0), r([m()], d10.prototype, "defaultSpatialReference", void 0), r([m()], d10.prototype, "userSpatialReference", void 0), r([m()], d10.prototype, "sourcePreloadCount", void 0), r([m()], d10.prototype, "priorityCollection", void 0), r([m()], d10.prototype, "requiresExtentInSpatialReference", void 0), r([m()], d10.prototype, "suspended", void 0), r([m({ readOnly: true })], d10.prototype, "ready", null), r([m({ readOnly: true })], d10.prototype, "heightModelInfoReady", null), r([m({ readOnly: true })], d10.prototype, "spatialReference", null), r([m({ readOnly: true })], d10.prototype, "extent", null), r([m({ readOnly: true })], d10.prototype, "heightModelInfo", null), r([m({ readOnly: true })], d10.prototype, "vcsWkid", null), r([m({ readOnly: true })], d10.prototype, "latestVcsWkid", null), r([m({ readOnly: true })], d10.prototype, "viewingMode", null), r([m({ readOnly: true })], d10.prototype, "tileInfo", null), r([m({ readOnly: true })], d10.prototype, "mapCollections", null), r([m({ readOnly: true })], d10.prototype, "_spatialReferenceTask", null), r([m({ readOnly: true })], d10.prototype, "_tileInfoTask", null), r([m({ readOnly: true })], d10.prototype, "_heightModelInfoTask", null), r([m({ readOnly: true })], d10.prototype, "_extentCandidatesTask", null), r([m()], d10.prototype, "_extentTask", null), r([m()], d10.prototype, "_projectExtentTask", void 0), d10 = r([a("esri.views.support.DefaultsFromMap")], d10);
var f9 = class {
  constructor(e25, t29) {
...
var G = W2 = class extends o5.EventedMixin(n5(b2)) {
  constructor(e25) {
    super(e25), this._userSpatialReference = null, this._cursor = null, this.handles = new r3(), this.updatingHandles = new h6(), this.allLayerViews = new n8({ getCollections: () => {
      var _a, _b, _c;
  ...
  set map(e25) {
    e25 !== this._get("map") && ((e25 == null ? void 0 : e25.destroyed) && (n.getLogger(this).warn("#map", "The provided map is already destroyed", { map: e25 }), e25 = null), m5.isLoadable(e25) && e25.load().catch(() => {
...
G.views = new V(), r([m()], G.prototype, "_userSpatialReference", void 0), r([m()], G.prototype, "activeTool", null), r([m({ readOnly: true })], G.prototype, "allLayerViews", void 0), r([m()], G.prototype, "groundView", void 0), r([m()], G.prototype, "animation", null), r([m()], G.prototype, "basemapView", void 0), r([m()], G.prototype, "center", null), r([m()], G.prototype, "defaultsFromMapSettings", null), r([m()], G.prototype, "defaultsFromMap", null), r([m()], G.prototype, "fatalError", void 0), r([m({ type: w3 })], G.prototype, "extent", null), r([m(l5(c6, "graphics"))], G.prototype, "graphics", void 0), r([m(l5(t12, "analyses"))], G.prototype, "analyses", void 0), r([m({ readOnly: true, type: v4 })], G.prototype, "heightModelInfo", null), r([m({ readOnly: true })], G.prototype, "interacting", null), r([m({ readOnly: true })], G.prototype, "navigating", null), r([m({ readOnly: true, dependsOn: ["fatalError", "_isValid", "_readyCycleForced", "map", "map.loaded?", "width", "height", "spatialReference", "_lockedSpatialReference", "defaultsFromMap.ready", "typeSpecificPreconditionsReady"] })], G.prototype, "preconditionsReady", null), r([m({ readOnly: true })], G.prototype, "typeSpecificPreconditionsReady", void 0), r([m({ type: V, readOnly: true })], G.prototype, "layerViews", void 0), r([m()], G.prototype, "resolution", null), r([m({ type: p6 })], G.prototype, "magnifier", void 0), r([m({ value: null, type: L2 })], G.prototype, "map", null), r([m()], G.prototype, "padding", void 0), r([m({ readOnly: true })], G.prototype, "ready", void 0), r([m({ type: g3 })], G.prototype, "spatialReference", null), r([m()], G.prototype, "spatialReferenceWarningDelay", void 0), r([m()], G.prototype, "stationary", null), r([m({ readOnly: true })], G.prototype, "supportsGround", void 0), r([m({ type: p2 })], G.prototype, "timeExtent", null), r([m({ type: String, nonNullable: true })], G.prototype, "timeZone", null), r([m()], G.prototype, "tools", null), r([m()], G.prototype, "toolViewManager", void 0), r([m({ readOnly: true })], G.prototype, "type", void 0), r([m({ type: Number })], G.prototype, "scale", void 0), r([m({ readOnly: true })], G.prototype, "updating", void 0), r([m({ readOnly: true })], G.prototype, "initialExtentRequired", void 0), r([m({ readOnly: true })], G.prototype, "initialExtent", null), r([m()], G.prototype, "cursor", null), r([m({ readOnly: true })], G.prototype, "input", void 0), r([m({ type: p12, nonNullable: true })], G.prototype, "navigation", void 0), r([m()], G.prototype, "layerViewManager", void 0), r([m()], G.prototype, "analysisViewManager", void 0), r([m()], G.prototype, "selectionManager", void 0), r([m()], G.prototype, "width", void 0), r([m()], G.prototype, "height", void 0), r([m({ readOnly: true })], G.prototype, "resizing", void 0), r([m({ value: null, readOnly: true })], G.prototype, "size", null), r([m({ readOnly: true })], G.prototype, "suspended", void 0), r([m({ readOnly: true })], G.prototype, "viewEvents", void 0), r([m({ readOnly: true })], G.prototype, "persistableViewModels", void 0), r([m()], G.prototype, "_isValid", void 0), r([m()], G.prototype, "_readyCycleForced", void 0), r([m()], G.prototype, "_lockedSpatialReference", void 0), r([m()], G.prototype, "_userTimeZone", void 0), r([m()], G.prototype, "_lockedTimeZone", void 0), r([m()], G.prototype, "_userTimeExtent", void 0), r([m()], G.prototype, "_lockedTimeExtent", void 0), r([m({ type: l8 })], G.prototype, "theme", void 0), r([m({ readOnly: true, type: l8 })], G.prototype, "effectiveTheme", null), G = W2 = r([a("esri.views.View")], G);
...
r([m({ readOnly: true })], p15.prototype, "done", null), r([m({ readOnly: true, type: String })], p15.prototype, "state", void 0), r([m()], p15.prototype, "target", void 0), p15 = r([a("esri.views.ViewAnimation")], p15), function(t29) {
...
var W3 = G2 = class extends f {
  ...
  copy(t29) {
    ...
    return e25 && i22 ? (this.viewpoint = Z(e25, t29.viewpoint), this._set("size", r9(i22, t29.size))) : (this.viewpoint = t29.viewpoint.clone(), this._set("size", [t29.size[0], t29.size[1]])), this._set("pixelRatio", t29.pixelRatio), this;
  }
  clone() {
  ...
  _update() {
    const { center: t29, spatialReference: e25, scale: s28, rotation: o32 } = this._viewpoint2D, h20 = this._get("pixelRatio") || 1, c26 = this._get("size"), u17 = new m4({ targetGeometry: new j(t29[0], t29[1], e25), scale: s28, rotation: o32 });
    if (this._set("viewpoint", u17), !c26 || !e25 || !s28) return;
    this.resolution = ot(u17), this.rotation = o32, this.scale = s28, this.spatialReference = e25, r9(this.center, t29);
    const j5 = 0 !== c26[0] ? 2 / c26[0] : 0, g13 = 0 !== c26[1] ? -2 / c26[1] : 0;
    r8(this.displayMat3, j5, 0, 0, 0, g13, 0, -1, 1, 1);
    const R2 = o8(this.viewMat3), _11 = t6(c26[0] / 2, c26[1] / 2), M8 = t6(-c26[0] / 2, -c26[1] / 2), b8 = u5(o32);
...
r([m({ readOnly: true })], W3.prototype, "id", void 0), r([m({ value: 1, json: { write: true } })], W3.prototype, "pixelRatio", null), r([m({ json: { write: true } })], W3.prototype, "size", null), r([m()], W3.prototype, "spatialReference", void 0), r([m({ type: m4, json: { write: true } })], W3.prototype, "viewpoint", null), r([m({ readOnly: true })], W3.prototype, "visibleArea", null), W3 = G2 = r([a("esri.views.2d.ViewState")], W3);
var L4 = W3;
...
r([m()], g10.prototype, "left", void 0), r([m()], g10.prototype, "top", void 0), r([m()], g10.prototype, "right", void 0), r([m()], g10.prototype, "bottom", void 0), g10 = l12 = r([a("esri.views.2d.PaddedViewState.Padding")], g10);
  ...
  constructor(...t29) {
    super(...t29), this.paddedViewState = new L4(), this._updateContent = (() => {
      ...
      return () => {
        ...
        o9(t30, i22.left + i22.right, i22.top + i22.bottom), e6(t30, e25, t30), r9(o32.size, t30);
...
r([m()], w7.prototype, "paddedViewState", void 0), r([m({ type: g10 })], w7.prototype, "padding", null), r([m()], w7.prototype, "viewpoint", null), w7 = m16 = r([a("esri.views.2d.PaddedViewState")], w7);
var f10 = w7;

// node_modules/@arcgis/core/views/2d/pointToPoint/Camera.js
var a8 = class {
  constructor(e25) {
    this._view = e25, this.viewpoint = new m4({ targetGeometry: new j(), scale: 0, rotation: 0 });
  }
  get view() {
    return this._view;
  }
...
var o19 = { desiredScreenFlow: 2, minDuration: n3(500), maxDuration: n3(8e3) };
var r18 = { ...o19, maxDuration: n3(4e3) };
...
var p17 = class {
  ...
  constructor(i22) {
    this._time = n3(0), this._easing = w8, this.definition = new r19(i22), this.path = new s18();
  }
  update(t29, a22, o32) {
    this.definition.update(t29, a22, o32), this.path.update(this.definition, o32), this._time = this._applyTimeSettings(r4(isFinite(this.path.time) ? this.path.time : t3(0)), o32), this._easing = o32.easing ?? (this._time >= 1e3 ? w8 : f11);
  }
  cameraAt(t29, i22) {
  ...
  _applyTimeSettings(i22, e25) {
    ...
    return i22 = null != e25.duration ? e25.duration : n3(Math.min(Math.max(i22 / n33, s28), a22));
  }
};
...
var T2 = class extends b2 {
  constructor(t29) {
    super(t29), this._animation = null, this._destinationViewState = new f10(), this.updateFunction = null, this.easing = t7.ease, this.viewpoint = new m4({ targetGeometry: new j(), scale: 0, rotation: 0 }), this._updateTask = A2({ postRender: this._postRender.bind(this) }), this._updateTask.pause(), this._transition = new y6(t29.view);
  }
  destroy() {
  ...
  animate(t29, i22, e25) {
    ...
    this._transition.update(this.viewpoint, s28, { apex: { maximumDistance: Math.min(Math.min(i22.scale, s28.scale) * j4, this.view.constraints.effectiveMinScale), desiredSlope: 5e-8 }, duration: e25 == null ? void 0 : e25.duration, maxDuration: "auto" === (e25 == null ? void 0 : e25.animationMode) ? n3(1 / 0) : (e25 == null ? void 0 : e25.maxDuration) ?? r18.maxDuration, speedFactor: e25 == null ? void 0 : e25.speedFactor, easing: "function" == typeof o32 ? (t30) => o32(t30) : void 0 }), "auto" === (e25 == null ? void 0 : e25.animationMode) && (this._destinationViewState.copy(this.view.state), this._destinationViewState.viewpoint = s28, x(this._transition.animation, e25, this.view.state, this._destinationViewState) || this._transition.update(this.viewpoint, s28, { duration: n3(0) }));
    const r30 = () => {
...
function x(t29, i22, e25, n33) {
  ...
  if (a22) {
    const t30 = 1.5, i23 = n11(), a23 = c4(...n33.toScreen(i23, ...e25.center)), p27 = c4(...e25.toScreen(i23, ...n33.center)), u17 = null != p27 && p27.x > -(t30 - 0.5) * e25.size[0] && p27.x < (t30 + 0.5) * e25.size[0] && p27.y > -(t30 - 0.5) * e25.size[1] && p27.y < (t30 + 0.5) * e25.size[1], c26 = null != a23 && a23.x > -(t30 - 0.5) * n33.size[0] && a23.x < (t30 + 0.5) * n33.size[0] && a23.y > -(t30 - 0.5) * n33.size[1] && a23.y < (t30 + 0.5) * n33.size[1];
...
r([m()], T2.prototype, "easing", void 0), r([m()], T2.prototype, "view", void 0), r([m()], T2.prototype, "viewpoint", void 0), T2 = r([a("esri.views.2d.AnimationManager")], T2);
var S4 = T2;
...
var h14 = class extends b2 {
  ...
  _gotoImmediate(t29, o32) {
    const e25 = this._gotoTask, r30 = this.view.animation, a22 = t29.then((t30) => {
      if (s3(o32), e25 !== this._gotoTask) throw new s("view:goto-interrupted", "Goto was interrupted");
  ...
  _cancellableGoTo(t29, o32, e25, i22) {
    ...
    return h3(e25, i22).finally(() => {
      r30() && (o32.done || o32.stop());
    });
  }
};
r([m({ constructOnly: true })], h14.prototype, "view", void 0), h14 = r([a("esri.views.2d.GoToManager")], h14);

// node_modules/@arcgis/core/views/2d/layerViewModuleImportUtils.js
function r21() {
  return Promise.all([import("./webglDeps-2ZYDEKDE.js"), import("./mapViewDeps-OBMQYY3Z.js")]);
}
var a10 = () => r21().then(() => import("./TileLayerView2D-3EP4BVPL.js"));
var t18 = () => r21().then(() => import("./FeatureLayerView2D-3PHZO5R3.js"));
var i16 = { "base-dynamic": () => r21().then(() => import("./BaseDynamicLayerView2D-6I6ANMXN.js")), "base-tile": a10, "bing-maps": a10, catalog: () => r21().then(() => import("./CatalogLayerView2D-EKP2DGUD.js")), "catalog-dynamic-group": () => r21().then(() => import("./CatalogDynamicGroupLayerView2D-67LGNG5U.js")), "catalog-footprint": () => r21().then(() => import("./CatalogFootprintLayerView2D-PSUX67RO.js")), csv: t18, "geo-rss": () => r21().then(() => import("./GeoRSSLayerView2D-FIXKRCES.js")), feature: t18, geojson: t18, parquet: t18, graphics: () => r21().then(() => import("./GraphicsLayerView2D-WSYAY2UP.js")), group: () => r21().then(() => import("./GroupLayerView2D-KAZ7Y3PK.js")), imagery: () => r21().then(() => import("./ImageryLayerView2D-PZ6OPWZN.js")), "imagery-tile": () => r21().then(() => import("./ImageryTileLayerView2D-MXIY2SD3.js")), kml: () => r21().then(() => import("./KMLLayerView2D-YZXPK2JN.js")), "knowledge-graph": () => r21().then(() => import("./KnowledgeGraphLayerView2D-MIMB6RRU.js")), "link-chart": () => r21().then(() => import("./KnowledgeGraphLayerView2D-MIMB6RRU.js")), "knowledge-graph-sublayer": t18, "map-image": () => r21().then(() => import("./MapImageLayerView2D-UKH6LH7I.js")), "map-notes": () => r21().then(() => import("./MapNotesLayerView2D-ZKSQBL2A.js")), media: () => r21().then(() => import("./MediaLayerView2D-MQF6DDCW.js")), "ogc-feature": () => r21().then(() => import("./OGCFeatureLayerView2D-2YY7MBBW.js")), "open-street-map": a10, "oriented-imagery": t18, route: () => r21().then(() => import("./RouteLayerView2D-G4G2QQCT.js")), stream: () => r21().then(() => import("./StreamLayerView2D-FW7GIPDF.js")), "subtype-group": () => r21().then(() => import("./SubtypeGroupLayerView2D-BMWLJE2Z.js")), tile: a10, "vector-tile": () => r21().then(() => import("./VectorTileLayerView2D-5P55B3VG.js")), video: () => r21().then(() => import("./VideoLayerView2D-MF4SJIZH.js")), wcs: () => r21().then(() => import("./ImageryTileLayerView2D-MXIY2SD3.js")), "web-tile": a10, wfs: t18, wms: () => r21().then(() => import("./WMSLayerView2D-25UHRHXM.js")), wmts: () => r21().then(() => import("./WMTSLayerView2D-ADNNSVYX.js")), "line-of-sight": null, "base-elevation": null, "building-scene": null, dimension: null, elevation: null, focusArea: null, "integrated-mesh": null, "integrated-mesh-3dtiles": null, "point-cloud": null, viewshed: null, voxel: null, scene: null, unknown: null, unsupported: null };
function s19(r30) {
...
var l15;
var p18 = l15 = class extends i3(b2) {
  constructor(e25) {
...
r([m({ constructOnly: true })], p18.prototype, "geometry", void 0), r([m({ readOnly: true })], p18.prototype, "normalizedGeometry", null), r([m({ constructOnly: true })], p18.prototype, "spatialReference", void 0), p18 = l15 = r([a("esri.views.2d.constraints.GeometryConstraint")], p18);

// node_modules/@arcgis/core/views/2d/constraints/RotationConstraint.js
var a11;
var n24 = a11 = class extends i3(b2) {
  constructor() {
...
r([m()], n24.prototype, "enabled", void 0), r([m()], n24.prototype, "rotationEnabled", void 0), n24 = a11 = r([a("esri.views.2d.constraints.RotationConstraint")], n24);
var i17 = n24;

// node_modules/@arcgis/core/views/2d/constraints/ZoomConstraint.js
var a12;
var c13 = a12 = class extends i3(b2) {
  constructor(e25) {
...
r([m({ readOnly: true })], c13.prototype, "effectiveLODs", void 0), r([m({ readOnly: true })], c13.prototype, "effectiveMinZoom", void 0), r([m({ readOnly: true })], c13.prototype, "effectiveMaxZoom", void 0), r([m({ readOnly: true })], c13.prototype, "effectiveMinScale", void 0), r([m({ readOnly: true })], c13.prototype, "effectiveMaxScale", void 0), r([m()], c13.prototype, "lods", void 0), r([m()], c13.prototype, "minZoom", void 0), r([m()], c13.prototype, "maxZoom", void 0), r([m()], c13.prototype, "minScale", void 0), r([m()], c13.prototype, "maxScale", void 0), r([m()], c13.prototype, "snapToZoom", void 0), c13 = a12 = r([a("esri.views.2d.constraints.ZoomConstraint")], c13);
var l16 = c13;

// node_modules/@arcgis/core/views/2d/MapViewConstraints.js
var p19 = { base: null, key: "type", typeMap: { extent: w3, polygon: v3 } };
...
r([m({ readOnly: true })], y7.prototype, "effectiveLODs", null), r([m({ readOnly: true })], y7.prototype, "effectiveMinScale", null), r([m({ readOnly: true })], y7.prototype, "effectiveMaxScale", null), r([m({ readOnly: true })], y7.prototype, "effectiveMinZoom", null), r([m({ readOnly: true })], y7.prototype, "effectiveMaxZoom", null), r([m({ types: p19, value: null })], y7.prototype, "geometry", null), r([m({ type: [p3] })], y7.prototype, "lods", void 0), r([m()], y7.prototype, "minScale", void 0), r([m()], y7.prototype, "maxScale", void 0), r([m()], y7.prototype, "minZoom", void 0), r([m()], y7.prototype, "maxZoom", void 0), r([m()], y7.prototype, "rotationEnabled", void 0), r([m()], y7.prototype, "snapToZoom", void 0), r([m({ type: V })], y7.prototype, "customConstraints", void 0), r([m()], y7.prototype, "view", void 0), r([m({ readOnly: true })], y7.prototype, "version", null), r([m({ type: p18, readOnly: true })], y7.prototype, "_geometry", null), r([m({ type: i17 })], y7.prototype, "_rotation", null), r([m({ readOnly: true, type: l16 })], y7.prototype, "_zoom", null), y7 = r([a("esri.views.2d.MapViewConstraints")], y7);
var f14 = y7;
...
var z3 = class extends b2 {
  ...
  set viewpoint(t29) {
    ...
    const n33 = new m4({ targetGeometry: new j(), scale: 0, rotation: 0 });
  ...
  startup(t29, e25, i22, s28) {
    ...
    try {
      ...
      n.getLogger(this).warn(new s2("mapview:startup-projection-error", "projection of initial viewpoint to the view's spatial reference, defaulting to the initial viewpoint.", { center: o32.toJSON(), spatialReference: i22, error: n33 })), t29.targetGeometry = s28 || new j({ x: 0, y: 0, spatialReference: i22 });
    }
  ...
  changeSpatialReference(t29) {
    ...
    try {
      ...
      r6() || n.getLogger(this).warn(new s2("mapview:spatial-reference-change", "could not project the view's center to the new spatial reference", { center: a22 == null ? void 0 : a22.toJSON(), spatialReference: t29, error: h20 }));
    }
    a22 || (a22 = new j({ x: 0, y: 0, spatialReference: t29 }));
    const p27 = xt(new m4({ targetGeometry: new j(), scale: 0, rotation: 0 }), i22.viewpoint, a22);
    s28.viewpoint = p27;
    try {
  ...
  toScreen(t29, e25) {
    ...
    return false === (e25 == null ? void 0 : e25.pickClosestTarget) || this.state.paddedViewState.wrapMapCoordinate(s28, s28), this.state.toScreen(s28, s28), c4(s28[0], s28[1]);
  }
  _project(t29, e25) {
    var _a;
...
r([m({ type: j })], z3.prototype, "center", null), r([m()], z3.prototype, "constraints", void 0), r([m({ type: w3 })], z3.prototype, "extent", null), r([m({ value: { top: 0, right: 0, bottom: 0, left: 0 }, cast: (t29) => ({ top: 0, right: 0, bottom: 0, left: 0, ...t29 }) })], z3.prototype, "padding", null), r([m()], z3.prototype, "ready", void 0), r([m()], z3.prototype, "resizeAlign", void 0), r([m({ readOnly: true })], z3.prototype, "resolution", null), r([m({ type: Number })], z3.prototype, "rotation", null), r([m({ type: Number })], z3.prototype, "scale", null), r([m({ readOnly: true })], z3.prototype, "state", void 0), r([m({ type: m4 })], z3.prototype, "viewpoint", null), r([m({ readOnly: true })], z3.prototype, "visibleArea", null), r([m()], z3.prototype, "zoom", null), z3 = r([a("esri.views.2d.ViewStateManager")], z3);
...
var d13 = class extends t9 {
  constructor(i22) {
    super(true), this._view = i22, this._frameTask = null, this._watchHandles = new r3(), this._currentDevice = null, this._transformation = { translation: [0, 0, 0], heading: 0, tilt: 0, zoom: 0 }, this._handle = this.registerIncoming("gamepad", (t29) => this._handleGamePadEvent(t29)), this._handle.pause();
  }
  onInstall(t29) {
...
function o26(t29, n33) {
  if (n33 ? (n33.radius = 0, n33.center.x = 0, n33.center.y = 0) : n33 = { radius: 0, center: c4() }, 0 === t29.length) return n33;
  ...
  const h20 = 0.5 * (m26 + x2), D4 = 0.5 * (s28 + y10), g13 = i22 * a22 - l21 * l21, f17 = (h20 * a22 - D4 * l21) / g13, b8 = (i22 * D4 - l21 * h20) / g13, p27 = c4(f17 + r30, b8 + o32);
...
var u12 = class extends t9 {
  ...
  _dragStart(t29, e25) {
    ...
    const n33 = d15("begin", c4(0, 0), o32);
    this._doubleTapDrag.emit(n33, void 0, a22), e25.stopPropagation();
  }
  _dragUpdate(t29) {
    if (!this._doubleTapDragActive) return;
    const { data: e25, modifiers: o32 } = t29, { center: a22 } = e25, r30 = d15("update", c4(a22.x - this._dragStartCenter.x, a22.y - this._dragStartCenter.y), e25);
    this._doubleTapDrag.emit(r30, void 0, o32), t29.stopPropagation();
  }
  _dragEnd(t29) {
    if (!this._doubleTapDragActive) return;
    const { data: e25, modifiers: o32 } = t29, { center: a22 } = e25, r30 = d15("end", c4(a22.x - this._dragStartCenter.x, a22.y - this._dragStartCenter.y), e25);
...
function r24(e25) {
  ...
  return e25.forEach((e26) => {
    i22.push(c4(e26.event.x, e26.event.y));
  }), o26(i22);
}
function a18(t29) {
  const e25 = r24(t29);
...
r([m()], z4.prototype, "view", void 0), r([m()], z4.prototype, "latestPointerType", null), r([m()], z4.prototype, "latestPointerLocation", null), r([m()], z4.prototype, "multiTouchActive", null), z4 = r([a("esri.views.2d.input.MapViewInputManager")], z4);
var k3 = z4;
...
var u13 = class extends o5 {
  ...
  updateTiles(e25) {
    ...
    for (const s28 of e25.added) if (!this.has(s28)) {
      const e26 = new n14(this.tileScheme, s28);
  ...
  setViewState(e25) {
    ...
    if (s28.length > 0) for (const { row: n33, colFrom: l21, colTo: h20 } of s28) for (let e26 = l21; e26 <= h20; e26++) {
      ...
      if (a19.add(t30), !this.has(t30)) {
        const e27 = new n14(this.tileScheme, t30);
    ...
    (d16.added.length || d16.removed.length) && this.emit("update", d16), s10.pool.release(t29), a19.clear(), d16.added.length = 0, d16.removed.length = 0;
  }
};

// node_modules/@arcgis/core/views/2d/support/hitTestUtils.js
async function s25(e25, i22, s28) {
  const f17 = o12(i22) ? r11(e25, i22) : i22;
  ...
  const m26 = e25.toMap(f17), w11 = e25.allLayerViews.filter((r30) => !r30.suspended && d21.has(r30) && r30.clips.every((r31) => m8(e25, r31, f17, m26))).reverse();
...
r([m()], i21.prototype, "_timer", void 0), r([m()], i21.prototype, "stationary", null), i21 = r([a("esri.views.2d.support.StationaryManager")], i21);
...
r([m()], p22.prototype, "id", null), r([m()], p22.prototype, "node", null), r([s4("node")], p22.prototype, "castNode", null), r([m({ readOnly: true })], p22.prototype, "widget", void 0), p22 = r([a("esri.views.ui.Component")], p22);
var m22 = p22;
...
var P5 = class extends o5.EventedAccessor {
  ...
  _add(t29, e25, n33, r30, s28) {
    ...
    null != a22 && a22 instanceof b2 && a22.addHandles(e(() => {
...
r([m()], P5.prototype, "_locale", void 0), r([m()], P5.prototype, "container", null), r([m()], P5.prototype, "height", null), r([m({ value: _9 })], P5.prototype, "padding", null), r([s4("padding")], P5.prototype, "castPadding", null), r([m()], P5.prototype, "view", void 0), r([m()], P5.prototype, "width", null), P5 = r([a("esri.views.ui.UI")], P5);
var L5 = P5;
...
r([m({ readOnly: true, type: V })], _10.prototype, "items", void 0), r([m({ readOnly: true })], _10.prototype, "state", null), r([m()], _10.prototype, "view", void 0), _10 = r([a("esri.widgets.Attribution.AttributionViewModel")], _10);
var v12 = _10;
...
r([m()], h17.prototype, "_isOpen", void 0), r([m()], h17.prototype, "_isInteractive", null), r([m()], h17.prototype, "_attributionTextOverflowed", void 0), r([m()], h17.prototype, "_prevSourceNodeHeight", void 0), r([m({ readOnly: true, dependsOn: ["viewModel.items.length", "itemDelimiter"] })], h17.prototype, "attributionText", null), r([m()], h17.prototype, "icon", null), r([m()], h17.prototype, "itemDelimiter", void 0), r([m()], h17.prototype, "label", null), r([m(), e3("esri/widgets/Attribution/t9n/Attribution")], h17.prototype, "messages", void 0), r([m()], h17.prototype, "view", null), r([m({ type: v12 })], h17.prototype, "viewModel", void 0), r([t10()], h17.prototype, "_toggleState", null), h17 = r([a("esri.widgets.Attribution")], h17);
var u15 = h17;
...
r([m({ readOnly: true })], p23.prototype, "canShowNorth", null), r([m({ readOnly: true })], p23.prototype, "orientation", void 0), r([m({ readOnly: true })], p23.prototype, "state", null), r([m()], p23.prototype, "view", void 0), p23 = r([a("esri.widgets.Compass.CompassViewModel")], p23);
var h18 = p23;
...
r([m()], c20.prototype, "goToOverride", null), r([m()], c20.prototype, "icon", null), r([m()], c20.prototype, "label", null), r([m(), e3("esri/widgets/Compass/t9n/Compass")], c20.prototype, "messages", void 0), r([m()], c20.prototype, "view", null), r([m({ type: h18 })], c20.prototype, "viewModel", void 0), c20 = r([a("esri.widgets.Compass")], c20);
var d19 = c20;
...
r([m({ readOnly: true })], s26.prototype, "state", null), r([m()], s26.prototype, "_navigationMode", void 0), r([m()], s26.prototype, "view", void 0), s26 = r([a("esri.widgets.NavigationToggle.NavigationToggleViewModel")], s26);
var r28 = s26;
...
r([m()], c21.prototype, "icon", null), r([m()], c21.prototype, "label", null), r([m({ value: "vertical" })], c21.prototype, "layout", null), r([m(), e3("esri/widgets/NavigationToggle/t9n/NavigationToggle")], c21.prototype, "messages", void 0), r([m()], c21.prototype, "view", null), r([m({ type: r28 })], c21.prototype, "viewModel", void 0), c21 = r([a("esri.widgets.NavigationToggle")], c21);
var d20 = c21;
...
r([m({ readOnly: true })], r29.prototype, "canZoomIn", null), r([m({ readOnly: true })], r29.prototype, "canZoomOut", null), r([m()], r29.prototype, "view", void 0), r([m()], r29.prototype, "_scale", null), r29 = r([a("esri.widgets.Zoom.ZoomConditions2D")], r29);
var c22 = r29;
...
r([m({ readOnly: true })], s27.prototype, "canZoomIn", null), r([m({ readOnly: true })], s27.prototype, "canZoomOut", null), r([m()], s27.prototype, "view", void 0), s27 = r([a("esri.widgets.Zoom.ZoomConditions3D")], s27);
var c23 = s27;
...
r([m()], m23.prototype, "_zoomConditions", void 0), r([m()], m23.prototype, "canZoomIn", null), r([m()], m23.prototype, "canZoomOut", null), r([m({ readOnly: true })], m23.prototype, "state", null), r([m()], m23.prototype, "view", null), m23 = r([a("esri.widgets.Zoom.ZoomViewModel")], m23);
var p24 = m23;
...
r([m()], c24.prototype, "icon", null), r([m()], c24.prototype, "label", null), r([m({ value: "vertical" })], c24.prototype, "layout", null), r([m(), e3("esri/widgets/Zoom/t9n/Zoom")], c24.prototype, "messages", void 0), r([m()], c24.prototype, "view", null), r([m({ type: p24 })], c24.prototype, "viewModel", void 0), c24 = r([a("esri.widgets.Zoom")], c24);
var p25 = c24;
...
r([m()], h19.prototype, "components", void 0), h19 = r([a("esri.views.ui.DefaultUI")], h19);
var u16 = h19;
...
r([m()], e24.prototype, "components", void 0), e24 = r([a("esri.views.ui.2d.DefaultUI2D")], e24);
var c25 = e24;
...
var re;
async function se() {
  const [, { GraphicsView2D: e25, GraphicContainer: t29, LabelManager: i22, MapViewNavigation: r30, MagnifierView2D: s28, GridView2D: a22, Stage: n33 }] = await Promise.all([import("./webglDeps-2ZYDEKDE.js"), import("./mapViewDeps-OBMQYY3Z.js")]);
  X = e25, Y2 = t29, ee = i22, te = r30, ie = s28, re = a22, Q = n33;
}
var ae = class extends o13(w5(w4($))) {
  constructor(e25) {
    super(e25), this._magnifierView = null, this._gridView = null, this.stage = null, this._resolveWhenReady = [], this.rootLayerViews = new n8({ getCollections: () => {
      var _a, _b;
...
`);
  ...
  get visibleArea() {
    ...
    return e25 ? new v3({ rings: [e25.map((e26) => [e26[0], e26[1]])], spatialReference: this.spatialReference }) : e25;
  }
  get zoom() {
  ...
  toMap(e25) {
    if (!this.ready) return null;
    const t29 = o12(e25) ? r11(this, e25) : e25;
  ...
  async popupHitTest(e25) {
    var _a;
    const t29 = this.toMap(e25), i22 = await this.hitTest(e25), r30 = this.allLayerViews.toArray().filter((i23) => i23.clips.every((i24) => m8(this, i24, e25, t29))).reverse(), s28 = new globalThis.Map(r30.map((e26) => [e26.layer.uid, e26])), a22 = [];
    let n33 = 0, o32 = 0;
  ...
  _getDefaultViewpoint() {
    ...
    return u17 && m26 ? new m4({ targetGeometry: u17, scale: m26, rotation: c26 }) : null;
  }
  _startup() {
    var _a;
...
ae.type = "2d", r([m({ readOnly: true })], ae.prototype, "animationManager", void 0), r([m({ constructOnly: true })], ae.prototype, "deactivatedWebGLExtensions", void 0), r([m({ constructOnly: true })], ae.prototype, "debugWebGLExtensions", void 0), r([m({ readOnly: true })], ae.prototype, "featuresTilingScheme", void 0), r([m({ readOnly: true })], ae.prototype, "fullOpacity", void 0), r([m()], ae.prototype, "goToManager", void 0), r([m({ readOnly: true })], ae.prototype, "graphicsTileStore", null), r([m()], ae.prototype, "graphicsView", void 0), r([m()], ae.prototype, "stateManager", void 0), r([m()], ae.prototype, "constraintsInfo", null), r([m({ readOnly: true })], ae.prototype, "state", null), r([m()], ae.prototype, "initialExtentRequired", null), r([m()], ae.prototype, "labelManager", void 0), r([m({ readOnly: true })], ae.prototype, "mapViewNavigation", void 0), r([m({ constructOnly: true })], ae.prototype, "renderCanvas", void 0), r([m()], ae.prototype, "renderingOptions", void 0), r([m({ constructOnly: true })], ae.prototype, "supersampleScreenshotsEnabled", void 0), r([m({ readOnly: true })], ae.prototype, "supportsGround", void 0), r([m()], ae.prototype, "defaultsFromMapSettings", null), r([m({ readOnly: true })], ae.prototype, "typeSpecificPreconditionsReady", null), r([m()], ae.prototype, "animation", null), r([m({ type: m10 })], ae.prototype, "background", null), r([m()], ae.prototype, "center", null), r([m({ type: f14 })], ae.prototype, "constraints", null), r([m()], ae.prototype, "extent", null), r([m()], ae.prototype, "floors", void 0), r([m()], ae.prototype, "grid", void 0), r([m({ type: l6 })], ae.prototype, "highlightOptions", null), r([m({ type: V.ofType(i8) })], ae.prototype, "highlights", void 0), r([m({ readOnly: true })], ae.prototype, "inputManager", void 0), r([m()], ae.prototype, "map", void 0), r([m()], ae.prototype, "padding", null), r([m({ readOnly: true })], ae.prototype, "rendering", null), r([m()], ae.prototype, "resizeAlign", null), r([m({ readOnly: true })], ae.prototype, "resolution", null), r([m()], ae.prototype, "rotation", null), r([m()], ae.prototype, "scale", null), r([m({ constructOnly: true })], ae.prototype, "spatialReferenceLocked", void 0), r([m()], ae.prototype, "stationary", null), r([m({ readOnly: true })], ae.prototype, "tileInfo", null), r([m({ type: e11, readOnly: true })], ae.prototype, "timeline", void 0), r([m({ readOnly: true })], ae.prototype, "type", void 0), r([m({ readOnly: true })], ae.prototype, "updating", null), r([m({ readOnly: true })], ae.prototype, "view2dType", void 0), r([m()], ae.prototype, "viewpoint", null), r([m({ readOnly: true })], ae.prototype, "visibleArea", null), r([m()], ae.prototype, "zoom", null), r([m({ readOnly: true })], ae.prototype, "navigating", null), r([m(), s4((e25) => e25 instanceof u16 ? e25 : h2(c25, e25))], ae.prototype, "ui", void 0), ae = r([a("esri.views.View2D")], ae);
var ne = ae;
...
r([m({ readOnly: true })], t28.prototype, "view2dType", void 0), t28 = r([a("esri.views.MapView")], t28);
var p26 = t28;
export {
  p26 as default
};
