...
async function o(o2) {
  ...
  if (i2.isWebMercator) return j(o2);
  const s2 = g.WGS84;
  return await N(i2, s2), K(o2, s2);
}
function i(e, t) {
  if (!s(e, t)) {
...
var f = { DEVELOPER_BASEMAP: "DeveloperBasemap", JSAPI: "ArcGIS API for JavaScript", METADATA: "Metadata", MULTI_LAYER: "Multilayer", SINGLE_LAYER: "Singlelayer", TABLE: "Table", HOSTED_SERVICE: "Hosted Service", LOCAL_SCENE: "ViewingMode-Local", TILED_IMAGERY: "Tiled Imagery", GROUP_LAYER_MAP: "Map", ORIENTED_IMAGERY_LAYER: "OrientedImageryLayer" };
function E(e) {
  var _a;
...
//# sourceMappingURL=chunk-2DHZIDQK.js.map
