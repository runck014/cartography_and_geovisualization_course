...
var O = class extends u(a2) {
  ...
  readControlPoints(t3, o6) {
    ...
    return t3.map((t4) => (o4(N2, t4.x, t4.y), p4(N2, N2, r4), { sourcePoint: t4, mapPoint: new j({ x: N2[0], y: N2[1], spatialReference: e3 }) }));
  }
  ...
  set coords(t3) {
    ...
    M2(p6) && M2(u7) && M2(m5) && M2(f4) && (W(S3, p6, u7, m5, f4), this.controlPoints = this.controlPoints.map(({ sourcePoint: t4 }) => (o4(N2, t4.x, t4.y), p4(N2, N2, S3), { sourcePoint: t4, mapPoint: new j({ x: N2[0], y: N2[1], spatialReference: o6 }) })));
  }
  ...
  toSource(t3) {
    ...
    const o6 = this.controlPoints[0].mapPoint.spatialReference;
    return t3 = t3.normalize(), null == (t3 = V3(t3, o6).geometry) ? null : (o4(N2, t3.x, t3.y), p4(N2, N2, this.inverseTransform), c3(N2[0], N2[1]));
  }
...
r([m({ type: [_3], json: { write: { allowNull: false, isRequired: true, target: { controlPoints: { type: [T2] }, coefficients: { type: [Number] }, spatialReference: { type: g } } } } })], O.prototype, "controlPoints", void 0), r([o("controlPoints")], O.prototype, "readControlPoints", null), r([r2("controlPoints")], O.prototype, "writeControlPoints", null), r([m({ clonable: false })], O.prototype, "coords", null), r([m({ type: Number, nonNullable: true, json: { write: true } })], O.prototype, "height", void 0), r([m({ readOnly: true })], O.prototype, "inverseTransform", null), r([m({ readOnly: true })], O.prototype, "transform", null), r([m({ type: Number, nonNullable: true, json: { write: true } })], O.prototype, "width", void 0), O = r([a("esri.layers.support.ControlPointsGeoreference")], O);
var G = n6();
var I2 = n6();
var L = n6();
var J = n6();
...
r([m(h2)], u6.prototype, "georeference", void 0), r([o("georeference")], u6.prototype, "readGeoreference", null), r([r2("georeference")], u6.prototype, "writeGeoreference", null), r([m({ json: { read: false, write: false } })], u6.prototype, "opacity", void 0), u6 = r([a("esri.layers.support.MediaElementBase")], u6);
var d4 = u6;
...
var M4 = V2.ofType(w4);
var I3 = class extends m2.LoadableMixin(n3(o2.EventedAccessor)) {
  constructor(e3) {
...
var E3 = class extends l2(t(b(j2(S2(f2))))) {
  constructor(e3) {
    super(e3), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = k(async (e4, r4, o6) => {
      const { save: t3, saveAs: s6 } = await import("./mediaLayerUtils-Q7JYUO6T.js");
      switch (e4) {
        case A.SAVE:
          return t3(this, r4);
        case A.SAVE_AS:
...
} } } })], E3.prototype, "source", null), r([s3("source")], E3.prototype, "castSource", null), r([o("source", ["url"])], E3.prototype, "readSource", null), r([r2("source")], E3.prototype, "writeSource", null), r([m()], E3.prototype, "spatialReference", void 0), r([m({ readOnly: true })], E3.prototype, "type", void 0), E3 = r([a("esri.layers.MediaLayer")], E3);
var _4 = E3;
export {
  _4 as default
};
//# sourceMappingURL=MediaLayer-JR5ZT2OJ.js.map
