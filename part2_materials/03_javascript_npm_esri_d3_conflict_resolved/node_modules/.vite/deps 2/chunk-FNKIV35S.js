...
var w2 = /* @__PURE__ */ new Map([["geometry", [new t2("a_position", 2, C.UNSIGNED_SHORT, 0, 8), new t2("a_texcoord", 2, C.UNSIGNED_SHORT, 4, 8)]]]);
...
var h2 = /* @__PURE__ */ new Map([["geometry", [new t2("a_xyts0", 4, C.FLOAT, 0, 64), new t2("a_xyts1", 4, C.FLOAT, 16, 64), new t2("a_typeIdDurationSeed", 4, C.FLOAT, 32, 64), new t2("a_extrudeInfo", 4, C.FLOAT, 48, 64)]]]);
...
var h3 = /* @__PURE__ */ new Map([["geometry", [new t2("a_positionAndSide", 3, C.FLOAT, 0, 36), new t2("a_timeInfo", 3, C.FLOAT, 12, 36), new t2("a_extrude", 2, C.FLOAT, 24, 36), new t2("a_speed", 1, C.FLOAT, 32, 36)]]]);
...
var f8 = class extends e2 {
  ...
  setTransform(r3) {
    ...
    M(l6, l6, t(n5, c4)), M(l6, l6, t(m5 / 2, u5 / 2)), h(l6, l6, -d9), M(l6, l6, t(-m5 / 2, -u5 / 2)), b3(l6, l6, t(m5, u5)), i(this.transforms.displayViewScreenMat3, r3.displayViewMat3, l6);
  }
  onAttach() {
    this.invalidateVAO();
  }
...
//# sourceMappingURL=chunk-FNKIV35S.js.map
