...
function m2(a, i2, n4) {
  ...
  const r = "number" == typeof i2, s = r ? null : i2, l3 = s == null ? void 0 : s.attributes;
  let o = r ? i2 : null;
  const c2 = t.field, { ipData: p2, hasExpression: d3 } = t.cache;
  ...
  if ("number" != typeof o) if (d3) {
    ...
    const e2 = { viewingMode: n4.viewingMode, scale: n4.scale, spatialReference: n4.spatialReference }, a2 = n4.arcade.arcadeUtils, i3 = a2.getViewInfo(e2), r2 = a2.createExecContext(s, i3, n4.timeZone);
    if (!v2) {
  ...
  const m3 = t.normalizationField, b2 = null != l3 && null != m3 ? parseFloat(l3[m3]) : void 0;
  if (null != o && (!m3 || r || !isNaN(b2) && 0 !== b2)) {
    isNaN(b2) || r || (o /= b2);
    const a2 = U(o, p2);
    if (a2) {
      const i3 = a2[0], r2 = a2[1], s2 = i3 === r2 ? t.stops[i3].color : l.blendColors(t.stops[i3].color, t.stops[r2].color, a2[2], null != n4 ? n4.color : void 0);
      return new l(s2);
    }
  }
}
function b(e2, a, i2) {
  ...
  const t = "number" == typeof a, r = t ? null : a, s = r == null ? void 0 : r.attributes;
  let l3 = t ? a : null;
  ...
  if ("number" != typeof l3) if (p2) {
    if (null == (i2 == null ? void 0 : i2.arcade)) return void f();
    const e3 = { viewingMode: i2.viewingMode, scale: i2.scale, spatialReference: i2.spatialReference }, a2 = i2.arcade.arcadeUtils, t2 = a2.getViewInfo(e3), s2 = a2.createExecContext(r, t2, i2.timeZone);
    if (!d3) {
      const e4 = a2.createSyntaxTree(n4.valueExpression);
      d3 = a2.createFunction(e4), n4.cache.compiledFunc = d3;
    }
    l3 = a2.executeFunction(d3, s2);
  } else s && (l3 = s[o]);
  const v2 = n4.normalizationField, m3 = null != s && null != v2 ? parseFloat(s[v2]) : void 0;
  if (null != l3 && (!v2 || t || !isNaN(m3) && 0 !== m3)) {
    isNaN(m3) || t || (l3 /= m3);
    const e3 = U(l3, c2);
    if (e3) {
...
function h(e2, a, i2) {
  ...
  const t = n4.axis || "heading", r = "heading" === t && "arithmetic" === n4.rotationType ? 90 : 0, s = "heading" === t && "arithmetic" === n4.rotationType ? -1 : 1, l3 = "number" == typeof a ? null : a, o = l3 == null ? void 0 : l3.attributes, c2 = n4.field, { hasExpression: p2 } = n4.cache;
  let d3 = n4.cache.compiledFunc, v2 = 0;
  if (!c2 && !p2) return v2;
  if (p2) {
    if (null == (i2 == null ? void 0 : i2.arcade)) return void f();
    const e3 = { viewingMode: i2.viewingMode, scale: i2.scale, spatialReference: i2.spatialReference }, a2 = i2.arcade.arcadeUtils, t2 = a2.getViewInfo(e3), r2 = a2.createExecContext(l3, t2, i2.timeZone);
    if (!d3) {
      const e4 = a2.createSyntaxTree(n4.valueExpression);
      d3 = a2.createFunction(e4), n4.cache.compiledFunc = d3;
    }
...
function V(e2, a, i2) {
  const n4 = "number" == typeof a, t = n4 ? null : a, r = t == null ? void 0 : t.attributes;
  let l3 = n4 ? a : null;
  const { isScaleDriven: c2 } = e2.cache;
  let u2 = e2.cache.compiledFunc;
  if (c2) {
    const a2 = null != i2 ? i2.scale : void 0, n5 = null != i2 ? i2.view : void 0;
    l3 = null == a2 || "3d" === n5 ? x(e2) : a2;
  } else if (!n4) switch (e2.inputValueType) {
    case n2.Expression: {
      if (null == (i2 == null ? void 0 : i2.arcade)) return void f();
      const a2 = { viewingMode: i2.viewingMode, scale: i2.scale, spatialReference: i2.spatialReference }, n5 = i2.arcade.arcadeUtils, r2 = n5.getViewInfo(a2), s = n5.createExecContext(t, r2, i2.timeZone);
      if (!u2) {
        const a3 = n5.createSyntaxTree(e2.valueExpression);
        u2 = n5.createFunction(a3), e2.cache.compiledFunc = u2;
      }
      l3 = n5.executeFunction(u2, s);
      break;
    }
    case n2.Field:
      r && (l3 = r[e2.field]);
  ...
  if (n4 || !e2.normalizationField) return l3;
  const p2 = r ? parseFloat(r[e2.normalizationField]) : null;
  return l2(p2) && 0 !== p2 ? l3 / p2 : null;
}
function x(e2) {
  let a = null, i2 = null;
  const n4 = e2.stops;
...
function g(e2, a, i2) {
  return null == e2 ? null : e(e2) ? y(e2, a, i2) : l2(e2) ? e2 : null;
}
function w(e2, a, i2) {
  return l2(i2) && e2 > i2 ? i2 : l2(a) && e2 < a ? a : e2;
}
...
function F(e2, a, i2) {
  const n4 = e2.stops;
  let t = (n4 == null ? void 0 : n4.length) && n4[0].size;
  return null == t && (t = e2.minSize), g(t, a, i2);
}
function S(e2, a, i2, n4) {
  const t = (e2 - a.minDataValue) / (a.maxDataValue - a.minDataValue), r = g(a.minSize, i2, n4), s = g(a.maxSize, i2, n4), l3 = null != n4 ? n4.shape : void 0;
  if (e2 <= a.minDataValue) return r;
  if (e2 >= a.maxDataValue) return s;
  if (null == r || null == s) return null;
  if ("area" === a.scaleBy && l3) {
    const e3 = "circle" === l3, a2 = e3 ? d2 * (r / 2) ** 2 : r * r, i3 = a2 + t * ((e3 ? d2 * (s / 2) ** 2 : s * s) - a2);
    return e3 ? 2 * Math.sqrt(i3 / d2) : Math.sqrt(i3);
  }
  return r + t * (s - r);
}
function E(e2, a, i2, n4) {
  const t = null != n4 ? n4.shape : void 0, r = e2 / a.minDataValue, s = g(a.minSize, i2, n4), l3 = g(a.maxSize, i2, n4);
  let o = null;
  return o = "circle" === t ? 2 * Math.sqrt(r * (s / 2) ** 2) : "square" === t || "diamond" === t || "image" === t ? Math.sqrt(r * s ** 2) : r * s, w(o, s, l3);
}
function C(e2, a, i2, n4, t) {
  var _a, _b, _c;
  const [r, s, l3] = U(e2, t);
  if (r === s) return g((_a = a.stops) == null ? void 0 : _a[r].size, i2, n4);
  {
    const e3 = g((_b = a.stops) == null ? void 0 : _b[r].size, i2, n4);
    return e3 + (g((_c = a.stops) == null ? void 0 : _c[s].size, i2, n4) - e3) * l3;
  }
}
function D(e2, a, i2, n4) {
  const r = ((n4 == null ? void 0 : n4.resolution) ?? 1) * m[a.valueUnit], s = g(a.minSize, i2, n4), l3 = g(a.maxSize, i2, n4), { valueRepresentation: o } = a;
  let c2 = null;
  return c2 = "area" === o ? 2 * Math.sqrt(e2 / d2) / r : "radius" === o || "distance" === o ? 2 * e2 / r : e2 / r, w(c2, s, l3);
}
function M(e2) {
  return e2;
}
...
//# sourceMappingURL=chunk-RCGJPJRB.js.map
