...
var __assign = function() {
  __assign = Object.assign || function __assign2(t4) {
    for (var s, i = 1, n2 = arguments.length; i < n2; i++) {
      s = arguments[i];
      for (var p2 in s) if (Object.prototype.hasOwnProperty.call(s, p2)) t4[p2] = s[p2];
    }
    return t4;
  };
...
function l2(...e3) {
  ...
  for (let t4 = 0; t4 < e3.length; t4++) {
    const o3 = e3[t4], n2 = typeof o3;
    if ("string" === n2) r.push(o3);
    else if (Array.isArray(o3)) r.push.apply(r, o3);
    else if ("object" === n2) for (const e4 in o3) o3[e4] && r.push(e4);
  }
  const o2 = r.join(" ");
  return t2.release(r), o2;
}
var p = (() => {
  const e3 = /* @__PURE__ */ new Map(), t4 = new ResizeObserver((t5) => {
    var _a;
    t3();
    for (const r of t5) (_a = e3.get(r.target)) == null ? void 0 : _a(r);
  }), n2 = (r, n3, s) => (e3.set(r, n3), t4.observe(r, s), e(() => {
    t4.unobserve(r), e3.delete(r);
  }));
  return (e4, t5, a) => {
    let c2 = null;
    return t([d(() => "function" == typeof e4 ? e4() : e4, (e5) => {
      c2 == null ? void 0 : c2.remove(), e5 && (c2 = n2(e5, t5, a));
...
var d2 = ["dd", "dl", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "sub", "sup", ...["animate", "animatetransform", "circle", "clippath", "defs", "ellipse", "g", "image", "line", "lineargradient", "marker", "mask", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "svg", "switch", "symbol", "text", "textpath", "tspan", "use"]];
var g = d2.reduce((e3, t4) => (e3[t4] = [], e3), {});
var h = ["align", "alink", "alt", "bgcolor", "border", "cellpadding", "cellspacing", "class", "color", "cols", "colspan", "coords", "d", "dir", "face", "height", "hspace", "ismap", "lang", "marginheight", "marginwidth", "multiple", "nohref", "noresize", "noshade", "nowrap", "ref", "rel", "rev", "rows", "rowspan", "scrolling", "shape", "span", "summary", "tabindex", "title", "usemap", "valign", "value", "vlink", "vspace", "width"];
var y = new Sanitizer({ whiteList: g, onTagAttr: (e3, t4, r) => {
  const o2 = `${t4}="${r}"`;
  if (h.includes(t4)) return o2;
}, stripIgnoreTag: true, stripIgnoreTagBody: ["script", "style"] }, true);
function v(e3) {
  return "Enter" === e3 || " " === e3;
}
async function w(e3, t4) {
  await P(l(t4));
  const r = "function" == typeof e3 ? e3() : e3;
...
@esri/arcgis-html-sanitizer/dist/esm/index.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-3FXXSWHF.js.map
