...
var s = class extends hi {
  setupDefaultRules() {
    ...
    u("Entity").setAll({ stateAnimationDuration: 0, stateAnimationEasing: Pe(we) }), u("Component").setAll({ interpolationDuration: 0, interpolationEasing: Pe(we) }), u("Sprite").setAll({ visible: true, scale: 1, opacity: 1, rotation: 0, position: "relative", tooltipX: n, tooltipY: n, tooltipPosition: "fixed", isMeasured: true }), u("Sprite").states.create("default", { visible: true, opacity: 1 }), u("Container").setAll({ interactiveChildren: true, setStateOnChildren: false }), u("Graphics").setAll({ strokeWidth: 1 }), u("Chart").setAll({ width: r, height: r, interactiveChildren: false }), u("ZoomableContainer").setAll({ width: r, height: r, wheelable: true, pinchZoom: true, maxZoomLevel: 32, minZoomLevel: 1, zoomStep: 2, animationEasing: Pe(we), animationDuration: 600, maxPanOut: 0.4 }), u("Sprite", ["horizontal", "center"]).setAll({ centerX: n, x: n }), u("Sprite", ["vertical", "center"]).setAll({ centerY: n, y: n }), u("Container", ["horizontal", "layout"]).setAll({ layout: d }), u("Container", ["vertical", "layout"]).setAll({ layout: c }), u("Pattern").setAll({ repetition: "repeat", width: 50, height: 50, rotation: 0, fillOpacity: 1 }), u("LinePattern").setAll({ gap: 6, colorOpacity: 1, width: 49, height: 49 }), u("RectanglePattern").setAll({ gap: 6, checkered: false, centered: true, maxWidth: 5, maxHeight: 5, width: 48, height: 48, strokeWidth: 0 }), u("CirclePattern").setAll({ gap: 5, checkered: false, centered: false, radius: 3, strokeWidth: 0, width: 45, height: 45 }), u("GrainPattern").setAll({ width: 200, height: 200, colors: [Yt.fromHex(0)], size: 1, horizontalGap: 0, verticalGap: 0, density: 1, minOpacity: 0, maxOpacity: 0.2 });
    {
    ...
    u("Container", ["legend", "marker"]).setAll({ setStateOnChildren: true, centerY: n, paddingLeft: 0, paddingRight: 0, paddingBottom: 0, paddingTop: 0, width: 18, height: 18 }), u("RoundedRectangle", ["legend", "marker", "rectangle"]).setAll({ width: r, height: r, cornerRadiusBL: 3, cornerRadiusTL: 3, cornerRadiusBR: 3, cornerRadiusTR: 3 });
    {
      const e2 = u("RoundedRectangle", ["legend", "marker", "rectangle"]).states.create("disabled", {});
      l(e2, "fill", s2, "disabled"), l(e2, "stroke", s2, "disabled");
    }
    u("Label", ["legend", "label"]).setAll({ centerY: n, marginLeft: 5, paddingRight: 0, paddingLeft: 0, paddingTop: 0, paddingBottom: 0, populateText: true });
    l(u("Label", ["legend", "label"]).states.create("disabled", {}), "fill", s2, "disabled");
    u("Label", ["legend", "value", "label"]).setAll({ centerY: n, marginLeft: 5, paddingRight: 0, paddingLeft: 0, paddingTop: 0, paddingBottom: 0, width: 50, centerX: r, populateText: true });
    ...
    u("Button", ["resize"]).setAll({ paddingTop: 9, paddingBottom: 9, paddingLeft: 13, paddingRight: 13, draggable: true, centerX: n, centerY: n, position: "absolute", role: "slider", ariaValueMin: "0", ariaValueMax: "100", ariaLabel: e.translate("Use up and down arrows to move selection") });
    {
    ...
    u("RoundedRectangle", ["scrollbar", "thumb", "vertical"]).setAll({ x: n, width: r, centerX: n, ariaLabel: e.translate("Use up and down arrows to move selection") }), u("RoundedRectangle", ["scrollbar", "thumb", "horizontal"]).setAll({ y: n, centerY: n, height: r, ariaLabel: e.translate("Use left and right arrows to move selection") });
    {
    ...
    u("Graphics", ["button", "plus", "icon"]).setAll({ x: n, y: n, draw: (e2) => {
      e2.moveTo(-4, 0), e2.lineTo(4, 0), e2.moveTo(0, -4), e2.lineTo(0, 4);
    } }), u("Graphics", ["button", "minus", "icon"]).setAll({ x: n, y: n, draw: (e2) => {
      e2.moveTo(-4, 0), e2.lineTo(4, 0);
    } }), u("Graphics", ["button", "home", "icon"]).setAll({ x: n, y: n, svgPath: "M 8 -1 L 6 -1 L 6 7 L 2 7 L 2 1 L -2 1 L -2 7 L -6 7 L -6 -1 L -8 -1 L 0 -9 L 8 -1 Z M 8 -1" }), u("Button", ["zoomtools"]).setAll({ marginTop: 1, marginBottom: 2 }), u("ZoomTools").setAll({ x: r, centerX: r, y: r, centerY: r, paddingRight: 10, paddingBottom: 10 });
  }
};
...
//# sourceMappingURL=chunk-CLIR7IOF.js.map
