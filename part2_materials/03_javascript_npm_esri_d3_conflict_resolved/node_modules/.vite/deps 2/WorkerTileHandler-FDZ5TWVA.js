...
var l4 = class {
  ...
  getShaping(s6, c5, h5) {
    const l6 = this._letterSpacing, n5 = this._lineHeight, a6 = this._justify, r6 = this._maxWidth, m2 = [];
    let f3 = 0, p4 = 0;
    for (const t5 of s6) {
    ...
    const y2 = s6.includes("​"), d2 = [], x2 = m2.length;
    for (let e6 = 0; e6 < x2 - 1; e6++) {
      ...
      if (s3(o6) || s7) {
        ...
        d2.push(this._buildBreak(e6 + 1, m2[e6].x, g2, d2, t5, false));
      }
    }
    ...
    for (let t5 = 0; t5 < u4.length; t5++) {
      const i5 = u4[t5];
      let o6 = I4;
      for (; o6 < i5 && a4(m2[o6].codePoint); ) m2[o6].glyphMosaicItem = null, ++o6;
      let s7 = i5 - 1;
      for (; s7 > o6 && a4(m2[s7].codePoint); ) m2[s7].glyphMosaicItem = null, --s7;
      if (o6 <= s7) {
        const t6 = m2[o6].x;
        for (let i6 = o6; i6 <= s7; i6++) m2[i6].x -= t6, m2[i6].y = p4;
        let e6 = m2[s7].x;
        m2[s7].glyphMosaicItem && (e6 += m2[s7].glyphMosaicItem.metrics.advance), M = Math.max(e6, M), a6 && this._applyJustification(m2, o6, s7);
      }
      I4 = i5, p4 += _2;
    }
    if (m2.length > 0) {
      const t5 = u4.length - 1, e6 = (a6 - this._hAnchor) * M;
      let i5 = (-this._vAnchor * (t5 + 1) + 0.5) * n5;
      c5 && t5 && (i5 += t5 * n5);
  ...
  static getTextBox(t5, e6) {
    ...
    for (const l6 of t5) {
      const t6 = l6.glyphMosaicItem.metrics.advance, n5 = l6.x, a6 = l6.y - h3, r6 = n5 + t6, m2 = a6 + e6;
      i5 = Math.min(i5, n5), s6 = Math.max(s6, r6), o6 = Math.min(o6, a6), c5 = Math.max(c5, m2);
    }
  ...
  static getBox(t5) {
    ...
    for (const c5 of t5) {
      const { height: t6, left: h5, top: l6, width: n5 } = c5.glyphMosaicItem.metrics, a6 = c5.x, r6 = c5.y - (t6 - Math.abs(l6)), m2 = a6 + n5 + h5, f3 = r6 + t6;
      e6 = Math.min(e6, a6), o6 = Math.max(o6, m2), i5 = Math.min(i5, r6), s6 = Math.max(s6, f3);
    }
  ...
  static addDecoration(t5, e6) {
    ...
    for (let n5 = 1; n5 < i5; n5++) {
      const i6 = t5[n5];
      if (i6.y !== h5) {
        const l7 = t5[n5 - 1].x + t5[n5 - 1].glyphMosaicItem.metrics.left + t5[n5 - 1].glyphMosaicItem.metrics.width;
        t5.push({ codePoint: 0, x: c5, y: h5 + e6 - o6, vertical: false, glyphMosaicItem: { sdf: true, rect: new t3(4, 0, 4, 8), metrics: { width: l7 - c5, height: 2 + 2 * o6, left: 0, top: 0, advance: 0 }, page: 0, code: 0 } }), h5 = i6.y, c5 = i6.x + i6.glyphMosaicItem.metrics.left;
      }
    }
    const l6 = t5[i5 - 1].x + t5[i5 - 1].glyphMosaicItem.metrics.left + t5[i5 - 1].glyphMosaicItem.metrics.width;
    t5.push({ codePoint: 0, x: c5, y: h5 + e6 - o6, vertical: false, glyphMosaicItem: { sdf: true, rect: new t3(4, 0, 4, 8), metrics: { width: l6 - c5, height: 2 + 2 * o6, left: 0, top: 0, advance: 0 }, page: 0, code: 0 } });
  }
  ...
  _buildBreak(t5, e6, i5, o6, s6, c5) {
    ...
    for (const n5 of o6) {
      const t6 = e6 - n5.x, o7 = this._breakScore(t6, i5, s6, c5) + n5.score;
      o7 <= l6 && (h5 = n5, l6 = o7);
    }
...
var T = 2;
var y = class {
  constructor(e6, t5, i5 = 0, n5 = -1, s6 = w) {
    this.x = e6, this.y = t5, this.angle = i5, this.segment = n5, this.minzoom = s6;
  }
};
var f2 = class {
  constructor(e6, t5, i5, s6, o6, a6 = w, l6 = r) {
    this.anchor = e6, this.labelAngle = t5, this.glyphAngle = i5, this.page = s6, this.alternateVerticalGlyph = o6, this.minzoom = a6, this.maxzoom = l6;
  }
};
var I2 = class {
  constructor(e6, t5, i5, n5, s6, o6, a6, l6, h5, r6, c5, g2) {
    this.tl = e6, this.tr = t5, this.bl = i5, this.br = n5, this.mosaicRect = s6, this.labelAngle = o6, this.minAngle = a6, this.maxAngle = l6, this.anchor = h5, this.minzoom = r6, this.maxzoom = c5, this.page = g2;
  }
};
var u2 = class {
  constructor(e6) {
...
var b2 = class {
  getIconPlacement(n5, s6, o6) {
    const a6 = new h(n5.x, n5.y), l6 = o6.rotationAlignment === l2.MAP, h5 = o6.keepUpright;
    let r6 = o6.rotate * s;
    l6 && (r6 += n5.angle);
    const m2 = new u2([]);
    return o6.allowOverlap && o6.ignorePlacement || !o3 || (m2.iconColliders = []), this._addIconPlacement(m2, a6, s6, o6, r6), l6 && h5 && this._addIconPlacement(m2, a6, s6, o6, r6 + o2), m2;
  }
  _addIconPlacement(t5, i5, s6, o6, a6) {
    ...
    const p4 = s6.rect, T2 = 2 / l6, y2 = x2 - T2, f3 = d2 - T2, u4 = y2 + p4.width / l6, b4 = f3 + p4.height / l6, P = new h(y2, f3), O2 = new h(u4, b4), _2 = new h(y2, b4), k = new h(u4, f3);
    if (0 !== a6) {
      const e6 = Math.cos(a6), t6 = Math.sin(a6);
      P.rotate(e6, t6), O2.rotate(e6, t6), _2.rotate(e6, t6), k.rotate(e6, t6);
    }
    const M = new I2(P, k, _2, O2, p4, a6, 0, 256, i5, w, r, 0);
    if (t5.shapes.push(M), (!o6.allowOverlap || !o6.ignorePlacement) && o3) {
      const e6 = o6.size, s7 = o6.padding, l7 = { xTile: i5.x, yTile: i5.y, dxPixels: x2 * e6 - s7, dyPixels: d2 * e6 - s7, hard: !o6.optional, partIndex: 0, width: h5 * e6 + 2 * s7, height: r6 * e6 + 2 * s7, angle: a6, minLod: w, maxLod: r };
      t5.iconColliders.push(l7);
    }
  }
  getTextPlacement(s6, o6, a6, c5) {
    const x2 = new h(s6.x, s6.y), d2 = c5.rotate * s, y2 = c5.rotationAlignment === l2.MAP, b4 = c5.keepUpright, P = c5.padding;
    let O2 = w;
    const _2 = !y2 ? 0 : s6.angle, k = s6.segment >= 0 && y2, M = c5.allowOverlap && c5.ignorePlacement ? null : [], E2 = [], G = 4, N = !k;
    let A2 = Number.POSITIVE_INFINITY, L2 = Number.NEGATIVE_INFINITY, z = A2, F = L2;
    const v = (k || y2) && b4, R = c5.size / c4;
    let B = false;
    ...
    for (const t5 of o6) {
      ...
      if (M && N) {
        if (void 0 !== H && H !== t5.y) {
          ...
          const a7 = { xTile: s6.x, yTile: s6.y, dxPixels: e6 * R - P, dyPixels: t6 * R - P, hard: !c5.optional, partIndex: 1, width: i5 * R + 2 * P, height: o8 * R + 2 * P, angle: d2, minLod: w, maxLod: r };
      ...
      const m2 = [];
      if (k) {
        const e6 = 0.5 * o7.metrics.width, i5 = (t5.x + h5.left - G + e6) * R * p3;
        if (O2 = this._placeGlyph(s6, O2, i5, a6, s6.segment, 1, t5.vertical, g2, m2), b4 && (O2 = this._placeGlyph(s6, O2, i5, a6, s6.segment, -1, t5.vertical, g2, m2)), O2 >= T) break;
      } else m2.push(new f2(x2, _2, _2, g2, false)), y2 && b4 && m2.push(new f2(x2, _2 + o2, _2 + o2, g2, false));
      const u4 = t5.x + h5.left, C3 = t5.y - h3 - h5.top, S = u4 + h5.width, Y = C3 + h5.height;
      let q, U2, D, J, K, Q, W, X;
      if (!k && B) if (t5.vertical) {
        const t6 = (u4 + S) / 2 - h5.height / 2, i5 = (C3 + Y) / 2 + h5.width / 2;
        q = new h(-i5 - G + V, t6 - G + j), U2 = new h(q.x + l6.width, q.y + l6.height), D = new h(q.x, U2.y), J = new h(U2.x, q.y);
      } else q = new h(-C3 + G + V, u4 - G + j), U2 = new h(q.x - l6.height, q.y + l6.width), D = new h(U2.x, q.y), J = new h(q.x, U2.y);
      else q = new h(u4 - G + V, C3 - G + j), U2 = new h(q.x + l6.width, q.y + l6.height), D = new h(q.x, U2.y), J = new h(U2.x, q.y);
      for (const i5 of m2) {
        let n5, o8, a7, r6;
        if (i5.alternateVerticalGlyph) {
          if (!K) {
            const t6 = (C3 + Y) / 2 + j;
            K = new h((u4 + S) / 2 + V - h5.height / 2 - G, t6 + h5.width / 2 + G), Q = new h(K.x + l6.height, K.y - l6.width), W = new h(Q.x, K.y), X = new h(K.x, Q.y);
          }
          n5 = K, o8 = W, a7 = X, r6 = Q;
        } else n5 = q, o8 = D, a7 = J, r6 = U2;
        const g3 = C3, m3 = Y, x3 = i5.glyphAngle + d2;
        if (0 !== x3) {
          const e6 = Math.cos(x3), t6 = Math.sin(x3);
          n5 = n5.clone(), o8 = o8 == null ? void 0 : o8.clone(), a7 = a7 == null ? void 0 : a7.clone(), r6 = r6 == null ? void 0 : r6.clone(), n5.rotate(e6, t6), r6 == null ? void 0 : r6.rotate(e6, t6), o8 == null ? void 0 : o8.rotate(e6, t6), a7 == null ? void 0 : a7.rotate(e6, t6);
        }
        let p4 = 0, w2 = 256;
        if (k && B ? t5.vertical ? i5.alternateVerticalGlyph ? (p4 = 32, w2 = 96) : (p4 = 224, w2 = 32) : (p4 = 224, w2 = 96) : (p4 = 192, w2 = 64), E2.push(new I2(n5, a7, o8, r6, l6, i5.labelAngle, p4, w2, i5.anchor, i5.minzoom, i5.maxzoom, i5.page)), M && (!v || this._legible(i5.labelAngle))) {
          if (N) u4 < A2 && (A2 = u4), g3 < z && (z = g3), S > L2 && (L2 = S), m3 > F && (F = m3);
          else if (i5.minzoom < T) {
            const e6 = { xTile: s6.x, yTile: s6.y, dxPixels: (u4 + V) * R - P, dyPixels: (g3 + V) * R - P, hard: !c5.optional, partIndex: 1, width: (S - u4) * R + 2 * P, height: (m3 - g3) * R + 2 * P, angle: x3, minLod: i5.minzoom, maxLod: i5.maxzoom };
            M.push(e6);
          }
        }
      }
    ...
    if (M && N) {
      ...
      const a7 = { xTile: s6.x, yTile: s6.y, dxPixels: e6 * R - P, dyPixels: t5 * R - P, hard: !c5.optional, partIndex: 1, width: i5 * R + 2 * P, height: o7 * R + 2 * P, angle: d2, minLod: w, maxLod: r };
      M.push(a7);
    }
    const C2 = new u2(E2);
  ...
  _placeGlyph(t5, s6, l6, h5, r6, c5, g2, m2, x2) {
    let d2 = c5;
    const p4 = d2 < 0 ? a2(t5.angle + o2, e3) : t5.angle;
    let w2 = 0;
    l6 < 0 && (d2 *= -1, l6 *= -1, w2 = o2), d2 > 0 && ++r6;
    let T2 = new h(t5.x, t5.y), y2 = h5[r6], I4 = r;
    if (h5.length <= r6) return I4;
    for (; ; ) {
      const e6 = y2.x - T2.x, t6 = y2.y - T2.y, i5 = Math.sqrt(e6 * e6 + t6 * t6), n5 = Math.max(l6 / i5, s6), c6 = e6 / i5, u4 = t6 / i5, b4 = a2(Math.atan2(u4, c6) + w2, e3);
      if (x2.push(new f2(T2, p4, b4, m2, false, n5, I4)), g2 && x2.push(new f2(T2, p4, b4, m2, true, n5, I4)), n5 <= s6) return n5;
      T2 = y2.clone();
      do {
        if (r6 += d2, h5.length <= r6 || r6 < 0) return n5;
        y2 = h5[r6];
      } while (T2.isEqual(y2));
      let P = y2.x - T2.x, O2 = y2.y - T2.y;
      const _2 = Math.sqrt(P * P + O2 * O2);
      P *= i5 / _2, O2 *= i5 / _2, T2.x -= P, T2.y -= O2, I4 = n5;
    }
  }
};
...
var o4 = class extends t2 {
  ...
  add(t5, o6, r6, u4, h5, a6, n5, d2, e6, p4, i5, c5) {
    const M = this.array;
    let l6 = t2.i1616to32(t5, o6);
    M.push(l6);
    const m2 = 31;
    l6 = t2.i8888to32(Math.round(m2 * r6), Math.round(m2 * u4), Math.round(m2 * h5), Math.round(m2 * a6)), M.push(l6), l6 = t2.i8888to32(Math.round(m2 * n5), Math.round(m2 * d2), Math.round(m2 * e6), Math.round(m2 * p4)), M.push(l6), l6 = t2.i1616to32(i5, 0), M.push(l6), c5 && M.push(...c5);
  }
};
var r3 = class extends t2 {
  ...
  add(t5, o6, r6) {
    const u4 = this.array;
    u4.push(t2.i1616to32(t5, o6)), r6 && u4.push(...r6);
  }
};
var u3 = class extends t2 {
  ...
  add(t5, o6, r6, u4, h5, a6, n5) {
    const d2 = this.array, e6 = this.index;
    let p4 = t2.i1616to32(t5, o6);
    d2.push(p4);
    const i5 = 15;
    return p4 = t2.i8888to32(Math.round(i5 * r6), Math.round(i5 * u4), h5, a6), d2.push(p4), n5 && d2.push(...n5), e6;
  }
};
var h4 = class extends t2 {
  constructor(t5) {
    super(t5);
  }
  add(o6, r6, u4, h5, a6, n5, d2, e6, p4, i5, c5, M) {
    const l6 = this.array;
    let m2 = t2.i1616to32(o6, r6);
    l6.push(m2), m2 = t2.i1616to32(Math.round(8 * u4), Math.round(8 * h5)), l6.push(m2), m2 = t2.i8888to32(a6 / 4, n5 / 4, e6, p4), l6.push(m2), m2 = t2.i8888to32(0, f(d2), 10 * i5, Math.min(10 * c5, 255)), l6.push(m2), M && l6.push(...M);
  }
};
var a5 = class extends t2 {
  ...
  add(t5, o6, r6, u4, h5) {
    const a6 = this.array, n5 = t2.i1616to32(2 * t5 + r6, 2 * o6 + u4);
...
var r4 = class extends t4 {
  ...
  processFeatures(e6) {
    ...
    for (const s6 of this._features) {
      const n5 = s6.getGeometry(e6);
      if (!n5) continue;
      const l6 = i5.circleMaterial.encodeAttributes(s6, c5, i5);
      for (const e7 of n5) if (e7) for (const i6 of e7) {
        const e8 = t5.index;
...
var s4 = class _s extends t4 {
  constructor(t5, e6, i5, r6, n5, s6, o6) {
    super(t5, e6, i5), this.type = E.FILL, this._patternMap = /* @__PURE__ */ new Map(), this._fillVertexBuffer = r6, this._fillIndexBuffer = n5, this._outlineVertexBuffer = s6, this._outlineIndexBuffer = o6;
  }
  get fillIndexStart() {
  ...
  getResources(t5, e6, i5) {
    const r6 = this.layer, l6 = this.zoom, n5 = r6.getPaintProperty("fill-pattern");
    if (n5) if (n5.isDataDriven) for (const s6 of this._features) e6(n5.getValue(l6, s6), true);
    else e6(n5.getValue(l6), true);
  }
  processFeatures(t5) {
    ...
    const e6 = this.layer, i5 = this.zoom, { fillMaterial: r6, outlineMaterial: l6, hasDataDrivenFill: n5, hasDataDrivenOutline: s6 } = e6;
    t5 && t5.setExtent(this.layerExtent);
    const o6 = e6.getPaintProperty("fill-pattern"), a6 = o6 == null ? void 0 : o6.isDataDriven;
    ...
    if (a6) {
      const n6 = [];
      for (const a7 of u4) {
        const u5 = o6.getValue(i5, a7), h5 = this._spriteInfo[u5];
        if (!(h5 == null ? void 0 : h5.rect)) continue;
        const x2 = r6.encodeAttributes(a7, i5, e6, h5), c5 = f3 && s6 ? l6.encodeAttributes(a7, i5, e6) : [], _2 = a7.getGeometry(t5);
        n6.push({ ddFillAttributes: x2, ddOutlineAttributes: c5, page: h5.page, geometry: _2 }), n6.sort((t6, e7) => t6.page - e7.page);
        for (const { ddFillAttributes: t6, ddOutlineAttributes: i6, page: r7, geometry: l7 } of n6) this._processFeature(l7, f3, e6.outlineUsesFillColor, t6, i6, d2, r7);
      }
    } else for (const h5 of u4) {
      const o7 = n5 ? r6.encodeAttributes(h5, i5, e6) : null, a7 = f3 && s6 ? l6.encodeAttributes(h5, i5, e6) : null, u5 = h5.getGeometry(t5);
      this._processFeature(u5, f3, e6.outlineUsesFillColor, o7, a7, d2);
    }
  }
  serialize() {
    let t5 = 10;
    ...
    const l6 = this._patternMap, n5 = l6.size;
    if (e6[r6++] = n5, n5 > 0) for (const [s6, [o6, a6]] of l6) e6[r6++] = s6, e6[r6++] = o6, e6[r6++] = a6;
  ...
  _processFeature(t5, e6, i5, r6, l6, n5, o6) {
    if (!t5) return;
    const a6 = t5.length, f3 = !l6 || 0 === l6.length;
    if (e6 && (!i5 || f3)) for (let s6 = 0; s6 < a6; s6++) this._processOutline(t5[s6], l6);
    const u4 = 32;
    let d2;
    for (let h5 = 0; h5 < a6; h5++) {
      const e7 = _s._area(t5[h5]);
      e7 > u4 ? (void 0 !== d2 && this._processFill(t5, d2, r6, n5, o6), d2 = [h5]) : e7 < -u4 && void 0 !== d2 && d2.push(h5);
    }
    void 0 !== d2 && this._processFill(t5, d2, r6, n5, o6);
  }
  _processOutline(t5, e6) {
    const i5 = this._outlineVertexBuffer, l6 = this._outlineIndexBuffer, n5 = l6.index;
    let s6, o6, a6;
    ...
    if (!(I4 - p4 < 2)) {
      for (let r6 = p4; r6 < I4; ++r6) {
        ...
        V > 8 && (V = 8), B2 >= 0 ? (c5 = i5.add(o6.x, o6.y, f3.x, f3.y, 0, 1, e6), -1 === _2 && (_2 = c5), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), x2 = i5.add(o6.x, o6.y, V * -d2.x, V * -d2.y, 0, -1, e6), -1 === y2 && (y2 = x2), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), h5 = x2, x2 = c5, c5 = i5.add(o6.x, o6.y, d2.x, d2.y, 0, 1, e6), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), x2 = i5.add(o6.x, o6.y, u4.x, u4.y, 0, 1, e6), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5)) : (c5 = i5.add(o6.x, o6.y, V * d2.x, V * d2.y, 0, 1, e6), -1 === _2 && (_2 = c5), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), x2 = i5.add(o6.x, o6.y, -f3.x, -f3.y, 0, -1, e6), -1 === y2 && (y2 = x2), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), h5 = x2, x2 = c5, c5 = i5.add(o6.x, o6.y, -d2.x, -d2.y, 0, -1, e6), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5), h5 = i5.add(o6.x, o6.y, -u4.x, -u4.y, 0, -1, e6), h5 >= 0 && x2 >= 0 && c5 >= 0 && !n6 && l6.add(h5, x2, c5));
      }
      h5 >= 0 && x2 >= 0 && _2 >= 0 && !g2 && l6.add(h5, x2, _2), h5 >= 0 && _2 >= 0 && y2 >= 0 && !g2 && l6.add(h5, y2, _2), this._outlineIndexCount += 3 * (l6.index - n5);
    }
  }
  _processFill(r6, l6, n5, s6, o6) {
    s6 = true;
    let a6;
    l6.length > 1 && (a6 = []);
    let f3 = 0;
    for (const t5 of l6) 0 !== f3 && a6.push(f3), f3 += r6[t5].length;
    const u4 = 2 * f3, d2 = t.acquire();
    for (const t5 of l6) {
      const e6 = r6[t5], i5 = e6.length;
      for (let t6 = 0; t6 < i5; ++t6) d2.push(e6[t6].x, e6[t6].y);
    }
    const h5 = e(d2, a6, 2);
    if (s6 && e.deviation(d2, a6, 2, h5) > 0) {
      const t5 = l6.map((t6) => r6[t6].length), { buffer: e6, vertexCount: s7 } = a3(d2, t5);
      if (s7 > 0) {
        const t6 = this._fillVertexBuffer.index;
        for (let i5 = 0; i5 < s7; i5++) this._fillVertexBuffer.add(e6[2 * i5], e6[2 * i5 + 1], n5);
      ...
      if (t5 > 0) {
        ...
        let i5 = 0;
        for (; i5 < u4; ) this._fillVertexBuffer.add(d2[i5++], d2[i5++], n5);
        let r7 = 0;
...
var n4 = class extends t4 {
  ...
  getResources(e6, t5, i5) {
    const s6 = this.layer, n5 = this.zoom, r6 = s6.getPaintProperty("line-pattern"), l6 = s6.getPaintProperty("line-dasharray"), a6 = s6.getLayoutProperty("line-cap");
    if (!r6 && !l6) return;
    const o6 = (a6 == null ? void 0 : a6.getValue(n5)) || 0, u4 = a6 == null ? void 0 : a6.isDataDriven, f3 = r6 == null ? void 0 : r6.isDataDriven, h5 = l6 == null ? void 0 : l6.isDataDriven;
    if (f3 || h5) for (const p4 of this._features) t5(f3 ? r6.getValue(n5, p4) : this._getDashArrayKey(p4, n5, s6, l6, u4, a6, o6));
    else if (r6) t5(r6.getValue(n5));
    else if (l6) {
      const e7 = l6.getValue(n5);
      t5(s6.getDashKey(e7, o6));
    }
  }
  processFeatures(e6) {
    this._lineIndexStart = 3 * this.tessellationProperties._lineIndexBuffer.index, this._lineIndexCount = 0;
    const t5 = this.layer, i5 = this.zoom, s6 = this._features, n5 = this._tessellationOptions, { hasDataDrivenLine: r6, lineMaterial: l6 } = t5;
    e6 && e6.setExtent(this.layerExtent);
    ...
    const p4 = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, g2 = p4 ? null : t5.getLayoutValue("line-cap", i5), y2 = g2 || 0, d2 = !!p4;
    ...
    if (u4 || f3) {
      const r7 = [];
      for (const n6 of s6) {
        const s7 = u4 ? a6.getValue(i5, n6) : this._getDashArrayKey(n6, i5, t5, o6, d2, p4, y2), f4 = this._spriteInfo[s7];
        if (!(f4 == null ? void 0 : f4.rect)) continue;
        const h6 = l6.encodeAttributes(n6, i5, t5, f4), v = n6.getGeometry(e6);
        r7.push({ ddAttributes: h6, page: f4.page, cap: p4 ? p4.getValue(i5, n6) : g2, join: c5 ? c5.getValue(i5, n6) : _2, miterLimit: x2 ? x2.getValue(i5, n6) : V, roundLimit: m2 ? m2.getValue(i5, n6) : D, halfWidth: 0.5 * (P ? P.getValue(i5, n6) : I4), offset: L2 ? L2.getValue(i5, n6) : B, geometry: v });
      }
      r7.sort((e7, t6) => e7.page - t6.page), n5.textured = true;
      for (const { ddAttributes: e7, page: t6, cap: i6, join: s7, miterLimit: l7, roundLimit: a7, halfWidth: o7, offset: u5, geometry: f4 } of r7) n5.capType = i6, n5.joinType = s7, n5.miterLimit = l7, n5.roundLimit = a7, n5.halfWidth = o7, n5.offset = u5, this._processFeature(f4, e7, t6);
    } else {
      if (a6) {
        const e7 = a6.getValue(i5), t6 = this._spriteInfo[e7];
      ...
      for (const a7 of s6) {
        const s7 = r6 ? l6.encodeAttributes(a7, i5, t5) : null;
        p4 && (n5.capType = p4.getValue(i5, a7)), c5 && (n5.joinType = c5.getValue(i5, a7)), x2 && (n5.miterLimit = x2.getValue(i5, a7)), m2 && (n5.roundLimit = m2.getValue(i5, a7)), P && (n5.halfWidth = 0.5 * P.getValue(i5, a7)), L2 && (n5.offset = L2.getValue(i5, a7));
        const o7 = a7.getGeometry(e6);
  ...
  serialize() {
    ...
    if (t5[s6++] = r6, r6 > 0) for (const [l6, [a6, o6]] of n5) t5[s6++] = l6, t5[s6++] = a6, t5[s6++] = o6;
  ...
  _processFeature(e6, t5, i5) {
    if (!e6) return;
    const s6 = e6.length;
    for (let n5 = 0; n5 < s6; n5++) this._processGeometry(e6[n5], t5, i5);
  }
  _processGeometry(e6, t5, i5) {
    if (e6.length < 2) return;
    const n5 = 1e-3;
    let r6, l6, a6 = e6[0], o6 = 1;
    for (; o6 < e6.length; ) r6 = e6[o6].x - a6.x, l6 = e6[o6].y - a6.y, r6 * r6 + l6 * l6 < n5 * n5 ? e6.splice(o6, 1) : (a6 = e6[o6], ++o6);
    if (e6.length < 2) return;
  ...
  _getDashArrayKey(e6, t5, i5, s6, n5, r6, l6) {
    const a6 = n5 ? r6.getValue(t5, e6) : l6, o6 = s6.getValue(t5, e6);
    return i5.getDashKey(o6, a6);
  }
};
var r5 = (e6) => (t5, i5, s6, n5, r6, l6, a6, o6, u4, f3, h5) => (e6._lineVertexBuffer.add(t5, i5, a6, o6, s6, n5, r6, l6, u4, f3, h5, e6._ddValues), e6._lineVertexBuffer.index - 1);
var l5 = (e6) => (t5, i5, s6) => {
...
var L = class _L extends t4 {
  constructor(e6, t5, n5, i5, s6, o6, r6, l6, h5) {
    super(t5, n5, h5.getSpriteItems()), this.type = E.SYMBOL, this._markerMap = /* @__PURE__ */ new Map(), this._glyphMap = /* @__PURE__ */ new Map(), this._glyphBufferDataStorage = /* @__PURE__ */ new Map(), this._isIconSDF = false, this._sourceTileKey = e6, this._iconVertexBuffer = i5, this._iconIndexBuffer = s6, this._textVertexBuffer = o6, this._textIndexBuffer = r6, this._placementEngine = l6, this._workerTileHandler = h5;
  }
  get markerPageMap() {
  ...
  getResources(e6, t5, i5) {
    ...
    const x2 = [];
    let c5, d2, f3, g2;
    o6 && !o6.isDataDriven && (c5 = o6.getValue(a6)), r6 && !r6.isDataDriven && (d2 = r6.getValue(a6)), l6 && l6.isDataDriven || (f3 = s6.getLayoutValue("text-transform", a6), l6 = null), h5 && h5.isDataDriven || (g2 = s6.getLayoutValue("text-font", a6), h5 = null);
    for (const m2 of this._features) {
      const u4 = m2.getGeometry(e6);
      if (!u4 || 0 === u4.length) continue;
      let p4, _2;
      o6 && (p4 = o6.isDataDriven ? o6.getValue(a6, m2) : this._replaceKeys(c5, m2.values), p4 && t5(p4));
      let M = false;
      if (r6 && (_2 = r6.isDataDriven ? r6.getValue(a6, m2) : this._replaceKeys(d2, m2.values), _2)) {
        switch (_2 = _2.replaceAll("\\n", "\n"), l6 && (f3 = l6.getValue(a6, m2)), f3) {
          case o.LOWERCASE:
            _2 = _2.toLowerCase();
            break;
          case o.UPPERCASE:
      ...
      if (!p4 && !_2) continue;
      const P = s6.getLayoutValue("symbol-sort-key", a6, m2), I4 = { feature: m2, sprite: p4, label: _2, rtl: M, geometry: u4, hash: (_2 ? l(_2) : 0) ^ (p4 ? l(p4) : 0), priority: P, textFont: g2 };
      x2.push(I4);
    }
  ...
  processFeatures(e6) {
    e6 && e6.setExtent(this.layerExtent);
    const n5 = this.layer, s6 = this.zoom, a6 = n5.getLayoutValue("symbol-placement", s6), r6 = a6 !== n3.POINT, l6 = n5.getLayoutValue("symbol-spacing", s6) * p3, g2 = n5.getLayoutProperty("icon-image"), y2 = n5.getLayoutProperty("text-field"), b4 = g2 ? new U(n5, s6, r6) : null, T2 = y2 ? new O(n5, s6, r6) : null, V = this._workerTileHandler;
    let w2;
    ...
    for (const o6 of this._symbolFeatures) {
      let e7;
      b4 && w2 && o6.sprite && (e7 = w2[o6.sprite], e7 && e7.sdf && (this._isIconSDF = true));
      let n6;
      !!e7 && b4.update(s6, o6.feature);
      let g3 = 0;
      const y3 = o6.label;
      if (y3) {
        n(T2), T2.update(s6, o6.feature);
        const e8 = r6 && T2.rotationAlignment === l2.MAP ? T2.keepUpright : T2.writingMode && T2.writingMode.includes(p.VERTICAL);
        let i5 = 0.5;
        switch (T2.anchor) {
          case m.TOP_LEFT:
          case m.LEFT:
        ...
        if (n6 = new l4(P, c5, m2, x2, i5, a7, l7).getShaping(y3, o6.rtl, e8), n6 && n6.length > 0) {
          let e9 = 1e30, t5 = -1e30;
          for (const i6 of n6) e9 = Math.min(e9, i6.x), t5 = Math.max(t5, i6.x);
          g3 = (t5 - e9 + 2 * c4) * C2 * p3;
        }
      }
      for (let t5 of o6.geometry) {
        ...
        if (a6 === n3.LINE) {
          if ((n6 == null ? void 0 : n6.length) && (T2 == null ? void 0 : T2.size)) {
            const e8 = T2.size * p3 * (2 + Math.min(2, 4 * Math.abs(T2.offset[1])));
            t5 = _L._smoothVertices(t5, e8);
          }
          _L._pushAnchors(s7, t5, l6, g3);
        } else a6 === n3.LINE_CENTER ? _L._pushCenterAnchor(s7, t5) : o6.feature.type === i.Polygon ? _L._pushCentroid(s7, t5) : s7.push(new y(t5[0].x, t5[0].y));
        for (const i5 of s7) {
          ...
          const s8 = { shaping: n6, line: t5, iconMosaicItem: e7, anchor: i5, symbolFeature: o6, textColliders: [], iconColliders: [], textVertexRanges: [], iconVertexRanges: [] };
  ...
  serialize() {
    ...
    const t5 = new Uint32Array(e6), n5 = new Int32Array(t5.buffer), i5 = new Float32Array(t5.buffer), [s6, a6, o6] = this._sourceTileKey.split("/");
    let r6 = 0;
    ...
    t5[r6++] = this._iconVertexBuffer.index / 4, t5[r6++] = this._textVertexBuffer.index / 4, r6 = _L.serializeSymbols(t5, n5, i5, r6, this._symbolInstances), t5[r6++] = this._iconVertexBuffer.array.length;
    for (let l6 = 0; l6 < this._iconVertexBuffer.array.length; l6++) n5[r6++] = this._iconVertexBuffer.array[l6];
    ...
    for (let l6 = 0; l6 < this._textVertexBuffer.array.length; l6++) n5[r6++] = this._textVertexBuffer.array[l6];
  ...
  static _symbolsSerializationLength(e6) {
    ...
    for (const n5 of e6 || []) {
      t5 += 5, t5 += 1;
      for (const e7 of n5.textColliders) t5 += b3;
      for (const e7 of n5.iconColliders) t5 += b3;
      t5 += 1, t5 += 2 * n5.textVertexRanges.length, t5 += 1, t5 += 2 * n5.iconVertexRanges.length;
    }
    return t5;
  }
  static serializeSymbols(e6, t5, n5, i5, s6) {
    s6 = s6 || [], t5[i5++] = s6.length;
    for (const a6 of s6) {
      t5[i5++] = a6.anchor.x, t5[i5++] = a6.anchor.y, t5[i5++] = a6.symbolFeature.hash, t5[i5++] = a6.symbolFeature.priority, t5[i5++] = a6.symbolFeature.feature.featureIndex, t5[i5++] = a6.textColliders.length + a6.iconColliders.length;
      for (const e7 of a6.textColliders) t5[i5++] = e7.xTile, t5[i5++] = e7.yTile, t5[i5++] = e7.dxPixels, t5[i5++] = e7.dyPixels, t5[i5++] = e7.hard ? 1 : 0, t5[i5++] = e7.partIndex, n5[i5++] = e7.minLod, n5[i5++] = e7.maxLod, t5[i5++] = e7.width, t5[i5++] = e7.height;
      for (const e7 of a6.iconColliders) t5[i5++] = e7.xTile, t5[i5++] = e7.yTile, t5[i5++] = e7.dxPixels, t5[i5++] = e7.dyPixels, t5[i5++] = e7.hard ? 1 : 0, t5[i5++] = e7.partIndex, n5[i5++] = e7.minLod, n5[i5++] = e7.maxLod, t5[i5++] = e7.width, t5[i5++] = e7.height;
      t5[i5++] = a6.textVertexRanges.length;
      for (const [e7, n6] of a6.textVertexRanges) t5[i5++] = e7, t5[i5++] = n6;
      t5[i5++] = a6.iconVertexRanges.length;
      for (const [e7, n6] of a6.iconVertexRanges) t5[i5++] = e7, t5[i5++] = n6;
    }
    return i5;
  }
  _replaceKeys(e6, t5) {
    return e6.replaceAll(/{([^{}]+)}/g, (e7, n5) => n5 in t5 ? t5[n5] : "");
  }
  _processFeature(e6, t5, n5) {
    const { line: i5, iconMosaicItem: s6, shaping: a6, anchor: o6 } = e6, l6 = this.zoom, h5 = this.layer, x2 = !!s6;
    let c5 = true;
    x2 && (c5 = (t5 == null ? void 0 : t5.optional) || !s6);
    const d2 = a6 && a6.length > 0, f3 = !d2 || (n5 == null ? void 0 : n5.optional);
    let g2, y2;
    if (x2 && (g2 = this._placementEngine.getIconPlacement(o6, s6, t5)), (g2 || c5) && (d2 && (y2 = this._placementEngine.getTextPlacement(o6, a6, i5, n5)), y2 || f3)) {
      if (g2 && y2 || (f3 || c5 ? f3 || y2 ? c5 || g2 || (y2 = null) : g2 = null : (g2 = null, y2 = null)), y2) {
        ...
        if (this._storePlacedGlyphs(e6, y2.shapes, l6, n5.rotationAlignment, t6), y2.textColliders) {
          ...
          for (const e7 of y2.textColliders) {
            ...
            const t7 = e7.angle;
            if (t7) {
              const n6 = Math.cos(t7), i6 = Math.sin(t7), s7 = e7.dxPixels * n6 - e7.dyPixels * i6, a7 = e7.dxPixels * i6 + e7.dyPixels * n6, o7 = (e7.dxPixels + e7.width) * n6 - e7.dyPixels * i6, r6 = (e7.dxPixels + e7.width) * i6 + e7.dyPixels * n6, l7 = e7.dxPixels * n6 - (e7.dyPixels + e7.height) * i6, h6 = e7.dxPixels * i6 + (e7.dyPixels + e7.height) * n6, x3 = (e7.dxPixels + e7.width) * n6 - (e7.dyPixels + e7.height) * i6, c6 = (e7.dxPixels + e7.width) * i6 + (e7.dyPixels + e7.height) * n6, d3 = Math.min(s7, o7, l7, x3), f4 = Math.max(s7, o7, l7, x3), g3 = Math.min(a7, r6, h6, c6), y3 = Math.max(a7, r6, h6, c6);
              e7.dxPixels = d3, e7.dyPixels = g3, e7.width = f4 - d3, e7.height = y3 - g3;
            }
          }
        }
      }
      if (g2) {
        const n6 = h5.hasDataDrivenIcon ? h5.iconMaterial.encodeAttributes(e6.symbolFeature.feature, l6, h5) : null;
        if (this._addPlacedIcons(e6, g2.shapes, l6, s6.page, t5.rotationAlignment === l2.VIEWPORT, n6), g2.iconColliders) {
          e6.iconColliders = g2.iconColliders;
          for (const e7 of g2.iconColliders) {
            e7.minLod = Math.max(l6 + h2(e7.minLod), 0), e7.maxLod = Math.min(l6 + h2(e7.maxLod), 25);
            const t6 = e7.angle;
            if (t6) {
              const n7 = Math.cos(t6), i6 = Math.sin(t6), s7 = e7.dxPixels * n7 - e7.dyPixels * i6, a7 = e7.dxPixels * i6 + e7.dyPixels * n7, o7 = (e7.dxPixels + e7.width) * n7 - e7.dyPixels * i6, r6 = (e7.dxPixels + e7.width) * i6 + e7.dyPixels * n7, l7 = e7.dxPixels * n7 - (e7.dyPixels + e7.height) * i6, h6 = e7.dxPixels * i6 + (e7.dyPixels + e7.height) * n7, x3 = (e7.dxPixels + e7.width) * n7 - (e7.dyPixels + e7.height) * i6, c6 = (e7.dxPixels + e7.width) * i6 + (e7.dyPixels + e7.height) * n7, d3 = Math.min(s7, o7, l7, x3), f4 = Math.max(s7, o7, l7, x3), g3 = Math.min(a7, r6, h6, c6), y3 = Math.max(a7, r6, h6, c6);
              e7.dxPixels = d3, e7.dyPixels = g3, e7.width = f4 - d3, e7.height = y3 - g3;
            }
          }
        }
  ...
  _addPlacedIcons(e6, t5, n5, i5, s6, a6) {
    const o6 = Math.max(n5 - 1, 0), l6 = this._iconVertexBuffer, h5 = this._iconIndexBuffer, x2 = this._markerMap;
    for (const c5 of t5) {
      const t6 = s6 ? 0 : Math.max(n5 + h2(c5.minzoom), o6), d2 = s6 ? 25 : Math.min(n5 + h2(c5.maxzoom), 25);
      if (d2 <= t6) continue;
      const f3 = c5.tl, g2 = c5.tr, y2 = c5.bl, m2 = c5.br, u4 = c5.mosaicRect, p4 = c5.labelAngle, _2 = c5.minAngle, M = c5.maxAngle, P = c5.anchor, I4 = l6.index, b4 = u4.x, A2 = u4.y, L2 = b4 + u4.width, T2 = A2 + u4.height, V = l6.index;
      l6.add(P.x, P.y, f3.x, f3.y, b4, A2, p4, _2, M, t6, d2, a6), l6.add(P.x, P.y, g2.x, g2.y, L2, A2, p4, _2, M, t6, d2, a6), l6.add(P.x, P.y, y2.x, y2.y, b4, T2, p4, _2, M, t6, d2, a6), l6.add(P.x, P.y, m2.x, m2.y, L2, T2, p4, _2, M, t6, d2, a6), e6.iconVertexRanges.length > 0 && e6.iconVertexRanges[0][0] + e6.iconVertexRanges[0][1] === V ? e6.iconVertexRanges[0][1] += 4 : e6.iconVertexRanges.push([V, 4]), h5.add(I4, I4 + 1, I4 + 2), h5.add(I4 + 1, I4 + 2, I4 + 3), x2.has(i5) ? x2.get(i5)[1] += 6 : x2.set(i5, [this._iconIndexStart + this._iconIndexCount, 6]), this._iconIndexCount += 6;
    }
  }
  _addPlacedGlyphs() {
    const e6 = this._textVertexBuffer, t5 = this._textIndexBuffer, n5 = this._glyphMap;
    for (const [i5, s6] of this._glyphBufferDataStorage) for (const a6 of s6) {
      const s7 = e6.index, o6 = a6.symbolInstance, r6 = a6.ddAttributes, l6 = e6.index;
      e6.add(a6.glyphAnchor[0], a6.glyphAnchor[1], a6.tl[0], a6.tl[1], a6.xmin, a6.ymin, a6.labelAngle, a6.minAngle, a6.maxAngle, a6.minLod, a6.maxLod, r6), e6.add(a6.glyphAnchor[0], a6.glyphAnchor[1], a6.tr[0], a6.tr[1], a6.xmax, a6.ymin, a6.labelAngle, a6.minAngle, a6.maxAngle, a6.minLod, a6.maxLod, r6), e6.add(a6.glyphAnchor[0], a6.glyphAnchor[1], a6.bl[0], a6.bl[1], a6.xmin, a6.ymax, a6.labelAngle, a6.minAngle, a6.maxAngle, a6.minLod, a6.maxLod, r6), e6.add(a6.glyphAnchor[0], a6.glyphAnchor[1], a6.br[0], a6.br[1], a6.xmax, a6.ymax, a6.labelAngle, a6.minAngle, a6.maxAngle, a6.minLod, a6.maxLod, r6), o6.textVertexRanges.length > 0 && o6.textVertexRanges[0][0] + o6.textVertexRanges[0][1] === l6 ? o6.textVertexRanges[0][1] += 4 : o6.textVertexRanges.push([l6, 4]), t5.add(s7, s7 + 1, s7 + 2), t5.add(s7 + 1, s7 + 2, s7 + 3), n5.has(i5) ? n5.get(i5)[1] += 6 : n5.set(i5, [this._textIndexStart + this._textIndexCount, 6]), this._textIndexCount += 6;
    }
    this._glyphBufferDataStorage.clear();
  }
  _storePlacedGlyphs(e6, t5, n5, i5, s6) {
    const a6 = Math.max(n5 - 1, 0), o6 = i5 === l2.VIEWPORT;
    let l6, h5, x2, c5, d2, f3, g2, y2, m2, p4, _2;
    for (const u4 of t5) {
      if (l6 = o6 ? 0 : Math.max(n5 + h2(u4.minzoom), a6), h5 = o6 ? 25 : Math.min(n5 + h2(u4.maxzoom), 25), h5 <= l6) continue;
      x2 = u4.tl, c5 = u4.tr, d2 = u4.bl, f3 = u4.br, g2 = u4.labelAngle, y2 = u4.minAngle, m2 = u4.maxAngle, p4 = u4.anchor, _2 = u4.mosaicRect, this._glyphBufferDataStorage.has(u4.page) || this._glyphBufferDataStorage.set(u4.page, []);
      this._glyphBufferDataStorage.get(u4.page).push({ glyphAnchor: [p4.x, p4.y], tl: [x2.x, x2.y], tr: [c5.x, c5.y], bl: [d2.x, d2.y], br: [f3.x, f3.y], xmin: _2.x, ymin: _2.y, xmax: _2.x + _2.width, ymax: _2.y + _2.height, labelAngle: g2, minAngle: y2, maxAngle: m2, minLod: l6, maxLod: h5, placementLod: a6, symbolInstance: e6, ddAttributes: s6 });
    }
  }
  static _pushAnchors(e6, t5, n5, i5) {
    n5 += i5;
    let a6 = 0;
    const o6 = t5.length - 1;
    for (let l6 = 0; l6 < o6; l6++) a6 += h.distance(t5[l6], t5[l6 + 1]);
    let r6 = i5 || n5;
    if (r6 *= 0.5, a6 <= r6) return;
    const h5 = r6 / a6;
    let c5 = 0, d2 = -(n5 = a6 / Math.max(Math.round(a6 / n5), 1)) / 2;
    const f3 = t5.length - 1;
    for (let s6 = 0; s6 < f3; s6++) {
      const i6 = t5[s6], a7 = t5[s6 + 1], o7 = a7.x - i6.x, r7 = a7.y - i6.y, f4 = Math.sqrt(o7 * o7 + r7 * r7);
      let g2;
      for (; d2 + n5 < c5 + f4; ) {
        d2 += n5;
        const t6 = (d2 - c5) / f4, y2 = p2(i6.x, a7.x, t6), m2 = p2(i6.y, a7.y, t6);
        void 0 === g2 && (g2 = Math.atan2(r7, o7)), e6.push(new y(y2, m2, g2, s6, h5));
      }
      c5 += f4;
    }
  }
  static _pushCenterAnchor(e6, t5) {
    let n5 = 0;
    const i5 = t5.length - 1;
    for (let l6 = 0; l6 < i5; l6++) n5 += h.distance(t5[l6], t5[l6 + 1]);
    const a6 = n5 / 2;
    let o6 = 0;
    const r6 = t5.length - 1;
    for (let s6 = 0; s6 < r6; s6++) {
      const n6 = t5[s6], i6 = t5[s6 + 1], r7 = i6.x - n6.x, h5 = i6.y - n6.y, c5 = Math.sqrt(r7 * r7 + h5 * h5);
      if (a6 < o6 + c5) {
        const t6 = (a6 - o6) / c5, d2 = p2(n6.x, i6.x, t6), f3 = p2(n6.y, i6.y, t6), g2 = Math.atan2(h5, r7);
        return void e6.push(new y(d2, f3, g2, s6, 0));
      }
      o6 += c5;
    }
  }
  static _deviation(e6, t5, n5) {
    const i5 = (t5.x - e6.x) * (n5.x - t5.x) + (t5.y - e6.y) * (n5.y - t5.y), s6 = (t5.x - e6.x) * (n5.y - t5.y) - (t5.y - e6.y) * (n5.x - t5.x);
    return Math.atan2(s6, i5);
  }
  static _honorsTextMaxAngle(e6, t5, n5, i5, a6) {
    let o6 = 0;
    const r6 = n5 / 2;
    ...
    for (; o6 < r6; ) {
      ...
      let n6, r7 = h5;
      do {
        if (++r7, r7 === d2) return false;
        n6 = e6[r7];
      } while (n6.isEqual(t6));
      let l7, f3 = r7;
      do {
        if (++f3, f3 === d2) return false;
        l7 = e6[f3];
      } while (l7.isEqual(n6));
      const g2 = this._deviation(t6, n6, l7);
      for (x2.push({ deviation: g2, distToAnchor: o6 }), c5 += g2; o6 - x2[0].distToAnchor > a6; ) c5 -= x2.shift().deviation;
      if (Math.abs(c5) > i5) return false;
      o6 += h.distance(n6, l7), h5 = r7;
    }
    return true;
  }
  static _smoothVertices(e6, t5) {
    ...
    for (let y2 = 1; y2 < n5; y2++) {
      ...
      t6 > 0 && (a6 += t6, i5.push(a6), o6++, o6 !== y2 && (e6[o6] = e6[y2]));
    }
    if (n5 = o6 + 1, n5 < 3) return e6;
    t5 = Math.min(t5, 0.2 * a6);
    const r6 = e6[0].x, l6 = e6[0].y, h5 = e6[n5 - 1].x, x2 = e6[n5 - 1].y, c5 = h.sub(e6[0], e6[1]);
    c5.normalize(), e6[0].x += t5 * c5.x, e6[0].y += t5 * c5.y, c5.assignSub(e6[n5 - 1], e6[n5 - 2]), c5.normalize(), e6[n5 - 1].x += t5 * c5.x, e6[n5 - 1].y += t5 * c5.y, i5[0] -= t5, i5[n5 - 1] += t5;
    const d2 = [];
    d2.push(new h(r6, l6));
    ...
    for (let y2 = 1; y2 < n5 - 1; y2++) {
      ...
      for (let n6 = y2 - 1; n6 >= 0; n6--) {
        const s6 = g2 + i5[n6 + 1] - i5[y2];
        if (s6 < 0) break;
        const l7 = i5[n6 + 1] - i5[n6], h6 = i5[y2] - i5[n6] < g2 ? 1 : s6 / l7;
        if (h6 < f3) break;
        const x3 = h6 * h6, c6 = h6 * s6 - 0.5 * x3 * l7, d3 = h6 * l7 / t5, m2 = e6[n6 + 1], u4 = e6[n6].x - m2.x, p4 = e6[n6].y - m2.y;
        a7 += d3 / c6 * (m2.x * h6 * s6 + 0.5 * x3 * (s6 * u4 - l7 * m2.x) - x3 * h6 * l7 * u4 / 3), o7 += d3 / c6 * (m2.y * h6 * s6 + 0.5 * x3 * (s6 * p4 - l7 * m2.y) - x3 * h6 * l7 * p4 / 3), r7 += d3;
      }
      for (let s6 = y2 + 1; s6 < n5; s6++) {
        const n6 = g2 - i5[s6 - 1] + i5[y2];
        if (n6 < 0) break;
        const l7 = i5[s6] - i5[s6 - 1], h6 = i5[s6] - i5[y2] < g2 ? 1 : n6 / l7;
        if (h6 < f3) break;
        const x3 = h6 * h6, c6 = h6 * n6 - 0.5 * x3 * l7, d3 = h6 * l7 / t5, m2 = e6[s6 - 1], u4 = e6[s6].x - m2.x, p4 = e6[s6].y - m2.y;
        a7 += d3 / c6 * (m2.x * h6 * n6 + 0.5 * x3 * (n6 * u4 - l7 * m2.x) - x3 * h6 * l7 * u4 / 3), o7 += d3 / c6 * (m2.y * h6 * n6 + 0.5 * x3 * (n6 * p4 - l7 * m2.y) - x3 * h6 * l7 * p4 / 3), r7 += d3;
      }
      d2.push(new h(a7 / r7, o7 / r7));
    }
    return d2.push(new h(h5, x2)), e6[0].x = r6, e6[0].y = l6, e6[n5 - 1].x = h5, e6[n5 - 1].y = x2, d2;
  }
  static _pushCentroid(e6, t5) {
    const n5 = 0, i5 = 0, s6 = 4096, a6 = 4096, o6 = t5.length - 1;
    let r6 = 0, l6 = 0, h5 = 0, c5 = t5[0].x, d2 = t5[0].y;
    c5 > s6 && (c5 = s6), c5 < n5 && (c5 = n5), d2 > a6 && (d2 = a6), d2 < i5 && (d2 = i5);
    for (let x2 = 1; x2 < o6; x2++) {
      let e7 = t5[x2].x, o7 = t5[x2].y, f3 = t5[x2 + 1].x, g2 = t5[x2 + 1].y;
      e7 > s6 && (e7 = s6), e7 < n5 && (e7 = n5), o7 > a6 && (o7 = a6), o7 < i5 && (o7 = i5), f3 > s6 && (f3 = s6), f3 < n5 && (f3 = n5), g2 > a6 && (g2 = a6), g2 < i5 && (g2 = i5);
      const y2 = (e7 - c5) * (g2 - d2) - (f3 - c5) * (o7 - d2);
      r6 += y2 * (c5 + e7 + f3), l6 += y2 * (d2 + o7 + g2), h5 += y2;
    }
    r6 /= 3 * h5, l6 /= 3 * h5, isNaN(r6) || isNaN(l6) || e6.push(new y(r6, l6));
  }
};
L._bidiEngine = new C();
...
var g = class {
  constructor(t5, r6, o6, n5, l6, a6) {
    ...
    for (const c5 of Object.keys(t5)) {
      const r7 = t5[c5];
      this._pbfTiles[c5] = new n2(new Uint8Array(r7.protobuff), new DataView(r7.protobuff));
      if (r7.refKey) {
        const [e6] = r7.refKey.split("/").map(parseFloat), t6 = u4 - e6;
        if (t6 > 0) {
          const e7 = (1 << t6) - 1, r8 = f3 & e7, i5 = p4 & e7;
          this._tileClippers[c5] = new e2(t6, r8, i5, 8, h5);
        }
      }
  ...
  async parse(e6) {
    ...
    const o6 = [], c5 = /* @__PURE__ */ new Set(), n5 = (e7, t6) => {
      c5.has(e7) || (o6.push({ name: e7, repeat: t6 }), c5.add(e7));
    }, l6 = {};
    for (const r6 of i5) r6.getResources(r6.tileClipper, n5, l6);
    if (this._tile.status === I3.INVALID) return [];
    const a6 = this._fetchResources(o6, l6, e6);
  ...
  _processLayers(e6) {
    const { sourceNameToTileData: t5, zoom: r6, layers: s6, sourceNameToTileClipper: i5, sourceNameToUniqueSourceLayerBuckets: o6, sourceNameToUniqueSourceLayers: c5, returnedBuckets: n5, layerIdToBucket: l6, referencerUIDToReferencedId: a6 } = e6, u4 = this._sourceDataMaxLOD;
    for (let f3 = s6.length - 1; f3 >= 0; f3--) {
      ...
      if (e7.type === a.BACKGROUND || !this._canParseStyleLayer(e7.uid) || !t5[e7.source] || !i5[e7.source]) continue;
      const p4 = t5[e7.source], h5 = i5[e7.source], m2 = e7.sourceLayer, _2 = p4[m2];
      if (_2) {
        let t6 = c5[e7.source];
        if (t6 || (t6 = c5[e7.source] = /* @__PURE__ */ new Set()), t6.add(e7.sourceLayer), e7.refLayerId) a6.set(e7.uid, e7.refLayerId);
        else {
          ...
          if (t7) {
            ...
            r7 || (r7 = o6[e7.source] = {});
            let s7 = r7[m2];
            s7 || (s7 = r7[m2] = []), s7.push(t7), n5.push(t7), l6[e7.id] = t7;
          }
        }
      }
    }
  ...
  _filterFeatures(e6) {
    const { signal: r6, sourceNameToTileData: s6, sourceNameToUniqueSourceLayerBuckets: i5, sourceNameToUniqueSourceLayers: c5 } = e6, n5 = 10 * this._level, l6 = 10 * (this._level + 1), a6 = [], u4 = [];
    for (const t5 of Object.keys(c5)) {
      c5[t5].forEach((e7) => {
        a6.push(e7), u4.push(t5);
      });
    }
    for (let f3 = 0; f3 < a6.length; f3++) {
      const e7 = u4[f3], c6 = a6[f3];
  ...
  _fetchResources(e6, t5, r6) {
    ...
    for (const n5 in t5) {
      const e7 = t5[n5];
      e7.size > 0 && (c5 = i5.fetchGlyphs(this._tile.tileKey, n5, e7, this._client, r6), s6.push(c5));
    }
    return s6;
  }
  _processFeatures(e6) {
  ...
  _createLineBucket(e6) {
    return new n4(e6, this._level, this._tile.getWorkerTileHandler().getSpriteItems(), new o4(e6.lineMaterial.getStride()), new r2());
  }
...
var i3 = class {
  constructor(t5, s6, i5, a6) {
    this.status = I3.INITIALIZED, this.placementEngine = new b2(), this.tileKey = t5, this.refKeys = s6, this._workerTileHandler = i5, this._styleRepository = a6;
  }
  release() {
  ...
  async parse(e6, s6) {
    ...
    const l6 = n5.bucketsWithData, o6 = [];
    for (const t5 of a6) if (t5.hasFeatures()) {
...
var i4 = class {
  ...
  async createTileAndParse(t5, r6) {
    ...
    const a6 = new i3(o6, i5, this, this._styleRepository);
    try {
      return await a6.parse({ ...t5, sourceDataMaxLOD: this._sourceDataMaxLOD }, r6);
    } catch (n5) {
      if (a6.setObsolete(), a6.release(), !b(n5)) throw n5;
      return null;
    }
  }
  updateStyle(e6) {
  ...
  fetchGlyphs(e6, t5, s6, r6, o6) {
    ...
    return a6 ? s6.forEach((e7) => {
      a6[e7] || i5.push(e7);
    }) : (a6 = this._glyphInfo[t5] = [], s6.forEach((e7) => i5.push(e7))), 0 === i5.length ? Promise.resolve() : r6.invoke("getGlyphs", { tileID: e6, font: t5, codePoints: i5 }, o6).then((e7) => {
      for (let t6 = 0; t6 < e7.length; t6++) e7[t6] && (a6[t6] = e7[t6]);
    });
  }
  getGlyphItems(e6) {
...
//# sourceMappingURL=WorkerTileHandler-FDZ5TWVA.js.map
