...
function s2(o2) {
  switch (o2.ESRI_externalColorMixMode) {
    ...
    case "replace":
      break;
    default:
      n2(o2.ESRI_externalColorMixMode), o2.ESRI_externalColorMixMode = "tint";
  }
  return o2;
}
...
function r6(r7) {
  let e4, t5;
  return r7.replace(/^(.*\/)?([^/]*)$/, (r8, a2, i4) => (e4 = a2 || "", t5 = i4 || "", "")), { dirPart: e4, filePart: t5 };
}
...
var Y = class _Y {
  ...
  static async load(t5, r7, o2) {
    ...
    const i4 = await t5.loadBinary(r7, o2);
    if (_Y._isGLBData(i4)) return this._fromGLBData(t5, r7, i4);
  ...
  static async _parseGLBData(r7) {
    ...
    const n6 = o2.readUint32(), s3 = o2.readUint32(), a2 = o2.readUint32();
    if (n6 !== k.MAGIC) throw new s("gltf-loader-error", "Magic first 4 bytes do not fit to expected glb value.");
    ...
    for (; o2.remainingBytes() >= 8; ) {
      const r8 = o2.readUint32(), n7 = o2.readUint32();
      if (0 === f2) {
        if (n7 !== k.CHUNK_TYPE_JSON) throw new s("gltf-loader-error", "First glb chunk must be JSON.");
        if (r8 < 0) throw new s("gltf-loader-error", "No JSON data found.");
        i4 = await n3(o2.readUint8Array(r8));
      } else if (1 === f2) {
        if (n7 !== k.CHUNK_TYPE_BIN) throw new s("gltf-loader-unsupported-feature", "Second glb chunk expected to be BIN.");
  ...
  async getBuffer(t5, r7) {
    ...
    const n6 = await this._getBufferLoader(t5, r7);
    if (n6.byteLength !== o2.byteLength) throw new s("gltf-loader-error", "Buffer byte lengths should match.");
    return n6;
  }
  async _getBufferLoader(e4, t5) {
    const r7 = this._bufferLoaders.get(e4);
    if (r7) return r7;
    const o2 = this.json.buffers[e4].uri, n6 = this._context.loadBinary(this._resolveUri(o2), t5).then((e5) => new Uint8Array(e5));
    return this._bufferLoaders.set(e4, n6), n6;
  }
  async getAccessor(t5, r7) {
    ...
    const n6 = this.json.bufferViews[o2.bufferView], s3 = await this.getBuffer(n6.buffer, r7), a2 = X[o2.type], i4 = $[o2.componentType], u3 = a2 * i4, f2 = n6.byteStride || u3;
    return { raw: s3.buffer, byteStride: f2, byteOffset: s3.byteOffset + (n6.byteOffset || 0) + (o2.byteOffset || 0), entryCount: o2.count, isDenselyPacked: f2 === u3, componentCount: a2, componentByteSize: i4, componentType: o2.componentType, min: o2.min, max: o2.max, normalized: !!o2.normalized };
  }
  ...
  async getMaterial(e4, t5, r7) {
    ...
    if (!o2) {
      const n6 = null != e4.material ? i3(this.json.materials[e4.material]) : i3(), s3 = n6.pbrMetallicRoughness, a2 = this.hasVertexColors(e4), i4 = this.getTexture(s3.baseColorTexture, t5), u3 = this.getTexture(n6.normalTexture, t5), f2 = r7 ? this.getTexture(n6.occlusionTexture, t5) : void 0, l4 = r7 ? this.getTexture(n6.emissiveTexture, t5) : void 0, d3 = r7 ? this.getTexture(s3.metallicRoughnessTexture, t5) : void 0, c5 = null != e4.material ? e4.material : -1;
      o2 = { alphaMode: n6.alphaMode, alphaCutoff: n6.alphaCutoff, color: s3.baseColorFactor, doubleSided: !!n6.doubleSided, colorTexture: await i4, normalTexture: await u3, name: n6.name, id: c5, occlusionTexture: await f2, emissiveTexture: await l4, emissiveFactor: n6.emissiveFactor, metallicFactor: s3.metallicFactor, roughnessFactor: s3.roughnessFactor, metallicRoughnessTexture: await d3, hasVertexColors: a2, ESRI_externalColorMixMode: n6.extras.ESRI_externalColorMixMode, colorTextureTransform: (_b = (_a = s3 == null ? void 0 : s3.baseColorTexture) == null ? void 0 : _a.extensions) == null ? void 0 : _b.KHR_texture_transform, normalTextureTransform: (_d = (_c = n6.normalTexture) == null ? void 0 : _c.extensions) == null ? void 0 : _d.KHR_texture_transform, occlusionTextureTransform: (_f = (_e = n6.occlusionTexture) == null ? void 0 : _e.extensions) == null ? void 0 : _f.KHR_texture_transform, emissiveTextureTransform: (_h = (_g = n6.emissiveTexture) == null ? void 0 : _g.extensions) == null ? void 0 : _h.KHR_texture_transform, metallicRoughnessTextureTransform: (_j = (_i = s3 == null ? void 0 : s3.metallicRoughnessTexture) == null ? void 0 : _i.extensions) == null ? void 0 : _j.KHR_texture_transform, receiveAmbientOcclusion: n6.extras.ESRI_receiveAmbientOcclusion, receiveShadows: n6.extras.ESRI_receiveShadows };
    }
    return o2;
  }
  async getTexture(t5, o2) {
    ...
    const n6 = t5.index, s3 = this.json.textures[n6], a2 = n4(null != s3.sampler ? this.json.samplers[s3.sampler] : {}), i4 = Z(s3), u3 = this.json.images[i4], f2 = await this._loadTextureImageData(n6, s3, o2);
    return r(this._textureCache, n6, () => {
      const t6 = (e4) => 33071 === e4 || 33648 === e4 || 10497 === e4, r7 = (t7) => {
        throw new s("gltf-loader-error", `Unexpected TextureSampler WrapMode: ${t7}`);
      };
      return { data: f2, wrapS: t6(a2.wrapS) ? a2.wrapS : r7(a2.wrapS), wrapT: t6(a2.wrapT) ? a2.wrapT : r7(a2.wrapT), minFilter: a2.minFilter, name: u3.name, id: n6 };
    });
  }
  getNodeTransform(e4) {
  ...
  async _loadTextureImageData(e4, t5, r7) {
    ...
    if (o2) return o2;
    const n6 = this._createTextureLoader(t5, r7);
    return this._textureLoaders.set(e4, n6), n6;
  }
  async _createTextureLoader(t5, r7) {
    const o2 = Z(t5), n6 = this.json.images[o2];
    if (n6.uri) {
      if (n6.uri.endsWith(".ktx2")) {
        const e4 = await this._context.loadBinary(this._resolveUri(n6.uri), r7);
        return new t(new Uint8Array(e4));
      }
      return this._context.loadImage(this._resolveUri(n6.uri), r7);
    }
    if (null == n6.bufferView) throw new s("gltf-loader-unsupported-feature", "Image bufferView must be defined.");
    if (null == n6.mimeType) throw new s("gltf-loader-unsupported-feature", "Image mimeType must be defined.");
    const s3 = this.json.bufferViews[n6.bufferView], a2 = await this.getBuffer(s3.buffer, r7);
    ...
    return o(new Uint8Array(a2.buffer, i4, s3.byteLength), n6.mimeType);
  }
  async getLoadedBuffersSize() {
    ...
    return e4.reduce((e5, t6) => e5 + ((t6 == null ? void 0 : t6.byteLength) ?? 0), 0) + t5.reduce((e5, t6) => e5 + (t6 ? r4(t6) ? t6.data.byteLength : t6.width * t6.height * 4 : 0), 0);
  }
};
...
var n5 = 0;
async function l3(o2, r7, a2 = {}, l4 = true) {
  var _a, _b;
  const m2 = await Y.load(o2, r7, a2), p2 = "gltf_" + n5++, T = { lods: [], materials: /* @__PURE__ */ new Map(), textures: /* @__PURE__ */ new Map(), meta: u2(m2) }, f2 = !(!m2.json.asset.extras || "symbolResource" !== m2.json.asset.extras.ESRI_type), x2 = (_b = (_a = m2.json.asset.extras) == null ? void 0 : _a.ESRI_webstyleSymbol) == null ? void 0 : _b.webstyle, g4 = /* @__PURE__ */ new Map();
  await c4(m2, async (o3, r8, s3, n6) => {
    var _a2;
    const u3 = g4.get(s3) ?? 0;
    g4.set(s3, u3 + 1);
    const c5 = void 0 !== o3.mode ? o3.mode : E2.TRIANGLES, f3 = c5 === E2.TRIANGLES || c5 === E2.TRIANGLE_STRIP || c5 === E2.TRIANGLE_FAN ? c5 : null;
    if (null == f3) return void n.getLogger("esri.views.3d.glTF").warn("[Unsupported Feature] Unsupported primitive mode (" + E2[c5] + "). Skipping primitive.");
    if (!m2.hasPositions(o3)) return void n.getLogger("esri.views.3d.glTF").warn("Skipping primitive without POSITION vertex attribute.");
    const x3 = m2.getPositionData(o3, a2), h2 = m2.getMaterial(o3, a2, l4), w2 = m2.hasNormals(o3) ? m2.getNormalData(o3, a2) : null, v2 = m2.hasTangents(o3) ? m2.getTangentData(o3, a2) : null, S = m2.hasTextureCoordinates(o3) ? m2.getTextureCoordinates(o3, a2) : null, R = m2.hasVertexColors(o3) ? m2.getVertexColors(o3, a2) : null, _2 = m2.getIndexData(o3, a2), E4 = { name: n6, transform: r3(r8), attributes: { position: await x3, normal: w2 ? await w2 : null, texCoord0: S ? await S : null, color: R ? await R : null, tangent: v2 ? await v2 : null }, indices: await _2, primitiveType: f3, material: d2(T, await h2, p2) };
    let I = null;
    null != ((_a2 = T.meta) == null ? void 0 : _a2.ESRI_lod) && "screenSpaceRadius" === T.meta.ESRI_lod.metric && (I = T.meta.ESRI_lod.thresholds[s3]), T.lods[s3] = T.lods[s3] || { parts: [], name: n6, lodThreshold: I }, T.lods[s3].parts[u3] = E4;
  });
  for (const e4 of T.lods) e4.parts = e4.parts.filter((e5) => !!e5);
  const h = await m2.getLoadedBuffersSize();
  return { model: T, meta: { isEsriSymbolResource: f2, uri: m2.uri, ESRI_webstyle: x2 }, customMeta: {}, size: h };
}
function u2(e4) {
  const t5 = e4.json;
  let o2 = null;
  return t5.nodes.forEach((e5) => {
    const t6 = e5.extras;
    null != t6 && (t6.ESRI_proxyEllipsoid || t6.ESRI_lod) && (o2 = t6);
  }), o2;
}
async function c4(t5, o2) {
  const r7 = t5.json, s3 = r7.scenes[r7.scene || 0].nodes, a2 = s3.length > 1, i4 = [];
  for (const e4 of s3) {
    const t6 = r7.nodes[e4];
    if (i4.push(n6(e4, 0)), m(t6) && !a2) {
      t6.extensions.MSFT_lod.ids.forEach((e5, t7) => n6(e5, t7 + 1));
    }
  }
  async function n6(s4, a3) {
    const l4 = r7.nodes[s4], u3 = t5.getNodeTransform(s4);
    if (null != l4.weights && n.getLogger("esri.views.3d.glTF").warn("[Unsupported Feature] Morph targets are not supported."), null != l4.mesh) {
      ...
      for (const t6 of e4.primitives) i4.push(o2(t6, u3, a3, e4.name));
    }
    for (const e4 of l4.children || []) i4.push(n6(e4, a3));
  }
...
function d2(e4, t5, s3) {
  const a2 = (t6) => {
    const o2 = `${s3}_tex_${t6 && t6.id}${(t6 == null ? void 0 : t6.name) ? "_" + t6.name : ""}`;
    if (t6 && !e4.textures.has(o2)) {
      const s4 = l(t6.data, { wrap: { s: t6.wrapS, t: t6.wrapT }, mipmap: p.has(t6.minFilter), noUnpackFlip: true });
      e4.textures.set(o2, s4);
    }
    return o2;
  }, i4 = `${s3}_mat_${t5.id}_${t5.name}`;
  if (!e4.materials.has(i4)) {
    const r7 = r5({ color: [t5.color[0], t5.color[1], t5.color[2]], opacity: t5.color[3], alphaMode: t5.alphaMode, alphaCutoff: t5.alphaCutoff, doubleSided: t5.doubleSided, colorMixMode: t5.ESRI_externalColorMixMode, textureColor: t5.colorTexture ? a2(t5.colorTexture) : void 0, textureNormal: t5.normalTexture ? a2(t5.normalTexture) : void 0, textureOcclusion: t5.occlusionTexture ? a2(t5.occlusionTexture) : void 0, textureEmissive: t5.emissiveTexture ? a2(t5.emissiveTexture) : void 0, textureMetallicRoughness: t5.metallicRoughnessTexture ? a2(t5.metallicRoughnessTexture) : void 0, emissiveFactor: [t5.emissiveFactor[0], t5.emissiveFactor[1], t5.emissiveFactor[2]], colorTextureTransform: t5.colorTextureTransform, normalTextureTransform: t5.normalTextureTransform, occlusionTextureTransform: t5.occlusionTextureTransform, emissiveTextureTransform: t5.emissiveTextureTransform, metallicRoughnessTextureTransform: t5.metallicRoughnessTextureTransform, metallicFactor: t5.metallicFactor, roughnessFactor: t5.roughnessFactor, receiveShadows: t5.receiveShadows, receiveAmbientOcclustion: t5.receiveAmbientOcclusion });
    e4.materials.set(i4, r7);
  }
  return i4;
}
...
//# sourceMappingURL=chunk-V63IGEOE.js.map
