...
var d5 = class extends P2 {
  getVVRotationMat4(t13) {
    return xt(w2(t13), nt.identity(), () => {
      const e5 = this.getNormalizedAngle(t13).multiply(t4), r5 = Zn(e5), o12 = nn(e5);
...
var u3 = class extends t8 {
  render(a6, u11) {
    const { context: f12, painter: c8 } = a6, { target: l8 } = u11, { freezeGlobalTime: p14 } = t6, g7 = 0, x8 = c8.textureManager.animationStore.getTexture(f12, g7), d10 = [2 / a6.state.size[0], 0, 0, 0, -2 / a6.state.size[1], 0, -1, 1, 1], h10 = Array.from(s2(e3(), d10)), b7 = Array.from(i3(e3(), h10, l8.transforms.displayViewScreenMat3)), T4 = u11.instance.getInput();
...
var f4 = class {
  ...
  getFBO(t13) {
    if (null == this._dotFBO) {
      ...
      const d10 = new s3(t13, new i4(B.DEPTH_STENCIL, s8, o12));
...
var f5 = class {
  ...
  ensureAccumulateFBO(e5, r5, t13) {
    if (null == this._accumulateFramebuffer) {
      ...
      const c8 = new i4(B.DEPTH_STENCIL, r5, t13);
...
function g6() {
  const { supportsColorBufferFloat: e5, supportsColorBufferFloatBlend: o12, supportsColorBufferHalfFloat: r5 } = t3();
  return e5 && o12 || r5;
}
function m13(o12) {
  if (!o12) return true;
  switch (o12.type) {
    ...
    case "heatmap":
      if (!g6()) {
        const o13 = t3(), r5 = ["supportsColorBufferFloat", "supportsColorBufferFloatBlend", "supportsColorBufferHalfFloat"].filter((e5) => !o13[e5]).join(", ");
...
function t12(e5, i10) {
  return { type: "simple", filters: i10, capabilities: { maxTextureSize: t3().maxTextureSize }, bindings: a5(e5) };
}
function s7(e5) {
  switch (e5) {
    case "opacity":
...
//# sourceMappingURL=chunk-OBWNWUWS.js.map
