...
r([m({ type: [s5], json: { write: true } })], c4.prototype, "features", void 0), r([o("features")], c4.prototype, "readFeatures", null), c4 = r([a2("esri.rest.support.AggregateFeatureSet")], c4);
var m5 = c4;
...
var d7 = class {
  constructor(t11, i12, s9, o14) {
    this.getStage = t11, this.getSubscriptionVersion = i12, this.version = s9, this._tileInfoView = o14, this._pendingUpdates = new t2(r7), this._locked = false, this._tiles = /* @__PURE__ */ new Map();
  }
  destroy() {
...
async function t6(t11) {
  const o14 = await p2("FeaturePipelineWorker", { client: t11, strategy: "dedicated" });
  return new n6(o14);
}
var n6 = class {
  constructor(e7) {
  ...
  let q = class extends _3 {
    ...
    _validateFetchPopupFeatures(e7, r12) {
      if (null != r12) for (const i12 of e7) {
        ...
        if (i12.isAggregate) {
          ...
          if (!p(e8, r12)) throw new s("featurelayerview:fetchPopupFeatures", "Layer does not define a popup template", { layer: e8 });
        }
      }
    }
    ...
    async _fetchPopupFeatures(e7, t11) {
      ...
      for (let n11 = 0; n11 < e7.length; n11++) {
        ...
        const u12 = x(this.layer.fieldsIndex, s9.outFields), p9 = p(a11, t11);
        if (null == p9) continue;
...
//# sourceMappingURL=chunk-S6OBRPLN.js.map
