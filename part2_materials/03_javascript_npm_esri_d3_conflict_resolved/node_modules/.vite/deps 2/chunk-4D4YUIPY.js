...
var G = class extends m2 {
  ...
  async uploadAssets(e2, t2) {
    const { uploadAssets: r3 } = await import("./uploadAssets-NEGNKJSX.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(e2) {
    ...
    for (const i3 of t2) {
      ...
      if (a4(t3)) s5.push(e3);
        ...
        const t4 = e3.origin, { convertMeshVertexSpace: r4 } = await import("./convertMeshVertexSpace-RLOP5GUB.js"), n3 = await r4(e3, new a3({ origin: [t4.x, t4.y, t4.z ?? 0] }));
...
r([m()], G.prototype, "type", void 0), r([m({ constructOnly: true })], G.prototype, "layer", void 0), r([m({ constructOnly: true })], G.prototype, "supportedSourceTypes", void 0), r([m({ readOnly: true })], G.prototype, "queryTask", null), G = r([a("esri.layers.graphics.sources.FeatureLayerSource")], G);
var H = 1e3;
var B = G;
...
//# sourceMappingURL=chunk-4D4YUIPY.js.map
