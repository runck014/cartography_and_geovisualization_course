...
function y(t) {
  ...
  return s2 > 0 ? (r2.x /= s2, r2.y /= s2, true === t.hasZ && (r2.z /= s2), true === t.hasM && (r2.m /= s2), new j(r2)) : o2 > 0 ? (e.x /= o2, e.y /= o2, true === t.hasZ && (r2.z /= o2), true === t.hasM && (e.m /= o2), new j(e)) : null;
}
function m(t) {
  ...
  return i2.spatialReference = t.spatialReference.toJSON(), true === t.hasZ && (i2.z = o2 / t.points.length), true === t.hasM && (i2.m = s2 / t.points.length), new j(i2);
}
function p(t, n) {
...
function d(t, n) {
  return M2(z2(t, n), 2 * Math.PI) * (180 / Math.PI);
}
function v2(t, n) {
  return M2(Math.PI / 2 - z2(t, n), 2 * Math.PI) * (180 / Math.PI);
}
function P(t, n, e) {
...
function w(t, n, e) {
  const r2 = [e[0] - n[0], e[1] - n[1], e[2] - n[2]], o2 = W(j2(r2, [t[0] - n[0], t[1] - n[1], t[2] - n[2]]) / q(r2), 0, 1);
...
function y2(n, s2) {
  ...
  if (n.spatialReference.vcsWkid || n.spatialReference.latestVcsWkid) {
    r2 = c(n.spatialReference) / z(n.spatialReference);
  }
  ...
  for (const e of a2) {
    if (l2++, e.length > 0 && e[0][h3] === s2) return { partId: l2, distanceAlong: o2, coordinate: new j({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: e[0][0], y: e[0][1], ...n.hasZ ? { z: e[0][m3] } : {}, ...n.hasM ? { m: e[0][h3] } : {} }), segmentId: 0 };
    let t = -1;
    for (let a3 = 1; a3 < e.length; a3++) {
      const i2 = u3(e[a3 - 1], e[a3], r2);
      t++;
      const f3 = e[a3][h3] - e[a3 - 1][h3], y3 = e[a3][h3];
      if (y3 === s2) return { partId: l2, distanceAlong: i2 + o2, coordinate: new j({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: e[a3][0], y: e[a3][1], ...n.hasZ ? { z: e[a3][m3] } : {}, ...n.hasM ? { m: e[a3][h3] } : {} }), segmentId: t };
      if (y3 > s2 && s2 > e[a3 - 1][h3]) {
        const y4 = (s2 - e[a3 - 1][h3]) / f3 * i2;
        let Z3 = n.hasZ ? p2(e[a3 - 1], e[a3], y4, r2) : d2(e[a3 - 1], e[a3], y4);
        Z3 = [...Z3, s2];
        const R3 = new j({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: Z3[0], y: Z3[1], ...n.hasZ ? { z: Z3[m3] } : {}, ...n.hasM ? { m: Z3[h3] } : {} });
...
function Z2(n, s2) {
  ...
  let y3 = -1;
  if (0 === s2) return 0 === a2.length || 0 === a2[0].length ? null : { partId: 0, coordinate: new j({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: a2[0][0][0], y: a2[0][0][1], ...n.hasZ ? { z: a2[0][0][u3] } : {}, ...n.hasM ? { m: a2[0][0][o2] } : {} }), segmentId: 0 };
  for (const e of a2) {
    y3++;
    let t = -1;
    for (let a3 = 1; a3 < e.length; a3++) {
      ...
      if (f3 === s2) return { partId: y3, coordinate: new j({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: e[a3][0], y: e[a3][1], ...n.hasZ ? { z: e[a3][u3] } : {}, ...n.hasM ? { m: e[a3][o2] } : {} }), segmentId: t };
      if (f3 > s2) {
        let f4 = n.hasZ ? p2(e[a3 - 1], e[a3], s2 - l2, r2) : d2(e[a3 - 1], e[a3], s2 - l2);
        return f4 = [...f4, m2(e[a3 - 1][o2], e[a3][o2], i2, s2 - l2)], { partId: y3, coordinate: new j({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: f4[0], y: f4[1], ...n.hasZ ? { z: f4[u3] } : {}, ...n.hasM ? { m: f4[o2] } : {} }), segmentId: t };
      }
      l2 = f3;
    }
  }
...
function R2(s2, a2) {
  ...
  if (a2.spatialReference.vcsWkid || a2.spatialReference.latestVcsWkid) {
    r2 = c(a2.spatialReference) / z(a2.spatialReference);
  }
  let l2 = null, c2 = 0;
...
function M3(o2, f3) {
  ...
  if (f3.spatialReference.vcsWkid || f3.spatialReference.latestVcsWkid) {
    h3 = c(f3.spatialReference) / z(f3.spatialReference);
  }
  ...
  if (d3 < 0) return null;
  const x3 = o2.hasM && o2.hasZ ? 3 : 2, I2 = 2, z3 = u3[Z3][d3], w2 = u3[Z3][d3 + 1];
  let k2 = null, W2 = null, A = R3 ? g3[2] : null;
  o2.hasM && (W2 = m2(z3[x3], w2[x3], R3 ? r(z3, w2, h3) : h(z3, w2, false), R3 ? r(z3, g3, h3) : h(z3, g3, false))), o2.hasZ && false === f3.hasZ && (A = m2(z3[I2], w2[I2], R3 ? r(z3, w2, h3) : h(z3, w2, false), R3 ? r(z3, g3, h3) : h(z3, g3, false))), k2 = new j({ hasZ: R3, hasM: o2.hasM, spatialReference: f3.spatialReference, x: g3[0], y: g3[1], ...o2.hasZ ? { z: A } : {}, ...o2.hasM ? { m: W2 } : {} });
  let V = 0;
  for (let e = 0; e <= Z3; e++) {
  ...
  return V += o2.hasZ ? r(z3, [k2.x, k2.y, k2.z], h3) : h(z3, [k2.x, k2.y], false), { partId: Z3, segmentId: d3, coordinate: k2, distance: Math.sqrt(p3), distanceAlong: V };
}
function x2(e, t) {
  if (!e) return null;
  if (!t) return null;
  if ("extent" === e.type) {
    const t2 = e;
    e = new v({ spatialReference: e.spatialReference, rings: [[[t2.xmin, t2.ymin], [t2.xmin, t2.ymax], [t2.xmax, t2.ymax], [t2.xmax, t2.ymin], [t2.xmin, t2.ymin]]] });
  }
  switch (e.type) {
    case "point":
      return R2(e, t) ?? null;
...
//# sourceMappingURL=chunk-JAIDXJUO.js.map
