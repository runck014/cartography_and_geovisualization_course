...
var c2 = class {
  ...
  getDataValues(t6, e4, i3 = true) {
    ...
    return t6.map((t7) => {
      ...
      if (e4.field2 ? (a7 = `${m2(a7)}${e4.fieldDelimiter}${m2(this.getFieldValue(t7, e4.field2, this.fieldsIndex.get(e4.field2)))}`, e4.field3 && (a7 = `${a7}${e4.fieldDelimiter}${m2(this.getFieldValue(t7, e4.field3, this.fieldsIndex.get(e4.field3)))}`)) : "string" == typeof a7 && i3 && (h3 ? a7 = a7 ? new Date(a7).getTime() : null : f5 && (a7 = a7 ? I2(a7) : null)), s7 && Number.isFinite(a7)) {
...
var q = class {
  ...
  _sortFeatures(e4, t6, s7) {
    if (e4.length > 1 && (t6 == null ? void 0 : t6.length)) for (const i3 of t6.reverse()) {
      const t7 = i3.split(" "), a7 = t7[0], r4 = this.fieldsIndex.get(a7), n3 = !!t7[1] && "desc" === t7[1].toLowerCase(), o2 = g3(r4 == null ? void 0 : r4.type, n3);
      e4.sort((e5, t8) => {
...
var V = class {
  ...
  async executeQueryForExtent(e4, t6) {
    ...
    try {
      ...
      if (r4 === g2) return { count: 0, extent: null };
      throw r4;
    }
  }
  ...
  async executeQueryForIdSet(e4, t6) {
    ...
    try {
      ...
      if (s7 === g2) return /* @__PURE__ */ new Set();
      throw s7;
    }
  }
  ...
  _canExecuteSinglePass(e4, t6) {
    ...
    return I(e4) && ("esriSpatialRelEnvelopeIntersects" === i3 || "esriGeometryPoint" === this.geometryType && ("esriSpatialRelIntersects" === i3 || "esriSpatialRelContains" === i3));
  }
...
//# sourceMappingURL=chunk-PQMYL64R.js.map
