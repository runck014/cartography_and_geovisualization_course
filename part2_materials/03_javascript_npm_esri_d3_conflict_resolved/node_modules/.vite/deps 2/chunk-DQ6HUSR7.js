...
import {
  f
} from "./chunk-ZVUCWHFM.js";
import {
  d as d3,
  v
} from "./chunk-DXUZMPT2.js";
import {
  e as e11
...
function o13(o22, v3) {
  switch (v3.textureCoordinateType) {
    case d4.Default:
      return o22.attributes.add(e4.UV0, "vec2"), o22.varyings.add("vuv0", "vec2"), void o22.vertex.code.add(o5`void forwardTextureCoordinates() {
vuv0 = uv0;
}`);
    case d4.Compressed:
      return o22.attributes.add(e4.UV0, "vec2"), o22.varyings.add("vuv0", "vec2"), void o22.vertex.code.add(o5`vec2 getUV0() {
return uv0 / 16384.0;
}
...
vuv0 = getUV0();
    ...
    case d4.Atlas:
      return o22.attributes.add(e4.UV0, "vec2"), o22.varyings.add("vuv0", "vec2"), o22.attributes.add(e4.UVREGION, "vec4"), o22.varyings.add("vuvRegion", "vec4"), void o22.vertex.code.add(o5`void forwardTextureCoordinates() {
vuv0 = uv0;
vuvRegion = uvRegion;
}`);
    default:
      n3(v3.textureCoordinateType);
    case d4.None:
...
function n8({ normalTexture: u7, metallicRoughnessTexture: n18, metallicFactor: r11, roughnessFactor: t17, emissiveTexture: o22, emissiveFactor: s8, occlusionTexture: c8 }) {
...
function u2(u7, n18) {
  ...
  if (s8 === d4.None || s8 === d4.COUNT) return;
  u7.include(o13, n18);
  const i6 = s8 === d4.Atlas;
  i6 && u7.include(e14), u7.fragment.code.add(o5`
...
function m3(l7, u7) {
  ...
  if (d8 !== n9.Schematic && d8 !== n9.Disabled && d8 !== n9.Normal) return void m6.code.add(o5`void applyPBRFactors() {}`);
  if (d8 === n9.Disabled) return void m6.code.add(o5`void applyPBRFactors() {}
float getBakedOcclusion() { return 1.0; }`);
  if (d8 === n9.Schematic) return void m6.code.add(o5`vec3 mrr = vec3(0.0, 0.6, 0.2);
float occlusion = 1.0;
...
float getBakedOcclusion() { return 1.0; }`);
  ...
  (p4 || f6) && l7.include(u2, u7), m6.code.add(o5`vec3 mrr;
...
function o15(o22) {
  o22.attributes.add(e4.POSITION, "vec3"), o22.vertex.code.add(o5`vec3 positionModel() { return position; }`);
}
...
var F = class extends t3 {
  constructor() {
    super(...arguments), this.transformWorldFromViewTH = n2(), this.transformWorldFromViewTL = n2(), this.transformViewFromCameraRelativeRS = e3(), this.transformProjFromView = e2();
  }
};
...
var n10 = class extends W {
  constructor() {
    super(...arguments), this.transformNormalGlobalFromModel = e3(), this.toMapSpace = n4();
  }
};
...
function n11(r11, n18) {
  const { vertex: s8 } = r11;
  switch (n18.output) {
    case n7.Color:
    case n7.ColorEmission:
      if (n18.receiveShadows) return t7(r11), void s8.code.add(o5`void forwardLinearDepth() { linearDepth = gl_Position.w; }`);
      break;
    case n7.Shadow:
    case n7.ShadowHighlight:
    case n7.ShadowExcludeHighlight:
    case n7.ViewshedShadow:
      return r11.include(v2, n18), t7(r11), i2(r11), d5(r11), void s8.code.add(o5`void forwardLinearDepth() {
...
function o16(o22) {
  d5(o22), o22.vertex.code.add(o5`vec4 transformPositionWithDepth(mat4 proj, mat4 view, vec3 pos, vec2 nearFar, out float depth) {
...
function M(r11, n18) {
  ...
  m6 && (r11.vertex.uniforms.add(new e8("model", (e23) => e23.modelTransformation ?? o3)), r11.vertex.uniforms.add(new e7("normalLocalOriginFromModel", (r12) => (j(f3, r12.modelTransformation ?? o3), f3)))), n18.instanced && x2 && (r11.attributes.add(e4.INSTANCEMODELORIGINHI, "vec3"), r11.attributes.add(e4.INSTANCEMODELORIGINLO, "vec3"), r11.attributes.add(e4.INSTANCEMODEL, "mat3"), r11.attributes.add(e4.INSTANCEMODELNORMAL, "mat3"));
  const M3 = r11.vertex;
  x2 && (M3.include(c, n18), M3.uniforms.add(new o6("viewOriginHi", (e23, r12) => o12(o2(O3, r12.camera.viewInverseTransposeMatrix[3], r12.camera.viewInverseTransposeMatrix[7], r12.camera.viewInverseTransposeMatrix[11]), O3)), new o6("viewOriginLo", (e23, r12) => r5(o2(O3, r12.camera.viewInverseTransposeMatrix[3], r12.camera.viewInverseTransposeMatrix[7], r12.camera.viewInverseTransposeMatrix[11]), O3)))), M3.code.add(o5`
...
function i3(i6, t17) {
  t17.hasSymbolColors ? (i6.include(e5), i6.attributes.add(e4.SYMBOLCOLOR, "vec4"), i6.varyings.add("colorMixMode", "mediump float"), i6.vertex.code.add(o5`int symbolColorMixMode;
vec4 getSymbolColor() {
...
function e16(e23, d8) {
  d8.hasVertexColors ? (e23.attributes.add(e4.COLOR, "vec4"), e23.varyings.add("vColor", "vec4"), e23.vertex.code.add(o5`void forwardVertexColor() { vColor = color; }`), e23.vertex.code.add(o5`void forwardNormalizedVertexColor() { vColor = color * 0.003921568627451; }`)) : e23.vertex.code.add(o5`void forwardVertexColor() {}
  ...
  switch (r11.alphaDiscardMode) {
    case i.Blend:
      a10.fragment.code.add(o5`
        #define discardOrAdjustAlpha(color) { if (color.a < ${o5.float(o)}) { discard; } }
      `);
      break;
    case i.Opaque:
...
function h2(h4, O5) {
  ...
  switch (C2) {
    case n7.Depth:
      d2(j2, O5), h4.include(o16, O5), h4.include(P2, O5), h4.include(o13, O5), b2 && w.uniforms.add(new s4("tex", (e23) => e23.texture)), j2.main.add(o5`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`), h4.include(t8, O5), w.main.add(o5`
          discardBySlice(vpos);
    ...
    case n7.ObjectAndLayerIdColor:
      d2(j2, O5), h4.include(o16, O5), h4.include(o13, O5), h4.include(l2, O5), h4.include(e18, O5), h4.include(P2, O5), h4.include(e12, O5), i2(h4), h4.varyings.add("depth", "float"), b2 && w.uniforms.add(new s4("tex", (e23) => e23.texture)), j2.main.add(o5`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPositionWithDepth(proj, view, vpos, nearFar, depth);
forwardTextureCoordinates();
forwardObjectAndLayerIdColor();`), h4.include(t8, O5), w.main.add(o5`
          discardBySlice(vpos);
          ${r4(b2, o5`vec4 texColor = texture(tex, ${A2 ? "colorUV" : "vuv0"});
                 discardOrAdjustAlpha(texColor);`)}
      ...
      break;
    case n7.Normal: {
      d2(j2, O5), h4.include(o16, O5), h4.include(t4, O5), h4.include(c2, O5), h4.include(o13, O5), h4.include(l2, O5), b2 && w.uniforms.add(new s4("tex", (e24) => e24.texture)), V === a5.ScreenDerivative && h4.varyings.add("vPositionView", "vec3");
      const e23 = V === a5.Attribute || V === a5.Compressed;
      j2.main.add(o5`
          ...
          vpos = addVerticalOffset(vpos, localOrigin);
          gl_Position = transformPosition(proj, view, vpos);
          forwardTextureCoordinates();`), h4.include(P2, O5), h4.include(t8, O5), w.main.add(o5`
          discardBySlice(vpos);
          ${r4(b2, o5`vec4 texColor = texture(tex, ${A2 ? "colorUV" : "vuv0"});
                 discardOrAdjustAlpha(texColor);`)}

          ${V === a5.ScreenDerivative ? o5`vec3 normal = screenDerivativeNormal(vPositionView);` : o5`vec3 normal = normalize(vNormalWorld);
    ...
    case n7.Highlight:
      d2(j2, O5), h4.include(o16, O5), h4.include(o13, O5), h4.include(l2, O5), b2 && w.uniforms.add(new s4("tex", (e23) => e23.texture)), j2.main.add(o5`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`), h4.include(P2, O5), h4.include(t8, O5), h4.include(g2, O5), w.main.add(o5`
          discardBySlice(vpos);
          ${r4(b2, o5`vec4 texColor = texture(tex, ${A2 ? "colorUV" : "vuv0"});
                 discardOrAdjustAlpha(texColor);`)}
...
var u4 = class extends b {
  constructor(e23) {
    super(e23), this.view = null, this.consumes = { required: [] }, this.produces = n13.COMPOSITE, this.requireGeometryDepth = false, this._dirty = true;
  }
  initialize() {
  ...
  requestRender(e23) {
    var _a;
    e23 === a2.UPDATE && ((_a = this.view._stage) == null ? void 0 : _a.renderView.requestRender(e23)), this._dirty = true;
  }
  resetWebGLState() {
    var _a;
...
r([m({ constructOnly: true })], u4.prototype, "view", void 0), r([m({ constructOnly: true })], u4.prototype, "consumes", void 0), r([m()], u4.prototype, "produces", void 0), u4 = r([a("esri.views.3d.webgl.RenderNode")], u4);
var c3 = u4;
...
var r6 = class {
  constructor(r11, i6, s8) {
    ...
    }, this.bindPass = i6.generateBindPass(this), this.bindDraw = i6.generateBindDraw(this), this._fragmentUniforms = a6() ? i6.fragmentUniforms : null;
  }
  dispose() {
...
var l4 = class extends n14 {
  constructor(r11, s8, i6) {
    super(r11, s8, new t10(f, () => import("./SSAOBlur.glsl-S2NI3HYA.js")), i6);
  }
  initializePipeline() {
...
var t12 = class extends n14 {
  constructor(r11, s8, i6) {
    super(r11, s8, new t10(v, () => import("./SSAO.glsl-LTVXX7TR.js")), i6);
  }
  initializePipeline() {
    return B({ colorWrite: g });
  }
...
var O4 = class extends c3 {
  constructor(e23) {
    super(e23), this.consumes = { required: ["normals"] }, this.produces = t9.SSAO, this.isEnabled = () => false, this._enableTime = n(0), this._passParameters = new t11(), this._drawParameters = new o18();
  }
  initialize() {
    const e23 = Uint8Array.from(atob(e20), (e24) => e24.charCodeAt(0)), r11 = new p();
    r11.wrapMode = D.CLAMP_TO_EDGE, r11.pixelFormat = G.RGB, r11.wrapMode = D.REPEAT, r11.hasMipmap = true, r11.width = 32, r11.height = 32, this._passParameters.noiseTexture = new m2(this.renderingContext, r11, e23), this.techniques.precompile(t12), this.techniques.precompile(l4), this.addHandles(d(() => this.isEnabled(), () => this._enableTime = n(0)));
  }
  destroy() {
    this._passParameters.noiseTexture = r2(this._passParameters.noiseTexture);
  }
  render(e23) {
    const s8 = this.bindParameters, t17 = e23.find(({ name: e24 }) => "normals" === e24), o22 = t17 == null ? void 0 : t17.getTexture(), a10 = t17 == null ? void 0 : t17.getTexture(t2), p4 = this.fboCache, d8 = s8.camera, f6 = d8.fullViewport[2], b2 = d8.fullViewport[3], _3 = Math.round(f6 / A), P4 = Math.round(b2 / A), x2 = this.techniques.acquire(t12), q = this.techniques.acquire(l4);
    if (!x2.compiled || !q.compiled) return this._enableTime = n(performance.now()), this.requestRender(a2.UPDATE), x2.release(), q.release(), p4.acquire(_3, P4, t9.SSAO, R.RED);
    0 === this._enableTime && (this._enableTime = n(performance.now()));
    const O5 = this.renderingContext, E3 = this.view.qualitySettings.fadeDuration, v3 = d8.relativeElevation, R2 = r3((o17 - v3) / (o17 - e19), 0, 1), C2 = E3 > 0 ? Math.min(E3, performance.now() - this._enableTime) / E3 : 1, D2 = C2 * R2;
    ...
    O5.bindFramebuffer(M3.fbo), this._drawParameters.colorTexture = V.getTexture(), o4(this._drawParameters.blurSize, 0, A / b2), O5.bindTechnique(q, s8, this._passParameters, this._drawParameters), O5.setViewport(0, 0, _3, P4), O5.screen.draw(), V.release();
    const L2 = p4.acquire(_3, P4, t9.SSAO, R.RED);
    return O5.bindFramebuffer(L2.fbo), O5.setViewport(0, 0, f6, b2), O5.setClearColor(1, 1, 1, 0), O5.clear(_2.COLOR), this._drawParameters.colorTexture = M3.getTexture(), o4(this._drawParameters.blurSize, A / f6, 0), O5.bindTechnique(q, s8, this._passParameters, this._drawParameters), O5.setViewport(0, 0, _3, P4), O5.screen.draw(), q.release(), O5.setViewport4fv(d8.fullViewport), M3.release(), C2 < 1 && this.requestRender(a2.UPDATE), L2;
  }
};
...
function n15(n18, r11) {
  ...
  n18.include(t16), r11.pbrMode !== n9.Normal && r11.pbrMode !== n9.Schematic && r11.pbrMode !== n9.Simplified && r11.pbrMode !== n9.TerrainWithWater || (l7.add(o5`float normalDistribution(float NdotH, float roughness)
{
...
return c2 * a004 + r.zw;
}`)), r11.pbrMode !== n9.Normal && r11.pbrMode !== n9.Schematic || (n18.include(t15), l7.add(o5`struct PBRShadingInfo
{
float NdotV;
float LdotH;
float NdotNG;
...
return ambientLight * (1.0 - ambientOcclusion);
}`), g4.pbrMode !== n9.Normal && g4.pbrMode !== n9.Schematic || r11.code.add(o5`const vec3 skyTransmittance = vec3(0.9, 0.9, 1.0);
...
function p3(g4, p4) {
  ...
  switch (g4.include(t13, p4), p4.pbrMode !== n9.Disabled && g4.include(n15, p4), g4.include(r8, p4), g4.include(t16), v3.code.add(o5`
    const float GAMMA_SRGB = 2.1;
    const float INV_GAMMA_SRGB = 0.4761904;
    ${p4.pbrMode === n9.Disabled ? "" : "const vec3 GROUND_REFLECTANCE = vec3(0.2);"}
...
inputs.averageAmbientRadiance = ambientLightIrradianceComponent[1] * (1.0 + GROUND_REFLECTANCE[1]);`), v3.code.add(o5`
        ...
        ${p4.pbrMode !== n9.Schematic || p4.hasColorTexture ? o5`vec3 outColor = pow(blackLevelSoftCompression(outColorLinear, inputs), vec3(INV_GAMMA_SRGB));` : o5`vec3 outColor = pow(max(vec3(0.0), outColorLinear - 0.005 * inputs.averageAmbientRadiance), vec3(INV_GAMMA_SRGB));`}
        return outColor;
      }
    `);
      break;
    case n9.Simplified:
    case n9.TerrainWithWater:
...
function c7(u7, f6) {
  ...
  p4 && (u7.include(u2, f6), u7.fragment.uniforms.add(l7 === a3.Pass ? new s4("texEmission", (e23) => e23.textureEmissive) : new s3("texEmission", (e23) => e23.textureEmissive)));
...
function d7(d8, f6) {
  ...
  const p4 = f6.output === n7.ObjectAndLayerIdColor, c8 = S2(f6.output), g4 = u(f6.output) && f6.oitPass === o10.ColorAlpha, h4 = u(f6.output) && f6.oitPass !== o10.ColorAlpha, m6 = f6.discardInvisibleFragments;
  let C2 = 0;
  (h4 || c8 || g4) && d8.outputs.add("fragColor", "vec4", C2++), c8 && d8.outputs.add("fragEmission", "vec4", C2++), g4 && d8.outputs.add("fragAlpha", "float", C2++), d8.fragment.code.add(o5`
    void outputColorHighlightOID(vec4 finalColor, const in vec3 vWorldPosition) {
      ...
      ${r4(m6, o5`if (finalColor.a < ${o5.float(o)}){
              discard;
              return;
            }`)}
...
//# sourceMappingURL=chunk-DQ6HUSR7.js.map
