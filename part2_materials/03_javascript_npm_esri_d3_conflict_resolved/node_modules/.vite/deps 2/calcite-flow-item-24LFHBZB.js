...
var FlowItem = proxyCustomElement(class FlowItem2 extends H {
  ...
  renderBackButton() {
    ...
    return showBackButton ? h("calcite-action", { "aria-label": label, class: CSS.backButton, icon, key: "flow-back-button", onClick: backButtonClick, ref: this.setBackRef, scale: "s", slot: "header-actions-start", text: label, title: label }) : null;
  }
  render() {
    ...
    return h(Host, { key: "2e7872bb2687db0b67ddbf375f8ec0beaabbda36" }, h(InteractiveContainer, { key: "a9418954405a2cec2092bae3be5d77f02306e3c9", disabled }, h("calcite-panel", { key: "d563c751421bf2d66c03286deaa613e09f585546", beforeClose, closable, closed, collapseDirection, collapsed, collapsible, description, disabled, heading, headingLevel, loading, menuOpen, messageOverrides: messages, onCalcitePanelClose: this.handleInternalPanelClose, onCalcitePanelScroll: this.handleInternalPanelScroll, onCalcitePanelToggle: this.handleInternalPanelToggle, overlayPositioning, ref: this.setContainerRef, scale: this.scale }, this.renderBackButton(), h("slot", { key: "c506ec8bb4debbd6a9da6c7941878de49776f614", name: SLOTS2.actionBar, slot: SLOTS.actionBar }), h("slot", { key: "e76e55e654ff878acff734bdf387402a9e262159", name: SLOTS2.alerts, slot: SLOTS.alerts }), h("slot", { key: "f7ab8839d7b101e31087130ebf3e36af1ec7da24", name: SLOTS2.headerActionsStart, slot: SLOTS.headerActionsStart }), h("slot", { key: "2932c4c15b168732356b8e55fcc3064f5b3f4cf5", name: SLOTS2.headerActionsEnd, slot: SLOTS.headerActionsEnd }), h("slot", { key: "1ef8a9050683022733695445092f8c626487d87b", name: SLOTS2.headerContent, slot: SLOTS.headerContent }), h("slot", { key: "24c0ab570a601a6c0edfb0c820e580fd24b158ce", name: SLOTS2.headerMenuActions, slot: SLOTS.headerMenuActions }), h("slot", { key: "ec55bbe7ba939a6efb35225850c37a1aadb97275", name: SLOTS2.fab, slot: SLOTS.fab }), h("slot", { key: "aa0bfec47656ef9f7f575cd933897a7909e5badc", name: SLOTS2.contentTop, slot: SLOTS.contentTop }), h("slot", { key: "e23532d080e2df529c2aeb6af043c6efe7a0ab6d", name: SLOTS2.contentBottom, slot: SLOTS.contentBottom }), h("slot", { key: "db6ffc0d9300c77067a4c88ab277de685c7713af", name: SLOTS2.footerStart, slot: SLOTS.footerStart }), h("slot", { key: "5f249356da9292f34c4036d0d0741f048fe999e9", name: SLOTS2.footer, slot: SLOTS.footer }), h("slot", { key: "7476137bacc0f3be5c97682c5027f74d73254765", name: SLOTS2.footerEnd, slot: SLOTS.footerEnd }), h("slot", { key: "58f60a46c42a05abe9b100a57d478d991e4f25bc", name: SLOTS2.footerActions, slot: SLOTS.footerActions }), h("slot", { key: "926a8d94b76b6fcdef6dfd219ba8180c44f81c35" }))));
  }
...
@esri/calcite-components/dist/components/calcite-flow-item.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-flow-item-24LFHBZB.js.map
