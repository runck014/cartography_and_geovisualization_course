...
function b3(r5) {
  s4(f4, r5), A(f4, f4);
  const a10 = Math.atan2(f4[1], f4[0]), s8 = b2(e3(), h, -a10);
  Q(f4, f4, s8);
  const c7 = -1 * Math.atan2(f4[2], f4[0]);
  return [c(a10) + 270, c(c7) + 90];
}
function g2(o3, a10) {
  return b2(u4, h, u2(o3 - 270)), b2(p3, j4, u2(a10 - 90)), x2(l4, u4, p3), s4(f4, x3), Q(f4, f4, l4), A(f4, f4), [f4[0], f4[1], f4[2]];
}
...
var m2 = class extends i(f) {
  ...
  get orientation() {
    ...
    return a5.normalize(a2(o3), 0, true);
  }
  set orientation(o3) {
  ...
  get tilt() {
    if (!Array.isArray(this.normal) || 3 !== this.normal.length) return 0;
    const [o3, t6] = b3(this.normal);
    return a5.normalize(a2(t6), 0, true);
  }
  set tilt(o3) {
...
r([m({ type: Boolean, json: { write: true } })], m2.prototype, "enabled", void 0), r([m({ type: String, json: { write: true } })], m2.prototype, "label", void 0), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o3) => a5.normalize(a2(o3), 0, true))], m2.prototype, "orientation", null), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o3) => a5.normalize(a2(o3), 0, true))], m2.prototype, "tilt", null), r([m({ type: [Number], json: { write: true } })], m2.prototype, "normal", void 0), r([m({ type: [Number], json: { write: true } })], m2.prototype, "point", void 0), m2 = r([a3("esri.layers.voxel.VoxelSlice")], m2);
var c3 = m2;
...
r([m({ type: Boolean, json: { default: true, write: true } })], d3.prototype, "enabled", void 0), r([m({ type: String, json: { origins: { service: { read: f2 } }, write: { enabled: true, isRequired: true } } }), j3({ origins: ["web-scene"], type: "resource", prefix: "sections", compress: true })], d3.prototype, "href", void 0), r([m({ type: x, json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "id", void 0), r([m({ type: String, json: { write: true } })], d3.prototype, "label", void 0), r([m({ type: Number, clonable: false, readOnly: true, range: { min: 0, max: 360 } })], d3.prototype, "orientation", null), r([m({ type: Number, clonable: false, readOnly: true, range: { min: 0, max: 360 } })], d3.prototype, "tilt", null), r([m({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "normal", void 0), r([m({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "point", void 0), r([m({ type: [x], json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "sizeInPixel", void 0), r([m({ type: [c3], json: { write: true } })], d3.prototype, "slices", void 0), r([m({ type: x, json: { default: 0, write: true } })], d3.prototype, "timeId", void 0), r([m({ type: x, json: { write: { enabled: true, isRequired: true } } })], d3.prototype, "variableId", void 0), d3 = r([a3("esri.layers.voxel.VoxelSection")], d3);
var u5 = d3;
...
r([m({ type: l, json: { type: [x], write: { enabled: true, isRequired: true } } })], c4.prototype, "color", void 0), r([m({ type: Number, json: { write: { enabled: true, isRequired: true } } })], c4.prototype, "position", void 0), c4 = r([a3("esri.layers.voxel.VoxelColorStop")], c4);
var l6 = c4;
...
r([m({ type: Number, json: { name: "alpha", write: { enabled: true, isRequired: true } } })], p7.prototype, "opacity", void 0), r([m({ type: Number, json: { write: { enabled: true, isRequired: true } } })], p7.prototype, "position", void 0), p7 = r([a3("esri.layers.voxel.VoxelOpacityStop")], p7);
var i5 = p7;
...
r([m({ type: Boolean, json: { default: false, write: true } })], p8.prototype, "enabled", void 0), r([m({ type: [Number], json: { write: true } })], p8.prototype, "range", void 0), p8 = r([a3("esri.layers.voxel.VoxelRangeFilter")], p8);
var a7 = p8;
...
} } } })], y4.prototype, "opacityStops", null), r([m({ type: a7, json: { write: true } })], y4.prototype, "rangeFilter", void 0), r([m({ type: [l], clonable: false, json: { read: false } })], y4.prototype, "rasterizedTransferFunction", null), y4 = r([a3("esri.layers.voxel.VoxelTransferFunctionStyle")], y4);
var g3 = y4;
var S2 = ["r", "g", "b"];
...
r([m({ type: l, json: { type: [x], write: { enabled: true, isRequired: true } } })], a8.prototype, "color", void 0), r([m({ type: x, json: { write: { enabled: true, isRequired: true } } })], a8.prototype, "value", void 0), r([m({ type: Boolean, json: { default: true, write: true } })], a8.prototype, "enabled", void 0), r([m({ type: String, json: { write: true } })], a8.prototype, "label", void 0), a8 = r([a3("esri.layers.voxel.VoxelUniqueValue")], a8);
var l7 = a8;
...
} } } })], c5.prototype, "isosurfaces", void 0), c5 = p9 = r([a3("esri.layers.voxel.VoxelVariableStyle")], c5);
var f5 = c5;
...
var f6 = class extends f {
  ...
  computeLayerSpaceLocation(e4) {
    ...
    const i6 = u(e4);
    if (e2(i6, i6, this.voxelSizeInLayerSpaceSigned), u3(i6, i6, this.originInLayerSpace3D), "xyt" === this.volumeType) return new j({ x: i6[0], y: i6[1], spatialReference: this.spatialReference });
...
r([m({ type: Boolean, json: { default: true, write: true } })], m3.prototype, "enabled", void 0), r([m({ type: String, json: { write: true } })], m3.prototype, "label", void 0), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o3) => a5.normalize(a2(o3), 0, true))], m3.prototype, "orientation", null), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o3) => a5.normalize(a2(o3), 0, true))], m3.prototype, "tilt", null), r([m({ type: [Number], json: { write: true } })], m3.prototype, "normal", void 0), r([m({ type: [Number], json: { write: true } })], m3.prototype, "point", void 0), m3 = r([a3("esri.layers.voxel.VoxelDynamicSection")], m3);
var c6 = m3;
...
} } } })], m4.prototype, "dynamicSections", null), m4 = p13 = r([a3("esri.layers.voxel.VoxelVolumeStyle")], m4);
var d5 = m4;

// node_modules/@arcgis/core/layers/VoxelLayer.js
var z = class extends R(l2(b(j2(t(S(e(i3(f3)))))))) {
  constructor(e4) {
  ...
  set url(e4) {
    this._set("url", y2(e4, n.getLogger(this)));
  }
  load(e4) {
  ...
  get fields() {
    const e4 = [new y({ name: "Voxel.Position", alias: "Voxel Position", domain: null, editable: false, length: 128, type: "string" }), new y({ name: "Voxel.CurrentVariable", alias: "Current Variable", domain: null, editable: false, length: 128, type: "string" })];
    for (const i6 of this.variables) {
      const t7 = new y({ name: i6.name, alias: i6.description, domain: null, editable: false, length: 128, type: "discrete" === i6.renderingFormat.continuity ? "string" : "double" });
      e4.push(t7);
    }
    const t6 = this.getVolume(null);
    if (null != t6) {
      if ("xyzt" === t6.volumeType || "xyt" === t6.volumeType) {
        const t7 = new y({ name: "Voxel.LocalTime", alias: "Local Time", domain: null, editable: false, length: 256, type: "date" });
        e4.push(t7);
        const i6 = new y({ name: "Voxel.SourceTime", alias: "Source Time", domain: null, editable: false, length: 256, type: "string" });
        e4.push(i6);
      }
      if ("xyt" !== t6.volumeType) {
        const t7 = new y({ name: "Voxel.Depth", alias: "Depth", domain: null, editable: false, length: 128, type: "double" });
        e4.push(t7);
      }
    }
    return e4;
  ...
  get timeInfo() {
    ...
    return new d2({ fullTimeExtent: i6, stops: t6 });
  }
  getVolumeStyle(e4) {
    const t6 = this.getVariable(e4);
