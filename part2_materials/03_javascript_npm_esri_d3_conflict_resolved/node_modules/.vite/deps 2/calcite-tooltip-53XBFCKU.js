...
var TooltipManager = class {
  constructor() {
    ...
    this.pointerMoveHandler = (event) => {
      ...
      } else if (activeTooltip == null ? void 0 : activeTooltip.open) {
    ...
    this.openHoveredTooltip = (tooltip) => {
      ...
      this.hoverOpenTimeout = window.setTimeout(() => {
        ...
        this.closeTooltipIfNotActive(tooltip);
        this.toggleTooltip(tooltip, true);
      }, ((_a = this.activeTooltip) == null ? void 0 : _a.open) ? 0 : TOOLTIP_OPEN_DELAY_MS);
    };
    this.closeHoveredTooltip = () => {
...
var Tooltip = proxyCustomElement(class Tooltip2 extends H {
  ...
  render() {
    ...
    }, ref: this.setTransitionEl }, h(FloatingArrow, { key: "57f68bea5a7bb369d82437f10535cab9753677ea", floatingLayout, ref: (arrowEl) => this.arrowEl = arrowEl }), h("div", { key: "100b8318173849508952f996acaeb5bf81b8af43", class: CSS.container }, h("slot", { key: "f89d3ae9313d9555e6a7acdc32c323de85319a3a" }))));
  }
  get el() {
    return this;
  }
...
@esri/calcite-components/dist/components/calcite-tooltip.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-tooltip-53XBFCKU.js.map
