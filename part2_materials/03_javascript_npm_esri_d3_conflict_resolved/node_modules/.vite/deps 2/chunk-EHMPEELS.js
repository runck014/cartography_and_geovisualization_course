...
var ye = class extends p9(c2(c(l(p4(l3(t(f4(S(f3))))))))) {
  constructor(e5) {
  ...
  set renderer(e5) {
    p6(e5, this.fieldsIndex), this._set("renderer", e5);
  }
  get renderer() {
    var _a;
  ...
  async queryFeatures(e5, t7) {
    const { resolvedQuery: r7, queryEngine: o5 } = await this._setupQueryObjects(e5), i4 = d3.fromJSON(await o5.executeQuery(r7.toJSON(), t7 == null ? void 0 : t7.signal));
  ...
  loadQueryEngine(e5) {
    var _a;
    const t7 = new m3({ geometryType: o.toJSON(this.geometryType), hasM: this.hasM, hasZ: this.hasZ }), r7 = new V({ fieldsIndex: this.fieldsIndex.toJSON(), geometryType: o.toJSON(this.geometryType), hasM: this.hasM, hasZ: this.hasZ, objectIdField: this.objectIdField, spatialReference: this.spatialReference.toJSON(), timeInfo: (_a = this.timeInfo) == null ? void 0 : _a.toJSON(), featureStore: t7 });
...
r([m(ie(a(s2)))], ye.prototype, "blendMode", void 0), r([m()], ye.prototype, "capabilities", void 0), r([m({ json: { origins: { "web-scene": { write: false } }, write: ae() } })], ye.prototype, "charts", void 0), r([m({ readOnly: true })], ye.prototype, "defaultPopupTemplate", null), r([m({ type: String, json: { origins: { service: { read: false } }, name: "layerDefinition.definitionExpression", write: { ignoreOrigin: true } } })], ye.prototype, "definitionExpression", void 0), r([m()], ye.prototype, "displayField", void 0), r([m(ie(a(a3)))], ye.prototype, "effect", void 0), r([m()], ye.prototype, "elevationInfo", void 0), r([m(ie(a(p2)))], ye.prototype, "featureEffect", void 0), r([m(ie(a(p3)))], ye.prototype, "featureReduction", null), r([m()], ye.prototype, "fields", null), r([m()], ye.prototype, "geometryType", null), r([m()], ye.prototype, "geometryFieldName", null), r([m({ type: ["entity", "relationship"], nonNullable: true, json: { write: { isRequired: true, ignoreOrigin: true } } })], ye.prototype, "graphType", void 0), r([m({ type: String, nonNullable: true, json: { write: { isRequired: true, ignoreOrigin: true } } })], ye.prototype, "graphTypeName", null), r([m()], ye.prototype, "hasM", null), r([m()], ye.prototype, "hasZ", null), r([m({ type: String, json: { origins: { service: { read: false }, "portal-item": { read: false } }, write: { ignoreOrigin: true } } })], ye.prototype, "id", void 0), r([m(ie(a(p)))], ye.prototype, "labelsVisible", void 0), r([m({ type: [C], json: { name: "layerDefinition.drawingInfo.labelingInfo", read: n3, write: ae() } })], ye.prototype, "labelingInfo", void 0), r([m({ readOnly: true, json: { read: false, write: { writer(e5, t7) {
...
}, isRequired: true, ignoreOrigin: true, writerEnsuresNonNull: true } } })], ye.prototype, "layerType", void 0), r([m(ie(a(d2)))], ye.prototype, "legendEnabled", void 0), r([m(ie(a(v2)))], ye.prototype, "maxScale", void 0), r([m(ie(a(j2)))], ye.prototype, "minScale", void 0), r([m()], ye.prototype, "objectIdField", void 0), r([m()], ye.prototype, "objectType", void 0), r([m(ie(a(f2)))], ye.prototype, "opacity", void 0), r([m(ie(a(c3)))], ye.prototype, "orderBy", void 0), r([m({ clonable: false })], ye.prototype, "parent", void 0), r([m()], ye.prototype, "parentCompositeLayer", void 0), r([m(ie(a(l2)))], ye.prototype, "popupEnabled", void 0), r([m({ type: q, json: { name: "popupInfo", write: { ignoreOrigin: true } } })], ye.prototype, "popupTemplate", void 0), r([m({ type: Number, json: { write: { overridePolicy: le } } })], ye.prototype, "refreshInterval", void 0), r([m({ types: m2, json: { name: "layerDefinition.drawingInfo.renderer", write: ae() } })], ye.prototype, "renderer", null), r([m()], ye.prototype, "source", void 0), r([m()], ye.prototype, "spatialReference", null), r([m({ type: d4, json: { name: "layerDefinition.timeInfo", write: true, origins: { "web-document": { name: "layerDefinition.timeInfo", read: true, write: true }, "portal-item": { name: "layerDefinition.timeInfo", read: true, write: true } } } })], ye.prototype, "timeInfo", null), r([m({ type: String, json: { write: { isRequired: true, ignoreOrigin: true, writerEnsuresNonNull: true } } })], ye.prototype, "title", null), r([r3("title")], ye.prototype, "writeTitle", null), r([m({ json: { read: false } })], ye.prototype, "type", void 0), r([m(ie(a(f5)))], ye.prototype, "useViewTime", void 0), r([m({ type: Boolean, json: { name: "visibility", write: ae() } })], ye.prototype, "visible", void 0), ye = r([a2("esri.layers.knowledgeGraph.KnowledgeGraphSublayer")], ye);
var ue = ye;
...
//# sourceMappingURL=chunk-EHMPEELS.js.map
