...
function v(e8, n7) {
  if (!(n7 == null ? void 0 : n7.constructor) || !p(n7.constructor)) return g(e8, n7) ? n7 : new e8(n7);
  const r5 = y(e8.prototype.itemType), t6 = y(n7.constructor.prototype.itemType);
  return r5 ? t6 ? r5 === t6 ? n7 : r5.prototype.isPrototypeOf(t6.prototype) ? new e8(n7) : (g(e8, n7), n7) : new e8(n7) : n7;
}
function g(e8, n7) {
  return !!c(n7) && (r2().error("Accessor#set", "Assigning an instance of '" + (n7.declaredClass || "unknown") + "' which is not a subclass of '" + m(e8) + "'"), true);
}
function h(e8, n7) {
  return null == n7 ? n7 : p(e8) ? v(e8, n7) : f(e8, n7) ? g(e8, n7) ? n7 : new e8(n7) : n7;
}
function m(e8) {
  var _a;
...
function T(e8, n7) {
  if (2 === arguments.length) return T(e8).call(null, n7);
  ...
  return (e9, n8) => {
    ...
    return i6 && (t6.has(e9) || u8.some((e10) => "string" === l7 && e10 === String || "number" === l7 && e10 === Number)) || "object" === l7 && u8.some((n9) => !f(e9, n9)) ? e9 : (i6 && o10.length ? (a10 || (a10 = o10.map((e10) => "string" == typeof e10 ? `'${e10}'` : `${e10}`).join(", ")), r2().error("Accessor#set", `'${e9}' is not a valid value for this property, only the following values are valid: ${a10}`)) : "object" == typeof e9 && u8.length ? (s10 || (s10 = u8.map((e10) => m(e10)).join(", ")), r2().error("Accessor#set", `'${e9}' is not a valid value for this property, value must be one of ${s10}`)) : r2().error("Accessor#set", `'${e9}' is not a valid value for this property`), n8 && (n8.valid = false), null);
  };
}
function N(e8, n7) {
  ...
  return (n8) => {
    ...
    if (!f(e8.typeMap[o11], n8)) return n8;
    if ("string" == typeof e8.key && !c(n8)) {
      const r5 = {};
...
function u2(r5, n7, t6) {
  if (t6) {
    return o2(r5, n7, { policy: t6, path: "" });
  }
  return o2(r5, n7, null);
}
function o2(r5, t6, e8) {
  return t6 ? Object.keys(t6).reduce((r6, i6) => {
    ...
    if (Array.isArray(c9) || Array.isArray(r6)) a10 = a10 ? Array.isArray(a10) ? r6[u8] = a10.slice() : r6[u8] = [a10] : r6[u8] = [], c9 && (Array.isArray(c9) || (c9 = [c9]), c9.forEach((r7) => {
      ...
      const n7 = e8.path;
      e8.path = l7, r6[u8] = o2(a10, c9, e8), e8.path = n7;
    } else r6[u8] = o2(a10, c9, null);
...
function c2(r5) {
  if (Array.isArray(r5)) {
    const n7 = [];
    for (const t6 of r5) n7.push(...a3(t6));
    return n7;
  }
  return a3(r5);
}
function p2(n7, t6, e8, i6) {
  const u8 = c2(t6);
  if (1 !== u8.length) {
...
var l2 = false;
var g2 = false;
function f2(t6, n7, r5) {
  if (l2) return p3(t6, n7, r5);
  let e8 = null;
  return k2(t6), e8 = n7.call(r5), m2(), e8;
}
function u3(t6, n7) {
  return f2(o3, t6, n7);
}
function p3(n7, r5, e8) {
  const i6 = l2;
  l2 = true, k2(n7);
  let o10 = null;
  try {
    ...
    g2 && n.getLogger("esri.core.accessorSupport.tracking").error(c9);
  }
  return m2(), l2 = i6, o10;
}
function k2(t6) {
...
function m2() {
  ...
  if (t6 > 1) {
    const n7 = c3.pop();
    s5 = c3[t6 - 2], n7.onTrackingEnd();
  } else if (1 === t6) {
    const t7 = c3.pop();
    s5 = o3, t7.onTrackingEnd();
  } else s5 = o3;
}
function d2(t6, n7) {
  ...
  const r5 = g2;
  g2 = false, n7.flags & i2.AutoTracked ? p3(n7.trackingTarget, n7.metadata.get, t6) : y2(t6, n7), g2 = r5;
}
var T2 = [];
function y2(t6, r5) {
  r5.flags & i2.ExplicitlyTracking || (r5.flags |= i2.ExplicitlyTracking, p3(r5.trackingTarget, () => {
    const e8 = r5.metadata.dependsOn || T2;
    for (const r6 of e8) if ("string" != typeof r6 || r6.includes(".")) {
      const e9 = s3(r6);
      for (let n7 = 0, r7 = t6; n7 < e9.length && null != r7 && "object" == typeof r7; ++n7) r7 = h2(r7, e9[n7], n7 !== e9.length - 1);
    } else h2(t6, r6, false);
  }), r5.flags &= ~i2.ExplicitlyTracking);
}
function h2(t6, n7, e8) {
...
var i3 = () => n.getLogger("esri.core.accessorSupport.extensions.serializableProperty.reader");
...
function y3(t6) {
  return t6.prototype.read ? (e8, r5, n7) => {
    ...
    const o10 = typeof e8;
    if ("object" !== o10) return void i3().error(`Expected JSON value of type 'object' to deserialize type '${t6.prototype.declaredClass}', but got '${o10}'`);
    const p8 = new t6();
...
function g3(t6) {
  ...
  return (p8, u8, s10) => {
    ...
    const y6 = typeof p8;
    if ("object" !== y6) return void i3().error(`Expected JSON value of type 'object' to deserialize, but got '${y6}'`);
    e8 || (e8 = v2(t6));
    const f6 = t6.key;
    ...
    if (!a10) {
      ...
      return (s10 == null ? void 0 : s10.messages) && p8 && s10.messages.push(new s6(`${n7}:unsupported`, t7, { definition: p8, context: s10 })), void i3().error(t7);
    }
    const d4 = new a10();
...
function e6(e8) {
  if (e8.json || (e8.json = {}), o6(e8.json), n5(e8.json), r4(e8.json), e8.json.origins) for (const t6 in e8.json.origins) o6(e8.json.origins[t6]), n5(e8.json.origins[t6]), r4(e8.json.origins[t6]);
  return true;
}
function r4(e8) {
...
function i4(r5, e8) {
  ...
  r5 && (1 === t6 || "type" in r5 && e5(r5.type)) ? e8.write.writer = a7 : t6 > 1 ? e8.write.writer = l4(t6) : e8.types ? Array.isArray(e8.types) ? e8.write.writer = f4(e8.types[0]) : e8.write.writer = o7(e8.types) : e8.write.writer = s8;
}
function o7(r5) {
...
function p6(r5) {
  ...
  if (r5.json.origins) for (const e8 in r5.json.origins) {
    ...
    p4(s10, o10, false), o10.types && !o10.write && ((_a = r5.json.write) == null ? void 0 : _a.enabled) && (o10.write = { ...r5.json.write }), i4(s10, o10);
  }
  p4(i6, r5.json, true), i4(i6, r5.json);
}
function f5(r5) {
...
var e7 = class _e {
  ...
  acquire(...t6) {
    ...
    return this._acquireFunction ? this._acquireFunction(o10, ...t6) : i5(o10) && o10.acquire(...t6), o10;
  }
  release(i6) {
    i6 && !_e.test.disabled && (this._releaseFunction ? this._releaseFunction(i6) : t4(i6) && i6.release(), this._pool.push(i6));
  }
...
e7.test = { disabled: false };

// node_modules/@arcgis/core/core/nextTick.js
var o9 = [];
function t5(t6) {
  o9.push(t6), 1 === o9.length && queueMicrotask(() => {
    const t7 = o9.slice();
    o9.length = 0;
...
//# sourceMappingURL=chunk-33ECLFFF.js.map
