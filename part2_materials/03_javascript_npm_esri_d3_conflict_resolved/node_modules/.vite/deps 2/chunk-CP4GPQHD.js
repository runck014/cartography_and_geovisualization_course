...
var c = class extends f {
  constructor(o3) {
    super(o3), this.id = "sym" + m2++, this.type = null, this.color = new l([0, 0, 0, 1]);
  }
  readColor(o3) {
...
r([m({ type: p.apiValues, readOnly: true, json: { read: false, write: { ignoreOrigin: true, writer: p.write } } })], c.prototype, "type", void 0), r([m({ type: l, json: { write: { allowNull: true } } })], c.prototype, "color", void 0), r([o("color")], c.prototype, "readColor", null), c = r([a3("esri.symbols.Symbol")], c);
var n2 = c;
...
r([r4({ esriSLS: "simple-line" }, { readOnly: true })], p2.prototype, "type", void 0), r([m({ type: Number, cast: o2, json: { write: true } })], p2.prototype, "width", void 0), p2 = r([a3("esri.symbols.LineSymbol")], p2);
var c2 = p2;
...
r([m({ type: ["begin", "end", "begin-end"], json: { write: true } })], m3.prototype, "placement", void 0), r([r4({ "line-marker": "line-marker" }, { readOnly: true }), m({ json: { origins: { "web-map": { write: false } } } })], m3.prototype, "type", void 0), r([m({ type: n3 })], m3.prototype, "style", void 0), r([r2("style")], m3.prototype, "writeStyle", null), r([m({ type: l, value: null, json: { write: { allowNull: true } } })], m3.prototype, "color", null), r([o("color")], m3.prototype, "readColor", null), r([r2("color")], m3.prototype, "writeColor", null), m3 = n4 = r([a3("esri.symbols.LineSymbolMarker")], m3);
var u = m3;

// node_modules/@arcgis/core/symbols/SimpleLineSymbol.js
var h;
var p3 = new n({ esriSLSSolid: "solid", esriSLSDash: "dash", esriSLSDot: "dot", esriSLSDashDot: "dash-dot", esriSLSDashDotDot: "long-dash-dot-dot", esriSLSNull: "none", esriSLSShortDash: "short-dash", esriSLSShortDot: "short-dot", esriSLSShortDashDot: "short-dash-dot", esriSLSShortDashDotDot: "short-dash-dot-dot", esriSLSLongDash: "long-dash", esriSLSLongDashDot: "long-dash-dot" });
var m4 = h = class extends c2 {
  constructor(...o3) {
...
r([r4({ esriSLS: "simple-line" }, { readOnly: true })], m4.prototype, "type", void 0), r([m({ type: p3.apiValues, json: { read: p3.read, write: p3.write } })], m4.prototype, "style", void 0), r([m({ type: ["butt", "round", "square"], json: { write: { overridePolicy: (o3, r6, t2) => ({ enabled: "round" !== o3 && null == (t2 == null ? void 0 : t2.origin) }) } } })], m4.prototype, "cap", void 0), r([m({ type: ["miter", "round", "bevel"], json: { write: { overridePolicy: (o3, r6, t2) => ({ enabled: "round" !== o3 && null == (t2 == null ? void 0 : t2.origin) }) } } })], m4.prototype, "join", void 0), r([m({ types: { key: "type", base: null, defaultKeyValue: "line-marker", typeMap: { "line-marker": u } }, json: { write: true, origins: { "web-scene": { write: false } } } })], m4.prototype, "marker", void 0), r([m({ type: Number, json: { read: false, write: false } })], m4.prototype, "miterLimit", void 0), m4 = h = r([a3("esri.symbols.SimpleLineSymbol")], m4);
var d = m4;
...
var l3 = c3 = class extends f {
  ...
  clone() {
    return new c3({ decoration: this.decoration, family: this.family, size: this.size, style: this.style, weight: this.weight });
  }
  hash() {
    return `${this.decoration}.${this.family}.${this.size}.${this.style}.${this.weight}`;
  }
};
r([m({ type: l2, json: { default: "none", write: true } })], l3.prototype, "decoration", void 0), r([m({ type: String, json: { write: true } })], l3.prototype, "family", void 0), r([m({ type: Number, json: { write: { overridePolicy: (t2, o3, e2) => ({ enabled: !e2 || !e2.textSymbol3D }) } } })], l3.prototype, "size", void 0), r([s("size")], l3.prototype, "castSize", null), r([m({ type: t, json: { default: "normal", write: true } })], l3.prototype, "style", void 0), r([m({ type: r5, json: { default: "normal", write: true } })], l3.prototype, "weight", void 0), l3 = c3 = r([a3("esri.symbols.Font")], l3);
var m6 = l3;
...
var f2;
var g = f2 = class extends n2 {
  constructor(...t2) {
    super(...t2), this.backgroundColor = null, this.borderLineColor = null, this.borderLineSize = null, this.font = new m6(), this.horizontalAlignment = "center", this.kerning = true, this.haloColor = null, this.haloSize = null, this.rightToLeft = null, this.rotated = false, this.text = "", this.type = "text", this.verticalAlignment = "baseline", this.xoffset = 0, this.yoffset = 0, this.angle = 0, this.width = null, this.lineWidth = 192, this.lineHeight = 1;
  }
...
r([m({ type: l, json: { write: true } })], g.prototype, "backgroundColor", void 0), r([m({ type: l, json: { write: true } })], g.prototype, "borderLineColor", void 0), r([m({ type: Number, json: { write: true }, cast: o2 })], g.prototype, "borderLineSize", void 0), r([m({ type: m6, json: { write: true } })], g.prototype, "font", void 0), r([m({ ...m5, json: { write: true } })], g.prototype, "horizontalAlignment", void 0), r([m({ type: Boolean, json: { write: true } })], g.prototype, "kerning", void 0), r([m({ type: l, json: { write: true } })], g.prototype, "haloColor", void 0), r([m({ type: Number, cast: o2, json: { write: true } })], g.prototype, "haloSize", void 0), r([m({ type: Boolean, json: { write: true } })], g.prototype, "rightToLeft", void 0), r([m({ type: Boolean, json: { write: true } })], g.prototype, "rotated", void 0), r([m({ type: String, json: { write: true } })], g.prototype, "text", void 0), r([r4({ esriTS: "text" }, { readOnly: true })], g.prototype, "type", void 0), r([m({ ...p4, json: { write: true } })], g.prototype, "verticalAlignment", void 0), r([m({ type: Number, cast: o2, json: { write: true } })], g.prototype, "xoffset", void 0), r([m({ type: Number, cast: o2, json: { write: true } })], g.prototype, "yoffset", void 0), r([m({ type: Number, json: { read: (t2) => t2 && -1 * t2, write: (t2, o3) => o3.angle = t2 && -1 * t2 } })], g.prototype, "angle", void 0), r([m({ type: Number, json: { write: true } })], g.prototype, "width", void 0), r([m({ type: Number })], g.prototype, "lineWidth", void 0), r([r2("lineWidth")], g.prototype, "writeLineWidth", null), r([s("lineWidth")], g.prototype, "castLineWidth", null), r([m(n5)], g.prototype, "lineHeight", void 0), r([r2("lineHeight")], g.prototype, "writeLineHeight", null), g = f2 = r([a3("esri.symbols.TextSymbol")], g);
var m9 = g;
...
//# sourceMappingURL=chunk-CP4GPQHD.js.map
