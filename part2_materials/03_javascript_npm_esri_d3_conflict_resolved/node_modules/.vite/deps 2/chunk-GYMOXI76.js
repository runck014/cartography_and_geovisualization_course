...
var o3 = class {
  constructor() {
    this.instances = { fill: a(T.fill, { uniforms: l, optionalAttributes: { zoomRange: true } }), marker: a(T.marker, { uniforms: l, optionalAttributes: { zoomRange: true } }), line: a(T.line, { uniforms: l, optionalAttributes: { zoomRange: true } }), text: a(T.text, { uniforms: l, optionalAttributes: { zoomRange: true, referenceSymbol: false, clipAngle: false } }), complexFill: a(T.complexFill, { uniforms: l, optionalAttributes: { zoomRange: true } }), texturedLine: a(T.texturedLine, { uniforms: l, optionalAttributes: { zoomRange: true } }), animatedMarker: a(T.animatedMarker, { uniforms: l, optionalAttributes: { zoomRange: true } }) }, this._instancesById = Object.values(this.instances).reduce((e3, i4) => (e3.set(i4.instanceId, i4), e3), /* @__PURE__ */ new Map());
  }
  getInstance(e3) {
...
var b2 = class extends e2 {
  ...
  _updateMatricesAndLocalOrigin(t2) {
    const { state: a2 } = t2, { displayMat3: m, size: c, resolution: u2, pixelRatio: _, rotation: h2, viewpoint: p } = a2, d = v * h2, { x: g, y: x2 } = p.targetGeometry, b3 = L(g, a2.spatialReference);
    this._localOrigin.x = b3, this._localOrigin.y = x2;
    const y2 = _ * c[0], B = _ * c[1], M2 = u2 * y2, j = u2 * B, A = o(this._dvsMat3);
    i(A, A, m), M(A, A, t(y2 / 2, B / 2)), f(A, A, r2(c[0] / M2, -B / j, 1)), h(A, A, -d);
  }
...
var i3 = class extends n {
  ...
  enableRenderingBounds(e3) {
    this._boundsRenderer = new b2(e3), this.requestRender();
  }
  get hasHighlight() {
...
//# sourceMappingURL=chunk-GYMOXI76.js.map
