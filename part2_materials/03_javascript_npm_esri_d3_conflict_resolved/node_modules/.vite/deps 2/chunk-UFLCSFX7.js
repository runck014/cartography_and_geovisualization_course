...
async function r3(r4, n4, t2, s2, a2, i2, l) {
  ...
  if (null != t2) {
    ...
    try {
      return { type: "page", rootPage: (await U(n5, { query: { f: "json", ...s2, token: a2 }, responseType: "json", signal: l })).data, rootIndex: t2.rootIndex, pageSize: t2.nodesPerPage, lodMetric: t2.lodSelectionMetricType, urlPrefix: o3 };
    } catch (g2) {
  ...
  try {
    return { type: "node", rootNode: (await U(u3, { query: { f: "json", ...s2, token: a2 }, responseType: "json", signal: l })).data, urlPrefix: c };
  } catch (g2) {
  ...
  let C2 = class extends R2 {
    ...
    readFullExtent(e, t2, r4) {
      if (null != e && "object" == typeof e) {
        const o4 = null == e.spatialReference ? { ...e, spatialReference: U2(t2) } : e;
        return w.fromJSON(o4, r4);
      }
      const o3 = t2.store, i2 = U2(t2);
      return null == i2 || null == (o3 == null ? void 0 : o3.extent) || !Array.isArray(o3.extent) || o3.extent.some((e2) => e2 < L) ? null : new w({ xmin: o3.extent[0], ymin: o3.extent[1], xmax: o3.extent[2], ymax: o3.extent[3], spatialReference: i2 });
    }
    ...
    set url(e) {
      ...
      const t2 = S2({ layer: this, url: e, nonStandardUrlAllowed: false, logger: n.getLogger(this) });
    ...
    async _fetchFirstLayerId(e) {
      const r4 = await U(this.url ?? "", { query: { f: "json", ...this.customParameters, token: this.apiKey }, responseType: "json", signal: e });
      if (r4.data && Array.isArray(r4.data.layers) && r4.data.layers.length > 0) return r4.data.layers[0].id;
    }
    async _fetchServiceLayer(e) {
      var _a;
      const r4 = await U(((_a = this.parsedUrl) == null ? void 0 : _a.path) ?? "", { query: { f: "json", ...this.customParameters, token: this.apiKey }, responseType: "json", signal: e });
    ...
    async _fetchVoxelServiceLayer(e) {
      var _a;
      const r4 = (await U(((_a = this.parsedUrl) == null ? void 0 : _a.path) + "/layer", { query: { f: "json", ...this.customParameters, token: this.apiKey }, responseType: "json", signal: e })).data;
    ...
    async _saveAs(e, t2) {
      ...
      const s2 = i2.portal || b.getDefault();
      await this._ensureLoadBeforeSave(), i2.type = P, i2.portal = s2;
...
${t3.join("\n")}`;
  ...
  return r([m(u)], C2.prototype, "id", void 0), r([m({ type: g })], C2.prototype, "spatialReference", void 0), r([o("spatialReference", ["spatialReference", "store.indexCRS", "store.geographicCRS"])], C2.prototype, "readSpatialReference", null), r([m({ type: w })], C2.prototype, "fullExtent", void 0), r([o("fullExtent", ["fullExtent", "store.extent", "spatialReference", "store.indexCRS", "store.geographicCRS"])], C2.prototype, "readFullExtent", null), r([m({ readOnly: true, type: v })], C2.prototype, "heightModelInfo", void 0), r([m({ type: Number, json: { name: "layerDefinition.minScale", write: true, origins: { service: { read: { source: "minScale" }, write: false } } } })], C2.prototype, "minScale", void 0), r([m({ type: Number, json: { name: "layerDefinition.maxScale", write: true, origins: { service: { read: { source: "maxScale" }, write: false } } } })], C2.prototype, "maxScale", void 0), r([m({ readOnly: true })], C2.prototype, "version", void 0), r([o("version", ["store.version"])], C2.prototype, "readVersion", null), r([m({ type: String, json: { read: { source: "copyrightText" } } })], C2.prototype, "copyright", void 0), r([m({ type: String, json: { read: false } })], C2.prototype, "sublayerTitleMode", void 0), r([m({ type: String })], C2.prototype, "title", void 0), r([o("portal-item", "title")], C2.prototype, "readTitlePortalItem", null), r([o("service", "title", ["name"])], C2.prototype, "readTitleService", null), r([m({ type: Number, json: { origins: { service: { read: { source: "id" } }, "portal-item": { write: { target: "id", isRequired: true, ignoreOrigin: true }, read: false } } } })], C2.prototype, "layerId", void 0), r([m(y)], C2.prototype, "url", null), r([r2("url")], C2.prototype, "writeUrl", null), r([m()], C2.prototype, "parsedUrl", null), r([m({ readOnly: true })], C2.prototype, "store", void 0), r([m({ type: String, readOnly: true, json: { read: { source: "store.rootNode" } } })], C2.prototype, "rootNode", void 0), C2 = r([a("esri.layers.mixins.SceneService")], C2), C2;
};
var L = -1e38;
function U2(e) {
...
//# sourceMappingURL=chunk-UFLCSFX7.js.map
