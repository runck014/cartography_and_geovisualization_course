...
var c = class _c extends M2 {
  ...
  _readGeometry() {
    if (!this._cachedGeometry) {
      ...
      if ("esriGeometryPolyline" === this.geometryType && (t4 = ht(new s3(), t4, this.hasZ, this.hasM, this.geometryType, this._tile.transform.scale[0])), this._cachedGeometry = at(new s3(), t4, this.hasZ, this.hasM, this.geometryType, this._tile.transform), !this._cachedGeometry) return null;
  ...
  _wrapGeometry(t4) {
    ...
    if (t4.isPoint) return 1 === e ? (t4.coords.push(a4, 0), t4.coords.push(2 * -a4, 0), void t4.lengths.push(3)) : 2 === e ? (t4.coords.push(2 * a4, 0), t4.coords.push(4 * -a4, 0), void t4.lengths.push(3)) : void this._wrapVertex(t4.coords, 0, 2, e);
  ...
  _wrapVertex(t4, e, r2, s6) {
    ...
    o2 < -a4 * (s6 - 2) ? t4[i2] = o2 + a4 * s6 : o2 > a4 * (s6 - 1) && (t4[i2] = o2 - a4 * s6);
  }
  _readX() {
  ...
  _readServerCentroid() {
    switch (this.geometryType) {
      case "esriGeometryPolygon": {
        const t4 = l(this._current.projectedGeometry), r2 = new s3([], t4);
        return at(new s3(), r2, this.hasZ, this.hasM, this.geometryType, this._tile.transform);
      }
      case "esriGeometryPolyline": {
        const e = this._current.projectedGeometry, r2 = o(e.paths, this.hasZ), s6 = new s3([], r2);
        return at(new s3(), s6, this.hasZ, this.hasM, this.geometryType, this._tile.transform);
      }
    }
    return null;
  }
...
//# sourceMappingURL=chunk-LH2VBN6X.js.map
