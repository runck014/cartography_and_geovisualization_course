...
import type { WebChartBin, WebChartDataItem } from "@arcgis/charts-spec";
 ...
 */
export declare function isSliceMatchingSelection(props: {
    sliceDataContext: WebChartDataItem;
    selectionDataContext: WebChartDataItem;
    xAxisField: string;
    layerOidField?: string;
}): boolean;
/**
 ...
 */
export declare function isElementPartOfSelection(props: {
    options?: ChartOptions;
    elementDataContext?: WebChartBin | WebChartDataItem;
    selectionDataItems: WebChartDataItem[];
...
export declare function getSelectedElementData(props: {
