...
const ArcGISChartsBarChart = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a542c82c3aae570cb0f4f560448f793ac5c42ba1' }, index.h("slot", { key: '4f9afb8f19681e524c788d4bba5745273c43d785', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.BarSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), index.h("div", { key: '8c8809d062c01092fddf756eebaa1b91ea6afd52', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: 'cc61e0b06b128fec89b5bdd23a86fb48985b8450', class: notifyStyles }, notifyPanel)));
    }
    /**
