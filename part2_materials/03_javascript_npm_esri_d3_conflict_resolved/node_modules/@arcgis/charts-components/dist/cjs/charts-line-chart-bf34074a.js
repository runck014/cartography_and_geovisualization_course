...
const ArcGISChartsLineChart = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e0f32fe0a0ee702a9d6ff1f1e15007ac989f5715' }, index.h("slot", { key: '1a822414b6a9347520958062140f19893ccab60c', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.LineSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), index.h("div", { key: '05df626a4c4701aacbb01a4ee08cb5bc9a968e66', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '503d08383bbcfb5eb55dab94e8550690df0281f1', class: notifyStyles }, notifyPanel)));
    }
    /**
