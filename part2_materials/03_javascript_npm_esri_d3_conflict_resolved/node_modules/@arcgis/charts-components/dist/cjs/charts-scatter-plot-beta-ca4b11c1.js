...
const ArcGISChartsScatterPlotBeta = class {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.Mc([actionBarUtils.WebChartTypes.ScatterSeries], this.config);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e6b14c8002c0afede3de90e184b1ebcf79dc04f8' }, index.h("slot", { key: 'add5e1e2ea3770b66d7c0b4f6afb6a33cdf49c03', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.ScatterSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), index.h("div", { key: '7cf4ecddf1090b96ba6b66213fe241e4e53e336c', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '80f38804c69d4e77f210d5ffa24cef20d335091e', class: notifyStyles }, notifyPanel)));
    }
    /**
