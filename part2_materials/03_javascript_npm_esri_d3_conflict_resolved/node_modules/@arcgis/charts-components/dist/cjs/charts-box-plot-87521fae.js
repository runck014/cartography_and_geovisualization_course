...
const ArcGISChartsBoxPlot = class {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.Mc([actionBarUtils.WebChartTypes.BoxPlotSeries, actionBarUtils.WebChartTypes.LineSeries], this.config);
    ...
    render() {
        ...
        const chartStyles = this.showNotifyPanel && this.notifyOptions?.kind === "danger" ? "hide" : `${actionBarUtils.WebChartTypes.BoxPlotSeries} show`;
        const notifyStyles = this.showNotifyPanel ? "show notifyPanel" : "hide";
        return (index.h(index.Host, { key: '85f8f9cff7410c223c31c71a3f4a0b128b3adae2' }, index.h("slot", { key: '8cb3db0f73228dd8ed49faa7c25066240ef7db38', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.BoxPlotSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), index.h("div", { key: '4685723d03fbc3c517154fdf0ab5469a5d0ed628', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: 'c6da22d1ec706b9b40d1a20a4d4ccb6240b941b2', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    checkForIncompatibleChartVersion() {
        ...
        if (actionBarUtils.jc(chartVersion).versionStatus === actionBarUtils.WebChartVersionStatus.Newer) {
