...
const ArcGISChartsHistogram = class {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.Mc([actionBarUtils.WebChartTypes.HistogramSeries], this.config);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd575fe47ab3f5bdf2509f75a87c8fccb1d975daf' }, index.h("slot", { key: '34ec67613feade72ef09361487a70687b697891f', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.HistogramSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), index.h("div", { key: 'e548fbab3b1c97f757c268f262e6e5c4fb652d48', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: 'a68ea4310a28df1fdba44a77b0fc8ad8770a9883', class: notifyStyles }, notifyPanel)));
    }
    /**
