...
const ArcGISChartsScatterPlot = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c536edac1d40148e6b893b5fefa919c4fd9b04e9' }, index.h("slot", { key: '96c68736b3f3459ccf23d2e9be1703cc3716d2bb', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.ScatterSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), index.h("div", { key: '9942604ba06a484d9a9f1b74ce524c62d36157b8', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: 'd14bbd08004bce2ad9595d80e8ed1903198f3b8d', class: notifyStyles }, notifyPanel)));
    }
    /**
