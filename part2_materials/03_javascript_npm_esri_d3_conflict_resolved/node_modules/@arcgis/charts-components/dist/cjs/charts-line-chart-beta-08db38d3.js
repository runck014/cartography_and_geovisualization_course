...
const index$1 = require('./index-d6b5a76f.js');
...
const ArcGISChartsLineChartBeta = class {
    ...
    layerRendererChangePolicyCallBack(newRefreshOnLayerRenderer) {
        if (newRefreshOnLayerRenderer !== actionBarUtils.Em.Ignore) {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.Mc([actionBarUtils.WebChartTypes.LineSeries], this.config);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd2f016cfdc8dc9d3d5a192baaa02ed72d3d050af' }, index.h("slot", { key: '4f0edfe56fdf009c4f8b2629f67587261d3efbae', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.LineSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), index.h("div", { key: '77c443f3482ba202d59b0183ec1d3545f8442930', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '3458c2113233d998402d78aeccd2131ce2f3ee60', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    async createChartInstance(firstCreation = true) {
        ...
        try {
            if (configUpdate.isValidDataSource(this.config, this.layer)) {
                ...
                this.chartCreationProcessing = index$1.wV({
