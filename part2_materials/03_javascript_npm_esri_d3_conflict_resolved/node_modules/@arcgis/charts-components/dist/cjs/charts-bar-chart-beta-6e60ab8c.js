...
const ArcGISChartsBarChartBeta = class {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.Mc([actionBarUtils.WebChartTypes.BarSeries], this.config);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '91a6be49778ec467e87ef1de119e7508af377585' }, index.h("slot", { key: 'c5b509ece4aa25110b7ab72a52df3b1daaf4c774', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
                actionBarUtils.onActionBarSlotChange(e, actionBarUtils.WebChartTypes.BarSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), index.h("div", { key: '8aea83dd957720a2ba40d920de6295f5d9876332', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '289e792e14206745575bfc068f52c0c95cf05d94', class: notifyStyles }, notifyPanel)));
    }
    /**
