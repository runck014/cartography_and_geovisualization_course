...
const configUpdate = require('./config-update-99377d6b.js');
...
const ArcGISChartsBarLineChart = class {
    constructor(hostRef) {
        ...
        this.errorPolicy = actionBarUtils.Lm.Throw;
        ...
        this.layerFilterChangePolicy = actionBarUtils.Am.Refresh;
        this.layerRendererChangePolicy = actionBarUtils.Em.Refresh;
    ...
    handleTooManySelectedElements() {
        if (this.errorPolicy === actionBarUtils.Lm.Throw) {
    ...
    rotationChange(newRotation) {
        this.config = actionBarUtils.xn(newRotation, this.config);
    }
    /**
    ...
    layerFilterChangePolicyCallBack(newRefreshOnLayerFilter) {
        if (newRefreshOnLayerFilter !== actionBarUtils.Am.Ignore) {
    ...
    layerRendererChangePolicyCallBack(newRefreshOnLayerRenderer) {
        if (newRefreshOnLayerRenderer !== actionBarUtils.Am.Ignore) {
    ...
    async componentDidUpdate() {
        ...
        await actionBarUtils.Mc([actionBarUtils.WebChartTypes.BarSeries, actionBarUtils.WebChartTypes.LineSeries], this.config);
        if (this.config !== undefined && this.chart !== undefined && !this.showNotifyPanel) {
            try {
                ...
                if (this.chartRef !== undefined) {
                    if (e.name === actionBarUtils.El.ChartDisposed) {
                        this.chart.dispose();
                        ...
                        if (e.name === actionBarUtils.El.QueryFeaturesError) {
        ...
        if (this.actionBarElement !== undefined) {
            actionBarUtils.updateActionBarStates(this.actionBarElement, this.config);
        }
    }
    /**
    ...
    render() {
        ...
        const notifyStyles = this.showNotifyPanel ? `${configUpdate.HTMLClasses.Show} ${configUpdate.HTMLClasses.NotifyPanel}` : configUpdate.HTMLClasses.Hide;
        return (index.h(index.Host, { key: 'd73fd4429c6166c3c9acf451977735b8afe2c10a' }, index.h("slot", { key: 'cfd92d7952609d1ebb1ead6095ca598752913591', name: actionBarUtils.Slot.actionBar, onSlotchange: (e) => {
            ...
            } }), index.h("div", { key: '91227b9efad1516653ba186d51a1ef57a0ae9780', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), index.h("div", { key: '08a5c0546bbab5feb9e35e0d592bc29b6a367692', class: notifyStyles }, notifyPanel)));
    }
    /**
    ...
    checkForIncompatibleChartVersion() {
        ...
        if (this.errorPolicy === actionBarUtils.Lm.Throw &&
            actionBarUtils.jc(chartVersion).versionStatus === actionBarUtils.WebChartVersionStatus.Newer) {
    ...
    async createChartInstance(firstCreation = true) {
        ...
        try {
            if (configUpdate.isValidDataSource(this.config, this.layer)) {
                ...
                this.chartCreationProcessing = configUpdate.zY({
