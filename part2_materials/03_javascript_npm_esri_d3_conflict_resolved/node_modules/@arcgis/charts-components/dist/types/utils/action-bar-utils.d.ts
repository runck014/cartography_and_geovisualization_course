...
import type { WebChart } from "@arcgis/charts-spec";
/**
 ...
 */
export declare const onActionBarActionSelect: (e: CustomEvent<DefaultActionSelectPayload>) => void;
/**
 * Event handler for action bar slot change.
 * @param e
 * @param layer
 */
export declare const onActionBarSlotChange: (e: Event, chartType: ChartTypes, config?: WebChart) => void;
/**
 ...
 * @param config
 */
export declare function updateActionBarStates(actionBar: HTMLArcgisChartsActionBarElement, config?: WebChart): void;
