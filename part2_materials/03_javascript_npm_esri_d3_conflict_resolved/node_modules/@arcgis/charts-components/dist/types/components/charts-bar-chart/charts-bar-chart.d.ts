 ...
 */
export declare class ArcGISChartsBarChart {
    /**
     ...
     * @type {HTMLArcgisChartsBarChartElement}
     * @element
     */
    el: HTMLArcgisChartsBarChartElement;
    /**
    ...
    /**
     * When `true`, the series is completely hidden from the displayed chart, and the legend, if it doesn't have data (i.e. empty),
