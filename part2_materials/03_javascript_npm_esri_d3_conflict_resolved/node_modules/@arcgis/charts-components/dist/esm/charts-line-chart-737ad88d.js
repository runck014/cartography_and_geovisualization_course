 ...
 * v4.31.2
 */
import { r as registerInstance, c as createEvent, h, H as Host, a as getElement } from './index-99a9ccd1.js';
import { H as HTMLClasses, u as updateLegendPosition, b as updateLegendVisibility, f as fetchErrorsStrings, c as fetchCommonStrings, p as promise, g as gatherComponentOptions, l as addMissingSplitBySeries, d as gatherComponentGlobalOptions, m as maximumNumberOfSimultaneousUpdates, i as isValidDataSource, e as addLayerFilterListener, h as addLayerRendererListener, j as addExtentChangeListener, z as zY, k as ArcgisChartsNotifyPanel } from './config-update-298b5ba9.js';
import { L as Lm, A as Am, E as Em, x as xn, M as Mc, W as WebChartTypes, b as El, u as updateActionBarStates, S as Slot, o as onActionBarSlotChange, j as jc, e as WebChartVersionStatus, K as Kr, t as ta } from './action-bar-utils-0ddfb839.js';
...
const ArcGISChartsLineChart = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e0f32fe0a0ee702a9d6ff1f1e15007ac989f5715' }, h("slot", { key: '1a822414b6a9347520958062140f19893ccab60c', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.LineSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), h("div", { key: '05df626a4c4701aacbb01a4ee08cb5bc9a968e66', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: '503d08383bbcfb5eb55dab94e8550690df0281f1', class: notifyStyles }, notifyPanel)));
    }
    /**
