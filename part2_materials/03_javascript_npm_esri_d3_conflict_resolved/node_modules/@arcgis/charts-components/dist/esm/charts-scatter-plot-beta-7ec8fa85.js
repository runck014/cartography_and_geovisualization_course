...
import { w as wV } from './index-04f0a4b8.js';
import { L as Lm, A as Am, E as Em, M as Mc, W as WebChartTypes, b as El, u as updateActionBarStates, S as Slot, o as onActionBarSlotChange, j as jc, e as WebChartVersionStatus, K as Kr } from './action-bar-utils-0ddfb839.js';
...
const ArcGISChartsScatterPlotBeta = class {
    ...
    async componentDidUpdate() {
        ...
        await Mc([WebChartTypes.ScatterSeries], this.config);
    ...
    render() {
        ...
        return (h(Host, { key: 'e6b14c8002c0afede3de90e184b1ebcf79dc04f8' }, h("slot", { key: 'add5e1e2ea3770b66d7c0b4f6afb6a33cdf49c03', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.ScatterSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), h("div", { key: '7cf4ecddf1090b96ba6b66213fe241e4e53e336c', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: '80f38804c69d4e77f210d5ffa24cef20d335091e', class: notifyStyles }, notifyPanel)));
    }
    /**
