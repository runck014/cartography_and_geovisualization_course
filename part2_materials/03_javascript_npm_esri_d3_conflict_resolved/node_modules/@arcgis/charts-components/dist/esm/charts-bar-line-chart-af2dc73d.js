...
import { L as Lm, A as Am, E as Em, x as xn, M as Mc, W as WebChartTypes, b as El, u as updateActionBarStates, S as Slot, o as onActionBarSlotChange, j as jc, e as WebChartVersionStatus, K as Kr } from './action-bar-utils-0ddfb839.js';
...
const ArcGISChartsBarLineChart = class {
    ...
    layerRendererChangePolicyCallBack(newRefreshOnLayerRenderer) {
        if (newRefreshOnLayerRenderer !== Am.Ignore) {
    ...
    async componentDidUpdate() {
        ...
        await Mc([WebChartTypes.BarSeries, WebChartTypes.LineSeries], this.config);
    ...
    render() {
        ...
        return (h(Host, { key: 'd73fd4429c6166c3c9acf451977735b8afe2c10a' }, h("slot", { key: 'cfd92d7952609d1ebb1ead6095ca598752913591', name: Slot.actionBar, onSlotchange: (e) => {
                onActionBarSlotChange(e, WebChartTypes.ComboLineAndBarSeries, this.config);
            }, ref: (el) => {
                this.actionBarElement = el;
            } }), h("div", { key: '91227b9efad1516653ba186d51a1ef57a0ae9780', class: chartStyles, ref: (el) => {
                this.chartRef = el;
            } }), h("div", { key: '08a5c0546bbab5feb9e35e0d592bc29b6a367692', class: notifyStyles }, notifyPanel)));
    }
    /**
