...
export namespace Components {
    interface ArcgisAreaMeasurement2d {
        ...
        /**
          * Icon which represents the component. Typically used when the component is controlled by another component (e.g. by the Expand component). Search [Calcite Icons](https://developers.arcgis.com/calcite-design-system/icons/) for possible values.
         */
        "icon": string;
        /**
    ...
    interface ArcgisBasemapGallery {
        ...
        "state": "ready" | "disabled" | "unsupported" | "loading";
    }
    ...
    interface ArcgisFeature {
        ...
        "label": string;
        /**
          * The location of the graphic to be displayed.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Feature.html#location)
         */
        "location": Point;
        /**
    ...
    interface ArcgisFeatureTable {
        /**
          * Configuration for the [ActionColumn](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable-ActionColumn.html).  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#actionColumnConfig)
         */
         ...
         */
        "activeFilters": Collection<GeometryFilter | SelectionFilter> | undefined;
        /**
        ...
        /**
          * Use this property to configure how columns display within the table in regard to visibility, column order, and sorting.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#attributeTableTemplate)
         */
         ...
         */
        "columns": Collection<Column | FieldColumn | GroupColumn | ActionColumn | AttachmentsColumn | RelationshipColumn> | undefined;
        ...
        "icon": string;
        /**
          * The user-provided number of total features accessed from the data source.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#initialSize)
         */
        "initialSize": number;
        /**
         ...
         */
        "layers": (FeatureLayer | SceneLayer | GeoJSONLayer | CatalogFootprintLayer | CSVLayer | ImageryLayer | KnowledgeGraphSublayer | WFSLayer)[] | undefined;
        /**
          * This property is applicable when working with layers that contain a large number of features, as it provides the ability to limit the displayed total feature count.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#maxSize)
         */
        "maxSize": number;
        /**
        ...
        /**
          * An array of field names from the table's data source to include when the table requests data.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#outFields)
         */
        "outFields": string[];
        "pageCount": number;
        /**
          * Represents the index of the page of the feature currently being displayed.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#pageIndex)
         */
        "pageIndex": number;
        /**
        ...
        /**
          * A collection of nested table instances.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#relatedTables)
         */
        ...
        /**
          * This property accepts and returns a collection of feature object IDs.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#rowHighlightIds)
         */
        ...
        /**
          * The [TimeExtent](https://developers.arcgis.com/javascript/latest/api-reference/esri-time-TimeExtent.html) in which to filter and display data within the FeatureTable widget.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#timeExtent)
         */
    ...
    interface ArcgisMap {
        ...
        /**
          * Options for configuring the highlight.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-View2D.html#highlightOptions)
          * @deprecated Options for configuring the highlight. Use the highlight method on the appropriate esri/views/layers/LayerView to highlight a feature. The layerView's `highlightOptions` will take precedence over the MapView's `highlightOptions` if both properties are set.
         */
    ...
    interface ArcgisPrint {
        ...
        "destroy": () => Promise<void>;
        /**
          * The collection of links exported from the Print widget.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Print.html#exportedLinks)
         */
    ...
    interface ArcgisScene {
        ...
        "camera": Camera;
        /**
          * The diagonal field of view (fov) angle for the camera. The range of angles must be between 1 and 170 degrees.  Setting the camera fov immediately changes the current view. For animating the view, see this component's goTo() method.  [Read more](https://developers.arcgis.com/javascript/latest/api-reference/esri-Camera.html#fov)
         */
        "cameraFov": number | Nil;
        /**
          * The compass heading of the camera in degrees.  Setting the camera heading immediately changes the current view. For animating the view, see this component's goTo() method.  [Read more](https://developers.arcgis.com/javascript/latest/api-reference/esri-Camera.html#heading)
         */
        "cameraHeading": number | Nil;
        /**
          * The position of the camera defined by a map point. It can be an `esri/geometry/Point` instance or a string with the format `"<longitude>, <latitude>, <elevation>"`.  Setting the camera position immediately changes the current view. For animating the view, see this component's goTo() method.  [Read more](https://developers.arcgis.com/javascript/latest/api-reference/esri-Camera.html#position)
         */
        "cameraPosition": string | Nil | Point | number[];
        /**
          * The tilt of the camera in degrees with respect to the surface as projected down from the camera position.  Setting the camera tilt immediately changes the current view. For animating the view, see this component's goTo() method.  [Read more](https://developers.arcgis.com/javascript/latest/api-reference/esri-Camera.html#tilt)
         */
        "cameraTilt": number | Nil;
        /**
          * Represents the view's center point; when setting the center, you may pass a esri/geometry/Point instance or a string representing a longitude/latitude pair (`"-100.4593, 36.9014"`). Setting the center immediately changes the current view. For animating the view, see this component's goTo() method.
         */
        "center": string | Nil | Point | number[];
        ...
        "resolution": number;
        /**
          * Represents an approximation of the map scale.  [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-SceneView.html#scale)
         */
        "scale": number;
        /**
          * The spatial reference of the view. This indicates the projected or geographic coordinate system used to locate geographic features in the map.
...
declare global {
    ...
    interface HTMLArcgisFeatureTableElementEventMap {
        ...
        "arcgisPropertyChange": any;
        "arcgisCellClick": __esri.FeatureTableCellClickEvent;
        "arcgisCellKeydown": __esri.FeatureTableCellKeydownEvent;
        "arcgisCellPointerout": __esri.FeatureTableCellPointeroutEvent;
        "arcgisCellPointerover": __esri.FeatureTableCellPointeroverEvent;
        "arcgisColumnReorder": __esri.FeatureTableColumnReorderEvent;
    }
...
declare namespace LocalJSX {
    ...
    interface ArcgisFeatureTable {
         ...
         */
        "objectIds"?: Collection<string | number>;
        "onArcgisCellClick"?: (event: ArcgisFeatureTableCustomEvent<__esri.FeatureTableCellClickEvent>) => void;
        "onArcgisCellKeydown"?: (event: ArcgisFeatureTableCustomEvent<__esri.FeatureTableCellKeydownEvent>) => void;
        "onArcgisCellPointerout"?: (event: ArcgisFeatureTableCustomEvent<__esri.FeatureTableCellPointeroutEvent>) => void;
        "onArcgisCellPointerover"?: (event: ArcgisFeatureTableCustomEvent<__esri.FeatureTableCellPointeroverEvent>) => void;
        "onArcgisColumnReorder"?: (event: ArcgisFeatureTableCustomEvent<__esri.FeatureTableColumnReorderEvent>) => void;
