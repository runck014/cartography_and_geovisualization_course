...
} & Pick<__esri.FullscreenViewModel, never> & {
...
} | undefined) => __esri.FullscreenViewModel;
export declare class ArcgisFullscreen implements Use<typeof useFullscreenViewModel> {
    ...
    viewModel: __esri.FullscreenViewModel;
    el: HTMLElement;
    arcgisPropertyChange: import("@arcgis/components-controllers").EventEmitter<{
        name: "state";
    }>;
     ...
     */
    element: HTMLElement;
    get fullscreenTitle(): string | undefined;
    /**
