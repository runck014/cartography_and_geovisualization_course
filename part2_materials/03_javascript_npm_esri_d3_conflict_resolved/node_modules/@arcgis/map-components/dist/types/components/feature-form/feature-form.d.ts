...
declare const useFeatureFormWidget: (component: import("@arcgis/components-controllers").StencilLifecycles & {
    ...
    editConstructorProperties(props: __esri.FeatureFormProperties): Promise<__esri.FeatureFormProperties> | __esri.FeatureFormProperties;
