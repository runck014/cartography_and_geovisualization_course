...
declare const useMeasurementWidget: (component: import("@arcgis/components-controllers").StencilLifecycles & {
    ...
    editConstructorProperties(props: __esri.MeasurementProperties): Promise<__esri.MeasurementProperties> | __esri.MeasurementProperties;
