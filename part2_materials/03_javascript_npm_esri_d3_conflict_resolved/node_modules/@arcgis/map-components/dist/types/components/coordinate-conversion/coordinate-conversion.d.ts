...
declare const useCoordinateConversionWidget: (component: import("@arcgis/components-controllers").StencilLifecycles & {
    ...
    editConstructorProperties(props: __esri.CoordinateConversionProperties): Promise<__esri.CoordinateConversionProperties> | __esri.CoordinateConversionProperties;
