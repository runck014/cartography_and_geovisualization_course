...
declare const useElevationProfileWidget: (component: import("@arcgis/components-controllers").StencilLifecycles & {
    ...
    editConstructorProperties(props: __esri.ElevationProfileProperties): Promise<__esri.ElevationProfileProperties> | __esri.ElevationProfileProperties;
