...
declare const useBasemapGalleryWidget: (component: import("@arcgis/components-controllers").StencilLifecycles & {
    ...
    editConstructorProperties(props: __esri.BasemapGalleryProperties): Promise<__esri.BasemapGalleryProperties> | __esri.BasemapGalleryProperties;
