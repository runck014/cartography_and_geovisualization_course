...
declare const useWebScene: (component: import("@arcgis/components-controllers").StencilLifecycles & {
    ...
    editConstructorProperties(props: __esri.WebSceneProperties): Promise<__esri.WebSceneProperties> | __esri.WebSceneProperties;
...
declare const useSceneView: (component: import("@arcgis/components-controllers").StencilLifecycles & {
    ...
    autoDestroyDisabled?: boolean;
    destroy?: () => Promise<void>;
} & Pick<__esri.SceneView, "map" | "constraints" | "extent" | "floors" | "highlightOptions" | "scale" | "viewpoint" | "zoom" | "allLayerViews" | "basemapView" | "fatalError" | "graphics" | "layerViews" | "navigation" | "padding" | "spatialReference" | "theme" | "timeExtent" | "popup" | "camera" | "clippingArea" | "alphaCompositingEnabled" | "analyses" | "environment" | "qualityProfile" | "viewingMode"> & {
    reactiveUtils?: typeof __esri.reactiveUtils;
    autoDestroyDisabled: boolean;
    destroy: () => Promise<void>;
}, options?: {
    editConstructorProperties(props: __esri.SceneViewProperties): Promise<__esri.SceneViewProperties> | __esri.SceneViewProperties;
...
export declare class ArcgisScene implements Use<typeof useWebScene>, Use<typeof useSceneView> {
    ...
    /**
     * The position of the camera defined by a map point. It can be an `esri/geometry/Point` instance or a string with the
     ...
     *
     */
    cameraPosition: string | Nil | __esri.Point | number[];
    /**
    ...
    /**
     * This property contains performance information in a Scene like global memory usage and additional
