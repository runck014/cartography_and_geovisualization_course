...
} & Pick<__esri.WebMap, "ipsInfo"> & {
    reactiveUtils?: typeof __esri.reactiveUtils;
    autoDestroyDisabled: boolean;
    destroy: () => Promise<void>;
}, options?: {
    editConstructorProperties(props: __esri.WebMapProperties): Promise<__esri.WebMapProperties> | __esri.WebMapProperties;
...
declare const useMapView: (component: import("@arcgis/components-controllers").StencilLifecycles & {
    ...
    editConstructorProperties(props: __esri.MapViewProperties): Promise<__esri.MapViewProperties> | __esri.MapViewProperties;
