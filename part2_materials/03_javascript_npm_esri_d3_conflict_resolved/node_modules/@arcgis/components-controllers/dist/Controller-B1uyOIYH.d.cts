 ...
 *
 * @remarks
 * Do not use this type in Lumina. Use `LitElement` instead
 */
...
type ControllerLifecycleMethods = {
     ...
     *
     * @remarks
     * The changedProperties parameter will only be present in Lumina, not in Stencil
     */
...
/**
 * Lumina's LitElement should have a $createEvent static property. That
 * will be used by controllers when they wish to emit an event on the component.
 *
 * The controllers package cannot import `createEvent()` directly from
 * `@arcgis/lumina` as controllers package needs to support both Stencil and Lit,
...
type CreateEventFactory = <T = undefined>(eventName?: string, options?: EventInit, component?: BaseComponent) => EventEmitter<T>;
/**
 * An event emitter object
 */
type EventEmitter<T = undefined> = {
 ...
 */
type LuminaPropertyDeclaration = PropertyDeclaration & {
    /**
...
export { type BaseComponent as B, type ControllerHost as C, type EventEmitter as E, GenericControllerType as G, type LitElementWithCreateEventFactory as L, type StencilLifecycles as S, type TrackKeyResolution as T, type Use as U, type BaseController as a, Controller as b, type ControllerLifecycleMethods as c, GenericController as d, ControllerManager as e, controllerSymbol as f, type LitElementWithChangedPropertiesMap as g, type LuminaPropertyDeclaration as h, retrieveComponent as r, useControllerManager as u };
