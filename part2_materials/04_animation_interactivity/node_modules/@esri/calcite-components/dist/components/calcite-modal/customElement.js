...
import { c as z } from "../../chunks/loadable.js";
import { c as f } from "../../chunks/observers.js";
import { o as C } from "../../chunks/openCloseComponent.js";
...
class M extends y {
  ...
  renderCloseButton() {
    return this.closeButtonDisabled ? null : h("button", a`<button .ariaLabel=${this.messages.close} class=${o(t.close)} @click=${this.handleCloseClick} title=${this.messages.close ?? k} ${d(this.closeButtonEl)}><calcite-icon .icon=${B.close} .scale=${$(this.scale)}></calcite-icon></button>`);
  }
  renderStyle() {
