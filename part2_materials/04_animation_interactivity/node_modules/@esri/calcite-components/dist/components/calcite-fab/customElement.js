...
import { createRef as w, ref as b } from "lit-html/directives/ref.js";
import { LitElement as u, safeClassMap as x, nothing as f } from "@arcgis/lumina";
import { b as m } from "../../chunks/dom.js";
import { u as v, I as g } from "../../chunks/interactive.js";
import { c as y } from "../../chunks/loadable.js";
...
class R extends u {
  ...
  async setFocus() {
    await y(this), m(this.buttonEl.value);
  }
  // #endregion
  // #region Lifecycle
  load() {
  ...
  // #region Rendering
  render() {
    const { appearance: o, kind: s, disabled: t, loading: e, scale: i, textEnabled: l, icon: d, label: a, text: n, iconFlipRtl: r } = this, c = l ? null : a || n || null;
    return g({ disabled: t, children: h`<calcite-button .appearance=${o === "solid" ? "solid" : "outline-fill"} class=${x(E.button)} .disabled=${t} .iconFlipRtl=${r ? "start" : null} .iconStart=${d} .kind=${s} .label=${a} .loading=${e} round .scale=${i} title=${c ?? f} type=button width=auto ${b(this.buttonEl)}>${this.textEnabled ? this.text : null}</calcite-button>` });
  }
}
p("calcite-fab", R);
export {
