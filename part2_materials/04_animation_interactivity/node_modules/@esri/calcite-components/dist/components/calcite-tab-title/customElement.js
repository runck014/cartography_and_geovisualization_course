import { i as f, c as g } from "../../chunks/runtime.js";
...
class H extends y {
  ...
  renderCloseButton() {
    ...
    return t ? v(e.closeButton, a`<button .ariaLabel=${i.close} class=${n(e.closeButton)} @click=${this.closeClickHandler} title=${i.close ?? x} type=button ${b(this.closeButtonEl)}><calcite-icon .icon=${F.close} .scale=${r(this.scale)}></calcite-icon></button>`) : null;
  }
}
g("calcite-tab-title", H);
export {
  H as TabTitle
};
