...
class dt extends E {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.commonDateSeparators = [".", "-", "/"], this.dialogId = `date-picker-dialog--${k()}`, this.focusOnOpen = !1, this.focusTrapDeactivates = () => {
      this.open = !1;
    }, this.transitionProp = "opacity", this.placeholderTextId = `calcite-input-date-picker-placeholder-${k()}`, this.rangeStartValueChangedByUser = !1, this.userChangedValue = !1, this._value = "", this.valueAsDateChangedExternally = !1, this.focusedInput = "start", this.disabled = !1, this.focusTrapDisabled = !1, this.layout = "horizontal", this.messages = rt({ blocking: !0 }), this.monthStyle = "wide", this.open = !1, this.overlayPositioning = "absolute", this.placement = W, this.proximitySelectionDisabled = !1, this.range = !1, this.readOnly = !1, this.required = !1, this.scale = "m", this.status = "idle", this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,
  ...
  connectedCallback() {
    ...
    Z(this), Y(this), this.setFilteredPlacements(), b.numberFormatOptions = {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), w(this), J(this), _(this), L(this);
  }
  // #endregion
  // #region Private Methods
  handleFocusTrapDisabled(t) {
    this.open && (t ? w(this) : C(this));
  }
  ...
  onClose() {
    this.calciteInputDatePickerClose.emit(), U(this), w(this), this.focusOnOpen = !1, this.datePickerEl?.reset();
  }
