...
class M extends $ {
  ...
  renderTile() {
    const { description: e, disabled: c, hasContentBottom: a, hasContentEnd: f, hasContentStart: g, hasContentTop: m, heading: l, icon: r, iconFlipRtl: x, interactive: i, selectionMode: h } = this, k = l && r && !e, p = !!this.href || !i, v = h === "multiple" && i ? "checkbox" : h !== "none" && i ? "radio" : i ? "button" : void 0, b = !!(e || f || g || l || r), z = !b && m && a;
    ...
    })} @click=${this.clickHandler} .role=${v} tabindex=${(p ? void 0 : 0) ?? y} ${w(this.setContainerEl)}>${this.renderSelectionIcon()}<div class=${n({
