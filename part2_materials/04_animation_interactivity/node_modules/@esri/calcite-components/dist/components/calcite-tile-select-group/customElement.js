...
class r extends s {
  ...
  // #region Rendering
  render() {
    return o({ disabled: this.disabled, children: t`<slot></slot>` });
  }
}
e("calcite-tile-select-group", r);
export {
