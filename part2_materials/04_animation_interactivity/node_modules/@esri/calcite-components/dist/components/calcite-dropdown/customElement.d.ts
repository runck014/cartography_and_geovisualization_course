...
export declare class Dropdown extends LitElement {
    ...
    readonly calciteDropdownBeforeClose: TargetedEvent<this, undefined>;
    /** Fires when the component is added to the DOM but not rendered, and before the opening transition begins. */
    readonly calciteDropdownBeforeOpen: TargetedEvent<this, undefined>;
    /** Fires when the component is closed and animation is complete. */
    readonly calciteDropdownClose: TargetedEvent<this, undefined>;
    /** Fires when the component is open and animation is complete. */
    readonly calciteDropdownOpen: TargetedEvent<this, undefined>;
    /** Fires when a `calcite-dropdown-item`'s selection changes. */
    readonly calciteDropdownSelect: TargetedEvent<this, undefined>;
}
