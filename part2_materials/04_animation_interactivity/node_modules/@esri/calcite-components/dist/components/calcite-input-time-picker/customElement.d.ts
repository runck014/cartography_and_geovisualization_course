...
import { EffectiveHourFormat, HourFormat } from '../../utils/time';
import { Scale, Status } from '../interfaces';
import { IconNameOrString } from '../calcite-icon/interfaces';
import { TimePicker } from '../calcite-time-picker/customElement.js';
import { InputText } from '../calcite-input-text/customElement.js';
...
export declare class InputTimePicker extends LitElement {
    ...
    readonly calciteInputTimePickerBeforeClose: TargetedEvent<this, undefined>;
    /** Fires when the component is added to the DOM but not rendered, and before the opening transition begins. */
    readonly calciteInputTimePickerBeforeOpen: TargetedEvent<this, undefined>;
    /** Fires when the component's `value` is changes. */
    readonly calciteInputTimePickerChange: TargetedEvent<this, undefined>;
    /** Fires when the component is closed and animation is complete. */
    readonly calciteInputTimePickerClose: TargetedEvent<this, undefined>;
    /** Fires when the component is open and animation is complete. */
    readonly calciteInputTimePickerOpen: TargetedEvent<this, undefined>;
}
