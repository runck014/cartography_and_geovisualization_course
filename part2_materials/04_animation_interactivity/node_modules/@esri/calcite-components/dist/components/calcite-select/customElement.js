...
import { c as N } from "../../chunks/loadable.js";
...
class A extends p {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.componentToNativeEl = /* @__PURE__ */ new Map(), this.mutationObserver = z("mutation", () => this.populateInternalSelect()), this.disabled = !1, this.required = !1, this.scale = "m", this.status = "idle", this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,
