...
export declare class Carousel extends LitElement {
    ...
    readonly calciteCarouselChange: TargetedEvent<this, undefined>;
    ...
    readonly calciteCarouselPause: TargetedEvent<this, undefined>;
    /** Fires when the carousel autoplay is invoked by the user. */
    readonly calciteCarouselPlay: TargetedEvent<this, undefined>;
    ...
    readonly calciteCarouselResume: TargetedEvent<this, undefined>;
    /** Fires when the carousel autoplay state is stopped by a user. */
    readonly calciteCarouselStop: TargetedEvent<this, undefined>;
}
