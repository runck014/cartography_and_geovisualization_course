...
import { LitElement as w, createEvent as l, safeClassMap as a } from "@arcgis/lumina";
import { h as I, a as d } from "../../chunks/dom.js";
import { u as P, I as z } from "../../chunks/interactive.js";
import { H as A } from "../../chunks/Heading.js";
import { c as T } from "../../chunks/loadable.js";
import { o as M } from "../../chunks/openCloseComponent.js";
import { e as F } from "../../chunks/floating-ui.js";
import { u as L } from "../../chunks/useT9n.js";
import { l as D } from "../../chunks/logger.js";
...
class q extends w {
  constructor() {
    super(...arguments), this.transitionProp = "margin-top", this.hasContentStart = !1, this.hasControl = !1, this.hasEndActions = !1, this.hasIcon = !1, this.hasMenuActions = !1, this.collapsible = !1, this.disabled = !1, this.dragDisabled = !1, this.dragHandle = !1, this.loading = !1, this.menuPlacement = F, this.messages = L(), this.moveToItems = [], this.open = !1, this.overlayPositioning = "absolute", this.setPosition = null, this.setSize = null, this.sortHandleOpen = !1, this.calciteBlockBeforeClose = l({ cancelable: !1 }), this.calciteBlockBeforeOpen = l({ cancelable: !1 }), this.calciteBlockClose = l({ cancelable: !1 }), this.calciteBlockOpen = l({ cancelable: !1 }), this.calciteBlockSortHandleBeforeClose = l({ cancelable: !1 }), this.calciteBlockSortHandleBeforeOpen = l({ cancelable: !1 }), this.calciteBlockSortHandleClose = l({ cancelable: !1 }), this.calciteBlockSortHandleOpen = l({ cancelable: !1 }), this.calciteBlockToggle = l({ cancelable: !1 });
  }
  static {
  ...
  renderTitle() {
    ...
    return e || i ? n`<div class=${a(t.title)}>${A({ class: t.heading, level: o, children: e })}${i ? n`<div class=${a(t.description)}>${i}</div>` : null}</div>` : null;
  }
  renderIcon(e) {
