...
export declare class ListItem extends LitElement {
    ...
    readonly calciteListItemClose: TargetedEvent<this, undefined>;
    /** Fires when the component is selected. */
    readonly calciteListItemSelect: TargetedEvent<this, undefined>;
    /** Fires when the sort handle is requested to be closed and before the closing transition begins. */
    readonly calciteListItemSortHandleBeforeClose: TargetedEvent<this, undefined>;
    /** Fires when the sort handle is added to the DOM but not rendered, and before the opening transition begins. */
    readonly calciteListItemSortHandleBeforeOpen: TargetedEvent<this, undefined>;
    /** Fires when the sort handle is closed and animation is complete. */
    readonly calciteListItemSortHandleClose: TargetedEvent<this, undefined>;
    /** Fires when the sort handle is open and animation is complete. */
    readonly calciteListItemSortHandleOpen: TargetedEvent<this, undefined>;
    /** Fires when the open button is clicked. */
    readonly calciteListItemToggle: TargetedEvent<this, undefined>;
}
