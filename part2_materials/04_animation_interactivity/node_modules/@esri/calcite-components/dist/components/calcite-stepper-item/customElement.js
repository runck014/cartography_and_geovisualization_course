...
import { html as o, nothing as n } from "lit";
...
import { i as f } from "../../chunks/component.js";
...
class z extends p {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.headerEl = c(), this.complete = !1, this.disabled = !1, this.error = !1, this.icon = !1, this.iconFlipRtl = !1, this.itemHidden = !1, this.messages = g(), this.numbered = !1, this.scale = "m", this.selected = !1, this.calciteInternalStepperItemKeyEvent = r({
      cancelable: !1
  ...
  handleItemClick(e) {
    this.disabled || f(this.el) || this.layout === "horizontal" && e.composedPath().some((a) => a.classList?.contains("stepper-item-content")) || this.emitUserRequestedItem();
  }
