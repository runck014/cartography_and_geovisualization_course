...
import { html as a, nothing as l } from "lit";
import { createRef as s, ref as o } from "lit-html/directives/ref.js";
import { LitElement as h, createEvent as c, safeClassMap as i, safeStyleMap as b } from "@arcgis/lumina";
import { u, I as p } from "../../chunks/interactive.js";
import { c as g, d as E, g as f } from "../../chunks/label.js";
import { c as m } from "../../chunks/loadable.js";
import { s as y } from "../../chunks/dom.js";
...
class v extends h {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.cancelEditingButton = s(), this.confirmEditingButton = s(), this._editingEnabled = !1, this.enableEditingButton = s(), this.controls = !1, this.disabled = !1, this.loading = !1, this.messages = k(), this.calciteInlineEditableEditCancel = c({ cancelable: !1 }), this.calciteInlineEditableEditConfirm = c({ cancelable: !1 }), this.calciteInternalInlineEditableEnableEditingChange = c({ cancelable: !1 }), this.listen("calciteInternalInputBlur", this.blurHandler);
  }
  static {
  ...
  async setFocus() {
    await m(this), this.inputElement?.setFocus();
  }
  connectedCallback() {
  ...
  async handleDefaultSlotChange(t) {
    const e = y(t).filter((d) => d.matches("calcite-input"))[0];
    this.inputElement = e, e && (await e.componentOnReady(), e.editingEnabled = this.editingEnabled, e.disabled = this.disabled, e.label = e.label || f(this), this.scale = this.scale || this.inputElement?.scale || "m");
  }
  onLabelClick() {
    this.setFocus();
  }
