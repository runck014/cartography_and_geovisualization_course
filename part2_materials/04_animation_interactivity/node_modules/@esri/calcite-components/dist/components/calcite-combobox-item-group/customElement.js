...
import { g as d, a as p } from "../../chunks/utils3.js";
...
class g extends r {
  ...
  render() {
    ...
    return c`<ul aria-labelledby=${this.guid ?? i} class=${e({ [t.list]: !0, [`scale--${l}`]: !0 })} role=group><li class=${e({ [t.label]: !0 })} id=${this.guid ?? i} role=presentation style=${n({ "--calcite-combobox-item-spacing-indent-multiplier": `${s}` })}><span class=${e(t.title)}>${this.label}</span></li><slot></slot></ul>`;
  }
}
a("calcite-combobox-item-group", g);
export {
