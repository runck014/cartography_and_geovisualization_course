...
class k extends d {
  ...
  // #region Rendering
  render() {
    const e = h(this.value).replaceAll("-", "");
    ...
    return this.el.ariaLabel = l, this.el.ariaSelected = f(this.active), i(this.el, "id", e), this.el.role = "button", i(this.el, "tabIndex", this.active && !this.disabled ? 0 : -1), p({ disabled: this.disabled, children: n`<div aria-hidden=true class="day-wrapper"><span class="day"><span class="text">${r}</span></span></div>` });
  }
}
s("calcite-date-picker-day", k);
export {
  k as DatePickerDay
};
