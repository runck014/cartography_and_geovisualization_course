...
interface StencilCalciteBlock extends Partial<Pick<Block, 'collapsible' | 'description' | 'disabled' | 'dragDisabled' | 'dragHandle' | 'heading' | 'headingLevel' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'loading' | 'menuFlipPlacements' | 'menuPlacement' | 'messageOverrides' | 'open' | 'overlayPositioning' | 'sortHandleOpen' | 'status'>>, StencilJsx.HTMLAttributes<HTMLCalciteBlockElement> {
...
interface StencilCalciteBlockSection extends Partial<Pick<BlockSection, 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'messageOverrides' | 'open' | 'status' | 'text' | 'toggleDisplay'>>, StencilJsx.HTMLAttributes<HTMLCalciteBlockSectionElement> {
...
interface StencilCalciteDropdown extends Partial<Pick<Dropdown, 'closeOnSelectDisabled' | 'disabled' | 'flipPlacements' | 'maxItems' | 'open' | 'overlayPositioning' | 'placement' | 'scale' | 'type' | 'width' | 'widthScale'>>, StencilJsx.HTMLAttributes<HTMLCalciteDropdownElement> {
...
interface StencilCalciteDropdownGroup extends Partial<Pick<DropdownGroup, 'groupTitle' | 'selectionMode'>>, StencilJsx.HTMLAttributes<HTMLCalciteDropdownGroupElement> {
}
...
interface StencilCalciteListItem extends Partial<Pick<ListItem, 'closable' | 'closed' | 'description' | 'disabled' | 'dragDisabled' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'messageOverrides' | 'metadata' | 'open' | 'scale' | 'selected' | 'sortHandleOpen' | 'unavailable' | 'value'>>, StencilJsx.HTMLAttributes<HTMLCalciteListItemElement> {
