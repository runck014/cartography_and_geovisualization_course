...
interface LuminaCalciteBlock extends Partial<Pick<Block, 'collapsible' | 'description' | 'disabled' | 'dragDisabled' | 'dragHandle' | 'heading' | 'headingLevel' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'loading' | 'menuFlipPlacements' | 'menuPlacement' | 'messageOverrides' | 'open' | 'overlayPositioning' | 'sortHandleOpen' | 'status'>>, h.JSX.HTMLAttributes<HTMLCalciteBlockElement> {
...
interface LuminaCalciteBlockSection extends Partial<Pick<BlockSection, 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'messageOverrides' | 'open' | 'status' | 'text' | 'toggleDisplay'>>, h.JSX.HTMLAttributes<HTMLCalciteBlockSectionElement> {
...
interface LuminaCalciteDropdown extends Partial<Pick<Dropdown, 'closeOnSelectDisabled' | 'disabled' | 'flipPlacements' | 'maxItems' | 'open' | 'overlayPositioning' | 'placement' | 'scale' | 'type' | 'width' | 'widthScale'>>, h.JSX.HTMLAttributes<HTMLCalciteDropdownElement> {
...
interface LuminaCalciteDropdownGroup extends Partial<Pick<DropdownGroup, 'groupTitle' | 'selectionMode'>>, h.JSX.HTMLAttributes<HTMLCalciteDropdownGroupElement> {
}
...
interface LuminaCalciteListItem extends Partial<Pick<ListItem, 'closable' | 'closed' | 'description' | 'disabled' | 'dragDisabled' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'messageOverrides' | 'metadata' | 'open' | 'scale' | 'selected' | 'sortHandleOpen' | 'unavailable' | 'value'>>, h.JSX.HTMLAttributes<HTMLCalciteListItemElement> {
