...
interface ReactCalciteBlock extends Partial<Pick<Block, 'collapsible' | 'description' | 'disabled' | 'dragDisabled' | 'dragHandle' | 'heading' | 'headingLevel' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'loading' | 'menuFlipPlacements' | 'menuPlacement' | 'messageOverrides' | 'open' | 'overlayPositioning' | 'sortHandleOpen' | 'status'>>, HTMLProps<HTMLCalciteBlockElement> {
...
interface ReactCalciteBlockSection extends Partial<Pick<BlockSection, 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'messageOverrides' | 'open' | 'status' | 'text' | 'toggleDisplay'>>, HTMLProps<HTMLCalciteBlockSectionElement> {
...
interface ReactCalciteDropdown extends Partial<Pick<Dropdown, 'closeOnSelectDisabled' | 'disabled' | 'flipPlacements' | 'maxItems' | 'open' | 'overlayPositioning' | 'placement' | 'scale' | 'type' | 'width' | 'widthScale'>>, HTMLProps<HTMLCalciteDropdownElement> {
...
interface ReactCalciteDropdownGroup extends Partial<Pick<DropdownGroup, 'groupTitle' | 'selectionMode'>>, HTMLProps<HTMLCalciteDropdownGroupElement> {
}
...
interface ReactCalciteListItem extends Partial<Pick<ListItem, 'closable' | 'closed' | 'description' | 'disabled' | 'dragDisabled' | 'iconEnd' | 'iconFlipRtl' | 'iconStart' | 'label' | 'messageOverrides' | 'metadata' | 'open' | 'scale' | 'selected' | 'sortHandleOpen' | 'unavailable' | 'value'>>, HTMLProps<HTMLCalciteListItemElement> {
